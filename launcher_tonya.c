...
void __EntryFunction__()
{
	...
	Var0.f_41 = 6;
	func_285(&Var0);
	vLocal_52 = { ScriptParam_228.f_1[0 /*3*/] };
	...
	iVar1[1] = 59;
	iVar1[2] = 62;
	if (!func_265(&iVar1, &Var0, vLocal_52, 1f))
	{
	...
	MISC::CLEAR_AREA(vLocal_52, 5f, 1, 0, 0, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		func_214(Var0);
		func_206(&iLocal_227, &(Var0.f_9), vLocal_52);
		func_184(&Var0);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
...
void func_184(var uParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_52);
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				case 0:
					if (!func_146())
					{
						func_205(&uLocal_58, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_204(&uLocal_58, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
							{
						...
						{
							func_192(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
						...
						{
							func_192(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
				...
				case 1:
					if (!func_146())
					{
						if (func_191(&iLocal_223))
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
							{
				...
				case 2:
					if (func_191(&iLocal_223))
					{
						if (func_185(&iLocal_223) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_226++;
							switch (iLocal_226)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_204(&uLocal_58, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_204(&uLocal_58, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_204(&uLocal_58, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_204(&uLocal_58, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_192(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
...
float func_210(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_215(int iParam0, bool bParam1)
{
	...
	func_110(*iParam0, &Var0);
	if ((func_252(*iParam0) || func_250(*iParam0)) || Global_76822 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_237(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar2 != -1)
		{
			func_236(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_230(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_230(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_231(iParam2, iParam5) };
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_235(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_234(vVar1, vVar0);
...
float func_234(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_242(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
{
	if ((func_251() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0)
{
	...
	iLocal_53 = PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_52 - Vector(10f, 10f, 10f), vLocal_52 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	iLocal_55 = 1;
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_266((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_266((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_266(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_267(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_267(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
