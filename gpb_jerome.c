...
void func_105()
{
	...
	StringCopy(&Local_204, "PBJE", 8);
	StringCopy(&Local_205, "JEROME", 16);
	StringCopy(&Local_202, "Special_Ped@jerome", 64);
	StringCopy(&Local_203, "Base", 64);
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBJS_INTERACT";
	StringCopy(&Local_231, "", 16);
	StringCopy(&Local_232, "", 16);
	StringCopy(&Local_233, "", 16);
	StringCopy(&cLocal_234, "special_ped@jerome@base", 64);
	StringCopy(&cLocal_243, "special_ped@jerome@intro", 64);
	bLocal_268 = false;
	iLocal_217 = 6;
	iLocal_221[0] = 9;
	iLocal_221[1] = 9;
