...
void func_2(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_5(0) && Global_76823.f_1 == 1) && func_4(Global_76823))
		{
		}
		else
		{
	...
	if (Global_111560.f_9080 || func_5(0))
	{
		iVar0 = func_3();
...
void func_6()
{
	...
	{
		if (!func_105(iVar0, 1, 1))
		{
			func_94(12.5881f, 545.7901f, 174.9232f, 5f, 0);
		}
	}
	else
	{
	...
	if (func_91(func_93(), 1))
	{
		func_90(26.15189f, 560.6541f, 190.3232f, -14.36067f, 539.8602f, 170.3472f, 30f, 3.518f, 546.9235f, 173.7262f, 125.6127f, func_93(), 1, 1, 1, 0, 0);
	}
	else
	{
	...
	while (CUTSCENE::IS_CUTSCENE_PLAYING() || !bVar1)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_30))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!func_105(iVar0, 1, 1) && !func_76(1, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
				{
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_69(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_69(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_75(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_13(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_12(*iParam1);
				...
				func_10(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_10(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_22(int iParam0)
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_17(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_23(int iParam0)
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_17(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
void func_44(int iParam0, int iParam1)
{
	...
	func_45(iParam0, &(Global_111560.f_32744.f_5510));
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_86(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
void func_81()
{
	...
	{
		if (func_84(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_83(PLAYER::PLAYER_PED_ID());
			if (func_75(iVar0) && (!func_82(14) || Global_110511))
			{
...
int func_86(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_87(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_87(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_87(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_87(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_87(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_87(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_87(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_87(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_87(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_87(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_87(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_87(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_87(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_87(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_87(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_87(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_87(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_90(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_78(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

bool func_91(vector3 vParam0, int iParam1)
{
	return func_92(Global_102125.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_92(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_94(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_102(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_95(int iParam0)
{
	...
	if (func_102(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_101(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_99(0, Global_75396.f_555[0 /*21*/].f_12) || !func_99(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_98(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_99(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_100(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_51(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_102(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_103(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_103(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_103(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_103(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_104(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_106()
{
	...
	while (!CUTSCENE::HAS_CUTSCENE_LOADED())
	{
		...
		{
			func_107("FRANKLIN", PLAYER::PLAYER_PED_ID(), 0, 2);
		}
		SYSTEM::WAIT(0);
	}
}

void func_107(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar1;
...
void func_108(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_188(iVar4, func_190(iVar0), func_189(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_190(iVar0)), &uVar1))
			{
				Var3 = { func_119(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_117(iVar4, func_190(iVar0), func_189(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_190(iVar0)), &uVar1))
			{
				Var3 = { func_119(iVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_188(iVar4, 14, func_110(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_119(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_117(iVar4, 14, func_110(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_119(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_189(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_189(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_109(iVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_119(iVar4, 0, iVar9, -1) };
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_112(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_112(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
	...
	while (iVar4 <= (iVar2 - 1))
	{
		...
		else
		{
			...
			while (iVar5 <= (iVar6 - 1))
			{
				...
				{
					iVar3 = (iVar3 + func_111(iParam0, iParam3));
					return iVar3;
				}
				else
				{
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_114(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_113(iParam0, func_114(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
...
void func_121(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_133(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_122(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_125(func_128(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_125(func_124(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_125(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_114(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_188(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
void func_191(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				uParam1->f_59 = func_125(2051, iParam3, 0);
			}
			else
			{
				uParam1->f_59 = func_125(752, iParam3, 0);
			}
			uParam1->f_60 = func_125(753, iParam3, 0);
			uParam1->f_61 = func_125(754, iParam3, 0);
		}
...
int func_192(int iParam0, var uParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_126(uParam1)];
...
int func_199(int iParam0)
{
	...
	func_200(&(Global_111560.f_2358.f_539), iVar1);
...
void func_200(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_202(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
