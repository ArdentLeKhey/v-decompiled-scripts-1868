...
void __EntryFunction__()
{
	...
	if (MISC::IS_BIT_SET(Global_111560.f_18962.f_1, iVar77))
	{
		fVar65 = 0.1f;
	}
	iVar13 = iVar77;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar33))
	{
		...
		if (func_525(&Var3) != 0 && ENTITY::GET_ENTITY_MODEL(iVar33) == func_525(&Var3))
		{
			iVar36 = iVar33;
			iVar33 = 0;
		}
		...
		switch (iVar7)
		{
			case 0:
				...
				if (iVar13 == 0)
				{
					...
					uVar41 = VEHICLE::ADD_VEHICLE_COMBAT_ANGLED_AVOIDANCE_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f);
				}
				else if (iVar13 == 5)
				{
				...
				if (CAM::IS_SCREEN_FADED_OUT() || (((iVar13 == 5 || iVar13 == 6) || iVar13 == 12) && !bVar93))
				{
					if (!bVar93)
					{
						if ((iVar13 != 5 && iVar13 != 6) && iVar13 != 12)
						{
							...
							vVar57 = { func_469(SYSTEM::COS(vVar57.z), SYSTEM::SIN(vVar57.z), MISC::TAN(vVar57.x)) };
							if (func_468(iVar13))
							{
								STREAMING::NEW_LOAD_SCENE_START(func_467(iVar13), vVar57, 4000f, 0);
							}
						}
					...
					if (((bVar93 || iVar13 == 4) || iVar13 == 8) || iVar13 == 3)
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_467(iVar13), 0, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_458(&Var3));
						ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), true);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					}
					iVar7 = 2;
				}
				else if (!CAM::IS_SCREEN_FADING_OUT() && (!func_456(&iVar23) || func_455(&iVar23) > 0.05f))
				{
			...
			case 3:
				...
				{
					if (func_459(func_460(iVar13)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3))
					{
					}
					else if (bVar93)
					{
					...
					else
					{
						...
						{
							SYSTEM::WAIT(1000);
							CAM::SET_CAM_ACTIVE_WITH_INTERP(func_427(&uVar5, 1), func_427(&uVar5, 0), 10000, 1, 1);
						...
						if (!func_425(func_426(iVar13)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_426(iVar13), 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_424(func_426(iVar13), func_467(iVar13)));
							PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
							if (func_422() == 0)
							{
							...
							TASK::OPEN_SEQUENCE_TASK(&iVar48);
							if (func_421(iVar13) > 0)
							{
								TASK::TASK_STAND_STILL(0, func_421(iVar13));
							}
							TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_467(iVar13), 1f, -1, func_458(&Var3), 1056964608);
							TASK::CLOSE_SEQUENCE_TASK(iVar48);
							TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar48);
							TASK::CLEAR_SEQUENCE_TASK(&iVar48);
						}
						if (!func_459(func_460(iVar13)))
						{
							...
							while (iVar82 < iVar39)
							{
								...
								{
									if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar39[iVar82], false), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 2500f)
									{
			...
			case 4:
				...
				else if (CAM::IS_SCREEN_FADED_OUT())
				{
					...
					if (func_459(func_460(iVar13)))
					{
						...
						if (bVar110)
						{
							AUDIO::PLAY_SOUND_FROM_ENTITY(iVar85, "Helicopter_Wind_Idle", iVar33, "BASEJUMPS_SOUNDS", false, 0);
						}
						if (bVar109)
						{
			...
			case 5:
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					if (bVar93 && bVar103)
					{
						CLOCK::SET_CLOCK_TIME(func_368(iVar15), func_367(iVar15), func_366(iVar15));
					}
					SYSTEM::WAIT(2000);
					if (bVar93)
					{
				...
				{
					iVar45 = HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar34, func_364(&Var3)));
					HUD::SET_BLIP_COLOUR(iVar45, 5);
					HUD::SHOW_HEIGHT_ON_BLIP(iVar45, true);
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_TGT");
				}
				else
				{
					iVar45 = HUD::ADD_BLIP_FOR_COORD(func_363(&Var3, 0));
					HUD::SET_BLIP_COLOUR(iVar45, 5);
					if (iVar72 == 1)
					{
						HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_TGT");
				...
				if (iVar72 > 1)
				{
					iVar46 = HUD::ADD_BLIP_FOR_COORD(func_363(&Var3, 1));
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0))
				{
					...
					{
						ENTITY::SET_ENTITY_COORDS(iVar34, func_363(&Var3, 0), 1, false, 0, 1);
					}
				}
				if (MISC::IS_BIT_SET(Global_111560.f_18962.f_1, (func_360(&Var3) - 125)))
				{
				...
				if (!func_372(&Var3))
				{
					...
					else
					{
						...
						{
							CAM::SET_CAM_COORD(func_427(&uVar5, 0), -76.7226f, -829.9866f, 326.0427f);
							CAM::SET_CAM_ROT(func_427(&uVar5, 0), 0.8541f, 0f, -17.012f, 2);
							CAM::SET_CAM_FOV(func_427(&uVar5, 0), 53.883f);
							CAM::SET_CAM_ACTIVE(func_427(&uVar5, 0), true);
						}
						else
						{
							if (CAM::IS_SCRIPT_GLOBAL_SHAKING())
			...
			case 6:
				...
				else
				{
					...
					{
						if (!ENTITY::IS_ENTITY_ON_SCREEN(iVar36) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar36, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 40000f)
						{
					...
					{
						if (HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_456(&iVar31))
						{
							func_365(&iVar31);
						}
			...
			case 7:
				...
				else
				{
					...
					func_342(&Var3, iVar34, iVar42, &iVar44, &iVar49, &iVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &iVar45, &iVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
					func_341(&uVar52);
					if (func_459(func_460(iVar13)) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0))
					{
					...
					if (func_326(&Var3, &uVar5, &uVar4, &iVar18, &vVar56, &uVar60, vVar61, vVar62) || bVar98)
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								ENTITY::SET_ENTITY_COORDS(iVar33, func_467(iVar13), 1, false, 0, 1);
								ENTITY::SET_ENTITY_HEADING(iVar33, func_458(&Var3));
								...
								TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar81, "oddjobs@basejump@", "Heli_jump", 4f, -4f, 7, 0, 1148846080, 0);
						...
						AUDIO::PLAY_SOUND_FROM_ENTITY(iVar85, "Helicopter_Wind", iVar33, "BASEJUMPS_SOUNDS", false, 0);
						bVar98 = false;
						iVar7 = 8;
					}
				}
			...
			case 8:
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar81))
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iVar47);
						TASK::TASK_FORCE_MOTION_STATE(0, -1161760501, 0);
						TASK::TASK_PARACHUTE(0, 1, 0);
						TASK::CLOSE_SEQUENCE_TASK(iVar47);
						TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar47);
						TASK::CLEAR_SEQUENCE_TASK(&iVar47);
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar33))
				{
					...
					{
						ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(PLAYER::PLAYER_PED_ID(), iVar33, false);
			...
			case 9:
				...
				else
				{
					...
					{
						vVar58 = { func_363(&Var3, (iVar72 - 1)) };
						func_271(PLAYER::PLAYER_PED_ID(), vVar58);
						bVar98 = false;
					}
					func_352(&iVar19);
					if (func_361(func_362(&Var3)))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iVar34) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_363(&Var3, 0), false) <= 200f)
						{
							iVar34 = VEHICLE::CREATE_MISSION_TRAIN(6, func_363(&Var3, 0), 1);
					...
					else if ((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !func_425(func_363(&Var3, 0)))
					{
						PED::IS_PED_INJURED(iVar43);
						if (func_270(PLAYER::PLAYER_PED_ID(), iVar34, 0) <= 325f)
						{
							if (iVar13 == 5)
							{
							...
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar43, -1273030092) != 1)
							{
								if (iVar13 == 5)
								{
									TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, vVar115, 4, 5f, 16785408, 5f, 10f, 1);
								}
								else
								{
									TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, vVar115, 4, 5f, 16777216, 4f, -1f, 1);
								}
							}
							else
							{
					...
					if (iVar8 == 1 || iVar8 >= 2)
					{
						...
						while (iVar116 < iVar44)
						{
							...
							{
								TASK::CLEAR_PED_TASKS(iVar44[iVar116]);
								iVar44[iVar116] = 0;
							}
							iVar116++;
						}
			...
			case 10:
				...
				if ((!bVar96 && !bVar97) && !bVar99)
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, vVar59, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_363(&Var3, iVar71), vVar59, false, true, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							bVar117 = false;
				...
				if (((bVar96 || bVar97) || bVar99) || (func_456(&iVar21) && func_455(&iVar21) > 0.25f))
				{
					...
					if (bVar96 || iVar8 == 1)
					{
						...
						{
							iVar79 = 125;
							MISC::SET_BIT(&(Global_111560.f_18962.f_1), (func_360(&Var3) - iVar79));
							...
							while (iVar83 < 13)
							{
								if (!MISC::IS_BIT_SET(Global_111560.f_18962.f_1, iVar83))
								{
			...
			case 11:
				...
				else if (!CAM::IS_SCREEN_FADING_OUT() && (!func_74() || func_455(&iVar25) >= 2f))
				{
					...
					if (func_456(&iVar18))
					{
						if ((iVar9 == 1 || func_455(&iVar18) >= 60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar108 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))))
						{
							if (!bVar113)
							{
								func_73(&(Var6.f_26));
...
int func_76(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	...
	if (SYSTEM::TIMERA() > 1000)
	{
		...
		else if ((!*iParam9 && func_322(uParam3, 8, 1000)) && (!PLAYER::IS_PLAYER_ONLINE() || func_257(iParam1, 26)))
		{
			*iParam9 = 1;
			if (PLAYER::IS_PLAYER_ONLINE())
			{
...
void func_96(var uParam0, var uParam1)
{
	...
	Var10 = { func_58(PLAYER::PLAYER_ID()) };
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
...
void func_105(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, bool bParam16, bool bParam17)
{
	...
	switch (Param0.f_29[iParam14])
	{
		...
		case 8:
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_107(func_110(iParam15), 0));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
...
int func_138(var uParam0)
{
	...
	iVar5 = -1;
	iVar9 = 2;
	Var12 = { func_58(PLAYER::PLAYER_ID()) };
...
void func_206(int iParam0, bool bParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	iParam0->f_3[6] = 359;
	iParam0->f_3[7] = 359;
	iParam0->f_12[0] = func_207(iParam2 != 359, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam2, true), "");
	iParam0->f_12[1] = func_207(iParam4 != 359, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam4, true), "");
	iParam0->f_12[2] = func_207(iParam6 != 359, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam6, true), "");
	iParam0->f_12[3] = func_207(iParam8 != 359, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam8, true), "");
	iParam0->f_12[4] = 0;
	iParam0->f_12[5] = 0;
	iParam0->f_12[6] = 0;
	iParam0->f_12[7] = 0;
...
void func_259(vector3 vParam0, int iParam1, int iParam2, int iParam3, var uParam4, float fParam5)
{
	...
	if (bVar10)
	{
		...
		vVar17 = { ENTITY::GET_ENTITY_COORDS(iVar0, true) };
		vVar18 = { ENTITY::GET_ENTITY_COORDS(iVar16, true) };
	}
}
	...
	if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(iParam0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
			{
				...
				{
					vVar5 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
					vVar5.x = func_261((MISC::ABSF(vVar5.x) - 1.305f), 0f);
					if (vVar5.y >= 0f)
					{
...
void func_265(int iParam0)
{
	...
	vVar4 = { vVar1 - vVar2 };
	vVar4.z = 0f;
	fVar9 = MISC::ABSF(func_269(vVar4, vVar3));
	if (func_268(*iParam0))
	{
	...
	if (((ENTITY::DOES_ENTITY_EXIST(*iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, 0)) && vVar6.y > 2f) && vVar6.y < VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(*iParam0))
	{
		TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam0, -1, 0), fVar10);
	}
}
...
void func_273(int iParam0, var uParam1)
{
	...
	while (iVar5 < 6)
	{
		if ((ENTITY::DOES_ENTITY_EXIST((*uParam1)[iVar5]) && !ENTITY::IS_ENTITY_DEAD((*uParam1)[iVar5], 0)) && !PED::IS_PED_INJURED((*uParam1)[iVar5]))
		{
			...
			{
				vVar2 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS((*uParam1)[iVar5], true) };
	...
	if (iVar4 > 0)
	{
		...
		while (iVar5 < iVar4)
		{
			if ((((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar5]) && !ENTITY::IS_ENTITY_DEAD(uVar0[iVar5], 0)) && !PED::IS_PED_INJURED(uVar0[iVar5])) && PED::IS_PED_HUMAN(uVar0[iVar5])) && !PED::IS_PED_IN_ANY_VEHICLE(uVar0[iVar5], 1))
			{
				...
				{
					vVar2 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(uVar0[iVar5], true) };
					fVar3 = ((vVar2.x * vVar2.x) + (vVar2.y * vVar2.y));
					if (vVar2.z * vVar2.z) > (3f * fVar3)
					{
						bVar7 = false;
						...
						while (iVar6 < *uParam1)
						{
							if (!ENTITY::DOES_ENTITY_EXIST((*uParam1)[iVar6]) || PED::IS_PED_INJURED((*uParam1)[iVar6]))
							{
								...
								TASK::TASK_PERFORM_SEQUENCE(uVar0[iVar5], iVar1);
...
void func_276(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, bool bParam30, bool bParam31, bool bParam32, bool bParam33, bool bParam34, int iParam35, var uParam36)
{
	...
	*bParam30 = 0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		{
			PED::_0xF9ACF4A08098EA25(PLAYER::PLAYER_PED_ID(), 1);
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iVar0, true) + Vector(0f, 0f, 2f), 1, false, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(*iParam6) && iVar0 == *iParam6)
			{
				...
				ENTITY::SET_ENTITY_COORDS(iVar0, func_319(iParam20), 1, false, 0, 1);
	...
	switch (uParam0->f_3)
	{
		case 0:
			if (func_455(iParam1) >= 0f)
			{
				...
				CAM::SET_CAM_PARAMS(func_427(uParam0, 0), vParam2 + vVar0, *uParam5, *uParam6, 300, 1, 1, 2);
...
void func_324(int iParam0, var uParam1, int iParam2)
{
	...
	CAM::SET_CAM_NEAR_CLIP(iVar2, func_325());
...
int func_342(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21)
{
	...
	if (bVar15)
	{
		...
		{
			vVar9 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, func_364(uParam0)) };
		...
		{
			GRAPHICS::DRAW_MARKER(6, vVar9, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_351(vVar9, 170, 200), 0, 0, 2, 0, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vVar9, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_351(vVar9, 170, 200), 0, 0, 2, 0, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vVar9, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_351(vVar9, 170, 200), 0, 0, 2, 0, 0, 0, false);
		}
		if (*iParam7 != -1)
		{
	...
	else
	{
		...
		GRAPHICS::DRAW_MARKER(6, vVar4, func_469(vVar6), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_351(vVar4, 25, 200), 0, 0, 2, 0, 0, 0, false);
		if (*iParam7 != *iParam6)
		{
			if (*iParam7 >= 0)
			{
			...
			*iParam4 = GRAPHICS::CREATE_CHECKPOINT(15, vVar4, vVar5, 9f, iVar17, iVar18, iVar19, func_351(vVar9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			if (*iParam6 < (iParam9 - 2))
			{
				*iParam5 = GRAPHICS::CREATE_CHECKPOINT(15, vVar5, func_363(uParam0, *iParam6 + 2), (9f * 0.5f), iVar17, iVar18, iVar19, func_351(vVar9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			}
			*iParam7 = *iParam6;
		}
		if (*iParam6 + 1 == (iParam9 - 1))
		{
			GRAPHICS::DRAW_MARKER(6, vVar5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 4f), (0.5f * 4f), (0.5f * 4f), 240, 200, 80, func_351(vVar5, 170, 200), 0, 0, 2, 0, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vVar5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 9f), (0.5f * 9f), (0.5f * 9f), 240, 200, 80, func_351(vVar5, 170, 200), 0, 0, 2, 0, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vVar5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_351(vVar5, 170, 200), 0, 0, 2, 0, 0, 0, false);
		}
		else
		{
			GRAPHICS::DRAW_MARKER(6, vVar5, func_469(vVar3 - vVar5), 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_351(vVar5, 25, 200), 0, 0, 2, 0, 0, 0, false);
		}
		if (*iParam4 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*iParam4, iVar17, iVar18, iVar19, func_351(vVar4, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
		if (*iParam5 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*iParam5, iVar17, iVar18, iVar19, func_351(vVar5, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
	}
	if (!bParam19)
	{
...
int func_353(var uParam0, int iParam1, var uParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		else if (!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, true), &fVar3, 0, 0))
		{
			return 0;
		}
...
void func_356(int iParam0, bool bParam1)
{
	...
	vVar2 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) };
	fVar4 = VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(*iParam0);
	iVar1 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam0, -1, 0);
	ENTITY::FREEZE_ENTITY_POSITION(*iParam0, false);
	TASK::OPEN_SEQUENCE_TASK(&iVar0);
	if (!bParam1)
	{
		TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, ENTITY::GET_ENTITY_COORDS(*iParam0, true), 4, 0f, 786469, 2f, 0f, 1);
	}
	TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, vVar2 + Vector(5f, 5f, 5f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) + Vector(20f, 0f, 0f), 4, (0.3f * fVar4), 786469, 5f, 10f, 1);
	vVar3 = { Vector(1000f, 1000f, 1000f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) };
	vVar3.z = 200f;
	TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, vVar2 + vVar3, 4, fVar4, 262144, 15f, 10f, 1);
...
void func_429(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	...
	if (iVar0 != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam3, 0) || ENTITY::DOES_ENTITY_EXIST(*iParam3))
		{
			...
			ENTITY::SET_ENTITY_COORDS(*iParam3, func_467(iParam13), 1, false, 0, 1);
	...
	else
	{
		...
		if (func_372(uParam0))
		{
			...
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_467(iParam13), 1, false, 0, 1);
	...
	else if (iVar0 != 0)
	{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(*iParam4, 0))
		{
			...
			ENTITY::SET_ENTITY_COORDS(*iParam4, func_363(uParam0, 0), 1, false, 0, 1);
...
void func_439(var uParam0, var uParam1, int iParam2)
{
	...
	if (iVar0 != 0)
	{
		...
		{
			ENTITY::SET_ENTITY_COORDS(iVar2, func_441(uParam0), 1, false, 0, 1);
...
int func_468(int iParam0)
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		...
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_467(iParam0), 0, false, 0, 1);
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_467(iParam0), 15f, 15f, 15f, false, true, 0))
		{
			return 1;
		}
...
void func_471(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_476(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vVar0, vVar1, 65f, 0, 2), 1);
	}
	else
	{
		CAM::SET_CAM_COORD(func_427(uParam0, 0), vVar0);
		CAM::SET_CAM_ROT(func_427(uParam0, 0), vVar1, 2);
	}
	CAM::SET_CAM_FOV(func_427(uParam0, 0), fVar2);
	CAM::SET_CAM_ACTIVE(func_427(uParam0, 0), true);
	if (bParam3)
	{
		vVar3 = { vVar0 };
		vVar3.z = (vVar3.z + 8f);
		CAM::SET_CAM_PARAMS(func_427(uParam0, 0), vVar3, vVar1, fVar2, func_475(iParam2), 1, 1, 2);
	}
	...
	{
		func_476(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vVar0, vVar1, 65f, 0, 2), 1);
	}
	else
	{
		CAM::SET_CAM_COORD(func_427(uParam0, 1), vVar0);
		CAM::SET_CAM_ROT(func_427(uParam0, 1), vVar1, 2);
	}
	CAM::SET_CAM_FOV(func_427(uParam0, 1), fVar2);
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_505(var uParam0)
{
	...
	func_512(&uVar1, &uVar2, &iVar3, &iVar4, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::_IS_INPUT_DISABLED(2));
