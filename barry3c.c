#region Local Var
	...
	int iLocal_307 = 0;
	vector3 vLocal_308[9] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
	int iLocal_309 = 0;
...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_491(49);
	vLocal_107 = { -0.1f, -0.85f, 0.23f };
	vLocal_108 = { 8f, 0.5f, 0f };
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_79.f_35[0], 0))
		{
			VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_79.f_35[0], true, 0);
			func_468(&(Local_97.f_4), &(Local_79.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_97.f_4, true, 1);
			func_467(Local_97.f_4, 0);
		}
	}
	func_466(&iLocal_106, &(Local_79.f_41[0]));
	func_452();
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[1]))
	{
		func_468(&(Local_117[6 /*7*/].f_4), &(Local_79.f_35[1]));
	}
	if (func_451())
	{
		iVar0 = func_450();
	...
	while (true)
	{
		...
		func_398(Local_79.f_9, 0, 0, 0, 0, 0);
		if (iLocal_94 == 13)
		{
			func_379();
		}
		...
		{
			func_377();
			func_372(&uLocal_81, &uLocal_121, "BAR3CAU", &sLocal_82, &cLocal_88);
			switch (iLocal_94)
			{
				case 0:
					func_371();
...
void func_1()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, true, 0))
			{
				iLocal_95 = 2;
			}
			else
...
int func_4()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_114) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_114, 0))
	{
		return 1;
	}
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_415(iVar0))
		{
			...
			if ((((iVar1 == joaat("TOWTRUCK") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("CARGOBOB")) || iVar1 == joaat("CARGOBOB2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_120 <= 7)
				{
					if (func_415(Local_117[iLocal_120 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, 0))
					{
						bVar2 = true;
						Local_117[iLocal_120 /*7*/].f_6 = 1;
						func_468(&iLocal_114, &(Local_117[iLocal_120 /*7*/].f_4));
					}
					iLocal_120++;
				}
				if (!bVar2)
...
void func_5(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_120 <= 7)
		{
			func_10(&(Local_117[iLocal_120 /*7*/].f_4));
			iLocal_120++;
		}
	}
	else
	{
		...
		while (iLocal_120 <= 7)
		{
			...
			{
				if (!func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 175f) && func_8(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_117[iLocal_120 /*7*/].f_4));
				}
			}
			else if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 100f))
			{
				...
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_117[iLocal_120 /*7*/].f_4, 1084227584);
...
bool func_9(int iParam0, vector3 vParam1, float fParam2)
{
...
{
	vLocal_308[iParam0 /*3*/].f_1 = iParam1;
}

void func_12(int iParam0)
{
	if (vLocal_308[iParam0 /*3*/].f_1 < vLocal_308[iParam0 /*3*/] || vLocal_308[iParam0 /*3*/] == -1)
	{
		func_14(vLocal_308[iParam0 /*3*/].f_2, 7500, 1);
		func_13(&uLocal_81);
		vLocal_308[iParam0 /*3*/].f_1++;
	}
}
...
void func_17()
{
	if (!iLocal_298)
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 0))
		{
			iLocal_298 = 1;
			bLocal_297 = false;
			iLocal_294 = 0;
		...
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 1))
		{
			func_18();
		}
	}
			...
			switch (iLocal_294)
			{
				case 0:
					...
					else
					{
						...
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_97.f_4, -1, 0) == PLAYER::PLAYER_PED_ID())
							{
								iLocal_294 = 1;
							}
						}
				...
				case 2:
					...
					TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
...
void func_19()
{
	...
	switch (iLocal_95)
	{
		case 0:
			...
			func_47(&iLocal_96);
			if (func_415(iLocal_114))
			{
				iLocal_96 = func_46(Local_97.f_4, 1, 5);
		...
		case 1:
			func_20();
			if (iLocal_307 && !func_415(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, false, 0) && !ENTITY::IS_ENTITY_IN_AIR(Local_97.f_4))
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(Local_97.f_4, true) };
				if (vVar0.z < 6.7f)
				{
					iLocal_94 = 12;
					iLocal_95 = 0;
...
void func_20()
{
	switch (iLocal_301)
	{
		case 0:
			...
			if (func_44())
			{
				if (func_21(&uLocal_121, "BAR3CAU", sLocal_302[iLocal_303], 7, 1, 0, 0))
				{
					iLocal_301 = 1;
				}
			}
			else if (func_21(&uLocal_121, "BAR3CAU", sLocal_302[iLocal_303], 7, 0, 0, 0))
			{
				iLocal_301 = 1;
			}
			break;
...
void func_34()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_39(14) || Global_110511))
			{
...
int func_44()
{
	...
	while (iLocal_120 <= 8)
	{
		if (func_45(vLocal_308[iLocal_120 /*3*/].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_120++;
...
void func_48()
{
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_415(iLocal_114))
			{
				iLocal_96 = func_46(iLocal_114, 1, 5);
				HUD::SET_BLIP_ROUTE(iLocal_96, true);
		...
		case 1:
			...
			else if (iLocal_307 && !func_415(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, true, 0))
					{
						iLocal_94 = 6;
					}
					else
...
void func_49()
{
	...
	switch (iLocal_95)
	{
		...
		case 2:
			HUD::CLEAR_PRINTS();
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_114, 0))
			{
				iLocal_94 = 8;
			}
			else if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_114, Local_97.f_4))
...
{
	HUD::CLEAR_THIS_PRINT(vLocal_308[iParam0 /*3*/].f_2);
}
...
void func_51()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, true, 0))
			{
				if (!func_248(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 150f, 1) && !func_15())
				{
					iLocal_95 = 2;
				}
...
void func_53(int iParam0, bool bParam1)
{
	...
	{
		func_214(&(Global_110647[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_56()
{
	...
	{
		func_58(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76389[1 /*14*/] = { func_132(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar6 = { func_128(iVar0, 0) };
		Global_76389[1 /*14*/] = { func_132(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_124(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
	if (func_123(iParam0, iVar0, &iVar7, 0))
	{
...
int func_82(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_196(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_132(iVar10, iParam1, iParam2, -1) };
		if (!func_122(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_132(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_125(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_132(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_115(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_132(iVar10, iVar0, func_90(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_132(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_132(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_132(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_132(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_132(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_125(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_132(iVar10, 14, uVar15[iVar1], -1) };
			func_100(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_115(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
{
	Global_76389[1 /*14*/] = { func_132(iParam0, iParam1, iParam2, -1) };
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar7 = 0;
		iVar8 = (iParam1 - func_103(iParam0, func_124(iParam2)));
		if (iVar8 < 0)
		{
			return -1;
		}
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_103(iParam0, func_124(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
...
void func_115(int iParam0)
{
	...
	{
		func_121(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_118(iParam2)];
	if (iVar0 != 0)
	{
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_196(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_131(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_131(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_131(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_130(vVar2.z)] = vVar2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_130(vVar2.z)] = func_107(iParam1, vVar2.x, func_130(vVar2.z), iVar0);
					}
				}
				else if (vVar2.y != -1)
				{
					(*uParam0)[func_130(vVar2.z)] = vVar2.y;
				}
			}
			iVar4++;
		}
...
void func_134(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_141(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_135(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_119(func_138(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_119(func_137(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_119(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_124(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_196(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_196(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_125(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_196(iParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_132(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_196(iParam0, 14, iVar4))
										{
											if (!func_88(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_132(iVar0, iVar2, iVar1, -1) };
						if (!func_88(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar8 = { func_125(iVar0, iParam2) };
		iVar7 = 0;
		while (iVar7 <= 8)
		{
			if (!func_196(iParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_124(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_124(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_202(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1 == 1)
	{
		func_203(iParam0, iParam2, iParam3);
	}
...
void func_203(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_200(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_98706, 0);
		func_204(&sVar1, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_204(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_209()
{
	...
	{
		func_34();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_210(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
...
{
	func_219(iParam0, 1);
	Global_111560.f_18569[iParam0 /*6*/].f_3 = func_218();
...
void func_247(bool bParam0)
{
	if (bParam0)
	{
		...
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_97.f_4, 1);
	}
	else
	{
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_97.f_4, true, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_97.f_4, 0);
	}
}
...
void func_249()
{
	...
	{
		if (func_326(&uLocal_121, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
...
void func_250(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_245(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_111560.f_18569[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_200(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_98706, iParam0);
			}
			else
			{
				iVar6 = func_320(&(Global_98669.f_3));
				if (iVar6 > -1)
				{
...
{
	func_252(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_271(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_118(iParam1)];
...
void func_275(int iParam0, bool bParam1)
{
	...
	if (func_35(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_276(iParam0, &(Global_111560.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_276(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_278(Var7.f_1)) && iVar9 < 51)
			{
...
int func_284(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
bool func_286(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_292(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_307(iVar0))
		{
			if (!bParam3 || func_306(iVar0))
			{
...
Vector3 func_293(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_303(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_27())
			{
				if (func_302(Global_1590285))
				{
					return func_295(2, 2);
				}
				else if (func_294(Global_1590285))
				{
...
int func_296(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_301(iParam1, &vVar1))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var2 = { func_299(iParam0) };
	}
	else
	{
		Var2 = { func_298(iParam0) };
	}
	vVar3 = { Var2 - Var0 };
	vVar3 = { func_297(vVar3, -Var0.f_3.f_2) };
	vVar3 = { func_297(vVar3, vVar1.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar1, 0f, vVar3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_297(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
void func_327()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_114, 0))
			{
				iLocal_95 = 2;
			}
			else if (func_2())
			{
				...
				else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, true, 0))
				{
					iLocal_94 = 10;
					iLocal_95 = 0;
				}
...
void func_331()
{
	...
	switch (iLocal_95)
	{
		case 0:
			func_47(&iLocal_96);
			iLocal_96 = func_332(vLocal_112, 5, 1);
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, false, 0))
					{
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 1, true, 0))
			{
				iLocal_95 = 2;
			}
			else if (iLocal_309)
		...
		case 2:
			...
			{
				if (func_3() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, false, 0))
				{
					if (!ENTITY::IS_ENTITY_IN_AIR(Local_97.f_4))
					{
						vVar0 = { ENTITY::GET_ENTITY_COORDS(Local_97.f_4, true) };
...
int func_332(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_333()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (((!iLocal_289 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f, 22f, 17.5f, 0, true, 0)) && !func_2()) && !func_3())
			{
				func_330("B3CTTHB", -1);
				iLocal_289 = 1;
			}
...
{
	if (vLocal_308[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		vLocal_308[iParam0 /*3*/].f_1 = vLocal_308[iParam0 /*3*/];
	}
}
	...
	switch (iLocal_95)
	{
		case 0:
			...
			else
			{
				...
				{
					if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_MUTT", 7, 0, 0, 0))
					{
						iLocal_286 = 1;
					}
				}
				else if (!iLocal_287 && (MISC::GET_GAME_TIMER() - iLocal_292) > 120000)
				{
					if (!func_338())
					{
						if (func_337(&uLocal_121, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_287 = 1;
						}
					}
				...
				{
					if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_TOW", 7, 0, 0, 0))
					{
						iLocal_288 = 1;
					}
				}
		...
		case 1:
			if (iLocal_118)
			{
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -417.58f, -1723.81f, 15.42f, -473.6f, -1705.96f, 26.95f, 49f, 0, true, 0))
				{
					iLocal_95 = 2;
				}
				else if (func_2())
...
int func_338()
{
	...
	while (iLocal_120 <= 7)
	{
		if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 8f))
		{
			return 1;
		}
		iLocal_120++;
...
void func_340(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_367(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_364(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_341(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_341(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_360(iParam3, &Var0, vParam1, fParam2, func_259(iParam0));
		func_342(iParam3, iParam0, 0);
	}
}
...
void func_342(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_359(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_309();
			}
...
void func_343(int iParam0, int iParam1)
{
	...
	func_263(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_344(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_259(iParam0) != 145) || func_358(iParam0)) || func_357(iParam0)) || func_356(iParam0)) || func_355(iParam0)) || !func_345(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_357(iParam0))
		{
		}
...
int func_359(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_286(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_286(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_286(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_360(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_359(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_362(iParam0);
			func_361(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_364(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_365(vParam0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_365(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_368()
{
	switch (iLocal_95)
	{
		case 0:
			iLocal_298 = 0;
			bLocal_297 = false;
			if (func_326(&uLocal_121, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_95 = 1;
			}
			break;
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			switch (iLocal_294)
			{
				...
				case 2:
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_97.f_4, -1, 0) == PLAYER::PLAYER_PED_ID() && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4))
					{
						if (iLocal_295 == 3)
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_300);
							TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_300);
							TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_300);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_300);
						...
						{
							if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_300);
								TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_295 * 250), 9, 0, 0, 0, 0);
								TASK::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_300);
								TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_300);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_300);
				...
				case 4:
					if (MISC::GET_GAME_TIMER() > iLocal_291)
					{
						...
						else
						{
							...
							if (iLocal_295 == 4)
							{
								TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_299, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
				...
				case 5:
					if (MISC::GET_GAME_TIMER() > iLocal_291)
					{
						VEHICLE::START_VEHICLE_HORN(Local_97.f_4, 500, MISC::GET_HASH_KEY("NORMAL"), 0);
						iLocal_291 = MISC::GET_GAME_TIMER() + 2000;
						iLocal_294 = 8;
					}
					break;
				...
				case 6:
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4))
					{
						if (!func_15())
						{
							if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_C2", 7, 0, 0, 0))
							{
		...
		case 2:
			if (!func_15() && (MISC::GET_GAME_TIMER() - iLocal_291) > 2500)
			{
				iLocal_95 = 0;
				iLocal_94 = 2;
			}
...
int func_378()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_97.f_4, 0))
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_114))
	{
		if (ENTITY::IS_ENTITY_DEAD(iLocal_114, 0) && iLocal_307 == 0)
		{
			if (func_3())
			{
...
void func_379()
{
	switch (iLocal_95)
	{
		case 0:
			...
			if (MISC::ARE_STRINGS_EQUAL(sLocal_310, "DEFAULT"))
			{
				func_471(1);
			}
			else
			{
				func_396(sLocal_310, 1);
			}
			iLocal_95 = 1;
			break;
		...
		case 1:
			if (func_395())
			{
				if ((func_415(Local_97.f_4) && func_415(iLocal_114)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_97.f_4, iLocal_114))
				{
...
void func_398(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_400(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_401(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_412(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_414(iParam0, Global_41396);
}
...
void func_420(vector3 vParam0, float fParam1, bool bParam2)
{
	if (func_415(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam2)
	...
	iLocal_114 = VEHICLE::CREATE_VEHICLE(iLocal_115, vParam0, fParam1, true, true, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_115);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_114, iLocal_116);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_114, 1084227584);
	if (bParam2)
	{
		func_421(PLAYER::PLAYER_PED_ID(), iLocal_114, -1);
	}
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_114, 0))
	{
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_114);
		iLocal_102 = 1;
	}
...
void func_423(vector3 vParam0, float fParam1)
{
	...
	func_246(&iLocal_106);
	func_6(&(Local_97.f_4));
	Local_97.f_4 = VEHICLE::CREATE_VEHICLE(Local_97.f_5, vParam0, fParam1, true, true, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_97.f_5);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_97.f_4, 1084227584);
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_97.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_97.f_4, false);
	...
	iLocal_106 = OBJECT::CREATE_OBJECT(iLocal_109, vParam0 + vLocal_107, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_106, Local_97.f_4, 0, vLocal_107, vLocal_108, 0, 0, 0, 0, 2, 1);
}
...
void func_432(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_451())
	{
...
bool func_434()
{
	return func_435(&(Global_105109.f_2890));
}
...
void func_438(bool bParam0)
{
	if (bParam0)
	{
		...
		func_432(Local_97, Local_97.f_3, 1, 0);
	}
	if (iLocal_115 == joaat("TOWTRUCK"))
	{
		vLocal_311 = { -462.0807f, -1711.68f, 17.6454f };
		fLocal_312 = 277.92f;
	}
	else if (iLocal_115 == joaat("towtruck2"))
	{
		vLocal_311 = { -463.5672f, -1712.284f, 17.6392f };
		fLocal_312 = 272.29f;
	}
	else if ((iLocal_115 == joaat("CARGOBOB") || iLocal_115 == joaat("CARGOBOB2")) || iLocal_115 == joaat("cargobob3"))
	{
		vLocal_311 = { -455.4628f, -1712.282f, 17.642f };
		fLocal_312 = 0.7f;
	}
	if (bParam0)
	{
		func_432(vLocal_311, fLocal_312, 1, 0);
	}
	else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 0))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_97, 1, false, 0, 1);
	}
	func_425();
	func_424();
	func_47(&iLocal_96);
	...
	func_11(7, 0);
	func_11(7, 0);
	func_423(Local_97, Local_97.f_3);
	if (bParam0)
	{
		func_420(vLocal_311, fLocal_312, 0);
		if (func_415(iLocal_114) && iLocal_115 == joaat("TOWTRUCK"))
		{
	...
	{
		func_420(vLocal_311, fLocal_312, 1);
		if (func_415(iLocal_114) && iLocal_115 == joaat("TOWTRUCK"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_114, 0f);
		}
...
void func_441(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_447(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_452()
{
	...
	vLocal_112 = { -1152.43f, -1238.824f, 5.9752f };
	iLocal_80 = func_465();
	iLocal_113[0] = PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_113[1] = PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
	Local_97.f_5 = joaat("EMPEROR2");
	Local_97 = { -468.9f, -1713.06f, 18.21f };
	Local_97.f_3 = -76.2f;
	Local_117[0 /*7*/] = { func_464(-552.67f, -1698.84f, 18.16f, 205.7f) };
	Local_117[1 /*7*/] = { func_464(-317.14f, -1540.72f, 26.67f, 336.5f) };
	Local_117[2 /*7*/] = { func_464(-104.41f, -1984.91f, 17.02f, 171.6f) };
	Local_117[3 /*7*/] = { func_464(-586.69f, -1774.59f, 21.67f, 145.8f) };
	Local_117[4 /*7*/] = { func_464(-1207.9f, -1334.87f, 3.77f, 204.1f) };
	Local_117[5 /*7*/] = { func_464(-1253.67f, -1210.3f, 6.03f, 10.7f) };
	Local_117[6 /*7*/] = { func_464(-426.56f, -1717.89f, 18.2f, 43.5f) };
	Local_117[7 /*7*/] = { func_464(401.64f, -1633.3f, 28.29f, 231.5f) };
	if (func_415(Local_97.f_4))
	{
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_97.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_97.f_4, false);
	...
	if (func_415(PLAYER::PLAYER_PED_ID()))
	{
		func_463(&uLocal_121, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_463(&uLocal_121, 3, 0, "BARRY", 0, 1);
	iLocal_289 = 0;
	func_461();
	sLocal_310 = "DEFAULT";
	iLocal_303 = 0;
...
void func_461()
{
	vLocal_308[0 /*3*/] = { func_462("B3CENTV", 1) };
	vLocal_308[1 /*3*/] = { func_462("B3CDELV", 1) };
	vLocal_308[2 /*3*/] = { func_462("B3CWAN1", -1) };
	vLocal_308[3 /*3*/] = { func_462("B3CNOGO", 1) };
	vLocal_308[4 /*3*/] = { func_462("B3CREVRS", 1) };
	vLocal_308[5 /*3*/] = { func_462("B3CLEAVE", 1) };
	vLocal_308[6 /*3*/] = { func_462("B3CRTTT", 1) };
	vLocal_308[7 /*3*/] = { func_462("B3CGBTB", 1) };
	vLocal_308[8 /*3*/] = { func_462("B3CRTCB", 1) };
}
...
struct<7> func_464(vector3 vParam0, float fParam1)
{
	struct<7> Var0;
...
void func_469()
{
	...
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_381(&Local_79, 1, 0, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_80, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_113[0], 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_113[1], 0);
...
int func_473(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_476())
	{
		...
		{
			iVar2 = func_320(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_474()
{
	...
	iVar0 = func_323(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_476()
{
	...
	{
		if (func_320(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
