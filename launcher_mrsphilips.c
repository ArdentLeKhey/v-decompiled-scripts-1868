...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_259(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_246(&Var0, 1);
	}
	...
	func_231(&Var0);
	iLocal_52 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar1 - Vector(20f, 20f, 20f), vVar1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (*iParam0 == 1)
	{
		if (func_244((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
...
int func_244(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	if (func_245(Var1.f_6, vParam1, fParam2, 0))
	{
