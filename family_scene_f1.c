...
void __EntryFunction__()
{
	...
	SYSTEM::WAIT(0);
	func_53(ScriptParam_320);
	func_51();
	while (iLocal_85)
	{
		SYSTEM::WAIT(0);
		iLocal_85 = 0;
		if (func_45(1, vLocal_114, 1.5f))
		{
			func_36(&uLocal_143, &iLocal_144, &uLocal_147, &uLocal_148, vLocal_114, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_96177[iVar0]))
			{
	...
	if (Global_93722 != 8)
	{
		if (Global_93723 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_93723 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_110511))
			{
...
int func_28(int iParam0)
{
	if (func_29(iParam0))
	{
		if ((Global_111560.f_9080 || Global_3) || func_5(0))
		{
...
void func_36(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)
{
	int iVar0;
	vector3 vVar1;
	...
	else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam5))
		{
			...
			{
				*uParam3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam4, sParam5);
			}
		}
		func_38(iParam1);
		*uParam0 = 0;
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			{
				if (!Global_111560.f_18509.f_17)
				{
					func_37("FAM_WEAPDIS", -1);
					Global_111560.f_18509.f_17 = 1;
				}
				*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam5))
				{
...
int func_45(int iParam0, vector3 vParam1, float fParam2)
{
	if (!func_46(iParam0))
	{
		return 0;
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_98719)
...
int func_46(int iParam0)
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_111550)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!MISC::IS_BIT_SET(Global_111560.f_9080.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
{
	return func_50(iParam0, Global_41396);
}
...
void func_51()
{
	...
	func_52(&uLocal_153, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_54()
{
	...
	func_60(&uLocal_318, &uLocal_98, &uLocal_86, &uLocal_100, &uLocal_102, &uLocal_88, &uLocal_90, &uLocal_122, &uLocal_124, &uLocal_126);
	iVar0 = 0;
	while (iVar0 < 1)
	{
		iVar1 = func_59(iVar0);
		if (iVar1 < 15)
		{
			if (Global_93705[iVar1] != 141)
			{
				func_58(iVar1);
				Global_93705[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)
{
	...
	while (iVar1 < Global_111560.f_7683.f_198)
	{
		...
		{
			func_66(Global_111560.f_7683.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
{
	Global_30796[iParam0 /*11*/].f_10 = iParam1;
}
...
int func_78()
{
	...
	while (iVar6 < 11)
	{
		func_80(iVar6, &iVar0, &vVar1, &iVar2, &iVar3, &cVar4, &iVar5);
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar1, 10f, iVar0, 0))
		{
			iVar7 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar1, 10f, iVar0, 0, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(iVar7))
			{
				if (iVar3 == 825812850)
				{
					ENTITY::SET_ENTITY_ROTATION(iVar7, 0f, 0f, 21f, 2, 1);
				}
