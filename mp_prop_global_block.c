...
void __EntryFunction__()
{
	...
	while (iVar0 < 127)
	{
		func_1(&(Global_1049852[iVar0 /*1951*/]), iVar0);
		iVar0++;
	}
}
...
int func_34(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_43())
	{
		...
		{
			iVar4 = NETSHOPPING::NET_GAMESERVER_GET_PRICE(iVar3, 426439576, 1);
	...
	switch (iParam0)
	{
		...
		case 102:
			return Global_262145.f_17507;
		
		case 103:
			return Global_262145.f_19171;
		
		case 104:
			return Global_262145.f_19064;
		
		case 105:
			return Global_262145.f_19065;
