...
void func_1()
{
	...
	if (func_109(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			{
				iLocal_49 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				func_125(1);
				func_13(0);
				if (func_109(PLAYER::PLAYER_PED_ID()))
				{
					if (func_11(&Local_42, &Local_48, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iLocal_54))
					{
						func_8();
					}
				}
...
void func_53(int iParam0, int iParam1)
{
	...
	iVar0 = (iVar0 + iParam1);
	STATS::STAT_SET_INT(func_54(iParam0, 1), iVar0, 1);
}
...
void func_59(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_61() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_61() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_62(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_63(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_65(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_61() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_66(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_63(iParam1)];
...
int func_85(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_111560.f_10044.f_108, func_87(func_88(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
