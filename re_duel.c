...
void __EntryFunction__()
{
	...
	if (func_156(vLocal_50, 31, 0, 0, 0))
	{
		func_153(31);
	}
	else
		...
		case 1:
			switch (iLocal_65)
			{
				...
				case 7:
					...
					{
						func_105(5, vLocal_49, -1082130432, 0);
						func_105(6, vLocal_49, -1082130432, 0);
						func_105(7, vLocal_49, -1082130432, 0);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_78);
						func_81(2, 0, vLocal_49, -1082130432);
						func_81(3, 0, vLocal_49, -1082130432);
						func_81(4, 0, vLocal_49, -1082130432);
						func_81(5, 0, vLocal_49, -1082130432);
						func_81(6, 0, vLocal_49, -1082130432);
						func_81(7, 0, vLocal_49, -1082130432);
				...
				case 8:
					...
					if (SYSTEM::TIMERA() > 20000 && func_80(PLAYER::PLAYER_PED_ID(), vLocal_51, 1) >= 150f)
					{
						iLocal_65++;
					}
					break;
				...
				case 9:
					if (func_94() || (func_225(Local_48[0 /*4*/]) && func_79(PLAYER::PLAYER_PED_ID(), Local_48[0 /*4*/], 1) <= 35f))
					{
						...
						if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vVar1, iVar5, &vVar2, 1, 5f, 0f))
						{
							...
							if (((uVar8 & 4 == 0 && (!func_78() || uVar8 & 8 == 0)) && (func_77() || uVar8 & 1 == 0)) && !func_76(vVar2, 1084227584))
							{
								fVar6 = func_75(vVar2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
								...
								if ((((!CAM::IS_SPHERE_VISIBLE(vVar2, 7f) && !CAM::IS_SPHERE_VISIBLE(vVar3, 7f)) && !CAM::IS_SPHERE_VISIBLE(vVar4, 7f)) && !func_76(vVar3, 1084227584)) && !func_76(vVar4, 1084227584))
								{
									func_74(Local_48[5 /*4*/], vVar2);
									func_74(Local_48[6 /*4*/], vVar3);
									func_74(Local_48[7 /*4*/], vVar4);
...
void func_62(int iParam0, int iParam1, var uParam2)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
	{
		if ((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && Local_48[iParam0 /*4*/] != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && func_68(Local_48[iParam0 /*4*/]))
		{
			...
			if (func_80(iParam1, vLocal_55, 1) >= fVar0 && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1))
			{
				vLocal_57 = { vLocal_55 };
				fLocal_58 = fLocal_56;
			...
			else if (((((((((((MISC::GET_GAME_TIMER() - *uParam2) > iVar2 && (MISC::GET_GAME_TIMER() - iLocal_59) > 1500) && func_79(Local_48[iParam0 /*4*/], iParam1, 1) > func_80(iParam1, vLocal_57, 1)) && func_67(iParam0)) && func_80(iParam1, vLocal_57, 1) >= fVar0) && func_79(Local_48[iParam0 /*4*/], iParam1, 1) >= fVar1) && func_66(Local_48[iParam0 /*4*/], vLocal_57, 1153138688)) && func_65(Local_48[iParam0 /*4*/], iParam1, vLocal_57)) && !func_64(vLocal_57)) && !CAM::IS_SPHERE_VISIBLE(vLocal_57, 4f)) && !func_76(vLocal_57, 1084227584))
			{
...
int func_66(int iParam0, vector3 vParam1, float fParam2)
{
	if (func_80(iParam0, vParam1, 1) <= fParam2)
	{
		return 1;
	}
	if (iParam0 == Local_48[3 /*4*/] && !HUD::DOES_BLIP_EXIST(Local_47[0 /*5*/].f_1))
...
float func_75(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}

int func_76(vector3 vParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
float func_80(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_81(int iParam0, bool bParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	float fVar1;
	int iVar2;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*5*/]))
	{
		...
		if (!func_85(vParam2, vLocal_49, 0))
		{
		...
		else
		{
			...
			ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Local_47[iParam0 /*5*/], !bVar59, 0);
		}
		if (bVar34)
		{
		...
		{
			TASK::TASK_START_SCENARIO_IN_PLACE(Local_47[iParam0 /*5*/], sVar65, -1, 0);
		}
		if (iVar11 > 0)
		{
...
bool func_85(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_86()
{
	...
	if ((func_225(Local_47[0 /*5*/]) && (PED::IS_PED_IN_COMBAT(Local_47[0 /*5*/], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(Local_47[0 /*5*/], 0))) || (func_225(Local_47[1 /*5*/]) && (PED::IS_PED_IN_COMBAT(Local_47[1 /*5*/], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(Local_47[1 /*5*/], 0))))
	{
		return 1;
	}
	if ((func_225(Local_48[1 /*4*/]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_48[1 /*4*/], PLAYER::PLAYER_PED_ID(), 1)) || (func_225(Local_48[2 /*4*/]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_48[2 /*4*/], PLAYER::PLAYER_PED_ID(), 1)))
	{
		return 1;
	}
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_225(Local_48[iParam2 /*4*/]))
	{
		...
		if (func_225(Local_47[iParam3 /*5*/]))
		{
			...
			TASK::TASK_VEHICLE_MISSION(Local_47[iParam3 /*5*/], Local_48[iParam2 /*4*/], Local_48[0 /*4*/], 2, 30f, 262144, -1f, -1f, 1);
		}
...
int func_93(vector3 vParam0, float fParam1)
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
bool func_94()
{
	return (func_225(Local_48[0 /*4*/]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_48[0 /*4*/], 0));
}
...
int func_105(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	vector3 vVar0;
	float fVar1;
	int iVar2;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_48[iParam0 /*4*/]))
	{
		...
		if (!func_85(vParam1, vLocal_49, 0))
		{
			vVar0 = { vParam1 };
		}
		if (fParam2 != -1f)
		...
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_48[iParam0 /*4*/], iVar15);
		...
		ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Local_48[iParam0 /*4*/], !bVar20, 0);
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_115(iParam2)];
	if (iVar0 != 0)
	{
...
int func_116(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_115(iParam1)];
...
void func_121()
{
	...
	if (func_152(6))
	{
		if (iLocal_68 == 0)
		{
			if (func_80(PLAYER::PLAYER_PED_ID(), vLocal_51, 1) >= 150f)
			{
	...
	if ((func_152(9) && func_225(Local_48[0 /*4*/])) && func_79(PLAYER::PLAYER_PED_ID(), Local_48[0 /*4*/], 1) <= 35f)
	{
		if (!func_152(10))
		{
			...
			{
				if (((MISC::GET_GAME_TIMER() - iLocal_72) >= 1000 && !func_76(vLocal_52, 7f)) && func_80(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) >= 50f)
				{
					MISC::CLEAR_AREA(vLocal_52, 7f, 1, 0, 0, false);
					func_105(3, vLocal_49, -1082130432, 0);
					func_105(1, vLocal_49, -1082130432, 0);
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(Local_48[3 /*4*/], Local_48[1 /*4*/], 1065353216);
					func_81(0, 0, vLocal_49, -1082130432);
					func_109(10);
					if (iLocal_65 > 2)
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[0 /*5*/], false);
		...
		if (!func_152(11))
		{
			...
			{
				if (((MISC::GET_GAME_TIMER() - iLocal_73) >= 1000 && !func_76(vLocal_53, 7f)) && func_80(PLAYER::PLAYER_PED_ID(), vLocal_53, 1) >= 50f)
				{
					MISC::CLEAR_AREA(vLocal_53, 7f, 1, 0, 0, false);
					func_105(4, vLocal_49, -1082130432, 0);
					func_105(2, vLocal_49, -1082130432, 0);
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(Local_48[4 /*4*/], Local_48[2 /*4*/], 1065353216);
					func_81(1, 0, vLocal_49, -1082130432);
					func_109(11);
					if (iLocal_65 > 2)
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[1 /*5*/], false);
...
void func_128(int iParam0)
{
	if (func_225(Local_48[iParam0 /*4*/]))
	{
		...
		{
			case 5:
				if ((!func_225(Local_47[2 /*5*/]) && !func_225(Local_47[3 /*5*/])) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
				{
					func_129(iParam0, 0);
				}
				break;
			...
			case 6:
				if ((!func_225(Local_47[4 /*5*/]) && !func_225(Local_47[5 /*5*/])) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
				{
					func_129(iParam0, 0);
				}
				break;
			...
			case 7:
				if ((!func_225(Local_47[6 /*5*/]) && !func_225(Local_47[7 /*5*/])) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
				{
					func_129(iParam0, 0);
				}
				break;
			...
			case 3:
				if (!func_225(Local_47[0 /*5*/]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
				{
			...
			case 4:
				if (!func_225(Local_47[1 /*5*/]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
				{
					if (func_79(PLAYER::PLAYER_PED_ID(), Local_48[iParam0 /*4*/], 1) >= 50f)
					{
						func_129(iParam0, 0);
				...
				switch (Local_47[iParam0 /*5*/].f_3)
				{
					...
					case 1:
						if (func_225(Local_48[iVar0 /*4*/]))
						{
							...
							{
								if ((((((MISC::GET_GAME_TIMER() >= iLocal_71 && !func_152(12)) && !ENTITY::IS_ENTITY_AT_COORD(Local_48[iVar0 /*4*/], vLocal_54, 7f, 7f, 7f, false, true, 0)) && func_80(PLAYER::PLAYER_PED_ID(), vLocal_54, 1) < func_79(Local_48[iVar0 /*4*/], PLAYER::PLAYER_PED_ID(), 1)) && !CAM::IS_SPHERE_VISIBLE(vLocal_54, 7f)) && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_48[iVar0 /*4*/], true), 7f)) && !func_76(vLocal_54, 8f))
								{
									fVar3 = func_75(vLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
								...
								if (!func_152(12) && ENTITY::IS_ENTITY_AT_COORD(Local_48[iVar0 /*4*/], vLocal_54, 7f, 7f, 7f, false, true, 0))
								{
									func_109(12);
								}
					...
					case 3:
						...
						{
							if (!PED::IS_PED_IN_ANY_VEHICLE(Local_47[iParam0 /*5*/], 0) && func_79(Local_47[iParam0 /*5*/], PLAYER::PLAYER_PED_ID(), 1) >= 250f)
							{
								func_134(iParam0, 0);
							}
						}
...
void func_134(int iParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*5*/]))
	{
		...
		if ((((func_225(Local_47[iParam0 /*5*/]) && ENTITY::IS_ENTITY_ATTACHED(Local_47[iParam0 /*5*/])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_47[iParam0 /*5*/], 1)) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_47[iParam0 /*5*/])) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(Local_47[iParam0 /*5*/]))
		{
...
void func_141(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_156(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_193(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
