...
void __EntryFunction__()
{
	...
	vLocal_333 = { -11.3259f, -1441.471f, 30.5788f };
	vLocal_334 = { -0.025f, 0.13f, 0f };
	vLocal_335 = { -0.025f, 0.12f, 0f };
	vLocal_336 = { 0f, 90f, 0f };
	vLocal_337 = { -10.1f, -1440.7f, 31.1f };
	vLocal_338 = { -4f, 0f, 121.2f };
	fLocal_339 = 31f;
	vLocal_340 = { -12.1f, -1440.7f, 31.3f };
	vLocal_341 = { -5.3f, 0f, -117.8f };
	fLocal_342 = 40f;
	vLocal_343 = { -10.1f, -1438.5f, 31.5f };
	vLocal_344 = { 0.3f, 0f, 159f };
	fLocal_345 = 50f;
	vLocal_346 = { -9.4f, -1439.6f, 30.9f };
	vLocal_347 = { 2.3f, 0f, 142.8f };
	fLocal_348 = 25.9f;
	...
	vLocal_332 = { ScriptParam_349.f_1[0 /*3*/] };
	vLocal_332 = { -11.3888f, -1441.325f, 30.1f };
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_332, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				if (iLocal_51)
				{
...
void func_22()
{
	...
	{
		case 0:
			if (((func_89(vLocal_332, vVar0) && !func_88()) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), vLocal_333, 90f)) && func_87())
			{
				func_86("TV_HLP0");
			...
			if (func_85(1, 0, 1))
			{
				if (func_89(vLocal_332, vVar0))
				{
					if (((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_CONTROL_PRESSED(2, 51)) && func_87())
					{
						...
						MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_333, 3f, 0);
		...
		case 2:
			...
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				iLocal_323 = CAM::CREATE_CAMERA(26379945, 0);
				if (Global_30796[0 /*11*/].f_2)
				{
					CAM::SET_CAM_PARAMS(iLocal_323, vLocal_340, vLocal_341, fLocal_342, 0, 1, 1, 2);
				...
				{
					CAM::SET_CAM_PARAMS(iLocal_323, vLocal_337, vLocal_338, fLocal_339, 0, 1, 1, 2);
				}
			}
			else
			{
			...
			if (func_73(iLocal_323))
			{
				CAM::SET_CAM_ACTIVE(iLocal_323, true);
				CAM::SHAKE_CAM(iLocal_323, "HAND_SHAKE", (0.2f / 3f));
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
			}
			iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "enter", 1000f, -4f, 0, 0, 1148846080, 0);
			if (func_73(iLocal_323))
			{
				PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_326, 0.278f);
			}
			else
			{
				PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_326, 0f);
			}
			if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
			}
		...
		case 3:
			...
			if (func_73(iLocal_323))
			{
				if (Global_30796[0 /*11*/].f_2)
				{
					func_69(iLocal_323, vLocal_341);
				}
				else
				{
					func_69(iLocal_323, vLocal_338);
				}
			}
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_326))
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				if (!Global_30796[0 /*11*/].f_2)
				{
					func_67();
					TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "base", 4f, -8f, 64, 0, 1148846080, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "base_remote", sLocal_331, 4f, -8f, 64, 1148846080);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_326, true);
				}
				else
				{
					TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_enter", 4f, -8f, 0, 0, 1148846080, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_enter_remote", sLocal_331, 4f, -8f, 0, 1148846080);
					if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
					{
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
					}
		...
		case 4:
			...
			else
			{
				...
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.2f)
				{
					if (!func_84("TV_HLP4"))
					{
						func_86("TV_HLP4");
		...
		case 5:
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
			{
				if (!iLocal_320)
				{
					...
					{
						STATS::STAT_SET_INT(joaat("NUM_SH_TV_WATCHED"), iLocal_329 + 1, 1);
						iLocal_320 = 1;
					}
				}
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("TV_FRANKLINS_HOUSE_SOCEN"))
				...
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_enter", 8f, -8f, 0, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_enter_remote", sLocal_331, 8f, -8f, 0, 1148846080);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
				}
			...
			else if (PAD::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				func_63();
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "exit", 8f, -8f, 0, 0, 1148846080, 0);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
				}
		...
		case 6:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.6f)
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_base", 4f, -8f, 64, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_base_remote", sLocal_331, 4f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_326, true);
				if (func_73(iLocal_323))
				{
					CAM::SET_CAM_PARAMS(iLocal_323, vLocal_340, vLocal_341, fLocal_342, 0, 1, 1, 2);
			...
			else if (!Global_30796[0 /*11*/].f_2)
			{
				if (func_73(iLocal_323))
				{
					func_69(iLocal_323, vLocal_338);
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.5f)
				{
					func_59(0, 0, 1, 0, 0);
					func_86("TV_HLP4");
					if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("TV_FRANKLINS_HOUSE_SOCEN"))
		...
		case 7:
			...
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_exit", 8f, -8f, 0, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_exit_remote", sLocal_331, 8f, -8f, 0, 1148846080);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
				}
			...
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_idle_a", 8f, -8f, 0, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_idle_a_remote", sLocal_331, 8f, -8f, 0, 1148846080);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
				}
		...
		case 8:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_326))
			{
				if (iLocal_315)
				{
					fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326);
					if (fVar1 > 0.3f)
					{
			...
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "tv_base", 8f, -8f, 64, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "tv_base_remote", sLocal_331, 8f, -8f, 64, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_326, true);
				iLocal_304 = 7;
			}
			break;
		...
		case 9:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) < 0.9f)
			{
				if (iLocal_314)
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.5f)
			...
			{
				iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "base", 8f, -8f, 64, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_66(), iLocal_326, "base_remote", sLocal_331, 8f, -8f, 64, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_326, true);
				if (func_73(iLocal_323))
				{
					CAM::SET_CAM_PARAMS(iLocal_323, vLocal_337, vLocal_338, fLocal_339, 0, 1, 1, 2);
		...
		case 10:
			...
			else if (func_73(iLocal_323))
			{
				func_69(iLocal_323, vLocal_347);
			}
			switch (iLocal_305)
			{
				case 0:
				...
				case 1:
					...
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_326) || iLocal_310)
					{
						iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "blunt_enter", 8f, -8f, 0, 0, 1148846080, 0);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_54(), iLocal_326, "blunt_enter_joint", sLocal_331, 1000f, -1000f, 0, 1148846080);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_52(), iLocal_326, "blunt_enter_lighter", sLocal_331, 8f, -8f, 0, 1148846080);
						if (!Global_30796[0 /*11*/].f_2)
						{
							if (func_73(iLocal_323))
							{
								CAM::SET_CAM_PARAMS(iLocal_323, vLocal_346, vLocal_347, fLocal_348, 0, 1, 1, 2);
							}
						}
						if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
						{
				...
				case 2:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_326))
					{
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.55f)
						{
							if (func_57())
							{
								func_50();
					...
					else
					{
						...
						if (bLocal_316)
						{
							TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "blunt_idle_a", 8f, -8f, 0, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_54(), iLocal_326, "blunt_idle_a_joint", sLocal_331, 1000f, -1000f, 0, 1148846080);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_52(), iLocal_326, "blunt_idle_a_lighter", sLocal_331, 8f, -8f, 0, 1148846080);
						}
						else
						{
							TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "blunt_idle_b", 8f, -8f, 0, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_54(), iLocal_326, "blunt_idle_b_joint", sLocal_331, 1000f, -1000f, 0, 1148846080);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_52(), iLocal_326, "blunt_idle_b_lighter", sLocal_331, 8f, -8f, 0, 1148846080);
						}
						if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
						{
							PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
				...
				case 3:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_326))
					{
						...
						if (iLocal_311)
						{
							if (!iLocal_312)
							{
								...
								if (iLocal_327 == 0)
								{
									if (ENTITY::FIND_ANIM_EVENT_PHASE(func_44(), "blunt_idle_a", func_43(), &fVar2, &fVar3))
									{
								...
								else if (ENTITY::FIND_ANIM_EVENT_PHASE(func_44(), "blunt_idle_b", func_43(), &fVar2, &fVar3))
								{
									if (fVar1 >= fVar2 && fVar1 <= fVar3)
									{
										iLocal_312 = 1;
							...
							{
								iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
								TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "blunt_interrupt", 8f, -8f, 0, 0, 1148846080, 0);
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_54(), iLocal_326, "blunt_interrupt_joint", sLocal_331, 1000f, -1000f, 0, 1148846080);
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_52(), iLocal_326, "blunt_interrupt_lighter", sLocal_331, 8f, -8f, 0, 1148846080);
								if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
								{
									PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
								}
								if (!iLocal_319)
								{
									if (func_73(iLocal_323))
									{
										func_24(PLAYER::PLAYER_PED_ID(), iLocal_323, 1);
									}
									else
									{
					...
					else
					{
						func_47();
						iLocal_326 = PED::CREATE_SYNCHRONIZED_SCENE(func_72(), func_71(), 2);
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_326, sLocal_331, "blunt_exit", 8f, -8f, 0, 0, 1148846080, 0);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_54(), iLocal_326, "blunt_exit_joint", sLocal_331, 1000f, -1000f, 0, 1148846080);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_52(), iLocal_326, "blunt_exit_lighter", sLocal_331, 8f, -8f, 0, 1148846080);
						if (PED::_0x7F2F4F13AC5257EF(iLocal_326))
						{
							PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_326, false);
						}
		...
		case 12:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.95f)
			{
				iLocal_304 = 13;
			}
			else
			{
				...
				{
					fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326);
					if (ENTITY::FIND_ANIM_EVENT_PHASE(func_44(), "exit", "WalkInterruptible", &fVar4, &fVar5) || ENTITY::FIND_ANIM_EVENT_PHASE(func_44(), "exit_drunk", "WalkInterruptible", &fVar4, &fVar5))
					{
		...
		case 13:
			...
			if (!iLocal_313 && func_73(iLocal_323))
			{
				CAM::_RENDER_FIRST_PERSON_CAM(0, 0, 3, 0);
			}
			if (STATS::STAT_GET_INT(joaat("NUM_SH_SOFA_USED"), &iLocal_330, -1))
			{
				STATS::STAT_SET_INT(joaat("NUM_SH_SOFA_USED"), iLocal_330 + 1, 1);
			}
...
void func_49(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				iLocal_325 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sh_lighter_flame", func_52(), 0f, 0f, 0.05f, 0f, 0f, 0f, 1f, 0, 0, 0);
				iLocal_306 = 1;
			}
			if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_325) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.45f)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_325, 0);
			}
			if (!iLocal_321 && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.346f)
			{
				iLocal_324 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sh_cig_smoke", func_54(), -0.09f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
				iLocal_321 = 1;
			}
		...
		case 3:
			if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_324) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_326) > 0.27f)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_324, 0);
			}
...
int func_52()
{
	...
	switch (iLocal_55)
	{
		case joaat("prop_bong_01"):
		case joaat("prop_cigar_03"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_cs_lighter_01"), 0, 0, 1);
			break;
		
		case joaat("p_cs_joint_01"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 2f, joaat("p_cs_lighter_01"), 0, 0, 1);
			break;
		
		case joaat("p_tumbler_02_s1"):
		case joaat("p_tumbler_cs2_s"):
		case joaat("p_tumbler_cs2_s_trev"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_whiskey_bottle_s"), 0, 0, 1);
			break;
		
		case joaat("p_wine_glass_s"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("prop_wine_bot_01"), 0, 0, 1);
			break;
		
		case joaat("prop_radio_01"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("prop_bottle_cap_01"), 0, 0, 1);
			break;
	}
	return iVar0;
}
...
int func_54()
{
	...
	{
		case joaat("prop_cigar_03"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("prop_cigar_03"), 0, 0, 1);
			break;
		
		case joaat("prop_cs_beer_bot_01"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 2.5f, joaat("prop_cs_beer_bot_01"), 0, 0, 1);
			break;
		
		case joaat("p_tumbler_02_s1"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_tumbler_02_s1"), 0, 0, 1);
			break;
		
		case joaat("p_tumbler_cs2_s"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_tumbler_cs2_s"), 0, 0, 1);
			break;
		
		case joaat("p_tumbler_cs2_s_trev"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_tumbler_cs2_s_trev"), 0, 0, 1);
			break;
		
		case joaat("p_cs_joint_01"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_cs_joint_01"), 0, 0, 1);
			break;
		
		case joaat("prop_radio_01"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 3f, joaat("prop_cs_beer_bot_01"), 0, 0, 1);
			break;
		
		case joaat("p_w_grass_gls_s"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_w_grass_gls_s"), 0, 0, 1);
			break;
		
		case joaat("p_wine_glass_s"):
			iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 5f, joaat("p_wine_glass_s"), 0, 0, 1);
			break;
	}
	return iVar0;
}
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != -1)
	{
		...
		{
			GRAPHICS::SET_TV_CHANNEL(-1);
			GRAPHICS::SET_TV_CHANNEL_PLAYLIST(iParam1, func_60(iParam2), iParam4);
...
void func_63()
{
	if (func_73(iLocal_323))
	{
		CAM::SET_CAM_PARAMS(iLocal_323, vLocal_343, vLocal_344, fLocal_345, 0, 1, 1, 2);
	}
	if (func_84("TV_HLP4") || func_84("TV_HLP3"))
	{
		HUD::CLEAR_HELP(1);
...
void func_64()
{
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 224))
	{
		...
		{
			STATS::STAT_SET_INT(joaat("NUM_SH_SOFA_SMOKED"), iLocal_328 + 1, 1);
		}
		iLocal_304 = 10;
	}
}
...
int func_66()
{
	...
	iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_53(), 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
	return iVar0;
}

void func_67()
{
	GRAPHICS::SET_TV_CHANNEL_PLAYLIST(0, func_60(1), 0);
	if (func_68(22))
	{
		GRAPHICS::SET_TV_CHANNEL_PLAYLIST(1, func_60(12), 0);
	}
	else
	{
		GRAPHICS::SET_TV_CHANNEL_PLAYLIST(1, func_60(2), 0);
	}
}
...
int func_89(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95627 && Global_95628) || func_91())
					{
						return 0;
					}
					if (func_90(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_99()
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_331);
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_331))
	{
		return 0;
	}
	iLocal_317 = 1;
...
void func_101()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_104(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_102(iVar0) && (!func_16(14) || Global_110511))
			{
...
{
	return func_110(iParam0, Global_41396);
}
