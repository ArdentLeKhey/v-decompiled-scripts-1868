...
void func_26()
{
	...
	{
		if (func_30(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_39()
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			if (!func_107(PLAYER::PLAYER_PED_ID(), vLocal_186, 270f))
			{
				iLocal_69 = 2;
			}
...
void func_108()
{
	...
	switch (iLocal_69)
	{
		...
		case 3:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_199, 0))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_199, -1);
				}
				else
				{
...
void func_129()
{
	...
	{
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_45[0 /*11*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
void func_131(bool bParam0)
{
	if (iLocal_48 != -1)
	{
		...
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, true, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_48 != -1)
	{
		if (!func_136(Local_46[iLocal_48 /*25*/].f_11) && !func_136(Local_46[iLocal_48 /*25*/].f_14))
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, false, 1);
		}
	}
}
...
int func_132()
{
	...
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_43, true) };
		iVar2 = 0;
		...
		fVar7 = func_133(Local_46[iVar0 /*25*/] - vVar1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
		iVar3 = iVar0;
		iVar8 = 0;
		while (fVar7 < 0f && iVar8 < 40)
		{
			...
			vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_43, true) };
			fVar7 = func_133(Local_46[iVar3 /*25*/] - vVar1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
			iVar8++;
		}
		if (iVar8 >= 40)
		{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (func_37(Global_95196[0]))
			{
				...
				if (func_37(Local_199))
				{
					...
					ENTITY::_SET_ENTITY_SOMETHING(Local_199, true);
					return 1;
				}
			}
		...
		case 3:
			...
			else if (func_150(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1))
			{
				if (func_37(Local_199))
				{
					PED::SET_PED_INTO_VEHICLE(Local_197, Local_199, -1);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_197, true);
					PED::SET_PED_CONFIG_FLAG(Local_197, 170, false);
					PED::SET_PED_FLEE_ATTRIBUTES(Local_197, 65536, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_197, 50, true);
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95196.f_9[1], 1))
				{
					...
					if (func_341(Local_198))
					{
						...
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_198, true);
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_198, true, 1);
						return 1;
					}
				}
				else
...
void func_156(int iParam0, int iParam1)
{
	if (func_341(*iParam0))
	{
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			...
			{
				if (func_10(Local_46[iLocal_48 /*25*/].f_17) && ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
				{
					...
					ENTITY::DETACH_ENTITY(Local_46[iLocal_48 /*25*/].f_17, 1, false);
					ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Local_46[iLocal_48 /*25*/].f_17, 1, ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (iParam0->f_5)
	...
	else
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!func_157(PLAYER::PLAYER_PED_ID(), *iParam0, 150f, 1) && !bLocal_52)
			{
	...
	switch (iParam0->f_6)
	{
		case 5:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				TASK::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 30f, -1, 0, 0);
				iParam0->f_6 = 6;
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				TASK::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 1);
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 4;
				iParam0->f_5 = 1;
			}
		...
		case 11:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_45[func_171(iParam0->f_10) /*11*/]))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_54, 1f, -1, 2f, 0, 1193033728);
					}
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 23;
		...
		case 19:
			...
			if (!func_184(*iParam0, -2017877118))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(*iParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				iParam0->f_5 = 1;
				iParam0->f_6 = 20;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
		...
		case 20:
			...
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
				{
					func_163(iParam0);
				}
				else
...
int func_159(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_160(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, 10f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, 3f, 2f), 5f, 0, true, 0) && PED::IS_PED_STOPPED(*iParam0))
	{
		return 1;
	}
	return 0;
...
void func_162(int iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_37(iVar0))
		{
			if (!VEHICLE::_0x639431E895B9AA57(*iParam0, iVar0, -1, 0, false))
			{
				iParam0->f_6 = 18;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
		...
		case 3:
			if (!func_184(*iParam0, 242628503))
			{
				...
				if (!PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
				{
					if (iParam0->f_10 == 0)
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
						iParam0->f_7 = 1;
					}
					else
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
						iParam0->f_7 = 1;
					}
				}
			}
...
int func_166()
{
	if (func_37(iLocal_43) && func_341(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_43, PLAYER::PLAYER_PED_ID(), 1))
		{
...
{
	if (func_37(iLocal_43) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, 0) && !PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0)))
	{
...
void func_185(var uParam0)
{
	...
	{
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, 1))
			{
				func_176(uParam0, 0);
				return;
			}
		...
		case 2:
			...
			else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, 1))
			{
				func_176(uParam0, 0);
				return;
			}
		...
		case 5:
			if (func_37(iLocal_43))
			{
				VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_43, 25f, 10, 0);
		...
		case 6:
			if (!func_184(*uParam0, 242628503) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_43))
			{
				if (bLocal_51)
				{
					uParam0->f_8 = uParam0->f_7;
...
void func_186(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, true), Local_46[iLocal_48 /*25*/].f_19) > 1.5f)
				{
			...
			if (func_184(*uParam0, 242628503))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						...
						if (func_10(Local_46[iLocal_48 /*25*/].f_17) && !ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_46[iLocal_48 /*25*/].f_17, *uParam0, PED::GET_PED_BONE_INDEX(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
			...
			if (func_37(iLocal_43))
			{
				if (!func_191(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), iLocal_43, 1.9f, 1.9f, 8f))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar1);
							if (func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, true), ENTITY::GET_ENTITY_COORDS(iLocal_43, true)) > 3f)
							{
						...
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_46[iLocal_48 /*25*/].f_17))
							{
								if (ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
								{
									...
									PED::RESET_PED_WEAPON_MOVEMENT_CLIPSET(*uParam0);
									ENTITY::DETACH_ENTITY(Local_46[iLocal_48 /*25*/].f_17, 1, false);
									OBJECT::SET_OBJECT_PHYSICS_PARAMS(Local_46[iLocal_48 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Local_46[iLocal_48 /*25*/].f_17, 1, ENTITY::GET_ENTITY_FORWARD_VECTOR(*uParam0), 0, 1, 1, 0);
								}
	...
	if (Local_42.f_26)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (ENTITY::IS_ENTITY_A_VEHICLE(Local_42.f_18))
			{
				...
				{
					if (ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(Local_42.f_18) == PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1))
					{
						return 1;
					}
				}
...
void func_196(var uParam0, bool bParam1)
{
	...
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
			func_197(uParam0);
		}
		else if (!func_184(*uParam0, 1227113341) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
			TASK::CLEAR_PED_TASKS(*uParam0);
			TASK::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 1073741824, 0);
		}
	}
	else if (func_107(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
...
void func_199()
{
	...
	while (iVar0 <= (iLocal_41 - 1))
	{
		if (Local_46[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if ((iVar0 != iLocal_48 && func_10(Local_46[iVar0 /*25*/].f_17)) && func_201(Local_46[iVar0 /*25*/].f_17, PLAYER::PLAYER_PED_ID(), 1) > 200f)
				{
			...
			{
				if (func_107(PLAYER::PLAYER_PED_ID(), Local_46[iVar0 /*25*/], 100f) || func_107(Local_45[0 /*11*/], Local_46[iVar0 /*25*/], 120f))
				{
...
void func_202(int iParam0, int iParam1, int iParam2)
{
	if (iParam0->f_5 != 1 || iParam2)
	{
		if (!func_341(Local_45[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_52)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_45[func_171(iParam1) /*11*/]))
				{
					...
					{
						vLocal_54 = { ENTITY::GET_ENTITY_COORDS(Local_45[func_171(iParam1) /*11*/], true) };
						iParam0->f_1 = MISC::GET_GAME_TIMER();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
		...
		{
			if (func_181(*iParam0, Local_45[func_171(iParam1) /*11*/], 140f, 0) && func_157(Local_45[func_171(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 15f, 1))
			{
				iParam0->f_5 = 1;
				iParam0->f_6 = 21;
			}
		...
		if (iParam0->f_10 == 0 && iParam0->f_7 == 4)
		{
			if (func_161(iParam0))
			{
				if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
				{
					TASK::TASK_DRIVE_BY(*iParam0, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 10f, 100, 1, -957453492);
		...
		if (func_204(*iParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_203(iParam0))
		{
				...
				if (func_37(iLocal_43))
				{
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(*iParam0, iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
								iParam0->f_6 = 7;
								TASK::TASK_COWER(Local_45[func_171(iParam1) /*11*/], -1);
								Local_45[func_171(iParam1) /*11*/].f_6 = 10;
								Local_45[func_171(iParam1) /*11*/].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = MISC::GET_GAME_TIMER();
								Local_45[func_171(iParam1) /*11*/].f_1 = MISC::GET_GAME_TIMER();
							}
							else
							{
								TASK::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[func_171(iParam1) /*11*/], iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
						...
						else
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_45[func_171(iParam1) /*11*/]))
							{
								if (func_181(Local_45[func_171(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
								{
			...
			else
			{
				...
				if (func_177(Local_45[func_171(iParam1) /*11*/], *iParam0, 1126825984, 1, 250, 7))
				{
					...
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_45[func_171(iParam1) /*11*/]);
				}
			}
			iParam0->f_5 = 1;
		}
	...
	if (iParam0->f_5 != 1)
	{
		if (func_341(Local_45[func_171(iParam1) /*11*/]))
		{
			if (PED::IS_PED_BEING_JACKED(Local_45[func_171(iParam1) /*11*/]))
			{
				func_169(iParam0);
				TASK::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 7;
				iParam0->f_5 = 1;
			}
...
void func_214()
{
	if (func_37(Local_199))
	{
		if (func_157(PLAYER::PLAYER_PED_ID(), Local_199, 100f, 1) && !iLocal_194)
		{
		...
		else if (!func_157(PLAYER::PLAYER_PED_ID(), Local_199, 120f, 1) && iLocal_194)
		{
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						HUD::CLEAR_THIS_PRINT(func_115(func_77(), bParam7));
					}
					if (func_77() != 33)
					{
						func_217(iParam0);
			...
			case 2:
			case 1:
				if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_220(*iParam0)) && !func_219(*iParam0))
				{
					func_7(iParam4);
...
int func_219(int iParam0)
{
	...
	if ((func_341(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_37(iParam0))
	{
			...
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, 1))
			{
				if (func_231(iVar2))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
					{
						...
						{
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), vLocal_186, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_229(iVar2))
				{
					if (func_37(Local_199))
					{
						if (!func_157(iVar2, Local_199, 17f, 1))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
							{
								TASK::TASK_VEHICLE_MISSION(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_199, 3, 20f, 786468, 2f, 0.5f, 1);
							}
						}
					}
				}
...
int func_231(int iParam0)
{
	if (!func_230())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_199) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_199, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_199, vLocal_186, 2f, 2f, 2f, false, true, 0))
		{
			if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_199, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (PED::IS_PED_IN_VEHICLE(iParam0, Local_199, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_199, -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
void func_232(int iParam0)
{
	if (iLocal_68 > 1)
	{
		if (iLocal_70 > 0)
		{
			if (!MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 0) && iLocal_71 == 1)
			{
		...
		{
			if ((MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 0) && !MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 1)) && iLocal_71 == 1)
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
			...
			if (!MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 5))
			{
...
{
	if (!MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_375 != -1)
		{
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
...
{
	if ((MISC::IS_BIT_SET(Local_73[0 /*8*/].f_7, iParam0) || MISC::IS_BIT_SET(Local_73[1 /*8*/].f_7, iParam0)) || MISC::IS_BIT_SET(Local_73[2 /*8*/].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_238()
{
	if (func_107(PLAYER::PLAYER_PED_ID(), vLocal_186, 220f))
	{
		if (!iLocal_203 && !func_107(PLAYER::PLAYER_PED_ID(), vLocal_186, 100f))
		{
			iLocal_203 = func_153(&iLocal_202, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_107(PLAYER::PLAYER_PED_ID(), vLocal_186, 240f))
	{
		if (iLocal_203)
		{
			func_6(&iLocal_202);
...
void func_239()
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			...
			if (!bLocal_190)
			{
				if (func_341(Local_197) && PED::IS_PED_BEING_JACKED(Local_197))
				{
					func_241();
				}
				if (func_341(Local_198) && PED::IS_PED_BEING_JACKED(Local_198))
				{
					func_241();
				}
			}
...
int func_252(int iParam0)
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_303(iParam0, 0, 0)) || func_303(iParam0, 1, 0)) || func_303(iParam0, 2, 0)) || func_326(iParam0) != 145) || func_302(iParam0)) || func_301(iParam0)) || func_300(iParam0)) || func_299(iParam0)) || !func_289(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_301(iParam0))
		{
		}
...
void func_338()
{
	...
	if (!func_37(iLocal_200))
	{
		...
		if (func_37(Local_199) && !func_157(PLAYER::PLAYER_PED_ID(), Local_199, fVar0, 1))
		{
			func_340(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!func_157(PLAYER::PLAYER_PED_ID(), iLocal_200, fVar0, 1))
		{
			iVar1++;
		}
		if (func_37(iLocal_201))
		{
			if (!func_157(PLAYER::PLAYER_PED_ID(), iLocal_201, fVar0, 1))
			{
				iVar1++;
			}
		}
		...
		if (func_37(Local_199))
		{
			if (!func_157(PLAYER::PLAYER_PED_ID(), Local_199, fVar0, 1))
			{
				iVar1++;
			}
		}
...
void func_346(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_347(iParam2)];
	if (iVar0 != 0)
	{
...
int func_348(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_347(iParam1)];
