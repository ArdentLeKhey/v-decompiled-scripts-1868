...
void __EntryFunction__()
{
	...
	fLocal_267 = 0f;
	fLocal_268 = 0.975f;
	vLocal_55 = { ScriptParam_275.f_1[0 /*3*/] };
...
void func_1()
{
	switch (iLocal_269)
	{
		...
		case 1:
			if (func_25(iLocal_67))
			{
				if (func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_270)
				{
					iLocal_269++;
				}
			}
			...
			if (MISC::GET_GAME_TIMER() > iLocal_270 && CAM::IS_SCREEN_FADED_IN())
			{
				if (!PED::IS_PED_INJURED(iLocal_67))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_67, 0))
					{
						...
						PED::APPLY_DAMAGE_TO_PED(iLocal_67, 200, 0, 0);
					}
					else
					{
						PED::SET_PED_TO_RAGDOLL(iLocal_67, 500, 1000, 0, 0, 0, 0);
		...
		case 4:
			if ((MISC::GET_GAME_TIMER() > iLocal_270 && func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0)) || MISC::GET_GAME_TIMER() > iLocal_270 + 6000)
			{
				func_322();
			}
			break;
...
void func_3()
{
	...
	{
		if (func_7(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_6(PLAYER::PLAYER_PED_ID());
			if (func_5(iVar0) && (!func_4(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_5(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_26()
{
	...
	switch (iLocal_53)
	{
		case 0:
			...
			{
				if (PED::IS_PED_IN_GROUP(iLocal_67) || ENTITY::IS_ENTITY_AT_COORD(iLocal_67, vLocal_56, Global_22, false, true, 0))
				{
					func_208(1, 0, 1, 0);
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_206(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 5f, 1, 1056964608, 0, 1, 0))
						{
							iVar0 = 1;
						}
					}
			...
			if (iVar0 == 1)
			{
				...
				MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_68, true), 20f, 1, 0, 0, false);
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67) && !PED::IS_PED_INJURED(iLocal_68))
			{
				if (func_76(&uLocal_76, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_67(iVar1))
						{
							ENTITY::SET_ENTITY_COORDS(iVar1, 1738.655f, 3836.227f, 33.879f, 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(iVar1, 119f);
						}
						else
						{
							ENTITY::SET_ENTITY_COORDS(iVar1, vLocal_56, 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(iVar1, 119f);
						}
					...
					else
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1734.259f, 3840.59f, 33.7883f, 1, false, 0, 1);
						PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
					}
					ENTITY::SET_ENTITY_COORDS(iLocal_67, 1738.047f, 3842.438f, 33.7707f, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_67, 36.8203f);
					PED::_0x2208438012482A1A(iLocal_67, 0, 0);
					MISC::CLEAR_AREA(vLocal_56, 4f, 1, 0, 0, false);
					func_66(&iVar1);
					iLocal_259 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, vLocal_73, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_259, sLocal_257, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, sLocal_257, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_34()
{
	...
	{
		func_36(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_100(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_122(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_122(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_130(iVar10, iVar0, func_89(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_107(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_115(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_115(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_115(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_122(int iParam0)
{
	...
	{
		func_128(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_125(iParam2)];
	if (iVar0 != 0)
	{
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_125(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_126(func_136(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_126(func_135(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_126(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_90(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_90(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_90(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_202(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_203(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_203(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_203(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_203(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_203(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_203(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_203(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_203(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_203(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_203(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_203(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_203(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_203(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_203(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_203(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_203(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
void func_209()
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		{
			PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_67, 0);
			...
			if (func_221())
			{
				if (iLocal_70)
				{
					...
					{
						func_219(&iLocal_69, 1, 0, 1);
						func_66(&iLocal_71);
						if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_265))
						{
							GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_265, 0);
						}
						iLocal_70 = 0;
					}
					else
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_66))
				{
					iLocal_66 = func_215(vLocal_56, 1);
				}
				if (bLocal_244)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), 1) || func_214(iLocal_68, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
						TASK::CLEAR_PED_TASKS(iLocal_68);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_68, false);
						PED::SET_PED_TO_RAGDOLL(iLocal_68, 250, 500, 0, 0, 0, 0);
						TASK::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_68, true);
						bLocal_272 = true;
						iLocal_52 = 2;
						iLocal_269 = 0;
					}
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_56, Global_19, true, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, true, 0))
					{
						iLocal_52 = 1;
						iLocal_53 = 0;
					}
				...
				if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_67) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_ON_ANY_BIKE(iLocal_67))
					{
						...
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_67, -2017877118) == 7)
						{
							TASK::TASK_PLAY_ANIM(iLocal_67, sLocal_256, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
			else
			{
				...
				if (!func_214(PLAYER::PLAYER_PED_ID(), iLocal_67, 200f, 1))
				{
					iLocal_52 = 2;
					iLocal_269 = 5;
				}
...
int func_210()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_67, 0))
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_67, 0);
...
void func_212()
{
	if (!bLocal_244 && func_220(PLAYER::PLAYER_PED_ID(), vLocal_56, 150f))
	{
		STREAMING::REQUEST_MODEL(iLocal_246);
		STREAMING::REQUEST_ANIM_DICT(sLocal_257);
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			iLocal_245 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 1, 0, 1);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_245, true);
			vLocal_72 = { 1730.038f, 3853.562f, 34.661f };
			vLocal_73 = { 0f, 0f, 36f };
			iLocal_68 = PED::CREATE_PED(26, iLocal_246, 1728.778f, 3851.287f, 33.7826f, 211.7722f, 1, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_68, true);
			func_213(&uLocal_76, 5, iLocal_68, "CrashSafehouse", 0, 1);
			iLocal_259 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, vLocal_73, 2);
			TASK::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, sLocal_257, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_244 = true;
		}
	}
}
...
void func_218()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_71, 0))
		{
			...
			{
				VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_71, 1);
			}
			else if ((iLocal_61 - iLocal_62) > 2000)
			{
				VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_71, 0);
...
int func_221()
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iLocal_67, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		...
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 20f, 20f, 20f, 0, 1, 0) || !func_230())
		{
			PED::REMOVE_PED_FROM_GROUP(iLocal_67);
		}
		else if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_67, -828834893) == 7)
				{
					TASK::CLEAR_PED_TASKS(iLocal_67);
	...
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, Global_19, 0, 1, 0) && func_230())
		{
	...
	{
		iLocal_65 = func_222(iLocal_67, 0, 0);
	}
	return 0;
}
...
int func_230()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((VEHICLE::IS_VEHICLE_SEAT_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0, 0) || VEHICLE::IS_VEHICLE_SEAT_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1, 0)) || VEHICLE::IS_VEHICLE_SEAT_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1, 0)) || VEHICLE::IS_VEHICLE_SEAT_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 2, 0))
				{
					iLocal_264 = 0;
					return 1;
				}
			...
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_67, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
				{
					iLocal_264 = 0;
					return 1;
				}
...
void func_233()
{
	switch (iLocal_54)
	{
		...
		case 1:
			if (iLocal_59 == 0)
			{
				if (func_235() && !func_339())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_WHEREM", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_WHEREF", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_WHERET", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_9(&uLocal_76, "RECRAAU", "RECRA_APPR", 3, 0, 0, 0))
				{
					iLocal_59++;
					if (!HUD::DOES_BLIP_EXIST(iLocal_66))
					{
			...
			{
				if (func_9(&uLocal_76, "RECRAAU", "RECRA_TSS", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
		...
		case 2:
			if (iLocal_59 == 0)
			{
				if (func_235() && !func_339())
				{
					if (func_221())
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_ALTRU", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
		...
		case 3:
			if (iLocal_59 == 0)
			{
				if (func_235() && !func_339())
				{
					if (func_221())
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT1", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			else if (iLocal_59 == 2)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT1M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT1F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT1T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT2", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 6)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT2M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT2F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT2T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT3", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 10)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT3M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT3F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT3T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT4", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 14)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT4M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT4F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT4T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT5", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 18)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT5M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT5F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT5T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT6", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 22)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT6M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT6F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT6T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT7", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			else if (iLocal_59 == 26)
			{
				if (func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT7M", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT7F", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT7T", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			{
				if (func_235() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT8", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
		...
		case 4:
			if (iLocal_59 == 0)
			{
				if (MISC::GET_GAME_TIMER() > iLocal_58 && !func_339())
				{
					if (func_221())
					{
						if (func_230() && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_9(&uLocal_76, "RECRAAU", "RECRA_PAIN", 3, 0, 0, 0))
							{
								iLocal_59++;
							}
						}
						else if (func_9(&uLocal_76, "RECRAAU", "RECRA_GETOUT", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
			...
			else if (iLocal_59 == 2)
			{
				if (func_221() && func_235())
				{
					if (func_2() == 0)
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_MC1", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_FC1", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
					...
					{
						if (func_9(&uLocal_76, "RECRAAU", "RECRA_TC1", 3, 0, 0, 0))
						{
							iLocal_59++;
						}
					}
...
void func_234(int iParam0, bool bParam1)
{
	if (!func_339())
	{
		if (iLocal_264)
		{
			if (func_9(&uLocal_76, "RECRAAU", "RECRA_WALK", 3, 0, 0, 0))
			{
				bLocal_263 = true;
				iLocal_264 = 0;
			}
	...
	switch (iLocal_63)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				vLocal_72 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_67, 0f, 0f, 5f) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_72, &(vLocal_72.f_2), 0, 0);
				vLocal_73 = { func_241() };
				...
				MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), 5f, 1, 0, 0, false);
				...
				iLocal_266 = GRAPHICS::ADD_DECAL(1110, vLocal_260, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) == 1)
				{
					PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_258, false);
				...
				if (func_2() == 0)
				{
					func_9(&uLocal_76, "RECRAAU", "RECRA_MHELP", 3, 0, 0, 0);
				}
				else if (func_2() == 1)
				{
					func_9(&uLocal_76, "RECRAAU", "RECRA_FHELP", 3, 0, 0, 0);
				}
				else if (func_2() == 2)
				{
					func_9(&uLocal_76, "RECRAAU", "RECRA_THELP", 3, 0, 0, 0);
				}
				iLocal_63++;
			}
			break;
		...
		case 4:
			...
			if (func_25(iLocal_67))
			{
				PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_67, 1);
			...
			WEAPON::HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER::PLAYER_PED_ID(), false);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_67, 1862763509);
			if (iLocal_242)
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
				...
				PED::FORCE_PED_MOTION_STATE(iLocal_67, -1871534317, false, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iLocal_67, 0, 0);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_72, vLocal_73, 1f, 2) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 1);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_72, vLocal_73, 1f, 2) };
				ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), vVar0.z);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_72, vLocal_73, 1f, 2) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				ENTITY::SET_ENTITY_COORDS(iLocal_67, vVar0, 1, false, 0, 1);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_72, vLocal_73, 1f, 2) };
				ENTITY::SET_ENTITY_HEADING(iLocal_67, vVar0.z);
			}
			else
			{
				if (!bLocal_243)
				{
					...
					TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sVar1, "idle_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
			...
			PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_241, 0);
			iLocal_241 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
void func_242()
{
	if (!PED::IS_PED_INJURED(iLocal_67) && !func_260())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 80f, 80f, 15f, 0, 1, 0))
		{
			STREAMING::REQUEST_ANIM_DICT(sLocal_251);
			if (!iLocal_273)
			{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_257(1, 0, 1))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_67, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
			...
			else if (func_214(PLAYER::PLAYER_PED_ID(), iLocal_67, 15f, 1) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f)
			{
				if (func_339())
				{
					func_255();
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_65))
				{
					iLocal_65 = func_254(iLocal_67, 1, 1, 5);
				}
			}
			else
			{
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_339())
						{
							...
							func_9(&uLocal_76, "RECRAAU", "RECRA_PLEAD", 3, 0, 0, 0);
					...
					case 2:
						if (MISC::GET_GAME_TIMER() > iLocal_58 && !func_339())
						{
							func_9(&uLocal_76, "RECRAAU", "RECRA_PLEAD2", 3, 0, 0, 0);
					...
					case 3:
						if (MISC::GET_GAME_TIMER() > iLocal_58 && !func_339())
						{
							func_9(&uLocal_76, "RECRAAU", "RECRA_PLEAD3", 3, 0, 0, 0);
...
int func_243(int iParam0)
{
	if (func_247())
	{
		...
		if (func_40(Global_111549))
		{
			func_244(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_40(Global_111549))
		{
...
int func_247()
{
	switch (func_248(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_251(iParam0, Global_41396);
}
...
int func_253()
{
	if ((Global_111549 == func_49() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
int func_260()
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_67, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_261()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_MODEL_LOADED(iLocal_248)) && STREAMING::HAS_MODEL_LOADED(iLocal_247)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_249)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_253)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_254)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_252)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_71, false, false, 0);
		VEHICLE::SET_VEHICLE_LIGHTS(iLocal_71, 1);
		VEHICLE::SET_VEHICLE_TYRE_BURST(iLocal_71, 0, 0, 1148846080);
		MISC::GET_MODEL_DIMENSIONS(iLocal_248, &uVar0, &vVar1);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_71, 0);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_71, 2);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_71, 3);
		VEHICLE::_DETACH_VEHICLE_WINDSCREEN(iLocal_71);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, 0f, vVar1.y, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, vVar1.x, (vVar1.y * 0.75f), 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, vVar1.x, 0f, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, 0f, 0f, vVar1.z, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_71, 5, 1, true);
		VEHICLE::SET_VEHICLE_DIRT_LEVEL(iLocal_71, 12f);
		VEHICLE::START_VEHICLE_ALARM(iLocal_71);
		ENTITY::SET_ENTITY_PROOFS(iLocal_71, false, true, false, false, false, false, 0, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_71, 0f, 180f, 0f, 2, 1);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(iLocal_71, true);
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(iLocal_71, true);
		iLocal_265 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_recrash_rescue_fire", iLocal_71, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_262)
		{
			iLocal_67 = PED::CREATE_PED(26, iLocal_247, vLocal_260, (fLocal_261 - 180f), 1, true);
		}
		else
		{
			iLocal_67 = PED::CREATE_PED(26, iLocal_247, vLocal_260, fLocal_261, 1, true);
		}
		PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_67, 0, 0.7f, 0.5f, 2);
		vLocal_57 = { ENTITY::GET_ENTITY_COORDS(iLocal_67, true) };
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_57.x, (vLocal_57.y + 0.1f), (vLocal_57.z + 0.1f), vLocal_57.x, (vLocal_57.y - 0.1f), (vLocal_57.z - 0.1f), 1, 1, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
		TASK::TASK_PLAY_ANIM(iLocal_67, sLocal_249, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_25(iLocal_67))
		{
			PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_67, 0);
		}
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67, true);
		...
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_67, sLocal_250, 1048576000);
		PED::SET_PED_CONFIG_FLAG(iLocal_67, 229, true);
		func_213(&uLocal_76, 3, iLocal_67, "TALINA", 0, 1);
		PED::APPLY_PED_BLOOD(iLocal_67, 3, 0f, 0f, 0f, "wound_sheet");
		PED::SET_PED_CAN_BE_TARGETTED(iLocal_67, false);
		iLocal_69 = PED::CREATE_PED(26, iLocal_246, 1935.53f, 6291.888f, 41.144f, -28.44f, 1, true);
		iLocal_70 = 1;
		vLocal_57 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, true) };
		PED::APPLY_PED_BLOOD(iLocal_69, 3, 0f, 0f, 0f, "wound_sheet");
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_57.x, (vLocal_57.y + 0.1f), (vLocal_57.z + 0.1f), vLocal_57.x, (vLocal_57.y - 0.1f), (vLocal_57.z - 0.1f), 1, 1, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
		PED::SET_PED_CONFIG_FLAG(iLocal_69, 227, true);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_69, sLocal_252, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		ENTITY::SET_ENTITY_HEALTH(iLocal_69, 0, 0);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_246);
		if (func_2() == 0)
		{
			func_213(&uLocal_76, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_2() == 1)
		{
			func_213(&uLocal_76, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_2() == 2)
		{
			func_213(&uLocal_76, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		iLocal_241 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
		iLocal_51 = 1;
	}
}
...
int func_279(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (func_5(func_2()))
		{
			if (!func_315(iParam1, iParam2, 145))
			{
				return 0;
			}
		}
		if (!func_314(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (iParam2 == 2 || iParam2 == 5)) && !func_303(0, 0))
		{
			return 0;
		}
		if (Global_30882)
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110607) || Global_30738) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_308()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_312()) || Global_30738) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110607) || Global_30738) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110607) || Global_30738) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_312() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_22(8, -1)) || func_307()) || func_306()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_30738) || func_311()) || func_22(8, -1)) || func_309()) || func_308()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_312()) || func_309()) || Global_110607) || Global_30738) || func_311()) || Global_42561) || func_22(8, -1)) || func_308()) || func_306()) || func_307()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_110607) || Global_30738) || func_311()) || func_22(8, -1)) || func_308()) || func_306()) || func_310()) || func_309()) || func_307())
						{
							return 0;
						}
						break;
...
void func_322()
{
	...
	{
		ENTITY::SET_ENTITY_PROOFS(iLocal_71, false, false, false, false, false, false, 0, false);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_245))
	{
		...
		func_334(&iLocal_245, 0);
	}
	if (iLocal_273)
	{
		func_258(0);
	}
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(vLocal_55 - Vector(3f, 3f, 3f), vLocal_55 + Vector(3f, 3f, 3f), true);
...
void func_323(int iParam0)
{
	...
	if (func_253())
	{
		...
		func_326(30000);
		StringCopy(&cVar0, func_325(Global_111549, 1), 64);
		if (func_48(Global_111549) > 0)
		{
