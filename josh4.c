#region Local Var
	...
	vector3 vLocal_416[5] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	iLocal_50 = 1;
	iLocal_51 = 1;
	vLocal_53 = { -1102.906f, 284.731f, 63.0602f };
	fLocal_54 = 9.4866f;
	iLocal_392 = joaat("FELON2");
	func_487("*** Now in Josh 4 loop ***");
	Local_386 = { ScriptParam_418 };
	func_485(&Local_386);
	MISC::SET_MISSION_FLAG(1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		func_484("Force cleanup [TERMINATING]");
	...
	if (func_453())
	{
		func_487("*** Setting up initial scene for replay");
		func_452(vLocal_53, fLocal_54, 1, 0);
		func_487("*** Replay setup started");
		Global_76822 = 1;
		iLocal_37 = 0;
		while (!func_441(&Local_386))
		{
			SYSTEM::WAIT(0);
		}
		func_487("*** Josh 4 scene set up");
		func_440(&Local_386, 0, 1);
		Global_76822 = 0;
	}
	if (func_439(Local_386.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_386.f_28[1], true);
	}
	if (func_439(Local_386.f_28[2]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_386.f_28[2], true);
	}
	iLocal_390 = Local_386.f_35[0];
	iLocal_391 = Local_386.f_35[1];
	func_487("*** About to set up positions...");
	func_438();
	func_431(58, 2, 0);
	if (func_453())
	{
		func_487("*** Creating replay vehicle and jumping to post-cutscene");
		func_332(&iLocal_44, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_309(Local_386.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_45)
		{
			case 0:
				func_299();
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			func_440(&Local_386, 0, 1);
			if (func_439(iLocal_390))
			{
				ENTITY::SET_ENTITY_PROOFS(iLocal_390, false, false, false, false, false, false, 0, false);
			}
			if (func_439(iLocal_391))
			{
				ENTITY::SET_ENTITY_PROOFS(iLocal_391, false, false, false, false, false, false, 0, false);
			}
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_206())
			{
				...
				{
					if (func_439(Local_386.f_28[iVar0]))
					{
						func_205(&(Local_386.f_28[iVar0]), 0, 1, 1);
					}
					iVar0++;
				}
				if (func_204(iLocal_390))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_390, 0))
					{
						func_203(777);
					}
				}
...
void func_2()
{
	if (func_439(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST_RADIO");
			func_487("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
			func_487("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
		func_487("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_454();
}
...
void func_207()
{
	if (iLocal_414 == 0)
	{
		if (func_208(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			...
			func_487("*** Played special Josh 4 police report ***");
			iLocal_414 = 1;
		}
	}
}

float func_208(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
void func_209()
{
	if (iLocal_409 == 0)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, true, 0))
		{
			while (func_206())
			{
				func_229();
			...
			func_228(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_228(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
	...
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
					func_211(&uLocal_221, "JOSH4AU", "JOSH4CAR2", 9, 0, 0, 0);
				}
				else if (iLocal_49 == 1)
				{
					if (func_439(Local_386.f_28[0]))
					{
						if (func_210(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) < 75f)
						{
							func_211(&uLocal_221, "JOSH4AU", "JOSH4CAR3", 9, 0, 0, 0);
						}
						else
						{
							func_211(&uLocal_221, "JOSH4AU", "JOSH4CAR1", 9, 0, 0, 0);
						}
					}
				}
				else if (iLocal_49 == 2)
		...
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_439(Local_386.f_28[0]))
				{
					...
					if (func_204(iLocal_391))
					{
						if (MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
							func_487("Back gate blocked");
							vLocal_55 = { -1130.35f, 307.92f, 65.19f };
							TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
						...
						{
							func_487("Back gate clear");
							TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
							if (func_204(iLocal_391))
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					{
						func_487("Josh car not ok - do Josh flee anyway");
						TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
						if (func_204(iLocal_391))
						{
				...
				PED::SET_PED_CAN_BE_DRAGGED_OUT(Local_386.f_28[0], 1);
		...
		case 1:
			if (func_439(Local_386.f_28[0]))
			{
				if (!iLocal_406)
				{
					...
					{
						if (func_210(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							func_228(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_228(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
							if (func_206())
							{
								func_236();
								func_235(&uLocal_221, "JOSH4AU", "JOSH4COP3", 9, 0, 0);
							}
							else
							{
								func_211(&uLocal_221, "JOSH4AU", "JOSH4COP3", 9, 0, 0, 0);
							}
							func_487("Doing Josh comment");
						}
						else
						{
							func_487("Too far away to do Josh comment");
						}
						iLocal_406 = 1;
					}
				}
				if (func_204(iLocal_391))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_386.f_28[0], iLocal_391, 1))
					{
						if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_391) < 20f)
						{
							TASK::CLEAR_PED_TASKS(Local_386.f_28[0]);
							TASK::TASK_LEAVE_ANY_VEHICLE(Local_386.f_28[0], 0, 4416);
							TASK::TASK_SMART_FLEE_PED(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_234(&iLocal_391);
						}
					}
					if (func_439(PLAYER::PLAYER_PED_ID()))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_391, 1))
						{
							TASK::CLEAR_PED_TASKS(Local_386.f_28[0]);
							TASK::TASK_SMART_FLEE_PED(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_234(&iLocal_391);
					...
					if (PED::IS_PED_BEING_JACKED(Local_386.f_28[0]))
					{
						if (iLocal_407 == 0)
						{
							if (func_211(&uLocal_221, "JOSH4AU", "JOSH4BEGS", 9, 0, 0, 0))
							{
								iLocal_407 = 1;
							}
						}
				...
				if (func_210(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) > 350f)
				{
					func_487("Deleting Josh, setting as lost");
					func_233(&(Local_386.f_28[0]));
					func_232(&iLocal_391);
					iLocal_49 = 2;
				}
				if (func_439(PLAYER::PLAYER_PED_ID()) && func_439(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						if (func_210(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) < 10f)
						{
							if (!func_206() && (MISC::GET_GAME_TIMER() - iLocal_413) > 8000)
							{
								if (func_211(&uLocal_221, "JOSH4AU", "JOSH4CHASE", 9, 0, 0, 0))
								{
									iLocal_410++;
									iLocal_413 = MISC::GET_GAME_TIMER();
								}
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 1))
				{
					RECORDING::_0x293220DA1B46CEBC(2f, 2f, 0);
					func_487("Player killed Josh!");
					func_203(776);
				}
				func_487("Josh - DEAD!");
				if (func_206())
				...
				if (func_211(&uLocal_221, "JOSH4AU", "JOSH4KILL", 9, 0, 0, 0))
				{
					iLocal_49 = 3;
				}
			}
...
void func_237()
{
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, true, 2))
				{
					func_238("Player detected inside flee direction trigger: ", iLocal_393);
					STREAMING::REQUEST_MODEL(iLocal_43);
					STREAMING::REQUEST_MODEL(iLocal_42);
					Local_47 = { vLocal_416[iLocal_393 /*3*/] };
					...
					func_238("iFlee value is: ", iLocal_393);
					func_487("Requesting flee recording: ");
					func_238(Local_47.f_10, Local_47.f_9);
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_47.f_7))
			{
				...
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_47.f_7, 1084227584);
				ENTITY::SET_ENTITY_QUATERNION(Local_47.f_7, Local_47.f_3, Local_47.f_4, Local_47.f_5, Local_47.f_6);
				Local_47.f_8 = PED::CREATE_PED_INSIDE_VEHICLE(Local_47.f_7, 6, iLocal_42, -1, 1, true);
				...
				func_487("Flee car created!");
				Local_47.f_11 = 2;
			}
			break;
		
		case 2:
			if (func_204(Local_47.f_7))
			{
				if (func_439(Local_47.f_8))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_47.f_8, 0))
					{
						VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_47.f_7, Local_47.f_9, Local_47.f_10, 1);
						VEHICLE::_0x1F2E4E06DEA8992B(Local_47.f_7, 1);
						func_238("*** m_AI_FleeCar.iRecNum: ", Local_47.f_9);
						switch (Local_47.f_9)
						{
							case 0:
			...
			if (func_204(Local_47.f_7))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_47.f_7))
				{
					if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_47.f_9, Local_47.f_10))
					{
						...
						func_487("Flee car recording finished!");
						Local_47.f_11 = 4;
					}
				}
				else
		...
		case 4:
			if (func_204(Local_47.f_7))
			{
				if (func_439(Local_47.f_8))
				{
					...
					func_205(&(Local_47.f_8), 1, 0, 1);
				}
				Local_47.f_11 = 5;
				func_234(&(Local_47.f_7));
			}
			func_487("Flee car & ped released!");
			break;
	}
}
...
void func_239()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			{
				func_487("************************************** TIMEOUT - AIM next frame");
				iLocal_48 = 1;
				iLocal_394 = MISC::GET_GAME_TIMER();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_439(Local_386.f_28[iVar0]))
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 10f)
					{
						func_487("************************************** TOO FAR - AIM next frame");
						iLocal_48 = 1;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 2:
			...
			{
				func_487("************************************** TIMEOUT - ARREST next frame");
				if (func_439(Local_386.f_28[1]))
				{
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_439(Local_386.f_28[iVar0]))
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 12f)
					{
						func_487("************************************** TOO FAR - ATTACK next frame");
						iLocal_48 = 3;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_439(Local_386.f_28[iVar0]))
				{
					...
					else if (func_240(Local_386.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						func_487("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_48 = 3;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				func_228(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				func_228(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
				if (func_206())
				{
					func_236();
					func_235(&uLocal_56, "JOSH4AU", "JOSH4COP2", 7, 0, 0);
				}
				else
				{
					func_211(&uLocal_56, "JOSH4AU", "JOSH4COP2", 7, 0, 0, 0);
				}
				func_487("Doing cop fire warning");
				iLocal_399 = 1;
			...
			else
			{
				...
				{
					if (func_439(Local_386.f_28[iVar1]))
					{
						if (func_210(Local_386.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) > 20f)
						{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_411) > 15000)
				{
					...
					while (iVar1 <= (Local_386.f_28 - 1))
					{
						if (func_439(Local_386.f_28[iVar1]))
						{
							if (func_210(Local_386.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) >= 50f)
							{
								func_205(&(Local_386.f_28[iVar1]), 0, 1, 1);
							}
						}
						iVar1++;
					}
		...
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (func_439(Local_386.f_28[iVar0]))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_386.f_28[iVar0]))
				{
					...
					{
						func_487("************************************** AIMED WEAPON - ATTACK now");
						iLocal_48 = 3;
					}
				}
				if (func_240(Local_386.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_487("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_48 = 3;
				}
				if (iLocal_48 != 4)
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) < 2.3f)
					{
						func_487("************************************** TOO CLOSE - ATTACK now");
						iLocal_48 = 3;
					}
				}
			}
...
int func_240(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_439(PLAYER::PLAYER_PED_ID()) && func_439(iParam0))
	{
...
bool func_243(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_251(iParam0, iParam1);
	if (!func_439(iParam0) || !func_439(iParam1))
	{
		if (iVar2 != -1)
		{
			func_250(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_244(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_244(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_245(iParam2, iParam5) };
...
int func_247(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_249(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_248(vVar1, vVar0);
...
float func_248(vector3 vParam0, vector3 vParam1)
{
...
int func_256(int iParam0, float fParam1)
{
	...
	{
		if (func_257(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_257(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
void func_259()
{
	if (!iLocal_395)
	{
		func_228(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		func_228(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
		func_211(&uLocal_56, "JOSH4AU", "JOSH4GIVEUP", 8, 1, 0, 0);
		iLocal_395 = 1;
	}
	else
	{
			...
			case 1:
				if (!func_206() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_51)
					{
						func_228(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_228(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
						if (func_211(&uLocal_56, "JOSH4AU", "JOSH4COP1", 8, 0, 0, 0))
						{
							iLocal_50 = 2;
							iLocal_51 = 0;
						}
					...
					else
					{
						func_228(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_228(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
						if (func_211(&uLocal_221, "JOSH4AU", "JOSH4JOSH", 6, 0, 0, 0))
						{
							iLocal_50 = 2;
							iLocal_51 = 1;
						}
...
void func_261()
{
	...
	else if (!iLocal_404)
	{
		...
		func_487("Starting 'JOSH4_ACTION'");
		iLocal_404 = 1;
	}
	else if (!iLocal_405)
	{
		if (func_439(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				func_487("Starting 'JOSH4_VEHICLE'");
				iLocal_405 = 1;
			}
		}
	}
...
void func_262()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_439(Local_386.f_28[1]))
		{
			func_487("Trying to set Cop 1 component variation (intro loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_439(Local_386.f_28[2]))
		{
			func_487("Trying to set Cop 2 component variation (intro loop)");
			...
			switch (iLocal_408)
			{
				case 0:
					if (func_290(1, 1093140480, 0))
					{
						...
						if (func_204(iVar0))
						{
							...
							else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, true, 0))
							{
						...
						if (func_204(iVar0))
						{
							if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iVar0)))
							{
								func_280(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar2, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								func_280(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar2, func_279(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
						...
						if (func_204(iLocal_390))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_390, -1107.5f, 280.33f, 64.01f, 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(iLocal_390, 97.97f);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_390, 1084227584);
						}
						iLocal_408++;
					}
					break;
				...
				case 3:
					...
					if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
					{
						...
						{
							AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_START");
							func_487("Starting 'JOSH4_START' via cutscene skip");
							iLocal_403 = 1;
						}
					}
					break;
...
int func_271(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_439(Local_386.f_28[0]))
		{
			func_487("Playing Josh's leadout");
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_439(Local_386.f_28[1]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[1], 1063765679, false, 1, 0);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_439(Local_386.f_28[2]))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[2], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			func_487("*** Notepad cop anim");
		}
	}
}
...
void func_275(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_280(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_281(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_281(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_285(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_283(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_284(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_285(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_249(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_286(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_286(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_286(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_286(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_286(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_286(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_286(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_286(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_286(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_286(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_286(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_286(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_286(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_286(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_286(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_286(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_286(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_289()
{
	if (func_439(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_487("*** Registered Trevor");
	}
	if (func_439(Local_386.f_28[0]))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[0], "Josh", 0, 0, 0);
		func_487("*** Registered Josh");
	}
	if (func_439(Local_386.f_28[1]))
	{
		iLocal_387 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_PISTOL"), -1, ENTITY::GET_ENTITY_COORDS(Local_386.f_28[1], true), 1, 1065353216, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_487("*** Registered Cop standing");
	}
	if (func_439(Local_386.f_28[2]))
	{
		iLocal_388 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_PISTOL"), -1, ENTITY::GET_ENTITY_COORDS(Local_386.f_28[2], true), 1, 1065353216, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_487("*** Registered Cop with notepad");
	}
	if (func_439(iLocal_387))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_387, "Security_guard_pistol", 0, 0, 0);
		func_487("*** Registered idle cop gun");
	}
	if (func_439(iLocal_388))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_388, "FBI_Agent_1_Gun", 0, 0, 0);
		func_487("*** Registered notepad cop gun");
	}
	iLocal_403 = 0;
	iLocal_404 = 0;
	iLocal_405 = 0;
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_294(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_294(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_297(int iParam0)
{
	...
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, false, 0f, 0);
	}
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, false, 0f, 0);
	}
	if (func_439(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			ENTITY::SET_ENTITY_COORDS(Local_386.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, false, 0, 1);
			ENTITY::SET_ENTITY_HEADING(Local_386.f_28[0], 193.1737f);
			TASK::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
	...
	if (iParam0 == 1)
	{
		if (func_439(Local_386.f_28[2]))
		{
			...
			ENTITY::SET_ENTITY_COORDS(Local_386.f_28[2], -1106.08f, 288.55f, 63.31f, 1, false, 0, 1);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[2], iLocal_389);
	...
	if (iParam0 == 1)
	{
		if (func_439(Local_386.f_28[1]))
		{
			...
			ENTITY::SET_ENTITY_COORDS(Local_386.f_28[1], -1102.41f, 289.73f, 63.18f, 1, false, 0, 1);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[1], iLocal_389);
...
void func_299()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_439(Local_386.f_28[1]))
		{
			func_487("Trying to set Cop 1 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_439(Local_386.f_28[2]))
		{
			func_487("Trying to set Cop 2 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		case 0:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				func_487("Doing setup for leadin");
				func_228(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
				func_228(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				STREAMING::REQUEST_ANIM_DICT("rcmjosh4");
			...
			{
				func_487("Skipping setup for leadin (repeat play/wrong area)");
				func_296(1);
			}
			break;
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_439(PLAYER::PLAYER_PED_ID()) && func_264(Local_386.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_300())
						{
				...
				if (!iLocal_400)
				{
					if (func_264(Local_386.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_206())
						{
							TASK::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_487("Done Josh leadin anim");
							if (func_264(Local_386.f_28[2]))
							{
								TASK::TASK_PLAY_ANIM(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_487("Done Notepad cop leadin anim");
							}
							if (func_264(Local_386.f_28[1]))
							{
								TASK::TASK_PLAY_ANIM(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_487("Done Speaker cop leadin anim");
							}
				...
				{
					if ((func_439(PLAYER::PLAYER_PED_ID()) && func_264(Local_386.f_28[0])) && !func_300())
					{
						if (!func_293(PLAYER::PLAYER_PED_ID(), -875674219))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
					...
					if (func_264(Local_386.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
									if (func_211(&uLocal_221, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
							...
							if (func_210(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) <= 2f)
							{
								if (func_206())
								{
									func_229();
								}
								func_487("Player too close to Josh, starting cutscene early");
								func_296(1);
							}
						}
						else
...
void func_302()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_294(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_309(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_311(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_322(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_324(iParam0, Global_41396);
}
...
void func_325()
{
	if (func_439(Local_386.f_28[1]))
	{
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_386.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(Local_386.f_28[1], 177.74f);
	}
	else
	{
		Local_386.f_28[1] = PED::CREATE_PED(6, iLocal_42, -1102.92f, 290.12f, -200f, 40.46f, 0, false);
	}
	if (func_439(Local_386.f_28[2]))
	{
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_386.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(Local_386.f_28[2], -167.67f);
	}
	else
	{
		Local_386.f_28[2] = PED::CREATE_PED(6, iLocal_42, -1102.73f, 290.91f, -200f, 92.06f, 0, false);
	}
	if (!func_331())
	{
		func_330(PLAYER::PLAYER_PED_ID(), vLocal_53, fLocal_54, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_297(1);
...
int func_330(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_332(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_453() || !func_430())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_427(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_405(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_404(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105109.f_2890 };
			fParam2 = Global_105109.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, 1, 0, 0, false);
		func_398(vParam1, 5f, 0);
		if (func_152(iParam10))
		{
			func_396(iParam10, 0);
			while (!func_333(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_333(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_390(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_390(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_390(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_338(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_337(*iParam1);
				...
				func_335(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_335(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_335(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_336(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
int func_339(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_366(iVar0, bParam1, uParam2) && !func_365(PLAYER::PLAYER_ID())) && !func_349(iParam0))
	{
		return 0;
	}
...
int func_341(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_342(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_347(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_342(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_364(PLAYER::PLAYER_ID()) || func_363(PLAYER::PLAYER_ID()))
	{
		if (func_350(iParam0))
		{
			return 1;
...
int func_363(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_217())
			{
				return func_342(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_364(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_217())
			{
				return func_342(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_365(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_342(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_366(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_368(int iParam0, int iParam1)
{
	...
	func_369(iParam0, &(Global_111560.f_32744.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_370(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_283(iParam0, 0, 0)) || func_283(iParam0, 1, 0)) || func_283(iParam0, 2, 0)) || func_386(iParam0) != 145) || func_385(iParam0)) || func_384(iParam0)) || func_340(iParam0)) || func_383(iParam0)) || !func_373(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_384(iParam0))
		{
		}
...
int func_390(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_362(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_393(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_393(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_392(iParam0);
	if (func_391(*iParam0))
	{
...
void func_396(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_397(iParam0, iParam1))
				{
...
void func_398(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_403(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_399(int iParam0)
{
	...
	if (func_403(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_401(0, Global_75396.f_555[0 /*21*/].f_12) || !func_401(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_400(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_401(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_402(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_374(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_403(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_404(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_404(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_404(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_404(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_405(vector3 vParam0, float fParam1)
{
	return func_406(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_406(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_423(uParam0))
	{
		...
		if (func_422(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_411(iVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_396(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_396(uParam0->f_11, 2);
						}
					}
				...
				else if ((!func_408(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_408(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_410(iParam0, Global_75396.f_139[38], 0))
			{
				func_399(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_410(iParam0, Global_75396.f_139[43], 1))
			{
				func_399(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_410(iParam0, uVar1[iVar3], 1) && func_409(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_404(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_409(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_411(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_370(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_370(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_370(iVar1 + 1));
			}
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_414(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_413())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_390(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_370(iVar2 + 1)))
				{
...
int func_415(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_421(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_417(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
int func_423(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("STUNT") && func_409(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_424()
{
	return func_422(&(Global_105109.f_2890));
}

void func_425()
{
	func_426(&(Global_105109.f_2890));
}
...
int func_427(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_429(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_431(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 150)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_436(iParam0, 1, 1);
			func_436(iParam0, 2, 1);
		}
		else
		{
			if (func_435(iParam0, iParam1) == 1 && func_434(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_437(iParam0, iVar0, 1);
			func_436(iParam0, iVar0, 1);
		}
		if (bParam2)
		{
			if (!Global_76577)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_433(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_433(iParam0) };
...
void func_438()
{
	vLocal_53 = { -1102.906f, 284.731f, 63.0602f };
	fLocal_54 = 9.4866f;
	vLocal_55 = { -1140.98f, 297.59f, 65.89f };
	Local_47.f_10 = "Josh4CopRush";
	Local_47.f_11 = 0;
	Local_415[0 /*7*/] = { -1152.526f, 278.2318f, 65.69334f };
	Local_415[0 /*7*/].f_3 = { -1136.277f, 239.0551f, 69.44059f };
	Local_415[0 /*7*/].f_6 = 3.25f;
	Local_415[1 /*7*/] = { -1151.918f, 287.2276f, 66.04018f };
	Local_415[1 /*7*/].f_3 = { -1137.051f, 290.5453f, 70.0429f };
	Local_415[1 /*7*/].f_6 = 3.25f;
	Local_415[2 /*7*/] = { -1093.003f, 295.5289f, 63.11537f };
	Local_415[2 /*7*/].f_3 = { -1069.194f, 293.5286f, 67.53568f };
	Local_415[2 /*7*/].f_6 = 3.25f;
	Local_415[3 /*7*/] = { -1050.776f, 284.3935f, 63.15669f };
	Local_415[3 /*7*/].f_3 = { -1050.369f, 244.0945f, 67.86394f };
	Local_415[3 /*7*/].f_6 = 3.25f;
	Local_415[4 /*7*/] = { -1065.411f, 229.6216f, 61.88657f };
	Local_415[4 /*7*/].f_3 = { -1104.021f, 232.1321f, 68.14975f };
	Local_415[4 /*7*/].f_6 = 3.25f;
	vLocal_416[0 /*3*/] = { -1357.57f, 200.1279f, 58.075f };
	Local_417[0 /*4*/] = 0.0072f;
	Local_417[0 /*4*/].f_1 = 0.0163f;
	Local_417[0 /*4*/].f_2 = -0.5901f;
	Local_417[0 /*4*/].f_3 = 0.8071f;
	vLocal_416[1 /*3*/] = { -1219.035f, 401.5473f, 74.713f };
	Local_417[1 /*4*/] = -0.0145f;
	Local_417[1 /*4*/].f_1 = 0.0329f;
	Local_417[1 /*4*/].f_2 = -0.6893f;
	Local_417[1 /*4*/].f_3 = 0.7235f;
	vLocal_416[2 /*3*/] = { -1113.06f, 397.6948f, 69.1133f };
	Local_417[2 /*4*/] = -0.0155f;
	Local_417[2 /*4*/].f_1 = -0.04f;
	Local_417[2 /*4*/].f_2 = 0.7661f;
	Local_417[2 /*4*/].f_3 = -0.6413f;
	vLocal_416[3 /*3*/] = { -885.071f, 240.0283f, 71.7539f };
	Local_417[3 /*4*/] = -0.0576f;
	Local_417[3 /*4*/].f_1 = 0f;
	Local_417[3 /*4*/].f_2 = 0.5936f;
	Local_417[3 /*4*/].f_3 = 0.8027f;
	vLocal_416[4 /*3*/] = { -1020.495f, 121.0783f, 53.0567f };
	...
	if (func_331())
	{
		if (func_329(0, 1))
		{
			func_487("*** Opened Josh gate for replay");
		}
	}
	func_487("*** Set up coords");
}
...
void func_440(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_439(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_439(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_439(uParam0->f_41[iVar0]))
		{
...
int func_441(var uParam0)
{
	...
	switch (iLocal_37)
	{
		case 0:
			...
			func_451(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_37 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_445(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_444(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_439(uParam0->f_28[1]))
				{
			...
			{
				func_444(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_439(uParam0->f_28[2]))
				{
			...
			{
				func_443(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_442(&(uParam0->f_35[1]), 0);
...
void func_442(int iParam0, bool bParam1)
{
	...
	func_443(iParam0, iLocal_39, vVar0, fVar1);
...
void func_443(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_232(iParam0);
...
void func_444(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_233(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

int func_445(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_446(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_446(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_452(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_453())
	{
...
void func_454()
{
	...
	if (func_464())
	{
		func_487("...Random Character Script was triggered so additional cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= (Local_386.f_28 - 1))
	{
...
void func_465(bool bParam0)
{
	...
	if (!func_482())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_466(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_467(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_473())
	{
		...
		{
			iVar2 = func_468(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_469()
{
	...
	iVar0 = func_470(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_470(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_473()
{
	...
	{
		if (func_468(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_486(&(uParam0->f_28));
	func_486(&(uParam0->f_35));
	func_486(&(uParam0->f_41));
}
