...
int func_1()
{
	...
	switch (Local_139.f_1)
	{
		case 0:
			...
			else if (func_19(&(Local_139.f_10), Global_262145.f_12489, 0))
			{
				MISC::SET_BIT(&(Local_139.f_2), 4);
				func_18(2);
			}
		...
		case 1:
			...
			else
			{
				...
				else
				{
					...
					MISC::CLEAR_BIT(&(Local_139.f_2), 6);
				}
				...
				bVar1 = func_7();
				if (func_19(&(Local_139.f_12), Global_262145.f_12490, 0) || bVar1)
				{
					func_18(2);
					if (!bVar1)
					{
...
void func_2()
{
	...
	if (!MISC::IS_BIT_SET(Local_139.f_2, 5))
	{
		if (MISC::IS_BIT_SET(Local_139.f_2, 3))
		{
			Var0 = 564131320;
		...
		else if (MISC::IS_BIT_SET(Local_139.f_2, 2) || MISC::IS_BIT_SET(Local_139.f_2, 1))
		{
			Var2 = 564131320;
...
int func_4()
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_5(iVar2, 0, 0))
		{
			if (!MISC::IS_BIT_SET(vLocal_140[iVar1 /*3*/].f_2, 0))
			{
...
int func_7()
{
	if ((((MISC::IS_BIT_SET(Local_139.f_2, 0) || MISC::IS_BIT_SET(Local_139.f_2, 1)) || MISC::IS_BIT_SET(Local_139.f_2, 2)) || MISC::IS_BIT_SET(Local_139.f_2, 3)) || MISC::IS_BIT_SET(Local_139.f_2, 4))
	{
		return 1;
	}
	return 0;
...
void func_22()
{
	...
	if (!MISC::IS_BIT_SET(Local_139.f_2, 1) && !MISC::IS_BIT_SET(Local_139.f_2, 2))
	{
		iVar0 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(func_16());
		if (iVar0 >= 0 && iVar0 < 32)
		{
			if (MISC::IS_BIT_SET(vLocal_140[iVar0 /*3*/].f_2, 11))
			{
				MISC::SET_BIT(&(Local_139.f_2), 2);
				if (Local_139.f_1 == 0)
				{
...
int func_23()
{
	...
	STATS::_0x6DEE77AFF8C21BD1(&(Local_139.f_20), &(Local_139.f_21));
	...
	switch (vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		...
		case 1:
			if (func_678())
			{
				...
				if (bLocal_128)
				{
					if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 8))
					{
						func_636();
						MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 8);
					}
				}
				...
				if (MISC::IS_BIT_SET(Local_139.f_2, 6))
				{
					func_671(4);
				}
			}
			...
			if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 7))
			{
				func_569(-1, 0, 0, -1, 0, 0);
				MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 7);
			}
		...
		case 2:
			...
			if (func_678())
			{
				...
				if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 11))
				{
					func_863();
					return;
				}
			...
			else if (MISC::IS_BIT_SET(Local_139.f_2, 1))
			{
				if (func_633(NETWORK::PARTICIPANT_ID_TO_INT()))
				{
					if (!func_669(PLAYER::PLAYER_ID(), Local_139.f_5, 1))
					{
						func_638(7);
					}
				}
			...
			else if (MISC::IS_BIT_SET(Local_139.f_2, 2))
			{
				if (func_678())
				{
					func_638(12);
			...
			else if (MISC::IS_BIT_SET(Local_139.f_2, 3))
			{
				if (func_678())
				{
					if (func_81())
				...
				else if (Local_139.f_6 == PLAYER::PLAYER_ID())
				{
					if (func_669(PLAYER::PLAYER_ID(), func_16(), 0))
					{
						func_638(15);
			...
			else if (MISC::IS_BIT_SET(Local_139.f_2, 4))
			{
				if (func_678())
				{
					func_638(16);
...
int func_74(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_26(iParam1)];
...
int func_81()
{
	...
	if (!func_669(Local_139.f_6, Local_139.f_5, 0))
	{
		return 0;
	}
	return 1;
...
{
	if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 6))
	{
		if (iParam0 != func_11())
		{
			func_83(0, iParam0);
		...
		MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 6);
	}
}
...
void func_86()
{
	...
	Var0.f_18 = -1;
	Var0.f_19 = -1;
	if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 5))
	{
		if (MISC::IS_BIT_SET(Local_139.f_2, 3))
		{
			...
			MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 5);
		}
		else if (MISC::IS_BIT_SET(Local_139.f_2, 0))
		{
			if (func_669(PLAYER::PLAYER_ID(), func_16(), 1))
...
void func_128(struct<66> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
int func_201(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	int iVar0;
	struct<8> Var1;
...
void func_242(int iParam0, var uParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_258(struct<5> Param0, int iParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_259(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_275(char* sParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_105())
			{
				...
				iVar6 = func_290(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
			...
			else if (func_50(0))
			{
				...
				iVar20 = func_290(func_137(), Var14, *uParam3);
				if (Var14.f_1 == 1)
				{
...
void func_297(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_324()
{
	if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 7))
	{
		...
		MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 7);
	}
}

void func_325(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_444(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, char* sParam7)
{
	int iVar0;
	int iVar1[32];
	bool bVar2;
	...
	{
		if (func_516(iParam1, iParam2, uParam3, Global_1574182, 0, func_564(), sParam7))
		{
			func_515(1);
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 27)
						{
							...
							while (iVar17 < 32)
							{
								if (func_5(PLAYER::INT_TO_PLAYERINDEX(iVar17), 0, 1))
								{
									...
									if (!func_205(iVar3, 0))
									{
										if ((func_503(iVar3) || Global_2424073[iVar3 /*421*/].f_236 != -1) || func_12(iVar3))
										{
											iVar9 = iVar3;
											if (func_118(iVar3))
											{
												...
												iVar20++;
												iVar0++;
												func_502(&iVar1, iVar3, &iVar20, &iVar0);
											}
										}
									}
								}
						...
						while (iVar17 < 32)
						{
							...
							if ((func_499(iVar3) && func_495(iVar3, iParam2)) && func_5(iVar3, 0, 1))
							{
								iVar9 = iVar3;
								...
								*(uParam4[iVar17 /*13*/]) = { func_160(iVar3) };
								...
								if (iParam5 != -1)
								{
									func_479(&iVar8, &fVar10, (uParam0[iVar17 /*42*/])->f_9, iParam5);
								...
								iVar16 = func_476(iVar3, 0);
								if (bVar2)
								{
									if (func_241(iVar3, 1) && iVar1[iVar9] != -1)
									{
										iVar18 = iVar1[iVar9];
									}
									else
								...
								if (func_475(iParam5))
								{
									func_474(iVar3, iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar8, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
								else
								{
									func_474(iVar3, iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar11, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
							...
							if (func_499(iVar3))
							{
								if (func_5(PLAYER::INT_TO_PLAYERINDEX(iVar17), 0, 1))
								{
									...
									*(uParam4[iVar17 /*13*/]) = { func_160(iVar3) };
									...
									uParam3->f_38[iVar9 /*2*/].f_1 = iVar18;
									func_457(iVar3, PLAYER::GET_PLAYER_NAME(iVar3), iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar16, iVar15);
									iVar18++;
								}
							}
							iVar17++;
...
bool func_449(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
...
void func_457(int iParam0, char* sParam1, int iParam2, var uParam3, int iParam4, char* sParam5, var uParam6, var uParam7, var uParam8, char* sParam9, int iParam10, int iParam11, int iParam12)
{
	int iVar0;
	char* sVar1;
...
void func_474(int iParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, char* sParam16, int iParam17, int iParam18, bool bParam19)
{
	int iVar0;
	char* sVar1;
...
char* func_478(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	switch (iParam0)
	{
		case 0:
...
int func_479(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_483(iParam3))
	{
...
void func_488(int iParam0)
{
	...
	func_489(&(Global_1385294[iVar2 /*5*/]));
...
void func_491(var uParam0, char* sParam1)
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(uParam0, 35, sParam1);
}

struct<35> func_492(int iParam0)
{
	struct<13> Var0;
	struct<35> Var1;
...
int func_516(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, char* sParam6)
{
	struct<4> Var0;
	char* sVar1;
	bool bVar2;
	...
	if (func_21(&(uParam2->f_19)) || bParam5)
	{
		...
		else
		{
			...
			if (!MISC::IS_BIT_SET(uParam2->f_33, 0))
			{
				...
				HUD::THEFEED_SET_SCRIPTED_MENU_HEIGHT(fVar4);
				if (func_541(bVar3, iParam0, 0))
				{
					func_504(iParam0, 0, 0);
					sVar1 = func_538(iParam1, &(Global_4456448.f_154367), bParam4);
					Var0 = { func_536(iParam1) };
					if (bParam4)
					{
						func_533(iParam0, sVar1, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 26)
					{
					...
					{
						sVar6 = func_524(uParam2);
						if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam6))
						{
							sVar6 = sParam6;
						}
						func_522(iParam0, sVar6, func_523(), -1);
					}
					else if (func_463())
					{
						uParam2->f_34 = Global_1574183;
						func_533(iParam0, sVar1, &Var0, 1, -1, Global_1574183, 1);
					}
					else if (bVar2)
					{
						iVar5 = func_517(iParam1);
						uParam2->f_34 = Global_1574183;
						func_533(iParam0, sVar1, "", 0, iVar5, Global_1574183, 1);
					}
					else
					{
						iVar5 = func_517(iParam1);
						func_533(iParam0, sVar1, &Var0, 1, iVar5, -1, 1);
					}
...
void func_522(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
	{
...
void func_533(int iParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
char* func_538(int iParam0, char* sParam1, bool bParam2)
{
	var uVar0;
	
	if (iParam0 == 20 && (!func_463() || MISC::IS_STRING_NULL_OR_EMPTY(sParam1)))
	{
		uVar0 = func_539();
		return uVar0;
	}
...
bool func_541(bool bParam0, int iParam1, bool bParam2)
{
	if (bParam0)
	{
...
void func_569(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_579(func_580(joaat("trailersmall2"))))
		{
...
int func_572(int iParam0, int iParam1, var uParam2)
{
	int iVar0;
...
void func_591()
{
	...
	vVar1 = { ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false) };
...
int func_593(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_618(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
...
void func_630()
{
	...
	if (fVar2 < 25f)
	{
		...
		{
			fVar3 = (1f - (func_632(fVar2, 5f, 25f) / 25f));
			fVar4 = func_631(26f, 175f, fVar3);
		}
		PAD::SET_PAD_SHAKE(0, 1000, SYSTEM::ROUND(fVar4));
	}
}

float func_631(float fParam0, float fParam1, float fParam2)
{
	return (((1f - fParam2) * fParam0) + (fParam2 * fParam1));
}

float func_632(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_633(int iParam0)
{
	...
	if (!MISC::IS_BIT_SET(vLocal_140[iParam0 /*3*/].f_2, 0))
	{
		return 0;
	}
	return 1;
	...
	switch (iParam0)
	{
		...
		case 3:
			if (!MISC::IS_BIT_SET(iLocal_123, iParam0))
			{
				...
				{
					func_663();
					func_659(87, Local_139.f_5, -1, "GB_HTB_BMS3", "GB_WINNER", 1, -1, 2, 0);
					MISC::SET_BIT(&iLocal_123, iParam0);
				}
			}
			break;
...
int func_639(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	struct<80> Var0;
...
void func_652(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4)
{
...
char* func_653()
{
	...
	if (iVar0 != func_11())
	{
		...
		sVar1 = func_654(&(Global_1628955[iVar0 /*614*/].f_11.f_104));
...
char* func_655(int iParam0, bool bParam1)
{
	if (!bParam1)
	{
...
int func_659(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<80> Var0;
...
int func_661(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
char* func_662(int iParam0)
{
	...
	if (iVar1 != func_11())
	{
		sVar0 = func_654(&(Global_1628955[iVar1 /*614*/].f_11.f_104));
...
int func_664(char* sParam0, int iParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	if (!iParam2 == 0)
	{
...
int func_665(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	if (!iParam2 == 0)
	{
...
int func_666(char* sParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	if (!iParam2 == 0)
	{
...
void func_675(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	if (!iParam2 == 0)
	{
...
void func_676(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	if (!iParam2 == 0)
	{
...
void func_679()
{
	...
	if (func_21(&(Local_139.f_12)))
	{
		if (func_688(Local_139.f_12, (Global_262145.f_12490 - 35000), 0))
		{
			func_687(&iLocal_137, 3, 1);
		}
		if (func_688(Local_139.f_12, (Global_262145.f_12490 - 30000), 0))
		{
			func_687(&iLocal_137, 4, 1);
		}
		if (func_688(Local_139.f_12, (Global_262145.f_12490 - 27000), 0))
		{
			func_687(&iLocal_137, 5, 1);
		}
		if (func_688(Local_139.f_12, Global_262145.f_12490, 0))
		{
			func_687(&iLocal_137, 2, 1);
		}
	}
	if (func_685(PLAYER::PLAYER_ID(), Global_262145.f_12494, &uVar1, func_687(&iLocal_137, 13, -1), 1123024896, 0))
	{
		func_687(&iLocal_137, 13, 1);
	}
	else
	{
		func_687(&iLocal_137, 13, 0);
	}
	if (bLocal_129 || (!func_683() && !func_687(&iLocal_137, 13, -1)))
	{
		iVar0 = 0;
	}
	switch (func_682(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		...
		case 1:
			if (!func_687(&iLocal_137, 12, 1))
			{
				iLocal_138 = NETWORK::GET_NETWORK_TIME();
			}
			if (iVar0 && !func_687(&iLocal_137, 3, -1))
			{
				if (!func_687(&iLocal_137, 1, -1))
				{
					sVar2 = func_681(func_683(), "BG_HUNT_BOSS_DEFEND_START", "BG_HUNT_BOSS_ATTACK_START");
					if (AUDIO::PREPARE_MUSIC_EVENT(sVar2) && func_687(&iLocal_137, 11, -1))
					{
						AUDIO::TRIGGER_MUSIC_EVENT(sVar2);
						func_687(&iLocal_137, 1, 1);
					}
					if (!func_687(&iLocal_137, 11, -1))
					{
						func_680(1);
					}
				}
			}
			else if (func_687(&iLocal_137, 1, -1) && !func_687(&iLocal_137, 3, -1))
			{
				if (AUDIO::PREPARE_MUSIC_EVENT("BG_HUNT_STOP"))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("BG_HUNT_STOP");
					func_680(0);
					func_687(&iLocal_137, 1, 0);
				}
			}
			if (func_687(&iLocal_137, 3, -1))
			{
				if (func_687(&iLocal_137, 1, -1))
				{
			...
			if (func_687(&iLocal_137, 4, -1))
			{
				if ((!func_687(&iLocal_137, 7, -1) && !func_687(&iLocal_137, 5, -1)) && !(func_592() || iLocal_112 != 3))
				{
					if (AUDIO::PREPARE_MUSIC_EVENT("APT_COUNTDOWN_30S"))
					{
						AUDIO::SET_AUDIO_FLAG("AllowScoreAndRadio", 1);
						AUDIO::TRIGGER_MUSIC_EVENT("APT_COUNTDOWN_30S");
						func_687(&iLocal_137, 7, 1);
					}
				}
				if ((!func_687(&iLocal_137, 6, -1) && !func_687(&iLocal_137, 5, -1)) && func_687(&iLocal_137, 7, -1))
				{
					AUDIO::SET_USER_RADIO_CONTROL_ENABLED(0);
					func_687(&iLocal_137, 6, 1);
				}
			}
			break;
		
		case 2:
			if (!func_687(&iLocal_137, 8, -1) && func_687(&iLocal_137, 7, -1))
			{
				if (AUDIO::PREPARE_MUSIC_EVENT("APT_FADE_IN_RADIO"))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("APT_FADE_IN_RADIO");
					func_687(&iLocal_137, 8, 1);
				}
			}
			if (func_687(&iLocal_137, 1, -1))
			{
			...
			if (func_687(&iLocal_137, 7, -1) && !func_687(&iLocal_137, 2, -1))
			{
				if (AUDIO::PREPARE_MUSIC_EVENT("APT_COUNTDOWN_30S_KILL"))
				{
					func_687(&iLocal_137, 7, 0);
	...
	if (func_687(&iLocal_137, 6, -1) && (func_687(&iLocal_137, 5, -1) || func_682(NETWORK::PARTICIPANT_ID_TO_INT()) == 2))
	{
		AUDIO::SET_USER_RADIO_CONTROL_ENABLED(1);
		AUDIO::SET_AUDIO_FLAG("AllowScoreAndRadio", 0);
		func_687(&iLocal_137, 6, 0);
	}
	if (func_21(&(Local_139.f_16)) && func_688(Local_139.f_16, 10000, 0))
	{
		if (!func_687(&iLocal_137, 10, -1))
		{
			iLocal_136 = AUDIO::GET_SOUND_ID();
			AUDIO::PLAY_SOUND_FRONTEND(iLocal_136, "10s", "MP_MISSION_COUNTDOWN_SOUNDSET", false);
			func_687(&iLocal_137, 10, 1);
		}
	}
	else if (func_687(&iLocal_137, 10, -1))
	{
		AUDIO::STOP_SOUND(iLocal_136);
		iLocal_136 = -1;
		func_687(&iLocal_137, 10, 0);
	}
}
...
void func_680(bool bParam0)
{
	if (bParam0)
	{
		...
		func_687(&iLocal_137, 11, 1);
	}
	else
	{
		AUDIO::SET_AUDIO_FLAG("DisableFlightMusic", 0);
		AUDIO::SET_AUDIO_FLAG("WantedMusicDisabled", 0);
		func_687(&iLocal_137, 11, 0);
	}
}

char* func_681(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
int func_685(int iParam0, int iParam1, var uParam2, bool bParam3, float fParam4, bool bParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_688(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	if (iParam2 == -1)
	{
		return 1;
...
void func_689()
{
	switch (vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 1:
			if (func_678())
			{
				if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 3))
				{
					if (func_690(82, "GB_INTTXT_HBB", 2, 0, 0, 0, 0, 1, 0, 1))
					{
						MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 3);
					}
				}
			}
			else if (func_669(PLAYER::PLAYER_ID(), func_16(), 0))
...
int func_690(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
struct<4> func_691(int iParam0)
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_692(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_696(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_698(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
int func_702(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
		...
		case 1:
			...
			else if (func_633(NETWORK::PARTICIPANT_ID_TO_INT()))
			{
				if (!func_728("GB_HTB_OT3"))
				{
					...
					{
						func_712("GB_HTB_OT3", Local_139.f_5, "GB_BOSS_LC", iLocal_113, 0);
					}
				}
			}
			break;
...
void func_712(char* sParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
...
int func_713(char* sParam0, char* sParam1, char* sParam2, bool bParam3, var uParam4)
{
...
bool func_723(char* sParam0, char* sParam1, char* sParam2)
{
	if (!func_721())
	{
		return 0;
...
void func_727(char* sParam0, bool bParam1)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		return;
	...
	switch (func_682(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		...
		case 1:
			if (func_678())
			{
				if (func_21(&(Local_139.f_16)))
				{
					iVar0 = (20000 - func_736(&(Local_139.f_16), 0, 0));
					if (iVar0 > 0)
					{
			...
			if (func_21(&(Local_139.f_12)))
			{
				iVar0 = (Global_262145.f_12490 - func_736(&(Local_139.f_12), 0, 0));
				if (iVar0 > 0)
				{
...
void func_733(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)
{
	int iVar0;
	int iVar1;
...
int func_736(var uParam0, bool bParam1, bool bParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
void func_737()
{
	...
	switch (vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!func_17(Local_139.f_7))
			{
				if (func_669(PLAYER::PLAYER_ID(), func_16(), 1))
				{
					...
					{
						iLocal_121 = HUD::ADD_BLIP_FOR_RADIUS(Local_139.f_7, SYSTEM::TO_FLOAT((Global_262145.f_12494 - 1)));
					...
					if (func_753(Local_139.f_5) != iLocal_125)
					{
						iLocal_125 = func_753(Local_139.f_5);
		...
		case 1:
			...
			{
				func_751();
				if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
				{
					if (!func_21(&(Local_139.f_16)) && !func_21(&(Local_139.f_18)))
					{
						if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 2))
						{
							func_750(1, 0);
							MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 2);
						}
					}
					else if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 2))
					{
						func_750(0, 0);
						MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 2);
					}
				}
			}
			else
			{
				...
				if (!func_669(PLAYER::PLAYER_ID(), func_16(), 0))
				{
					if (bLocal_128)
					{
						if (vLocal_140[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_139.f_5) /*3*/].f_1 == 1 && !MISC::IS_BIT_SET(vLocal_140[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_139.f_5) /*3*/].f_2, 2))
						{
							if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 10))
							{
								func_747(Local_139.f_5, 432, 1, 0);
								func_745(Local_139.f_5, func_746(iLocal_113), 1, 0);
								if (func_5(func_16(), 1, 1))
								{
									func_738(Local_139.f_5, 1, 0, 0);
								}
								MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 10);
							}
						}
						else if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 10))
						{
							func_747(Local_139.f_5, 432, 0, 0);
							func_745(Local_139.f_5, func_746(iLocal_113), 0, 0);
							if (func_5(func_16(), 1, 1))
							{
								func_738(Local_139.f_5, 0, 0, 0);
							}
							MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 10);
						}
					}
				}
			}
...
void func_738(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	var uVar0;
...
int func_740(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
void func_745(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	var uVar0;
...
void func_749()
{
	if (MISC::IS_BIT_SET(vLocal_140[func_16() /*3*/].f_2, 4))
	{
		if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 9))
		{
			if (func_16() != func_137())
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Boss_Blipped", "GTAO_Magnate_Hunt_Boss_SoundSet", false);
				MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 9);
			}
		}
	}
	else if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 9))
	{
		MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 9);
	}
}
...
void func_751()
{
	...
	{
		vLocal_130 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	...
	else if (func_21(&uLocal_134))
	{
		...
		if (func_19(&uLocal_134, SYSTEM::ROUND(Global_262145.f_12493), 0))
		{
			func_8(&uLocal_134);
			MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 4);
	...
	else if (func_736(&uLocal_132, 0, 0) > (500 * iLocal_131))
	{
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_130) > IntToFloat(Global_262145.f_12491))
		{
			func_8(&uLocal_132);
			if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
			{
		...
		else if (IntToFloat(func_736(&uLocal_132, 0, 0)) > Global_262145.f_12492)
		{
			if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 2))
			{
				func_750(0, 0);
			...
			if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
			{
				MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 4);
			}
		}
		iLocal_131++;
	}
...
void func_752(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
int func_755(int iParam0, int iParam1, var uParam2, float fParam3, bool bParam4)
{
	int iVar0;
	float fVar1;
		...
		if (ENTITY::DOES_ENTITY_EXIST(Var4.f_1))
		{
			if (ENTITY::IS_ENTITY_A_PED(Var4.f_1))
			{
				...
				if (PED::IS_PED_A_PLAYER(iVar1))
				{
					...
					{
						if (MISC::IS_BIT_SET(vLocal_140[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar3) /*3*/].f_2, 0))
						{
							if (iVar3 != func_11())
							{
								if (func_5(iVar3, 0, 0))
...
void func_765()
{
	...
	if (!func_17(Local_139.f_7))
	{
		if (Local_139.f_1 >= 1 || func_137() == Local_139.f_5)
		{
			func_790(164, Local_139.f_7, &uLocal_127, 1140457472, 1144750080, 0);
		}
	...
	if (func_678())
	{
		if (func_780())
		{
			if (!MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 11))
			{
				MISC::SET_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 11);
			}
		}
	}
	switch (func_682(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		case 1:
			bLocal_129 = (func_68() || func_775(func_678()));
			if (bLocal_129)
			{
				if (MISC::IS_BIT_SET(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				{
					MISC::CLEAR_BIT(&(vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					if (func_678())
					{
						func_769(0, 0);
						func_768(2);
...
void func_790(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	...
	else
	{
		...
		if (*uParam2 && func_5(PLAYER::PLAYER_ID(), 1, 1))
		{
			*uParam2 = 0;
			...
			if (iParam5 && !func_78(PLAYER::PLAYER_ID()))
			{
...
void func_798(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	if (bParam0)
	{
		if (func_809())
...
void func_802(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_824(vector3 vParam0, int iParam1, int iParam2)
{
...
{
	vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = iParam0;
}
...
void func_832()
{
	iLocal_112 = func_63(PLAYER::PLAYER_ID());
	func_833(164, 1, -1, 0);
	iLocal_113 = func_210(Local_139.f_5, -2, 0, 0, 0);
	HUD::GET_HUD_COLOUR(iLocal_113, &(uLocal_126[0]), &(uLocal_126[1]), &(uLocal_126[2]), &(uLocal_126[3]));
}

void func_833(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	float fVar0;
...
{
	vLocal_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = iParam0;
}
...
void func_863()
{
	...
	Global_1674861.f_2 = Local_139.f_20;
	Global_1674861.f_3 = Local_139.f_21;
	func_908(Local_139.f_4, -1, -1, -1082130432);
	func_769(0, 0);
	func_864(0, 0);
...
bool func_878(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_908(var uParam0, int iParam1, int iParam2, int iParam3)
{
	char* sVar0;
	struct<14> Var1;
	struct<17> Var2;
...
int func_911(struct<21> Param0)
{
	func_956(func_957(Param0), Param0);
	func_915(164, 0, 0);
	NETWORK::RESERVE_NETWORK_MISSION_OBJECTS(0);
	func_912(0, -1, 0);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_139, 22);
...
void func_956(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_914();
