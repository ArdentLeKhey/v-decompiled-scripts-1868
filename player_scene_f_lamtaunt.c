	...
	while (iLocal_289 && func_138(2, 0))
	{
		...
		switch (iLocal_98)
		{
			...
			case 2:
				if (func_134())
				{
					func_133(&uLocal_100, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_133(&uLocal_100, 2, Global_98390, "LAMAR", 0, 1);
					iLocal_98 = 3;
				}
				break;
...
int func_2()
{
	...
	{
		func_126(&(iLocal_290[iVar0]), iVar0);
		iVar0++;
	}
	func_126(&Global_98390, iLocal_290);
	func_3(Global_98390);
	return 0;
}
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					if (!func_118(iVar2) || func_110(iVar2) == 6)
					{
						...
						if (func_41(Global_94433, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_369 = 1;
						}
					}
...
void func_39()
{
	...
	{
		if (func_34(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_40(PLAYER::PLAYER_PED_ID());
			if (func_36(iVar0) && (!func_24(14) || Global_110511))
			{
...
void func_47(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_49() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_49() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_55(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_49() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_86(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_19665)
	{
		if (Global_19486.f_1 == 6)
		{
			...
			func_88(1);
			func_91(Global_19467, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19466), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_95()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_96(Global_111560.f_14136[iVar2 /*104*/].f_18, Global_111560.f_14136[Global_21872 /*104*/].f_18))
		{
			Global_21872 = iVar2;
		}
		iVar2++;
...
int func_98(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_99(&(Var1[0 /*4*/]), iVar2))
			{
				iParam2 = 1;
			}
			else if (func_99(&(Var1[1 /*4*/]), iVar2))
			{
				iParam2 = 0;
			}
			else
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			if (func_98(iParam0, iParam1, 0, &(Var0[0 /*4*/])) && func_98(iParam0, iParam1, 1, &(Var0[1 /*4*/])))
			{
				...
				if (func_99(&(Var0[0 /*4*/]), iVar1))
				{
					iParam2 = 1;
				}
				else if (func_99(&(Var0[1 /*4*/]), iVar1))
				{
					iParam2 = 0;
				}
				else
...
int func_111(int iParam0, int iParam1)
{
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_111560.f_7683.f_919[func_112()])
		{
			return 5;
		}
	}
		...
		switch (iLocal_292[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_349, &(Local_359[iParam1 /*16*/]), 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96029) > fVar1)
					{
						if (func_132(vLocal_298[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
						...
						if (PED::IS_PED_INJURED(*iParam0))
						{
							...
							TASK::TASK_GO_STRAIGHT_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
			...
			case 1:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
			...
			case 2:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 713668775) != 1)
				{
					...
					TASK::TASK_WANDER_IN_AREA(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_365))
				{
					TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_365, false);
				}
				...
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					vVar6 = { func_127(vLocal_295 + vLocal_298[iParam1 /*3*/], func_130((fLocal_300[iParam1] * 0.9f), 10f, 100f), 0f) };
					...
					else if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar6, 0, &vVar7, 14))
					{
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar7, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_292[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_293, Global_93703);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_93703, iLocal_293);
...
Vector3 func_128(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_129(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
int func_134()
{
	...
	{
		func_126(&(iLocal_290[iVar1]), iVar1);
		iVar1++;
	}
	func_126(&Global_98390, iLocal_290);
	return 0;
...
int func_137()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96028))
	{
		...
		while (iVar0 < iLocal_290)
		{
			if (!PED::IS_PED_INJURED(iLocal_290[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_290[iVar0], Global_96028, &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			func_133(&uLocal_100, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_98390))
		{
			func_133(&uLocal_100, 4, Global_98390, "LAMAR", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_290[0]))
		{
			func_133(&uLocal_100, 5, iLocal_290[0], "GangMember1", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_290[1]))
		{
			func_133(&uLocal_100, 6, iLocal_290[1], "GangMember2", 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_138(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_139(Global_98390) && iParam1 != 0)
		{
			Global_98390 = 0;
		}
	}
...
void func_146()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_98390))
	{
		if (func_37(19) == ENTITY::GET_ENTITY_MODEL(Global_98390))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98390, true, 1);
		}
		func_147(&Global_98390, Global_93703);
	...
	while (iVar0 < iLocal_290)
	{
		if (iLocal_291[iVar0] != 0)
		{
			...
			TASK::TASK_PLAY_ANIM(iLocal_290[iVar0], &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
...
void func_148()
{
	...
	func_152(iLocal_99, &vLocal_295, &fLocal_296, &cVar0);
	func_150(iLocal_99, &sLocal_301, &cLocal_317, &cLocal_333, &uVar1, &uVar2);
	switch (iLocal_99)
	{
		case 218:
		...
		case 225:
			...
			Local_360 = { func_149("FRAS_IG_10", 3) };
			fLocal_363 = 0f;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[0];
			StringCopy(sParam2, func_158(Global_111560.f_2358.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[1];
			StringCopy(sParam2, func_158(Global_111560.f_2358.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[2];
			StringCopy(sParam2, func_158(Global_111560.f_2358.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_159()
{
	...
	if (!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_365))
	{
		TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_365, true);
	}
