...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (func_2(iLocal_34, PLAYER::PLAYER_PED_ID(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (func_2(iLocal_34, PLAYER::PLAYER_PED_ID(), 1) > 100f)
				{
					func_3(2);
					return;
				}
...
{
	func_6(&(Global_105109.f_2890), vParam0, fParam1);
}
...
{
	if (func_8(Global_76817, 0f, 0f, 0f, 0))
	{
...
void func_13(int iParam0)
{
	...
	if (Global_111560.f_9080 || func_28(0))
	{
		iVar0 = func_27();
		if (!func_14(iVar0))
		{
...
int func_14(int iParam0)
{
	...
	func_15(&(Global_111560.f_2358.f_539), iVar1);
...
void func_15(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_17(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
...
void func_29()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_34, false);
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
				{
					TASK::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
	...
	if (iLocal_54 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 1))
				{
...
void func_32(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_28(0) && Global_76823.f_1 == 1) && func_33(Global_76823))
		{
		}
		else
		{
...
void func_35()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_39, 0))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_39, -1);
				}
			}
			else
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1565.084f, 2780.813f, 16.4022f, 1, false, 0, 1);
			...
			if (func_20() == 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
					{
						if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
						{
							PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, -1);
						}
						ENTITY::FREEZE_ENTITY_POSITION(iLocal_34, false);
					}
				}
	...
	switch (iLocal_28)
	{
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				...
				iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), vLocal_118, fLocal_122, true, true, false);
				VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(iLocal_34, 0);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_34, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_34, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
				VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(joaat("BUZZARD")))
				{
					...
					iLocal_35[0] = VEHICLE::CREATE_VEHICLE(joaat("BUZZARD"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, true, true, false);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_35[0], true, 1);
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(iLocal_35[0], 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_35[0], 1084227584);
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_39))
				{
					if (func_108())
					{
						if (!VEHICLE::IS_THIS_MODEL_A_HELI(func_107()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_107()))
						{
							...
							VEHICLE::SET_VEHICLE_STRONG(iLocal_39, true);
						}
					}
				}
			}
		...
		case 3:
			...
			{
				iLocal_31[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_35[0], 26, joaat("s_m_m_pilot_02"), -1, 1, true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_pilot_02"));
			}
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
			{
				PED::SET_PED_INTO_VEHICLE(iLocal_31[0], iLocal_35[0], -1);
			}
		...
		case 4:
			...
			{
				MISC::CLEAR_AREA(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, true, true, false);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_34, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
				VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_34, true, true, 0);
				VEHICLE::SET_HELI_BLADES_FULL_SPEED(iLocal_34);
		...
		case 5:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				...
				iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), 1749.61f, 3272.95f, 40.1533f, 51.128f, true, true, false);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_34, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
			...
			{
				iLocal_36[0] = VEHICLE::CREATE_VEHICLE(joaat("SANDKING"), 1754.951f, 3290.994f, 40.1176f, 182.397f, true, true, false);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_36[0], true);
...
{
	return func_39(&(Global_105109.f_2890), vParam0, fParam1, 0);
}
...
int func_71(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_8(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_75(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_77(iParam0, uVar1[iVar3], 1) && func_76(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_8(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_marine_01")) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_pilot_02")))
		{
			...
			while (iLocal_55 <= 12)
			{
				if (iLocal_97[iLocal_55] == 0)
				{
					...
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_32[iLocal_55], true, 1);
...
void func_102(var uParam0, int iParam1)
{
	...
	while (iVar0 < 16)
	{
		if (Global_73719[iVar0 /*2*/] == 0)
		{
			Global_73719[iVar0 /*2*/] = uParam0;
			Global_73719[iVar0 /*2*/].f_1 = iParam1;
			if (iVar0 == Global_73752)
			{
				Global_73752++;
			}
			return;
...
bool func_104()
{
	return func_98(&(Global_105109.f_2890));
}

void func_105()
{
	func_106(&(Global_105109.f_2890));
}
...
bool func_108()
{
	return func_99(&(Global_105109.f_2890));
}
...
void func_116()
{
	if (!func_36())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1738.131f, 3283.38f, 40.1261f, 1, false, 0, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_35[0], 0);
	}
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[0], 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], true, 1);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_95196[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_95196[1]))
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[1], 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[1], true, 1);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_95196[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_95196[2]))
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[2], 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_95196[2]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_118, true) > 800f)
						{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_125() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_149(&uLocal_198, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_119, 2f, 2f, 2f, true, true, 0))
					{
					}
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
...
void func_150(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_214(&(Global_98669.f_3));
				if (iVar6 > -1)
				{
...
{
	func_152(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_170(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_172(Var7.f_1)) && iVar9 < 51)
			{
...
Vector3 func_187(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_197(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_137())
			{
...
int func_221(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_222(Global_111560.f_9080.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_222(Global_111560.f_9080.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_222(Global_111560.f_9080.f_99.f_205[11]);
			break;
		
		case 90:
			return func_222(Global_111560.f_9080.f_99.f_205[7]);
			break;
		
		case 93:
			return func_222(Global_111560.f_9080.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_228()
{
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	...
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_119, true) > 550f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
			{
				VEHICLE::DELETE_VEHICLE(&(iLocal_36[0]));
...
void func_233()
{
	iLocal_37 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 300f, joaat("LAZER"), 4);
	iLocal_38 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 300f, joaat("LAZER"), 16386);
	...
	if (iLocal_28 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
				{
					vLocal_121 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							{
								vLocal_120 = { ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true) };
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							{
								TASK::TASK_ENTER_VEHICLE(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							TASK::TASK_HELI_MISSION(0, iLocal_35[0], 0, 0, vLocal_120.x, vLocal_120.y, (vLocal_120.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							TASK::TASK_HELI_MISSION(0, iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1f, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_367);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_31[0], iLocal_367);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_367);
							iLocal_81[0] = 1;
						}
					}
				}
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_31[0]))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
						{
							...
							else if (MISC::GET_GAME_TIMER() > iLocal_67 + 10000 && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
							{
								if (iLocal_104 == 0)
								{
									PED::SET_PED_ACCURACY(iLocal_31[0], 100);
							...
							if (func_2(iLocal_35[0], PLAYER::PLAYER_PED_ID(), 1) < 300f)
							{
								if (iLocal_106 == 0)
								{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_35[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_35[0], ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true), 1, 1)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
								{
									if (!PED::IS_PED_INJURED(iLocal_31[0]))
									{
										TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
...
void func_235()
{
	if (iLocal_85 == 0)
	{
		if ((((func_236(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 0, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, 0, true, 0))
		{
			iLocal_85 = 1;
		}
	}
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_55]))
				{
					if (!PED::IS_PED_INJURED(iLocal_32[iLocal_55]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0) || iLocal_87 == 1)
								{
									if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											TASK::CLEAR_PED_TASKS(iLocal_32[iLocal_55]);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_32[iLocal_55], ENTITY::GET_ENTITY_COORDS(iLocal_32[iLocal_55], true), 50f, 0, 0);
											TASK::TASK_COMBAT_PED(iLocal_32[iLocal_55], PLAYER::PLAYER_PED_ID(), 0, 16);
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										TASK::CLEAR_PED_TASKS(iLocal_32[iLocal_55]);
										TASK::OPEN_SEQUENCE_TASK(&iLocal_367);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_34, true), 2f, -1, 20f, 0, 1193033728);
								...
								else
								{
									...
									if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) > 41f && func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 400f)
									{
										if (iLocal_94[iLocal_55] == 0)
										{
											...
											if (iLocal_74 == 0)
											{
												TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 25f, 2f, 1073741824, 0);
											}
											else if (iLocal_74 == 1)
											{
		...
		if (((iLocal_85 == 0 && iLocal_98 == 0) && iLocal_109 == 0) && iLocal_86 == 0)
		{
			...
			while (iLocal_72 <= 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_72]))
				{
					...
					{
						if (func_2(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								if (!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_32[iLocal_72]))
								{
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_32[iLocal_72]);
								}
								else
								{
									TASK::CLEAR_PED_TASKS(iLocal_32[iLocal_72]);
								}
								TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), -1, 0);
						...
						else if (func_2(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), 1) > 30f)
						{
...
void func_237()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_95196[0]))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[0], 0))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], true, 1);
					iLocal_34 = Global_95196[0];
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(iLocal_34, 0);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_34, true, 1);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_95196[1]))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[1], 0))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[1], true, 1);
					iLocal_35[0] = Global_95196[1];
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(iLocal_35[0], 1);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_35[0], true, 1);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_35[0], false);
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_35[0], 0);
				}
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_95196[2]))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[2], 0))
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_95196[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
					func_245(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_95196[2])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_95196[2]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_95196[2]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_95196[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
	...
	if (iLocal_54 == 1)
	{
			...
			if (MISC::GET_GAME_TIMER() > iLocal_61 + 3000)
			{
				...
				while (iLocal_63 <= 12)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_63]))
					{
						...
						{
							if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_63], 1) < 40f)
							{
								if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_63], PLAYER::PLAYER_PED_ID()))
								{
									...
									if (iLocal_114 == 0)
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_242(0))
										{
									...
									else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_242(0))
									{
										if (func_241(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
										{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_34, 1) < 30f)
				{
					iLocal_87 = 1;
				}
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
...
{
	MISC::CLEAR_BIT(&Global_94554, iParam0);
}
...
void func_245(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_254(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_251(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_246(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_247(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_203();
			}
...
void func_255()
{
	if (iLocal_54 == 0)
	{
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_44, -472287501);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, iLocal_44);
...
void func_256()
{
	...
	ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1747.04f, 3267.456f, 40.246f, 1, false, 0, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
	{
		...
		iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, true, true, false);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34))
					{
						if (func_262(PLAYER::PLAYER_PED_ID(), iLocal_34) == -1)
						{
...
void func_263()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_236(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_118, true) > 1000f)
			{
				PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
				PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
			}
	...
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_64]))
			{
				...
				{
					if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID()))
					{
						if (func_2(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID(), 1) < 40f)
						{
						...
						if (func_2(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (func_241(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
							{
				...
				if (!PED::IS_PED_INJURED(iLocal_32[iLocal_71]))
				{
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_125())
						{
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_71], PLAYER::PLAYER_PED_ID()))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_242(0))
										{
											if (func_241(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[0]))
												{
													...
													{
														if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[0], 1) < 30f)
														{
												...
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[1]))
												{
													...
													{
														if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[1], 1) < 30f)
														{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_267(iParam2), 1);
}
...
int func_269()
{
	...
	while (iLocal_59 <= 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_59]))
		{
			...
			{
				if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_59], 1) < 25f)
				{
					return 1;
				}
			}
