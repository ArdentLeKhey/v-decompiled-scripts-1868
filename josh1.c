...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_345(58);
	iLocal_79 = joaat("FELON2");
	vLocal_88 = { -1106.999f, 288.96f, 63.4f };
	vLocal_89 = { 0f, 0f, 12.06f };
	...
	if (func_308())
	{
		Global_76822 = 1;
		iLocal_77 = 0;
		while (!func_296(&Local_81))
		{
			SYSTEM::WAIT(0);
		}
		func_295(&Local_81, 0, 1);
		Global_76822 = 0;
	}
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_277(Local_81.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_82)
		{
			case 0:
				func_268();
...
void func_1()
{
	switch (iLocal_83)
	{
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
					ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
					PED::_0x2208438012482A1A(Local_81.f_28[0], 1, 0);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
						func_231(&uLocal_97, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
						func_231(&uLocal_97, 5, Local_81.f_28[0], "Josh", 0, 1);
						if (func_216(&uLocal_97, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, -8f, 1);
					}
					iLocal_96 = 1;
				}
				if (func_215(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_293(Local_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_28[0], -8f, 1);
						TASK::CLEAR_PED_TASKS(Local_81.f_28[0]);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
		...
		case 2:
			...
			if (func_293(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
					...
					TASK::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (iLocal_96 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -668482597, false, 0, 1);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
...
void func_235(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_241(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	...
	switch (iLocal_83)
	{
		case 0:
			if (func_260(1, 1093140480, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, false, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, false, 0);
				MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0);
				iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				if (func_259(iVar0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, true, 0))
					{
				...
				func_249(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar2, 3f, 6f, 3f, 1, 1, 1, 0, 0);
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -1871534317, false, 1, 1);
						iLocal_94 = 1;
					}
				}
			}
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::_0x2208438012482A1A(Local_81.f_28[0], 0, 0);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
int func_245(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_246(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_249(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_250(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_250(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_254(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_254(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_255(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_255(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_255(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_255(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_255(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_255(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_255(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_255(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_255(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_255(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_255(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_255(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_255(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_255(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_255(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_255(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_255(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_266(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_266(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_268()
{
	...
	{
		case 0:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
						{
							iLocal_86 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_86))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_86) > 0.15f)
					{
						if (!iLocal_91)
						{
							if (func_216(&uLocal_97, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
					...
					if (func_215(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 2.5f)
					{
...
void func_270()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_266(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_277(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_279(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_280(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_290(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_292(iParam0, Global_41396);
}
...
void func_298(int iParam0, bool bParam1)
{
	...
	func_299(iParam0, iLocal_79, vVar0, fVar1);
...
void func_299(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_300(iParam0);
...
int func_301(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_302(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_302(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_309()
{
	...
	func_321(&(Local_81.f_28[0]), 1, 1, 1);
	func_310(&Local_81, 1, 0, 0);
...
int func_327()
{
	...
	iVar0 = func_328(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_331()
{
	...
	{
		if (func_326(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
