...
void func_105()
{
	...
	StringCopy(&Local_204, "PBAM", 8);
	StringCopy(&Local_205, "ANDYMOON", 16);
	StringCopy(&Local_202, "Special_Ped@andy_moon", 64);
	StringCopy(&Local_203, "Base", 64);
	bLocal_265 = !Global_3;
	iLocal_218 = 15;
	sLocal_226 = "PBAM_INTERACT";
	StringCopy(&Local_231, "PBAM_CONV_GM", 16);
	StringCopy(&Local_232, "PBAM_CONV_GT", 16);
	StringCopy(&Local_233, "PBAM_CONV_GF", 16);
	StringCopy(&cLocal_234, "special_ped@andy_moon@base", 64);
	StringCopy(&cLocal_243, "special_ped@andy_moon@intro", 64);
	iLocal_217 = 0;
	iLocal_221[0] = 6;
	iLocal_221[1] = 7;
	iLocal_221[2] = 6;
