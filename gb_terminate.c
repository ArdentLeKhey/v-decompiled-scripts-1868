...
void func_37()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_41() < 2)
		{
			if (MISC::IS_BIT_SET(Local_115[iVar2 /*4*/].f_1, 1))
			{
				func_38(PLAYER::INT_TO_PLAYERINDEX(iVar2));
				MISC::SET_BIT(&(Local_114.f_1), 1);
			}
			if (MISC::IS_BIT_SET(Local_115[iVar2 /*4*/].f_1, 4))
			{
				func_38(func_11());
				MISC::SET_BIT(&(Local_114.f_1), 7);
			}
			if (MISC::IS_BIT_SET(Local_115[iVar2 /*4*/].f_1, 0))
			{
				MISC::SET_BIT(&(Local_114.f_1), 0);
			}
			if (MISC::IS_BIT_SET(Local_115[iVar2 /*4*/].f_1, 2))
			{
				MISC::SET_BIT(&(Local_114.f_1), 4);
			}
		}
		...
		{
			if (MISC::IS_BIT_SET(Local_115[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
...
void func_95()
{
	switch (func_627())
	{
		...
		case 2:
			if (!MISC::IS_BIT_SET(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
			{
				func_401(0, func_10());
				func_310();
				func_96();
...
void func_96()
{
	...
	if (!MISC::IS_BIT_SET(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
	{
		...
		{
			MISC::SET_BIT(&(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
			return;
		}
		if (func_309())
		{
		...
		{
			func_97(151, MISC::IS_BIT_SET(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 1), &Var0, 0);
		}
		MISC::SET_BIT(&(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
	}
}
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_119(iParam2)];
	if (iVar0 != 0)
	{
...
int func_118(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_119(iParam1)];
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_121())
			{
				...
				iVar6 = func_270(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
							...
							if (func_462(iVar3))
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar17), 0, 1))
								{
									...
									*(uParam4[iVar17 /*13*/]) = { func_174(iVar3) };
									...
									uParam3->f_38[iVar9 /*2*/].f_1 = iVar18;
									func_418(iVar3, PLAYER::GET_PLAYER_NAME(iVar3), iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar16, iVar15);
									iVar18++;
								}
							}
							iVar17++;
	...
	else
	{
		...
		if (*uParam2 && func_9(PLAYER::PLAYER_ID(), 1, 1))
		{
			*uParam2 = 0;
			...
			if (iParam5 && !func_433(PLAYER::PLAYER_ID()))
			{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(Var0) && ENTITY::IS_ENTITY_A_PED(Var0)) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var0) == PLAYER::GET_PLAYER_PED(func_36()))
		{
			if (Var0.f_3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && ENTITY::IS_ENTITY_A_PED(Var0.f_1))
				{
					...
					{
						MISC::SET_BIT(&(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 1);
					}
				}
			}
		}
...
void func_573(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		...
		else if (HUD::DOES_BLIP_EXIST(Global_2416074[iVar0]))
		{
			...
			HUD::SET_BLIP_FLASHES(Global_2416074[iVar0], true);
	...
	if (!bParam1)
	{
		...
		{
			func_574(iParam0);
			HUD::SET_BLIP_FLASHES(Global_2416074[iVar0], false);
		}
	}
}
...
void func_607()
{
	...
	if (PLAYER::PLAYER_ID() != func_59())
	{
		if (MISC::IS_BIT_SET(iLocal_112, 0))
		{
			if (!func_343())
			{
				...
				func_609(sVar0, PLAYER::GET_PLAYER_NAME(func_36()), 0, -1);
				func_608(1);
		...
		else
		{
			...
			MISC::SET_BIT(&(Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
		}
	}
	else if (MISC::IS_BIT_SET(iLocal_112, 0))
	{
		if (!func_343())
		{
			...
			func_609(sVar3, PLAYER::GET_PLAYER_NAME(func_36()), 0, -1);
			MISC::SET_BIT(&iLocal_112, 2);
			func_608(1);
		}
	}
...
{
	Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 = iParam0;
}
...
int func_627()
{
	return Local_115[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2;
}
