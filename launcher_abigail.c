...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_292(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_275(&Var0, 1);
	}
	iVar3[0] = 0;
	iVar3[1] = 1;
	if (!func_272(&iVar3, &Var0, vVar1, 1f))
	{
		func_271();
	...
	while (true)
	{
		...
		func_213(Var0);
		func_206(&iLocal_56, &(Var0.f_9), vVar1);
		switch (Var0)
		{
			case 0:
			...
			case 1:
				func_188(&Var0, vVar1, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_173(&Var0, 0))
		{
...
int func_188(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
	...
	if (func_127(*uParam1) && func_127(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				{
					TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_194(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
				...
				if (!func_146())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "loop_talk") > 0.99f)
						{
							...
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
...
{
	if ((func_250() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_255(iParam0);
...
int func_256(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_257(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_272(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_273((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_273((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_273(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_274(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_274(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
