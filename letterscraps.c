				...
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!func_20())
					{
						if (((!AUDIO::IS_MOBILE_PHONE_CALL_ONGOING() && !func_14()) && !func_13()) && !func_12())
						{
							...
							iLocal_55 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("LETTER_SCRAPS");
...
int func_15(int iParam0)
{
	...
	if (!MISC::ARE_STRINGS_EQUAL(&(Global_110212[iParam0 /*28*/]), "") && !MISC::IS_STRING_NULL(&(Global_110212[iParam0 /*28*/])))
	{
		if (MISC::IS_BIT_SET(Global_110212[iParam0 /*28*/].f_27, 1))
		{
			...
			{
				return func_19(iVar0, &(Global_110212[iParam0 /*28*/]), &(Global_110212[iParam0 /*28*/].f_4), Global_110212[iParam0 /*28*/].f_20);
			}
			else
			{
				return func_18(iVar0, &(Global_110212[iParam0 /*28*/]), &(Global_110212[iParam0 /*28*/].f_4));
			}
		}
		else if (MISC::IS_BIT_SET(Global_110212[iParam0 /*28*/].f_27, 2))
		{
			return func_17(iVar0, &(Global_110212[iParam0 /*28*/]), Global_110212[iParam0 /*28*/].f_20);
		}
		else
		{
			return func_16(iVar0, &(Global_110212[iParam0 /*28*/]));
		}
	}
	return 0;
}

int func_16(int iParam0, char* sParam1)
{
...
int func_18(int iParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
int func_19(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(iParam2);
...
void func_24(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7)
{
	...
	if (*uParam0)
	{
		...
		{
			case 0:
				*iParam5 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MIDSIZED_MESSAGE");
...
int func_26(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_111560.f_10044.f_108, func_32(func_33(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_40(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_55((uParam1[iVar0 /*11*/])->f_1))
			{
	...
	{
		if ((SYSTEM::VDIST2(vParam2, OBJECT::GET_PICKUP_COORDS((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
...
void func_52(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 == 1)
	{
		if (iParam1 <= 31)
		{
			if (bParam2)
			{
				MISC::SET_BIT(&(Global_111560.f_10044.f_122), iParam1);
			}
			else
			{
				MISC::CLEAR_BIT(&(Global_111560.f_10044.f_122), iParam1);
			}
			return;
		}
		if (bParam2)
		{
			MISC::SET_BIT(&(Global_111560.f_10044.f_122.f_1), (iParam1 - 32));
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_111560.f_10044.f_122.f_1), (iParam1 - 32));
		}
	}
	else if (iParam0 == 0)
	{
		if (iParam1 <= 31)
		{
			if (bParam2)
			{
				MISC::SET_BIT(&(Global_111560.f_10044.f_125), iParam1);
			}
			else
			{
				MISC::CLEAR_BIT(&(Global_111560.f_10044.f_125), iParam1);
			}
			return;
		}
		if (bParam2)
		{
			MISC::SET_BIT(&(Global_111560.f_10044.f_125.f_1), (iParam1 - 32));
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_111560.f_10044.f_125.f_1), (iParam1 - 32));
		}
	}
}
...
void func_64()
{
	...
	Global_111560.f_10044.f_122.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
		Local_50[iVar0 /*11*/].f_3 = { func_65(iVar0, 0) };
...
void func_75()
{
	...
	Global_111560.f_10044.f_122.f_2 = 0;
	iVar0 = 0;
