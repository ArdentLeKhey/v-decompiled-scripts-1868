...
void __EntryFunction__()
{
	...
	vLocal_60 = { ScriptParam_530.f_1[0 /*3*/] };
	func_401();
	if (func_360(vLocal_60, 11, iLocal_153, 0, 0))
	{
		func_355(11);
	}
	else
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_58 > 1)
		{
			...
			if (iLocal_58 > 0)
			{
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_83, 0))
				{
					...
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_510, 1862763509);
						if (func_1(iLocal_78))
						{
...
void func_3()
{
	if ((iLocal_178 == 0 && func_1(iLocal_83)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3))
	{
...
void func_4()
{
	...
	if (func_1(iLocal_83))
	{
		...
		TASK::TASK_SMART_FLEE_PED(iLocal_83, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
void func_18()
{
	...
	{
		if (func_21(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_20(PLAYER::PLAYER_PED_ID());
			if (func_19(iVar0) && (!func_23(14) || Global_110511))
			{
...
void func_39()
{
	...
	sVar2 = "RECHA_THX";
	sVar3 = "RECHA_THX_1";
	if (func_1(PLAYER::PLAYER_PED_ID()) && func_1(iLocal_83))
	{
		switch (iLocal_152)
		{
			case 0:
				if (!STREAMING::_0x07C313F94746702C(iLocal_525))
				{
					iLocal_525 = STREAMING::FORMAT_FOCUS_HEADING(ENTITY::GET_ENTITY_COORDS(iLocal_83, true), 200f, 12, 127);
				}
				...
				if (!func_1(iLocal_92) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_92 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
					VEHICLE::SET_LAST_DRIVEN_VEHICLE(iLocal_92);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_225(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1093140480, 1, 1056964608, 0, 1, 0))
				{
				}
				else
				{
			...
			case 1:
				...
				func_218(0);
				func_217();
				if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !func_216()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_169)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_wallet_01")))
				{
					if (iLocal_523 == -1)
					{
					...
					if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83) || (MISC::GET_GAME_TIMER() - iLocal_523) > 2000)
					{
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_127, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						fLocal_132 = ENTITY::GET_ENTITY_HEADING(iLocal_83);
						vVar0 = { vLocal_131 };
						vVar0.z = (vVar0.z + 50f);
						MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
						vVar1 = { ENTITY::GET_ENTITY_ROTATION(iLocal_83, 2) };
						iLocal_150 = PED::CREATE_SYNCHRONIZED_SCENE(vVar0, vVar1, 2);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_150, false);
						...
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_150, sLocal_169, sLocal_170, 1000f, -1000f, 1, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_83);
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_83, iLocal_150, sLocal_169, sLocal_171, 1000f, -1000f, 1, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(iLocal_83, 0, 0);
						WEAPON::HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER::PLAYER_PED_ID(), true);
						iVar4 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(335.98f, -839.47f, 28.31f, 10f, joaat("prop_rub_binbag_03b"), 1, 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar4))
						{
							ENTITY::SET_ENTITY_COORDS(iVar4, 317.94f, -824.33f, 28.27f, 1, false, 0, 1);
						}
						func_100(&iVar4, 0);
						iVar4 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(336.86f, -840.08f, 28.27f, 10f, joaat("prop_rub_binbag_05"), 1, 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar4))
						{
							ENTITY::SET_ENTITY_COORDS(iVar4, 315.63f, -826.01f, 28.27f, 1, false, 0, 1);
						}
						func_100(&iVar4, 0);
						MISC::CLEAR_AREA_OF_OBJECTS(vVar0, 20f, 2);
						MISC::CLEAR_AREA_OF_PROJECTILES(vVar0, 20f, 0);
						MISC::CLEAR_AREA_OF_VEHICLES(vVar0, 5f, 0, 0, 0, 0, false, 0);
						MISC::CLEAR_AREA(vVar0, 2f, 1, 0, 0, false);
						MISC::CLEAR_AREA(PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_169, sLocal_171, vVar0, vVar1, 0, 2), 2f, 1, 0, 0, false);
						CAM::SET_CAM_ACTIVE(iLocal_151, true);
						CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
						switch (func_17())
						{
							case 0:
								func_99(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
								func_98(&uLocal_345, "REAR1AU", "REAR1_REM", "REAR1_REM_1", 4, 0, 0);
								break;
							
							case 1:
								func_99(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
								func_98(&uLocal_345, "REAR1AU", "REAR1_REF", "REAR1_REF_1", 4, 0, 0);
								break;
							
							case 2:
								func_99(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			case 2:
				...
				if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_150) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_150) == 1f) || func_94()) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -571081548))
				{
					...
					func_76(1, 0, 1, 1);
					func_41(func_17(), 1, SYSTEM::FLOOR((IntToFloat(iLocal_149) * 0.9f)));
				...
				else
				{
					...
					{
						if ((ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_127, PLAYER::PLAYER_PED_ID()) && iLocal_179 == 0) && func_98(&uLocal_180, "RECHAAU", sVar2, sVar3, 4, 0, 0))
						{
							ENTITY::DETACH_ENTITY(iLocal_127, 0, true);
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_127, iLocal_83, PED::GET_PED_BONE_INDEX(iLocal_83, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							iLocal_179 = 1;
						}
					}
					else
...
void func_45(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_47() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_47() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_49(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_53(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_47() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_49(iParam1)];
...
int func_60(int iParam0, int iParam1)
{
	...
	if (func_70(&Global_4269915))
	{
		if (func_68(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_61(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_64(var uParam0)
{
	...
	func_66(uParam0, (Global_4269914 - 0.5f));
}
...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_57 != 0 && iLocal_57 != joaat("OBJECT")) && iLocal_57 != joaat("GADGET_PARACHUTE"))
		{
			...
			{
				if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_57, 0))
				{
...
void func_90()
{
	...
	{
		func_92(iLocal_83, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 2f, 1f), fLocal_132, 1, 1);
		PED::_0x2208438012482A1A(iLocal_83, 0, 0);
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_150(iVar10, iParam1, iParam2, -1) };
		if (!func_149(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_150(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_150(iVar10, 14, uVar12[iVar1], -1) };
							func_123(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_145(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_113(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_145(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_150(iVar10, iVar0, func_112(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_150(iVar10, 14, uVar15[iVar1], -1) };
			func_123(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_145(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_113(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_104(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_214(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76389[1 /*14*/] = { func_150(iParam0, iParam1, iParam2, -1) };
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_214(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_130(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_138(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_138(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_138(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_145(int iParam0)
{
	...
	{
		func_148(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_152(int iParam0)
{
	...
	func_153(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_54(func_156(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_54(func_155(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_54(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_214(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76389[1 /*14*/] = { func_150(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_214(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_214(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_150(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_214(iParam0, 14, iVar4))
										{
											if (!func_109(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_150(iVar0, iVar2, iVar1, -1) };
						if (!func_109(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_113(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_113(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_230()
{
	if (func_1(iLocal_83))
	{
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 1, 0))
		{
			func_231();
			iLocal_58 = 6;
		}
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 50f, 50f, 20f, 0, 1, 0))
			{
				func_2(2);
				func_422();
			}
		}
		else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 30f, 30f, 20f, 0, 1, 0))
		{
			iLocal_144 = 1;
		}
		else if (fLocal_146 > -1f)
		{
			if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_60) > (fLocal_146 + 120f))
			{
				func_2(2);
				func_422();
			}
...
void func_234(int iParam0)
{
	if (func_1(iParam0))
	{
		if (func_1(PLAYER::PLAYER_PED_ID()))
		{
			if ((PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0) && func_1(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0))) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0), -1, 0) == iParam0)
			{
		...
		{
			TASK::TASK_SMART_FLEE_COORD(iParam0, ENTITY::GET_ENTITY_COORDS(iParam0, true), 150f, -1, 0, 0);
		}
	...
	if (func_1(iLocal_83))
	{
		...
		switch (iLocal_75)
		{
			case 0:
				if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 30f, 30f, 30f, 0, 0, 0) && func_98(&uLocal_180, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0))
					{
						iLocal_75++;
					}
				}
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, 0, 0, 0) && func_5(&uLocal_180, "RECHAAU", "RECHA_WT", 4, 0, 0, 0))
				{
					iLocal_75++;
				}
				break;
...
void func_237()
{
	if (!PED::IS_PED_FACING_PED(iLocal_83, PLAYER::PLAYER_PED_ID(), 20f) && !func_93(iLocal_83, -875674219))
	{
...
void func_239()
{
	if (iLocal_67 == 0 && func_1(iLocal_83))
	{
		if (iLocal_64 == 1)
		{
			if ((!func_216() && SYSTEM::TIMERA() > 8000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, 0, 0, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
		...
		else if (PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83))
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, 0, 0, 0))
				{
		...
		else if (SYSTEM::TIMERA() > 1000)
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(iLocal_83, iLocal_136);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_136);
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, 0, 0, 0) && func_5(&uLocal_180, "RECHAAU", "RECHA_SRDN", 4, 0, 0, 0))
			{
				iLocal_64 = 1;
			}
			SYSTEM::SETTIMERA(0);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_241(iParam2), 1);
}
...
void func_242()
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_520))
	{
		...
		bLocal_65 = true;
		fLocal_146 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_60);
	...
	{
		func_244(2);
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_176) > 150f)
		{
			func_243();
		}
	}
...
void func_248()
{
	...
	if (iLocal_68 == 1)
	{
		...
		if (func_1(iLocal_83) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_521, "pickup_low", 3))
		{
			EVENT::REMOVE_ALL_SHOCKING_EVENTS(0);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
			if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_83, vLocal_131, 1f, 1f, 2f, false, true, 0))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_131, 1f, 20000, 1048576000, 0, 1193033728);
			}
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_136);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_83, iLocal_136);
	...
	else if ((((bLocal_65 == 0 && OBJECT::DOES_PICKUP_EXIST(iLocal_520)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, OBJECT::GET_PICKUP_COORDS(iLocal_520), 15f, 15f, 2f, false, true, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3))
	{
		STREAMING::REQUEST_ANIM_DICT(sLocal_521);
		vVar0 = { OBJECT::GET_PICKUP_COORDS(iLocal_520) - Vector(15f, 15f, 15f) };
		vVar1 = { OBJECT::GET_PICKUP_COORDS(iLocal_520) + Vector(15f, 15f, 15f) };
		if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_521) && !PED::IS_ANY_PED_SHOOTING_IN_AREA(vVar0, vVar1, 0, 1))
		{
			iLocal_67 = 1;
			if (!func_93(iLocal_83, 242628503))
			{
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_520), 2f, 20000, 1048576000, 0, 1193033728);
				}
				TASK::TASK_TURN_PED_TO_FACE_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_520), 0);
				TASK::TASK_PLAY_ANIM(0, sLocal_521, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_136);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_83, iLocal_136);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_136);
			}
...
void func_250()
{
	...
	else if (func_299())
	{
		...
		iLocal_520 = OBJECT::CREATE_PICKUP(joaat("PICKUP_MONEY_WALLET"), vLocal_176, iLocal_163, iLocal_149, 1, iLocal_168);
		func_247();
	...
	else
	{
		...
		else
		{
			...
			if (((((iLocal_69 == 0 && func_1(PLAYER::PLAYER_PED_ID())) && !func_216()) && func_1(iLocal_86)) && func_255(PLAYER::PLAYER_PED_ID(), iLocal_86, 1) < 30f) && func_5(&uLocal_180, "RECHAAU", "RECHA_SPOT", 4, 0, 0, 0))
			{
				iLocal_69 = 1;
			}
		}
...
void func_251()
{
	if ((func_1(iLocal_83) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, 474215631) == 7)
	{
		if (MISC::IS_BULLET_IN_AREA(vLocal_60, 50f, 0))
		{
			func_224(0);
...
void func_252()
{
	if (func_1(iLocal_83))
	{
		if (PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83) && iLocal_73 > 1)
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 8f, 8f, 8f, 0, 1, 0) && PED::IS_PED_FACING_PED(iLocal_83, PLAYER::PLAYER_PED_ID(), 40f))
				{
		...
		{
			case 0:
				if (((iLocal_147 == 0 && !func_216()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_GET", 4, 0, 0, 0))
				{
					iLocal_147 = 1;
				}
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, -2017877118) == 7 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, 242628503) == 7)
				{
			...
			case 1:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_74) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 2;
					iLocal_73++;
			...
			case 2:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_74) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 3;
					iLocal_73++;
			...
			case 3:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 4;
					iLocal_73++;
			...
			case 4:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 15f, 15f, 15f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0))
				{
					iLocal_162 = 5;
					iLocal_73++;
				}
...
int func_253()
{
	if (func_1(iLocal_83))
	{
		if (func_254())
		{
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83, iLocal_78, 20f, 20f, 10f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_83, iLocal_78, 17))
				{
					return 1;
				}
			}
			else if (((ENTITY::DOES_ENTITY_EXIST(iLocal_78) && ENTITY::IS_ENTITY_DEAD(iLocal_78, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, ENTITY::GET_ENTITY_COORDS(iLocal_78, false), 20f, 20f, 10f, false, true, 0)) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_83, iLocal_78, 17))
			{
				return 1;
			}
		}
...
int func_254()
{
	if (!PED::IS_PED_INJURED(iLocal_78))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_78, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
...
void func_257()
{
	...
	{
		case 0:
			if ((func_1(iLocal_78) && func_1(iLocal_79)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_86, true, true, 0);
				PED::FORCE_PED_MOTION_STATE(iLocal_78, -1115154469, false, 0, 0);
				iLocal_59 = 1;
			}
			else
			{
		...
		case 1:
			if ((func_1(iLocal_78) && func_1(iLocal_79)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_78, iLocal_86, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
					if (iLocal_153 == 2)
					{
					}
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_86, PLAYER::PLAYER_PED_ID(), 8, 25f, 786724, -1f, -1f, 1);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_136);
		...
		case 2:
			if (iLocal_61 == 0)
			{
				if (!PED::IS_PED_INJURED(iLocal_78) && !PED::IS_PED_INJURED(iLocal_79))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
					{
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_86, vLocal_87, 30f, 30f, 5f, false, true, 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, 0))
						{
		...
		case 3:
			...
			if (((((((iLocal_71 < 4 && (MISC::GET_GAME_TIMER() - iLocal_72) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_216()) && !PED::IS_PED_INJURED(iLocal_78)) && func_255(PLAYER::PLAYER_PED_ID(), iLocal_78, 1) < 40f) && func_5(&uLocal_180, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0))
			{
				iLocal_71++;
				iLocal_72 = MISC::GET_GAME_TIMER();
			}
...
void func_258()
{
	if (((((((iLocal_141 == 1 && (MISC::GET_GAME_TIMER() - iLocal_76) > 8000) && !func_216()) && func_1(iLocal_78)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_78, 20f, 20f, 20f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_78, iLocal_83, 30f, 30f, 30f, 0, 1, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0))
	{
		iLocal_76 = MISC::GET_GAME_TIMER();
	}
}
...
int func_262()
{
	...
	iLocal_138 = 0;
	iVar3 = 10;
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89[1], 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_90[0]))
		{
			func_240(iLocal_90[0], "GENERIC_FUCK_YOU", 24);
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_90[0], -1273030092) == 1)
			{
				if (!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_90[0]))
				{
					TASK::TASK_DRIVE_BY(iLocal_90[0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
				}
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_90[1]))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_90[1], -1273030092) == 1)
			{
				if (!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_90[1]))
				{
					TASK::TASK_DRIVE_BY(iLocal_90[1], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
				}
			}
		}
		return 1;
	...
	else
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("HEXER")))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (VEHICLE::_0xA4822F1CF23F4810(&vVar2, &vVar0, &vVar1, 0f, 180f, 75f, false, 1, 1))
				{
					iLocal_138 = 0;
					while (iLocal_138 < 2)
					{
						vVar0.x = (vVar0.x + SYSTEM::TO_FLOAT(iLocal_138));
						iLocal_89[iLocal_138] = VEHICLE::CREATE_VEHICLE(joaat("HEXER"), vVar0, vVar1.z, true, true, false);
						iLocal_90[iLocal_138] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_89[iLocal_138], 22, iLocal_164, -1, 1, true);
						iLocal_91[iLocal_138] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_89[iLocal_138], 22, iLocal_164, 0, 1, true);
						...
						{
							TASK::TASK_VEHICLE_MISSION(iLocal_90[iLocal_138], iLocal_89[iLocal_138], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar3, 40f, 786469, 5f, 10f, 1);
						}
						else
						{
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_90[iLocal_138], iLocal_89[iLocal_138], PLAYER::PLAYER_PED_ID(), iVar3, 40f, 786469, 5f, 10f, 1);
						}
						...
						TASK::TASK_DRIVE_BY(iLocal_91[iLocal_138], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 0, -753768974);
...
int func_264()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_86, 0))
		{
			return 1;
		}
		if (func_1(iLocal_78))
		{
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_78, PLAYER::PLAYER_PED_ID(), 1))
			{
				return 1;
			}
			...
			if ((iLocal_59 == 1 && !PED::IS_PED_IN_VEHICLE(iLocal_78, iLocal_86, 1)) && !VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_86, 0, 0, false))
			{
				return 1;
			}
		}
		...
		if (func_1(iLocal_79))
		{
			...
			if (!PED::IS_PED_IN_VEHICLE(iLocal_79, iLocal_86, 0))
			{
				return 1;
			}
		}
...
int func_265()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_86, 20f, 20f, 10f, 0, 1, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_86, PLAYER::PLAYER_PED_ID(), 1))
			{
				iLocal_139++;
...
void func_266()
{
	if (iLocal_62 == 0)
	{
		if ((func_1(iLocal_78) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, 0)) && !PED::IS_PED_IN_COMBAT(iLocal_78, 0))
		{
			TASK::TASK_DRIVE_BY(iLocal_78, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
		}
		if ((((func_1(iLocal_79) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_79, -1273030092) == 1) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_79)) && !PED::IS_PED_IN_COMBAT(iLocal_79, 0))
		{
			TASK::TASK_DRIVE_BY(iLocal_79, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 30f, 60, 1, -753768974);
			TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_79, 40f);
		}
		if ((func_1(iLocal_80) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_80, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_80, 242628503) == 7)
		{
			TASK::TASK_DRIVE_BY(iLocal_80, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
		}
		if ((func_1(iLocal_81) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_81, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_81, 242628503) == 7)
		{
...
int func_267()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
	{
		if (((VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_86, 0, 0) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_86, 1, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_86, 4, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_86, 5, 0))
		{
			return 1;
		}
	}
...
int func_275(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_282() || func_281(Global_4456448.f_190930)) || func_280())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
...
int func_276(int iParam0)
{
	if (iParam0 != func_11())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_277(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
	...
	switch (uParam0->f_5)
	{
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_289(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_299()
{
	if (ENTITY::IS_ENTITY_DEAD(iLocal_78, 0) && ENTITY::GET_ENTITY_SPEED(iLocal_78) < 1f)
	{
		return 1;
	}
	return 0;
...
int func_303()
{
	...
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_86, fLocal_522, fLocal_522, fLocal_522, 0, 0, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_86))
		{
			return 1;
		}
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_78, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_78, fLocal_522, fLocal_522, fLocal_522, 0, 0, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_78))
		{
			return 1;
		}
	}
...
void func_304()
{
	if (iLocal_145 == 1)
	{
		if (func_1(iLocal_83) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3))
		{
		...
		if (func_1(iLocal_78))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0) && !func_264())
			{
	...
	else
	{
		...
		if (func_1(iLocal_83))
		{
			if ((!func_216() && func_5(&uLocal_180, "RECHAAU", "RECHA_STO", 4, 0, 0, 0)) || func_255(PLAYER::PLAYER_PED_ID(), iLocal_83, 1) < 20f)
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
				TASK::TASK_PLAY_ANIM(0, sLocal_515, sLocal_516, 8f, -4f, 8200, 0, 0, 0, 0, 0);
				if (func_1(iLocal_78))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 10f, 10f, 10f, 0, 1, 0))
					{
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					}
					else
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_131, 2f, 20000, 2f, 8192, 1193033728);
					TASK::TASK_PLAY_ANIM(0, sLocal_518, sLocal_519, 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				TASK::CLOSE_SEQUENCE_TASK(iLocal_136);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_83, iLocal_136);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_136);
				if (func_1(iLocal_78))
				{
					TASK::TASK_PLAY_ANIM(iLocal_78, sLocal_515, sLocal_517, 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				iLocal_145 = 1;
			}
		}
...
void func_306()
{
	...
	if (func_1(iLocal_78))
	{
		TASK::TASK_SMART_FLEE_PED(iLocal_78, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	if (func_1(iLocal_79))
	{
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, 0))
		{
	...
	if (func_1(iLocal_81))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_81, 0))
		{
			TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
		}
		TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
...
void func_307()
{
	...
	else
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_86, 25f, 25f, 25f, 0, 0, 0) && ENTITY::GET_ENTITY_SPEED(iLocal_86) > 5f)
			{
...
{
	return MISC::IS_BIT_SET(Global_111556, iParam0);
}
...
int func_314(int iParam0)
{
	if (func_316())
	{
		...
		if (func_315(Global_111549))
		{
			func_244(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_315(Global_111549))
		{
...
int func_316()
{
	switch (func_317(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_322()
{
	...
	if (iLocal_153 == 1)
	{
		...
		fVar2 = 167.5f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, fVar2, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_154, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar1, fVar2, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar1, fVar2, joaat("WEAPON_RPG"), 0)) || PED::IS_PED_INJURED(iLocal_78))
		{
			return 1;
		}
	}
	else if (iLocal_153 == 2)
	{
		...
		fVar2 = 100f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, fVar2, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_155, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar1, fVar2, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar1, fVar2, joaat("WEAPON_RPG"), 0)) || PED::IS_PED_INJURED(iLocal_78))
		{
			return 1;
		}
	}
	else if (iLocal_153 == 3)
	{
		...
		fVar2 = 96.75f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, fVar2, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_131, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar1, fVar2, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar1, fVar2, joaat("WEAPON_RPG"), 0)) || PED::IS_PED_INJURED(iLocal_78))
		{
			return 1;
		}
	}
...
void func_336()
{
	...
	MISC::CLEAR_AREA(vLocal_84, 20f, 1, 0, 0, false);
	iLocal_83 = PED::CREATE_PED(26, iLocal_165, vLocal_84, fLocal_85, 1, true);
	...
	{
		iLocal_133 = VEHICLE::CREATE_VEHICLE(iLocal_167, vLocal_134, fLocal_135, true, true, false);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_133, 1084227584);
		VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_133, 0);
	...
	iLocal_78 = PED::CREATE_PED(26, iLocal_164, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_83, vLocal_177), fLocal_82, 1, true);
	iLocal_86 = VEHICLE::CREATE_VEHICLE(iLocal_166, vLocal_87, fLocal_88, true, true, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_86, 1084227584);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_166, true);
	VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_86, 1);
	VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_86, 1);
	VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_86, true, true, 0);
	PED::ADD_RELATIONSHIP_GROUP("re_chasethieves badGuys", &iLocal_510);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_510, 1862763509);
	switch (iLocal_153)
	{
		case 1:
			iLocal_79 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, -1, 1, true);
		...
		case 3:
			...
			{
				iLocal_80 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, 1, 1, true);
				iLocal_81 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, 2, 1, true);
	...
	if (func_17() == 0)
	{
		func_99(&uLocal_180, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		iLocal_69 = 1;
		iLocal_71 = 9;
		iLocal_70 = 1;
	}
	if (func_17() == 1)
	{
		func_99(&uLocal_180, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		iLocal_69 = 1;
		iLocal_71 = 9;
		iLocal_70 = 1;
	}
	if (func_17() == 2)
	{
		func_99(&uLocal_180, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		iLocal_69 = 0;
		iLocal_71 = 0;
		iLocal_70 = 0;
	}
	...
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_86, 1, 0, false);
	}
	...
	if (iLocal_153 == 2)
	{
		PED::GIVE_PED_HELMET(iLocal_78, 1, 4096, -1);
		vVar1[0 /*3*/] = { 381.5702f, -867.3578f, 28.1573f };
		vVar1[1 /*3*/] = { 379.5334f, -867.1062f, 28.1713f };
		fVar2[0] = 236.3457f;
		fVar2[1] = 232.1922f;
		iLocal_138 = 0;
		while (iLocal_138 <= 1)
		{
			iVar0[iLocal_138] = VEHICLE::CREATE_VEHICLE(iLocal_166, vVar1[iLocal_138 /*3*/], fVar2[iLocal_138], true, true, false);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iVar0[iLocal_138], 1084227584);
			iLocal_138++;
		}
	}
	if (iLocal_153 == 3)
	{
		iLocal_137 = PED::ADD_SCENARIO_BLOCKING_AREA(1608.8f, 4824.81f, 0f, 1730.9f, 4856.1f, 51.1f, 0, 1, 1, 1);
		MISC::CLEAR_AREA_OF_PEDS(1973.98f, 4817.32f, 41.53f, 10f, 0);
	}
	MISC::SET_BIT(&iLocal_159, 5);
	MISC::SET_BIT(&iLocal_159, 4);
	MISC::SET_BIT(&iLocal_159, 0);
	MISC::SET_BIT(&iLocal_159, 1);
	if (iLocal_511 == 0)
	{
		iLocal_511 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101, vLocal_60, 60000f);
	}
}
...
int func_338()
{
	...
	if ((((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_512) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_515)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_518)) && VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_166)) && func_339(&Local_526))
	{
		return 1;
	}
	return 0;
...
int func_360(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_394(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_392()) || Global_110607) || Global_30738) || func_391()) || func_25(8, -1)) || func_390()) || func_389()) || func_388()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_392()) || Global_30738) || func_391()) || func_25(8, -1)) || func_388()) || func_390()) || func_389()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_392()) || Global_110607) || Global_30738) || func_391()) || func_25(8, -1)) || func_388()) || func_390()) || func_389()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_392()) || Global_110607) || Global_30738) || func_391()) || func_25(8, -1)) || func_390()) || func_389()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_392() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_25(8, -1)) || func_387()) || func_386()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_392()) || Global_30738) || func_391()) || func_25(8, -1)) || func_389()) || func_388()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_392()) || func_389()) || Global_110607) || Global_30738) || func_391()) || Global_42561) || func_25(8, -1)) || func_388()) || func_386()) || func_387()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_392()) || Global_110607) || Global_30738) || func_391()) || func_25(8, -1)) || func_388()) || func_386()) || func_390()) || func_389()) || func_387())
						{
							return 0;
						}
						break;
...
Vector3 func_401()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_154, true);
		iLocal_153 = 1;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_155, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_155, true);
			iLocal_153 = 2;
		}
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_156, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_156, true);
			iLocal_153 = 3;
		}
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_157, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_157, true);
			iLocal_153 = 4;
		}
		if (iLocal_153 == 1)
		{
...
void func_402()
{
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_137, 0);
	...
	if (func_1(iLocal_83))
	{
		...
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_83, 1);
		if (((iLocal_152 == 0 && iLocal_68 == 0) && !func_93(iLocal_83, 1805844857)) && !PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83))
		{
			TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_83, "WORLD_HUMAN_STAND_MOBILE", 0, 0);
			PED::_0x2208438012482A1A(iLocal_83, 0, 0);
		}
...
void func_403(int iParam0)
{
	...
	if (func_415())
	{
		...
		func_407(30000);
		StringCopy(&cVar0, func_406(Global_111549, 1), 64);
		if (func_405(Global_111549) > 0)
		{
...
int func_415()
{
	if ((Global_111549 == func_358() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
void func_425()
{
	...
	{
		func_72(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
