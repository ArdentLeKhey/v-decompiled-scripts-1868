...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_29[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_27[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_24[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_14()
{
	switch (Global_30977)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_20[Global_30979]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_20[Global_30979]))
					{
						Global_30980 = 0;
					}
					else
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_22[Global_30979]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_22[Global_30979]))
					{
						Global_30980 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_23[Global_30979]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_23[Global_30979]))
					{
						Global_30980 = 0;
					}
					else
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	iLocal_23[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)
{
	...
	iLocal_22[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_HEALTH_STANDARD"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	iLocal_21[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_WEAPON_PETROLCAN"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_20[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_ARMOUR_STANDARD"), func_39(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
