...
void func_8(bool bParam0)
{
	...
	while (iVar0 < Local_1298)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_1298[iVar0 /*2*/]))
		{
			...
			else
			{
				...
				{
					ENTITY::DETACH_ENTITY(Local_1298[iVar0 /*2*/], 1, true);
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1299))
	{
		...
		else
		{
			...
			{
				ENTITY::DETACH_ENTITY(iLocal_1299, 1, true);
			}
...
int func_23()
{
	...
	if (iLocal_90)
	{
		...
		{
			case 1:
				if ((((((iLocal_1282 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_1295)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1295, 0)) && ENTITY::DOES_ENTITY_EXIST(vLocal_1285.x)) && !PED::IS_PED_INJURED(vLocal_1285.x)) && PED::IS_PED_IN_VEHICLE(vLocal_1285.x, Local_1295, 0)) && func_134(&(Local_1079[0 /*8*/])))
				{
				...
				else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_1296) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1296, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1296, Local_1295))
				{
					...
					{
						VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_1296, 5f, -1, 0);
						iLocal_89 = 101;
					}
				}
				...
				else if (iLocal_1282 == 0)
				{
					...
					if (func_98(&iLocal_1080, vVar0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1295, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1295, 0), 0, 1, -1))
					{
						iLocal_89 = 101;
					}
					if (HUD::DOES_BLIP_EXIST(iLocal_1080) && HUD::DOES_BLIP_HAVE_GPS_ROUTE(iLocal_1080))
					{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_63(iParam2), 1);
}
...
int func_115(int iParam0)
{
	if (iParam0 != func_32())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_116(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_137()
{
	...
	if (iLocal_1282 == 2)
	{
		if ((((!ENTITY::DOES_ENTITY_EXIST(Local_1295) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1295, 0)) || (ENTITY::DOES_ENTITY_EXIST(Local_1298[0 /*2*/]) && !func_94(Local_1298[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1298[1 /*2*/]) && !func_94(Local_1298[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1298[2 /*2*/]) && !func_94(Local_1298[2 /*2*/])))
		{
			iLocal_1282 = 3;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_190(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_187(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_157(iParam0, 0, 0)) || func_157(iParam0, 1, 0)) || func_157(iParam0, 2, 0)) || func_180(iParam0) != 145) || func_156(iParam0)) || func_155(iParam0)) || func_154(iParam0)) || func_153(iParam0)) || !func_143(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_155(iParam0))
		{
		}
...
void func_192()
{
	...
	{
		if (func_194(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_201()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_1319)
		{
			func_204(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1);
			func_203(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1);
			iLocal_1319 = 1;
		}
	}
	else if (iLocal_1319)
	...
	if (iLocal_88 == 0)
	{
		...
		{
			case 0:
				if ((ENTITY::DOES_ENTITY_EXIST(vLocal_1285.x) && !PED::IS_PED_INJURED(vLocal_1285.x)) && func_134(&(Local_1079[0 /*8*/])))
				{
					if (Local_1079[0 /*8*/].f_1 == 1)
					{
						if (func_202(PLAYER::PLAYER_PED_ID(), Local_1295, 1) > 500f)
						{
							func_307(1);
						}
					}
					...
					{
						if (func_202(PLAYER::PLAYER_PED_ID(), Local_1295, 1) > 250f)
						{
							func_307(1);
						}
					}
					else if (func_202(PLAYER::PLAYER_PED_ID(), Local_1295, 1) > 250f)
					{
						func_307(2);
					}
				}
			...
			case 2:
				if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_BRIEFCASE"), 0))
				{
					if (((((ENTITY::DOES_ENTITY_EXIST(Local_1298[0 /*2*/]) && func_202(PLAYER::PLAYER_PED_ID(), Local_1298[0 /*2*/], 1) > 250f) && ENTITY::DOES_ENTITY_EXIST(Local_1298[1 /*2*/])) && func_202(PLAYER::PLAYER_PED_ID(), Local_1298[1 /*2*/], 1) > 250f) && ENTITY::DOES_ENTITY_EXIST(Local_1298[2 /*2*/])) && func_202(PLAYER::PLAYER_PED_ID(), Local_1298[2 /*2*/], 1) > 250f)
					{
						func_307(3);
					}
				}
...
void func_205()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1295))
	{
		if (((!func_199(Local_1295) && ENTITY::IS_ENTITY_DEAD(Local_1295, 0)) && iLocal_1314) && func_202(Local_1295, PLAYER::PLAYER_PED_ID(), 1) > 200f)
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1295);
		}
	}
		...
		else
		{
			...
			switch (iLocal_88)
			{
				case 0:
					...
					if (MISC::ARE_STRINGS_EQUAL(&Global_95561, "jhp2a_main"))
					{
...
void func_213(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_173(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
...
int func_217(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_242(iVar0, bParam1, uParam2) && !func_241(PLAYER::PLAYER_ID())) && !func_225(iParam0))
	{
		return 0;
	}
...
{
	if (func_240(PLAYER::PLAYER_ID()) || func_239(PLAYER::PLAYER_ID()))
	{
		if (func_226(iParam0))
		{
			return 1;
...
int func_247(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_238(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_250(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_250(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_249(iParam0);
	if (func_248(*iParam0))
	{
...
void func_252(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_255(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_254())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_182(iVar2 + 1)))
				{
...
int func_256(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_262(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_258(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
int func_263(int iParam0, var uParam1)
{
	...
	{
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam0 /*98*/] == uParam1->f_66 && MISC::GET_HASH_KEY(&(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam0 /*98*/].f_27)) == MISC::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	{
		if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam0 /*98*/] == uParam1->f_66 && MISC::GET_HASH_KEY(&(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam0 /*98*/].f_27)) == MISC::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
...
int func_267(bool bParam0)
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_84)) && STREAMING::HAS_MODEL_LOADED(iLocal_85))
	{
		...
		{
			func_276(&uLocal_94, iLocal_83);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_83) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_95561))
			{
				if (MISC::ARE_STRINGS_EQUAL(&Global_95561, "jhp2a_main"))
				{
					TASK::WAYPOINT_RECORDING_GET_COORD(&Global_95561, 23, &vVar1);
					...
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1295, 1084227584);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_95561, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					TASK::WAYPOINT_RECORDING_GET_COORD(&Global_95561, 29, &vVar1);
					MISC::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, false, 0);
					Local_1295 = VEHICLE::CREATE_VEHICLE(iLocal_83, vVar1, 134.0011f, true, true, false);
					vLocal_1285.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1295, 26, iLocal_82, -1, 1, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1295, 1084227584);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_95561, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1295))
...
void func_284()
{
	if (bLocal_93 && (func_285() || CAM::IS_SCREEN_FADED_OUT()))
	{
		func_8(1);
		SCRIPT::TERMINATE_THIS_THREAD();
	}
...
void func_286()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1284, joaat("COP"));
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1284, -183807561);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), iLocal_1284);
	...
	func_288(88);
	func_272(&uLocal_1105, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	func_287();
	if (MISC::IS_STRING_NULL_OR_EMPTY(&Global_95561))
	{
	}
			...
			switch (uParam0->f_1)
			{
				case 1:
					...
					if (((((iLocal_1305 >= 3 || ENTITY::IS_ENTITY_DEAD(iLocal_1299, 0)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1295, 2)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1295, 3)) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1295, 2) > 0f) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1295, 3) > 0f)
					{
						...
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1295, 2, 0, false);
						}
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1295, 3))
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1295, 3, 0, false);
						}
						iLocal_1315 = 0;
						iLocal_1316 = 0;
				...
				case 3:
					if (func_295(Local_1295))
					{
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1295, 2))
						{
							...
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1295, 2, 1, false);
						...
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1295, 3))
						{
							...
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1295, 3, 1, false);
...
void func_299(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (bParam1)
		{
			vVar0 = { func_300(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
...
void func_302(var uParam0)
{
	...
	if (!func_135(uParam0))
	{
		if (((!ENTITY::DOES_ENTITY_EXIST(vLocal_1285.x) || PED::IS_PED_INJURED(vLocal_1285.x)) || (ENTITY::DOES_ENTITY_EXIST(Local_1295) && func_202(Local_1295, vLocal_1285.x, 1) > 200f)) || (!PED::IS_PED_IN_ANY_VEHICLE(vLocal_1285.x, 0) && func_202(Local_1295, vLocal_1285.x, 1) > 200f))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1295, 0))
			{
				VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1295, 0);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1285);
			func_298(uParam0);
		}
		else
		{
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					vVar1 = { func_300(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(Local_1295, true)) };
			...
			{
				case 1:
					if ((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1295, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1285.x, PLAYER::PLAYER_PED_ID(), 1)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1285.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1295)) || iLocal_1301 > 0)
					{
						iLocal_1307 = 0;
						iLocal_1308 = 0;
						StringCopy(&cLocal_1309, "", 24);
					...
					else
					{
						...
						if (!func_304(vLocal_1285.x, -235832601, 1))
						{
							...
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_95561, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
				...
				case 2:
					...
					else if (!func_304(vLocal_1285.x, -235832601, 1))
					{
						...
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
						}
					}
					break;
				
				case 3:
					if (((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1295, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1285.x, PLAYER::PLAYER_PED_ID(), 1)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1285.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1295)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1295, 1)) || iLocal_1301 > 0)
					{
						iLocal_1307 = 0;
						iLocal_1308 = 0;
						StringCopy(&cLocal_1309, "", 24);
					...
					else if (PED::IS_PED_IN_VEHICLE(vLocal_1285.x, Local_1295, 1))
					{
						...
						{
							TASK::TASK_LEAVE_VEHICLE(vLocal_1285.x, Local_1295, 0);
						}
					}
					else
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_1283);
							...
							TASK::CLOSE_SEQUENCE_TASK(iLocal_1283);
							TASK::TASK_PERFORM_SEQUENCE(vLocal_1285.x, iLocal_1283);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_1283);
						}
					}
					break;
				...
				case 4:
					...
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1285.x, Local_1295, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
					}
					break;
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && !ENTITY::IS_ENTITY_DEAD(Local_1295, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(vLocal_1285.x, Local_1295, 0))
						{
							if (!func_87(Local_1295))
							{
								...
								{
									TASK::CLEAR_PED_TASKS(vLocal_1285.x);
									TASK::TASK_VEHICLE_TEMP_ACTION(vLocal_1285.x, Local_1295, 5, -1);
								}
							}
							else if (!func_304(vLocal_1285.x, 451360105, 1))
							{
								TASK::TASK_LEAVE_VEHICLE(vLocal_1285.x, Local_1295, 256);
							}
						}
						else if (!func_304(vLocal_1285.x, 780511057, 1))
						{
							PED::SET_PED_CAN_BE_TARGETTED(vLocal_1285.x, true);
							TASK::TASK_COMBAT_PED(vLocal_1285.x, PLAYER::PLAYER_PED_ID(), 0, 16);
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && !ENTITY::IS_ENTITY_DEAD(Local_1295, 0))
					{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(vLocal_1285.x) && !PED::IS_PED_INJURED(vLocal_1285.x)) && !PED::IS_CONVERSATION_PED_DEAD(vLocal_1285.x))
		{
			switch (uParam0->f_1)
			{
				case 4:
					...
					{
						case 0:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
						...
						case 1:
							...
							else if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
						...
						case 2:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
								if (MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1309))
								{
									...
									if ((((((iLocal_1302 || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 126)) || fVar4 < 49f) && (MISC::GET_GAME_TIMER() - iLocal_1308) > 5000) && fVar4 < 225f)
									{
						...
						case 3:
							if (!func_43() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
