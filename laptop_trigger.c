...
void __EntryFunction__()
{
	...
	sVar1 = "tvscreen";
	bVar3 = true;
	vVar4 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_216, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iScriptParam_216) * Vector(0.6f, 0.6f, 0.6f) };
	vVar4.z = (vVar4.z + 0.5f);
	vLocal_212 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_216, vLocal_211) };
	Global_1676739 = 0;
	Global_1676849 = 0;
	while (bVar3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_208))
		{
			if (iLocal_199)
			{
				...
				{
					if (!func_235(&uLocal_202))
					{
						func_234(&uLocal_202, 1, 0);
					}
				}
			}
			if (Global_1676739 && (func_233(PLAYER::PLAYER_ID()) || func_232(PLAYER::PLAYER_ID())))
			{
				if (!func_235(&uLocal_206))
				{
					func_234(&uLocal_206, 0, 0);
				}
				else if (func_231(&uLocal_206, 10000, 0))
				{
					func_230(&uLocal_206);
					Global_1676739 = 0;
				}
			...
			if (Global_1590297)
			{
				if (!bVar0)
				{
					iVar5 = ENTITY::GET_ENTITY_MODEL(iLocal_208);
					if (iVar5 == joaat("prop_laptop_01a"))
					{
						ENTITY::CREATE_MODEL_HIDE(ENTITY::GET_ENTITY_COORDS(iScriptParam_216, true), 1f, joaat("prop_laptop_01a"), 0);
						vVar6 = { ENTITY::GET_ENTITY_ROTATION(iLocal_208, 2) };
						iLocal_208 = OBJECT::CREATE_OBJECT(joaat("prop_laptop_lester2"), ENTITY::GET_ENTITY_COORDS(iLocal_208, true), false, true, false);
						ENTITY::SET_ENTITY_ROTATION(iLocal_208, vVar6, 2, 1);
						bVar0 = true;
					}
				}
			}
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(iLocal_208, 0))
			{
				func_239();
				SCRIPT::TERMINATE_THIS_THREAD();
			}
		}
		if (((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_208)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_208))
			{
				bVar7 = false;
				...
				if (((func_223() || func_222(PLAYER::PLAYER_ID())) || func_232(PLAYER::PLAYER_ID())) || func_221())
				{
					vVar10 = { 1f, 1f, 0.9f };
				}
				else if (func_220())
				{
					vVar10 = { 0.75f, 0.55f, 1.25f };
				}
				bVar11 = func_219(PLAYER::PLAYER_ID());
				if ((((((((((((((((!bVar7 && !Global_31003) && !func_218(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_217()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar4, vVar10, false, true, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_208)) && !MISC::IS_BIT_SET(Global_2359302, 15)) && !func_216()) && !(Global_76577 && func_215())) && !(!Global_76577 && func_214())) && !((Global_76577 && MISC::IS_BIT_SET(Global_4456448.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_76577 && func_213()) && func_212())) && !(Global_76577 && func_210(PLAYER::PLAYER_ID()) == 5)) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) && !Global_75389) && (!func_220() || func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_208), 90f)))
				{
					if ((!func_208(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26) && !func_207(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26, -1)) && !func_206(PLAYER::PLAYER_ID()))
					{
						if (iLocal_200 != bVar11)
						{
							if ((func_233(PLAYER::PLAYER_ID()) || func_205(PLAYER::PLAYER_ID())) || func_232(PLAYER::PLAYER_ID()))
							{
								if (iLocal_197 != -1)
								{
									func_204(&iLocal_197);
						...
						if (iLocal_197 == -1)
						{
							if (bVar0)
							{
								func_201(&iLocal_197, 1, "MPLA_BILL", 0, 0, 0, 0);
							}
							else if (func_223())
							{
								func_200(bVar11);
							...
							{
								func_201(&iLocal_197, 1, "BROWSEINPUTTRIG", 0, 0, 0, 0);
							}
						}
					}
					if (((iLocal_197 != -1 && func_180(iLocal_197, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179())
					{
						if (iLocal_197 != -1)
						{
							func_204(&iLocal_197);
						...
						if (!bVar0)
						{
							...
							if ((func_178() || func_177()) || func_176())
							{
								func_21(&uLocal_204, 0, 0);
								while (!func_231(&uLocal_204, 500, 0))
								{
									func_224(0);
									SYSTEM::WAIT(0);
								}
							...
							while (bVar12)
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_208) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_208, true), 1.5f, 1.5f, 4f, false, true, 1))
								{
									Global_73787 = 1;
								}
								if (((func_178() || func_177()) || func_206(PLAYER::PLAYER_ID())) || func_176())
								{
									if (!func_20() && !Global_75389)
									{
										bVar12 = false;
									}
								}
								else if (func_20() || Global_73787)
								{
									bVar12 = false;
								}
								if (func_178())
					...
					else if ((((iLocal_197 != -1 && PAD::IS_CONTROL_JUST_PRESSED(2, 52)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179()) && func_176())
					{
						if (iLocal_197 != -1)
						{
							func_204(&iLocal_197);
						...
						func_170();
						MISC::SET_BIT(&(Global_1676879.f_4), 28);
						while (MISC::IS_BIT_SET(Global_1676879.f_4, 28))
						{
							SYSTEM::WAIT(0);
						}
						func_3();
				...
				else
				{
					...
					if (func_233(PLAYER::PLAYER_ID()) || func_205(PLAYER::PLAYER_ID()))
					{
						if (func_202())
						{
							HUD::CLEAR_HELP(1);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_216))
					{
						if (!BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iScriptParam_216))
						{
							bVar3 = false;
						}
					}
...
void func_3()
{
	...
	if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1) && ENTITY::DOES_ENTITY_EXIST(iLocal_208))
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_4(2, &sVar0))
				{
					if (iLocal_209 != 0)
					{
						...
						{
							PED::DETACH_SYNCHRONIZED_SCENE(iLocal_210);
							iLocal_210 = -1;
						}
						iLocal_210 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_212, ENTITY::GET_ENTITY_ROTATION(iLocal_208, 2), 2, false, false, 1065353216, 0, 1065353216);
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar0, "exit", 8f, -4f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
						STREAMING::REMOVE_ANIM_DICT(&sVar0);
					}
				}
			}
...
int func_4(int iParam0, char* sParam1)
{
	...
	if ((!func_233(PLAYER::PLAYER_ID()) && !func_232(PLAYER::PLAYER_ID())) && !func_5(PLAYER::PLAYER_ID()))
	{
		StringCopy(sParam1, "", 64);
		return 0;
	}
...
int func_5(int iParam0)
{
	if (iParam0 != func_8())
	{
		if (func_7(iParam0, 1, 1))
		{
			...
			{
				return func_6(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
void func_23()
{
	if ((!func_25() && !func_24()) && Global_2449754)
	{
...
int func_29(int iParam0, bool bParam1, int iParam2)
{
	...
	if (Global_76577 && func_215())
	{
		return 0;
	}
	if (!Global_76577 && func_214())
	{
		return 0;
	}
	if (bVar0)
...
void func_31(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		...
		{
			func_32(82, "GB_TXTMSG_INIT", 2, 0, 0, 0, 0, 1, 0, 1);
		}
	}
}
...
int func_34(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19665)
	{
		if (Global_19486.f_1 == 6)
		{
			...
			func_39(1);
			func_42(Global_19467, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19466), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_46()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_47(Global_111560.f_14136[iVar2 /*104*/].f_18, Global_111560.f_14136[Global_21872 /*104*/].f_18))
		{
			Global_21872 = iVar2;
		}
		iVar2++;
...
void func_51()
{
	...
	{
		if (func_54(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_53(PLAYER::PLAYER_PED_ID());
			if (func_52(iVar0) && (!func_238(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_52(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_56()
{
	if ((!func_85() && func_70()) && func_68(PLAYER::PLAYER_ID()))
	{
		if (func_65())
		{
			func_57("GB_INFO_MC_L", 1);
		}
		else
		{
			func_57("GB_INFO_LFG", 1);
		}
	}
}

int func_57(char* sParam0, int iParam1)
{
	int iVar0;
...
{
	return func_77(iParam0, bParam1, 1);
}
...
int func_85()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1628955[PLAYER::PLAYER_ID() /*614*/].f_11.f_11[iVar0] == func_8())
		{
			StringCopy(&Var2, "", 64);
			Var2 = { func_86(func_87(iVar0)) };
...
void func_88(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
	Param0 = 564131320;
...
void func_92()
{
	...
	func_96(&Var0, iVar1, 0);
	if ((!MISC::IS_DURANGO_VERSION() && NETWORK::_0x595F028698072DD9(0, -1, 1)) || func_95())
	{
		func_94(28);
	}
	else
...
void func_102(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (func_104())
	{
		iVar0 = Global_2577450[iParam0 /*3*/][func_103(iParam3)];
		iVar1 = Global_2577450[iParam1 /*3*/][func_103(iParam3)];
		if (iVar0 != 0 && iVar1 != 0)
		{
			StringCopy(&cVar2, "", 32);
			StringCopy(&cVar3, "", 32);
...
struct<16> func_107(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2577450[iParam0 /*3*/][func_103(iParam2)];
	uVar1 = Global_2577450[iParam1 /*3*/][func_103(iParam2)];
...
void func_108()
{
	...
	while (iVar0 <= 3)
	{
		if (Global_2437549.f_2708[iVar0 /*80*/].f_2 != 0)
		{
			...
			func_109(&(Global_2437549.f_2708[iVar0 /*80*/].f_69), 1);
		}
		iVar0++;
	}
}
...
void func_112(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1628955[PLAYER::PLAYER_ID() /*614*/].f_11 != PLAYER::PLAYER_ID())
	{
		...
		if (Global_2531497.f_4898.f_253 != func_8())
		{
			Global_2531497.f_4898.f_253 = func_8();
		}
		...
		if (iParam2 != 1)
		{
			...
			{
				bVar7 = false;
				iVar8 = func_151(9507, -1, 0);
				if (!MISC::IS_BIT_SET(iVar8, 11))
				{
					MISC::SET_BIT(&iVar8, 11);
					func_128(9507, iVar8, -1, 1, 0);
					bVar7 = true;
				}
				func_118(82, 3, bVar7);
			}
		...
		if (iParam2 == 1)
		{
			STATS::_0x0B565B0AAE56A0E8(func_116(func_117()), func_115(func_117()), func_114(), func_113(), Global_1628955[PLAYER::PLAYER_ID() /*614*/].f_11.f_451, 4, Global_1628955[PLAYER::PLAYER_ID() /*614*/].f_11.f_489);
		}
	}
}
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_103(iParam2)];
	if (iVar0 != 0)
	{
...
void func_134(int iParam0, int iParam1, bool bParam2)
{
	if (func_141())
	{
		if (iParam1 == 1)
		{
			...
			func_21(&(Global_2531497.f_4393), 0, 0);
			if (bParam2)
			{
				...
				func_21(&(Global_2531497.f_4396), 0, 0);
			}
			else
			{
				Global_1312417 = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1) && !ENTITY::IS_ENTITY_DEAD(iVar1, 0))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iVar1, 0))
			{
				...
				if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && ENTITY::IS_ENTITY_A_VEHICLE(iVar0)) && !ENTITY::IS_ENTITY_DEAD(iVar0, 0))
				{
					...
					if (func_78(iParam1, func_117(), 1))
					{
						...
						{
							iVar2 = func_145(func_117(), iParam1);
							if (iVar2 != -1)
							{
			...
			else if (!bParam0)
			{
				if (func_78(iParam1, func_117(), 1))
				{
					...
					{
						iVar3 = func_145(func_117(), iParam1);
						if (iVar3 != -1)
						{
...
int func_145(int iParam0, int iParam1)
{
	...
	if (func_219(iParam0))
	{
		if (func_78(iParam1, iParam0, 0) || func_147(iParam1, iParam0))
		{
			iVar0 = 0;
			while (iVar0 < 7)
			{
...
int func_147(int iParam0, int iParam1)
{
	if (iParam1 != func_8())
	{
		if (Global_1628955[iParam0 /*614*/].f_11.f_26 != func_8())
		{
...
void func_148(int iParam0)
{
	...
	if (func_151(9510, -1, 0) != func_149(PLAYER::PLAYER_ID()))
	{
		func_128(9510, func_149(PLAYER::PLAYER_ID()), -1, 1, 0);
	}
}
...
int func_151(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_103(iParam1)];
...
void func_156(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	if (func_104())
	{
		iVar0 = Global_2576213[iParam0 /*3*/][func_103(iParam2)];
		if (iVar0 != 0)
		{
...
bool func_169(int iParam0, bool bParam1)
{
	...
	return Global_1628955[iParam0 /*614*/].f_11 != func_8();
}
...
void func_170()
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
		vVar1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_208, 0.0328f, -0.8f, 0.3f) };
		bVar2 = false;
		func_230(&uLocal_204);
		if (func_4(0, &sVar0))
		{
			...
			{
				func_224(0);
				if (!func_235(&uLocal_204))
				{
					func_234(&uLocal_204, 0, 0);
				}
				else if (func_231(&uLocal_204, 4000, 0))
				{
					bVar2 = true;
				}
				if (!func_175(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar1, 0.05f, 0) && !func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_208), 5f))
				{
					if (!func_172(PLAYER::PLAYER_PED_ID(), 2106541073))
					{
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar1, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iLocal_208), 0.25f);
					}
				}
				else
				{
				...
				GRAPHICS::DRAW_DEBUG_SPHERE(vVar1, 0.1f, 255, 0, 0, 255);
				GRAPHICS::DRAW_DEBUG_LINE(vVar1, ENTITY::GET_ENTITY_COORDS(iLocal_208, true), 0, 255, 0, 255);
				GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar1, 0, 0, 255, 255);
				SYSTEM::WAIT(0);
			}
			func_230(&uLocal_204);
			iLocal_209 = 0;
...
void func_171(int iParam0)
{
	...
	switch (iLocal_209)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
				{
					...
					iLocal_210 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_212, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
					STREAMING::REMOVE_ANIM_DICT(&sVar0);
					iLocal_209 = 1;
				}
		...
		case 1:
			...
			iVar5 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_210);
			if (!iLocal_201)
			{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar1) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar5) >= 0.96f))
			{
				...
				if ((((MISC::ARE_STRINGS_EQUAL(&cLocal_213, "idle_a") && iVar6 == 0) || (MISC::ARE_STRINGS_EQUAL(&cLocal_213, "idle_b") && iVar6 == 1)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_213, "idle_c") && iVar6 == 2)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_213, "idle_d") && iVar6 == 3))
				{
					iVar6++;
					if (iVar6 >= iVar4)
					{
				...
				iLocal_210 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_212, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1065353216, 0, 1065353216);
				switch (iVar6)
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar1, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
						StringCopy(&cLocal_213, "idle_a", 16);
						iLocal_209 = 3;
						break;
					
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar1, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
						StringCopy(&cLocal_213, "idle_b", 16);
						iLocal_209 = 3;
						break;
					
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar1, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
						StringCopy(&cLocal_213, "idle_c", 16);
						iLocal_209 = 3;
						break;
					
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar1, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
						StringCopy(&cLocal_213, "idle_d", 16);
						iLocal_209 = 3;
						break;
					
					default:
						StringCopy(&cLocal_213, "idle_XXX", 16);
						break;
					}
			}
			break;
		...
		case 3:
			...
			iVar5 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_210);
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_210) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_210))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(iLocal_210);
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_210, &sVar1, sVar3, 4f, -2f, 5, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_210);
				iLocal_209 = 3;
				return;
			}
...
int func_175(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
bool func_176()
{
	return MISC::IS_BIT_SET(Global_1676879.f_430, 30);
}
...
int func_177()
{
	...
	{
		if (MISC::IS_BIT_SET(Global_1676879.f_430, 0) || MISC::IS_BIT_SET(Global_1676879.f_430, 2))
		{
			return 1;
		}
	}
...
{
	if (((func_176() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676739)
	{
		func_201(&iLocal_197, 2, "ARENAWHINPUT", 0, 0, 0, 0);
	}
}
...
{
	if ((((func_206(PLAYER::PLAYER_ID()) && func_193(PLAYER::PLAYER_ID()) == func_192(PLAYER::PLAYER_ID())) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676739)
	{
		if (func_190())
		{
		...
		else if (!bParam0)
		{
			...
			{
				func_201(&iLocal_197, 1, "WHSECUROMAXVIP", 0, 0, 0, 0);
			}
			else if (func_163(PLAYER::PLAYER_ID()))
			{
				func_201(&iLocal_197, 1, "PIM_EXECH0x1", 0, 0, 0, 0);
			}
			...
			{
				func_201(&iLocal_197, 1, "SECINPUTTREGLAP", 0, 0, 0, 0);
			}
		}
		...
		else if ((func_235(&uLocal_202) && func_231(&uLocal_202, 10000, 1)) || !iLocal_199)
		{
			if (func_185(PLAYER::PLAYER_ID()) || Global_1676739 == 1)
			{
				iLocal_199 = 1;
				if (!Global_1676739)
				{
			...
			else
			{
				...
				iLocal_199 = 0;
				func_230(&uLocal_202);
				func_201(&iLocal_197, 1, "WHSECUROINPUT", 0, 0, 0, 0);
			}
		}
		else if (iLocal_199)
		{
...
int func_193(int iParam0)
{
	if (func_206(iParam0))
	{
		return func_194(Global_2424073[iParam0 /*421*/].f_309.f_5);
	}
	return 0;
}
...
{
	if (((((func_205(PLAYER::PLAYER_ID()) || func_177()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676739) && func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_208), 90f))
	{
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		{
			func_189("WHSECUROBLCK");
		...
		{
			if ((func_235(&uLocal_202) && func_231(&uLocal_202, 10000, 1)) || !iLocal_199)
			{
				if (func_196(PLAYER::PLAYER_ID()) || Global_1676739 == 1)
				{
					iLocal_199 = 1;
					if (!Global_1676739)
					{
				...
				else
				{
					...
					iLocal_199 = 0;
					func_230(&uLocal_202);
					func_201(&iLocal_197, 1, "BIKERWHINPUT", 0, 0, 0, 0);
				}
			}
			else if (iLocal_199)
			{
		...
		{
			func_201(&iLocal_197, 1, "BIKERWHBLCKA", 0, 0, 0, 0);
		}
		else
		{
...
int func_198()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_208))
	{
		if (func_232(PLAYER::PLAYER_ID()) || func_199(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
...
{
	if (func_207(Global_1590446[iParam0 /*871*/].f_273.f_26, -1))
	{
		return 1;
	}
	return 0;
...
{
	if (((func_178() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676739)
	{
		if (func_190())
		{
			func_189("WHPRIVSESLAP");
		...
		{
			if (func_236(PLAYER::PLAYER_ID()) || Global_1676739 == 1)
			{
				iLocal_199 = 1;
				if (!Global_1676739)
				{
...
{
	if (func_207(Global_1590446[iParam0 /*871*/].f_273.f_26, -1) && !MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_24, 1))
	{
		return 1;
	}
	return 0;
...
int func_206(int iParam0)
{
	if (iParam0 != func_8())
	{
		if (func_7(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_6(Global_2424073[iParam0 /*421*/].f_309.f_5) == 1;
			}
		}
	}
	return 0;
...
int func_220()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_208) && func_5(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_221()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_208) && func_206(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_223()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_208))
	{
		if (ENTITY::GET_ENTITY_MODEL(iLocal_208) == joaat("ex_prop_monitor_01_ex") || func_233(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
...
int func_232(int iParam0)
{
	if (iParam0 != func_8())
	{
		if (func_7(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_6(Global_2424073[iParam0 /*421*/].f_309.f_5) == 2;
			}
		}
	}
	return 0;
...
int func_233(int iParam0)
{
	if (iParam0 != func_8())
	{
		if (func_7(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_6(Global_2424073[iParam0 /*421*/].f_309.f_5) == 0;
			}
		}
	}
	return 0;
...
{
	return func_237(func_187(iParam0));
}
