...
int func_15()
{
	...
	if ((func_21(2, Global_19453, 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19)) && !MISC::IS_STUNT_JUMP_IN_PROGRESS())
	{
		...
		if (HUD::THEFEED_GET_FIRST_VISIBLE_DELETE_REMAINING() == Global_21862 && HUD::THEFEED_GET_FIRST_VISIBLE_DELETE_REMAINING() != -1)
		{
			...
			iLocal_60 = 0;
			iLocal_61 = 0;
			while (((func_19(2, Global_19453) && iLocal_60 < 250) && Global_19672 == 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19))
			{
				if (Global_8060 > 0)
				{
					func_16();
...
void func_47()
{
	...
	if (((((((Global_4268350[Global_4269599 /*104*/].f_32 == 4 || Global_4268350[Global_4269599 /*104*/].f_32 == 5) || Global_4268350[Global_4269599 /*104*/].f_32 == 6) || Global_4268350[Global_4269599 /*104*/].f_32 == 7) || Global_4268350[Global_4269599 /*104*/].f_32 == 8) || Global_4268350[Global_4269599 /*104*/].f_32 == 9) || Global_4268350[Global_4269599 /*104*/].f_32 == 10) || Global_4268350[Global_4269599 /*104*/].f_32 == 11)
	{
		...
		while (iVar1 < Global_4268350[Global_4269599 /*104*/].f_49)
		{
			...
			{
				case 4:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2531497.f_1662[iVar1 /*4*/]));
					break;
				
				case 5:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662564[iVar1 /*4*/]));
					break;
				
				case 6:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662605[iVar1 /*4*/]));
					break;
				
				case 7:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662626[iVar1 /*4*/]));
					break;
				
				case 8:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662643[iVar1 /*4*/]));
					break;
				
				case 9:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662656[iVar1 /*4*/]));
					break;
				
				case 10:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662669[iVar1 /*4*/]));
					break;
				
				case 11:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1662682[iVar1 /*4*/]));
					break;
			}
			iVar1++;
		}
		StringCopy(&cVar2, HUD::_GET_LABEL_TEXT(&(Global_1798[Global_4268350[Global_4269599 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		{
			StringCopy(&cVar4, HUD::_GET_LABEL_TEXT(&(Global_1798[Global_4268350[Global_4269599 /*104*/].f_17 /*29*/].f_3)), 64);
...
void func_49()
{
	if (MISC::IS_BIT_SET(Global_7356, 1))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_45[Global_19486] = NETWORK::GET_NETWORK_TIME();
			iLocal_43[Global_19486] = 1;
		}
		else if (!MISC::IS_BIT_SET(Global_7356, 10))
		{
			iLocal_44[Global_19486] = MISC::GET_GAME_TIMER();
			iLocal_43[Global_19486] = 1;
		}
		else
		{
...
void func_52()
{
	...
	if (((((((Global_111560.f_14136[Global_21872 /*104*/].f_32 == 4 || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 5) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 6) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 7) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 8) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 9) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 10) || Global_111560.f_14136[Global_21872 /*104*/].f_32 == 11)
	{
		...
		StringCopy(&cVar2, HUD::_GET_LABEL_TEXT(&(Global_1798[Global_111560.f_14136[Global_21872 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		{
			StringCopy(&cVar4, HUD::_GET_LABEL_TEXT(&(Global_1798[Global_111560.f_14136[Global_21872 /*104*/].f_17 /*29*/].f_3)), 64);
...
void func_54()
{
	if (iLocal_43[Global_19486] == 1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_47 = NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_45[Global_19486]);
		}
		else
		{
			iLocal_46[Global_19486] = MISC::GET_GAME_TIMER();
...
void func_72()
{
	...
	{
		iLocal_37 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("cellphone_alert_popup");
