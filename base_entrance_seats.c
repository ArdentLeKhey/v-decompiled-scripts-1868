...
void func_11(var uParam0)
{
	...
	Var2 = { *(uParam0[uParam0->f_57.f_2 /*14*/]) };
	switch (uParam0->f_57.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 451.6327f, 4829.453f, -54.97165f, 499.981f, 4842.034f, -50.67961f, 30.75f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
...
void func_74()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_75(0, &uLocal_162, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_75(1, &uLocal_162, &iVar0);
}
...
void func_75(int iParam0, var uParam1, int iParam2)
{
	...
	func_82(iParam0, &vVar0, &fVar1);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		(*uParam1)[(*iParam2)[iVar2] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_78(func_79(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_78(func_77(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_78(func_76(iVar2), fVar1) + vVar0 };
...
Vector3 func_78(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
