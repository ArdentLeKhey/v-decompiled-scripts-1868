...
void __EntryFunction__()
{
	...
	MISC::CLEAR_BIT(&(Global_111560.f_10011.f_25), 1);
	func_7();
	...
	iLocal_0 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("OPENING_CREDITS");
	...
	{
		func_7();
		if (!MISC::IS_BIT_SET(Global_111560.f_10011.f_25, 1))
		{
			...
			{
				MISC::SET_BIT(&(Global_111560.f_10011.f_25), 1);
