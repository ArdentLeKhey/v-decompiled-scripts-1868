#region Local Var
	...
	int iLocal_344 = 0;
	struct<8> Local_345 = { 0, 0, 0, 0, 0, 0, -1, 0 } ;
#endregion
...
void __EntryFunction__()
{
	...
	sLocal_152 = "Trevor";
	sLocal_153 = "Maude";
	sLocal_154 = "maude_criminal_2";
	sLocal_155 = "maude_chair";
	sLocal_156 = "maude_laptop";
	StringCopy(&vLocal_323, "", 24);
	StringCopy(&cLocal_327, "PostKilled_BailBond2", 24);
	StringCopy(&vLocal_331, "MAUDE_MCS_3", 24);
	StringCopy(&Local_335, "", 24);
	Local_63 = { ScriptParam_345 };
	...
	if (func_520())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_105109.f_2890.f_12.f_66))
				{
					func_447(&iLocal_344, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_447(&iLocal_344, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				func_446(vLocal_339, fLocal_119, 1, 0);
				iLocal_61 = 2;
				func_435(1, 0);
				break;
			
			case 1:
				func_447(&iLocal_344, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_446(vLocal_336, 254.9762f, 0, 0);
				func_435(4, 0);
				break;
	...
	else if (func_434(0))
	{
		...
		{
			func_432(PLAYER::PLAYER_PED_ID(), vLocal_339, fLocal_119, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_337 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_421();
			func_420();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_340, fLocal_120, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_341, fLocal_121, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
			...
			case 2:
				...
				if (iLocal_60 == 1)
				{
					...
					{
						iVar0 = 0;
						while (iVar0 <= (iLocal_134 - 1))
						{
							if (func_23(Local_69[iVar0 /*20*/]))
							{
								PED::EXPLODE_PED_HEAD(Local_69[iVar0 /*20*/], joaat("WEAPON_SNIPERRIFLE"));
								ENTITY::SET_ENTITY_HEALTH(Local_69[iVar0 /*20*/], 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_432(Local_68.f_9, vLocal_336, 0f, 0, 0);
					if (!func_71())
					{
						func_432(PLAYER::PLAYER_PED_ID(), vLocal_336, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
void func_7()
{
	...
	while (iVar0 <= (iLocal_134 - 1))
	{
		Local_69[iVar0 /*20*/].f_15 = 0;
		Local_69[iVar0 /*20*/].f_16 = 0;
		Local_69[iVar0 /*20*/].f_17 = 0;
		iVar0++;
	}
}
...
int func_37()
{
	if (func_59(vLocal_337, Local_75.f_1, 210f))
	{
		if (!iLocal_113)
		{
		...
		{
			if (func_59(vLocal_337, Local_79.f_1, 150f))
			{
		...
		{
			if (func_59(vLocal_337, Local_80.f_1, 150f))
			{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (iLocal_62 == 4)
			{
				...
				if (func_107(&Local_75, &Local_77, &iLocal_141))
				{
					iLocal_105 = 1;
				}
			}
			...
			iVar1 = 0;
			while (iVar1 <= (iLocal_134 - 1))
			{
				func_106(Local_69[iVar1 /*20*/], 1);
				iVar1++;
			}
			switch (iLocal_62)
			{
			...
			else
			{
				if (!iLocal_95)
				{
					...
					if (iLocal_62 == 4)
					{
						if (func_23(Local_75))
						{
							if (func_112(Local_75, vLocal_337, 35f))
							{
				...
				if (iLocal_62 == 4)
				{
					...
					else if (func_23(Local_75))
					{
						if (!func_64(Local_75, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_75, func_109(), func_74(), 3))
								{
									func_73(&Local_75);
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || TASK::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_109()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					TASK::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_109(), func_74(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_118(int iParam0)
{
	...
	{
		func_116(&(Local_69[iVar0 /*20*/].f_6));
		iVar0++;
	}
}
	...
	switch (iLocal_60)
	{
		case 0:
			...
			while (iVar0 <= (iLocal_134 - 1))
			{
				if (func_23(Local_69[iVar0 /*20*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iVar0 /*20*/], iLocal_322);
					if (!PED::IS_PED_FLEEING(Local_69[iVar0 /*20*/]))
					{
						func_121(iVar0);
					}
				}
		...
		case 1:
			if (func_120(iLocal_138, 500))
			{
				...
				if (!iLocal_106)
				{
					SCRIPT::REQUEST_SCRIPT(&cLocal_327);
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_327))
					{
						iVar0 = 0;
						while (iVar0 <= (iLocal_134 - 1))
						{
						...
						while (iVar0 <= (iLocal_131 - 1))
						{
							if (iVar0 < Var1.f_5)
							{
								Var1.f_5[iVar0] = Local_71[iVar0 /*6*/];
							}
							iVar0++;
						}
						SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&cLocal_327, &Var1, 9, 512);
						SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_327);
						iLocal_106 = 1;
					}
				}
				if (iLocal_96 && iLocal_106)
				{
					func_122(2);
				}
				if (func_120(iLocal_138, 1500))
				{
					func_122(2);
				}
			}
...
void func_124()
{
	...
	{
		func_127(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_128(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					func_196(&vVar0, &vVar1, &fVar3);
					vVar2 = { func_195() };
					if (func_192(vVar2, 0))
					{
						func_185(vVar0, vVar1, fVar3, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
						func_132(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
					}
					else
					{
						func_185(vVar0, vVar1, fVar3, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
void func_132(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_184(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_181(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_133(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_151(iParam0, 0, 0)) || func_151(iParam0, 1, 0)) || func_151(iParam0, 2, 0)) || func_173(iParam0) != 145) || func_150(iParam0)) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || !func_137(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_149(iParam0))
		{
		}
...
void func_167(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_164(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
bool func_174(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_181(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_182(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
{
	func_186(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_186(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_188(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_188(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_190(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_189(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_189(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_189(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_189(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_189(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_189(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_189(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_189(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_189(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_189(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_189(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_189(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_189(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_189(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_189(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_189(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
bool func_192(vector3 vParam0, int iParam1)
{
	return func_193(Global_102125.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_193(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_197(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_249(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_241(iVar0);
						if (Global_76387 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_249(iVar10, 14, uVar15[iVar1], -1) };
			func_219(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_241(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar2 = 0;
		iVar3 = (iParam1 - func_223(iParam0));
		if (iVar3 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar7 = 0;
		iVar8 = (iParam1 - func_222(iParam0, func_209(iParam2)));
		if (iVar8 < 0)
		{
			return -1;
		}
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_209(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_209(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_222(iParam0, func_209(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_226(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_233(vVar2.z)] = vVar2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_233(vVar2.z)] = func_226(iParam1, vVar2.x, func_233(vVar2.z), iVar0);
					}
				}
				else if (vVar2.y != -1)
				{
					(*uParam0)[func_233(vVar2.z)] = vVar2.y;
				}
			}
			iVar4++;
		}
...
void func_243(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_244(iParam2)];
	if (iVar0 != 0)
	{
...
int func_245(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_244(iParam1)];
...
void func_251(int iParam0)
{
	...
	func_252(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_245(func_255(iParam1, uParam0->f_2), Global_76386, 0);
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_252(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_252(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_209(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_313(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_209(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_209(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_315()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_382(Local_68.f_9, &iLocal_135, 1126825984, 7);
		...
		switch (iLocal_60)
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_322);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, 1862763509);
				iLocal_139 = ENTITY::GET_ENTITY_HEALTH(Local_68.f_9);
				vLocal_342 = { ENTITY::GET_ENTITY_COORDS(Local_68.f_9, false) };
				func_361(&vLocal_343, vLocal_342);
				...
				func_358(&(Local_68.f_8), "", "", &iLocal_127, iLocal_128, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else if (func_120(iLocal_136, 8000))
						{
							bVar0 = true;
						}
						if (func_327(Local_68.f_9, vLocal_337, bVar0, 0, 1, iLocal_139))
						{
							if ((func_120(iLocal_137, 5000) || func_174(vLocal_343, 0f, 0f, 0f, 0)) || (!func_59(vVar1, vLocal_343, 8.5f) && !func_59(vVar1, vLocal_342, 8.5f)))
							{
								func_326();
						...
						else
						{
							if (!iLocal_81)
							{
								if (!func_120(iLocal_124, 2500))
								{
									if (!func_62())
									{
										if (func_112(Local_68.f_9, vLocal_337, 30f))
										{
											if (func_75(&uLocal_157, cLocal_150, "BB2_J7", 4, 0, 0, 0))
											{
												iLocal_124 = MISC::GET_GAME_TIMER();
												iLocal_81 = 1;
											}
							...
							{
								if (func_120(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_68.f_9, vLocal_337, 30f))
									{
										if (PED::IS_PED_FLEEING(Local_68.f_9))
										{
											...
											else if (func_75(&uLocal_157, cLocal_150, "BB2_FLEE", 4, 0, 0, 0))
											{
												iLocal_124 = MISC::GET_GAME_TIMER();
											}
										}
							...
							func_323(Local_68.f_9, vLocal_337, iLocal_137, 925353388);
						}
					}
					else
					{
				...
				{
					func_326();
					if (!func_112(Local_68.f_9, vLocal_337, 10f))
					{
						if (!iLocal_98)
						{
							if (!func_321(sLocal_148, 1))
							{
								func_319(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_98 = 1;
							}
						}
						else
						{
							func_358(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, iLocal_128, 1);
						}
					}
					else
					{
...
void func_323(int iParam0, vector3 vParam1, int iParam2, float fParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_327(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	if (func_23(iParam0))
	{
		...
		if (bParam3)
		{
			if (func_328(iParam0, vParam1, 1112014848, 1084227584))
			{
				return 1;
			}
		}
...
int func_328(int iParam0, vector3 vParam1, float fParam2, float fParam3)
{
...
int func_340(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_341(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_362()
{
	...
	if (func_23(Local_68.f_9))
	{
		if (iLocal_70 == 0)
		{
			func_373(&(Local_68.f_9), &bLocal_116);
			if (func_372())
			{
				if (iLocal_109 || iLocal_58 == 7)
				{
					...
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_68.f_9, func_370(), 1048576000);
						iLocal_70 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_112(Local_68.f_9, vLocal_337, 20f))
					{
				...
				case 6:
					if (!func_112(Local_68.f_9, vLocal_337, 3.5f))
					{
				...
				case 29:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 14, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 28, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 37, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 43, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 45, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 50, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 51, false);
						PED::SET_PED_COMBAT_RANGE(Local_68.f_9, 2);
						...
						TASK::TASK_COMBAT_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_68.f_9, vLocal_338, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
						Local_68.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_68.f_9, vLocal_337);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
					{
						Local_68.f_10 = 13;
					}
				...
				case 21:
					...
					else if (PED::DOES_GROUP_EXIST(func_365()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_68.f_9, func_365()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_68.f_9, func_365());
						}
						PED::SET_GROUP_FORMATION(func_365(), 0);
						PED::SET_GROUP_FORMATION_SPACING(func_365(), 1.5f, 3.5f, -1082130432);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_364())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, 0))
								{
									...
									if (fVar3 < 1.75f && func_112(Local_68.f_9, vLocal_337, 8f))
									{
				...
				case 23:
					if (func_367(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_366())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_337, 50f)) || !func_120(iLocal_142, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 1))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
								}
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) && !func_366()) || ENTITY::IS_ENTITY_IN_WATER(Local_68.f_9))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
					...
					if (func_367(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_366())
					{
						if (!func_64(Local_68.f_9, -1519143300))
						{
							if (!func_64(Local_68.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									if (!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_337, 50f))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 23;
									}
							...
							else if (!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_337, 50f))
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) || func_366())
								{
									Local_68.f_10 = 23;
								}
							}
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		if (func_112(iParam0, vLocal_337, fParam2))
		{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_376(&(Local_56[iVar2 /*4*/]), vVar1, iParam1, &(Local_56[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar2 /*4*/].f_3) < iParam4);
}

int func_376(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_377(iParam2, iParam5) };
...
float func_380(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
void func_383()
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_336, 100f))
	{
		if (!func_384())
		{
			CUTSCENE::REQUEST_CUTSCENE(&vLocal_331, 8);
			func_67();
			iLocal_114 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_336, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					func_117(&(Local_68.f_8));
					if (!func_112(Local_68.f_9, vLocal_337, 25f))
					{
				...
				else if (func_112(Local_68.f_9, vLocal_337, 8f))
				{
					...
					if (!func_62())
					{
						if (Local_68.f_10 == 21 || Local_68.f_10 == 22)
						{
							...
							else if (func_75(&uLocal_157, cLocal_150, "BB2_J5", 4, 0, 0, 0))
							{
								iLocal_124 = MISC::GET_GAME_TIMER();
							}
						}
...
void func_386()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		if (!iLocal_85)
		{
			if (func_75(&uLocal_157, cLocal_150, "BB2_J6", 4, 0, 0, 0))
			{
				iLocal_85 = 1;
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_123) > 10000)
						{
							func_389(1);
						}
					}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iVar0) < 0.5f)
						{
							if (!iLocal_94)
							{
								if (!func_62())
								{
									if (func_120(iLocal_140, 3500))
									{
										if (func_75(&uLocal_157, cLocal_150, "BB2_STOP", 4, 0, 0, 0))
										{
											iLocal_94 = 1;
										}
									}
				...
				{
					if (func_75(&uLocal_157, cLocal_150, "BB2_J9", 4, 0, 0, 0))
					{
						iLocal_84 = 1;
					}
				}
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_89)
				{
					...
					else if (!func_321("BBC_T8", 1) && !func_321("BB2_WTF", 1))
					{
						...
						else if (func_75(&uLocal_157, cLocal_150, "BB2_WTF", 4, iVar1, 0, 0))
						{
							iLocal_89 = 1;
						}
					}
				...
				else if (!iLocal_93)
				{
					if (func_387(&iVar0))
					{
						...
						{
							if (func_75(&uLocal_157, cLocal_150, "BB2_JACK", 4, iVar1, 0, 0))
							{
								iLocal_93 = 1;
							}
						}
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
				{
					if (!iLocal_90)
					{
						if (!func_321("BBC_T7", 1) && !func_321("BB2_OUT", 1))
						{
							...
							else if (func_75(&uLocal_157, cLocal_150, "BB2_OUT", 4, iVar1, 0, 0))
							{
								iLocal_90 = 1;
							}
						}
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, -1519143300))
				{
					if (func_112(Local_68.f_9, vLocal_337, 25f))
					{
						...
						{
							if (func_120(iLocal_125, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
								}
								if (func_75(&uLocal_157, cLocal_150, "BB2_J10", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_68.f_9, vLocal_337, 20f))
							{
								if (func_75(&uLocal_157, cLocal_150, "BB2_J4", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_117))
						{
							if (iLocal_97)
							{
								iLocal_117 = func_395(vLocal_336, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						{
							func_386();
							func_393(&Local_75, vLocal_337, &iLocal_126, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_336, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_336, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_336, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
				...
				else
				{
					...
					if (func_112(Local_68.f_9, vLocal_337, 8f))
					{
						if (Local_68.f_10 == 25 || Local_68.f_10 == 26)
						{
							Local_68.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_107)
				{
					bLocal_107 = func_391(vLocal_337, Local_63, 180f);
				}
				if (func_316(&(Local_68.f_9)))
				{
					iLocal_115 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_107)
					{
						bLocal_107 = func_391(vLocal_337, Local_63, 0f);
					}
					func_131(4);
				}
				break;
...
int func_391(vector3 vParam0, vector3 vParam1, float fParam2)
{
	int iVar0;
	
	if (!func_392(vParam0, vParam1, fParam2))
	{
...
bool func_392(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
...
int func_393(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
		...
		if (!func_62())
		{
			...
			if (SYSTEM::VDIST2(vParam1, vVar0) < (fParam4 * fParam4))
			{
				if (MISC::GET_GAME_TIMER() - *iParam2) > (iParam3 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar2 = "BBCAUD";
					sVar3 = "BBC_loiter";
					func_394(&uVar1, cVar2, sVar3, 4, 0, 0);
...
int func_395(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_396()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		{
			case 0:
				if (Local_68.f_10 != 29 && Local_68.f_10 != 30)
				{
					Local_68.f_18 = MISC::GET_GAME_TIMER();
					Local_68.f_10 = 29;
				}
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else if (func_120(iLocal_136, 5000))
						{
							bVar0 = true;
						}
						if (func_327(Local_68.f_9, vLocal_337, bVar0, 0, 1, 170))
						{
							func_326();
							func_398(iLocal_134);
							Local_68.f_17 = MISC::GET_GAME_TIMER();
					...
					else if ((iLocal_129 > 0 && func_112(Local_68.f_9, vLocal_337, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_68.f_9) < 200)
					{
						Local_68.f_10 = 13;
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_136 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_120(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_112(Local_68.f_9, vLocal_337, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
								{
									if (func_75(&uLocal_157, cLocal_151, "BBC_T2", 4, 0, 0, 0))
									{
										iLocal_124 = MISC::GET_GAME_TIMER();
									}
								}
								else if (func_75(&uLocal_157, cLocal_150, "BB2_SHOOT", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
...
void func_398(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (Local_69[iVar0 /*20*/].f_14 != 5)
		{
			func_106(Local_69[iVar0 /*20*/], 1);
			Local_69[iVar0 /*20*/].f_14 = 4;
			func_116(&(Local_69[iVar0 /*20*/].f_6));
		}
		iVar0++;
	}
...
void func_399(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			func_374(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_17), 1126825984, 7);
			switch (Local_69[iVar0 /*20*/].f_14)
			{
				case 0:
					break;
				...
				case 1:
					...
					if (func_120(Local_69[iVar0 /*20*/].f_15, iVar2))
					{
						func_121(iVar0);
					}
					break;
				...
				case 2:
					func_400(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					break;
				
				case 3:
					if (!func_64(Local_69[iVar0 /*20*/], -2017877118))
					{
						func_121(iVar0);
					}
					break;
				...
				case 4:
					if (!func_64(Local_69[iVar0 /*20*/], 1805844857))
					{
						func_106(Local_69[iVar0 /*20*/], 1);
					}
					func_116(&(Local_69[iVar0 /*20*/].f_6));
...
int func_400(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_401(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			Local_69[iVar0 /*20*/].f_15 = MISC::GET_GAME_TIMER();
			Local_69[iVar0 /*20*/].f_14 = 1;
		}
		iVar0++;
	}
}
...
void func_402()
{
	if (func_23(Local_68.f_9))
	{
		func_382(Local_68.f_9, &iLocal_135, 1126825984, 1);
		func_374(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_362();
		switch (iLocal_60)
		{
			case 0:
				...
				func_319(&(Local_68.f_8), "", "", &iLocal_127, &iLocal_128, 1, 0);
				iLocal_60 = 1;
				break;
				...
				switch (iLocal_61)
				{
					case 2:
						...
						else if (!iLocal_99)
						{
							...
							{
								func_319(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_99 = 1;
							}
						}
						else
						{
							func_358(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, iLocal_128, 1);
							if (func_112(Local_68.f_9, vLocal_337, 22f) && func_412(Local_68.f_9, vLocal_337, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (func_411(&(Local_68.f_19)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
								...
								else if (func_410(Local_68.f_9, iLocal_135, 0, 1102053376, 1086324736))
								{
									iLocal_61 = 0;
								}
								else if (func_112(Local_68.f_9, vLocal_337, 5f))
								{
									iLocal_61 = 0;
								}
								else if (func_411(&(Local_68.f_19)))
								{
									if (func_112(Local_68.f_9, vLocal_337, (22f - 1.5f)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
										if (Local_68.f_10 != 3 && Local_68.f_10 != 4)
						...
						if (func_367(Local_68.f_9, Local_68.f_19, 22f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_60 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_91)
						{
							...
							if (func_75(&uLocal_157, cLocal_150, "BB2_J2", 4, 0, 0, 0))
							{
								Local_68.f_17 = MISC::GET_GAME_TIMER();
								iLocal_124 = MISC::GET_GAME_TIMER();
								iLocal_91 = 1;
...
void func_406()
{
	if (!iLocal_92)
	{
		if (!func_62())
		{
			if (func_112(Local_68.f_9, vLocal_337, (22f + 5f)))
			{
				iLocal_118 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(&Local_335))
				{
					if (func_75(&uLocal_157, cLocal_150, "BB2_AMB", 1, iLocal_118, 0, 0))
					{
						iLocal_92 = 1;
					}
				}
				else if (func_408(&uLocal_157, cLocal_150, "BB2_AMB", &Local_335, 1, iLocal_118, 0))
				{
					iLocal_92 = 1;
					StringCopy(&Local_335, "", 24);
				}
	...
	{
		if (!func_112(Local_68.f_9, vLocal_337, (22f + 10f)))
		{
			Local_335 = { func_407() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_335))
			{
...
int func_410(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_433(iParam0))
	{
		if (!func_363(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_112(Local_68.f_9, vLocal_337, fParam3))
				{
					return 0;
				}
				if (!func_412(iParam0, vLocal_337, fParam4))
				{
					return 0;
				}
			}
...
int func_412(int iParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
...
void func_422()
{
	...
	if (iLocal_58 == 0)
	{
		if (!SYSTEM::VDIST2(vLocal_337, Local_63) <= ((Local_63.f_3 + 25f) * (Local_63.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_9, 0) && !PED::IS_PED_INJURED(Local_68.f_9))
		{
			...
			{
				if (!func_112(Local_68.f_9, vLocal_337, 150f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
			...
			{
				if (!func_112(Local_68.f_9, vLocal_337, 80f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
...
int func_423(bool bParam0)
{
	if (func_23(Local_75))
	{
		...
		if (func_429(Local_75, 1126825984))
		{
			return 1;
		}
		if (func_424(Local_75, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_427(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
void func_432(int iParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
...
void func_437(bool bParam0, bool bParam1)
{
	...
	if (iLocal_58 > 2)
	{
		func_397(0, &uLocal_144);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_143, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_114(&uLocal_157, 2);
	func_114(&uLocal_157, 3);
	func_114(&uLocal_157, 4);
	func_324(&uLocal_44, 0, 0);
...
void func_446(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_520())
	{
...
void func_447(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_515(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_493(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_174(vParam1, 0f, 0f, 0f, 0))
		...
		func_489(vParam1, 5f, 0);
		if (func_89(iParam10))
		{
			func_488(iParam10, 0);
			while (!func_448(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_448(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_483(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
int func_453(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_478(iVar0, bParam1, uParam2) && !func_477(PLAYER::PLAYER_ID())) && !func_461(iParam0))
	{
		return 0;
	}
...
{
	if (func_476(PLAYER::PLAYER_ID()) || func_475(PLAYER::PLAYER_ID()))
	{
		if (func_462(iParam0))
		{
			return 1;
...
int func_483(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_474(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_486(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_486(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_485(iParam0);
	if (func_484(*iParam0))
	{
...
void func_488(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_165(iParam0, iParam1))
				{
...
void func_489(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_493(vector3 vParam0, float fParam1)
{
	return func_494(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_494(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
int func_496(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_498(iParam0, uVar1[iVar3], 1) && func_497(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_174(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_497(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_499(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_502(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_501())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_176(iVar2 + 1)))
				{
...
int func_503(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_509(PLAYER::PLAYER_ID(), -1))
		{
...
void func_521()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_322);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, 1862763509);
	vVar0 = { func_528(Local_63) };
	vVar1 = { func_527(Local_63) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar1);
	iLocal_143 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
	MISC::CLEAR_AREA(Local_63, 15f, 0, 0, 0, false);
...
void func_522()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_360(Local_68.f_9);
		func_523(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		PED::SET_PED_COMPONENT_VARIATION(Local_68.f_9, 0, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_68.f_9, 2, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_68.f_9, 3, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_68.f_9, 4, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_68.f_9, 8, 0, 0, 0);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_145);
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			func_360(Local_69[iVar0 /*20*/]);
			if (Local_69[iVar0 /*20*/].f_5 != 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_69[iVar0 /*20*/], Local_69[iVar0 /*20*/].f_5, -1, true, true);
			}
			PED::SET_PED_CONFIG_FLAG(Local_69[iVar0 /*20*/], 137, true);
			func_523(Local_69[iVar0 /*20*/], "BACKUP_", iVar0);
			if (func_102(Local_71[0 /*6*/]))
			{
				if (iVar0 == 1)
				{
					PED::SET_PED_INTO_VEHICLE(Local_69[iVar0 /*20*/], Local_71[0 /*6*/], -1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iVar0 /*20*/], 1, false);
				}
				else if (iVar0 == 2)
				{
					PED::SET_PED_INTO_VEHICLE(Local_69[iVar0 /*20*/], Local_71[0 /*6*/], 2);
				}
				else if (iVar0 == 3)
				{
					PED::SET_PED_INTO_VEHICLE(Local_69[iVar0 /*20*/], Local_71[0 /*6*/], 1);
			...
			{
				case 0:
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 0, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 2, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 3, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 4, 0, 0, 0);
					break;
				
				case 1:
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 0, 0, 3, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 2, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 3, 2, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 4, 0, 1, 0);
					break;
				
				case 2:
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 0, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 2, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 3, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 4, 0, 2, 0);
					break;
				
				case 3:
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 0, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 2, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_69[iVar0 /*20*/], 4, 0, 2, 0);
					break;
			}
			if (iVar0 == 0)
			{
				...
				TASK::SET_SEQUENCE_TO_REPEAT(iLocal_145, 1);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_145);
				TASK::TASK_PERFORM_SEQUENCE(Local_69[iVar0 /*20*/], iLocal_145);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_145);
				if (func_23(Local_69[iVar0 /*20*/]))
				{
					func_97(&uLocal_157, 4, Local_69[iVar0 /*20*/], "HILLBILLY", 0, 1);
					PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_69[iVar0 /*20*/], 1);
				}
			}
		}
		iVar0++;
...
int func_524()
{
	...
	if (iLocal_134 > 0)
	{
		...
		while (iVar2 <= (iLocal_134 - 1))
		{
			if (func_54(&(Local_69[iVar2 /*20*/]), Local_69[iVar2 /*20*/].f_19, Local_69[iVar2 /*20*/].f_1, Local_69[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				...
				{
					PED::SET_PED_CONFIG_FLAG(Local_69[iVar2 /*20*/], 132, true);
					iVar0++;
					iVar1++;
				}
			}
	...
	if (iLocal_131 > 0)
	{
		...
		{
			if (func_526(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_133 - 1))
		{
			if (func_525(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iVar0 == ((((iLocal_134 + iLocal_131) + iLocal_132) + iLocal_130) + iLocal_133) + 1)
	{
		return 1;
	}
	return 0;
...
int func_525(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam4))
...
int func_526(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_527(struct<5> Param0, var uParam1, var uParam2, var uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_528(struct<5> Param0, var uParam1, var uParam2, var uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_529()
{
	...
	iVar0 = 0;
	iLocal_67 = 4;
	Local_68.f_11 = joaat("a_m_y_salton_01");
	Local_68.f_13 = { 162.5572f, 2289.158f, 93.1489f };
	Local_68.f_16 = 292.4985f;
	...
	Local_68.f_19 = 0;
	func_8();
	Local_69[0 /*20*/].f_19 = joaat("a_m_m_hillbilly_02");
	Local_69[0 /*20*/].f_1 = { 164.3371f, 2290.645f, 93.1434f };
	Local_69[0 /*20*/].f_4 = 119.9981f;
	Local_69[0 /*20*/].f_5 = joaat("WEAPON_PISTOL");
	Local_69[1 /*20*/].f_19 = joaat("a_m_m_hillbilly_02");
	Local_69[1 /*20*/].f_1 = { 162.4443f, 2283.816f, 92.9438f };
	Local_69[1 /*20*/].f_4 = 299.9979f;
	Local_69[1 /*20*/].f_5 = joaat("WEAPON_PISTOL");
	Local_69[2 /*20*/].f_19 = joaat("a_m_m_hillbilly_02");
	Local_69[2 /*20*/].f_1 = { 163.1961f, 2282.257f, 93.6852f };
	Local_69[2 /*20*/].f_4 = 299.9979f;
	Local_69[2 /*20*/].f_5 = joaat("WEAPON_PISTOL");
	Local_69[3 /*20*/].f_19 = joaat("a_m_m_hillbilly_02");
	Local_69[3 /*20*/].f_1 = { 163.9295f, 2283.512f, 92.6928f };
	Local_69[3 /*20*/].f_4 = 299.9979f;
	Local_69[3 /*20*/].f_5 = joaat("WEAPON_PISTOL");
	iVar0 = 0;
	while (iVar0 <= (iLocal_134 - 1))
	{
		Local_69[iVar0 /*20*/].f_15 = 0;
		Local_69[iVar0 /*20*/].f_16 = 0;
		Local_69[iVar0 /*20*/].f_17 = 0;
		Local_69[iVar0 /*20*/].f_14 = 0;
		iVar0++;
	}
	iLocal_134 = 4;
	Local_71[0 /*6*/].f_5 = joaat("BISON");
	Local_71[0 /*6*/].f_1 = { 167.6809f, 2285.204f, 92.2978f };
	Local_71[0 /*6*/].f_4 = 164.9999f;
	Local_71[1 /*6*/].f_5 = joaat("GAUNTLET");
	Local_71[1 /*6*/].f_1 = { 183.4f, 2287.07f, 91.09f };
	Local_71[1 /*6*/].f_4 = 208.2f;
	iLocal_131 = 2;
	iLocal_132 = 0;
	iLocal_130 = 0;
	iLocal_133 = 0;
	vLocal_339 = { 232.541f, 2321.896f, 76.1228f };
	fLocal_119 = 129.6421f;
	vLocal_340 = { 190.8215f, 2284.055f, 88.3843f };
	fLocal_120 = 76.0608f;
	vLocal_341 = { 181.1229f, 2289.56f, 91.2944f };
	fLocal_121 = 103.4559f;
	vLocal_342 = { 0f, 0f, 0f };
	vLocal_343 = { 0f, 0f, 0f };
	iLocal_61 = 4;
	iLocal_81 = 0;
	...
	iLocal_139 = 0;
	iLocal_141 = -1;
	vLocal_338 = { 166.4233f, 2285.507f, 92.5205f };
	vLocal_336 = { 2722.661f, 4143.105f, 43.0617f };
	StringCopy(&vLocal_323, "", 24);
	StringCopy(&Local_335, "", 24);
	Local_75.f_6 = func_540(62);
	Local_75.f_1 = { func_539() };
	Local_75.f_4 = func_538();
	Local_77.f_5 = func_537();
	Local_77.f_1 = { func_536() };
	Local_77.f_4 = func_535();
	Local_78.f_5 = func_534();
	Local_78.f_1 = { func_533() };
	Local_78.f_4 = func_532();
	Local_79.f_5 = func_48();
	Local_79.f_1 = { func_47() };
	Local_79.f_4 = func_46();
	Local_80.f_5 = func_45();
	Local_80.f_1 = { func_531() };
	Local_80.f_4 = func_530();
	sLocal_146 = "BailBond2Jumper";
	sLocal_147 = "BB2_J1";
	sLocal_148 = "BB2_J3";
	sLocal_149[0] = "BB2_VC1";
	sLocal_149[1] = "BB2_VC2";
	sLocal_149[2] = "BB2_VC3";
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		iLocal_86[iVar0] = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_549()) || func_548()) || func_542()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_544()) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_544() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_543()) || func_547()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_544()) || Global_30738) || func_550()) || func_95(8, -1)) || func_548()) || func_542()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_544()) || func_548()) || Global_110607) || Global_30738) || func_550()) || Global_42561) || func_95(8, -1)) || func_542()) || func_547()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_547()) || func_549()) || func_548()) || func_543())
						{
							return 0;
						}
						break;
...
void func_553(int iParam0)
{
	...
	if (!func_577())
	{
		...
		func_554(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}
...
int func_555(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_566())
	{
		...
		{
			iVar2 = func_556(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
void func_558(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
