...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_269(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
	iVar2[0] = 31;
	if (!func_250(&iVar2, &Var0, vVar1, 1f))
	{
		func_249();
	...
	while (true)
	{
		...
		func_192(Var0);
		func_184(&iLocal_53, &(Var0.f_9), vVar1);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_193(var uParam0, bool bParam1)
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_76822 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_213(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if ((func_229() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_233(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_234(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_234(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_199(iParam0);
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_251((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_251((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_251(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_252(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_252(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
