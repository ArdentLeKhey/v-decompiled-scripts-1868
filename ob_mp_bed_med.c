...
void __EntryFunction__()
{
	...
	iLocal_302 = 49;
	iLocal_303 = 64;
	fLocal_307 = ((0.05f + 0.275f) - 0.01f);
	iLocal_329 = -1;
	sLocal_330 = "mp_bedmid";
	sLocal_331 = "f_getin_l_bighouse";
	sLocal_332 = "f_sleep_l_loop_bighouse";
	sLocal_333 = "f_getout_l_bighouse";
	fLocal_335 = 43.8287f;
	vLocal_336 = { 349f, -997.3587f, -100.5f };
	vLocal_337 = { 351.74f, -997.3587f, -97f };
	vLocal_338 = { 349.66f, -996.183f, -99.764f };
	vLocal_339 = { 0f, 0f, -3.96f };
	vLocal_334 = { ScriptParam_342.f_1[0 /*3*/] };
	vLocal_334 = { 349.9853f, -997.8344f, -99.1952f };
	if ((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18) || func_83()) || Global_2531497.f_1852)
	{
		func_82();
	}
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_322)
				{
					case 0:
					...
					case 1:
						...
						{
							func_2();
							if (MISC::IS_BIT_SET(iLocal_321, 0))
							{
								func_1();
							}
						}
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 6f)
			{
				func_82();
			}
		}
...
void func_1()
{
	iLocal_328 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_327);
	switch (iLocal_323)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_323)
	{
		case 0:
			...
			if (func_73() == 5)
			{
				MISC::CLEAR_BIT(&iLocal_321, 0);
				if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
					iLocal_326 = 1;
				}
				iLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_338, vLocal_339, 2, false, true, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_327, sLocal_330, sLocal_332, 8f, -2f, 261, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_327);
				iLocal_323 = 7;
			}
			else if (func_54(9))
			{
				if ((((func_50(vLocal_334, vVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_336, vLocal_337, 2f, 0, true, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (iLocal_329 == -1)
					{
						func_45(&iLocal_329, 3, "SA_BED_IN", 0, 0, 0, 0);
					}
					iLocal_323 = 1;
				}
			}
		...
		case 1:
			vLocal_340 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(vLocal_334, vVar0) && vLocal_340.z < (vLocal_334.z + 1f)) && func_54(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_336, vLocal_337, 2f, 0, true, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (func_42(iLocal_329, 1))
					{
						func_40(&iLocal_329);
						func_39();
						...
						func_37();
						MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_334, 3f, 0);
						Global_1573337 = 9;
						...
						fLocal_335 = vVar1.z;
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_334, 1f, 5000, fLocal_335, 0.05f);
		...
		case 2:
			...
			{
				MISC::CLEAR_BIT(&iLocal_321, 0);
				iLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_338, vLocal_339, 2, false, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_327, sLocal_330, sLocal_331, 4f, -2f, 261, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_327);
				if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
					iLocal_326 = 1;
		...
		case 6:
			...
			if (!func_46(PLAYER::PLAYER_ID()) && PAD::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				...
				MISC::CLEAR_BIT(&iLocal_321, 0);
				iLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_338, vLocal_339, 2, false, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_327, sLocal_330, sLocal_333, 2f, -2f, 261, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_327);
				iLocal_323 = 8;
			}
			break;
		...
		case 7:
			if ((!func_8() && INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334))) && iLocal_326 == 1)
			{
				CAM::_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
			}
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && !func_8()) && !func_6()) && Global_1312467.f_8 == 0)
			{
				bLocal_325 = true;
				MISC::CLEAR_BIT(&iLocal_321, 0);
				iLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_338, vLocal_339, 2, false, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_327, sLocal_330, sLocal_333, 1000f, -2f, 261, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_327);
				iLocal_323 = 8;
			}
			break;
...
{
	if (!Global_2409284 == iParam0)
	{
		Global_2409284.f_1 = 0;
	}
	Global_2409284 = iParam0;
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2409284.f_3 = NETWORK::GET_NETWORK_TIME();
	}
}
...
float func_16(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_19(PLAYER::PLAYER_ID(), 0) && !func_23()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_31(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_31(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					...
					if (func_28(Global_4456448.f_190930))
					{
...
{
	return MISC::IS_BIT_SET(Global_1373500.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
int func_49()
{
	...
	if (iVar1 > 0)
	{
		...
		while (iVar2 <= 7)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar2], vLocal_336, vLocal_337, 2f, 0, true, 0))
				{
					return 0;
				}
			}
...
int func_50(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95627 && Global_95628) || func_52())
					{
						return 0;
					}
					if (func_51(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_51(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_60()
{
	...
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_330))
	{
		return 0;
	}
	iLocal_324 = 1;
...
{
	return func_81(iParam0, Global_41396);
}
