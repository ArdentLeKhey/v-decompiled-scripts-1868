...
void func_3()
{
	MISC::CLEAR_BIT(&(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847), 3);
}
...
{
	if ((!SCRIPT::IS_THREAD_ACTIVE(Global_2416074.f_1480) || Global_2416074.f_1480 == SCRIPT::GET_ID_OF_THIS_THREAD()) || bParam2)
	{
		if (bParam0)
		{
			Global_2416074.f_1480 = SCRIPT::GET_ID_OF_THIS_THREAD();
			Global_2416074.f_1481 = NETWORK::GET_NETWORK_TIME();
		}
		else
		{
			Global_2416074.f_1480 = -1;
		}
		Global_2416074.f_1483 = iParam1;
		Global_2416074.f_1485 = bParam0;
	}
	else if (!bParam2)
	{
	}
...
void func_13()
{
	MISC::CLEAR_BIT(&(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847), 1);
}
...
void func_14(int iParam0)
{
	...
	func_3();
	MISC::CLEAR_BIT(&(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847), 4);
}
...
bool func_27()
{
	return (!MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847, 4) && !func_28());
}

bool func_28()
{
	return ((Global_4456448.f_58154 == 6 || Global_4456448.f_58154 == 7) && Global_4456448.f_2 == 20);
}
...
void func_42()
{
	MISC::SET_BIT(&(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847), 1);
}
...
bool func_46()
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847, 3);
}
...
void func_51(int iParam0)
{
	...
	MISC::CLEAR_BIT(&(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847), 2);
}
...
bool func_53()
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847, 2);
}
...
int func_55(int iParam0)
{
	if (iParam0 > -1)
	{
		if (Global_2424073[iParam0 /*421*/].f_236 > -1)
		{
			if (func_56(Global_2424073[iParam0 /*421*/].f_236) == 4)
			{
				return 1;
			}
		}
		if (MISC::IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_195, 4))
		{
			return 1;
		}
	}
...
{
	return (iParam0 != -1 && MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_847, 1));
}
...
bool func_72()
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_847, 1);
}
