...
void func_8(int iParam0)
{
	...
	if (Global_111560.f_9080 || func_23(0))
	{
		iVar0 = func_22();
		if (!func_9(iVar0))
		{
...
void func_28()
{
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (!func_95(PLAYER::PLAYER_PED_ID(), vLocal_176, 270f))
			{
				iLocal_53 = 2;
			}
...
void func_49(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_23(0) && Global_76823.f_1 == 1) && func_50(Global_76823))
		{
		}
		else
		{
...
int func_68(int iParam0)
{
	...
	return Global_96177[func_69(iParam0)];
}
...
bool func_94(char* sParam0, int iParam1, int iParam2)
{
...
void func_96()
{
	func_131(&iLocal_198, &iLocal_199, &iLocal_55, &iLocal_173, &iLocal_172, vLocal_176, Local_202, 0, 11f);
	switch (iLocal_53)
	{
		case 0:
			if (func_110(iLocal_52, bLocal_40))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
				{
					...
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_198, 0))
						{
		...
		case 3:
			if (func_6(Local_202))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_202, 0))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_202, -1);
				}
				else
				{
					func_97(Local_202, vLocal_176, 126.0705f, 0, 1);
					func_29(1, 1, 1);
					iLocal_53 = 1;
				}
			}
...
void func_105(int iParam0, vector3 vParam1, bool bParam2)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_106(vParam1, 5, bParam2);
	}
}
...
int func_110(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_124(1, vLocal_175, 0))
			{
				if (!func_459())
				{
					if (func_123())
					...
					else if ((((func_124(2, Local_202.f_1, Local_202.f_4) && func_124(5, Local_200.f_1, Local_200.f_4)) && func_124(6, Local_201.f_1, Local_201.f_4)) && func_124(3, Local_197.f_1, Local_197.f_4)) && func_124(4, vLocal_175, 0))
					{
						iLocal_206 = PED::ADD_SCENARIO_BLOCKING_AREA(-417.198f, -2155.886f, 8.36266f, -383.4908f, -2188.511f, 12.9213f, 0, 1, 1, 1);
						func_122(34);
						VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("TRASH"), true);
						VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("TOWTRUCK"), true);
						if (func_446(Local_197))
						{
							if (!func_121(Local_197, -2017877118))
							{
								TASK::TASK_PLAY_ANIM_ADVANCED(Local_197, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_200), 1000f, -1.5f, -1, 1, 0, 2, 0);
								PED::_0x2208438012482A1A(Local_197, 0, 0);
							}
							func_120();
							func_118();
							PED::SET_PED_CONFIG_FLAG(Local_197, 154, false);
							PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_197, iLocal_203);
						}
						if (HUD::GET_BLIP_FROM_ENTITY(Local_202) != 0)
						{
							iVar0 = HUD::GET_BLIP_FROM_ENTITY(Local_202);
							MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
							func_27(&iVar0);
							MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(0);
						}
						func_116(&iLocal_173, Local_202, 1);
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Tow_truck_damage", Local_200, "FBI_04_HEAT_SOUNDS", false, 0);
						return 1;
					}
				}
				else
		...
		case 1:
			if (bParam1)
			{
				if ((((func_124(2, Local_202.f_1, Local_202.f_4) && func_124(5, Local_200.f_1, Local_200.f_4)) && func_124(4, vLocal_175, 0)) && func_124(6, Local_201.f_1, Local_201.f_4)) && func_124(3, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), -ENTITY::GET_ENTITY_HEADING(Local_200)))
				{
					MISC::CLEAR_AREA(Local_197.f_1, 100f, 1, 0, 0, false);
					func_115();
					if (func_446(Local_197))
					{
						PED::SET_PED_CAPSULE(Local_197, 0.1f);
						if (!func_121(Local_197, -2017877118))
						{
							TASK::TASK_PLAY_ANIM_ADVANCED(Local_197, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_200), 1000f, -1.5f, -1, 1, 0, 2, 0);
							PED::_0x2208438012482A1A(Local_197, 0, 0);
		...
		case 3:
			if (bParam1)
			{
				if (func_124(2, vLocal_176, Local_202.f_4))
				{
					func_115();
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_202, -1);
					if (!func_113())
...
void func_114(int iParam0, vector3 vParam1, float fParam2)
{
	...
	func_97(iParam0, vParam1, fParam2, 0, 1);
}
...
{
	func_119(&uLocal_208);
	func_87(&uLocal_208, 3, Local_197, "FIBP2TowGuy", 1, 1);
}
...
int func_123()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), joaat("TOWTRUCK")))
		{
			...
			iLocal_198 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			if (func_6(iLocal_198))
			{
				return 1;
			}
...
int func_124(int iParam0, vector3 vParam1, float fParam2)
{
	...
	{
		case 0:
			if (func_130(vParam1, vLocal_175, 1056964608, 0) && fParam2 == 0f)
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_6(Global_95196[0]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], true, 1);
				Local_202 = Global_95196[0];
				if (func_6(Local_202))
				{
					func_129(Local_202, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_202, true);
					return 1;
				}
			}
		...
		case 3:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95196.f_9[0], 1))
				{
					...
					if (func_446(Local_197))
					{
						...
						PED::SET_PED_CAPSULE(Local_197, 0.1f);
						AUDIO::STOP_PED_SPEAKING(Local_197, true);
						TASK::SET_PED_PATH_MAY_ENTER_WATER(Local_197, 0);
						return 1;
					}
				}
				else
			...
			else if (func_125(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1))
			{
				PED::SET_PED_CAPSULE(Local_197, 0.1f);
				AUDIO::STOP_PED_SPEAKING(Local_197, true);
				PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_197);
				TASK::SET_PED_PATH_MAY_ENTER_WATER(Local_197, 0);
				return 1;
			}
			break;
		...
		case 6:
			if (func_6(Global_95196[2]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
				Local_201 = Global_95196[2];
				if (func_6(Local_201))
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_201, 3);
					return 1;
				}
			}
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, vector3 vParam5, int iParam6, bool bParam7, float fParam8)
{
	if (func_6(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_137(*iParam0)) && !func_136(*iParam0))
				{
					func_27(iParam4);
...
int func_136(int iParam0)
{
	...
	if ((func_446(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_6(iParam0))
	{
...
void func_138()
{
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_110(iLocal_52, bLocal_40))
			{
				func_105(&iLocal_172, vLocal_176, 1);
				func_155(1);
				iLocal_53 = 1;
			}
			break;
		...
		case 1:
			...
			if (!bLocal_193)
			{
				if (func_143(iLocal_198, vLocal_176, &iLocal_172, iLocal_54, iLocal_55, &iLocal_167, &iLocal_191, 0, 0, 11f))
				{
					iLocal_53 = 2;
				}
			}
			else if (!iLocal_192)
			{
				if (!func_142())
				{
					if (func_446(Local_197))
					{
						if (func_137(PED::GET_VEHICLE_PED_IS_IN(Local_197, 0)))
						{
							func_116(&(Local_197.f_6.f_1), Local_202, 0);
						}
					}
		...
		case 3:
			if (func_6(iLocal_198))
			{
				...
				{
					func_97(iLocal_198, vLocal_176, 146.5443f, 0, 1);
					func_29(1, 1, 1);
					iLocal_53 = 1;
				}
			}
...
int func_146(int iParam0, int iParam1)
{
	switch (iLocal_57[iParam0])
	{
		case 0:
			...
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_176, 4, 20f, 786469, 2f, 10f, 1);
				iLocal_57[iParam0] = 5;
			}
			break;
		
		case 5:
			if (!func_150(iParam0, iParam1) || func_95(PLAYER::PLAYER_PED_ID(), vLocal_176, 1.5f))
			{
				iLocal_57[iParam0] = 6;
			}
			break;
...
int func_147(int iParam0, int iParam1)
{
	...
	if (func_446(Local_197))
	{
		if (PED::IS_PED_IN_MELEE_COMBAT(Local_197))
		{
			return 1;
		}
		switch (iLocal_57[iParam0])
		{
			case 0:
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_197, vVar1) };
				if (!MISC::IS_POSITION_OCCUPIED(vVar0, 1.5f, 0, 0, 1, 0, 0, Local_197, 0))
				{
					if (!bLocal_195)
					{
						if (iParam0 == 0)
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, vVar0, 1f, 20000, 0.25f, 0, 82.7989f);
			...
			case 1:
				...
				{
					TASK::TASK_STEALTH_KILL(iParam1, Local_197, MISC::GET_HASH_KEY("AR_stealth_kill_a"), 1f, 0);
					TASK::CLEAR_PED_TASKS(Local_197);
					iLocal_56 = 18;
					iLocal_57[iParam0] = 4;
				}
				break;
			...
			case 2:
				...
				{
					TASK::TASK_STEALTH_KILL(iParam1, Local_197, MISC::GET_HASH_KEY("AR_stealth_kill_knife"), 1f, 0);
					TASK::CLEAR_PED_TASKS(Local_197);
					iLocal_56 = 18;
					iLocal_57[iParam0] = 4;
				}
...
int func_150(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_198) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_198, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_198, vLocal_176, 2f, 2f, 2f, false, true, 0))
		{
			if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_198, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_198, -1, 0) != PLAYER::PLAYER_PED_ID())
			{
				if (PED::IS_PED_IN_VEHICLE(iParam1, iLocal_198, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_198, -1, 0) == iParam1)
				{
					iLocal_58[iParam0] = 2;
					return 1;
				}
...
int func_152(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if (func_446(Local_197))
		{
			if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, 0, true, 0) && !func_153(iParam0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_197)) && !PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0))
			{
				iLocal_58[iParam0] = 1;
				return 1;
			}
...
void func_156()
{
	...
	if (func_446(Local_197))
	{
		...
		switch (iLocal_56)
		{
			...
			case 3:
				if (func_6(Local_202))
				{
					if (func_95(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_202, -1f, 0.5f, 0f), 3f))
					{
						func_210(15);
						return;
					}
			...
			case 2:
				if (func_6(Local_200))
				{
					...
					{
						if (func_95(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, -1f, 0.5f, 0f), 2f))
						{
							func_210(4);
							return;
						}
			...
			case 7:
				if (func_6(Local_202) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_202))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_197, Local_202))
					{
						func_210(9);
					}
					if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
			...
			case 6:
				if (func_6(Local_200) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_200))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_197, Local_200))
					{
						func_210(9);
					}
					if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
			...
			case 8:
				if (func_6(Local_201) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_201))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_197, Local_201))
					{
						func_210(9);
					}
					if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
			...
			case 9:
				if (func_209(Local_197, PLAYER::PLAYER_PED_ID(), 20f, 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					func_210(10);
					return;
				}
				...
				if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
				{
					if (!func_121(Local_197, 780511057))
					{
						if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_197))
						{
							if (func_209(Local_197, PLAYER::PLAYER_PED_ID(), 10f, 1))
							{
								func_210(10);
							}
			...
			case 10:
				if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
				{
					...
					{
						if (!func_209(Local_197, Local_201, 15f, 1) && !PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
						{
							func_210(8);
						}
					}
					else if (bLocal_177)
					{
						if (func_6(Local_202))
						{
							if (!func_209(Local_197, Local_202, 10f, 1))
							{
								func_210(7);
							}
						}
					...
					else if (iLocal_55 == 1)
					{
						if (func_6(Local_200))
						{
							if (!func_209(Local_197, Local_200, 10f, 1))
							{
								func_210(6);
							}
						}
			...
			case 14:
				if (!func_209(Local_197, PLAYER::PLAYER_PED_ID(), 118f, 1))
				{
			...
			case 13:
				if (MISC::GET_GAME_TIMER() - Local_197.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_197, PLAYER::PLAYER_PED_ID(), 1))
					{
						func_210(14);
					}
					else
				...
				else if (func_202(Local_197, 1, 0, 0, 0))
				{
					func_210(14);
				}
				break;
			...
			case 15:
				...
				{
					if (func_195(Local_197, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7))
					{
						func_194();
						return;
					}
			...
			case 5:
				if (func_6(Local_200))
				{
					if (func_95(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 2f))
					{
						if (!func_121(Local_197, 713668775) && !func_121(Local_197, 1920390111))
						{
							func_210(1);
						}
					}
			...
			case 16:
				if (func_6(Local_202))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
					{
						if (func_190(Local_202, &uLocal_180, &uLocal_181, &uLocal_182, &uLocal_183, 3, 2f))
						{
							...
							TASK::TASK_PERFORM_SEQUENCE(Local_197, iVar0);
						...
						{
							func_160(&uLocal_20, Local_202, 0, 0, 1, 1, 1);
						}
					}
				}
				break;
			...
			case 17:
				...
				{
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -414.4899f, -2181.967f, 11.93531f, -414.1714f, -2170.252f, 5.64993f, 12.63f, 0, true, 0))
					{
						func_210(5);
					}
					else
	...
	else
	{
		...
		if (func_6(Local_200))
		{
			if (!func_95(Local_200, Local_200.f_1, 50f) || !func_209(PLAYER::PLAYER_PED_ID(), Local_200, 250f, 1))
			{
				func_133(&Local_200);
			}
		}
	...
	{
		func_158(Local_197, &(Local_197.f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
	}
	else
	{
...
int func_168(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_175() || func_174(Global_4456448.f_190930)) || func_173())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
int func_169(int iParam0)
{
	if (iParam0 != func_77())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_170(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_181(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_184(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_182(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_193()
{
	if (func_6(Local_200))
	{
		if (!func_121(Local_197, -2017877118))
		{
			if (!func_95(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 0.5f))
			{
				if (!func_121(Local_197, 713668775))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 1f, 60000, 0.3f, 512, -ENTITY::GET_ENTITY_HEADING(Local_200));
				}
			}
			else if (!func_121(Local_197, 1920390111))
			{
				TASK::TASK_ACHIEVE_HEADING(Local_197, -ENTITY::GET_ENTITY_HEADING(Local_200), 0);
			}
		}
		PED::SET_PED_CAPSULE(Local_197, 0.1f);
	}
...
void func_194()
{
	if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		if (!func_209(PLAYER::PLAYER_PED_ID(), Local_197, 10f, 1))
		{
			func_210(14);
		}
		else
...
int func_208()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (func_209(Local_197, PLAYER::PLAYER_PED_ID(), 20f, 1))
		{
			return 1;
		}
	...
	else if (func_209(Local_197, PLAYER::PLAYER_PED_ID(), 10f, 1))
	{
	...
	switch (iParam0)
	{
		case 1:
			if (!func_121(Local_197, -2017877118))
			{
				if (func_6(Local_200))
				{
					TASK::TASK_PLAY_ANIM(Local_197, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, -1, 1, 0, 0, 0, 0);
				}
			}
			break;
		
		case 3:
			if (!func_121(Local_197, -1794415470))
			{
				if (func_6(Local_202))
				{
					TASK::TASK_ENTER_VEHICLE(Local_197, Local_202, 60000, -1, 2f, 524296, 0);
				}
			}
			break;
		...
		case 2:
			if (!func_121(Local_197, 713668775))
			{
				if (func_6(Local_202))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, -1f, 0.5f, 0f), 1f, 30000, 0.25f, 0, 141.2603f);
				}
			}
			break;
		...
		case 6:
			if (!func_121(Local_197, -1794415470))
			{
				if (func_6(Local_200))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
					{
						TASK::TASK_ENTER_VEHICLE(Local_197, Local_200, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 7:
			if (!func_121(Local_197, -1794415470))
			{
				if (func_6(Local_202))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
					{
						TASK::TASK_ENTER_VEHICLE(Local_197, Local_202, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 8:
			if (func_121(Local_197, 242628503) || TASK::GET_SCRIPT_TASK_STATUS(Local_197, 242628503) == 2)
			{
				TASK::CLEAR_PED_TASKS(Local_197);
			}
			if (func_6(Local_201))
			{
				if (!func_121(Local_197, -1794415470))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
					{
						TASK::TASK_ENTER_VEHICLE(Local_197, Local_201, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 9:
			if (!func_121(Local_197, -1273030092))
			{
				if (func_6(Local_201))
				{
					if (func_6(Local_200) && func_6(Local_202))
					{
						if (bLocal_177)
						{
							if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_201))
							{
								TASK::TASK_VEHICLE_MISSION(Local_197, Local_201, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_213();
						...
						else if (iLocal_55 == 1)
						{
							if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_201))
							{
								TASK::TASK_VEHICLE_MISSION(Local_197, Local_201, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_213();
				...
				else if (func_6(Local_200) && func_6(Local_202))
				{
					if (bLocal_177)
					{
						if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_202))
						{
							TASK::TASK_VEHICLE_MISSION(Local_197, Local_202, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_213();
					...
					{
						if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_200))
						{
							TASK::TASK_VEHICLE_MISSION(Local_197, Local_200, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_213();
		...
		case 10:
			if (!func_121(Local_197, 242628503))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
				{
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_203, 1862763509);
		...
		case 11:
			if (!func_121(Local_197, -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_197, PLAYER::PLAYER_PED_ID(), 0);
			}
			break;
		...
		case 4:
			...
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_197, PLAYER::PLAYER_PED_ID(), 0);
				PED::SET_PED_CAPSULE(Local_197, 0f);
			}
			break;
		
		case 13:
			if (!func_121(Local_197, 474215631))
			{
				TASK::CLEAR_PED_TASKS(Local_197);
				TASK::TASK_COWER(Local_197, -1);
			}
			break;
		
		case 14:
			if (!func_121(Local_197, 1805844857))
			{
				if (!func_121(Local_197, 474215631))
				{
					TASK::CLEAR_PED_TASKS(Local_197);
				}
				TASK::TASK_SMART_FLEE_PED(Local_197, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
			}
			break;
		...
		case 15:
			...
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_203, 1862763509);
				TASK::TASK_COMBAT_PED(Local_197, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
			break;
		...
		case 16:
			if (!func_121(Local_197, 242628503))
			{
				if (func_6(Local_202))
				{
					...
					if (!PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
					{
						TASK::TASK_ENTER_VEHICLE(0, Local_202, 60000, -1, 2f, 1, 0);
					}
					TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_202, 30f, 786469);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(Local_197, iVar1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_197, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", 0);
}
...
void func_228()
{
	if (iLocal_56 != 14 && iLocal_56 != 13)
	{
		if (func_236(Local_197, 1090519040, 1097859072))
		{
			func_210(14);
			return;
		}
		if (!func_235() || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_197, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (func_209(PLAYER::PLAYER_PED_ID(), Local_197, 30f, 1))
			{
				if (func_230(Local_197, 1, 50f, 150f, 0, 1, 0, 0))
				{
					func_229();
					return;
				}
...
void func_229()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 1))
	{
		func_194();
	}
	else
	{
		if (func_6(Local_202))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_202, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_200))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_197, Local_200, 0))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_200, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_201))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_197, Local_201, 0))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_201, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
			}
		}
	}
	ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_197);
}
...
int func_235()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_197, 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		return 1;
	}
	return 0;
...
void func_237()
{
	if ((((((iLocal_56 != 6 && iLocal_56 != 7) && iLocal_56 != 8) && iLocal_56 != 9) && iLocal_56 != 10) && iLocal_56 != 14) && iLocal_56 != 13)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -419.0416f, -2179.051f, 8.78829f, -389.5436f, -2179.148f, 20.31836f, 25f, 0, true, 0))
			{
				if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_197))
				{
					if (func_6(Local_201))
...
void func_238()
{
	if (func_6(Local_202))
	{
		if (((func_241() && iLocal_56 != 6) && iLocal_56 != 11) && iLocal_56 != 8)
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_209(Local_202, PLAYER::PLAYER_PED_ID(), 6f, 1))
				{
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_202, PLAYER::PLAYER_PED_ID()))
					{
						func_210(15);
					}
				}
			}
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_202, PLAYER::PLAYER_PED_ID(), 1))
			{
		...
		if ((func_241() && iLocal_56 != 7) && iLocal_56 != 8)
		{
			if (iLocal_56 != 2)
			{
				if (iLocal_56 != 4)
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_209(Local_200, PLAYER::PLAYER_PED_ID(), 6f, 1))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_200, PLAYER::PLAYER_PED_ID()))
							{
								func_210(15);
							}
						}
					}
					else if (PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_200))
					{
						func_210(15);
					}
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_200, PLAYER::PLAYER_PED_ID(), 1))
					{
						if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4))
						{
							func_210(15);
...
int func_239()
{
	if (func_240())
	{
		...
		{
			if (iLocal_56 == 11 && func_209(Local_197, PLAYER::PLAYER_PED_ID(), 5f, 1))
			{
				return 0;
			}
			return 1;
...
{
	if (func_209(Local_197, PLAYER::PLAYER_PED_ID(), 2f, 1) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_197, PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_RAGDOLL(Local_197))
			{
				*uParam0 = 1;
			}
			else
...
void func_246()
{
	if (iLocal_56 != 20)
	{
		if (func_209(PLAYER::PLAYER_PED_ID(), Local_197, 15f, 1))
		{
...
void func_249()
{
	if (func_95(PLAYER::PLAYER_PED_ID(), vLocal_176, 220f))
	{
		if (!iLocal_205 && !func_95(PLAYER::PLAYER_PED_ID(), vLocal_176, 100f))
		{
			iLocal_205 = func_128(&iLocal_204, joaat("SADLER"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_95(PLAYER::PLAYER_PED_ID(), vLocal_176, 240f))
	{
		if (iLocal_205)
		{
			func_133(&iLocal_204);
...
void func_250()
{
	if (func_446(Local_197) && iLocal_56 != 15)
	{
		if (func_95(Local_197, vLocal_176, 200f))
		{
			bLocal_193 = true;
		}
		if (!func_209(Local_197, PLAYER::PLAYER_PED_ID(), 150f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_197))
		{
			fLocal_186 = (fLocal_186 + MISC::GET_FRAME_TIME());
			if (fLocal_186 > 10f)
			{
				if (ENTITY::IS_ENTITY_ON_SCREEN(Local_197))
				{
		...
		else if (!func_209(Local_197, PLAYER::PLAYER_PED_ID(), 200f, 1))
		{
			if (ENTITY::IS_ENTITY_ON_SCREEN(Local_197))
			{
				func_207(&Local_197, 0, 1, 1);
...
{
	func_252();
	func_131(&iLocal_198, &iLocal_199, &iLocal_55, &iLocal_173, &iLocal_172, vLocal_176, Local_202, 0, 1090519040);
	func_156();
	func_145();
	switch (iLocal_53)
	{
...
void func_252()
{
	if (func_6(Local_200))
	{
		if (!bLocal_177)
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_200, 0))
			{
				bLocal_177 = true;
			}
		}
		else if (!PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_200))
		{
			bLocal_177 = false;
		}
	}
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_110(iLocal_52, 0))
			{
				...
				if (func_459())
				{
					MISC::CLEAR_AREA_OF_VEHICLES(-399.8117f, -2172.942f, 9.3184f, 50f, 0, 0, 1, 1, false, 0);
...
void func_254(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_322(iVar10, iParam1, iParam2, -1) };
		if (!func_321(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_322(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_322(iVar10, 14, uVar12[iVar1], -1) };
							func_292(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_314(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_314(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_322(iVar10, iVar0, func_281(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_322(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_322(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_322(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_322(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_322(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_322(iVar10, 14, uVar15[iVar1], -1) };
			func_292(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_314(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_386(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76389[1 /*14*/] = { func_322(iParam0, iParam1, iParam2, -1) };
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_386(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_282(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_282(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_299(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_307(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_307(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_307(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_314(int iParam0)
{
	...
	{
		func_320(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_316(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_317(iParam2)];
	if (iVar0 != 0)
	{
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_317(iParam1)];
...
void func_324(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_325(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_318(func_328(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_318(func_327(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_318(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_331(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_325(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_325(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_325(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_325(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_282(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_386(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76389[1 /*14*/] = { func_322(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_386(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_386(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_322(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_386(iParam0, 14, iVar4))
										{
											if (!func_278(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_322(iVar0, iVar2, iVar1, -1) };
						if (!func_278(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_392(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_423(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_412();
			}
...
void func_393(int iParam0, int iParam1)
{
	...
	func_433(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_394(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_409(iParam0, 0, 0)) || func_409(iParam0, 1, 0)) || func_409(iParam0, 2, 0)) || func_432(iParam0) != 145) || func_408(iParam0)) || func_407(iParam0)) || func_406(iParam0)) || func_405(iParam0)) || !func_395(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_407(iParam0))
		{
		}
...
int func_423(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_180(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_426(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_423(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_431(iParam0);
			func_430(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_443()
{
	...
	if (!func_6(iLocal_198))
	{
		...
		if (func_6(Local_202))
		{
			if (!func_209(PLAYER::PLAYER_PED_ID(), Local_202, 500f, 1))
			{
				iVar0++;
			}
		}
...
void func_473()
{
	...
	func_475();
	func_474();
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_206, 0);
	func_262(0);
