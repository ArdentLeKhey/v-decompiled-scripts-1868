			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || TASK::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_11()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					TASK::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_11(), func_3(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
char* func_21()
{
	if (MISC::IS_BIT_SET(Global_111560.f_24981, 3))
	{
		return "BB4_loiter";
	}
	else if (MISC::IS_BIT_SET(Global_111560.f_24981, 2))
	{
		return "BB3_loiter";
	}
	else if (MISC::IS_BIT_SET(Global_111560.f_24981, 1))
	{
		return "BB2_loiter";
	}
	else if (MISC::IS_BIT_SET(Global_111560.f_24981, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
...
void func_50()
{
	...
	if (func_51(iLocal_42))
	{
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, joaat("prop_table_03b"), 0))
		{
			iLocal_40 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, joaat("prop_table_03b"), 1, 0, 1);
			if (func_8(iLocal_40))
			{
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, joaat("prop_laptop_01a"), 0))
		{
			iLocal_41 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, joaat("prop_laptop_01a"), 0, 0, 1);
			if (func_8(iLocal_41))
			{
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, joaat("prop_table_03_chr"), 0))
		{
			iLocal_39 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, joaat("prop_table_03_chr"), 0, 0, 1);
			if (func_8(iLocal_39))
			{
