...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		iVar4 = iVar3;
		iVar3 = Global_95791[iVar0 /*25*/][iVar1];
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
		...
		if (iVar0 == Global_95790 && iVar1 == Global_95789)
		{
			bVar2 = false;
		}
	}
	Global_95787 = Global_95786;
}
...
void func_8()
{
	...
	if (!Global_95785)
	{
		Global_95969 = CLOCK::GET_CLOCK_MONTH();
		Global_95968 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_95967 = CLOCK::GET_CLOCK_HOURS();
		Global_95785 = 1;
		Global_95790 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_95789 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
	...
	if (iVar11 > 0)
	{
		...
		if (iVar11 > 7)
		{
			...
			while (iVar8 < 7)
			{
				...
				while (iVar9 < 24)
				{
					if (!Global_95791[iVar6 /*25*/][iVar7] == 0)
					{
						Global_95786++;
						Global_95788 = (Global_95788 - 1);
					}
					Global_95791[iVar6 /*25*/][iVar7] = 0;
					iVar9++;
				}
				iVar8++;
			}
