...
void func_4()
{
	...
	if (Global_19482 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_21), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_32[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_19482 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_32[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_21), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_32[iVar1 /*6*/]), 0, 0, 0, 0);
...
void func_10()
{
	...
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_19467, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_19467, "SET_HEADER", &(Local_32[iLocal_23 /*6*/]), 0, 0, 0, 0);
...
void func_11()
{
	...
	{
		case 0:
			iLocal_27 = Global_111279;
			iLocal_28 = Global_111296;
			break;
		
		case 1:
			iLocal_27 = (Global_111280 + Global_111281);
			iLocal_28 = (Global_111297 + Global_111298);
			break;
		
		case 2:
			iLocal_27 = Global_111282;
			iLocal_28 = Global_111299;
			break;
		
		case 3:
			iLocal_27 = Global_111283;
			iLocal_28 = Global_111300;
			break;
		
		case 4:
			iLocal_27 = (Global_111284 + Global_111285);
			iLocal_28 = (Global_111301 + Global_111302);
			break;
...
void func_16()
{
	...
	{
		while (iVar0 < Global_93700)
		{
			func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Global_93491[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_21++;
...
{
	return func_19(iParam0, Global_41396);
}
...
void func_20()
{
	...
	while (iVar0 < 7)
	{
		if (Global_89451[iVar0 /*5*/] != -1)
		{
			if (Global_93700 < 52)
			{
				iVar1 = Global_76846.f_109[Global_89451[iVar0 /*5*/] /*4*/];
				MemCopy(&(Global_93491[Global_93700 /*4*/]), {func_24(iVar1)}, 4);
				Global_93700++;
			}
			else
			{
	...
	while (iVar0 < 63)
	{
		if ((MISC::IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 0) && MISC::IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 1)) && !MISC::IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 3))
		{
			if (Global_93700 < 52)
			{
				MemCopy(&(Global_93491[Global_93700 /*4*/]), {func_22(iVar0)}, 4);
				Global_93700++;
			}
			else
			{
	...
	while (iVar0 < 20)
	{
		if (MISC::IS_BIT_SET(Global_111560.f_9080.f_99.f_219[0], iVar0))
		{
			if (Global_93700 < 52)
			{
				StringCopy(&(Global_93491[Global_93700 /*4*/]), func_21(iVar0), 16);
				Global_93700++;
			}
			else
			{
...
void func_31()
{
	func_32(0, "CELL_3001", 1, Global_111296);
	func_32(1, "CELL_3008", 3, Global_111296);
	func_32(2, "CELL_3004", 7, Global_111299);
	func_32(3, "CELL_3005", 9, Global_111300);
	func_32(4, "CELL_3007", 11, Global_111301);
}
