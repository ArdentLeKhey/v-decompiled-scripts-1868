...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	if (!func_267(&iVar2, &Var0, vVar1, 5f))
	{
		func_266();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_197(&Var0, vVar1, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_197(&Var0, vVar1, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_196(Var0);
		func_188(&iLocal_55, &(Var0.f_9), vVar1);
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0))
			{
...
void func_148()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_149(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
float func_192(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_200(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_198(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_201(var uParam0, bool bParam1)
{
	...
	if ((func_238(*uParam0) || func_236(*uParam0)) || Global_76822 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_223(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar2 != -1)
		{
			func_222(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_216(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_217(iParam2, iParam5) };
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_221(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_220(vVar1, vVar0);
...
float func_220(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_228(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
{
	if ((func_237() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_241(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_242(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_207(iParam0);
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_244(iParam0);
...
void func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_246(iParam0);
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_248(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				if (func_127(uParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_127(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_127(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK::TASK_PLAY_ANIM(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_256(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, false, 1);
				VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, true, 1);
			}
			break;
	}
}
...
int func_267(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (*iParam0 == 1)
	{
		if (func_268((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_268((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_268(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_269(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_269(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
