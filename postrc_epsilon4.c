...
void func_1()
{
	...
	{
		if (((((!func_28() && !PED::IS_PED_FLEEING(iLocal_205)) && !PED::IS_PED_RAGDOLL(iLocal_205)) && !PED::IS_PED_PRONE(iLocal_205)) && !PED::IS_PED_INJURED(iLocal_205)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_205, 0))
		{
	...
	{
		if (((((!func_28() && !PED::IS_PED_FLEEING(iLocal_204)) && !PED::IS_PED_RAGDOLL(iLocal_204)) && !PED::IS_PED_PRONE(iLocal_204)) && !PED::IS_PED_INJURED(iLocal_204)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_204, 0))
		{
	...
	while (iVar1 < iVar0)
	{
		if (func_29(uVar2[iVar1]))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_32(55))
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_205, true, 0);
				}
			...
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_32(60))
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_204, true, 0);
				}
...
{
	if (((!func_16() == iParam0 || func_35()) || func_34()) || Global_76574 != -1)
	{
		if (!func_16() == 1)
		{
		}
