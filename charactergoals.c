...
void func_5(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_7() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_7() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_13(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_7() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_20(int iParam0, int iParam1)
{
	...
	if (func_30(&Global_4269915))
	{
		if (func_28(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_21(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_24(var uParam0)
{
	...
	func_26(uParam0, (Global_4269914 - 0.5f));
}
