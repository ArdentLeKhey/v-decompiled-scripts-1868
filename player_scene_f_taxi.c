...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_68, false) };
		fVar2 = SYSTEM::VDIST2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
{
	if (!PED::IS_PED_INJURED(Global_98390))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
		{
			...
			if (!func_5(Global_98390, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_98390, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
			...
			TASK::TASK_VEHICLE_TEMP_ACTION(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_98390, iLocal_70, 2))
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_70, -8f, 1);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_VEHICLE_TEMP_ACTION(0, iLocal_70, 24, 50);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_68, iVar2);
...
int func_8(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_98390) && iParam1 != 0)
		{
			Global_98390 = 0;
		}
	}
...
void func_12()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_17(14) || Global_110511))
			{
...
void func_22()
{
	...
	iLocal_70 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_98390) || !ENTITY::DOES_ENTITY_EXIST(iLocal_70)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_69) && iVar0 < 400))
	{
	...
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98390, true, 1);
	if (ENTITY::DOES_ENTITY_EXIST(Global_98390))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_98390, Global_93703);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_98390, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_70, 0))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_70, true, true, 0);
		...
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_68, 0);
...
void func_23()
{
	...
	func_42(iLocal_66, &vLocal_173, &uLocal_174, &cVar0);
	iLocal_69 = joaat("a_m_m_eastsa_02");
	func_29(1, iLocal_66, &iLocal_71, &vLocal_169, &uVar1, &vLocal_170, &fLocal_171);
	Var2.f_1 = -1;
	Var2.f_17 = 4;
	Var2.f_17.f_8 = 4;
	Var2.f_17.f_13 = 4;
...
int func_26(struct<109> Param0, var uParam1)
{
	uParam1->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_27(uParam1, 144, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_27(uParam1, 30, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 77:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, -0.7035f, -0.0282f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 78:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, -3.03f, -0.72f, 0.08f, 168f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, -2017877118, -2017877118, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_28(uParam1);
			}
		...
		case 94:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 94)
			{
				func_27(uParam1, 17, 1785177548, 1785177548, -1.71f, 1.05f, 0f, -138f);
			}
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 150:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 20, 1785177548, 1785177548, 0.98f, 0.8017f, -0.42f, -180f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 98:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_27(uParam1, 15, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_27(uParam1, 14, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 122:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, -2.04f, -0.15f, 0f, 14.4f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 152:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, 1.1779f, 2.4276f, 0f, 162.1022f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 156:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 14, 1785177548, 1785177548, 0.3427f, 1.1592f, 1.0351f, 139.912f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 14, -982327190, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 169:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 14, 1785177548, 1785177548, -0.3577f, -0.8968f, -0.0003f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 171:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 14, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 172:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 15, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 192:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, 1f, 1f, 0f, 0f);
			uParam1->f_118 = 1;
			if (Global_3)
			{
				uParam1->f_118 = 1;
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, -982327190, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_118 = 1;
			if (Global_3)
			{
				uParam1->f_118 = 1;
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 205:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, 3.4381f, -0.8269f, 0f, -87.6612f);
			if (Param0.f_2 != 205)
			{
		...
		case 221:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, -0.7949f, -0.508f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 218:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 19, 1785177548, 1785177548, 1.29f, 1.41f, 0f, 57.52f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 220:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 19, 1785177548, 1785177548, 0.5504f, -0.2322f, 0f, -9.9741f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 225:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 19, 1785177548, 1785177548, 1.23f, 0.6f, -1f, 34.56f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 236:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, 1.5033f, 1.2118f, 0f, -78.0449f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_27(uParam1, 144, -982327190, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
				func_27(uParam1, 144, 2106541073, 2106541073, -5.7915f, -11.0439f, 0.67f, -72.589f);
			}
			return 1;
			break;
		...
		case 262:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, -2017877118, -2017877118, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 295:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 32, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 299:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 32, 1785177548, 1785177548, 0.24f, 0.33f, -0.5f, -11.88f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 296:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 32, 1785177548, 1785177548, 1.41f, 1.35f, 0f, 168f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 297:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 32, 1785177548, 1785177548, 1.7491f, 0.6423f, 0f, 166.479f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 298:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 32, 1785177548, 1785177548, 0.72f, -0.69f, 0f, 172.44f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_27(uParam1, 144, 474215631, -1519143300, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam5)
{
...
int func_31(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_32(Global_98073[iParam0 /*98*/], 0))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[0];
			StringCopy(sParam2, func_49(Global_111560.f_2358.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[1];
			StringCopy(sParam2, func_49(Global_111560.f_2358.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[2];
			StringCopy(sParam2, func_49(Global_111560.f_2358.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_50()
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_68, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_68, 1))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_68);
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_70, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_70, 1))
	{
