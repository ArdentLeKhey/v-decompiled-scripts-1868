...
void __EntryFunction__()
{
	...
	if ((!Global_1 && !MISC::IS_PC_VERSION()) && MISC::_0x6FDDF453C0C756EC())
	{
		...
		iLocal_20 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MP_BIG_MESSAGE_FREEMODE");
		iLocal_21 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("INSTRUCTIONAL_BUTTONS");
	...
	Global_76846.f_1 = 0;
	MISC::SET_BIT(&(Global_111560.f_10011.f_25), 0);
	func_6();
}
