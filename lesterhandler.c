	...
	while (!MISC::IS_BIT_SET(iLocal_216, 1))
	{
		if (!MISC::IS_BIT_SET(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_46, 0);
					PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_46, 0);
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_46, 0, 0);
					PED::SET_PED_CAN_RAGDOLL(iLocal_46, 0);
					...
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar1, 8f, -8f, -1, 262152, 0, 2, 0);
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar1, 8f, -8f, -1, 262153, 0, 2, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_49);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_46, iLocal_49);
					PED::_0x2208438012482A1A(iLocal_46, 0, 0);
					...
					ENTITY::SET_ENTITY_COORDS(iLocal_47, 706.9874f, -967.0945f, 30.4f, 1, false, 0, 1);
					ENTITY::SET_ENTITY_ROTATION(iLocal_47, 90f, 0f, 160f, 2, 1);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_46, 0))
			{
				...
				if (Global_76841 == 86)
				{
					if (!Global_111555 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, 0, true, 0))
					{
						func_3(7, 1);
						Global_111551 = 0;
						Global_111555 = 1;
...
int func_2()
{
	iLocal_219 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("JHPB_02_Laptop");
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_24(iVar0) && (!func_16(14) || Global_110511))
			{
