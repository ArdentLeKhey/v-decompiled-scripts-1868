...
void func_5()
{
	...
	{
		if (func_9(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_8(PLAYER::PLAYER_PED_ID());
			if (func_7(iVar0) && (!func_6(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_7(Global_111560.f_2358.f_539.f_4321))
				{
...
int func_19(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_111560.f_10044.f_108, func_25(func_26(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_28(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_43((uParam1[iVar0 /*11*/])->f_1))
			{
	...
	{
		if ((SYSTEM::VDIST2(vParam2, OBJECT::GET_PICKUP_COORDS((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_6(13)) || func_6(14))
		{
...
void func_52()
{
	...
	iLocal_50 = 0;
	Global_111560.f_10044.f_125.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
void func_55()
{
	...
	Global_111560.f_10044.f_125.f_2 = 0;
	iVar0 = 0;
