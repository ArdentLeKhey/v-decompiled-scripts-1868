...
void __EntryFunction__()
{
	...
	if (func_75(PLAYER::PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((MISC::GET_MISSION_FLAG() == 0 && func_70() == 0) && func_69(PLAYER::PLAYER_PED_ID(), vLocal_64, fLocal_65));
			func_67();
		}
	}
	func_66(65, 0);
	...
	while (true)
	{
		...
		vLocal_244 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()) };
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				fVar1 = MISC::ACOS(func_56(vLocal_244, 0.73f, 0.683f, -0.013f));
...
void func_16(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111560.f_7256[iParam0], 1, 1);
			}
...
int func_57(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, vParam1, vParam2, fParam3, 0, true, 0))
	{
		return 1;
	}
	...
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var2.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var2.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var2, Var2.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var1.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var1.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var2, Var1.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
...
void func_63(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				fVar1 = MISC::ACOS(func_56(vLocal_244, -0.37f, -0.927f, -0.053f));
...
{
	func_66(65, 0);
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 0, false, 1);
	func_6(135, iParam0);
	func_6(136, iParam0);
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 0, false, 1);
	func_6(137, iParam0);
...
void func_67()
{
	...
	if (!func_69(PLAYER::PLAYER_PED_ID(), vLocal_64, (fLocal_65 + 30f)))
	{
		func_77();
	}
	SYSTEM::WAIT(0);
...
void func_71()
{
	...
	{
		if (func_73(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_72(PLAYER::PLAYER_PED_ID());
			if (func_13(iVar0) && (!func_11(14) || Global_110511))
			{
