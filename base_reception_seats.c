...
bool func_5(var uParam0)
{
	...
	func_7(uParam0, uParam0->f_85.f_2, &sVar1);
...
void func_11(var uParam0)
{
	...
	Var2 = { *(uParam0[uParam0->f_85.f_2 /*14*/]) };
	switch (uParam0->f_85.f_4)
	{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar7))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_85.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_85), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_57(&(uParam0->f_85), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
...
void func_74()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_77(2, &uLocal_162, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_77(3, &uLocal_162, &iVar0);
	iVar0[0] = 4;
	iVar0[1] = 5;
	func_77(4, &uLocal_162, &iVar0);
	func_75(&uLocal_162, 6662);
}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	func_84(iParam0, &vVar0, &fVar1);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		(*uParam1)[(*iParam2)[iVar2] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_80(func_81(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_80(func_79(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_80(func_78(iVar2), fVar1) + vVar0 };
