...
void __EntryFunction__()
{
	...
	bLocal_91 = true;
	bLocal_93 = true;
	vLocal_65 = { ScriptParam_100.f_1[0 /*3*/] };
	vLocal_65 = { vLocal_65 };
	uLocal_63 = uLocal_63;
	cLocal_53 = { cLocal_53 };
	bVar0 = false;
	...
	iLocal_62 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
	iLocal_68 = 0;
	func_186(&Global_110211, 0);
	func_181();
	if (func_180(uLocal_67, 1))
	{
		iLocal_73 = 10;
	}
	else
	...
	if (!func_180(uLocal_67, 8))
	{
		if (!func_178(iLocal_73))
		{
			if (func_177(0, iLocal_72))
			{
				func_188(0);
			}
			else
	...
	if (func_180(uLocal_67, 8388608))
	{
		func_188(1);
	}
	if (func_180(uLocal_67, 524288) && (func_176() && !func_175()))
	{
		func_188(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_180(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
			func_174(iLocal_78, 1, 0);
			iLocal_78 = 263;
		}
		func_173(10);
	}
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_62) && !ENTITY::IS_ENTITY_DEAD(iLocal_62, 0))
		{
			vLocal_64 = { ENTITY::GET_ENTITY_COORDS(iLocal_62, true) };
			fLocal_66 = SYSTEM::VDIST2(vLocal_64, ScriptParam_100.f_1[0 /*3*/]);
			fLocal_66 = fLocal_66;
			vLocal_84 = { vLocal_64 };
			vLocal_85 = { ScriptParam_100.f_1[0 /*3*/] };
			vLocal_84.z = 0f;
			vLocal_85.z = 0f;
			fLocal_83 = SYSTEM::VDIST2(vLocal_84, vLocal_85);
			switch (iLocal_68)
			{
				case 0:
					if (func_178(iLocal_73) || (func_180(uLocal_67, 16) && !func_180(uLocal_67, 524288)))
					{
						iLocal_71 = -1;
						func_172();
						func_173(1);
					...
					{
						if (fLocal_83 > (fLocal_75 * fLocal_75))
						{
							if (iLocal_78 != 263)
							{
								func_174(iLocal_78, 1, 0);
						...
						if ((vLocal_64.z - ScriptParam_100.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (!func_178(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98669.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					if (!func_180(uLocal_67, 4))
					{
						func_169();
						func_168(&uLocal_67, 4);
					}
					if (fLocal_83 > (fLocal_75 * fLocal_75) && !Global_98703)
					{
						if (iLocal_78 != 263)
						{
							if (func_167(6) && !func_166(iLocal_78))
							{
							}
							else
							{
					...
					{
						cLocal_53 = { Local_52 };
						bVar2 = !func_180(uLocal_67, 64);
						func_186(&uLocal_67, 128);
						if (!func_165(3) && !Global_98703)
						{
							if (func_180(uLocal_67, 2097152))
							{
								if ((!func_180(uLocal_67, 1) || !ENTITY::DOES_ENTITY_EXIST(func_164())) && !Global_98703)
								{
									func_173(10);
									break;
								}
						...
						if ((!func_153(6) || Global_110607) || func_152())
						{
							bVar2 = false;
						}
						if (!bLocal_91)
						{
							func_150(&uLocal_67, 128);
							bVar2 = false;
						}
						if (func_180(uLocal_67, 1))
						{
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_86, vLocal_87, fLocal_88, 1, false, iLocal_76) || (fLocal_90 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_139(vLocal_86, vLocal_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (MISC::ABSF((vLocal_64.z - vLocal_86.z)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_138(uLocal_63))
								{
									if (iLocal_69 == -1)
									{
										func_137(&iLocal_69, 4, sLocal_74, 0, 0, 0, 0);
										func_150(&uLocal_67, 2048);
									}
									else if (!func_180(uLocal_67, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_136(&iLocal_69);
										func_186(&uLocal_67, 2048);
									}
									if (func_134(iLocal_69, 1))
									{
										sLocal_74 = sLocal_74;
										func_136(&iLocal_69);
										func_186(&uLocal_67, 2048);
										SCRIPT::REQUEST_SCRIPT(&cLocal_53);
				...
				case 5:
					PAD::SET_INPUT_EXCLUSIVE(0, 51);
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_53))
					{
						if (iLocal_69 != -1)
						{
							func_136(&iLocal_69);
						...
						if (iVar3 != 1)
						{
							iVar3 = func_35(&iLocal_71, 6, iLocal_73, 0, 0);
						}
						if (iVar3 == 1)
						{
							...
							iLocal_51 = SYSTEM::START_NEW_SCRIPT(&cLocal_53, iLocal_70);
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_53);
							Local_52 = { cLocal_53 };
							StringCopy(&cLocal_53, "", 64);
							func_150(&uLocal_67, 2);
							func_173(6);
							func_21(&iLocal_80);
							if (iLocal_72 != -1)
							{
								func_20(iLocal_72);
								func_17(func_19(iLocal_72), 0, 0);
							}
						}
						else if (iVar3 == 2)
						{
				...
				case 6:
					if (func_180(Global_110211, 262144))
					{
						func_186(&Global_110211, 262144);
						func_15();
					}
					if (func_180(uLocal_67, 2097152))
					{
						if (!func_165(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
						{
							func_173(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_11(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&iLocal_80);
						func_186(&uLocal_67, 256);
						func_9();
						if (bVar0)
						{
							func_186(&uLocal_67, 2);
						}
						else if (func_180(uLocal_67, 2))
						{
							if (func_180(Global_110211, 0))
							{
								func_8(&iLocal_71);
								iLocal_71 = -1;
								func_186(&uLocal_67, 2);
						...
						if (iLocal_72 != -1)
						{
							if (func_180(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_72), 0, Global_98706, 0);
								func_7(func_19(iLocal_72), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_72), 0, Global_98706, 0);
								func_7(func_19(iLocal_72), 0, Global_98706, 0, 0);
							}
						}
						func_6();
						func_186(&Global_110211, 0);
						if (func_180(uLocal_67, 16777216))
						{
							func_188(1);
						}
						if (iLocal_72 != -1)
				...
				case 7:
					...
					if (iLocal_78 != 263)
					{
						func_174(iLocal_78, 0, 0);
					}
					if (iLocal_69 != -1)
					{
						func_136(&iLocal_69);
					}
					if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_74))
					{
						if (func_1(sLocal_74))
						{
							HUD::CLEAR_HELP(1);
					...
					if ((iLocal_77 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_79 == 2)
							{
								if (iLocal_79 == 2)
								{
									if (func_178(iLocal_73) && func_177(0, iLocal_72))
									{
										func_181();
										if (iLocal_78 != 263)
										{
...
void func_44(int iParam0, int iParam1, var uParam2)
{
	...
	uVar6 = { func_47(iParam1, (*uParam2)[13]) };
	iVar2 = 0;
	while (iVar2 <= 8)
	{
		iVar3 = iVar2;
		...
		{
			Var1 = { func_54(iParam1, 14, uVar6[iVar2], -1) };
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_49(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_51(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_50(iParam0, func_51(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
...
void func_56(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_67(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_57(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_60(func_63(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_60(func_59(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_60(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_60(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_61(iParam1)];
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_51(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_125(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_125(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_125(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_122(vVar2.z)] = vVar2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_122(vVar2.z)] = func_49(iParam1, vVar2.x, func_122(vVar2.z), iVar0);
					}
				}
				else if (vVar2.y != -1)
				{
					(*uParam0)[func_122(vVar2.z)] = vVar2.y;
				}
			}
			iVar4++;
		}
...
Vector3 func_139(vector3 vParam0, vector3 vParam1, float fParam2)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_156()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_160()) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_160() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_142(8, -1)) || func_144()) || func_155()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_30738) || func_159()) || func_142(8, -1)) || func_157()) || func_156()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_160()) || func_157()) || Global_110607) || Global_30738) || func_159()) || Global_42561) || func_142(8, -1)) || func_156()) || func_155()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_155()) || func_158()) || func_157()) || func_144())
						{
							return 0;
						}
						break;
...
void func_162()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_131(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_130(PLAYER::PLAYER_PED_ID());
			if (func_133(iVar0) && (!func_167(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_133(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_169()
{
	...
	if (bLocal_93 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar2[0] = MISC::GET_RANDOM_INT_IN_RANGE(2, 8);
			iVar3 = 1;
			while (iVar3 < iVar1 && iVar3 < 3)
			{
				iVar2[iVar3] = func_170(&iVar2, 3, 2, 7);
				iVar3++;
			}
			iVar3 = 0;
			while (iVar3 < iVar1 && iVar3 < 3)
...
{
	return func_179(iParam0, Global_41396);
}
...
void func_181()
{
	...
	iLocal_72 = 13;
	StringCopy(&Local_52, "tennis", 64);
	iLocal_70 = 29500;
	func_168(&uLocal_67, 1);
	sLocal_74 = "PLAY_TENNIS";
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		iLocal_92 = func_147(vLocal_65);
	}
	iLocal_78 = func_184(vLocal_65);
	bLocal_93 = true;
	iVar0 = func_130(PLAYER::PLAYER_PED_ID());
	if (iVar0 == 1)
	{
		func_168(&uLocal_67, 8388608);
		return;
	}
	...
	switch (iLocal_92)
	{
		case 2:
			...
			bLocal_93 = true;
			vLocal_86 = { -765.014f, 154.244f, 67.25f };
			vLocal_87 = { -782.014f, 154.244f, 67.25f };
			fLocal_88 = 28f;
			fLocal_89 = 2f;
			break;
		...
		case 1:
			...
			vLocal_86 = { -1164.958f, -1667.262f, 4.28f };
			vLocal_87 = { -1200.919f, -1615.872f, 4.28f };
			fLocal_88 = 65.5f;
			fLocal_89 = 5f;
			break;
		...
		case 3:
			...
			vLocal_86 = { 491.2348f, -206.7215f, 52.78849f };
			vLocal_87 = { 469.6835f, -266.507f, 53.78639f };
			fLocal_88 = 14f;
			fLocal_89 = 5f;
			break;
		...
		case 4:
			...
			vLocal_86 = { -1218.939f, 321.685f, 79.02952f };
			vLocal_87 = { -1228.746f, 355.2947f, 79.98589f };
			fLocal_88 = 20f;
			fLocal_89 = 2f;
			break;
		...
		case 5:
			...
			vLocal_86 = { -1250.003f, 367.6283f, 79.94628f };
			vLocal_87 = { -1216.369f, 377.5503f, 80.10213f };
			fLocal_88 = 20f;
			fLocal_89 = 2f;
			break;
		...
		case 6:
			...
			vLocal_86 = { -1610.862f, 249.7006f, 60.1168f };
			vLocal_87 = { -1626.516f, 282.9467f, 59.83001f };
			fLocal_88 = 32f;
			fLocal_89 = 5f;
			break;
		...
		case 7:
			...
			vLocal_86 = { -942.1958f, -1251.207f, 7.1391f };
			vLocal_87 = { -930.3892f, -1271.587f, 8.0366f };
			fLocal_88 = 12f;
			fLocal_89 = 5f;
			break;
		...
		case 8:
			...
			vLocal_86 = { -1373.602f, -83.734f, 50f };
			vLocal_87 = { -1369.198f, -120.774f, 50f };
			fLocal_88 = 20.84f;
			fLocal_89 = 5f;
			fLocal_90 = 19.6f;
			break;
		...
		case 9:
			...
			vLocal_86 = { -2860.762f, 13.3794f, 10.6083f };
			vLocal_87 = { -2924.066f, 31.5452f, 10.6083f };
			fLocal_88 = 28f;
			fLocal_89 = 5f;
			break;
	}
...
int func_183(int iParam0)
{
	if (func_133(iParam0))
	{
		if ((Global_111560.f_9080 || Global_3) || func_18(0))
		{
...
void func_189()
{
	func_186(&uLocal_67, 4);
	func_190();
	if (SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
	{
		PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(iLocal_51, 3);
	}
	if (!MISC::IS_STRING_NULL(&cLocal_53))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(&cLocal_53) != 0)
		{
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_53);
		}
	}
