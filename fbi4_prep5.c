...
void __EntryFunction__()
{
	...
	sLocal_190 = "FBIPRE";
	vLocal_199 = { 0f, 0f, 0f };
	vLocal_200 = { 20.8336f, -1113.793f, 28.797f };
	sLocal_202 = "FBIPRAU";
	iLocal_373 = -1;
	...
	if (func_280())
	{
		func_279(16.5342f, -1122.583f, 27.8635f, 354.7487f, 1, 0);
	}
	func_274();
	if (func_273(0))
	{
	...
	Global_111560.f_2358.f_539.f_2403[0] = -99;
	Global_111560.f_2358.f_539.f_2403[1] = -99;
	Global_111560.f_2358.f_539.f_2403[2] = -99;
	while (true)
	{
...
void func_4(int iParam0)
{
	...
	if (Global_111560.f_9080 || func_273(0))
	{
		iVar0 = func_18();
		if (!func_5(iVar0))
		{
...
void func_23()
{
	switch (iLocal_82)
	{
		...
		case 2:
			...
			{
				func_22(&iLocal_197);
				if (func_45(&uLocal_83, &cLocal_368, &uLocal_203))
				{
					func_40();
				}
			}
...
void func_38(int iParam0, vector3 vParam1, float fParam2)
{
	...
	func_39(iParam0, vParam1, fParam2, 0, 1);
}

int func_39(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_41(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_273(0) && Global_76823.f_1 == 1) && func_42(Global_76823))
		{
		}
		else
		{
...
int func_59(int iParam0)
{
	...
	return Global_96177[func_60(iParam0)];
}
...
bool func_85(char* sParam0, int iParam1, int iParam2)
{
...
int func_95(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_96(1, vLocal_199, 0))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (bParam1)
			{
				func_38(PLAYER::PLAYER_PED_ID(), vLocal_200, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_96(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
			if (func_97(vParam1, vLocal_199, 1056964608, 0) && fParam2 == 0f)
			{
				return 1;
			}
			break;
...
int func_97(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_100()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			func_106();
			if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_200, 2f) && func_104(28))
			{
				if (!iLocal_196)
				{
					PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(PLAYER::PLAYER_PED_ID(), vLocal_200, 75f))
					{
						if (!iLocal_195)
						{
							func_22(&iLocal_197);
						...
						func_108(&iLocal_197, vLocal_200, 1, 1, "PRE_SHOP");
					}
					else if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_200, 12f))
					{
						if (iLocal_195)
						{
							func_22(&iLocal_197);
		...
		case 2:
			...
			while (iVar0 < 3)
			{
				...
				{
					case 0:
						switch (Global_111560.f_2358.f_539.f_2403[0])
						{
							case 20:
								if (Global_111560.f_2358.f_539.f_2403[1] == 13 || Global_111560.f_2358.f_539.f_2403[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 21:
								if (Global_111560.f_2358.f_539.f_2403[1] == 14 || Global_111560.f_2358.f_539.f_2403[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 22:
								if (Global_111560.f_2358.f_539.f_2403[1] == 15 || Global_111560.f_2358.f_539.f_2403[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 1:
						switch (Global_111560.f_2358.f_539.f_2403[1])
						{
							case 13:
								if (Global_111560.f_2358.f_539.f_2403[0] == 20 || Global_111560.f_2358.f_539.f_2403[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 14:
								if (Global_111560.f_2358.f_539.f_2403[0] == 21 || Global_111560.f_2358.f_539.f_2403[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 15:
								if (Global_111560.f_2358.f_539.f_2403[0] == 22 || Global_111560.f_2358.f_539.f_2403[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 2:
						switch (Global_111560.f_2358.f_539.f_2403[2])
						{
							case 17:
								if (Global_111560.f_2358.f_539.f_2403[0] == 20 || Global_111560.f_2358.f_539.f_2403[1] == 13)
								{
									bVar1 = false;
								}
								break;
							...
							case 18:
								if (Global_111560.f_2358.f_539.f_2403[0] == 21 || Global_111560.f_2358.f_539.f_2403[1] == 14)
								{
									bVar1 = false;
								}
								break;
							...
							case 19:
								if (Global_111560.f_2358.f_539.f_2403[0] == 22 || Global_111560.f_2358.f_539.f_2403[1] == 15)
								{
									bVar1 = false;
								}
								break;
		...
		case 3:
			Global_111560.f_2358.f_539.f_2403[0] = 20;
			Global_111560.f_2358.f_539.f_2403[1] = 13;
			Global_111560.f_2358.f_539.f_2403[2] = 17;
			func_24(1, 1, 1);
			iLocal_82 = 1;
			break;
	}
...
bool func_105(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_108(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_109(vParam1, 5, bParam2);
		if (bParam3)
		{
...
int func_109(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
		...
		case 0:
			if (func_95(iLocal_81, 0))
			{
				if (func_280())
				{
					...
					func_116(&iVar3, vVar1, fVar2, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_113(0, -1, 1);
...
void func_116(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_280() || !func_219())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_216(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_195(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_194(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105109.f_2890 };
			fParam2 = Global_105109.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, 1, 0, 0, false);
		func_185(vParam1, 5f, 0);
		if (func_14(iParam10))
		{
			func_183(iParam10, 0);
			while (!func_117(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_117(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_177(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_177(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_177(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_122(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_121(*iParam1);
				...
				func_119(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_119(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_119(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_120(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
int func_123(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_150(iVar0, bParam1, uParam2) && !func_149(PLAYER::PLAYER_ID())) && !func_133(iParam0))
	{
		return 0;
	}
...
{
	if (func_148(PLAYER::PLAYER_ID()) || func_147(PLAYER::PLAYER_ID()))
	{
		if (func_134(iParam0))
		{
			return 1;
...
int func_147(int iParam0)
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_68())
			{
...
void func_152(int iParam0, int iParam1)
{
	...
	func_153(iParam0, &(Global_111560.f_32744.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_154(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_172(iParam0, 0, 0)) || func_172(iParam0, 1, 0)) || func_172(iParam0, 2, 0)) || func_171(iParam0) != 145) || func_170(iParam0)) || func_169(iParam0)) || func_124(iParam0)) || func_168(iParam0)) || !func_158(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_169(iParam0))
		{
		}
		...
		if (func_172(iParam0, 0, 0))
		{
		}
		if (func_172(iParam0, 1, 0))
		{
		}
		if (func_172(iParam0, 2, 0))
		{
		}
		if (func_171(iParam0) != 145)
		{
		}
		return 0;
	}
...
int func_172(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_173(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_173(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
int func_177(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_146(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_180(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_183(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_184(iParam0, iParam1))
				{
...
void func_185(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_193(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_186(int iParam0)
{
	...
	if (func_193(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_192(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_190(0, Global_75396.f_555[0 /*21*/].f_12) || !func_190(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_189(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_190(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_191(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_159(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_193(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_194(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_194(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_194(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_195(vector3 vParam0, float fParam1)
{
	return func_196(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_196(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_212(uParam0))
	{
		...
		if (func_211(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_200(iVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_183(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_183(uParam0->f_11, 2);
						}
					}
				...
				else if ((!func_198(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_197(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_198(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_199(iParam0, Global_75396.f_139[38], 0))
			{
				func_186(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_199(iParam0, Global_75396.f_139[43], 1))
			{
				func_186(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_199(iParam0, uVar1[iVar3], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_194(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_200(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_154(iVar1 + 1));
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar2 + 1)))
				{
...
int func_204(int iParam0)
{
	...
	{
		if (!func_210(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_206(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
int func_212(var uParam0)
{
	...
	if (!func_159(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
...
bool func_213()
{
	return func_211(&(Global_105109.f_2890));
}

void func_214()
{
	func_215(&(Global_105109.f_2890));
}
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_218(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_219()
{
	return func_212(&(Global_105109.f_2890));
}

bool func_220(vector3 vParam0, int iParam1)
{
	return func_221(Global_105109.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_221(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_223()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(PLAYER::PLAYER_PED_ID(), vLocal_200, 150f))
				{
					func_230(2);
				}
				else if (!func_105(PLAYER::PLAYER_PED_ID(), vLocal_200, 75f))
				{
					if (!bLocal_201)
					{
						HUD::CLEAR_PRINTS();
						func_224("PRE_RETSHOP", &bLocal_201);
					}
				}
			}
		}
...
int func_225()
{
	...
	if (!func_226(bLocal_193, iVar0) && !bLocal_193)
	{
		return 0;
	}
	return 1;
...
int func_227(int iParam0, int iParam1)
{
	...
	iVar0 = (func_228(iParam0) - iParam1);
	return iVar0;
}
...
void func_232()
{
	if (func_234())
	{
		...
		{
			case 0:
				if (Global_111560.f_2358.f_539.f_2403[0] == -99)
				{
					func_233(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2403[1] == -99)
				{
					func_233(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2403[2] == -99)
				{
					func_233(sLocal_80[2], sLocal_80[1], sLocal_80[0]);
				}
				break;
			
			case 1:
				if (Global_111560.f_2358.f_539.f_2403[1] == -99)
				{
					func_233(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2403[0] == -99)
				{
					func_233(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2403[2] == -99)
			...
			case 2:
				if (Global_111560.f_2358.f_539.f_2403[2] == -99)
				{
					func_233(sLocal_80[2], sLocal_80[1], sLocal_80[0]);
				}
				else if (Global_111560.f_2358.f_539.f_2403[0] == -99)
...
void func_233(char* sParam0, char* sParam1, char* sParam2)
{
...
int func_235()
{
	...
	while (iVar1 <= 2)
	{
		if (Global_111560.f_2358.f_539.f_2403[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_237()
{
	...
	if (func_228(iVar0) < 315)
	{
		func_238(func_11(), 96, 315, 0, 0);
	}
}
...
void func_238(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_239(func_270(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_242(int iParam0)
{
	...
	if (iParam0 == 12)
	{
		func_245(8269, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 13)
	{
		func_245(8270, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 14)
	{
		func_245(8271, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 15)
	{
		func_245(8272, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 16)
	{
		func_245(8273, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 17)
	{
		func_245(8274, 0, -1, 1, 0);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_244() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_244() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_246(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_248(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_244() /*10828*/].f_6168.f_10, iParam0);
}
...
{
	if (func_13(14) && !func_265(iParam0))
	{
		return 0;
	}
	...
	if (func_264(&Global_4269915))
	{
		if (func_262(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_255(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
int func_255(var uParam0, int iParam1)
{
	...
	if (func_13(14) && !func_265(iParam1))
	{
		return 0;
	}
...
void func_258(var uParam0)
{
	...
	func_260(uParam0, (Global_4269914 - 0.5f));
}
...
void func_271(int iParam0)
{
	...
	{
		func_272(iParam0, 10, 1);
		func_272(iParam0, 19, 1);
	}
}
...
void func_272(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			...
			func_245(func_91(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_275(int iParam0, bool bParam1, int iParam2)
{
	if (bParam1)
	{
		if (!func_88(iParam0, 0, 0))
		{
			...
			{
				if (func_278(iParam0) == 3 && !func_87(iParam0))
				{
					func_271(iParam0);
					func_272(iParam0, 0, 0);
					func_277(iParam0, 1, 0);
					func_276(iParam0);
				}
				else
				{
...
void func_279(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_280())
	{
...
{
	func_282(joaat("player_zero"), 12, 20, bParam0);
	func_282(joaat("player_zero"), 12, 21, bParam0);
	func_282(joaat("player_zero"), 12, 22, bParam0);
	func_282(joaat("player_one"), 12, 13, bParam0);
	func_282(joaat("player_one"), 12, 14, bParam0);
	func_282(joaat("player_one"), 12, 15, bParam0);
	func_282(joaat("player_two"), 12, 17, bParam0);
	func_282(joaat("player_two"), 12, 18, bParam0);
	func_282(joaat("player_two"), 12, 19, bParam0);
}

int func_282(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_76389[1 /*14*/] = { func_284(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_283(iParam1, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 0, Global_76389[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_283(iParam1, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 0, Global_76389[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_283(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_284(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_349();
...
void func_286(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_294(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_287(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_287(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_291(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_291(Global_2621444, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_283(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_283(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_283(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_290(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_89(func_289(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_288(iParam1, uParam0->f_2, &iVar1))
			{
...
int func_291(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_292(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_292(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_295(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_352(var uParam0, int iParam1)
{
	...
	{
		func_356(&uLocal_84, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_355(&uLocal_84);
	func_353(&uLocal_136, &uLocal_84, 50f);
}
...
void func_353(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_354(uParam1, *(uParam1[iVar1 /*3*/]) + vVar5))
		{
			vVar5 = { -vVar5 };
		}
...
bool func_354(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_356(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_369(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
