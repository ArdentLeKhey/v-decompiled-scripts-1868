...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_111560.f_10044.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_15(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_51874[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_16(Global_51874[iVar0 /*203*/].f_4[iVar1], Global_51874[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_16(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_27(Global_42574[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_27(Global_42574[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_22()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_23(iVar0) && (!func_46(14) || Global_110511))
			{
...
void func_35(vector3 vParam0)
{
	...
	{
		TASK::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), vParam0, 100, 2048, 1);
	}
}
...
int func_44(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	StringCopy(&(Global_111560.f_14136[iVar0 /*104*/]), sParam2, 64);
	Global_111560.f_14136[iVar0 /*104*/].f_17 = iParam1;
	if (iParam3 == 0)
	{
		return 0;
	}
	...
	{
		Global_111560.f_14136[iVar0 /*104*/].f_24 = iParam3;
	}
	Global_111560.f_14136[iVar0 /*104*/].f_25 = iParam4;
	Global_111560.f_14136[iVar0 /*104*/].f_26 = iParam5;
	Global_111560.f_14136[iVar0 /*104*/].f_29 = iParam6;
	Global_111560.f_14136[iVar0 /*104*/].f_30 = iParam8;
	Global_111560.f_14136[iVar0 /*104*/].f_31 = iParam7;
...
void func_48()
{
	...
	iVar0 = 0;
	if (Global_111560.f_18569.f_388)
	{
