	...
	while (true)
	{
		...
		if (Global_19486.f_1 != 9)
		{
			...
			else if (Global_19468)
			{
				...
				{
					iLocal_53 = 1;
					func_63(Global_19467, iLocal_51);
				...
				else
				{
					...
					if (iLocal_54)
					{
						...
						if (iLocal_56 == -1)
						{
							...
							iVar0 = func_63(Global_19467, iLocal_51);
							func_62(Global_19467, "SET_HEADER", "EM_INBOX", 0, 0, 0, 0);
							iLocal_55 = 0;
							if (iVar0 > 0)
							{
							...
							func_73(1);
							func_72(0);
							func_61(Global_19467, "DISPLAY_VIEW", 8f, fLocal_66, -1082130432, -1082130432, -1082130432);
						}
						else
						{
							...
							if (iLocal_57 == -1)
							{
								func_58(iLocal_51, iLocal_56);
								func_53(Global_19467, iLocal_51, iLocal_56);
								Global_21865 = 0;
								iLocal_64 = func_51(iLocal_51, iLocal_56);
								if (iLocal_64)
								{
									sLocal_65 = func_48(iLocal_51, iLocal_56);
									if (!func_47(37))
									{
							...
							else
							{
								...
								func_37(Global_19467, iLocal_51, iLocal_56);
								func_61(Global_19467, "DISPLAY_VIEW", 9f, -1082130432, -1082130432, -1082130432, -1082130432);
							}
						}
						iLocal_54 = 0;
...
void func_10(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_14()
{
	...
	if (!iLocal_59)
	{
		if (PAD::IS_CONTROL_PRESSED(2, 176) && SYSTEM::TIMERB() > 100)
		{
			...
			{
				if (func_31(iLocal_51, iLocal_56) && !iLocal_55)
				{
					iLocal_57 = 0;
					iLocal_54 = 1;
					SYSTEM::SETTIMERB(0);
			...
			{
				iLocal_57 = 0;
				func_19(iLocal_51, iLocal_56, iLocal_57);
				iLocal_55 = 1;
				iLocal_57 = -1;
				iLocal_54 = 1;
				func_34();
	...
	if (PAD::IS_CONTROL_PRESSED(2, 179))
	{
		if (iLocal_64)
		{
			...
			StringCopy(&Global_73768, sLocal_65, 64);
			func_15(7, 0, 0);
			iLocal_64 = 0;
			func_34();
		}
...
void func_24(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_29(Global_42574[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_29(Global_42574[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_25(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
void func_37(int iParam0, int iParam1, int iParam2)
{
	...
	if (!Global_51512[iVar0 /*120*/].f_86[iVar2])
	{
		...
		while (iVar6 < iVar7)
		{
			...
			Var10 = { func_29(Global_42574[iVar8 /*12*/].f_1) };
...
int func_50(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)
{
	int iVar0;
	int iVar1;
...
void func_53(int iParam0, int iParam1, int iParam2)
{
	...
	if (!bVar5)
	{
		...
		Var8 = { func_29(Global_42574[iVar6 /*12*/].f_1) };
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
		...
		if (Global_45899[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				iVar6 = Global_45899[iVar2 /*46*/].f_32[iVar10];
				Var7 = { func_29(Global_42574[iVar6 /*12*/]) };
				Var8 = { func_29(Global_42574[iVar6 /*12*/].f_1) };
				iVar12 = func_55(iParam1, Global_42574[iVar6 /*12*/].f_3);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar11 + 1);
				func_8(func_56(iVar12));
				func_8(func_56(Global_42574[iVar6 /*12*/].f_2));
				func_8(&Var7);
				func_8(&Var8);
				func_8(func_39(Global_42574[iVar6 /*12*/].f_2));
	...
	else
	{
		...
		while (iVar14 < 7)
		{
			if (Global_51874[iVar14 /*203*/].f_1 == iVar2)
			{
				iVar13 = iVar14;
			}
			iVar14++;
		...
		{
			iVar15 = Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/];
			iVar16 = Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/];
			Var17 = { func_29(Global_42574[iVar15 /*12*/]) };
			Var18 = { func_29(Global_42574[iVar15 /*12*/].f_1) };
			if (Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_1)
			{
				MemCopy(&Var18, {Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_2}, 16);
			}
			if (Global_42574[iVar15 /*12*/].f_4 == 0)
			{
				func_74(0);
			}
			else if (bVar1)
			...
			bVar19 = false;
			bVar19 = func_54(iParam0, Global_51874[iVar13 /*203*/].f_1, iVar3, iVar16);
			if (!bVar19)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
				func_8(func_56(Global_42574[iVar15 /*12*/].f_3));
				func_8(func_56(Global_42574[iVar15 /*12*/].f_2));
				func_8(&Var17);
				if (Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6 > 0)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				...
				func_8(func_39(Global_42574[iVar15 /*12*/].f_2));
				func_38(iVar15, Global_42574[iVar15 /*12*/].f_2);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
		}
	}
...
int func_54(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	while (iVar5 < 16)
	{
		...
		{
			case 72:
				if (Global_111560.f_24899[iVar6 /*4*/] == 0)
				{
					bVar7 = true;
				}
				break;
			...
			case 73:
				if (Global_111560.f_24899[iVar6 /*4*/] == 1)
				{
					bVar7 = true;
				}
				break;
			...
			case 74:
				if (Global_111560.f_24899[iVar6 /*4*/] == 2)
				{
					bVar7 = true;
				}
				break;
		...
		if (bVar7)
		{
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_111560.f_24899[iVar6 /*4*/].f_3);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			iVar2++;
			iVar0 = 1;
...
void func_58(int iParam0, int iParam1)
{
	...
	Global_51873 = iVar5;
	GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT(func_13(iVar5), false);
...
void func_61(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_62(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	func_8(sParam2);
...
int func_63(int iParam0, int iParam1)
{
	...
	while (iVar3 < iVar2)
	{
		...
		{
			iVar9 = Global_51512[iVar0 /*120*/].f_18[iVar1];
			iVar10 = -1;
			iVar11 = 0;
			iVar11 = 0;
			while (iVar11 < 7)
			{
				if (Global_51874[iVar11 /*203*/].f_1 == iVar9)
				{
					iVar10 = iVar11;
				}
				iVar11++;
			...
			{
				iVar12 = Global_51512[iVar0 /*120*/].f_1[iVar1];
				iVar13 = 0;
				if (Global_51512[iVar0 /*120*/].f_69[iVar1])
				{
					iVar13 = 1;
				}
				iVar14 = Global_51874[iVar10 /*203*/].f_10[iVar12 /*48*/];
				if (iVar13 == 1)
				{
					if (Global_42574[iVar14 /*12*/].f_4 > 0)
					{
						if (Global_51512[iVar0 /*120*/].f_35[iVar1] == 0)
						{
							iVar13 = 2;
				...
				Var15 = { func_29(Global_42574[iVar14 /*12*/]) };
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(8);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar3);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar13);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
				func_8(func_56(Global_42574[iVar14 /*12*/].f_2));
				func_8(&Var15);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
		}
...
void func_64(int iParam0)
{
	...
	while (iVar5 < iVar2)
	{
		...
		{
			iVar7 = Global_51512[iVar0 /*120*/].f_18[iVar3];
			iVar8 = -1;
			iVar9 = 0;
			iVar9 = 0;
			while (iVar9 < 7)
			{
				if (Global_51874[iVar9 /*203*/].f_1 == iVar7)
				{
					iVar8 = iVar9;
				}
				iVar9++;
		...
		{
			iVar10 = Var4;
			Var4.f_1[iVar10] = Global_51512[iVar0 /*120*/].f_1[iVar3];
			Var4.f_18[iVar10] = Global_51512[iVar0 /*120*/].f_18[iVar3];
			Var4.f_35[iVar10] = Global_51512[iVar0 /*120*/].f_35[iVar3];
			Var4.f_52[iVar10] = Global_51512[iVar0 /*120*/].f_52[iVar3];
			Var4.f_69[iVar10] = Global_51512[iVar0 /*120*/].f_69[iVar3];
			Var4.f_86[iVar10] = Global_51512[iVar0 /*120*/].f_86[iVar3];
			Var4++;
		}
		iVar3++;
		if (iVar3 == 16)
	...
	while (iVar5 < 16)
	{
		Global_51512[iVar0 /*120*/].f_103[iVar5] = 0;
		Global_51512[iVar0 /*120*/].f_1[iVar5] = Var4.f_1[iVar5];
		Global_51512[iVar0 /*120*/].f_18[iVar5] = Var4.f_18[iVar5];
		Global_51512[iVar0 /*120*/].f_35[iVar5] = Var4.f_35[iVar5];
		Global_51512[iVar0 /*120*/].f_52[iVar5] = Var4.f_52[iVar5];
		Global_51512[iVar0 /*120*/].f_69[iVar5] = Var4.f_69[iVar5];
		Global_51512[iVar0 /*120*/].f_86[iVar5] = Var4.f_86[iVar5];
		iVar5++;
	}
}
...
float func_66(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	struct<2> Var0;
	float fVar1;
	float fVar2;
	...
	fVar1 = func_68((SYSTEM::TO_FLOAT((MISC::GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
		...
		Global_19414 = { func_67(vParam0, vParam1, fVar2) };
		Global_19417 = { func_67(vParam2, vParam3, fVar2) };
	}
	else
	{
...
Vector3 func_67(vector3 vParam0, vector3 vParam1, float fParam2)
{
...
void func_70()
{
	...
	fVar0 = func_66(vLocal_47, vLocal_48, Global_19446, -90f, 0f, 90f, 350f, 0);
	if (Global_8160 == 0)
	{
