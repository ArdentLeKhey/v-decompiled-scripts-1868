...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = MISC::IS_BIT_SET(Global_111560.f_10044.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = MISC::IS_BIT_SET(Global_111560.f_10044.f_97, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = MISC::IS_BIT_SET(Global_111560.f_10044.f_98, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			MISC::SET_BIT(&(Global_111560.f_10044.f_96), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			MISC::SET_BIT(&(Global_111560.f_10044.f_97), (iLocal_31 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_111560.f_10044.f_98), (iLocal_31 - 64));
		}
		Global_95144 = 1;
		func_30();
		iLocal_29 = 1;
...
void func_9()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_12(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_53(14) || Global_110511))
			{
...
void func_16()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_48) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (MISC::IS_BIT_SET(Global_111560.f_10044.f_96, iLocal_31))
			{
				bLocal_47 = true;
			}
		}
	...
	switch (iLocal_28)
	{
		case 0:
			if (iLocal_29 && !bLocal_47)
			{
				if (!func_23())
				{
					iLocal_30 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MIDSIZED_MESSAGE");
...
void func_26()
{
	...
	{
		if (MISC::IS_BIT_SET(Global_111560.f_10044.f_97, (iLocal_31 - 32)))
		{
			bLocal_47 = true;
		}
	}
	else if (MISC::IS_BIT_SET(Global_111560.f_10044.f_98, (iLocal_31 - 64)))
	{
		bLocal_47 = true;
	}
	if (bLocal_47)
...
void func_45()
{
	...
	{
		func_48(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_49()
{
	...
	while (iVar1 < 32)
	{
		if (MISC::IS_BIT_SET(Global_111560.f_10044.f_96, iVar1))
		{
			if (func_50(iVar1))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_111560.f_10044.f_97, iVar1))
		{
			if (func_50(iVar1 + 32))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_111560.f_10044.f_98, iVar1))
		{
			if (func_50(iVar1 + 64))
			{
				iVar0++;
