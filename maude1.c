		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_58) || TASK::IS_PED_GETTING_UP(iLocal_58))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_50, false);
...
bool func_14(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_27()
{
	...
	switch (iLocal_43)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_56))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(2727.4f, 4145.56f, 43.68f, 10f, joaat("prop_table_03b"), 0))
				{
					...
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_56, 2727.4f, 4145.56f, 43.68f, 1, false, 0, 1);
		...
		case 1:
			...
			if (func_17(iLocal_58))
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_58, false) };
				if (!func_243(0))
				{
					if (SYSTEM::VDIST2(vVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) > 14400f)
					{
						if (!CAM::IS_SPHERE_VISIBLE(vVar0, 2.5f) || ENTITY::IS_ENTITY_OCCLUDED(iLocal_58))
						{
							iLocal_43 = 2;
						}
					}
					...
					{
						func_239(vVar0, vVar1, 18000, 1101004800);
					}
				}
				else
				{
...
void func_29(int iParam0, bool bParam1)
{
	...
	{
		func_197(&(Global_110647[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_33()
{
	...
	{
		func_35(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76389[1 /*14*/] = { func_109(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_109(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_101(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_59(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_174(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_109(iVar10, iParam1, iParam2, -1) };
		if (!func_99(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_109(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_109(iVar10, 14, uVar12[iVar1], -1) };
							func_77(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_92(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_76389[1 /*14*/] = { func_109(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_109(iVar10, 14, uVar15[iVar1], -1) };
			func_77(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_92(14);
			if (Global_76387 == 1)
			{
...
{
	Global_76389[1 /*14*/] = { func_109(iParam0, iParam1, iParam2, -1) };
...
void func_92(int iParam0)
{
	...
	{
		func_98(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_95(iParam2)];
	if (iVar0 != 0)
	{
...
int func_96(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_95(iParam1)];
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_174(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &vVar2) && vVar2.z != -1)
				{
					...
					{
						(*iParam0)[vVar2.z] = func_84(iParam1, vVar2.x, 14, iVar0);
					}
					else if (vVar2.y != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_108(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_108(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_108(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_107(vVar2.z)] = vVar2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_107(vVar2.z)] = func_84(iParam1, vVar2.x, func_107(vVar2.z), iVar0);
					}
				}
				else if (vVar2.y != -1)
				{
					(*uParam0)[func_107(vVar2.z)] = vVar2.y;
				}
			}
			iVar4++;
		}
...
void func_111(int iParam0)
{
	...
	func_112(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_96(func_115(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_96(func_114(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_96(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_174(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_174(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_109(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_174(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_109(iVar0, iVar2, iVar1, -1) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
...
void func_181()
{
	...
	{
		if (func_176(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_175(PLAYER::PLAYER_PED_ID());
			if (func_178(iVar0) && (!func_117(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_178(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_186(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_183(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_98706, 0);
		func_187(&sVar1, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_187(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_189(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_192()
{
	...
	{
		func_181();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_193(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
...
{
	func_202(iParam0, 1);
	Global_111560.f_18569[iParam0 /*6*/].f_3 = func_201();
...
int func_239(vector3 vParam0, vector3 vParam1, int iParam2, float fParam3)
{
...
int func_247(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_253(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_254(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_254(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_255(iParam2, iParam5) };
				...
				if (func_17(iLocal_58))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_60, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_61, 0))
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							...
							PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_47, false);
...
void func_263()
{
	...
	if (!func_11(iVar0))
	{
		iVar0 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_229, 10f, 0, 16390);
		if (!func_11(iVar0))
		{
			return;
		}
...
void func_275(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_40 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
			...
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_40, 0);
...
void func_276()
{
	...
	vVar1 = { 2719.126f, 4144.691f, 47.88543f };
	fVar3 = 13f;
	vVar2 = { 3f, 11f, 6f };
	if (func_332(vVar2, 0))
	{
		func_326(vVar0, vVar1, fVar3, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_277(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		vLocal_229 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		func_326(vVar0, vVar1, fVar3, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_277(2710.665f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		vLocal_229 = { 2710.665f, 4149.075f, 42.7026f };
	}
}

void func_277(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_325(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_322(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_278(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_278(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_312(iParam3, &Var0, vParam1, fParam2, func_315(iParam0));
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_309(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_298();
			}
...
void func_280(int iParam0, int iParam1)
{
	...
	func_317(iParam0, &(Global_111560.f_32744.f_5510));
}
...
int func_309(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_316(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_316(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_316(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_312(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_309(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_314(iParam0);
			func_313(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
bool func_316(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_322(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_323(vParam0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_323(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_326(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_327(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_327(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_329(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_329(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_330(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_330(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_330(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_330(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_330(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_330(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_330(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_330(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_330(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_330(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_330(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_330(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_330(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_330(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_330(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_330(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
bool func_332(vector3 vParam0, int iParam1)
{
	return func_333(Global_102125.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_333(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_335(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_340()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_57))
	{
		...
		{
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, iVar1, 0))
			{
				iLocal_57 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, iVar1, 1, 0, 1);
			}
		}
	}
}
...
int func_349()
{
	if ((func_449() || func_31(0)) || func_351())
	{
		return 1;
	}
	if (iLocal_48 == 0)
	...
	switch (iLocal_39)
	{
		...
		case 3:
			if (func_17(uParam0->f_28[0]) && func_11(uParam0->f_41[0]))
			{
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uParam0->f_59, false);
...
int func_364(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_365(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_365(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_367(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_4(iParam0);
...
void func_374(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_449())
	{
...
void func_375(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_445(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_423(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_316(vParam1, 0f, 0f, 0f, 0))
		...
		func_419(vParam1, 5f, 0);
		if (func_178(iParam10))
		{
			func_418(iParam10, 0);
			while (!func_376(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_376(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_413(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_413(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_413(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_377(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_178(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_319(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_380(*iParam1);
				...
				func_378(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_378(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_381(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_408(iVar0, bParam1, uParam2) && !func_407(PLAYER::PLAYER_ID())) && !func_391(iParam0))
	{
		return 0;
	}
...
int func_382(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			...
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_388(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_389(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_406(PLAYER::PLAYER_ID()) || func_405(PLAYER::PLAYER_ID()))
	{
		if (func_392(iParam0))
		{
			return 1;
...
int func_405(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_385())
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_406(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_385())
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_407(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_383(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_408(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
int func_413(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_404(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_416(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_416(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_415(iParam0);
	if (func_414(*iParam0))
	{
...
void func_418(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_310(iParam0, iParam1))
				{
...
void func_419(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_309(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_420(int iParam0)
{
	...
	if (func_309(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_75396.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_207(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_421(0, Global_75396.f_555[0 /*21*/].f_12) || !func_421(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_313(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_421(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_422(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_283(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_423(vector3 vParam0, float fParam1)
{
	return func_424(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_424(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_441(uParam0))
	{
		...
		if (func_440(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_429(iVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_418(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_418(uParam0->f_11, 2);
						}
					}
					...
					func_410(iVar0, uParam0->f_11);
				}
				else if ((!func_426(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_425(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_426(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_428(iParam0, Global_75396.f_139[38], 0))
			{
				func_420(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_428(iParam0, Global_75396.f_139[43], 1))
			{
				func_420(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_428(iParam0, uVar1[iVar3], 1) && func_427(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_316(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_427(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_428(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_429(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_432(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_431())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_413(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_318(iVar2 + 1)))
				{
...
int func_433(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_439(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_435(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
int func_441(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("STUNT") && func_427(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_442()
{
	return func_440(&(Global_105109.f_2890));
}

void func_443()
{
	func_444(&(Global_105109.f_2890));
}
...
int func_445(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_447(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_452()
{
	...
	func_453(&Local_41, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_453(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_461(uParam0, iParam1);
	func_456(uParam0, bParam2);
	func_454(uParam0, bParam3);
}

void func_454(var uParam0, bool bParam1)
{
	func_455(&(uParam0->f_41), bParam1);
}
