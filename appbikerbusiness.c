...
void __EntryFunction__()
{
	...
	iLocal_762 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("BIKER_BUSINESSES");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_762))
	{
		SYSTEM::WAIT(0);
	}
	func_492(1);
	...
	{
		iLocal_591 = func_485(PLAYER::PLAYER_ID());
	}
	else if (func_484())
	{
		iLocal_591 = Global_1694982;
	}
	else
	{
		func_472(PLAYER::PLAYER_ID(), 0, 0, 0);
	}
	func_454();
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		vLocal_576 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	}
	if (!func_451(7638, -1, -1))
	{
		func_448();
	}
	...
	if (iLocal_591 != 0)
	{
		iVar0 = func_446(iLocal_591);
		if (iVar0 != -1)
		{
			if (func_445(PLAYER::PLAYER_ID(), iLocal_591) == func_444(iLocal_591))
			{
				if (!MISC::IS_BIT_SET(Global_1366502, iVar0))
				{
					func_443(iVar0, 1, 0);
					MISC::SET_BIT(&Global_1366502, iVar0);
				}
			}
			else
			{
				MISC::CLEAR_BIT(&Global_1366502, iVar0);
			}
		}
	}
	while (func_442())
	{
		if (MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_24, 14) || func_441(PLAYER::PLAYER_PED_ID(), vLocal_576, 1) > 5f)
		{
			func_495(0);
		}
		...
		if (func_440(PLAYER::PLAYER_ID()) || ((!func_451(7638, -1, -1) && func_438(PLAYER::PLAYER_ID())) && func_416()))
		{
			func_415(7638, 1, -1, 1);
		}
		func_402();
		...
		if (iLocal_591 != 0)
		{
			iVar1 = func_446(iLocal_591);
			if ((iVar1 > -1 && iVar1 < 6) && iLocal_589 != Global_1366494[iVar1])
			{
				func_454();
			}
		}
		if (iLocal_592 == -1 && !Global_1676739)
		{
			func_11();
		}
		else if (iLocal_588 != 190)
		{
			if (!func_10(&uLocal_593))
			{
				func_9(&uLocal_593, 0, 0);
			}
			else if (func_8(&uLocal_593, 200, 0))
			{
				if (!Global_1676739)
				{
					func_3(PLAYER::PLAYER_ID(), iLocal_591, iLocal_592, 1);
					Global_1676739 = 1;
					func_495(0);
				}
				else if (!Global_1676879.f_2897)
				{
					func_1();
				}
			}
		}
		else if (!func_10(&uLocal_595))
		{
			func_9(&uLocal_595, 0, 0);
			CAM::DO_SCREEN_FADE_OUT(800);
		}
		else if (!Global_1676879.f_2897)
		{
			if (MISC::IS_BIT_SET(Global_1366469, 0))
			{
				func_1();
			}
			else if (func_8(&uLocal_595, 15000, 0))
			{
				func_1();
			}
		}
...
void func_11()
{
	...
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "GET_CURRENT_SELECTION");
		iLocal_763 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "GET_SELECTED_BUSINESS_ID");
		iLocal_765 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "GET_CURRENT_SCREEN_ID");
		iLocal_766 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_579 = 0;
		iLocal_578 = 0;
	}
	if ((PAD::IS_CONTROL_JUST_PRESSED(2, 202) || PAD::IS_CONTROL_JUST_PRESSED(2, 238)) && iLocal_579)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "GET_CURRENT_SCREEN_ID");
		iLocal_766 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_579 = 0;
	}
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_766) && !iLocal_579)
	{
		iLocal_587 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_766);
		iLocal_579 = 1;
	}
	if (iLocal_583 && !iLocal_584)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "GET_CURRENT_ROLLOVER");
		iLocal_764 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_584 = 1;
	}
	if (iLocal_584)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_764))
		{
			iLocal_585 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_764);
			iLocal_584 = 0;
		}
	}
	if (iLocal_585 == 3014 && func_400())
	{
		HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP("OR_RSP_TUT");
		HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, 8000);
		iVar0 = func_397(9356, -1, -1) + 1;
		func_396(9356, iVar0, -1, 1);
		iLocal_582 = 1;
	}
	if (!iLocal_578)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_763) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_765))
		{
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_763);
			iVar2 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_765);
			iVar3 = -1;
			if (iLocal_591 != 0)
			{
				iVar3 = func_446(iLocal_591);
			}
			switch (iVar1)
			{
				case 101:
				...
				case 2001:
					func_205(iVar2, iVar1);
					break;
				
				case 3001:
					if (Global_1366494[iVar3] >= Global_262145.f_17904)
					{
						func_204(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_203(iVar3))
					{
						func_204(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
					}
					break;
				
				case 3002:
					if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar3 /*12*/].f_4 <= 0)
					{
						func_204(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_192(iLocal_591) == 2)
					{
						func_204(0, "OR_UPGR_RES", "OR_OVRLY_OK", "", -1, 1);
					}
					break;
				...
				case 3003:
					...
					{
						func_204(0, "BKR_TF_R3", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (!func_189(192))
					{
						if (func_188(PLAYER::PLAYER_ID()) && !func_191(PLAYER::PLAYER_ID()))
						{
							iVar4 = func_31(PLAYER::PLAYER_ID(), 192, 0);
						}
						if (iVar4 == 15)
						{
							func_204(0, "GENERAL_MLF_G1", "OR_OVRLY_OK", "", -1, 1);
						}
						else if (iVar4 == 16)
						{
							func_204(0, "GENERAL_MLF_G4", "OR_OVRLY_OK", "", -1, 1);
						}
						else
						{
							func_204(0, "BKR_TF_R6", "OR_OVRLY_OK", "", -1, 1);
						}
					}
					else
					{
						func_204(iVar1, "OR_BUS_SETUP", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3005:
					if (func_203(iVar3))
					{
						func_204(0, "UA_CANT_SDOWN", "OR_OVRLY_OK", "", -1, 1);
					}
					else
					{
						func_204(iVar1, "OR_STOP_PROD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3006:
					if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar3 /*12*/].f_4 <= 0)
					{
						func_204(0, "OR_BS_NOT_SETUP", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (Global_1366494[iVar3] <= 0)
					{
						func_204(iVar1, "OR_START_PRD_NS", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					else
					{
						func_204(iVar1, "OR_START_PROD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3014:
					iVar6 = Global_1366494[iVar3];
					iVar7 = func_13(0, iVar6, 0);
					if (Global_262145.f_18468)
					{
						func_204(0, "OR_BS_PAY_NA", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (Global_1366494[iVar3] >= Global_262145.f_17904)
					{
						func_204(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_203(iVar3))
					...
					else if (!MONEY::NETWORK_CAN_SPEND_MONEY(iVar7, false, true, 0, -1, 0))
					{
						func_204(0, "OR_BS_PAY_NM", "OR_OVRLY_OK", "", -1, 1);
					}
					else
					{
						func_204(iVar1, "OR_BUY_SUP", "WHOUSE_CONF", "WHOUSE_CANC", iVar7, 0);
					}
					break;
...
void func_12(int iParam0)
{
	...
	if (Global_1366494[func_446(iLocal_591)] >= Global_262145.f_17904)
	{
		func_204(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_203(func_446(iLocal_591)))
	{
		func_204(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_189(192))
	...
	{
		func_204(iParam0, "OR_STEAL_SUP", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
}
...
void func_15(int iParam0, bool bParam1)
{
	...
	if (func_17(iLocal_591))
	{
		func_204(0, "OR_BUS_EMPTY", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_189(190))
	{
		if (func_188(PLAYER::PLAYER_ID()) && !func_191(PLAYER::PLAYER_ID()))
		{
		...
		{
			func_204(0, "OR_MIS_NA", "OR_OVRLY_OK", "", -1, 1);
		}
	}
	else if (func_16(iLocal_591) > 25)
	{
		if (bParam1)
		{
			func_204(1003, "OR_SELL_GDB", "OR_OVRLY_OK", "", -1, 0);
		}
		else
		{
			func_204(1002, "OR_SELL_GDB", "OR_OVRLY_OK", "", -1, 0);
		}
	}
	else
	{
		func_204(iParam0, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
}
...
int func_16(int iParam0)
{
	...
	iVar1 = func_445(PLAYER::PLAYER_ID(), iParam0);
...
void func_18(int iParam0, int iParam1)
{
	...
	if (!func_30(iVar0))
	{
		func_204(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_4 <= 0)
	{
		func_204(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_29(iParam0, iLocal_591))
	{
		func_204(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_28(PLAYER::PLAYER_ID(), iLocal_591, iParam0))
	{
		func_204(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (MONEY::NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iLocal_591), false, true, 0, -1, 0))
	{
		func_204(iParam1, "OR_BUY_UPGR", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
	else
	{
		func_204(0, "OR_UPG_NO_MONEY", "OR_OVRLY_OK", "", -1, 1);
	}
}
...
int func_22(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_23(iParam1)];
...
int func_31(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_66(func_163(iParam1, -1, -1, -1), func_126(iParam1, -1, 1, -1, -1, iParam0), func_75(iParam1, -1, -1, -1, -1, iParam0), 0, 1))
	{
		return 0;
	}
	iVar0 = iParam1;
...
{
	return Global_1651198.f_11.f_147[func_63(iParam0)];
}
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 225:
		case 226:
			return func_117(iParam1, iParam2, iParam3, iParam4);
		...
		case 229:
		case 230:
			return func_105(iParam1, iParam2, iParam3, PLAYER::INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 233:
			return func_98(iParam1, iParam2, iParam3, PLAYER::INT_TO_PLAYERINDEX(iParam5), iParam4);
		...
		case 237:
		case 250:
			return func_86(iParam1, iParam2, iParam3);
		...
		case 243:
			return func_81(iParam1, iParam2, PLAYER::INT_TO_PLAYERINDEX(iParam5), iParam4);
...
int func_80(int iParam0, int iParam1, var uParam2)
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = func_84(iParam0, iParam1, iParam3);
	if (!func_83(iParam0))
	{
		iVar0 = (iVar0 + func_82(iParam0, iParam2));
	}
	return iVar0;
}
...
int func_89(int iParam0, int iParam1)
{
	...
	if (!func_96(iParam0))
	{
		iVar0 = (iVar0 + func_90(iParam0, func_94() + 1));
	}
	if (iParam0 == 14 || ((((func_96(iParam0) && iParam0 != 9) && iParam0 != 16) && iParam0 != 7) && iParam0 != 17))
	{
		iVar0 = (iVar0 + func_90(iParam0, func_94() + 1));
	}
	if (iParam0 == 7)
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_104(iParam0, iParam1, iParam2, iParam4);
	if (!func_103(iParam0))
	{
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_100(iParam0, func_42(iParam3) + 1, iParam3, -1, iParam2));
		}
	}
	if (func_99(iParam0))
	{
...
int func_100(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	if (iVar0 > func_102(iParam0))
	{
		iVar0 = func_102(iParam0);
	}
	else if (iVar0 < func_101(iParam0))
	{
...
int func_104(int iParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	if (!func_115(iParam0))
	{
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_107(iParam0, func_42(iParam3) + 1, iParam3, -1, iParam2));
		}
	}
	if (func_106(iParam0))
	{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		iVar0 = iParam1;
		if (iVar0 > func_111(iParam2))
		{
			iVar0 = func_111(iParam2);
		}
	}
	if (iVar0 > func_109(iParam0))
	{
		iVar0 = func_109(iParam0);
	}
	else if (iVar0 < func_108(iParam0))
	{
...
{
	if (func_114(iParam0) || func_112(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = func_122(iParam0, iParam1, iParam2, iParam3);
	if (!func_121(iParam0))
	{
		iVar0 = (iVar0 + func_119(iParam0, func_94() + 1, -1, iParam2));
	}
	if (func_118(iParam0))
	{
		iVar0 = (iVar0 + iParam2);
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 225:
		case 226:
			return func_154(iParam1, iParam3, iParam4, 0, 0);
		...
		case 229:
		case 230:
			return func_148(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
		
		case 233:
			return func_142(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
			return 6;
		...
		case 192:
			return func_141(iParam1, iParam3);
		...
		case 237:
		case 250:
			return func_140(iParam1, iParam3, iParam4);
		...
		case 243:
			return func_133(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_127(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
...
int func_127(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		iVar0 = (iVar0 + func_132(iParam0, -1));
	}
	if (!bParam6)
	{
		if (func_131(0, iParam1) != -1)
		{
			iVar0 = (iVar0 + func_130(func_42(iParam2) + 1, iParam0, iParam2));
		}
	}
	if (!bParam3)
	{
		...
		{
			iVar0 = (iVar0 + func_128(iParam0, iParam1));
		}
	}
	return iVar0;
}
...
{
	return func_128(iParam0, iParam1) > 0;
}
...
int func_133(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		iVar0 = (iVar0 + func_138(iParam0, -1));
	}
	if (!bParam6)
	{
		if (func_137(0, iParam1) != -1)
		{
			iVar0 = (iVar0 + func_136(func_42(iParam2) + 1, iParam0));
		}
	}
	if (!bParam3)
	{
		...
		{
			iVar0 = (iVar0 + func_134(iParam0, iParam1));
		}
	}
	return iVar0;
}
...
{
	return func_134(iParam0, iParam1) > 0;
}
...
int func_141(int iParam0, int iParam1)
{
	...
	if ((func_96(iParam0) && iParam0 != 7) || iParam0 == 12)
	{
		iVar0 = (iVar0 + func_90(iParam0, func_94() + 1));
	}
	return iVar0;
...
int func_142(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_147(iParam0, func_42(iParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_146(0, iParam1) != -1)
		{
			if (iParam3 != func_5())
			{
				iVar0 = (iVar0 + func_145(func_42(iParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_153(iParam0, func_42(iParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_152(0, iParam1) != -1)
		{
			if (iParam3 != func_5())
			{
				iVar0 = (iVar0 + func_151(func_42(iParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_154(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 7:
			...
			if (func_119(iParam0, func_94() + 1, -1, iParam2) == 1)
			{
				iVar0++;
			}
			break;
	...
	if (!bParam4)
	{
		...
		iVar0 = (iVar0 + func_157(iParam0, func_94() + 1));
	}
	if (!bParam3)
	{
		if (func_156(iParam0))
...
int func_158(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = (iVar0 + func_161(iParam0, func_94() + 1, iParam2));
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3)
{
	switch (iParam0)
	{
		...
		case 178:
		case 188:
			return func_184(iParam1, iParam2, iParam3);
		
		case 225:
		case 226:
			return func_181(iParam1, iParam2, iParam3, 0);
		...
		case 229:
		case 230:
			return func_178(iParam1, iParam2, iParam3, 0);
		
		case 233:
			return func_175(iParam1, iParam2, iParam3, 0);
		...
		case 192:
			return func_174(iParam1, iParam2);
		...
		case 237:
		case 250:
			return func_171(iParam1, iParam2, iParam3);
		
		case 238:
		case 249:
			return func_170(iParam1, iParam2);
		...
		case 243:
			return func_167(iParam1, iParam2, 0, -1);
		
		case 158:
			return func_164(iParam1, iParam2, 0, -1);
...
int func_165(int iParam0, int iParam1)
{
	if (func_129(iParam0, iParam1))
	{
		return (func_128(iParam0, iParam1) + func_166(iParam0, iParam1));
	}
	return 0;
}
...
int func_168(int iParam0, int iParam1)
{
	if (func_135(iParam0, iParam1))
	{
		return (func_134(iParam0, iParam1) + func_169(iParam0, iParam1));
	}
	return 0;
}
...
int func_175(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (func_144(iParam0))
		{
			iVar0 = (iVar0 + func_176(iParam0, iParam1));
		}
	}
	return iVar0;
}
...
int func_176(int iParam0, var uParam1)
{
	if (func_144(iParam0))
	{
		return (func_143(iParam0) + func_177(iParam0, uParam1));
	}
	return 0;
}
...
int func_178(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
	...
	if (!bParam3)
	{
		if (func_150(iParam0))
		{
			iVar0 = (iVar0 + func_179(iParam0, iParam1));
		}
	}
	return iVar0;
}
...
int func_179(int iParam0, int iParam1)
{
	if (func_150(iParam0))
	{
		return (func_149(iParam0) + func_180(iParam0, iParam1));
	}
	return 0;
}
...
int func_182(int iParam0)
{
	if (func_156(iParam0))
	{
		return (func_155(iParam0) + func_183(iParam0));
	}
	return 0;
}
...
int func_192(int iParam0)
{
	...
	else if (!func_201(PLAYER::PLAYER_ID(), iVar0) && !func_200(iVar0))
	{
		return 2;
	}
	else if (func_193(iVar0, iParam0))
	{
		return 1;
	}
	return 3;
...
int func_193(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1366494[iParam0] > 0 && (!func_198(iParam1) || !func_194(PLAYER::PLAYER_ID(), iParam1)))
		{
			if (!Global_262145.f_21064 || func_188(PLAYER::PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1366494[iParam0] > 0 && !func_198(iParam1)) && (!Global_262145.f_18467 || func_64(PLAYER::PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
{
	return func_196(iParam0, iParam1) >= func_195(iParam1);
}
...
int func_196(int iParam0, int iParam1)
{
	...
	if (func_6(iParam1) && func_197(iParam1))
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
...
{
	return func_199(PLAYER::PLAYER_ID(), iParam0);
}
...
int func_199(int iParam0, int iParam1)
{
	...
	if (iParam0 != func_5() && func_7(iParam0, iParam1))
	{
		...
		if (func_30(iVar0))
		{
			return Global_1590446[iParam0 /*871*/].f_273.f_179[iVar0 /*12*/].f_1 >= func_444(iParam1);
		}
	}
	return 0;
}
...
{
	if (iParam0 != func_5() && func_7(iParam0, func_202(iParam0, iParam1)))
	{
...
void func_204(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, bool bParam5)
{
	iLocal_586 = iParam0;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SHOW_OVERLAY");
...
void func_205(int iParam0, int iParam1)
{
	...
	iVar0 = iParam0;
	bVar1 = func_225(iVar0);
	iVar2 = func_222(iVar0);
	if (func_221(PLAYER::PLAYER_ID(), func_27(iVar0)))
	{
		iVar3 = func_220(PLAYER::PLAYER_ID(), func_27(iVar0));
		iVar2 = (iVar2 - func_208(iVar3));
	}
	if (bVar1)
	{
		iVar2 = 0;
	}
	if (iVar2 > 0 && !MONEY::NETWORK_CAN_SPEND_MONEY(iVar2, false, true, 0, -1, 0))
	{
		func_204(0, "OR_BUS_AFF", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_206(iVar0))
	{
		if (func_221(PLAYER::PLAYER_ID(), func_27(iVar0)))
		{
			func_204(1001, "OR_BUY_BUSB", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
		}
		else
		{
			func_204(iParam1, "OR_BUY_BUS", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
		}
	}
	else
	{
		func_204(0, "OR_BUS_NA", "OR_OVRLY_OK", "", -1, 1);
	}
}

int func_206(int iParam0)
{
	if (func_207(iParam0) || func_7(PLAYER::PLAYER_ID(), iParam0))
	{
		return 0;
	}
	return 1;
...
int func_207(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return Global_262145.f_17738;
		
		case 7:
			return Global_262145.f_17731;
...
int func_208(int iParam0)
{
	...
	iVar0 = (func_215(iParam0) / 2);
	if (iVar0 < 0)
	{
		iVar0 = (func_222(iParam0) / 2);
	}
	...
	if (func_197(iParam0))
	{
		...
		{
			iVar4 = (Global_262145.f_20942 / 2);
			iVar0 = (iVar0 + iVar4);
		}
		if (func_212(PLAYER::PLAYER_ID()))
		{
			iVar5 = (Global_262145.f_20942 / 2);
			iVar0 = (iVar0 + iVar5);
		}
...
{
	if (func_22(func_219(iParam0), -1, 0) == func_22(func_218(iParam0), -1, 0))
	{
		*uParam1 = func_22(func_217(iParam0), -1, 0);
		return *uParam1 >= 0;
	}
	return 0;
}
...
int func_222(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_25())
	{
		...
		func_224(&sVar1, iParam0, bVar0);
		iVar2 = MISC::GET_HASH_KEY(&sVar1);
		if (NETSHOPPING::_NET_GAMESERVER_CATALOG_ITEM_EXISTS_HASH(iVar2))
		{
			iVar3 = NETSHOPPING::NET_GAMESERVER_GET_PRICE(iVar2, 426439576, 1);
			StringCopy(&cVar4, func_223(iParam0), 16);
			return iVar3;
		}
		else
		{
			StringCopy(&cVar5, func_223(iParam0), 16);
		}
	}
	if (func_225(iParam0))
	{
	...
	switch (iParam0)
	{
		...
		case 13:
			return Global_262145.f_17558;
		
		case 15:
			return Global_262145.f_17550;
		
		case 14:
			return Global_262145.f_17554;
		...
		case 18:
			return Global_262145.f_17559;
		
		case 20:
			return Global_262145.f_17551;
		
		case 19:
			return Global_262145.f_17555;
		
		case 21:
			return Global_262145.f_20931;
		
		case 22:
			return Global_262145.f_20930;
		
		case 23:
			return Global_262145.f_20932;
		
		case 24:
			return Global_262145.f_20927;
		
		case 25:
			return Global_262145.f_20929;
		
		case 26:
			return Global_262145.f_20928;
		
		case 27:
			return Global_262145.f_20933;
		
		case 28:
			return Global_262145.f_20937;
		
		case 29:
			return Global_262145.f_20936;
		
		case 30:
			return Global_262145.f_20935;
		
		case 31:
			return Global_262145.f_20934;
...
void func_224(char* sParam0, int iParam1, bool bParam2)
{
...
void func_229(bool bParam0, int iParam1)
{
	...
	GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_762, "HIDE_OVERLAY");
	iLocal_581 = 0;
	if (bParam0)
	{
		switch (iLocal_586)
		{
			case 2001:
				if (iLocal_580)
				{
					GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_762, "SHOW_HOMEPAGE");
					iLocal_580 = 0;
				}
				else if (!func_207(iParam1))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					if (func_221(PLAYER::PLAYER_ID(), func_27(iParam1)))
					{
						func_393(iParam1);
						func_392(iVar0, 0);
					}
			...
			case 1001:
				func_204(2001, "OR_BUY_SAV", "WHOUSE_CONF", "WHOUSE_CANC", func_336(iParam1), 0);
				break;
			...
			case 1002:
				...
				{
					func_204(3011, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
				}
				break;
			...
			case 1003:
				...
				{
					func_204(3012, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
				}
				break;
			
			case 3003:
				if (func_335(iLocal_591))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_331(iLocal_591);
					func_329(func_446(iLocal_591));
				}
				break;
			...
			case 3005:
				...
				{
					iVar2 = func_313(func_27(iLocal_591));
					if (func_312(iVar2))
					{
						iVar3 = func_310(iVar2);
						func_298(iVar3);
						MISC::SET_BIT(&Global_1676735, iVar0);
					}
				}
				break;
			...
			case 3006:
				...
				iVar0 = func_446(iLocal_591);
				func_296(func_446(iLocal_591));
				func_454();
				func_392(iVar0, 0);
				break;
			
			case 3008:
				if (func_295(0, iLocal_591))
				{
					if (func_291(0))
					{
						func_285(0);
			...
			case 3009:
				if (func_295(1, iLocal_591))
				{
					if (func_291(1))
					{
						func_285(1);
						func_454();
						func_204(0, "OR_SUS_P_STAF", "OR_OVRLY_OK", "", -1, 1);
					}
				}
				break;
			
			case 3010:
				if (func_295(2, iLocal_591))
				{
					if (func_291(2))
					{
						func_285(2);
			...
			case 3011:
				if (func_270(iLocal_591))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_268(func_446(iLocal_591), !Global_262145.f_16969);
					func_252(190, iLocal_591, 0);
					func_248(iLocal_591, 0);
				}
				else
				{
					func_204(0, func_247(iLocal_773), "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			...
			case 3012:
				if (func_270(iLocal_591))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_268(func_446(iLocal_591), !Global_262145.f_16969);
					func_252(190, iLocal_591, 1);
					func_248(iLocal_591, 1);
				}
				else
				{
					func_204(0, func_247(iLocal_773), "OR_OVRLY_OK", "", -1, 1);
			...
			case 3014:
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
				func_234(iLocal_591, -1);
				iVar0 = func_446(iLocal_591);
				if (func_233())
				{
					func_230(iVar0);
					func_204(0, "OR_RSP_PAID", "OR_OVRLY_OK", "", -1, 0);
					func_454();
					HUD::CLEAR_HELP(1);
					if (func_17(iLocal_591))
					{
				...
				{
					func_204(0, "UA_PSUP_FAIL", "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			...
			case 3015:
				if (func_335(iLocal_591))
				{
					Global_1676736 = iLocal_591;
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_252(192, iLocal_591, -1);
					func_268(func_446(iLocal_591), !Global_262145.f_16969);
					func_329(func_446(iLocal_591));
				}
				break;
...
void func_230(int iParam0)
{
	if (Global_1366470[iParam0] == 0)
	{
		...
		func_231(func_232(iParam0), 1, -1, 1, 0);
	}
}
...
void func_231(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_23(iParam2)];
	if (iVar0 != 0)
	{
...
int func_233()
{
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		if (iLocal_776 == -1)
		{
			if (Global_4263810[iLocal_775 /*84*/].f_65 != 2147483647)
			{
				iLocal_776 = Global_4263810[iLocal_775 /*84*/].f_65;
			}
		}
		iVar3 = 0;
		while (iVar3 < SCRIPT::GET_NUMBER_OF_EVENTS(1))
		{
			if (SCRIPT::GET_EVENT_AT_INDEX(1, iVar3) == 226)
			{
				...
				{
					if (vVar0.x == iLocal_776 && vVar0.x != -1)
					{
						if (vVar0.z == 0)
						{
							return 1;
...
void func_234(int iParam0, int iParam1)
{
	...
	if (func_25())
	{
		func_235(268924934, iVar3, &iVar6, 0, 1, 0);
...
void func_238(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_239(&(Global_4263810[iParam0 /*84*/]));
	}
}
...
void func_239(var uParam0)
{
	...
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	func_240(&(uParam0->f_13));
	func_240(&(uParam0->f_13.f_13));
...
int func_243(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	while (iVar0 < 5)
	{
		if (Global_4263810[iVar0 /*84*/].f_65.f_2 == 0)
		{
			...
			{
				func_244(Global_4263810[iVar0 /*84*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
void func_244(struct<66> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
void func_248(int iParam0, int iParam1)
{
	...
	if (func_251(iParam0))
	{
		if (iParam1 == 0)
		{
			iVar0 = func_250(iVar1);
		}
		else
		{
			iVar0 = func_249(iVar1);
		}
	}
	else if (iParam1 == 0)
	{
...
void func_252(int iParam0, int iParam1, int iParam2)
{
	if (func_189(iParam0))
	{
		func_253(iParam0, iParam1, iParam2);
...
void func_254(var uParam0, var uParam1)
{
	if (func_266())
	{
		if (!func_264(PLAYER::PLAYER_ID(), 0))
		{
			func_263(uParam0);
			func_255(uParam0, func_259(1, 1), func_258(), func_257(), func_256(), uParam1);
		}
	}
}

void func_255(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
int func_264(int iParam0, int iParam1)
{
	...
	{
		return func_53(Global_1628955[iParam0 /*614*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
void func_268(int iParam0, bool bParam1)
{
	...
	func_415(func_269(iParam0), bParam1, -1, 1);
...
int func_270(int iParam0)
{
	...
	iVar0 = func_446(iParam0);
	if (!func_190(PLAYER::PLAYER_ID(), 190, 0))
	{
		iLocal_773 = 4;
		return 0;
	}
	...
	if (func_25())
	{
		...
		iLocal_772 = 0;
		iVar1 = func_283(1);
		while (!func_272(iVar0, iVar1, &iLocal_774))
		{
			SYSTEM::WAIT(0);
			func_402();
		}
...
bool func_272(int iParam0, int iParam1, int iParam2)
{
	...
	switch (*iParam2)
	{
		case 0:
			...
			if (func_278(78225582, -1799524201, iParam1, -1018905335, 1, 0, 1, 4, iVar0, 3))
			{
				*iParam2 = 1;
			}
			else
		...
		case 1:
			if (func_274(func_282()))
			{
				if (func_273(func_282()) == 2)
				{
					*iParam2 = 2;
					func_238(func_282());
					func_271(iParam1);
...
int func_275()
{
	...
	if (!bVar0)
	{
		if (!NETSHOPPING::NET_GAMESERVER_IS_SESSION_VALID(func_24()) || NETSHOPPING::NET_GAMESERVER_IS_SESSION_REFRESH_PENDING())
		{
			if (func_277(Global_4263810[iVar2 /*84*/].f_65.f_6, Global_4263810[iVar2 /*84*/].f_65.f_4, Global_4263810[iVar2 /*84*/].f_65.f_1) == 1)
			{
				Global_4264386 = 1;
			}
			return 0;
	...
	if (iVar3 != 2147483647)
	{
		if ((bVar0 || iVar1) || NETSHOPPING::NET_GAMESERVER_CHECKOUT_START(iVar3))
		{
			...
			if (bVar0 || iVar1)
			{
				func_244(Global_4263810[iVar2 /*84*/], iVar2);
			}
			Global_4264371 = 1;
			return 1;
		}
...
int func_278(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
	...
	if (iVar1 == -1)
	{
		if (!func_280(&iVar1, iParam0, iParam1, iParam3, iParam7, iParam9))
		{
			return 0;
		}
	}
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_243(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
int func_286(int iParam0)
{
	if (iParam0 != func_5())
	{
		if (func_262(iParam0, 1, 1))
		{
			...
			{
				return func_287(Global_2424073[iParam0 /*421*/].f_309.f_5) == 17;
			}
		}
	}
	return 0;
...
void func_288(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_7(PLAYER::PLAYER_ID(), iParam0))
	{
		...
		func_231(func_290(iVar0, iParam1), func_289(bParam2), -1, 1, 0);
	}
}
...
int func_291(int iParam0)
{
	...
	bVar0 = true;
	iVar1 = 1;
	iVar2 = func_19(iParam0, iLocal_591);
	iVar3 = iParam0;
	iVar4 = func_446(iLocal_591);
	iVar5 = func_294(iVar4, iVar3 + 1);
	iVar6 = func_27(iLocal_591);
	iVar7 = func_293(iVar6, iVar3 + 1, 1);
	if (func_25())
	{
		bVar0 = false;
		while (!func_292(-103880010, 235173372, iVar7, 1, iVar2, &iLocal_590, iVar5, 3, 0, 0))
		{
			SYSTEM::WAIT(0);
			func_402();
			if (iLocal_590 == 1 && func_282() == -1)
			{
				iLocal_590 = 3;
				iVar1 = 0;
			}
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			vVar8.x = MISC::GET_HASH_KEY(func_223(iLocal_591));
			vVar8.y = iVar6;
			vVar8.z = iParam0;
...
bool func_292(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	{
		case 0:
			if (func_278(78225582, iParam0, iParam2, iParam1, iParam3, iParam4, 1, 4, iParam6, iParam7))
			{
				if (func_275())
				{
					*uParam5 = 1;
			...
			if (func_274(func_282()))
			{
				if (func_273(func_282()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEED(func_276(func_282()));
...
{
	if (!func_28(PLAYER::PLAYER_ID(), iParam1, iParam0) && MONEY::NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iParam1), false, true, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_296(int iParam0)
{
	if (Global_1366477[iParam0] == 0)
	{
		...
		func_415(func_297(iParam0), 1, -1, 1);
	}
}
...
void func_298(int iParam0)
{
	...
	iVar0 = func_308(PLAYER::PLAYER_ID(), iParam0);
	if (!func_307(iVar0))
	{
		return;
	}
	func_304(iVar0, iParam0, 1, 0);
	func_303(&(Global_2508018[iParam0 /*2*/]));
	iVar1 = iVar0;
	iVar2 = func_302(iParam0);
	func_396(iVar2, 0, -1, 1);
	if (iParam0 < 4)
	{
...
void func_304(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!func_309(iParam1) || !func_307(iParam0))
	{
		return;
	}
	...
	if (bParam2)
	{
		func_303(&(Global_2508018[iParam1 /*2*/]));
	}
	if (bParam3)
	{
		iVar1 = iVar0;
...
int func_311(int iParam0, int iParam1)
{
	...
	if (!func_309(iParam0) || !func_307(iParam1))
	{
		return 0;
	}
	if (iParam0 < 4)
...
void func_315()
{
	...
	iVar0 = func_446(iLocal_591);
	if (func_25() && func_445(PLAYER::PLAYER_ID(), iLocal_591) > 0)
	{
		iVar1 = func_283(1);
		iLocal_771 = 1;
		while (!func_272(iVar0, iVar1, &iLocal_774))
		...
		{
			iLocal_774 = 0;
			iVar2 = func_445(PLAYER::PLAYER_ID(), iLocal_591);
			while (!func_325(iVar0, iVar2, 0, 0, &iLocal_774, 0))
			{
				SYSTEM::WAIT(0);
				func_402();
			}
			...
			if (iLocal_774 == 2)
			{
				func_316(PLAYER::PLAYER_ID(), iLocal_591, 1, 0, 0, 0);
				func_443(iVar0, 0, 0);
			}
		}
	}
...
void func_316(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	if (func_30(iVar0))
	{
		if (func_7(iParam0, iParam1))
		{
			...
			if (bParam3)
			{
				...
				func_396(func_324(iVar0), 0, -1, 1);
			}
			else
			{
				Global_1590446[iParam0 /*871*/].f_273.f_179[iVar0 /*12*/].f_4 = 1;
				func_396(func_324(iVar0), 1, -1, 1);
			}
			if (bParam2)
			{
				func_231(func_323(iVar0), 0, -1, 1, 0);
				Global_1590446[iParam0 /*871*/].f_273.f_179[iVar0 /*12*/].f_1 = 0;
			}
			if (bParam4)
			{
				func_231(func_322(iVar0), 0, -1, 1, 0);
				func_321(iVar0, 0);
				func_320(iVar0, 0);
			}
			Global_1366477[iVar0] = 0;
			func_415(func_297(iVar0), 0, -1, 1);
			func_415(func_319(iVar0), 0, -1, 1);
...
bool func_325(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (*iParam4)
	{
		case 0:
			...
			if (iParam3 == 0 || func_278(78225582, -1799524201, iVar3, -788753717, 1, 0, 1, 4, iVar2, 3))
			{
				if (func_278(78225582, 69656641, iVar4, -788753717, iParam1, 0, 1, 4, 0, 3))
				{
					if (func_278(78225582, -739932302, iVar5, -788753717, 1, iParam2, 0, 4, iVar4, 3))
					{
						*iParam4 = 1;
					}
					else
		...
		case 1:
			if (func_274(func_282()))
			{
				if (func_273(func_282()) == 2)
				{
					...
					{
						NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEED(func_276(func_282()));
						iVar0 = func_202(PLAYER::PLAYER_ID(), iParam0);
						iVar1 = func_27(iVar0);
						MONEY::_NETWORK_EARN_FROM_BUSINESS_PRODUCT(iParam2, MISC::GET_HASH_KEY(func_223(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_238(func_282());
				}
...
int func_336(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_27(iVar0);
	iVar2 = func_220(PLAYER::PLAYER_ID(), iVar1);
	return func_208(iVar2);
}
...
void func_337(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar2 /*12*/] == 0)
		{
			iVar1 = iVar2;
		}
		else
	...
	if (func_381(iVar0, &iVar1, 0))
	{
		...
		func_344(28);
		func_344(29);
		func_343(func_446(iParam0));
		func_340();
		func_415(func_297(iVar1), 0, -1, 1);
		func_317(iVar1);
		func_338(iVar1);
		iLocal_577 = 1;
		func_204(2001, "OR_PUR_SUC", "OR_OVRLY_OK", "", -1, 0);
	}
	else
	{
		func_204(0, "BKR_TF_R5", "OR_OVRLY_OK", "", -1, 0);
	}
}
...
{
	Global_1366503 = 0;
	func_415(func_339(iParam0), 0, -1, 1);
	if (iParam0 == 5)
	{
		func_415(15440, 0, -1, 1);
	}
	Global_1366574 = 0;
	func_303(&Global_1366575);
}
...
void func_340()
{
	...
	Global_1366491 = NETWORK::GET_CLOUD_TIME_AS_INT();
}
...
void func_341(int iParam0)
{
	...
	if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iParam0 /*12*/] != 0 && Global_1366484[iParam0] != 0)
	{
		iVar0 = (NETWORK::GET_CLOUD_TIME_AS_INT() - Global_1366484[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
		{
			func_231(func_342(iParam0), iVar0, -1, 1, 0);
		}
	}
}
...
{
	Global_1366484[iParam0] = NETWORK::GET_CLOUD_TIME_AS_INT();
	func_231(func_342(iParam0), 0, -1, 1, 0);
}
...
void func_345(int iParam0)
{
	...
	bVar4 = false;
	sVar5 = ZONE::GET_NAME_OF_ZONE(func_369(iVar0, 0));
	Var6 = { func_368(iVar0, iVar2) };
	iVar7 = func_24();
	iVar8 = 0;
	iVar9 = func_222(iVar0);
	iVar10 = -1;
	iVar11 = func_444(iVar0);
	iVar12 = func_445(PLAYER::PLAYER_ID(), iVar0);
	iVar13 = func_367(PLAYER::PLAYER_ID(), iVar0, iVar12);
	iVar14 = 0;
	iVar15 = 0;
	iVar16 = 0;
	iVar17 = 0;
	...
	{
		iVar8 = func_446(iVar0);
		iVar18 = func_363(func_365(iVar7, iVar8), func_364(iVar7, iVar8));
		iVar21 = func_363(func_361(iVar7, iVar8), func_360(iVar7, iVar8));
		iVar22 = func_363(func_358(iVar7, iVar8), func_357(iVar7, iVar8));
		iVar17 = func_356(iVar7, iVar8);
		iVar15 = func_354(iVar0);
		iVar16 = func_350(iVar8, 0, 1);
		iVar23 = func_350(iVar8, 0, 0);
		iVar24 = func_350(iVar8, 1, 1);
		iVar14 = Global_1366494[iVar8];
		iVar19 = func_13(0, iVar14, 0);
		bVar4 = Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar8 /*12*/].f_4 > 0;
		if (bVar4 || func_349(iVar0))
		{
			bVar25 = true;
		}
	}
	fVar26 = ((SYSTEM::TO_FLOAT(iVar12) / SYSTEM::TO_FLOAT(iVar11)) * 100f);
	iVar27 = SYSTEM::ROUND(fVar26);
	if (iVar14 < 0)
	{
		iVar14 = 0;
	}
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "ADD_BUSINESS");
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "ADD_BUSINESS_STATS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_START_PRODUCTION_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
{
	return func_222(iParam0) < func_347(iParam0);
}
...
int func_349(int iParam0)
{
	...
	iVar0 = func_446(iParam0);
	if ((func_7(PLAYER::PLAYER_ID(), iParam0) && Global_1366494[iVar0] < Global_262145.f_17904) && !func_203(iVar0))
	{
		return 1;
	}
	return 0;
...
int func_350(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		return func_22(func_353(iParam0), -1, 0);
	}
	else if (bParam2)
	{
		return func_22(func_352(iParam0), -1, 0);
	}
	return func_22(func_351(iParam0), -1, 0);
}
...
int func_354(int iParam0)
{
	...
	iVar0 = func_446(iParam0);
	return func_22(func_355(iVar0), -1, 0);
}
...
{
	return (func_358(iParam0, iParam1) + func_361(iParam0, iParam1));
}

int func_357(int iParam0, int iParam1)
{
	return func_22(func_249(iParam1), iParam0, 0);
}

int func_358(int iParam0, int iParam1)
{
	return func_22(func_359(iParam1), iParam0, 0);
}
...
{
	return func_22(func_250(iParam1), iParam0, 0);
}

int func_361(int iParam0, int iParam1)
{
	return func_22(func_362(iParam1), iParam0, 0);
}
...
{
	return func_22(func_330(iParam1), iParam0, 0);
}

int func_365(int iParam0, int iParam1)
{
	return func_22(func_366(iParam1), iParam0, 0);
}
...
Vector3 func_369(int iParam0, int iParam1)
{
	...
	if (iParam1 && !func_370(vVar0[1 /*3*/], 0f, 0f, 0f, 0))
	{
		return vVar0[1 /*3*/];
	}
	return vVar0[0 /*3*/];
...
bool func_370(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_371(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar1 /*12*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		func_231(func_218(iVar0), iParam0, -1, 1, 0);
		func_231(func_219(iVar0), iParam0, -1, 1, 0);
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/] = iParam0;
		if (func_197(iParam0))
		{
			Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_11 = 0;
			func_396(9359, 0, -1, 1);
			func_231(5618, 0, -1, 1, 0);
		}
		func_380(iVar0);
		if (14 == iParam0 && func_226())
		{
			func_372(3, 1);
		}
		if (28 == iParam0 && func_226())
		{
			func_372(1, 1);
		}
	}
...
{
	func_231(func_352(iParam0), 0, -1, 1, 0);
	func_231(func_351(iParam0), 0, -1, 1, 0);
	func_231(func_330(iParam0), 0, -1, 1, 0);
	func_231(func_353(iParam0), 0, -1, 1, 0);
	func_231(func_366(iParam0), 0, -1, 1, 0);
	func_231(func_355(iParam0), 0, -1, 1, 0);
	func_231(func_249(iParam0), 0, -1, 1, 0);
	func_231(func_250(iParam0), 0, -1, 1, 0);
	func_231(func_359(iParam0), 0, -1, 1, 0);
	func_231(func_362(iParam0), 0, -1, 1, 0);
}
...
int func_381(int iParam0, int iParam1, int iParam2)
{
	...
	StringCopy(&cVar3, func_223(iParam0), 16);
	iVar4 = SYSTEM::CEIL((SYSTEM::TO_FLOAT(func_222(iParam0)) * Global_262145.f_78));
	iVar0 = iVar4;
	bVar5 = func_225(iParam0);
	if (bVar5)
	{
		iVar4 = 0;
		iVar0 = 0;
	...
	else
	{
		*iParam1 = func_446(iParam2);
		...
		if (iVar1 > 0)
		{
			...
			{
				func_391(MISC::GET_HASH_KEY(&cVar3), iVar1, 0);
				iLocal_773 = 1;
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", true);
				return 0;
			}
	...
	if (func_25())
	{
		iLocal_771 = 1;
		iLocal_772 = 0;
		iVar6 = func_390(iParam0, 0);
		iVar7 = func_389(*iParam1);
		iVar8 = 0;
		if (bVar5)
		{
			iVar6 = func_390(iParam0, 1);
		}
		if (iParam2 != 0 && iParam2 != 32)
		{
			bVar9 = false;
			...
			iVar8 = func_390(iParam2, bVar9);
		}
		iVar10 = -1;
		while (func_388(&iVar10, iVar4, *iParam1, -1616616027, 235173372, iVar6, iVar7, iVar2, iVar8))
		{
			func_402();
			SYSTEM::WAIT(0);
		}
	...
	vVar11.x = MISC::GET_HASH_KEY(func_223(iParam0));
	vVar11.y = func_27(iParam0);
	vVar11.z = -1;
	if (iVar1 > 0)
	{
		func_383(joaat("MPPLY_INGAMESTORE_MONEYSPENT"), iVar1);
	}
	iParam2 = func_202(PLAYER::PLAYER_ID(), *iParam1);
	func_382(*iParam1, iVar4);
	if (iParam2 == 0 || iParam2 == 32)
	{
		if (func_25())
		{
		...
		MONEY::_0x6FD97159FE3C971A(iVar4, &vVar11, 0, 1);
	}
	else
	{
		if (iVar2 > 0)
		{
			...
			MONEY::NETWORK_EARN_FROM_PROPERTY(iVar2, MISC::GET_HASH_KEY(func_223(iParam2)));
		}
		if (iVar4 > 0)
		{
			if (func_25())
			...
			MONEY::_0xA51B086B0B2C0F7A(iVar4, &vVar11, 0, 1);
		}
	}
	if (func_25())
	{
...
{
	func_231(func_217(iParam0), iParam1, -1, 1, 0);
}
...
int func_388(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	...
	if (iLocal_771)
	{
		switch (iLocal_772)
		{
			case 0:
				...
				if (func_278(78225582, iParam3, iParam5, iParam4, 1, iParam1, uParam2, 4, iParam6, 3))
				{
					...
					if (iParam8 != 0)
					{
						if (func_278(78225582, iParam3, iParam8, iParam4, 1, iParam7, 1, 4, iParam6, 3))
						{
						}
						else
						{
...
int func_390(int iParam0, bool bParam1)
{
	...
	func_224(&sVar0, iParam0, bParam1);
	return MISC::GET_HASH_KEY(&sVar0);
}
...
void func_393(int iParam0)
{
	...
	iVar0 = func_27(iParam0);
	iVar1 = func_220(PLAYER::PLAYER_ID(), iVar0);
	if (func_381(iParam0, &uVar2, iVar1))
	{
		func_394(iParam0, iVar1);
		func_345(iVar1);
		func_345(iParam0);
		iLocal_580 = 1;
		iLocal_577 = 1;
...
void func_394(int iParam0, int iParam1)
{
	...
	if (func_395(iParam0, iParam1))
	{
		...
		func_321(iVar0, 0);
		func_231(func_322(iVar0), 0, -1, 1, 0);
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_1 = 0;
		func_231(func_323(iVar0), 0, -1, 1, 0);
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_4 = 0;
		func_396(func_324(iVar0), 0, -1, 1);
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_5 = 0;
		func_231(func_290(iVar0, 2), 0, -1, 1, 0);
		func_231(func_290(iVar0, 0), 0, -1, 1, 0);
		func_231(func_290(iVar0, 1), 0, -1, 1, 0);
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_6 = 0;
		func_415(func_269(iVar0), 0, -1, 1);
		if (iVar0 != 5)
		{
			func_380(iVar0);
		}
		Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_8 = 0;
		func_415(func_318(iVar0), 0, -1, 1);
		if (func_197(iParam0))
		{
			Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_11 = 0;
...
int func_400()
{
	if (!iLocal_582 && func_397(9356, -1, -1) < 3)
	{
		return 1;
	}
	return 0;
...
void func_401()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_583 = 1;
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_583 = 1;
		}
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
		if (((iLocal_587 == 1 || iLocal_587 == -1) || iLocal_587 == 4) || iLocal_587 == 5)
		{
			if (!iLocal_581)
			{
				func_495(0);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_MOUSE_INPUT");
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_762, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
			if ((iLocal_587 == 1 || iLocal_587 == -1) || iLocal_587 == 4)
			{
				if (!iLocal_581)
				{
					func_495(0);
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_767 != 127) || iVar1 != 127) || iLocal_768 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_ANALOG_STICK_INPUT");
			iLocal_767 = iVar0;
			iLocal_768 = iVar1;
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_767);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_768);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			iLocal_583 = 1;
		}
	}
	...
	if (((iVar2 != 127 || iLocal_769 != 127) || iVar3 != 127) || iLocal_770 != 127)
	{
		...
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_769);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_770);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		if (!bVar4)
		{
...
void func_402()
{
	...
	func_411(0f, 0f, 1f, 1f, 0, 0, 0, 255);
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_762, 255, 255, 255, 255, 0);
	func_409();
	func_406(0);
	func_403(1);
...
void func_411(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_415(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_416()
{
	return func_417(&uLocal_597, "BPLESAU", "BPLES_TUT1", 8, 0, 0, 0);
}

int func_417(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	Global_21802 = 0;
	Global_2621441 = 0;
	return func_418(sParam2, iParam3, 0);
}

int func_418(char* sParam0, int iParam1, bool bParam2)
{
	Global_20806 = 0;
...
void func_428()
{
	...
	{
		if (func_431(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_430(PLAYER::PLAYER_PED_ID());
			if (func_429(iVar0) && (!func_433(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_429(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_437(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
{
	if (func_439(Global_1590446[iParam0 /*871*/].f_273.f_26, -1) && !MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_24, 1))
	{
		return 1;
	}
	return 0;
...
float func_441(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
{
	func_450(1);
	func_449(&uLocal_597, 2, 0, "LJT", 0, 1);
}

void func_449(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_454()
{
	...
	if (func_471())
	{
		...
		iVar0 = func_446(iLocal_591);
		iVar1 = iLocal_591;
		iVar2 = func_27(iLocal_591);
		func_345(iVar1);
		if (!func_17(iLocal_591))
		{
			iVar3 = func_367(PLAYER::PLAYER_ID(), iLocal_591, func_445(PLAYER::PLAYER_ID(), iLocal_591));
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18582);
			iVar5 = SYSTEM::ROUND(fVar4);
			func_461(func_251(iLocal_591), &cVar7, &sVar6);
			func_460(iVar1, 1, &sVar6, &cVar7, iVar5, 1);
			func_461(!func_251(iLocal_591), &cVar7, &sVar6);
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18583);
			iVar5 = SYSTEM::ROUND(fVar4);
			func_460(iVar1, 2, &sVar6, &cVar7, iVar5, 1);
		}
		iVar8 = 0;
		while (iVar8 < 12)
		{
			iVar9 = iVar8;
			bVar10 = true;
			Var11 = { func_459(iVar2, iVar9) };
			if (func_28(PLAYER::PLAYER_ID(), iLocal_591, iVar9) || Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_4 <= 0)
			{
				bVar10 = false;
			}
			iVar12 = func_19(iVar9, iLocal_591);
			iVar13 = -1;
			if (func_458(iLocal_591, iVar9) && bVar10)
			{
				iVar13 = iVar12;
				iVar12 = func_457(iVar9, iLocal_591);
			}
			func_455(iVar1, iVar8 + 1, func_456(iVar9), iVar12, iVar13, bVar10, &Var11);
			iVar8++;
		}
	}
	else
...
void func_455(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, char* sParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "ADD_BUSINESS_UPGRADE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_BUSINESS_UPGRADE_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
...
{
	return func_19(iParam1, iParam0) < func_457(iParam1, iParam0);
}

struct<4> func_459(int iParam0, int iParam1)
{
	struct<4> Var0;
...
void func_460(int iParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, bool bParam5)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "ADD_BUSINESS_BUYER");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam2);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam3);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_BUSINESS_BUYER_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bParam5);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_461(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
...
void func_462(bool bParam0)
{
	...
	sVar0 = func_464(PLAYER::PLAYER_ID());
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		sVar0 = func_463();
	}
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_762, "SET_PLAYER_DATA");
...
{
	if (((func_34(iParam0, 28) || func_34(PLAYER::PLAYER_ID(), 28)) || func_470(iParam0)) && !func_468(iParam0))
	{
		return func_463();
	}
	if (iParam0 != PLAYER::PLAYER_ID())
	...
	if (func_466(iParam0, 1))
	{
		if (func_64(iParam0))
		{
			return func_465(&(Global_1628955[iParam0 /*614*/].f_11.f_104));
		}
		else
		{
			return func_465(&(Global_1628955[iParam0 /*614*/].f_11.f_376));
		}
	}
	else
	{
...
{
	return func_467(iParam0, bParam1, 1);
}
...
void func_472(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_260(PLAYER::PLAYER_ID(), 0) && !func_480()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_476(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_476(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					...
					if (func_473(Global_4456448.f_190930))
					{
...
void func_477(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (iVar0 == 0)
	{
		...
		func_478(joaat("MPPLY_IS_CHAR_SPECTATING"), bParam0);
	}
}
...
int func_485(int iParam0)
{
	if (func_487(iParam0))
	{
		return func_486(Global_2424073[iParam0 /*421*/].f_309.f_5);
	}
	return 0;
}
...
int func_487(int iParam0)
{
	if (iParam0 != func_5())
	{
		if (func_262(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_287(Global_2424073[iParam0 /*421*/].f_309.f_5) == 2;
			}
		}
	}
	return 0;
...
void func_495(int iParam0)
{
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_762);
	func_488(iParam0);
	func_490(0);
	func_499();
	...
	if (!func_487(PLAYER::PLAYER_ID()))
	{
		func_472(PLAYER::PLAYER_ID(), 1, 0, 0);
	}
	if (func_451(7638, -1, -1) && func_498())
	{
		Var0 = { func_497() };
