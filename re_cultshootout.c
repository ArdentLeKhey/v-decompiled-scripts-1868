...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_60) || (func_111() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_46, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_111())
			{
				if (func_110())
...
void func_1()
{
	...
	if (SYSTEM::VDIST(func_2(PLAYER::PLAYER_ID()), vLocal_46) > 150f)
	{
		func_142();
	}
}
...
{
	Global_111560.f_24990.f_7 = iParam0;
}
	...
	switch (iLocal_45)
	{
		case 0:
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_65))
			{
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
					{
						func_67();
						if (!bLocal_61)
						{
		...
		case 1:
			...
			else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_46, 100f, 100f, 100f, false, true, 0))
			{
				func_25();
			}
			break;
...
void func_44()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_48(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(iVar0) && (!func_45(14) || Global_110511))
			{
...
int func_58(int iParam0)
{
	if (func_61())
	{
		...
		if (func_38(Global_111549))
		{
			func_59(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_38(Global_111549))
		{
...
int func_61()
{
	switch (func_62(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_65(iParam0, Global_41396);
}
			...
			switch (iLocal_73)
			{
					...
					if (!iLocal_56[iLocal_71])
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_63[iLocal_71])) || PED::CAN_PED_SEE_HATED_PED(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								...
								{
									PED::_0xF1C03A5352243A30(iLocal_63[iLocal_71]);
				...
				case 1:
					...
					if (iLocal_56[iLocal_71])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_93();
								SYSTEM::WAIT(0);
								if (func_92())
							...
							else
							{
								if (!PED::IS_PED_IN_COMBAT(iLocal_63[iLocal_71], 0))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_63[0]))
									{
										...
										TASK::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
...
bool func_92()
{
	return Global_111560.f_24990.f_7;
}
...
int func_95()
{
	...
	if (FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, vLocal_49, vLocal_50, fLocal_51))
	{
		return 1;
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
...
void func_96()
{
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_46 - Vector(20f, 50f, 50f), vLocal_46 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("BOBCATXL"), true);
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		MISC::ENABLE_DISPATCH_SERVICE(3, false);
		iLocal_64[0] = VEHICLE::CREATE_VEHICLE(joaat("BOBCATXL"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, true, true, false);
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_64[0], true, 0);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_64[0], 1084227584);
		VEHICLE::SET_VEHICLE_EXTRA(iLocal_64[0], 1, true);
		iLocal_64[1] = VEHICLE::CREATE_VEHICLE(joaat("BOBCATXL"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, true, true, false);
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_64[1], true, 0);
		VEHICLE::SET_VEHICLE_EXTRA(iLocal_64[1], 1, false);
		iVar0 = 0;
		MISC::SET_BIT(&iVar0, 1);
		iLocal_65 = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_MONEY_CASE"), vLocal_47, -1.368082f, 0.230633f, 176.8749f, iVar0, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_69, 1862763509);
		iLocal_71 = 0;
		while (iLocal_71 < 6)
		{
			iLocal_63[iLocal_71] = PED::CREATE_PED(26, joaat("g_m_y_salvagoon_01"), vLocal_48[iLocal_71 /*3*/], fLocal_52[iLocal_71], 1, true);
...
int func_111()
{
	if ((Global_111549 == func_53() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
int func_115(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_136(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_130()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_134()) || Global_30738) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_129()) || func_128()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_134()) || func_131()) || Global_110607) || Global_30738) || func_133()) || Global_42561) || func_88(8, -1)) || func_130()) || func_128()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_143(int iParam0)
{
	...
	if (func_111())
	{
		...
		func_146(30000);
		StringCopy(&cVar0, func_145(Global_111549, 1), 64);
		if (func_52(Global_111549) > 0)
		{
