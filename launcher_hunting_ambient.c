...
void __EntryFunction__()
{
	...
	iLocal_81 = 18;
	bLocal_85 = true;
	vLocal_56 = { ScriptParam_93.f_1[0 /*3*/] };
	vLocal_56 = { vLocal_56 };
	uLocal_54 = uLocal_54;
	Local_52 = { Local_52 };
	bVar0 = false;
	...
	iLocal_59 = 0;
	func_91(&Global_110211, 0);
	func_88();
	if (func_87(uLocal_58, 1))
	{
		iLocal_64 = 10;
	}
	else
	...
	if (!func_87(uLocal_58, 8))
	{
		if (!func_85(iLocal_64))
		{
			if (func_84(0, iLocal_63))
			{
				func_93(0);
			}
			else
	...
	if (func_87(uLocal_58, 8388608))
	{
		func_93(1);
	}
	if (func_87(uLocal_58, 524288) && (func_83() && !func_82()))
	{
		func_93(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_87(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			func_81(iLocal_69, 1, 0);
			iLocal_69 = 263;
		}
		func_80(10);
	}
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(vLocal_55, ScriptParam_93.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			vLocal_75 = { vLocal_55 };
			vLocal_76 = { ScriptParam_93.f_1[0 /*3*/] };
			vLocal_75.z = 0f;
			vLocal_76.z = 0f;
			...
			{
				case 0:
					if (func_85(iLocal_64) || (func_87(uLocal_58, 16) && !func_87(uLocal_58, 524288)))
					{
						iLocal_62 = -1;
						func_79();
						func_80(1);
					...
					else
					{
						...
						if ((vLocal_55.z - ScriptParam_93.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (fLocal_74 > (fLocal_66 * fLocal_66) && !Global_98703)
					{
						if (iLocal_69 != 263)
						{
							if (func_75(6) && !func_74(iLocal_69))
							{
							}
							else
							{
					...
					{
						Local_52 = { Local_51 };
						bVar2 = !func_87(uLocal_58, 64);
						func_91(&uLocal_58, 128);
						if (!func_73(3) && !Global_98703)
						{
							if (func_87(uLocal_58, 2097152))
							{
								if ((!func_87(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_72())) && !Global_98703)
								{
									func_80(10);
									break;
								}
						...
						if ((!func_62(6) || Global_110607) || func_61())
						{
							bVar2 = false;
						}
						if (!bLocal_78)
						{
							func_59(&uLocal_58, 128);
							bVar2 = false;
						}
						if (func_87(uLocal_58, 1))
						{
						...
						if (bVar2)
						{
							if (!func_46(iLocal_79))
							{
								func_59(&uLocal_58, 128);
								bVar2 = false;
							}
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_93.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, false, true, iLocal_67))
							{
								bVar2 = false;
							}
							...
							if (iLocal_80 > iLocal_81)
							{
								if (iVar3 < iLocal_80 && iVar3 >= iLocal_81)
								{
									...
									{
										if (!func_87(uLocal_58, 134217728))
										{
											func_45("MG_NA_TIME", iLocal_80, iLocal_81);
											func_59(&uLocal_58, 134217728);
										}
									}
									else
									{
										func_91(&uLocal_58, 134217728);
									}
								}
							}
							else if (iVar3 < iLocal_80 || iVar3 >= iLocal_81)
							{
								func_59(&uLocal_58, 128);
								bVar2 = false;
								if (fLocal_57 < ((fLocal_77 * fLocal_77) + 4f))
							...
							if (bVar2)
							{
								...
								if (func_44(uLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_43(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_59(&uLocal_58, 2048);
									}
									else if (!func_87(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_42(&iLocal_60);
										func_91(&uLocal_58, 2048);
									}
									if (func_40(iLocal_60, 1))
									{
										sLocal_65 = sLocal_65;
										func_42(&iLocal_60);
										func_91(&uLocal_58, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar4 != 1)
						{
							iVar4 = func_35(&iLocal_62, 6, iLocal_64, 0, 0);
						}
						if (iVar4 == 1)
						{
				...
				case 6:
					if (!func_87(uLocal_58, 256))
					{
						...
						{
							func_59(&uLocal_58, 256);
						}
					}
					if (func_87(Global_110211, 262144))
					{
						func_91(&Global_110211, 262144);
						func_13();
					}
					if (func_87(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						else if (func_87(uLocal_58, 2))
						{
							if (func_87(Global_110211, 0))
							{
								func_6(&iLocal_62);
								iLocal_62 = -1;
								func_91(&uLocal_58, 2);
					...
					if ((iLocal_68 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_70 == 2)
							{
								if (iLocal_70 == 2)
								{
									if (func_85(iLocal_64) && func_84(0, iLocal_63))
									{
										func_88();
										if (iLocal_69 != 263)
										{
...
int func_24()
{
	...
	vVar0.y = iLocal_84;
	vVar0.z = iLocal_83;
	iVar1 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &vVar0, 3, iLocal_61);
...
void func_38()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_84) && !ENTITY::IS_ENTITY_DEAD(iLocal_84, 0)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_84))
	{
		...
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(iLocal_84, true);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_84, false, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_84, 1);
		iLocal_82 = iLocal_84;
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_83) && !ENTITY::IS_ENTITY_DEAD(iLocal_83, 0))
		{
			VEHICLE::SET_VEHICLE_UNDRIVEABLE(iLocal_83, true);
			VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_83, 1);
			VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_83, false, 0);
	...
	else if ((iLocal_88 && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterIntro")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterOutro"))
	{
		STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterIntro");
		STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterOutro");
		iLocal_88 = 0;
...
void func_47()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_50(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_48(iVar0) && (!func_75(14) || Global_110511))
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_69()) || Global_110607) || Global_30738) || func_68()) || func_54(8, -1)) || func_67()) || func_66()) || func_65()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_69()) || Global_30738) || func_68()) || func_54(8, -1)) || func_65()) || func_67()) || func_66()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_69()) || Global_110607) || Global_30738) || func_68()) || func_54(8, -1)) || func_65()) || func_67()) || func_66()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_69()) || Global_110607) || Global_30738) || func_68()) || func_54(8, -1)) || func_67()) || func_66()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_69() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_54(8, -1)) || func_56()) || func_64()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_69()) || Global_30738) || func_68()) || func_54(8, -1)) || func_66()) || func_65()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_69()) || func_66()) || Global_110607) || Global_30738) || func_68()) || Global_42561) || func_54(8, -1)) || func_65()) || func_64()) || func_56()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_69()) || Global_110607) || Global_30738) || func_68()) || func_54(8, -1)) || func_65()) || func_64()) || func_67()) || func_66()) || func_56())
						{
							return 0;
						}
						break;
...
void func_77()
{
	if (bLocal_85)
	{
		...
		if (!iLocal_87)
		{
			MISC::CLEAR_AREA_OF_VEHICLES(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, false, 0);
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_83))
			{
...
{
	return func_86(iParam0, Global_41396);
}
...
void func_88()
{
	...
	fLocal_77 = 2f;
	iLocal_69 = 69;
	fLocal_66 = (SYSTEM::TO_FLOAT(func_90(iLocal_69)) + 5f);
	if (!func_84(0, 3))
	{
		func_89(iLocal_69);
		bLocal_85 = false;
