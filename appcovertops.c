...
void __EntryFunction__()
{
	...
	while (func_196())
	{
		...
		func_175();
		func_43();
		if (!MISC::IS_BIT_SET(iLocal_216, 3))
		{
			func_37();
			func_11();
		}
...
void func_1()
{
	if (((!MISC::IS_BIT_SET(iLocal_216, 7) && !MISC::IS_BIT_SET(iLocal_216, 6)) && iLocal_226 == 1) && !func_10())
	{
		if (!func_9())
		{
...
{
	if (func_13(&uLocal_232, "GNRCAUD", func_36(iParam0), 8, 0, 0, 0))
	{
		iLocal_219 = -1;
	}
}
...
void func_26()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_29(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_27(iVar0) && (!func_31(14) || Global_110511))
			{
...
void func_37()
{
	...
	if ((!MISC::IS_BIT_SET(iLocal_216, 4) && !func_10()) && iLocal_226 == 1)
	{
		if (!MISC::IS_BIT_SET(iLocal_216, 5))
		{
			if (!func_5(15378, -1, -1))
			{
				bVar0 = true;
	...
	if (bVar0)
	{
		MISC::SET_BIT(&iLocal_216, 4);
	}
	else if (MISC::IS_BIT_SET(iLocal_216, 4))
	{
		if (!func_42(&uLocal_230))
		{
			func_41(&uLocal_230, 0, 0);
		}
		else if (func_40(&uLocal_230, iLocal_218, 0))
		{
			MISC::CLEAR_BIT(&iLocal_216, 4);
			iLocal_218 = 0;
			func_39(&uLocal_230);
			if (func_38())
			{
				MISC::SET_BIT(&iLocal_216, 3);
			}
		}
	}
}
...
int func_38()
{
	if ((func_5(15378, -1, -1) || MISC::IS_BIT_SET(iLocal_216, 5)) && func_5(15379, -1, -1))
	{
		return 1;
	}
	return 0;
...
void func_43()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_398) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_399))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_398);
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_399);
			switch (iVar0)
			{
				case 102:
...
{
	if (iLocal_217 != func_47(iParam0))
	{
		iLocal_217 = func_47(iParam0);
	}
}
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "SHOW_OVERLAY");
	func_50(sParam0);
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_55(iParam1)];
...
{
	return iLocal_220 >= func_58(iParam0);
}
...
void func_60()
{
	switch (func_171())
	{
		case 1:
			...
			func_61(&(Global_2448961.f_680), iLocal_217, 1);
			func_245(0, 0);
			break;
...
int func_61(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_170(iParam2);
	if (iParam1 != -1)
	{
		iVar0 = iParam1;
	}
	if (iVar0 < func_169(iParam2))
	{
		iVar1 = func_167(iVar0, iParam2);
		if (iVar1 != -1)
		{
			func_165(&(Global_794709.f_4[iVar1 /*88*/]));
			func_164();
			switch (iParam2)
			{
				case 0:
				...
				case 2:
					func_162(PLAYER::PLAYER_ID(), 0);
					if (func_160(Global_794709.f_107189[iVar1 /*13*/].f_1))
					{
						func_163(235);
					}
					else
					...
					func_157(func_159(PLAYER::PLAYER_ID()));
					break;
			}
			func_156(Global_794709.f_4[iVar1 /*88*/].f_71);
			func_154();
			func_153();
			func_152();
			func_151();
			...
			func_142(func_143(), 0, 0, 0);
			func_63(uParam0, 0, 0, 0f, 0f, 0f, &uVar2, 0f, 0f, 0f, 1, 0, &uVar2, &iVar3, iVar3, 0, 0, 1, 0, 0, 0);
...
void func_63(var uParam0, int iParam1, int iParam2, vector3 vParam3, var uParam4, vector3 vParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	func_134(uParam0, iParam1, 1, iParam10, 1);
	...
	if (func_120(iParam1))
	{
		*uParam4 = { func_119(iParam1, iParam2) };
		vVar1 = { func_118(iParam1, iParam2) };
		fVar2 = func_117(iParam1, iParam2);
	}
	if (!func_116(*uParam4))
	{
		vVar0 = { *uParam4 };
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_116(vVar0))
		{
			if (func_132(PLAYER::PLAYER_ID(), 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_113()) && !ENTITY::IS_ENTITY_DEAD(func_113(), 0))
				{
					vVar0 = { ENTITY::GET_ENTITY_COORDS(func_113(), true) };
					vVar1 = { 0f, 0f, ENTITY::GET_ENTITY_HEADING(func_113()) };
					if (func_112(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_735, 1, 0))
					{
			...
			if ((func_111(PLAYER::PLAYER_ID()) || func_109(PLAYER::PLAYER_ID())) && func_108())
			{
	...
	else if (func_107(Global_4456448.f_154360) || iParam14)
	{
	...
	else if (func_105(Global_4456448.f_154360) || iParam13)
	{
		vVar0 = { 347.2638f, 4867.324f, -59.2679f };
		vVar1 = { 1.2933f, 0.0747f, -34.6934f };
		fVar2 = 50f;
	}
	else if (iParam16 || func_104(Global_4456448.f_154360))
	{
	...
	{
		func_97();
		func_96(&vVar3, 144, Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26);
		if (!func_116(vVar3))
		{
			vVar0 = { vVar3 };
		}
		func_90(&vVar3, 144, Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26);
		vVar1 = { vVar3 };
	}
	...
	if (func_131() && !bParam11)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				func_77(PLAYER::PLAYER_ID(), 0, 4, 0);
	...
	func_64(func_131(), ((iParam12 || iParam13) || iParam14));
}
...
void func_64(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_65())
			{
				func_77(PLAYER::PLAYER_ID(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_77(PLAYER::PLAYER_ID(), 0, 319492, 0);
			}
		}
		else
		{
			func_77(PLAYER::PLAYER_ID(), 0, 57348, 0);
		}
	}
}
...
int func_70()
{
	if (func_132(PLAYER::PLAYER_ID(), 0))
	{
		if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_735 != func_19())
		{
			if (func_71(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_735, 0, 1))
			{
				if (func_112(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_735, 1, 0))
				{
					return 0;
...
void func_77(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_132(PLAYER::PLAYER_ID(), 0) && !func_85()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_81(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_81(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					...
					if (func_78(Global_4456448.f_190930))
					{
...
void func_82(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		func_83(joaat("MPPLY_IS_CHAR_SPECTATING"), bParam0);
	}
}
...
int func_90(var uParam0, int iParam1, int iParam2)
{
	struct<4> Var0;
	...
	switch (iParam2)
	{
		...
		case 42:
		case 43:
			func_91(iParam2, iParam1, &Var0, -1, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
		...
		case 64:
		case 65:
			func_91(iParam2, iParam1, &Var0, 61, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
		...
		case 84:
		case 85:
			func_91(iParam2, iParam1, &Var0, 83, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
		...
		case 81:
		case 82:
			func_91(iParam2, iParam1, &Var0, 77, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
		...
		case 75:
		case 76:
			func_91(iParam2, iParam1, &Var0, 73, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
		...
		case 89:
		case 90:
			func_91(iParam2, iParam1, &Var0, 88, 0);
			*uParam0 = { Var0.f_3 };
			return 1;
			return 0;
	}
...
void func_91(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<6> Var0[2];
	vector3 vVar1;
	
	Var0[0 /*6*/] = { func_95(iParam3, bParam4) };
	Var0[1 /*6*/] = { func_95(iParam0, bParam4) };
	*uParam2 = { func_93(iParam1, iParam3) };
	vVar1 = { *uParam2 - Var0[0 /*6*/] };
	vVar1 = { func_92(vVar1, -Var0[0 /*6*/].f_3.f_2) };
	vVar1 = { func_92(vVar1, Var0[1 /*6*/].f_3.f_2) };
...
Vector3 func_92(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_93(var uParam0, int iParam1)
{
	struct<6> Var0;
	var uVar1;
	int iVar2;
...
struct<6> func_95(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
int func_96(var uParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		...
		case 42:
		case 43:
			func_91(iParam2, iParam1, &vVar0, -1, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 64:
		case 65:
			func_91(iParam2, iParam1, &vVar0, 61, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 84:
		case 85:
			func_91(iParam2, iParam1, &vVar0, 83, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 81:
		case 82:
			func_91(iParam2, iParam1, &vVar0, 77, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 75:
		case 76:
			func_91(iParam2, iParam1, &vVar0, 73, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 89:
		case 90:
			func_91(iParam2, iParam1, &vVar0, 88, 0);
			*uParam0 = { vVar0 };
			return 1;
			return 0;
	}
...
int func_101()
{
	...
	if (!func_99() && !((Global_1670925 || Global_1312791) && func_102()))
	{
		return 0;
	}
	return 1;
...
int func_109(int iParam0)
{
	if (iParam0 != func_19())
	{
		if (func_71(iParam0, 1, 1))
		{
			...
			{
				return func_110(Global_2424073[iParam0 /*421*/].f_309.f_5) == 6;
			}
		}
	}
	return 0;
...
int func_111(int iParam0)
{
	if (iParam0 != func_19())
	{
		if (func_71(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_19())
			{
				return func_110(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
var func_113()
{
	if (ENTITY::DOES_ENTITY_EXIST(func_115()))
	{
		return func_115();
	}
	return func_114();
...
{
	if (!GRAPHICS::ANIMPOSTFX_IS_RUNNING(func_122(0)))
	{
		GRAPHICS::ANIMPOSTFX_PLAY(func_122(iParam0), 0, 1);
	}
}

char* func_122(int iParam0)
{
	if (iParam0 || func_98(134))
	{
	...
	if (func_124(Global_4456448.f_190930))
	{
		return "MenuMGRemixIn";
	}
	if (func_123(Global_4456448.f_190930) && MISC::IS_BIT_SET(Global_4456448.f_192215.f_2808, 2))
	{
...
{
	if ((((func_129(iParam0) || func_128(iParam0)) || func_127(iParam0)) || func_126(iParam0)) || func_125(iParam0))
	{
		return 1;
	}
	return 0;
...
void func_134(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
int func_146()
{
	...
	return func_147(func_149());
}

int func_147(int iParam0)
{
	if (func_148(iParam0) == func_19())
	{
		return 0;
	}
...
void func_157(struct<13> Param0)
{
	if (func_158(Param0))
	{
...
int func_160(int iParam0)
{
	...
	while (iVar0 < 16)
	{
		if (func_161(iVar0) && Global_262145.f_5008[iVar0] == iParam0)
		{
			return 1;
		}
		iVar0++;
...
int func_167(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return func_168(Global_262145.f_4990[iParam0]);
			break;
		
		case 1:
			return func_168(Global_262145.f_4999[iParam0]);
			break;
		
		case 2:
			return func_168(Global_262145.f_5008[iParam0]);
			break;
	}
	return -1;
}
...
void func_172()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_49(0);
	MISC::CLEAR_BIT(&iLocal_216, 1);
}
...
void func_173()
{
	if (func_174())
	{
		if (!MISC::IS_BIT_SET(iLocal_216, 0))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "GET_CURRENT_SELECTION");
			iLocal_398 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "GET_CURRENT_SCREEN_ID");
			iLocal_399 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_175()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	PAD::ENABLE_CONTROL_ACTION(2, 189, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_226 == 0 || iLocal_226 == 1)
		{
			if (!func_176())
			{
				func_245(1, 0);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_400 != 127) || iVar1 != 127) || iLocal_401 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "SET_ANALOG_STICK_INPUT");
			iLocal_400 = iVar0;
			iLocal_401 = iVar1;
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_400);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_401);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
	...
	if (((iVar2 != 127 || iLocal_402 != 127) || iVar3 != 127) || iLocal_403 != 127)
	{
		...
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_402);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_403);
...
bool func_176()
{
	return MISC::IS_BIT_SET(iLocal_216, 1);
}
...
void func_177()
{
	...
	func_188(0f, 0f, 1f, 1f, 0, 0, 0, 255);
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
...
void func_188(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_192()
{
	...
	else if (func_193(PLAYER::PLAYER_ID()))
	{
		func_245(0, 0);
	}
}
...
int func_194(int iParam0)
{
	if (iParam0 != func_19())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_71(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
{
	func_192();
	iLocal_397 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("COVERT_OPS");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_397))
	{
		SYSTEM::WAIT(0);
	}
	MISC::SET_BIT(&iLocal_216, 7);
	func_181(1);
	func_243(1);
	func_242();
	HUD::THEFEED_PAUSE();
	func_241(1);
	func_77(PLAYER::PLAYER_ID(), 0, 0, 0);
...
void func_199()
{
	...
	{
		func_201(1);
		func_200(&uLocal_232, 2, 0, "AGENT14", 0, 1);
	}
}
...
void func_202()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "SET_PLAYER_DATA");
...
void func_203(int iParam0)
{
	...
	iLocal_220 = func_239(func_4(), 5);
	iVar1 = func_167(func_47(iParam0), 1);
	iVar2 = func_58(iParam0);
	bVar3 = iLocal_220 >= iVar2;
	sVar4 = func_238(&(Global_73840[func_47(iParam0) /*6*/]));
	fVar5 = 0f;
	fVar6 = 0f;
	if (bVar3)
	{
	...
	{
		MISC::CLEAR_BIT(&iLocal_216, 7);
	}
	if (iVar1 != -1)
	{
		if (!func_235())
		{
			while (!func_231(Global_794709.f_4[iVar1 /*88*/].f_54))
			{
				if (!func_42(&uLocal_228))
				{
					func_41(&uLocal_228, 0, 0);
				}
				else if (func_40(&uLocal_228, 750, 0))
				{
					iVar1 = -1;
				}
				else
			...
			if (iVar1 != -1)
			{
				func_204(&fVar5, &fVar6, 0, 9, 0, 0, MISC::GET_HASH_KEY(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_397, "ADD_MISSION");
	...
	if (iVar1 != -1)
	{
		...
		while (iVar0 < 8)
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_222[iVar0 /*16*/]));
			iVar0++;
		}
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}
...
void func_204(float fParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_209(iParam2, iParam3, 0, iParam4, iParam5);
	iVar1 = func_208(iParam6);
	func_205(iVar0, iVar1, joaat("XP_MULTIPLIER"), fParam0, 1);
	func_205(iVar0, iVar1, joaat("CASH_MULTIPLIER"), fParam1, 1);
}

void func_205(int iParam0, int iParam1, int iParam2, var uParam3, bool bParam4)
{
	func_206(0, iParam2, uParam3, bParam4);
	if (iParam0 == 0)
	{
		return;
	}
	switch (iParam0)
	{
		...
		case 24:
		case 25:
			func_206(1, iParam2, uParam3, bParam4);
			if (iParam0 == 1)
			{
				return;
			}
			switch (iParam0)
			{
				...
				case 4:
				case 5:
					func_206(2, iParam2, uParam3, bParam4);
					if (iParam0 == 2)
					{
						return;
					}
					switch (iParam0)
					{
						...
						case 4:
						case 5:
							func_206(iParam0, iParam2, uParam3, bParam4);
							return;
				...
				case 24:
				case 25:
					func_206(6, iParam2, uParam3, bParam4);
					if (iParam0 == 6)
					{
						return;
					}
					switch (iParam0)
					{
						...
						case 23:
						case 25:
							func_206(15, iParam2, uParam3, bParam4);
							if (iParam0 == 15)
							{
								if (iParam1 != 27)
								{
						...
						case 13:
						case 14:
							func_206(8, iParam2, uParam3, bParam4);
							if (iParam0 == 8)
							{
								if (iParam1 != 27)
								{
...
int func_209(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_210(iParam3, iParam4))
			{
				return 25;
			}
			else if (iParam1 == 0)
...
int func_210(int iParam0, int iParam1)
{
	...
	if ((((((((((((((((((((func_230(iParam0) || func_229(iParam0)) || func_228(iParam0)) || func_227(iParam0, 1)) || func_226(iParam0)) || func_225(iParam0)) || func_224(iParam0)) || func_223(iParam0)) || func_222(iParam0)) || func_221(iParam0)) || func_220(iParam0)) || func_219(iParam0)) || func_218(iParam0)) || func_217(iParam0)) || func_216(iParam0)) || func_215(iParam0)) || func_214(iParam0)) || func_213(iParam0)) || func_212(iParam0)) || func_211(iParam1)) || func_126(iParam1))
	{
		return 1;
	}
	return 0;
...
bool func_231(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (iVar6 < 8)
		{
			StringCopy(&(Local_222[iVar6 /*16*/]), "", 64);
			iVar6++;
		}
		sVar2 = func_232(iParam0, 500);
		...
		while (!bVar7)
		{
			...
			{
				StringCopy(&(Local_222[iVar5 /*16*/]), HUD::_GET_TEXT_SUBSTRING_SAFE(sVar2, iVar3, iVar4, 63), 64);
				iVar3 = (iVar3 + HUD::GET_LENGTH_OF_LITERAL_STRING(&(Local_222[iVar5 /*16*/])));
				iVar5++;
			}
		}
	}
...
var func_232(int iParam0, int iParam1)
{
	if (iParam0 == -1)
	{
		return func_233();
...
{
	return func_54(func_240(iParam1), iParam0, 0);
}
...
void func_245(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		func_77(PLAYER::PLAYER_ID(), 1, 0, 0);
	}
	HUD::THEFEED_RESUME();
