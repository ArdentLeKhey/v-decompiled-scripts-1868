...
void func_21(char* sParam0)
{
	...
	*sParam0 = { Var0 };
	...
	StringIntConCat(sParam0, iLocal_225[func_22()], 16);
}
...
void func_104()
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_208, 0))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_208, "MAG_2_RAGE_PED_GROUP", 0);
	}
}
...
void func_105()
{
	...
	StringCopy(&Local_204, "PBSH", 8);
	StringCopy(&Local_205, "IMPORAGE", 16);
	...
	iLocal_218 = 15;
	iLocal_219 = 6;
	sLocal_226 = "PBSH_INTERACT";
	StringCopy(&Local_231, "PBSH_CONV_M1", 16);
	StringCopy(&Local_232, "PBSH_CONV_T1", 16);
	StringCopy(&Local_233, "PBSH_CONV_F1", 16);
	StringCopy(&cLocal_234, "special_ped@Impotent_Rage@base", 64);
	StringCopy(&cLocal_243, "special_ped@Impotent_Rage@intro", 64);
	iLocal_217 = 11;
	iLocal_221[0] = 4;
	iLocal_221[1] = 3;
	iLocal_221[2] = 4;
