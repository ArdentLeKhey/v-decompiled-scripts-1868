	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -871.9259f, 162.0005f, 52.99224f, -741.5948f, 155.0873f, 113.0255f, 90f, 0, true, 0))
					{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					vVar1 = { -808.7974f, 169.3193f, 70.9558f };
					vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (func_219(vVar0, vVar1, 100f) || iLocal_40)
					{
						if (func_216() || iLocal_40)
						{
							...
							if ((vVar0.z > 59f && vVar0.z < 90f) || iLocal_40)
							{
								if (func_220(&uLocal_53, vVar0) || iLocal_40)
								{
		...
		switch (iLocal_38)
		{
			case 0:
				if (func_199(0, 1093140480, 0))
				{
					...
					vVar1[0 /*3*/] = { 6.6f, 0f, -96.1f };
					fVar2[0] = 39.8f;
					vVar0[1 /*3*/] = { -842f, 178.8f, 72.2f };
					vVar1[1 /*3*/] = { 6.6f, 0f, -96.1f };
					fVar2[1] = 39.8f;
					vVar3 = { func_61(vVar1[0 /*3*/]) };
					...
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar1[1 /*3*/], fVar2[1], iVar5, 0, 0, 2);
					}
			...
			case 1:
				...
				vVar1[0 /*3*/] = { -10.7f, 0f, 60.7f };
				fVar2[0] = 50f;
				vVar0[1 /*3*/] = { -810.7f, 179.2f, 77.2f };
				vVar1[1 /*3*/] = { -10.7f, 0f, 60.7f };
				fVar2[1] = 50f;
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 12f;
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && INTERIOR::IS_VALID_INTERIOR(iLocal_51)) && INTERIOR::IS_VALID_INTERIOR(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
				...
				{
					STREAMING::NEW_LOAD_SCENE_START(vVar0[0 /*3*/], vVar3, fVar4, 2);
				}
				break;
			
			case 2:
				vVar0[0 /*3*/] = { -814.4f, 174.1f, 76.7f };
				vVar1[0 /*3*/] = { -1.2f, 0f, -70.6f };
				fVar2[0] = 50.1f;
				vVar0[1 /*3*/] = { -814.4f, 174.1f, 76.7f };
				vVar1[1 /*3*/] = { 18.9f, 0f, -70.6f };
				fVar2[1] = 50.1f;
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 10f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar1[1 /*3*/], fVar2[1], iVar5, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 3:
				...
				vVar1[0 /*3*/] = { -10.5f, 0f, -18.4f };
				fVar2[0] = 54f;
				vVar0[1 /*3*/] = { -803.8f, 168.3f, 73.6f };
				vVar1[1 /*3*/] = { -10.5f, 0f, -18.4f };
				fVar2[1] = 54f;
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 25f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar1[1 /*3*/], fVar2[1], (iVar5 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 4:
				...
				vVar1[0 /*3*/] = { -8.1845f, 0f, -48.1518f };
				fVar2[0] = 41.6f;
				vVar0[1 /*3*/] = { -803.6697f, 181.5426f, 73.2662f };
				vVar1[1 /*3*/] = { -8.1845f, 0f, -48.1518f };
				fVar2[1] = 41.6f;
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 12f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > (iVar5 / 2)) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (CAM::_0xEE778F8C7E1142E2(CAM::_0x19CAFA3C87F7C2FF()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_48) >= (iVar5 - 300))
					{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_48) > iVar5)
				{
					iLocal_38 = 6;
				}
				break;
...
void func_10()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -840.6724f, 159.0602f, 66.2181f, 1, false, 0, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			MISC::CLEAR_AREA(-857.1225f, 157.4701f, 63.7638f, 5f, 1, 0, 0, false);
			ENTITY::SET_ENTITY_COORDS(iVar0, -857.1225f, 157.4701f, 63.7638f, 1, false, 0, 1);
...
void func_11(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_47(iParam3, &Var0, vParam1, fParam2, func_53(iParam0));
...
void func_12(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_43(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_32();
			}
...
void func_13(int iParam0, int iParam1)
{
	...
	func_55(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_14(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_29(iParam0, 0, 0)) || func_29(iParam0, 1, 0)) || func_29(iParam0, 2, 0)) || func_53(iParam0) != 145) || func_28(iParam0)) || func_27(iParam0)) || func_26(iParam0)) || func_25(iParam0)) || !func_15(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_27(iParam0))
		{
		}
...
int func_43(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_54(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_47(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_43(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_52(iParam0);
			func_51(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_66(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_181(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_181(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_183()
{
	...
	{
		if (func_185(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_184(PLAYER::PLAYER_PED_ID());
			if (func_46(iVar0) && (!func_124(14) || Global_110511))
			{
...
int func_199(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_206(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
{
	return func_214(iParam0, Global_41396);
}
...
int func_216()
{
	...
	if (Global_41943 != -1)
	{
		if (Global_111560.f_7683[Global_41943 /*15*/].f_3 >= 2)
		{
			return 0;
		}
	}
...
bool func_219(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
