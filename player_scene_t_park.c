...
int func_2()
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_80))
	{
		if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_77))
		{
			...
			iLocal_77 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_80, vLocal_75 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, false);
		}
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						...
						{
							if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_89, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
				...
				case 2:
					...
					{
						if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_98, vLocal_75 + vLocal_107, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_170++;
						}
					}
		...
		else
		{
			if (iLocal_78 != 0)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_78, 0);
				iLocal_78 = 0;
	...
	switch (iParam1)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("prop_iron_01"))
			{
				...
				vVar2 = { ENTITY::GET_ENTITY_ROTATION(*iParam0, 2) };
				ENTITY::SET_ENTITY_COORDS(*iParam0, vVar1 + Vector(0.1f, 0f, 0f), 1, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(*iParam0, vVar2.x, vVar2.y, vVar2.z, 2, 1);
			}
		...
		case 4:
			...
			switch (ENTITY::GET_ENTITY_MODEL(*iParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					vVar7 = { 0f, 0f, 53.6f };
					ENTITY::SET_ENTITY_COORDS(*iParam0, vVar6, 1, false, 0, 1);
					ENTITY::SET_ENTITY_ROTATION(*iParam0, vVar7, 2, 1);
			...
			OBJECT::DELETE_OBJECT(iParam0);
			*iParam0 = OBJECT::CREATE_OBJECT(iVar5, vVar3, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(*iParam0, vVar4, 2, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar5);
			return 1;
			break;
		
		case 5:
			FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(*iParam0, true), 0, 0.5f, 1, 0, 1f, 0);
			OBJECT::DELETE_OBJECT(iParam0);
			return 1;
			break;
		...
		case 8:
			vVar8 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) };
			vVar9 = { ENTITY::GET_ENTITY_ROTATION(*iParam0, 2) };
			sVar10 = "";
			switch (ENTITY::GET_ENTITY_MODEL(*iParam0))
			{
		...
		case 9:
			...
			vVar12 = { ENTITY::GET_ENTITY_ROTATION(*iParam0, 2) };
			sVar13 = "";
			switch (ENTITY::GET_ENTITY_MODEL(*iParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar14, vVar11, true, true, false);
			...
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_96029, &sVar15, &sVar18, 1000f, -8f, iVar17, 1148846080);
					}
				}
			}
...
int func_36()
{
	if (!iLocal_69 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_68))
		{
			...
			{
				iLocal_68 = OBJECT::CREATE_OBJECT(iLocal_69, vLocal_75, true, true, false);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_72), vLocal_70, vLocal_71, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				iLocal_68 = OBJECT::CREATE_OBJECT(iLocal_69, vLocal_75 + vLocal_70, true, true, false);
				ENTITY::SET_ENTITY_COORDS(iLocal_68, vLocal_75 + vLocal_70, 1, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_68, Vector(uLocal_76, 0f, 0f) + vLocal_71, 2, 1);
...
void func_42()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_45(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_43(iVar0) && (!func_47(14) || Global_110511))
			{
...
void func_52()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		{
			if (!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&cLocal_142, 0, -1))
			{
				bVar1 = false;
			}
		}
	...
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_55(uParam1, 144, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_55(uParam1, 30, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 77:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, -0.7035f, -0.0282f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 78:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, -3.03f, -0.72f, 0.08f, 168f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, -2017877118, -2017877118, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_56(uParam1);
			}
		...
		case 94:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 94)
			{
				func_55(uParam1, 17, 1785177548, 1785177548, -1.71f, 1.05f, 0f, -138f);
			}
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 150:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 20, 1785177548, 1785177548, 0.98f, 0.8017f, -0.42f, -180f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 98:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_55(uParam1, 15, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_55(uParam1, 14, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 122:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, -2.04f, -0.15f, 0f, 14.4f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 152:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, 1.1779f, 2.4276f, 0f, 162.1022f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 156:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 14, 1785177548, 1785177548, 0.3427f, 1.1592f, 1.0351f, 139.912f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 14, -982327190, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 169:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 14, 1785177548, 1785177548, -0.3577f, -0.8968f, -0.0003f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 171:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 14, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
		...
		case 172:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 15, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 2;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 192:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, 1f, 1f, 0f, 0f);
			uParam1->f_118 = 1;
			if (Global_3)
			{
				uParam1->f_118 = 1;
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, -982327190, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_118 = 1;
			if (Global_3)
			{
				uParam1->f_118 = 1;
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 43, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 205:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, 3.4381f, -0.8269f, 0f, -87.6612f);
			if (Param0.f_2 != 205)
			{
		...
		case 221:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, -0.7949f, -0.508f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 218:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 19, 1785177548, 1785177548, 1.29f, 1.41f, 0f, 57.52f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 220:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 19, 1785177548, 1785177548, 0.5504f, -0.2322f, 0f, -9.9741f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 225:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 19, 1785177548, 1785177548, 1.23f, 0.6f, -1f, 34.56f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 236:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, 1.5033f, 1.2118f, 0f, -78.0449f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_55(uParam1, 144, -982327190, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
				func_55(uParam1, 144, 2106541073, 2106541073, -5.7915f, -11.0439f, 0.67f, -72.589f);
			}
			return 1;
			break;
		...
		case 262:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, -2017877118, -2017877118, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 295:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 32, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 299:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 32, 1785177548, 1785177548, 0.24f, 0.33f, -0.5f, -11.88f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 296:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 32, 1785177548, 1785177548, 1.41f, 1.35f, 0f, 168f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 297:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 32, 1785177548, 1785177548, 1.7491f, 0.6423f, 0f, 166.479f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 298:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 32, 1785177548, 1785177548, 0.72f, -0.69f, 0f, 172.44f);
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_55(uParam1, 144, 474215631, -1519143300, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_118 = 1;
			return 1;
			break;
...
int func_60(int iParam0, var uParam1, char* sParam2)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[0];
			StringCopy(sParam2, func_64(Global_111560.f_2358.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[1];
			StringCopy(sParam2, func_64(Global_111560.f_2358.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[2];
			StringCopy(sParam2, func_64(Global_111560.f_2358.f_539.f_2314[2]), 32);
			return 1;
			break;
		...
		case 9:
			return func_60(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_60(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_60(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_60(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_60(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_60(303, uParam1, sParam2);
			break;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_61(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_61(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_61(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_61(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 77:
			if (func_61(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
...
int func_63(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		...
		case 9:
			return func_63(8, uParam1, uParam2);
			break;
