...
bool func_5(var uParam0)
{
	...
	func_7(uParam0, uParam0->f_29.f_2, &sVar1);
...
void func_11(var uParam0)
{
	...
	Var2 = { *(uParam0[uParam0->f_29.f_2 /*14*/]) };
	switch (uParam0->f_29.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				iVar5 = vVar4.z;
				TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar3, 1f, 500, iVar5, 0.15f);
			}
			func_52(uParam0, 5);
			break;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_29.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar7))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_29.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_29.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_29), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_57(&(uParam0->f_29), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_1590291);
		func_93(0, -1, 0);
		MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(0);
		func_92();
		if (func_91(Global_1590291))
		{
			func_84();
		}
		else
...
void func_74()
{
	func_77(2, &uLocal_162, 0);
	func_77(3, &uLocal_162, 1);
	func_75(&uLocal_162, 6632);
}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	func_83(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = 8;
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_81(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_79(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_78(), fVar1) + vVar0 };
...
void func_84()
{
	func_85(2, &uLocal_162, 0);
	func_85(3, &uLocal_162, 1);
}
...
void func_85(int iParam0, var uParam1, int iParam2)
{
	...
	func_90(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = 5;
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_88(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_87(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_86(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
{
	return MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_267.f_1, 0);
}
