	...
	while (true)
	{
		...
		if (func_48(&Local_41))
		{
			if (func_42(&Local_41))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_41.f_14, 8.5f, 0, 0, 0, 0, false, 0);
		...
		if (Global_111560.f_10044.f_104 != 0)
		{
			iLocal_49 = (Global_111560.f_10044.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
...
void func_1(int iParam0, var uParam1, int iParam2)
{
	...
	{
		case 0:
			*iParam0 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MIDSIZED_MESSAGE");
...
void func_44(int iParam0, bool bParam1)
{
	...
	{
		MISC::CLEAR_BIT(&iLocal_51, iParam0);
	}
}
...
void func_69(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41.f_6[0 /*3*/], Local_41.f_6[1 /*3*/], Local_41.f_6.f_7, 0, true, 0) && func_48(&Local_41))
				{
