	...
	while (true)
	{
		...
		switch (func_212(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 1:
				...
				{
					if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60.f_3, 500f, 500f, 500f, false, true, 0) && func_225(PLAYER::PLAYER_ID()) != 1) && !MISC::IS_BIT_SET(Global_2531497.f_859.f_7, 0))
					{
	...
	if (func_42(PLAYER::PLAYER_ID(), 1, 0))
	{
		...
		if (Global_969029.f_267 > 0)
		{
			...
			while (iVar0 < Global_969029.f_267)
			{
				...
				{
					if (func_34(vParam0, ENTITY::GET_ENTITY_COORDS(Global_969029.f_232[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_969029.f_232[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_969029.f_232[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969029.f_265 > 0)
		{
			...
			while (iVar0 < Global_969029.f_265)
			{
				...
				{
					if (func_34(vParam0, ENTITY::GET_ENTITY_COORDS(Global_969029.f_118[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_969029.f_118[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_969029.f_118[iVar0]), 0.5f))
					{
						return 1;
					}
				}
	...
	if (iParam2 && !bParam5)
	{
		if (func_26(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_115(PLAYER::PLAYER_ID()), vParam0, true) <= (fVar2 + fParam1))
				{
					if (CAM::IS_SPHERE_VISIBLE(vParam0, fParam1))
					{
						return 1;
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_74(iVar1) || !bParam8) && !Global_2424073[iVar1 /*421*/].f_259)
					{
						...
						if (!bParam5)
						{
							if ((iParam3 || (iParam3 == 0 && PLAYER::GET_PLAYER_TEAM(iVar1) != PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()))) || PLAYER::GET_PLAYER_TEAM(iVar1) == -1)
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_115(iVar1), vParam0, true) <= (fVar2 + fParam1))
								{
									if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam1))
									{
										return 1;
				...
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_74(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, true) < fParam1)
								{
									return 1;
								}
							}
		...
		while (iVar0 < 32)
		{
			...
			if (func_26(iVar1, 1, 1))
			{
				if ((!func_140(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1)) && iVar1 != PLAYER::PLAYER_ID())
				{
					...
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, true) <= (fVar2 + fParam1))
						{
							if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam1))
							{
								return 1;
...
void func_191(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_195(iParam2)];
	if (iVar0 != 0)
	{
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_195(iParam1)];
