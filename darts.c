...
void __EntryFunction__()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(ScriptParam_260.f_4))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ScriptParam_260, 5f, joaat("prop_dart_bd_cab_01"), 0))
			{
				...
				OBJECT::GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(ScriptParam_260, 5f, joaat("prop_dart_bd_cab_01"), &ScriptParam_260, &vVar19, 0);
	...
	func_467(1);
	iLocal_198 = func_464(func_500(iLocal_170[0]), 1);
	...
	while (true)
	{
		...
		if ((PED::IS_PED_INJURED(ScriptParam_260.f_5) && !ENTITY::DOES_ENTITY_EXIST(func_498())) || (ENTITY::DOES_ENTITY_EXIST(func_498()) && PED::IS_PED_INJURED(func_498())))
		{
			func_469(&Var0, &Var5, &Var6);
		}
		if (!PED::IS_PED_INJURED(iLocal_170[0]))
		{
			...
			switch (Var0)
			{
				case 0:
					HUD::CLEAR_HELP(1);
					func_461(&(Var0.f_243), &ScriptParam_260);
				...
				case 1:
					if (SYSTEM::TIMERA() > 500 && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_205);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_205);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_205);
							TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_205);
						}
						vLocal_42 = { vLocal_42 };
						Var0 = 2;
					}
				...
				case 2:
					...
					iVar1 = 2;
					func_457(0);
					func_455(&Var4, iLocal_207, Var0.f_243.f_1, Var0.f_243.f_4);
					if (ENTITY::DOES_ENTITY_EXIST(Var0.f_243))
					{
				...
				case 3:
					...
					{
						func_446(&(Var0.f_243), &Var2, &vVar3, 0);
						iLocal_249 = func_500(iLocal_170[0]);
						switch (iLocal_249)
						{
							case 0:
								sLocal_251 = func_445("MICHAEL");
								if (!MISC::IS_BIT_SET(Global_111521, 0))
								{
						...
						if (!ENTITY::IS_ENTITY_DEAD(func_498(), 0))
						{
							iLocal_250 = func_500(func_498());
							if (iLocal_250 == 145)
							{
								iLocal_250 = func_442(func_498());
							}
							switch (iLocal_250)
							{
								case 0:
									sLocal_252 = func_445("MICHAEL");
									break;
								
								case 1:
									sLocal_252 = func_445("FRANKLIN");
									break;
								
								case 2:
									sLocal_252 = func_445("TREVOR");
									break;
								
								case 19:
									sLocal_252 = func_445("LAMAR");
									PED::SET_PED_COMPONENT_VARIATION(func_498(), 5, 2, 0, 0);
									break;
								
								case 14:
									sLocal_252 = func_445("JIMMY");
									break;
						...
						else
						{
							...
							if (iLocal_207 == 2)
							{
								if (iVar12 < 51)
								{
									sLocal_252 = func_445("RAYMOND");
									iLocal_253 = 954610991;
								}
								else if (iVar12 < 101)
								{
									sLocal_252 = func_445("JOHAN");
									iLocal_253 = 94453331;
								}
								else if (iVar12 < 151)
								{
									sLocal_252 = func_445("STAN");
									iLocal_253 = 1891555423;
								}
								else
								{
									sLocal_252 = func_445("VINCE");
									iLocal_253 = -1067630349;
								}
							}
							else if (iVar12 < 51)
							{
								sLocal_252 = func_445("KRISTY");
								iLocal_253 = 885327384;
							}
							else if (iVar12 < 101)
							{
								sLocal_252 = func_445("MARLENE");
								iLocal_253 = -1791000994;
							}
							else if (iVar12 < 151)
							{
								sLocal_252 = func_445("LORIE");
								iLocal_253 = 1954368234;
							}
							else
							{
								sLocal_252 = func_445("SHELLEY");
				...
				case 4:
					if (!CAM::_0x705A276EBFF3133D())
					{
						...
						func_439(Var0.f_243.f_4, Var2, &uVar26, &ScriptParam_260);
						func_438(&Var4, sLocal_251, sLocal_252);
						...
						func_437(&(Var0.f_257), 0, PLAYER::PLAYER_PED_ID(), sLocal_251, 0, 1);
						if (ENTITY::IS_ENTITY_DEAD(func_498(), 0))
						{
							if (iLocal_207 == 2)
							{
								func_437(&(Var0.f_257), 3, iLocal_170[1], "DartsBillLost1", 0, 1);
							}
							else
							{
								func_437(&(Var0.f_257), 3, iLocal_170[1], "DartsMelHick1", 0, 1);
							}
							iVar13 = -1;
						}
						else
						{
							func_437(&(Var0.f_257), 3, func_498(), sLocal_252, 0, 1);
							func_435(&iVar25);
							iVar13 = 6;
						}
						if (!MISC::IS_BIT_SET(Global_111521, 0))
				...
				case 5:
					...
					{
						bLocal_178 = func_432(&uLocal_194);
						if ((func_431() && MISC::GET_GAME_TIMER() >= iLocal_196 + 1000) && iVar13 != 9)
						{
							...
							case 0:
								if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_200))
								{
									if (!bVar9)
									{
										...
										{
											func_422(iLocal_170[0], "DARTS_REQUEST_GAME", 6);
											bVar9 = true;
											func_421(&iVar25);
										}
									}
						...
						case 1:
							if (MISC::IS_PC_VERSION())
							{
								if (fLocal_89 != GRAPHICS::_GET_ASPECT_RATIO(0))
								{
									...
									CAM::SET_CAM_FOV(iLocal_75, func_404(fLocal_89));
									CAM::SET_CAM_FOV(iLocal_76, func_404(fLocal_89));
								}
							}
				...
				case 9:
					...
					{
						Var0.f_249.f_4 = 1;
						if (Global_111560.f_18965.f_5 >= 5 && Global_111560.f_18965.f_7 >= 0.8f)
						{
							Var0.f_249.f_4 = 2;
						}
						else if (Global_111560.f_18965.f_5 >= 3 && Global_111560.f_18965.f_7 >= 0.66f)
						{
							Var0.f_249.f_4 = 1;
						}
						else
						...
						if (func_332(Global_111560.f_18965.f_5, &iLocal_199))
						{
							func_331(&(Var5.f_666), 24, 1);
						}
						fLocal_45 = func_330(Global_111560.f_18965.f_5);
						fLocal_46 = func_329(Global_111560.f_18965.f_5);
						fLocal_43 = fLocal_45;
						fLocal_44 = fLocal_46;
						iLocal_106[4]++;
						if (!PED::IS_PED_INJURED(iLocal_170[1]))
				...
				case 10:
					...
					func_246(&Var0, &vVar3, &Var4, &Var5, &iVar23);
					break;
...
var func_21(int iParam0, bool bParam1)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_22350.f_7013[iParam0 /*16*/])))
	{
		...
		{
			return func_22(&(Global_22350.f_7013[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (PLAYER::IS_PLAYER_ONLINE())
	{
		if (!iLocal_191)
		{
			if (func_213(uParam1, 0, &iLocal_192))
			{
	...
	if (iLocal_173)
	{
		...
		{
			iVar0 = func_109(uParam1, 0, 0, iLocal_191);
...
void func_57(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_59() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_59() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_60(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_61(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_65(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_59() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_72(int iParam0, int iParam1)
{
	...
	if (func_82(&Global_4269915))
	{
		if (func_80(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_73(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_76(var uParam0)
{
	...
	func_78(uParam0, (Global_4269914 - 0.5f));
}
...
void func_91()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_93(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_92(iVar0) && (!func_84(14) || Global_110511))
			{
			...
			if (!func_153(uParam1))
			{
				...
				if (Global_1835392.f_2825 == -1)
				{
					...
					while (iVar0 < 3)
					{
						...
						func_152(*uParam0, iVar3, iVar9, &vVar12);
						iVar3++;
						iVar0++;
					}
					Global_1835392.f_2825 = 1;
				...
				else if (func_150(&(Global_1835392.f_2823), 300, 0))
				{
					...
					while (iVar0 < 3)
					{
						...
						iVar9 = 0;
						MISC::SET_BIT(&iVar9, 7);
						func_152(*uParam0, iVar3, iVar9, &vVar13);
						iVar3++;
						iVar0++;
					}
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_233(Global_4456448.f_190930) || func_230(Global_4456448.f_190930))
				{
					StringCopy(&(Global_1835392.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
				...
				else if (func_229(Global_4456448.f_190930))
				{
					StringCopy(&(Global_1835392.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
					StringCopy(&(Global_1835392.f_2717[1 /*6*/]), "SCLB_C_DEATH", 24);
					StringCopy(&(Global_1835392.f_2717[2 /*6*/]), "SCLB_C_RANK", 24);
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_303("DARTS_SHT_USE") && !func_303("DARTS_INSTR_W")) && !func_303("DARTS_INSTR_B")) && !func_303("DARTS_AIM_HLP")) && !func_303("DARTS_STD_HLP")) && !func_303("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						MISC::SET_BIT(&(Global_111560.f_18965.f_6), iLocal_199);
				...
				else if (!iLocal_174)
				{
					...
					{
						func_290(iLocal_170[(1 - iLocal_30)]);
						func_421(iParam4);
						iLocal_174 = 1;
					}
				}
	...
	switch (uParam0->f_2)
	{
		...
		case 2:
			...
			if (!func_3(&(uParam2->f_666), 6))
			{
				if (!iLocal_176)
				{
					if (func_251(iLocal_30 == 0, &(iLocal_170[1]), (uParam0->f_425[iLocal_30] - uParam0->f_422[iLocal_30]), uParam0->f_422[0], uParam0->f_422[1]))
					{
						iLocal_176 = 1;
					}
				}
			...
			{
				if (func_250(iLocal_30 == 0, &(iLocal_170[1]), (uParam0->f_425[iLocal_30] - uParam0->f_422[iLocal_30]), uParam0->f_422[0], uParam0->f_422[1]))
				{
					iLocal_176 = 1;
				}
			}
			...
			if (iLocal_171 || SYSTEM::TIMERB() > 2000)
			{
				...
				if (uParam0->f_425[iLocal_30] != uParam0->f_422[iLocal_30])
				{
					...
					AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_SCOREBOARD_MASTER", uParam0->f_243.f_1, 0, false, 0, 0);
				}
...
void func_255(var uParam0, var uParam1)
{
	...
	else
	{
		...
		else if ((uParam0->f_422[iLocal_30] == 1 || uParam0->f_422[iLocal_30] < 0) || (uParam0->f_422[iLocal_30] == 0 && uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_21 != 2))
		{
			...
			if (!iLocal_176)
			{
				if (func_264(iLocal_170[(1 - iLocal_30)]))
				{
					iLocal_176 = 1;
				}
			}
		...
		else
		{
			if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_20 == 50)
			{
				...
				{
					if (func_262(iLocal_170[iLocal_30]))
					{
						iLocal_176 = 1;
					}
				}
			...
			if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_20 == 0)
			{
				if (!iLocal_176 && !iLocal_181)
				{
					func_261(iLocal_170[(1 - iLocal_30)]);
					iLocal_176 = 1;
				}
			}
			if (uParam0->f_428 == 180)
			{
				if (!iLocal_176 && !iLocal_181)
				{
					if (func_260(iLocal_170[1], iLocal_30 == 0))
					{
						iLocal_176 = 1;
					}
				}
			...
			if (uParam0->f_428 == 140)
			{
				if (!iLocal_176 && !iLocal_181)
				{
					if (func_258(iLocal_170[iLocal_30], iLocal_30 == 0))
					{
						iLocal_176 = 1;
					}
				}
...
void func_265(int iParam0)
{
	...
	{
		case 0:
			Global_111560.f_18965++;
			func_266("DARTS_STAT_NUM_BULLSEYES", Global_111560.f_18965);
			break;
		
		case 1:
			Global_111560.f_18965.f_1++;
			func_266("DARTS_STAT_NUM_180S", Global_111560.f_18965.f_1);
			break;
		
		case 2:
			Global_111560.f_18965.f_2++;
			func_266("DARTS_STAT_NUM_WINS", Global_111560.f_18965.f_2);
			break;
		
		case 3:
			Global_111560.f_18965.f_3++;
			func_266("DARTS_STAT_NUM_LOSS", Global_111560.f_18965.f_3);
			break;
		
		case 4:
			Global_111560.f_18965.f_4++;
			func_266("DARTS_STAT_DARTS_THROWN", Global_111560.f_18965.f_4);
			break;
		
		case 5:
			Global_111560.f_18965.f_5++;
			func_266("DARTS_STAT_NUM_GAMES", Global_111560.f_18965.f_5);
			break;
		
		case 7:
			Global_111560.f_18965.f_7 = (SYSTEM::TO_FLOAT(Global_111560.f_18965.f_2) / SYSTEM::TO_FLOAT(Global_111560.f_18965.f_5));
			break;
		
		case 8:
			Global_111560.f_18965.f_8 = (SYSTEM::TO_FLOAT(Global_111560.f_18965.f_4) / SYSTEM::TO_FLOAT(Global_111560.f_18965.f_5));
			break;
	}
}
...
void func_300()
{
	...
	if (PAD::IS_CONTROL_PRESSED(2, 229))
	{
		...
		{
			iLocal_50 = 1;
			if (!MISC::IS_BIT_SET(Global_111521, 1))
			{
				func_418("DARTS_SHT_USE", -1);
				MISC::SET_BIT(&Global_111521, 1);
			}
		}
	}
	else if (bLocal_49)
...
void func_304(int iParam0, int iParam1)
{
	...
	else if (iParam0 == 2)
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_111521, 2))
			{
				func_418("DARTS_FST_HLP", -1);
				MISC::SET_BIT(&Global_111521, 2);
			}
			iLocal_51 = 1;
		}
	}
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (PAD::IS_CONTROL_PRESSED(2, 228))
			{
				...
				{
					func_317();
					func_316(&iLocal_208, vLocal_239, vLocal_240, 30f, 10, 10, 3, 15f, 0, 0, -1f, 1);
					*uParam0 = 2;
				}
			}
			else
		...
		case 2:
			...
			{
				func_313(&iLocal_208, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			}
			break;
...
void func_316(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9, float fParam10, bool bParam11)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = fParam3;
...
int func_332(int iParam0, var uParam1)
{
	if (iParam0 >= 10)
	{
		if (!MISC::IS_BIT_SET(Global_111560.f_18965.f_6, 12))
		{
			*uParam1 = 12;
			return 1;
		}
...
int func_344(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_399())
		{
			if (Global_4268347 == uParam0->f_660)
			{
				iVar1 = 1;
			}
			else
			{
				uParam0->f_660 = Global_4268347;
			...
			Global_4268348 = MISC::GET_GAME_TIMER() + 300;
		}
		else if (func_396() && MISC::GET_GAME_TIMER() > Global_4268348)
		{
			if (Global_4268347 == uParam0->f_660)
			{
				iVar2 = func_395(0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				{
					func_18(Global_4268271.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					fVar40 = (((Global_22347 + fVar36) + (0.00078125f * 4f)) - (0.00078125f * 1f));
				}
				func_361(fVar40);
				...
				{
					func_18(Global_4268271.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_360(Global_4268271.f_67, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_24(Global_4268271.f_67), func_21(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
	...
	if (Global_22350.f_4769 != 0)
	{
		...
		if (!Global_22350.f_4770)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_13(&Global_4268271);
				if (Global_4268271.f_20 == -1)
				{
					func_12(&(Global_4268271.f_16));
				}
				else
				{
...
int func_370(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_372(8, -1) && func_371() != 65)) || (HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_76837) || Global_22350.f_8384) || HUD::IS_WARNING_MESSAGE_ACTIVE()) || Global_98721.f_1417)
	{
		return 0;
	}
	return 1;
...
int func_374(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_395(0) == 1 && Global_4268347 == iParam1)
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
{
	Global_22350.f_8381 = iParam3;
	Global_22350.f_8378[0] = iParam1;
	Global_22350.f_8378[1] = iParam2;
	Global_22350.f_8382 = iParam0;
}
...
{
	Global_22350.f_8355 = iParam4;
	Global_22350.f_8351 = uParam0;
	Global_22350.f_8352 = uParam1;
	Global_22350.f_8353 = uParam2;
	Global_22350.f_8354 = uParam3;
}
...
int func_407(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	...
	if ((func_431() && MISC::GET_GAME_TIMER() >= iLocal_196 + 1000) && *iParam0 != 8)
	{
		if (!CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_OUT())
		{
			CAM::DO_SCREEN_FADE_OUT(500);
	...
	switch (*iParam0)
	{
		...
		case 5:
			if (!CAM::IS_CAM_INTERPOLATING(iLocal_83) && !func_303("DARTS_DBL_WIN"))
			{
...
void func_409(vector3 vParam0, float fParam1, vector3 vParam2, vector3 vParam3, int iParam4)
{
...
void func_415(vector3 vParam0, float fParam1, vector3 vParam2, vector3 vParam3, int iParam4, bool bParam5)
{
...
void func_455(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	int iVar1;
	...
	if (!func_456(vParam2) && fParam3 != 0f)
	{
...
void func_460(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
void func_469(int iParam0, var uParam1, var uParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(func_498(), 0))
	{
		...
		func_480(iLocal_202, iLocal_203);
	}
	else
	{
		func_478(&(iLocal_170[1]));
	}
	func_467(0);
	func_477(uParam2);
	func_36(0);
...
void func_474()
{
	...
	{
		func_85(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
void func_478(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0))
	{
		...
		if (bLocal_183)
		{
			if (!MISC::IS_BIT_SET(Global_111521, 10))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_242, vLocal_244), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, fLocal_246, fLocal_248));
			}
			else
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_241, vLocal_243), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, fLocal_245, fLocal_247));
			}
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
		}
		else
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_241, vLocal_243), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, 172.6813f, 142.6717f));
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, 1);
		}
		TASK::CLOSE_SEQUENCE_TASK(iLocal_205);
		TASK::TASK_PERFORM_SEQUENCE(*uParam0, iLocal_205);
		PED::SET_PED_KEEP_TASK(*uParam0, true);
	}
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_204);
}

Vector3 func_479(bool bParam0, vector3 vParam1, vector3 vParam2)
{
	if (bParam0)
	{
		return vParam1;
...
void func_487()
{
	...
	if (Global_111560.f_9080 || func_472(0))
	{
		if (!func_495())
		{
			iVar0 = func_494();
...
int func_489(int iParam0)
{
	...
	PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID());
	func_490(&(Global_111560.f_2358.f_539), iVar1);
...
void func_490(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_492(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
