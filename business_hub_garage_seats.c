...
int func_84()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1502.824f, -3006.31f, -80.557f, -1513.824f, -3006.31f, -84.557f, 9.5f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_85()
{
	if (Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
...
void func_86()
{
	func_87(0, &uLocal_162, 0, 2);
	func_87(1, &uLocal_162, 1, 1);
	func_87(2, &uLocal_162, 2, 2);
	func_87(3, &uLocal_162, 3, 1);
	func_87(4, &uLocal_162, 4, 2);
	func_87(5, &uLocal_162, 5, 1);
	func_87(6, &uLocal_162, 6, 2);
	func_87(7, &uLocal_162, 7, 1);
	func_87(8, &uLocal_162, 8, 1);
}
...
void func_87(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_91(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, fVar1 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_89(func_90(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_89(func_88(), fVar1) + vVar0 };
