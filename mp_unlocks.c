...
int func_19()
{
	...
	iVar0 = Global_1384267[func_14(-1)];
...
int func_32(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2577831[iParam0 /*3*/][func_14(iParam1)];
	if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
	...
	switch (iParam0)
	{
		...
		case 6:
			if ((NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT() || func_41()) || func_40())
			{
				...
				iVar0 += 19;
				iVar0 += 8;
				return (Global_262145.f_21367 + iVar0);
			}
			else
			{
...
int func_49(int iParam0)
{
	...
	iVar1 = func_52(iVar0);
	iVar2 = func_51(iVar0);
	if ((PAD::IS_CONTROL_JUST_RELEASED(2, iParam0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(2, iParam0)) || func_50(iParam0, &(Global_1373500.f_1060), 1))
	{
