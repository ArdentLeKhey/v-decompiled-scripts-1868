...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_272(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_260(&Var0, 1);
	}
	if (!func_257(&iVar2, &Var0, vVar1, 1f))
	{
		func_256();
	...
	MISC::CLEAR_AREA(vVar1, 3f, 1, 0, 0, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_197(&Var0, 1))
		...
		func_196(Var0);
		func_189(&iLocal_59, &(Var0.f_9), vVar1);
		if (Var0 == 25)
		{
			func_184(&Var0, vVar1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_169(&Var0, 0) && MISC::ABSF((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_188(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_187(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_185(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_197(int iParam0, bool bParam1)
{
	...
	func_110(*iParam0, &Var0);
	if ((func_234(*iParam0) || func_232(*iParam0)) || Global_76822 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_219(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar2 != -1)
		{
			func_218(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_212(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_212(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_213(iParam2, iParam5) };
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_217(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_216(vVar1, vVar0);
...
float func_216(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_224(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
{
	if ((func_233() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				iLocal_58 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_SNIPERRIFLE"), 0, vLocal_57, 0, 1065353216, 0, 0, 1);
		...
		case 3:
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_57, 1f, iLocal_54, 0))
			{
				ENTITY::SET_ENTITY_ROTATION(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_237(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	func_238(iParam0, iLocal_53, vParam1, fParam2);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_239(iParam0);
...
int func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_241(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_257(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_258((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_258((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_258(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_259(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_259(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
