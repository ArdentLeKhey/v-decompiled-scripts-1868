...
int func_52(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_53(iParam1)];
...
int func_55(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_53(iParam1)];
...
void func_62(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_64(Var7.f_1)) && iVar9 < 51)
			{
...
int func_167(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_169(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		vVar1 = { Global_31111[(iLocal_239 + iVar0) /*23*/][0 /*3*/] };
				...
				if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), 5.1f))
				{
					if (*iParam0 == 52)
					{
						...
						while (iVar2 < iParam0->f_41)
						{
							...
							{
								if ((func_128(iParam0->f_28[0]) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iParam0->f_41[iVar2], iParam0->f_28[0])) || (func_128(iParam0->f_28[1]) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iParam0->f_41[iVar2], iParam0->f_28[1])))
								{
	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			if (func_128(iParam0->f_28[0]))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 4:
			...
			if (func_128(iParam0->f_28[0]))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 6:
			...
			if (func_128(iParam0->f_28[0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
			}
			...
			if (func_128(uParam0->f_28[0]))
			{
				if (!func_147())
				{
					if (func_230(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_3", 8, 0, 0))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_238, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
	...
	switch (iParam1)
	{
		...
		case joaat("WEAPON_ASSAULTRIFLE_MK2"):
			switch (iParam2)
			{
				...
				case 23:
					func_329(uParam0, joaat("COMPONENT_AT_AR_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 24:
					func_329(uParam0, joaat("COMPONENT_AT_AR_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_CARBINERIFLE_MK2"):
			switch (iParam2)
			{
				...
				case 23:
					func_329(uParam0, joaat("COMPONENT_AT_CR_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 24:
					func_329(uParam0, joaat("COMPONENT_AT_CR_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_COMBATMG_MK2"):
			switch (iParam2)
			{
				...
				case 20:
					func_329(uParam0, joaat("COMPONENT_AT_MG_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 21:
					func_329(uParam0, joaat("COMPONENT_AT_MG_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_HEAVYSNIPER_MK2"):
			switch (iParam2)
			{
				...
				case 14:
					func_329(uParam0, joaat("COMPONENT_AT_SR_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 15:
					func_329(uParam0, joaat("COMPONENT_AT_SR_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_SMG_MK2"):
			switch (iParam2)
			{
				...
				case 21:
					func_329(uParam0, joaat("COMPONENT_AT_SB_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 22:
					func_329(uParam0, joaat("COMPONENT_AT_SB_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_SPECIALCARBINE_MK2"):
			switch (iParam2)
			{
				...
				case 23:
					func_329(uParam0, joaat("COMPONENT_AT_SC_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 24:
					func_329(uParam0, joaat("COMPONENT_AT_SC_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_MARKSMANRIFLE_MK2"):
			switch (iParam2)
			{
				...
				case 22:
					func_329(uParam0, joaat("COMPONENT_AT_MRFL_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 23:
					func_329(uParam0, joaat("COMPONENT_AT_MRFL_BARREL_02"), -1312077031, 2, 0);
					break;
		...
		case joaat("WEAPON_BULLPUPRIFLE_MK2"):
			switch (iParam2)
			{
				...
				case 12:
					func_329(uParam0, joaat("COMPONENT_AT_BP_BARREL_01"), -1312077031, 1, 1);
					break;
				
				case 13:
					func_329(uParam0, joaat("COMPONENT_AT_BP_BARREL_02"), -1312077031, 2, 0);
					break;
...
int func_279(int iParam0, int iParam1)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_312())
	{
		...
		func_306(&sVar10, Var11, ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()), 3, 1, func_308(iParam0), func_307(iParam0), -1, 0, 0);
...
void func_342(var uParam0)
{
	...
	func_346(&uLocal_68);
	while ((((!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_MODEL_LOADED(iVar1)) || !STREAMING::HAS_MODEL_LOADED(iVar2)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3)) || !func_345(&uLocal_68))
	{
		SYSTEM::WAIT(0);
	}
...
{
	*uParam0 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2(func_347());
}
