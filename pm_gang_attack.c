	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar1 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_110270.f_225[iVar1]))
					{
						uLocal_221[iVar1] = Global_110270.f_225[iVar1];
						Global_110270.f_225[iVar1] = 0;
				...
				while (iVar1 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_110270.f_222[iVar1]))
					{
						uLocal_220[iVar1] = Global_110270.f_222[iVar1];
						Global_110270.f_222[iVar1] = 0;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_35(iParam2), 1);
}
...
Vector3 func_40(vector3 vParam0, float fParam1)
{
	...
	return vParam0 + func_41(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1));
}
...
int func_58()
{
	return func_59(Global_110270.f_20, Global_110270.f_29);
}
