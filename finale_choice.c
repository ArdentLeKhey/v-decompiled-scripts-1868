...
void func_20()
{
	...
	if (Global_76577 == 0)
	{
		...
		func_16(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_41396 == 15 && func_2(0) == 0) && Global_7361 == 0)
		{
...
void func_30()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_32(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_17(14) || Global_110511))
			{
...
void func_39(int iParam0)
{
	...
	Global_41948[iParam0] = MISC::GET_GAME_TIMER();
}

void func_40()
{
	Global_41947 = MISC::GET_GAME_TIMER();
}
...
void func_47(int iParam0)
{
	...
	while (iVar1 < Global_111560.f_7683.f_198)
	{
		...
		{
			func_48(Global_111560.f_7683.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
