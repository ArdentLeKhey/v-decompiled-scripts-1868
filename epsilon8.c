...
void __EntryFunction__()
{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(func_485(), 0);
	MISC::CLEAR_BIT(&(Global_111560.f_18569.f_382), 1);
...
void func_4()
{
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[0], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[1], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[2]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[2], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[3]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[3], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[4]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[4], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[5]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[5], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[6]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[6], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_394[0]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_394[0], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_394[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_394[1], 0);
	}
	...
	if (iLocal_178 == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_68, 1, false, 0, 1);
			}
...
void func_31(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_33() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_33() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_34(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_35(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_39(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_33() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_35(iParam1)];
...
int func_46(int iParam0, int iParam1)
{
	...
	if (func_56(&Global_4269915))
	{
		if (func_54(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_47(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_50(var uParam0)
{
	...
	func_52(uParam0, (Global_4269914 - 0.5f));
}
...
void func_64()
{
	...
	else if (HUD::DOES_BLIP_EXIST(iLocal_431))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_297(PLAYER::PLAYER_PED_ID(), iLocal_384[3], 0) < 1f)
			{
	...
	if (func_18(iLocal_392) && func_18(iLocal_380))
	{
		...
		{
			if (func_296(iLocal_380, iLocal_392, 2) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_392, 1, 0))
			{
		...
		else if (func_296(iLocal_380, iLocal_392, 1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_392, 2, 0))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_380, 242628503) != 1 || TASK::GET_SEQUENCE_PROGRESS(iLocal_380) > 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
	...
	if (func_95(iLocal_379))
	{
		...
		if (MISC::GET_GAME_TIMER() > iLocal_112 + 8000)
		{
			...
			if (PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (iLocal_163 == 0)
				{
					if (func_66(PLAYER::PLAYER_PED_ID(), iLocal_392, 200f, 1))
					{
						if (!func_299())
						{
							if (iLocal_168 == 0)
...
{
	return func_68(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0), PLAYER::PLAYER_PED_ID(), 250, 7);
}
...
bool func_68(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	uVar1 = func_69(&(Local_35[iVar0 /*4*/]), ENTITY::GET_ENTITY_COORDS(iParam0, true), iParam1, &(Local_35[iVar0 /*4*/].f_3), iParam0, iParam3);
...
void func_86()
{
	...
	{
		if (func_89(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_88(PLAYER::PLAYER_PED_ID());
			if (func_87(iVar0) && (!func_58(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_87(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_97()
{
	...
	if (iLocal_133 == 1)
	{
		...
		Global_111560.f_18569.f_388 = 1;
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("EPS8_PASS");
		Global_111560.f_18569.f_388 = 0;
	}
...
void func_98(int iParam0, bool bParam1)
{
	...
	{
		func_254(&(Global_110647[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
int func_124(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76389[1 /*14*/] = { func_172(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_172(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_164(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_164(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_125(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_236(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_172(iVar10, iParam1, iParam2, -1) };
		if (!func_162(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_172(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_172(iVar10, 14, uVar12[iVar1], -1) };
							func_143(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_158(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_164(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_158(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_172(iVar10, iVar0, func_133(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_172(iVar10, 14, uVar15[iVar1], -1) };
			func_143(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_158(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_164(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
{
	Global_76389[1 /*14*/] = { func_172(iParam0, iParam1, iParam2, -1) };
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_164(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_164(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_158(int iParam0)
{
	...
	{
		func_161(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_236(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_171(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_171(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_171(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_174(int iParam0)
{
	...
	func_175(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_40(func_178(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_40(func_177(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_40(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_164(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_236(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_236(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_236(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_172(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_236(iParam0, 14, iVar4))
										{
											if (!func_131(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_172(iVar0, iVar2, iVar1, -1) };
						if (!func_131(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_164(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_164(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_243(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_244(&sVar1, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}
...
void func_249()
{
	...
	{
		func_86();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_250(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
...
{
	func_259(iParam0, 1);
	Global_111560.f_18569[iParam0 /*6*/].f_3 = func_258();
				...
				if (iLocal_148 == 0)
				{
					...
					if (iLocal_92 < 2)
					{
						...
						else if (iLocal_94 == 1)
						{
							if (MISC::GET_GAME_TIMER() > iLocal_112 + 10000)
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_297(PLAYER::PLAYER_PED_ID(), iLocal_392, 0) < 85f)
								{
									if (iLocal_101 < 25)
									{
										PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_61, iLocal_101, &vLocal_65, 1, 3f, 0f);
										if (func_289(PLAYER::PLAYER_PED_ID(), vLocal_65, 65f) && !func_289(PLAYER::PLAYER_PED_ID(), vLocal_65, 40f))
										{
											if (!ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
											{
												if (iLocal_168 == 0)
						...
						else if (iLocal_94 == 2)
						{
							...
							if ((iLocal_96 > iLocal_95 + 20000 || !func_66(PLAYER::PLAYER_PED_ID(), iLocal_392, 85f, 1)) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								iLocal_94 = 0;
							}
						}
...
void func_292()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_381[iLocal_78]))
	{
		...
		else if (!func_66(iLocal_381[iLocal_78], PLAYER::PLAYER_PED_ID(), fLocal_42, 1))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_422[iLocal_78]))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_382[iLocal_78]))
	{
		...
		else if (!func_66(iLocal_382[iLocal_78], PLAYER::PLAYER_PED_ID(), fLocal_42, 1))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_423[iLocal_78]))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_378[iLocal_78]))
	{
		...
		else if (!func_66(iLocal_378[iLocal_78], PLAYER::PLAYER_PED_ID(), fLocal_43, 1))
		{
		...
		else if (iLocal_78 != 5)
		{
			if (iLocal_182 == 0)
			{
				if (iLocal_151 == 0)
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_395, 30f, 1))
						{
							if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_395, 0))
							{
								if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_395, -1, 0))
								{
									...
									if (iLocal_143 == 1)
									{
										PATHFIND::SET_ROADS_IN_ANGLED_AREA(-397.6181f, -63.27855f, 42.65886f, -345.0219f, -93.33459f, 49.65768f, 24.75f, 0, true, 1);
									}
	...
	if (iLocal_78 == 1 || iLocal_78 == 4)
	{
		...
		else if (!func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), fLocal_43, 1))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_426))
			{
				func_26(&iLocal_426);
	...
	if (iLocal_78 == 2 || iLocal_78 == 6)
	{
		...
		else if (!func_66(iLocal_379, PLAYER::PLAYER_PED_ID(), fLocal_44, 1) && MISC::GET_GAME_TIMER() > iLocal_112 + 15000)
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_427))
			{
...
void func_294()
{
	...
	if (func_95(iLocal_383))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_426))
		{
			if (func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), fLocal_43, 1))
			{
	...
	if (func_95(iLocal_378[iLocal_78]))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_424[iLocal_78]))
		{
			if (PED::IS_PED_IN_COMBAT(iLocal_378[iLocal_78], PLAYER::PLAYER_PED_ID()) || MISC::GET_GAME_TIMER() > iLocal_112 + 50)
			{
				...
				{
					if (func_66(iLocal_378[iLocal_78], PLAYER::PLAYER_PED_ID(), fLocal_43, 1))
					{
						if (iLocal_78 == 5)
						{
	...
	if (iLocal_137 == 0)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_112 + 300)
		{
			if (func_19(iLocal_392))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_392, true, true, 0);
		...
		switch (iLocal_195)
		{
			...
			case 1:
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -371.3996f, -88.47154f, 44.65829f, -378.7455f, -85.82195f, 48.21037f, 5.75f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(-378.46f, -88.44f, 45.66f, 2f)) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_395)) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_383, 120f))
				{
					...
					iLocal_195 = 2;
					ENTITY::DETACH_ENTITY(iLocal_384[0], 1, true);
					ENTITY::DETACH_ENTITY(iLocal_384[1], 1, true);
					ENTITY::DETACH_ENTITY(iLocal_384[2], 1, true);
					ENTITY::DETACH_ENTITY(iLocal_384[3], 1, true);
			...
			case 3:
				if ((func_289(iLocal_378[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_392, -1.5f, 0f, 0f), 0.5f) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_378[5], 713668775) != 1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_378[5], 713668775) != 0)
				{
			...
			case 4:
				...
				{
					ENTITY::DETACH_ENTITY(iLocal_384[iLocal_126], 1, true);
				}
...
void func_304()
{
	if (iLocal_170 == 1)
	{
		if (func_95(iLocal_383))
		{
			if (!PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_383, 90f) || func_66(PLAYER::PLAYER_PED_ID(), iLocal_383, 50f, 1))
			{
...
void func_305()
{
	...
	if (func_95(iLocal_383) && func_19(iLocal_396))
	{
		...
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_395, 0))
		{
			...
			if (iLocal_153 == 0)
			{
				if (func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), 9f, 1))
				{
				...
				if (iLocal_191 == 0)
				{
					if ((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_383, "rcmepsilonism8", "jump_off_heli", 3) && ENTITY::FIND_ANIM_EVENT_PHASE("rcmepsilonism8", "jump_off_heli", "WalkInterruptible", &fVar0, &uVar1)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_383, "rcmepsilonism8", "jump_off_heli") >= fVar0)
					{
						...
						{
							PED::FORCE_PED_MOTION_STATE(iLocal_383, -668482597, false, 0, 0);
				...
				{
					if (func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), 6f, 1))
					{
						if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_383))
						{
					...
					if (func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), 9f, 1) && !func_66(iLocal_383, PLAYER::PLAYER_PED_ID(), 6f, 1))
					{
...
void func_310()
{
	...
	{
		if ((func_19(iLocal_396) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -383.1558f, -102.7442f, 37.43079f, -371.1183f, -109.4619f, 40.42916f, 13f, 0, true, 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_95(iLocal_383))
			{
				if (iLocal_153 == 1)
				...
				else
				{
					...
					if (iLocal_171 == 1)
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_395, 0))
						{
							...
							else if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_381[3], 30f, 1))
							{
								if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_393[3]))
								{
		...
		else if (iLocal_376 == 7)
		{
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (iLocal_78 == 5)
				{
					if (iLocal_139 == 0)
					{
						if (func_66(iLocal_378[5], PLAYER::PLAYER_PED_ID(), 4.5f, 1))
						{
				...
				if (iLocal_78 == 3)
				{
					if (iLocal_140 == 0)
					{
						if (func_66(iLocal_378[3], PLAYER::PLAYER_PED_ID(), 5f, 1))
						{
				...
				if (iLocal_78 == 4)
				{
					if (iLocal_141 == 0)
					{
						if (func_66(iLocal_378[4], PLAYER::PLAYER_PED_ID(), 5f, 1))
						{
	...
	else
	{
		...
		{
			if (func_66(iLocal_378[0], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
		...
		{
			if (func_66(iLocal_378[2], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
		...
		{
			if (func_66(iLocal_378[3], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
		...
		{
			if (func_66(iLocal_378[4], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
		...
		if (func_95(iLocal_378[5]))
		{
			if (func_66(iLocal_378[5], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_393[iLocal_78]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_393[iLocal_78], 0))
		{
			if (((MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_393[iLocal_78], true), joaat("WEAPON_GRENADE"), 4f, 1) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_393[iLocal_78], true), joaat("WEAPON_MOLOTOV"), 4f, 1)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_393[iLocal_78], true), joaat("WEAPON_SMOKEGRENADE"), 4f, 1)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_393[iLocal_78], true), joaat("WEAPON_STICKYBOMB"), 4f, 1))
			{
				iLocal_133 = 1;
			}
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_393[iLocal_78], 0))
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_392, 0))
	{
		if ((func_66(iLocal_392, PLAYER::PLAYER_PED_ID(), 3f, 1) || func_66(iLocal_392, iLocal_395, 3f, 1)) || func_297(iLocal_392, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) <= 3f)
		{
			PHYSICS::ACTIVATE_PHYSICS(iLocal_392);
		}
		if (func_311(PLAYER::PLAYER_PED_ID(), iLocal_392))
		{
			iLocal_133 = 1;
		}
...
void func_318()
{
	...
	func_310();
	func_308();
	if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_395, vLocal_56, 2f, 2f, 2f, false, true, 0))
	{
		func_290();
	}
	if (!PED::IS_PED_HEADTRACKING_PED(iLocal_383, PLAYER::PLAYER_PED_ID()))
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_395, vLocal_56, 2f, 2f, 2f, false, true, 0) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_395))
	{
		func_26(&iLocal_425);
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_395, vLocal_56, 2f, 2f, 2f, false, true, 0))
	{
		func_26(&iLocal_425);
	...
	{
		iLocal_190 = 0;
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_395, vLocal_56, 6f, 6f, 2f, true, true, 0))
		{
		}
	}
}
...
int func_329(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_336() || func_335(Global_4456448.f_190930)) || func_334())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
...
int func_330(int iParam0)
{
	if (iParam0 != func_80())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_331(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_342(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_345(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_343(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	if (func_19(iLocal_395))
	{
		if (func_95(iLocal_381[0]))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_395, 0))
			{
				...
				{
					if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_381[0], 40f, 1))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_395, 0))
						{
...
void func_352()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("TAXI")) && STREAMING::HAS_MODEL_LOADED(joaat("SADLER"))) && STREAMING::HAS_MODEL_LOADED(joaat("HABANERO"))) && STREAMING::HAS_MODEL_LOADED(joaat("SCHAFTER2"))) && STREAMING::HAS_MODEL_LOADED(joaat("RUMPO")))
	{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_399[iLocal_421 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_399[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_399[iLocal_421 /*3*/], 8f))
					{
						...
						if (iLocal_421 > 4 || func_289(PLAYER::PLAYER_PED_ID(), vLocal_56, 150f))
						{
							iLocal_397[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_399[iLocal_421 /*3*/], vLocal_399[iLocal_421 /*3*/].f_1, fVar2, fLocal_400[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_397[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_397[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_397[iLocal_421], 70f, 1))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_403[iLocal_421 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_403[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_403[iLocal_421 /*3*/], 8f))
					{
						...
						iLocal_401[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_403[iLocal_421 /*3*/], vLocal_403[iLocal_421 /*3*/].f_1, fVar2, fLocal_404[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_401[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_401[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_401[iLocal_421], 70f, 1))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_407[iLocal_421 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_407[iLocal_421 /*3*/], 220f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_407[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_407[iLocal_421 /*3*/], 8f))
					{
						...
						iLocal_405[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_407[iLocal_421 /*3*/], vLocal_407[iLocal_421 /*3*/].f_1, fVar2, fLocal_408[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_405[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_405[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_405[iLocal_421], 70f, 1))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_411[iLocal_421 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_411[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_411[iLocal_421 /*3*/], 8f))
					{
						...
						iLocal_409[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_411[iLocal_421 /*3*/], vLocal_411[iLocal_421 /*3*/].f_1, fVar2, fLocal_412[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_409[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_409[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_409[iLocal_421], 70f, 1))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_415[iLocal_421 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_415[iLocal_421 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_415[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_415[iLocal_421 /*3*/], 8f))
					{
						...
						iLocal_413[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_415[iLocal_421 /*3*/], vLocal_415[iLocal_421 /*3*/].f_1, fVar2, fLocal_416[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_413[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_413[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_413[iLocal_421], 60f, 1))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_419[iLocal_421 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_419[iLocal_421 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_419[iLocal_421 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_419[iLocal_421 /*3*/], 8f))
					{
						...
						iLocal_417[iLocal_421] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_419[iLocal_421 /*3*/], vLocal_419[iLocal_421 /*3*/].f_1, fVar2, fLocal_420[iLocal_421], true, true, false);
			...
			else if (func_18(iLocal_417[iLocal_421]))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_417[iLocal_421]))
				{
					...
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_417[iLocal_421], 60f, 1))
						{
...
void func_356()
{
	iLocal_392 = VEHICLE::CREATE_VEHICLE(joaat("MAVERICK"), vLocal_60, fLocal_72, true, true, false);
	...
	iLocal_393[2] = VEHICLE::CREATE_VEHICLE(joaat("SENTINEL"), vLocal_58[2 /*3*/], fLocal_69[2], true, true, false);
	...
	iLocal_393[3] = VEHICLE::CREATE_VEHICLE(joaat("SENTINEL"), vLocal_58[3 /*3*/], fLocal_69[3], true, true, false);
...
void func_366()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_395))
	{
		iLocal_395 = VEHICLE::CREATE_VEHICLE(joaat("TAILGATER"), vLocal_62, fLocal_73, true, true, false);
...
void func_368()
{
	...
	switch (iLocal_375)
	{
		case 0:
			if (iLocal_130 == 0)
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					{
						func_446(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -676.7216f, 46.6862f, 41.7595f, 91.6871f, 0, 1);
					...
					{
						func_446(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -719.0406f, 32.5248f, 41.7419f, 287.2928f, 0, 1);
			...
			else if (iLocal_130 == 1)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_18(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
					{
						if (!ENTITY::IS_ENTITY_AT_COORD(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -703.656f, 37.143f, 42.2135f, 9f, 9f, 9f, false, true, 0))
						{
							VEHICLE::SET_VEHICLE_FORWARD_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 5f);
						}
					}
				}
				if (MISC::GET_GAME_TIMER() > iLocal_129 + 6000 || func_444(1000))
				{
					iLocal_130 = 2;
				}
			}
			else if (iLocal_130 == 2)
			{
				...
				if (func_439(1, 1093140480, 0))
				{
					...
					PATHFIND::SET_ROADS_IN_ANGLED_AREA(-651.3148f, 121.844f, 63.45312f, -650.0618f, 0.95496f, 35.75433f, 41.75f, 0, false, 1);
					iLocal_375 = 1;
				}
			}
			break;
		...
		case 1:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (iLocal_189 == 0)
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_395, 0))
					{
						VEHICLE::SET_VEHICLE_USE_CUTSCENE_WHEEL_COMPRESSION(iLocal_395, 1, 1, 1);
					}
				}
		...
		case 2:
			...
			if (Global_111560.f_18569.f_387 == 0)
			{
				func_378(0, 29, 50000);
				Global_111560.f_18569.f_387 = 1;
			}
			func_369(1, 1, 1, 1);
			if (func_19(iLocal_395))
			{
...
void func_383(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_430(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_427(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_384(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_385(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_415(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_404();
			}
...
void func_386(int iParam0, int iParam1)
{
	...
	func_422(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_387(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_402(iParam0, 0, 0)) || func_402(iParam0, 1, 0)) || func_402(iParam0, 2, 0)) || func_421(iParam0) != 145) || func_401(iParam0)) || func_400(iParam0)) || func_399(iParam0)) || func_398(iParam0)) || !func_388(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_400(iParam0))
		{
		}
...
int func_415(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_341(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_418(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_415(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_420(iParam0);
			func_419(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_439(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_319(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	while (iVar6 <= 14)
	{
		...
		if (iVar0 != 12 && iVar0 != 14)
		{
			...
			else
			{
				...
				{
					Var1.f_3 = Global_111560.f_2358.f_539[Var1.f_5 /*65*/].f_13[iVar6];
					Var1.f_4 = Global_111560.f_2358.f_539[Var1.f_5 /*65*/][iVar6];
				}
...
void func_449()
{
	...
	{
		iLocal_393[0] = VEHICLE::CREATE_VEHICLE(joaat("LANDSTALKER"), vLocal_58[0 /*3*/], fLocal_69[0], true, true, false);
...
void func_450()
{
	...
	func_364(&uLocal_198, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_357(51, 0, 0);
}
		...
		if (iLocal_134 == 1)
		{
			if (func_95(iLocal_383))
			{
				if ((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_383, "rcmepsilonism8", "worship_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_383, "rcmepsilonism8", "worship_base", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_383, "rcmepsilonism8", "worship_idle_a", 3))
				{
					...
					{
						PED::FORCE_PED_MOTION_STATE(iLocal_383, -530524, false, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_383, true);
		...
		if (!func_299() || !iLocal_161 == 1)
		{
			if (iLocal_133 == 1)
			{
				...
				if (func_95(iLocal_383))
				{
					...
					if (func_18(iLocal_392) && PED::IS_PED_IN_VEHICLE(iLocal_383, iLocal_392, 0))
					{
				...
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(-651.3148f, 121.844f, 63.45312f, -650.0618f, 0.95496f, 35.75433f, 41.75f, 0, true, 1);
				...
				if (!MISC::IS_BIT_SET(Global_111560.f_18569.f_382, 1))
				{
					MISC::SET_BIT(&(Global_111560.f_18569.f_382), 1);
				}
				iLocal_376 = 8;
			}
		}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_395))
			{
				...
				else
				{
					...
					if (iLocal_376 != 7)
					{
						if (iLocal_144 == 0)
						{
							if (!func_66(iLocal_395, PLAYER::PLAYER_PED_ID(), 150f, 1))
							{
								if ((iLocal_121 != -1 && func_95(iLocal_378[iLocal_121])) && PED::IS_PED_IN_VEHICLE(iLocal_378[iLocal_121], iLocal_395, 0))
								{
						...
						{
							if (!func_66(iLocal_395, PLAYER::PLAYER_PED_ID(), 230f, 1))
							{
								if ((iLocal_121 != -1 && func_95(iLocal_378[iLocal_121])) && PED::IS_PED_IN_VEHICLE(iLocal_378[iLocal_121], iLocal_395, 0))
								{
									sLocal_194 = "EPS8_26";
							...
							else if (func_66(iLocal_395, PLAYER::PLAYER_PED_ID(), 100f, 1))
							{
							}
						}
					}
		...
		else if (ENTITY::DOES_ENTITY_EXIST(iLocal_392))
		{
			...
			else
			{
				...
				if (iLocal_376 != 7)
				{
					if (iLocal_144 == 0)
					{
						if (!func_66(iLocal_392, PLAYER::PLAYER_PED_ID(), 150f, 1))
						{
							func_298("EPS8_16", 7500, 0);
							iLocal_144 = 1;
						}
					}
					else if (!func_66(iLocal_392, PLAYER::PLAYER_PED_ID(), 230f, 1))
					{
						sLocal_194 = "EPS8_17";
						iLocal_376 = 10;
					}
					else if (func_66(iLocal_392, PLAYER::PLAYER_PED_ID(), 100f, 1))
					{
						iLocal_144 = 0;
					}
				}
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_464(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_475(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_477(iParam0, Global_41396);
}
...
void func_491()
{
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[0], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[0], 1);
	}
	if (func_19(iLocal_393[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[1], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[1], 1);
	}
	if (func_19(iLocal_393[2]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[2], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[2], 1);
	}
	if (func_19(iLocal_393[3]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[3], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[3], 1);
	}
	if (func_19(iLocal_393[4]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[4], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[4], 1);
	}
	if (func_19(iLocal_393[5]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[5], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[5], 1);
	}
	if (func_19(iLocal_393[6]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_393[6], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_393[6], 1);
	}
	if (func_19(uLocal_394[0]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_394[0], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(uLocal_394[0], 1);
	}
	if (func_19(uLocal_394[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_394[1], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(uLocal_394[1], 1);
	}
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_CHOPPER"))
	{
		AUDIO::STOP_AUDIO_SCENE("EPSILONISM_08_CHOPPER");
...
int func_507(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_513())
	{
		...
		{
			iVar2 = func_508(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_509()
{
	...
	iVar0 = func_510(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_513()
{
	...
	{
		if (func_508(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
