...
void __EntryFunction__()
{
	...
	func_280(&uLocal_74, 3);
	if (!Global_3)
	{
		if (func_238(vLocal_48, -1, 0, 0, 0))
		{
			func_235(-1);
		}
		else
	...
	while (true)
	{
		...
		if (!func_231())
		{
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_130)
				{
					...
					case 1:
						if ((func_201() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
						{
						...
						{
							func_191(1);
							iLocal_121 = func_190(iLocal_67, 0, 145);
		...
		else
		{
			...
			if (((iLocal_45 != 5 && iLocal_45 != 6) && iLocal_45 != 10) && iLocal_45 != 7)
			{
				if (!Global_3 && !bLocal_56)
				{
					if (func_74(iLocal_67, 1, 1) || func_73())
					{
						if (iLocal_45 > 0)
						{
							func_188(5);
	...
	switch (iLocal_47)
	{
		case 0:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_pap_camera_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("cavalcade2"))) && STREAMING::HAS_MODEL_LOADED(joaat("VADER"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_134)) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@pap_anims"))
			{
				...
				func_64(func_65(2), vLocal_161[1 /*3*/], fLocal_162[1]);
				func_64(func_65(3), vLocal_161[1 /*3*/], fLocal_162[1]);
				func_63(0, vLocal_161[0 /*3*/], fLocal_162[0], 1);
				func_63(1, vLocal_161[1 /*3*/], fLocal_162[1], 0);
		...
		case 2:
			...
			switch (iLocal_165)
			{
				case 0:
					...
					{
						func_63(2, vLocal_161[2 /*3*/], fLocal_162[2], 0);
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[2 /*18*/], 0))
						{
							func_64(func_67(2), ENTITY::GET_ENTITY_COORDS(Local_108[2 /*18*/], true), 0f);
							PED::SET_PED_INTO_VEHICLE(func_62(2, 0), Local_108[2 /*18*/], -1);
						}
					}
					if (!ENTITY::DOES_ENTITY_EXIST(Local_108[3 /*18*/]))
					{
						func_63(3, vLocal_161[3 /*3*/], fLocal_162[3], 0);
					}
					if (!PED::IS_PED_INJURED(func_62(2, 1)))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_62(2, 1), vLocal_156, 2f, -1, 1048576000, 0, 1193033728);
					}
					if (!PED::IS_PED_INJURED(func_62(3, 1)))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_62(3, 1), vLocal_157, 2f, -1, 1048576000, 0, 1193033728);
					}
					...
					if (Global_3 || bLocal_56)
					{
						if (!PED::IS_PED_INJURED(func_62(1, 0)))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_62(1, 0), vLocal_158, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_62(1, 1)))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_62(1, 1), vLocal_159, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_62(0, 1)))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_62(0, 1), vLocal_160, 2f, 20000, 1048576000, 0, 1193033728);
						}
					}
					SYSTEM::SETTIMERB(0);
					iVar1 = 0;
				...
				case 1:
					func_55();
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[0 /*18*/], 0) && !PED::IS_PED_INJURED(func_62(0, 0))) && !PED::IS_PED_INJURED(func_62(0, 1)))
					{
						if (!iLocal_152[1])
						{
							iLocal_152[1] = 1;
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_62(0, 0), Local_108[0 /*18*/], vLocal_154, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
						}
					}
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[2 /*18*/], 0) && !PED::IS_PED_INJURED(func_62(2, 0))) && !PED::IS_PED_INJURED(func_62(2, 1)))
					{
						if (!iLocal_152[0])
						{
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_62(2, 0), Local_108[2 /*18*/], vLocal_155, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
							iLocal_152[0] = 1;
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_67) && !PED::IS_PED_INJURED(iLocal_67))
					{
						...
						if (Global_3 || bLocal_56)
						{
							if (!PED::IS_PED_INJURED(func_62(1, 0)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_62(1, 0), vLocal_158, Global_22, false, true, 0))
								{
									func_51(iLocal_67, func_67(1));
								}
							}
							if (!PED::IS_PED_INJURED(func_62(1, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_62(1, 1), vLocal_159, Global_22, false, true, 0))
								{
									func_51(iLocal_67, func_65(1));
								}
							}
							if (!PED::IS_PED_INJURED(func_62(0, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_62(0, 1), vLocal_159, Global_22, false, true, 0))
								{
									func_51(iLocal_67, func_65(0));
								}
							}
						}
						else
						{
							func_52(iLocal_67, func_67(1));
							func_52(iLocal_67, func_65(1));
					...
					{
						if (ENTITY::IS_ENTITY_AT_COORD(func_62(2, 1), vLocal_156, Global_22, false, true, 0))
						{
							func_51(iLocal_67, func_65(2));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_62(3, 1), vLocal_157, Global_22, false, true, 0))
						{
							func_51(iLocal_67, func_65(3));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_62(0, 1), vLocal_157, Global_22, false, true, 0))
						{
							func_51(iLocal_67, func_65(0));
						}
					}
					else
					{
						...
						{
							TASK::CLEAR_PED_TASKS(Local_109[func_65(3) /*18*/]);
							MISC::SET_BIT(&iLocal_168, 3);
						}
						if (!MISC::IS_BIT_SET(iLocal_168, 2))
						{
							TASK::CLEAR_PED_TASKS(Local_109[func_65(2) /*18*/]);
							MISC::SET_BIT(&iLocal_168, 2);
						}
						if (!MISC::IS_BIT_SET(iLocal_168, 0))
						{
							TASK::CLEAR_PED_TASKS(Local_109[func_65(0) /*18*/]);
						...
						{
							func_52(iLocal_67, func_65(3));
						}
						func_52(iLocal_67, func_65(2));
						func_52(iLocal_67, func_65(0));
					}
					break;
			}
			func_50();
									...
									if (iVar3 != -1)
									{
										...
										if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]) && (iVar3 != -1 && !PED::IS_PED_INJURED(Local_109[iVar3 /*18*/])))
										{
											if ((PED::IS_PED_IN_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0) && (iVar3 != -1 && PED::IS_PED_IN_VEHICLE(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
											{
												...
												TASK::SET_DRIVE_TASK_CRUISE_SPEED(Local_109[iVar2 /*18*/], func_45((3f * MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_54, Local_108[iVar0 /*18*/].f_8, true)), 50f, 120f));
											}
										}
									}
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iVar0 /*18*/], 0))
					{
						...
						if (iVar6 != -1)
						{
							...
							if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]) && (iVar6 != -1 && !PED::IS_PED_INJURED(Local_109[iVar6 /*18*/])))
							{
								...
								{
									fVar7 = func_45((70f - (SYSTEM::TO_FLOAT((MISC::GET_GAME_TIMER() - iLocal_66)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (MISC::GET_GAME_TIMER() - iLocal_66) > 4000)
									{
										...
										{
											if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iVar8 /*18*/], 0) && !PED::IS_PED_INJURED(func_62(iVar8, 0))) && PED::IS_PED_IN_VEHICLE(func_62(iVar8, 0), Local_108[iVar8 /*18*/], 0))
											{
												TASK::CLEAR_PED_TASKS(func_62(iVar8, 0));
												TASK::TASK_VEHICLE_MISSION(func_62(iVar8, 0), Local_108[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_167 = 1;
				...
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_134))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/].f_2) && ENTITY::IS_ENTITY_ATTACHED(Local_109[iVar0 /*18*/].f_2))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iVar0 /*18*/], sLocal_134, func_33(iVar0), 3))
								{
						...
						if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/]) && func_32(Local_109[iVar0 /*18*/], PED::GET_VEHICLE_PED_IS_IN(Local_109[iVar0 /*18*/], 0)) == -1)
						{
							if (ENTITY::IS_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2))
							{
								ENTITY::SET_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2, false, 0);
...
void func_34(int iParam0)
{
	...
	while (iVar0 < 15)
	{
		if (MISC::IS_BIT_SET(Local_109[iParam0 /*18*/].f_15, iVar0))
		{
			...
			if (iVar3 < iVar1)
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0), 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0)) > 0.9f)
					{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_108[iLocal_149 /*18*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iLocal_149 /*18*/], 0)) && ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/])) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			if (VEHICLE::IS_VEHICLE_MODEL(Local_108[iLocal_149 /*18*/], joaat("cavalcade2")))
			{
				if (SYSTEM::VDIST2(Local_109[iVar0 /*18*/].f_6, vLocal_53) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					...
					else if (!func_42(iVar0) && (MISC::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_13) > 1000)
					{
...
void func_37(int iParam0, int iParam1)
{
	if (iParam1 < 15)
	{
		if (!MISC::IS_BIT_SET(Local_109[iParam0 /*18*/].f_15, iParam1))
		{
			if (func_39(iParam1))
			{
				TASK::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[func_38(iParam1)], 4f, -4f, -1, 16, 0, 0, 0, 0);
			}
			else if (iParam1 < 5)
			{
				TASK::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0), 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else
			{
...
int func_44(int iParam0, float fParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_62(iParam0, 0)))
	{
		...
		{
			if (SYSTEM::VDIST2(vLocal_52, Local_109[func_67(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !ENTITY::IS_ENTITY_OCCLUDED(func_62(iParam0, 0)))
			{
				iVar0 = 0;
			}
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_62(iParam0, 1)))
	{
		...
		{
			if (SYSTEM::VDIST2(vLocal_52, Local_109[func_65(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !ENTITY::IS_ENTITY_OCCLUDED(func_62(iParam0, 1)))
			{
				iVar0 = 0;
			}
		}
...
void func_46(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1)))
		{
			...
			{
				if (func_49(iParam0, iParam1, iLocal_119, ENTITY::GET_ENTITY_COORDS(iParam1, true), ENTITY::GET_ENTITY_ROTATION(iParam1, 2)))
				{
					*uParam2 = { *uParam4 };
					*uParam3 = *uParam5;
			...
			{
				if ((func_48(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, true), *uParam2, true) > 20f) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), *uParam2) > 100f)
				{
					if (!func_47(*uParam2))
					{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_148) > 100)
	{
		if ((MISC::GET_GAME_TIMER() - Local_109[iLocal_147 /*18*/].f_12) > 500)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_109[iLocal_147 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iLocal_147 /*18*/]))
			{
				...
				if (bVar0)
				{
					if (((ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147), 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147)) > 0.5f) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147)) < 0.75f) || Local_109[iLocal_147 /*18*/].f_9)
					{
						...
						if ((iLocal_147 % 3) == 0)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(-1, "SHUTTER_FLASH", ENTITY::GET_ENTITY_COORDS(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", false, 0, 0);
						}
						else if ((iLocal_147 % 3) == 1)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(-1, "SHUTTER", ENTITY::GET_ENTITY_COORDS(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", false, 0, 0);
						}
						else
						{
							AUDIO::PLAY_SOUND_FROM_COORD(-1, "FLASH", ENTITY::GET_ENTITY_COORDS(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", false, 0, 0);
						}
...
void func_51(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(Local_109[iParam1 /*18*/]) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_33(iParam1), 3))
			{
				TASK::TASK_PLAY_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_33(iParam1), 4f, -4f, -1, 0, 0, 0, 0, 0);
...
void func_53(vector3 vParam0, int iParam1, int iParam2)
{
	...
	vVar0 = { func_41(ENTITY::GET_ENTITY_COORDS(iParam2, true) - vParam0) };
...
void func_55()
{
	...
	while (iVar0 < Local_109)
	{
		...
		{
			Local_109[iVar0 /*18*/].f_1 = func_190(Local_109[iVar0 /*18*/], 1, 145);
...
void func_60(int iParam0, vector3 vParam1, float fParam2, char* sParam3, char* sParam4, char* sParam5)
{
	if (!PED::IS_PED_INJURED(Local_109[iParam0 /*18*/]))
	{
		...
		else if (MISC::ABSF((func_61(ENTITY::GET_ENTITY_HEADING(Local_109[iParam0 /*18*/])) - func_61(fParam2))) > 10f)
		{
...
var func_62(int iParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		return Local_109[func_67(iParam0) /*18*/];
	}
	return Local_109[func_65(iParam0) /*18*/];
}

void func_63(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if ((iParam0 % 2) == 1)
	{
	...
	if (bParam3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_62(iParam0, 0)))
		{
			func_64(func_67(iParam0), vParam1, fParam2);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(func_62(iParam0, 1)))
		{
			func_64(func_65(iParam0), vParam1, fParam2);
		}
		if (!PED::IS_PED_INJURED(func_62(iParam0, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iParam0 /*18*/], 0))
		{
			PED::SET_PED_INTO_VEHICLE(func_62(iParam0, 0), Local_108[iParam0 /*18*/], -1);
		}
		if (!PED::IS_PED_INJURED(func_62(iParam0, 1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iParam0 /*18*/], 0))
		{
			PED::SET_PED_INTO_VEHICLE(func_62(iParam0, 1), Local_108[iParam0 /*18*/], 0);
		}
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_108[iParam0 /*18*/], true, true, 0);
	}
}

void func_64(int iParam0, vector3 vParam1, float fParam2)
{
...
int func_69()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		if (func_72())
		{
			...
			{
				if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(func_71(), true), vLocal_53) < 5f && ENTITY::GET_ENTITY_SPEED(iLocal_70) < 1f)
				{
					bVar0 = true;
				}
			}
		...
		if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0) && func_70(iLocal_70)) && (!bLocal_129 || iLocal_45 == 1)) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), vLocal_50) > 15f)
		{
			bVar1 = true;
		}
...
int func_73()
{
	...
	while (iVar0 < Local_109)
	{
		if (func_74(Local_109[iVar0 /*18*/], 0, 0))
		{
			return 1;
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]))
...
int func_74(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (SYSTEM::VDIST2(vVar0, vLocal_52) < 400f)
		{
			...
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0)) && (func_75(vLocal_52, iParam0) && SYSTEM::VDIST2(vLocal_52, ENTITY::GET_ENTITY_COORDS(iParam0, true)) < 100f)) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				return 1;
			}
			if (iLocal_137 > 150)
...
int func_75(vector3 vParam0, int iParam1)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_91(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (!iLocal_203)
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(func_71(), true)) < 100f)
				{
					...
					if (func_24() == 1)
					{
						...
						{
							case 0:
								func_22(&Local_139, 6, func_71(), "PAP1ESCAPE", 0, 1);
							...
							case 1:
								func_22(&Local_139, 7, func_71(), "PAP2ESCAPE", 0, 1);
							...
							case 2:
								func_22(&Local_139, 8, func_71(), "PAP3ESCAPE", 0, 1);
					...
					else if (func_24() == 2)
					{
						...
						switch (iVar2)
						{
							...
							case 1:
								func_22(&Local_139, 5, func_71(), "PAP2ESCAPE", 0, 1);
								if (ENTITY::DOES_ENTITY_EXIST(Local_139[iVar2 /*10*/]) && !PED::IS_PED_INJURED(Local_139[iVar2 /*10*/]))
								{
...
void func_107(char* sParam0)
{
	...
	while (iVar0 < Local_108)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar0 /*18*/]))
		{
			if ((ENTITY::IS_ENTITY_OCCLUDED(Local_108[iVar0 /*18*/]) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_108[iVar0 /*18*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 2500f) && func_58(Local_108[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0, 1))
			{
	...
	if (func_73() || func_74(iLocal_67, 1, 1))
	{
		func_188(5);
	}
	iVar0 = 0;
...
void func_111()
{
	...
	switch (iLocal_130)
	{
		...
		case 1:
			if (!func_79() && !PED::IS_PED_INJURED(iLocal_67))
			{
		...
		switch (iLocal_130)
		{
			case 0:
				if (!PED::IS_PED_INJURED(iLocal_67) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					...
					{
						while (!func_149(&Local_139, cLocal_133, "REPAP_THK", "REPAP_THK_1", 4, 0, 0))
						{
							SYSTEM::WAIT(0);
						}
					}
...
int func_158(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_160()
{
	...
	if (bLocal_129 && !PED::IS_PED_INJURED(iLocal_67))
	{
		...
		else if (iLocal_130 != 100)
		{
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0))
			{
				...
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, -1, func_178(iLocal_70), 2f, 8388608, 0);
				}
			}
		}
	}
	...
	switch (iLocal_130)
	{
		...
		case 100:
			if (func_162(iLocal_70, 5f, 5, 1056964608, 0, 1, 0))
			{
				func_189("");
				func_188(3);
			}
	...
	if (func_24() == 2)
	{
		if ((func_161() && !func_174()) && iLocal_45 != 8)
		{
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
...
int func_162(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_165(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			if (func_167(&Local_139, cLocal_133, sParam0, &Local_61, 4, 0, 0))
			{
				iLocal_59 = 0;
			}
		}
...
void func_169()
{
	if (func_24() == 2)
	{
		...
		{
			func_172();
			iLocal_125 = func_171(-1034.6f, 4918.6f, 205.9f, 0);
...
int func_171(vector3 vParam0, bool bParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0) && !PED::IS_PED_INJURED(iLocal_67))
	{
		...
		else
		{
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_70, 0))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_122))
				{
					iLocal_122 = func_176(iLocal_70, 0, 0);
				}
			}
			if (!PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0))
			{
...
void func_182()
{
	if (!PED::IS_PED_INJURED(iLocal_67) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
	{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(func_71()) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), ENTITY::GET_ENTITY_COORDS(func_71(), true)) < 100f) && (ENTITY::GET_ENTITY_SPEED(iLocal_70) < 5f || !VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iLocal_70))))
		{
			if (bLocal_129)
			{
		...
		switch (iLocal_130)
		{
			case 0:
				if (SYSTEM::TIMERA() > 2000)
				{
					...
					{
						func_23(&Local_139, 4);
						func_22(&Local_139, 4, func_71(), "PAPARAZZO", 0, 1);
					}
					iLocal_47 = 2;
					func_108();
			...
			case 2:
				if (!bLocal_198)
				{
					...
					{
						bLocal_199 = false;
						if (ENTITY::DOES_ENTITY_EXIST(func_71()) && ENTITY::IS_ENTITY_AT_ENTITY(func_71(), iLocal_70, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_198 = true;
						}
					}
				...
				else
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(func_71()))
					{
						if (!ENTITY::IS_ENTITY_AT_ENTITY(func_71(), iLocal_70, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_198 = false;
						}
					}
				...
				else
				{
					...
					{
						case 0:
							if (((!bLocal_198 && func_168()) && !func_80()) && !func_79())
							{
						...
						case 4:
							if ((MISC::GET_GAME_TIMER() - iLocal_201) > 6000)
							{
								if (func_24() == 0)
								{
									if (func_165("REPAP_CHT3M", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								...
								{
									if (func_165("REPAP_CHT3F", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								else if (func_165("REPAP_CHT3T", ((func_168() && !func_80()) && !bLocal_198)))
								{
									iLocal_200++;
								}
								if (iLocal_200 > 4)
						...
						case 5:
							if ((MISC::GET_GAME_TIMER() - iLocal_201) > 8000)
							{
								if (func_24() == 0)
								{
									if (func_165("REPAP_CHT4M", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								...
								{
									if (func_165("REPAP_CHT4F", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								else if (func_165("REPAP_CHT4T", ((func_168() && !func_80()) && !bLocal_198)))
								{
									iLocal_200++;
								}
								if (iLocal_200 > 5)
						...
						case 6:
							if ((MISC::GET_GAME_TIMER() - iLocal_201) > 8000)
							{
								if (func_24() == 0)
								{
									if (func_165("REPAP_CHT5M", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								...
								{
									if (func_165("REPAP_CHT5F", ((func_168() && !func_80()) && !bLocal_198)))
									{
										iLocal_200++;
									}
								}
								else if (func_165("REPAP_CHT5T", ((func_168() && !func_80()) && !bLocal_198)))
								{
									iLocal_200++;
								}
								if (iLocal_200 > 6)
...
void func_184()
{
	...
	{
		if ((!PED::IS_PED_INJURED(iLocal_67) && ENTITY::DOES_ENTITY_EXIST(func_71())) && !PED::IS_PED_INJURED(func_71()))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, ENTITY::GET_ENTITY_COORDS(func_71(), true), true) < 8f)
			{
				...
				switch (iVar0)
				{
					...
					case 2:
						func_22(&Local_139, 5, func_71(), "PAP2", 0, 1);
					...
					case 3:
						func_22(&Local_139, 6, func_71(), "PAP3", 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(Local_139[6 /*10*/]) && !PED::IS_PED_INJURED(Local_139[6 /*10*/]))
						{
					...
					case 4:
						func_22(&Local_139, 7, func_71(), "PAP4", 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(Local_139[7 /*10*/]) && !PED::IS_PED_INJURED(Local_139[7 /*10*/]))
						{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		switch (iLocal_130)
		{
				...
				if (bVar0 || bVar1)
				{
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_173) > 5000 && iLocal_190 == 0)
					{
						if (SYSTEM::VDIST2(vLocal_52, vLocal_53) < (22.2f * 22.2f))
						{
							...
							if (func_24() == 1)
							{
								func_22(&Local_139, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							}
							else if (func_24() == 0)
							{
								func_22(&Local_139, 1, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
							}
							else
							{
								func_22(&Local_139, 1, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							}
			...
			case 3:
				...
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_70, 1);
					if (func_149(&Local_139, cLocal_133, "REPAP_EXP", "REPAP_EXP_2", 4, 0, 0))
					{
						SYSTEM::SETTIMERA(0);
						bLocal_194 = true;
						iLocal_130 = 100;
				...
				else if (func_149(&Local_139, cLocal_133, "REPAP_EXPB", "REPAP_EXPB_2", 4, 0, 0))
				{
					SYSTEM::SETTIMERA(0);
					bLocal_194 = true;
					iLocal_130++;
			...
			case 4:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, iLocal_67, Global_19, 0, 1, 0) && func_180(iLocal_70)) && (SYSTEM::TIMERA() > 6000 || !bLocal_129))
					{
						if (!iLocal_172)
						{
							func_108();
						...
						else
						{
							...
							TASK::CLEAR_PED_TASKS(iLocal_67);
							TASK::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, -1, func_178(iLocal_70), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case -5:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					if (func_162(iLocal_70, 1093140480, 1, 1056964608, 0, 1, 0))
					{
						iLocal_130 = 5;
					}
				}
			...
			case 101:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_70, 0) && func_187())
					{
						bLocal_129 = true;
						iLocal_60 = 1;
						iLocal_70 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
					...
					if (!iLocal_60)
					{
						if (SYSTEM::VDIST2(vLocal_52, vLocal_54) < 9f && func_24() == 0)
						{
...
void func_186(vector3 vParam0, bool bParam1)
{
...
void func_205(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_221()
{
	if (!iLocal_73)
	{
		func_229(&uLocal_74, joaat("SURANO"));
		func_229(&uLocal_74, joaat("prop_ld_test_01"));
		func_229(&uLocal_74, joaat("a_f_y_bevhills_03"));
		func_229(&uLocal_74, joaat("a_m_y_genstreet_02"));
		func_229(&uLocal_74, joaat("VADER"));
		func_229(&uLocal_74, joaat("cavalcade2"));
		func_229(&uLocal_74, joaat("prop_pap_camera_01"));
		func_226(&uLocal_74);
		iLocal_73 = 1;
	}
	if (!func_222(&uLocal_74))
	{
		return 0;
	}
...
void func_234(int iParam0, char* sParam1, int iParam2)
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_225(*iParam0))
...
int func_238(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_26(func_24()))
		{
			if (!func_275(iParam1, iParam2, 145))
			{
				return 0;
			}
		}
		if (!func_274(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (func_263(iParam1, iParam2) && !bParam3)
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (iParam2 == 2 || iParam2 == 5)) && !func_263(0, 0))
		{
			return 0;
		}
		if (Global_30882)
...
bool func_239(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
