			...
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_52)
				{
					...
					case 1:
						...
						if (iLocal_69 == 0)
						{
							iLocal_69 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101, vLocal_53, 30000f);
						}
						...
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							...
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_55, vLocal_53, 200f, -1, 0, 0);
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (CAM::IS_SPHERE_VISIBLE(vLocal_53, 2.5f))
								{
									if (iLocal_65 == 2)
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 120f, 120f, 8f, 0, 1, 0) || func_195())
										{
											func_186();
										}
									}
									else if (iLocal_65 == 1)
									{
										if (SYSTEM::VDIST(vLocal_53, -203.758f, -861.738f, 29.2684f) < 5f)
										{
											if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 100f, 100f, 8f, 0, 1, 0) || func_195())
											{
												func_186();
											}
										}
										else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 170f, 170f, 8f, 0, 1, 0) || func_195())
										{
											func_186();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 65f, 65f, 5f, 0, 1, 0) || func_195())
										{
											func_186();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 50f, 50f, 5f, 0, 1, 0) || func_195())
										{
											func_186();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 60f, 60f, 5f, 0, 1, 0) || func_195())
										{
											func_186();
										}
									}
									else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 30f, 30f, 8f, 0, 1, 0) || func_195())
									{
										func_186();
									}
								}
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_56, vLocal_53, 200f, -1, 0, 0);
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!func_132() && !func_129())
				{
					...
					if (HUD::DOES_BLIP_EXIST(iLocal_59))
					{
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							...
							else if (!iLocal_87)
							{
								...
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
								{
									if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_73, PLAYER::PLAYER_PED_ID(), 1))
									{
										...
										{
											TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_55, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 35f, 4, 10f, 10f, 1);
										}
										else
										{
											TASK::TASK_SMART_FLEE_PED(iLocal_55, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
							{
								if (!iLocal_87)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 10f, 0, 1, 0))
									{
										if (func_122(&Local_107, cLocal_123, sLocal_116, 4, 0, 0, 0))
										{
											...
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -4f, -1, 1, 0, 0, 0, 0);
								...
								else if (!iLocal_88)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 10f, 0, 1, 0))
									{
										if (((!PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_55) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)) && !PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) && func_118(iLocal_56, iLocal_55, 1) > 30f)
										{
							...
							if (func_114())
							{
								...
								if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_55, vVar0, 25f, 25f, 25f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 12f, 12f, 12f, 0, 1, 0))
								{
									...
									{
										if (func_112(iLocal_55) && !PED::IS_PED_RAGDOLL(iLocal_55))
										{
						...
						{
							if ((PED::IS_PED_INJURED(iLocal_55) || PED::IS_PED_DEAD_OR_DYING(iLocal_55, 1)) || func_182(iLocal_55, -1899872703))
							{
						...
						if (!bLocal_100)
						{
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_56, false)) > (fLocal_82 + 100f))
								{
									...
									{
										TASK::TASK_SMART_FLEE_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
										func_278();
									}
								}
	...
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (!bLocal_99)
		{
			if (iLocal_129)
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, fLocal_83, fLocal_83, fLocal_83, 0, 1, 0) && !func_100())
				{
					if (func_97(2))
					{
						HUD::CLEAR_HELP(1);
								...
								if (!MISC::IS_BIT_SET(Global_7356, 11) || func_95())
								{
									if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
										{
											...
											{
												while ((!func_83(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_84, 1, 1056964608, 0, 1, 0) || func_94()) || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_57))
												{
													if (!func_83(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_84, 1, 1056964608, 0, 1, 0))
													{
													}
													if (func_94())
													{
										...
										{
											while (func_94() || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_57))
											{
												SYSTEM::WAIT(0);
											}
										}
				...
				{
					func_73(ENTITY::GET_ENTITY_COORDS(iLocal_56, true), &fLocal_83, &fLocal_84);
					if (!func_100())
					{
						if (!func_182(iLocal_56, 1227113341) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
						{
							TASK::CLEAR_PED_TASKS(iLocal_56);
							TASK::TASK_GO_TO_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 1f, 1073741824, 0);
						}
					}
					else if (func_182(iLocal_56, 1227113341))
					{
						...
						TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -8f, -1, 1, 0, 0, 0, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 25f, 25f, 20f, 0, 1, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 30f, 30f, 20f, 0, 1, 2))
			{
				if (!func_100())
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
						TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 1f, 1073741824, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
					}
			...
			switch (iLocal_98)
			{
				case 0:
					if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
					{
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_78, (vLocal_137.y + 1f), (vLocal_137.y + 1f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, vLocal_78, vLocal_79, 0, 2), (vLocal_137.y + 1f), (vLocal_137.y + 1f), 3f, false, true, 0))
								{
									...
									else
									{
										...
										vLocal_75 = { func_66(vLocal_78, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, vLocal_78, vLocal_79, 0, 2)) };
						...
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_68, cLocal_142, sLocal_143, 1000f, -1000f, 1024, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
						if (!PED::IS_PED_INJURED(iLocal_56))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_56);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, iLocal_68, cLocal_142, sLocal_144, 1000f, -4f, 0, 0, 1148846080, 0);
						}
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_68) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_68) == 1f) || func_49())
					{
						...
						if (func_69(vLocal_53, -526.58f, -1222.79f, 17.46f, 10f, 0))
						{
							...
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 3.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -503.46f, -1199.39f, 19.02f, 1f, 20000, 1048576000, 5, 1193033728);
								TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_56), 1);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
								TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
							}
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 2.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
							TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_56), 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
...
void func_73(vector3 vParam0, float fParam1, float fParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_74(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fVar2, 15f))
		{
			bVar0 = true;
		}
...
void func_109()
{
	...
	else
	{
		if (!iLocal_91)
		{
			if (!func_182(iLocal_56, 242628503) && !PED::IS_PED_INJURED(iLocal_56))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
				if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_56, vLocal_138, 0.5f, 0.5f, 0.5f, false, true, 0))
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_138, 1f, 20000, 1193033728, 1056964608);
				}
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -2f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, -1, 1, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
			}
		...
		if (iLocal_91)
		{
			if (!bLocal_95)
			{
				if (!PED::IS_PED_INJURED(iLocal_56))
				{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, 242628503) == 7)
					{
						TASK::CLEAR_PED_TASKS(iLocal_56);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
						TASK::TASK_PLAY_ANIM(0, cLocal_93, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
		...
		else if (!PED::IS_PED_INJURED(iLocal_56))
		{
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_89))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_56, OBJECT::GET_PICKUP_COORDS(iLocal_89), 10f, 10f, 7f, false, true, 0))
				{
					TASK::CLEAR_PED_TASKS(iLocal_56);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_89), 1f, 20000, 1f, 512, 1193033728);
...
void func_113()
{
	...
	switch (iLocal_65)
	{
		...
		case 2:
			...
			else if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0) || !func_182(iLocal_55, -1273030092))
			{
				bVar0 = true;
			}
			...
			if (bVar0)
			{
				if (!iLocal_86)
				{
					...
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503) != 0)
						{
							...
							TASK::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_62);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
						}
					}
					else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503) != 0)
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
						TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
					...
					iVar1 = TASK::GET_NAVMESH_ROUTE_RESULT(iLocal_55);
					if (iVar1 == 2)
					{
						TASK::CLEAR_PED_TASKS(iLocal_55);
	...
	switch (iLocal_65)
	{
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
			{
				if (iLocal_126)
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_55, iLocal_73) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, -1273030092) == 1)
					{
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_55, iLocal_73, vLocal_53, 8, 35f, 786469, 10f, 10f, 1);
					}
					else
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_55, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
				...
				else
				{
					...
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_55, iLocal_73, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 8, 35f, 786469, 10f, 10f, 1);
				}
			}
			else
			{
		...
		default:
			...
			{
				TASK::TASK_SMART_FLEE_COORD(iLocal_55, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
			}
			else if (iLocal_126)
			{
...
bool func_129()
{
	...
	if (bVar0)
	{
		...
		{
			bVar0 = false;
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, 474215631) != 1)
			{
				if (func_130(iLocal_56))
				{
					TASK::TASK_COWER(iLocal_56, 2000);
				}
			}
		}
	}
...
int func_140(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_142(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_162(int iParam0)
{
	if (iParam0 != func_128())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_163(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
{
	TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
	TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_55, 750);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -8f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, -1, 1, 0, 0, 0, 0);
	TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
	TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
	TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
	...
	{
		if (func_118(PLAYER::PLAYER_PED_ID(), iLocal_56, 1) < 50f)
		{
...
int func_189()
{
	switch (func_190(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_196()
{
	if (SYSTEM::VDIST(vLocal_53, -3044.06f, 594.93f, 6.74f) < 5f)
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_59))
		{
			if (func_112(iLocal_56) && func_112(PLAYER::PLAYER_PED_ID()))
			{
...
int func_197()
{
	...
	if (func_199())
	{
		...
		TASK::TASK_PLAY_ANIM(iLocal_55, cLocal_92, "b_atm_mugging", 1000f, -4f, -1, 1, 0, 0, 0, 0);
		if (PED::IS_PED_MALE(iLocal_56))
		{
			TASK::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@male", "idle_a", 1000f, -4f, -1, 1, 0, 0, 0, 0);
			STREAMING::REMOVE_ANIM_DICT("random@atmrobberygen@female");
		}
		else
		{
			TASK::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@female", "idle_a", 1000f, -4f, -1, 1, 0, 0, 0, 0);
		...
		func_198(&Local_107, 0, PLAYER::PLAYER_PED_ID(), sLocal_112, 0, 1);
		...
		if (iLocal_65 == 1 || iLocal_65 == 2)
		{
			...
			if (iLocal_65 == 2)
			{
				VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_73, 0, 0, false);
			}
			else if (iLocal_65 == 1)
			{
...
int func_224()
{
	if ((Global_111549 == func_225() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
int func_236(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_271(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_269()) || Global_110607) || Global_30738) || func_268()) || func_61(8, -1)) || func_267()) || func_266()) || func_265()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_269()) || Global_30738) || func_268()) || func_61(8, -1)) || func_265()) || func_267()) || func_266()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_269()) || Global_110607) || Global_30738) || func_268()) || func_61(8, -1)) || func_265()) || func_267()) || func_266()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_269()) || Global_110607) || Global_30738) || func_268()) || func_61(8, -1)) || func_267()) || func_266()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_269() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_61(8, -1)) || func_264()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_269()) || Global_30738) || func_268()) || func_61(8, -1)) || func_266()) || func_265()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_269()) || func_266()) || Global_110607) || Global_30738) || func_268()) || Global_42561) || func_61(8, -1)) || func_265()) || func_263()) || func_264()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_269()) || Global_110607) || Global_30738) || func_268()) || func_61(8, -1)) || func_265()) || func_263()) || func_267()) || func_266()) || func_264())
						{
							return 0;
						}
						break;
