...
void __EntryFunction__()
{
	...
	iLocal_68 = 49;
	iLocal_69 = 64;
	iLocal_73 = HUD::_GET_LEVEL_BLIP_SPRITE();
	iLocal_74 = HUD::_GET_WAYPOINT_BLIP_SPRITE();
	bLocal_78 = true;
	bLocal_85 = true;
	bLocal_107 = true;
	fLocal_128 = 120f;
...
void func_5()
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		...
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_285, 0, 0, true);
		}
	}
	if (iLocal_223 > 0)
	{
	...
	if (iLocal_223 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
		{
			...
			{
				VEHICLE::_SET_VEHICLE_CLOSE_DOOR_DEFERED_ACTION(iLocal_284, 0);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_285))
		{
			...
			{
				VEHICLE::_SET_VEHICLE_CLOSE_DOOR_DEFERED_ACTION(iLocal_285, 0);
			}
		}
...
void func_7(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_432(0) && Global_76823.f_1 == 1) && func_9(Global_76823))
		{
		}
		else
		{
	...
	if (Global_111560.f_9080 || func_432(0))
	{
		iVar0 = func_8();
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_268[iLocal_231], 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						else if (func_13(PLAYER::PLAYER_PED_ID(), iLocal_268[iLocal_231]) > 20f)
						{
							...
							{
								TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_268[iLocal_231], PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 1, 15f, 20f, 0, 0, -687903391);
							}
						}
...
void func_25(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_108(&(Global_98669.f_3));
				if (iVar6 > -1)
				{
...
{
	func_27(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_52(iParam1)];
...
int func_54(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_52(iParam1)];
...
void func_58()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_48(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(iVar0) && (!func_59(14) || Global_110511))
			{
...
void func_60(int iParam0, bool bParam1)
{
	...
	if (func_38(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_61(iParam0, &(Global_111560.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
Vector3 func_79(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_90(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_89())
			{
				if (func_88(Global_1590285))
				{
					return func_81(2, 2);
				}
				else if (func_80(Global_1590285))
				{
					return func_81(45, 3);
				}
				else
...
int func_115(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_116(Global_111560.f_9080.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_116(Global_111560.f_9080.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_116(Global_111560.f_9080.f_99.f_205[11]);
			break;
		
		case 90:
			return func_116(Global_111560.f_9080.f_99.f_205[7]);
			break;
		
		case 93:
			return func_116(Global_111560.f_9080.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
bool func_128()
{
	return func_129(&(Global_105109.f_2890));
}
...
{
	return func_144(&(Global_105109.f_2890), vParam0, fParam1, 0);
}
...
void func_145(int iParam0, int iParam1)
{
	...
	func_39(iParam0, &(Global_111560.f_32744.f_5510));
}
...
void func_155(int iParam0)
{
	...
	if (func_159(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_154(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_157(0, Global_75396.f_555[0 /*21*/].f_12) || !func_157(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_156(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_157(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_158(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_132(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_159(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_71(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_71(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_71(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_161(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("CARGOBOB"):
			if (func_162(iParam0, Global_75396.f_139[38], 0))
			{
				func_155(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_162(iParam0, Global_75396.f_139[43], 1))
			{
				func_155(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_162(iParam0, uVar1[iVar3], 1) && func_131(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_71(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_164(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_36(iParam0, iParam1))
				{
...
void func_182(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	while (iVar0 < 68)
	{
		if (func_159(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
bool func_184()
{
	return func_130(&(Global_105109.f_2890));
}

void func_185()
{
	iLocal_305 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("BREAKING_NEWS");
	STREAMING::REQUEST_MODEL(joaat("JET"));
	STREAMING::REQUEST_MODEL(joaat("police3"));
	...
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_305) || !func_186(1, "BB_Chase"))
	{
		SYSTEM::WAIT(0);
	}
...
void func_193(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_52(iParam2)];
	if (iVar0 != 0)
	{
						...
						if (!PED::IS_PED_INJURED(iLocal_264))
						{
							if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
							{
								if (TASK::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 18)
								{
									...
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_action", 1000f, -1000f, 4, 0, 1148846080, 0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_266))
			{
				if (!PED::IS_PED_INJURED(iLocal_266))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_252))
					{
						...
						{
							iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_react_to_death", 1000f, -1.5f, 3, 16, 1148846080, 0);
							iLocal_458 = 1;
						}
					}
				}
					...
					if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
					{
						if (TASK::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 20)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
							{
								...
								{
									func_234(&iLocal_284);
									AUDIO::PLAY_SOUND_FROM_COORD(iLocal_253, "Trevor_4_747_Jet_Engine", -937.77f, -2981.36f, 15.44f, 0, false, 0, 0);
						...
						if (TASK::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 23)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
								{
									...
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_264, iLocal_251, "MISSSOLOMON_3", "molly_death", 1.5f, -8f, 4, 0, 1148846080, 0);
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_251) > 0.89f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
							{
								...
								AUDIO::PLAY_SOUND_FROM_COORD(iLocal_254, "Trevor_4_747_Man_Sucked_In", -938.6f, -2984.13f, 15.47f, 0, false, 0, 0);
	...
	if (iLocal_223 > 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_266))
		{
			...
			if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_airworker")) && STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3")) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_clipboard_01")))
			{
				...
				iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_start_loop", 1000f, -8f, 68, 0, 1148846080, 0);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_285))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_285, 0))
			{
				...
				{
					VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_285, 0, 0, false);
				}
			}
		}
	}
...
int func_239(int iParam0)
{
	...
	func_240(&(Global_111560.f_2358.f_539), iVar1);
...
void func_240(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_242(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
	...
	if (iLocal_223 == 0)
	{
		...
		if (iLocal_335 == 0)
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
				{
					if ((VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 15000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 125464f) && func_301(1, 0, 0))
					{
						iLocal_350 = 1;
						if (iLocal_405 == 0)
						{
		...
		else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
			{
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_305) && func_186(1, "BB_Chase"))
				{
			...
			case 0:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 30000f)
						{
							func_267(iLocal_278, VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278));
						}
					}
				}
				if (iLocal_408 == 0)
								...
								if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
								{
									if (!PED::IS_PED_INJURED(iLocal_264))
									{
										...
										if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											TASK::TASK_SYNCHRONIZED_SCENE(iLocal_264, iLocal_250, "misssolomon_3", "molly_escapes_car_mol", 1000f, -1000f, 5, 0, 1148846080, 0);
									...
									if (!PED::IS_PED_INJURED(iLocal_264))
									{
										if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_250) > 0.85f)
											{
												...
												OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_262, joaat("v_ilev_ss_door5_r"), -935.641f, -2927.185f, 14.0945f, 1, true, 0);
					...
					if (iLocal_468 == 0)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
						{
							if (!PED::IS_PED_INJURED(iLocal_264))
							{
								...
								{
									AUDIO::PLAY_SOUND_FROM_COORD(-1, "Trevor_4_747_Molly_Open_Doors", -935.1f, -2927.6f, 13.2f, 0, false, 0, 0);
									iLocal_468 = 1;
								}
							}
						}
	...
	if (iLocal_166 < 15)
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam0))
			{
				...
				vVar1 = { VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, (fParam1 + (SYSTEM::TO_FLOAT((iLocal_166 - 1)) * 2000f))) };
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
			{
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 55000f)
				{
					...
					if ((STREAMING::HAS_MODEL_LOADED(joaat("FIRETRUK")) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_fireman_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("missheist_agency3aig_lift_waitped_a"))
					{
						...
						iLocal_667[0] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1151f, -2311f, 15f, 0f, 0f, 0f, 1065353216, 0, 0, 0, false);
						if (iLocal_381 == 0)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(iLocal_259, "Trevor_4_747_Loud_Fire", -1151f, -2311f, 15f, 0, false, 0, 0);
							iLocal_381 = 1;
						}
						iLocal_667[1] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1140f, -2328f, 18f, 0f, 0f, 0f, 1065353216, 0, 0, 0, false);
						iLocal_667[2] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1150f, -2327f, 19f, 0f, 0f, 0f, 1065353216, 0, 0, 0, false);
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_265[0]))
						{
...
int func_302(int iParam0)
{
	if (iParam0 != func_89())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_181(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
			{
				if (iLocal_357 == 0)
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 10000f)
					{
						...
						{
							func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 40f, 55f, 100f, 1.7f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
						else
						{
							func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 0.6f, 40f, 50f, 60f, 1.7f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
					}
				...
				{
					func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 40f, 180f, 1.7f, 1f, fLocal_322, 0);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
					func_314(iLocal_278, fLocal_321);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 10000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 23000f)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[8], 0))
					{
						func_340(iLocal_204[8], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 30f, 50f, 1.7f, 0.5f, fLocal_322, 1);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
					else
					{
						func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 35f, 180f, 1.7f, 0.5f, fLocal_322, 1);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 23000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 32000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_204[7]))
					{
						...
						{
							func_340(iLocal_204[7], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 20f, 30f, 100f, 1.8f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
						else if (ENTITY::DOES_ENTITY_EXIST(iLocal_204[8]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[8], 0))
							{
								func_340(iLocal_204[8], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 10f, 20f, 40f, 1.8f, 1f, fLocal_322, 0);
								VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
								func_314(iLocal_278, fLocal_321);
							}
							else
							{
								func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_322, 0);
								VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
								func_314(iLocal_278, fLocal_321);
							}
						}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 32000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 39000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_204[7]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[7], 0))
						{
							func_340(iLocal_204[7], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 22f, 25f, 100f, 1.8f, 0.5f, fLocal_322, 1);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
						else
						{
							func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 35f, 150f, 1.8f, 0.5f, fLocal_322, 1);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
					}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 39000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 56000f)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[8], 0))
					{
						func_340(iLocal_204[8], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
					else
					{
						func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 35f, 150f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 56000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 65000f)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[11], 0))
					{
						func_340(iLocal_204[11], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 30f, 100f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
					else
					{
						func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 25f, 35f, 100f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
						func_314(iLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 65000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 90000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_204[13]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[13], 0))
						{
							func_340(iLocal_204[13], PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 30f, 35f, 50f, 1.8f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
						else
						{
							func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 45f, 55f, 150f, 1.8f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
							func_314(iLocal_278, fLocal_321);
						}
					}
				...
				{
					func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 60f, 70f, 150f, 1.5f, 0.5f, fLocal_322, 1);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
					func_314(iLocal_278, fLocal_321);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 110000f)
				{
					func_340(iLocal_278, PLAYER::PLAYER_PED_ID(), &fLocal_321, 1f, 100f, 120f, 150f, 1.6f, 1f, fLocal_322, 0);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_278, fLocal_321);
					func_314(iLocal_278, fLocal_321);
				}
			}
			...
			if (iLocal_153[iVar0] != 99)
			{
				...
				else if (iLocal_153[iVar0] == 1)
				{
					...
					if (MISC::IS_BIT_SET(iLocal_154[iVar0], 0))
					{
						...
						bVar8 = STREAMING::HAS_MODEL_LOADED(func_205());
					}
					...
					else
					{
						...
						bVar8 = STREAMING::HAS_MODEL_LOADED(func_208());
					}
					if (bVar8)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_204[iVar0]))
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[iVar0], 0))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[iVar0]))
						{
							...
							if (!PED::IS_PED_INJURED(iVar1))
							{
								if (bVar9)
								{
									if (((!bLocal_79 && !iLocal_76) && !bLocal_95) && (((!bLocal_104 && !bLocal_103) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_204[iVar0])) || func_322(iLocal_204[iVar0])))
									{
...
int func_323(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
	{
		if (VEHICLE::IS_VEHICLE_SEAT_FREE(*uParam0, -1, 0))
		{
			if (iParam1 == 2)
			{
				iVar0 = PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 6, func_205(), -1, 0, false);
			...
			{
				iVar0 = PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 4, func_208(), -1, 0, false);
				if (bLocal_107)
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_208());
				}
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_203[iVar0]))
						{
							...
							if (STREAMING::HAS_MODEL_LOADED(iLocal_196[iVar0]))
							{
								if ((iLocal_75 || iLocal_89) || (!bLocal_106 && !func_327(vLocal_174[iVar0 /*3*/], vVar1, 5f, fLocal_141)))
								{
									...
									if (VEHICLE::IS_VEHICLE_MODEL(iLocal_203[iVar0], func_207()))
									{
		...
		while (iVar0 < 175 && !bVar17)
		{
			if (iLocal_150[iVar0] != 99)
			{
				...
				else if (iLocal_150[iVar0] == 1)
				{
					...
					{
						STREAMING::REQUEST_MODEL(func_208());
						bVar11 = STREAMING::HAS_MODEL_LOADED(func_208());
					}
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_201[iVar0]))
					{
				...
				else if (iLocal_150[iVar0] == 2)
				{
					...
					if (((iVar3 < 8 && (iVar0 > iLocal_171 || iLocal_171 == 0)) || iLocal_89) || iParam2)
					{
						if (!MISC::IS_BIT_SET(iLocal_151[iVar0], 1))
						{
							...
							{
								STREAMING::REQUEST_MODEL(func_205());
								bVar11 = STREAMING::HAS_MODEL_LOADED(func_205());
								iVar15 = 2;
							}
							else if (!bLocal_102 && ((!MISC::IS_BIT_SET(iLocal_151[iVar0], 2) && bVar13) || (MISC::IS_BIT_SET(iLocal_151[iVar0], 2) && uVar14)))
							{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam0))
	{
		...
		if (fVar1 < (fParam1 + 25000f))
		{
			...
			if (fVar1 <= VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(iVar0))
			{
				if (iLocal_166 == 0)
				{
					vLocal_181 = { VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, fLocal_144) };
					iLocal_166++;
				}
				else if (iLocal_166 == 1)
				{
					vLocal_182 = { VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, fVar1) };
					iLocal_166++;
				}
				else if (!bLocal_106)
				{
		...
		if (fVar2 < (fParam1 - 8000f))
		{
			...
			if (iLocal_169 == 0)
			{
				vLocal_183 = { VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, fLocal_145) };
				iLocal_169++;
			}
			else if (iLocal_169 == 1)
			{
				vLocal_184 = { VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, fVar2) };
				iLocal_169++;
			}
...
void func_351()
{
	...
	if (iLocal_223 == 1)
	{
		...
		if ((iLocal_360 == 1 && ENTITY::DOES_ENTITY_EXIST(iLocal_278)) && ENTITY::DOES_ENTITY_EXIST(iLocal_264))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
			{
				if (WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_278, func_353(PLAYER::PLAYER_PED_ID()), 0))
				{
					func_352();
					iLocal_223 = 0;
					iLocal_225 = 0;
...
void func_360(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (!bParam1)
	{
		...
		{
			Global_111560.f_32744.f_4801 = func_96();
		}
	}
}
...
void func_362(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_371(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_363(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_365(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_159(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_366(iParam0);
			func_156(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_384(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_390(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5)))
		{
			func_385(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_390(&(Global_111560.f_18098.f_362[iVar1 /*3*/])))
		{
			func_385(&(Global_111560.f_18098.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
void func_399(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		...
		default:
			*uParam1 = Global_89487[iParam0 /*34*/].f_14;
			*uParam2 = Global_89487[iParam0 /*34*/].f_13;
			break;
	}
}
			...
			if (iLocal_223 > 0)
			{
				...
				if (iLocal_227 == 1)
				{
					if (iLocal_483 == 0)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_277 = func_408(PLAYER::PLAYER_PED_ID(), joaat("COP"), 0, 0, 28);
