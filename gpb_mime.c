...
{
	func_49(&uLocal_37, 3, iLocal_208, &Local_205, 0, 1);
	func_33(&uLocal_37, &cLocal_227, "PBMM_ABUSE", 3, 0, 0, 0);
}
...
void func_105()
{
	...
	StringCopy(&Local_204, "PBMM", 8);
	StringCopy(&Local_205, "MIME", 16);
	...
	StringCopy(&cLocal_234, "special_ped@mime@base", 64);
	StringCopy(&cLocal_243, "special_ped@mime@intro", 64);
	bLocal_268 = false;
	iLocal_217 = 9;
	iLocal_221[0] = 1;
	iLocal_221[1] = 1;
