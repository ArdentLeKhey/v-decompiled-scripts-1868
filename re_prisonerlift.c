								...
								switch (iLocal_53)
								{
										...
										else if (iLocal_54 == 1)
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												if (bLocal_83)
												{
													...
													{
														TASK::CLEAR_PED_SECONDARY_TASK(iLocal_64);
													}
													...
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
													{
														if (!func_72(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
														{
															if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_64, 40f, 40f, 20f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 17))
															{
																...
																TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
											...
											if (func_71())
											{
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_64, 0))
												{
													...
													{
														if (func_70(PLAYER::PLAYER_PED_ID(), iLocal_64) < 2.5f)
														{
													...
													else if (func_70(PLAYER::PLAYER_PED_ID(), iLocal_64) < 10f)
													{
														if (ENTITY::GET_ENTITY_SPEED(iLocal_67) < 1f)
														{
															func_69();
									...
									case 6:
										if (!iLocal_88 && !PED::IS_PED_INJURED(iLocal_64))
										{
											...
											TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_77, 1f, -1, 0.25f, 0, 333.9002f);
											TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
											TASK::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
										...
										if (func_65())
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												TASK::TASK_SMART_FLEE_COORD(iLocal_64, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
												PED::SET_PED_KEEP_TASK(iLocal_64, true);
												SYSTEM::WAIT(0);
											}
											func_92();
												...
												if (!iLocal_85)
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, 0))
													{
														if (!PED::IS_PED_INJURED(iLocal_64))
														{
															...
															TASK::TASK_ENTER_VEHICLE(iLocal_64, iLocal_67, -1, -1, 2f, 1, 0);
															PED::SET_PED_KEEP_TASK(iLocal_64, true);
															iLocal_53 = 12;
														}
													}
													if (!PED::IS_PED_INJURED(iLocal_64))
													{
														...
														{
															TASK::TASK_COMBAT_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 0, 16);
															func_52();
															iLocal_85 = 1;
														}
													}
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
											{
												if (!func_72(iLocal_67))
												{
													if (PED::IS_PED_IN_VEHICLE(iLocal_64, iLocal_67, 0))
													{
														...
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, iLocal_67, PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
														PED::SET_PED_KEEP_TASK(iLocal_64, true);
														iLocal_53 = 13;
													}
									...
									case 13:
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											...
											if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, 0))
											{
												...
												if (!iLocal_97)
												{
													if ((func_1(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, 0)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, 0), 0)) || func_72(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, 0)))
													{
														if (HUD::DOES_BLIP_EXIST(iLocal_89))
														{
															HUD::SET_BLIP_AS_FRIENDLY(iLocal_89, false);
	...
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_94())
			{
				...
				{
					TASK::TASK_GO_TO_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, 0))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_64, 0, 0);
				}
				if (!iLocal_95)
				{
					if (!func_89())
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 2000)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
					{
						...
						TASK::TASK_VEHICLE_TEMP_ACTION(PLAYER::PLAYER_PED_ID(), iLocal_67, 24, 2000);
						iLocal_90++;
					}
				}
			}
				...
				if (SYSTEM::TIMERA() > 4000)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_64))
						{
							...
							TASK::TASK_LEAVE_VEHICLE(iLocal_64, iLocal_67, 320);
							if (!HUD::DOES_BLIP_EXIST(iLocal_89))
							{
...
void func_47(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_48(iParam2)];
	if (iVar0 != 0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_48(iParam1)];
...
void func_55()
{
	...
	if (func_60(PLAYER::PLAYER_PED_ID(), vLocal_57, 1) > 200f)
	{
		if (!bLocal_84)
		{
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("SHERIFF"), vVar0[0 /*3*/], func_58(vVar0[0 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("SHERIFF"), vVar0[1 /*3*/], func_58(vVar0[1 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), -1, 1, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), 0, 1, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("SHERIFF"), vVar0[2 /*3*/], func_58(vVar0[2 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), -1, 1, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), 0, 1, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("SHERIFF"), vVar0[3 /*3*/], func_58(vVar0[3 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), -1, 1, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("s_m_y_ranger_01"), 0, 1, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
...
int func_63()
{
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (PED::IS_PED_IN_GROUP(iLocal_64))
		{
			if ((((((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_98, 50f, 50f, 50f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_99, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_100, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_101, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_102, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_103, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_104, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_105, 50f, 50f, 50f, false, true, 0)) || func_60(PLAYER::PLAYER_PED_ID(), vLocal_106, 1) < 205f)
			{
				return 1;
			}
		}
...
void func_64()
{
	if (!PED::IS_PED_INJURED(iLocal_64) && func_94())
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
		...
		if (iLocal_53 < 2)
		{
			...
			if (iLocal_54 == 0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_69))
				{
					...
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_64, true);
						return 1;
					}
				}
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				...
				else if (!bLocal_94)
				{
					...
					TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, (fLocal_93 - 3f), 1f, 1073741824, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
					if (!func_89())
		...
		case 2:
			...
			if (!iLocal_96)
			{
				if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2.5f)
				{
					...
					{
						TASK::CLEAR_PED_TASKS(iLocal_64);
						TASK::TASK_OPEN_VEHICLE_DOOR(iLocal_64, iLocal_67, -1, 0, 1f);
						iLocal_96 = 1;
					}
				}
				if (!func_89())
	...
	switch (*uParam0)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_64))
			{
				...
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), 0);
					*uParam0++;
				}
			}
			break;
...
void func_95()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0) && !PED::IS_PED_INJURED(iLocal_64)) && !bLocal_83)
		{
			...
			if (iLocal_54 == 0)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_67, 10000, 2048, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0, 0, 0, 0);
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, fLocal_93, 1f, 1, 0, -957453492);
			}
			else if (iLocal_54 == 1)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_67, 10000, 2052, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0, 0, 0, 0);
...
void func_108()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_65);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_65, joaat("COP"));
	TASK::TASK_PLAY_ANIM(iLocal_64, "random@prisoner_lift", "loop2_idlelook2", 2f, -2f, -1, 1, 0, 0, 0, 0);
	...
	if (iLocal_54 == 0)
	{
		...
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_69, 4, 0, false);
	...
	if (func_50() == 0)
	{
		func_109(&uLocal_114, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_50() == 1)
	{
		func_109(&uLocal_114, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_50() == 2)
	{
		func_109(&uLocal_114, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	iLocal_53 = 1;
}
...
int func_134(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_170(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
	...
	if (iLocal_107)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_64))
		{
			...
			else if (iLocal_54 == 1)
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
					TASK::TASK_ENTER_VEHICLE(0, iLocal_67, -1, -1, 2f, 9, 0);
					TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
