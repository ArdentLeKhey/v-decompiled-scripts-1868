...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_298))
	{
		iLocal_41 = iScriptParam_298;
...
void func_1()
{
	...
	if (iLocal_288)
	{
		if (!iLocal_290)
		{
			iLocal_291 = MISC::GET_GAME_TIMER() + 50;
			iLocal_290 = 1;
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_291)
		{
			if (fLocal_292 < fVar1)
			{
				fLocal_292 = (fLocal_292 + 0.003f);
				if (fLocal_292 > 1f)
				{
					fLocal_292 = 1f;
					iLocal_295 = 1;
				}
				MISC::SET_TIME_SCALE(fLocal_292);
			}
			if (fLocal_293 > fVar0)
			{
				fLocal_293 = (fLocal_293 - 0.02f);
				if (fLocal_293 < 0f)
				{
					fLocal_293 = 0f;
					iLocal_296 = 1;
				}
				if (func_2(iLocal_280))
				{
					CAM::SET_CAM_MOTION_BLUR_STRENGTH(iLocal_280, fLocal_293);
				}
			}
			if (fLocal_294 > fVar2)
			{
				fLocal_294 = (fLocal_294 - 0.004f);
				if (fLocal_294 < 0f)
				{
					fLocal_294 = 0f;
					iLocal_297 = 1;
				}
				GRAPHICS::SET_TIMECYCLE_MODIFIER_STRENGTH(fLocal_294);
			}
			iLocal_290 = 0;
			if ((iLocal_295 && iLocal_296) && iLocal_297)
			{
				iLocal_288 = 0;
			}
		}
...
void func_3()
{
	...
	if (bLocal_289)
	{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_291)
		{
			if (fLocal_292 > fVar1)
			{
				fLocal_292 = (fLocal_292 - 0.004f);
				MISC::SET_TIME_SCALE(fLocal_292);
			}
			if (fLocal_293 < fVar0)
			{
				fLocal_293 = (fLocal_293 + 0.075f);
				if (func_2(iLocal_280))
				{
					CAM::SET_CAM_MOTION_BLUR_STRENGTH(iLocal_280, fLocal_293);
				}
...
void func_4()
{
	...
	vVar0 = { func_69() };
	vVar1 = { 1.2f, 1.2f, 1.2f };
	switch (iLocal_277)
	{
		case 0:
			if ((func_64(vVar0, vVar1) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (func_63() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (func_63() + 90f))
			{
				func_62();
		...
		case 1:
			...
			if (func_59(1, 0, 1))
			{
				if ((((func_64(vVar0, vVar1) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (func_63() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (func_63() + 90f)) && vVar2.z > 33f) && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
				{
		...
		case 2:
			...
			iLocal_281 = PED::CREATE_SYNCHRONIZED_SCENE(func_47(), func_46(), 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_75(), func_45(0), 1000f, -8f, 0, 0, 1148846080, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_281, func_44(0), func_75(), 1000f, -8f, 0, 1148846080);
			if (!PED::_0x7F2F4F13AC5257EF(iLocal_281))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_281, true);
			}
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				iLocal_280 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_280, iLocal_281, func_41(0), func_75());
		...
		case 3:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_281) > 0.95f)
			{
				iLocal_277 = 4;
			}
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_281) > 0.35f)
			{
				if (!iLocal_279)
				{
		...
		case 4:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_281))
				{
					PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_281, 1f);
				}
				if (CAM::DOES_CAM_EXIST(iLocal_280))
				{
					CAM::DESTROY_CAM(iLocal_280, 0);
					CAM::RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
				}
				iLocal_282 = MISC::GET_RANDOM_INT_IN_RANGE(0, 6);
				switch (iLocal_282)
				{
					case 0:
						vLocal_286 = { 1546.069f, 3821.222f, 29.9139f };
						fLocal_287 = 235.002f;
						break;
					
					case 1:
						vLocal_286 = { 2515.749f, 3783.202f, 52.0043f };
						fLocal_287 = 0f;
						break;
					
					case 2:
						vLocal_286 = { 1902.893f, 4921.095f, 47f };
						fLocal_287 = 69.8293f;
						break;
					
					case 3:
						vLocal_286 = { -194.0443f, 3638.538f, 63.4521f };
						fLocal_287 = 156.1723f;
						break;
					
					case 4:
						vLocal_286 = { 560.8397f, 2738.103f, 41.2029f };
						fLocal_287 = 91.5686f;
						break;
					
					case 5:
						vLocal_286 = { -455.5521f, 1598.692f, 358.1478f };
						fLocal_287 = 270f;
						break;
				}
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_286, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_287);
				CLOCK::ADD_TO_CLOCK_TIME(6, 0, 0);
				func_33(SYSTEM::TO_FLOAT(6));
				func_32(vLocal_286, 10f, 13);
				iLocal_277 = 5;
			}
			break;
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_281))
			{
				...
				if (func_31())
				{
					sLocal_284 = "ig_8_wake_up_front_player";
					sLocal_285 = "ig_8_wake_up_front_cam";
				}
				else
				{
					sLocal_284 = "ig_8_wake_up_right_player";
					sLocal_285 = "ig_8_wake_up_right_cam";
				}
				vVar3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				switch (iLocal_282)
				{
					case 0:
						vVar3.z = (vVar3.z - 0.2f);
						break;
					
					case 1:
						vVar3.z = (vVar3.z - 0.15f);
						break;
					
					case 2:
						vVar3.z = (vVar3.z - 0.05f);
						break;
					...
					case 5:
						vVar3.z = (vVar3.z - 0.1f);
						break;
				}
				iLocal_281 = PED::CREATE_SYNCHRONIZED_SCENE(vVar3.x, vVar3.y, vVar3.z, 0f, 0f, fLocal_287, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_75(), sLocal_284, 1000f, -4f, 0, 0, 1148846080, 0);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_281))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_281, false);
				}
				if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
				{
					iLocal_280 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_280, iLocal_281, sLocal_285, func_75());
					CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
				}
				else
				{
		...
		case 8:
			if ((iLocal_295 && iLocal_296) && iLocal_297)
			{
				...
				if (STATS::STAT_GET_INT(joaat("NUM_SH_GAS_HUFFED"), &iLocal_283, -1))
				{
					STATS::STAT_SET_INT(joaat("NUM_SH_GAS_HUFFED"), iLocal_283 + 1, 1);
				}
				iLocal_279 = 0;
				func_49(0, 1, 1, 0, 0, 0);
				iLocal_278 = 0;
...
void func_25()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_18(14) || Global_110511))
			{
...
void func_32(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_33(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_39(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5)))
		{
			func_34(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_39(&(Global_111560.f_18098.f_362[iVar1 /*3*/])))
		{
			func_34(&(Global_111560.f_18098.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
char* func_42()
{
	...
	fVar2 = MISC::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[0 /*3*/], true);
	fVar3 = MISC::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[1 /*3*/], true);
	if (fVar2 < fVar3)
	{
		sVar0 = "drinking_wine_cam2";
		vLocal_274 = { -8.9f, 515.6f, 175.4f };
		vLocal_275 = { -17.1f, 0.5f, 6.5f };
	}
	else
	{
		sVar0 = "drinking_wine_cam3";
		vLocal_274 = { -10.1f, 516f, 175.3f };
		vLocal_275 = { -13.5f, 0.5f, -56f };
	}
	return sVar0;
}
...
int func_64(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95627 && Global_95628) || func_66())
					{
						return 0;
					}
					if (func_65(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_74()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_41, 0) && vVar0.z > 33f)
		{
			return 1;
		}
	}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar7 = 0;
		iVar8 = (iParam1 - func_83(iParam0, func_80(iParam2)));
		if (iVar8 < 0)
		{
			return -1;
		}
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_80(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_80(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_83(iParam0, func_80(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_bong_01"):
			...
			if (func_24() == 0)
			{
				...
				if (((((Global_93705[0] == 5 || Global_93705[0] == 21) || Global_93705[0] == 20) || Global_93705[0] == 16) || Global_93705[0] == 18) || Global_93705[0] == 9)
				{
					return 0;
				}
				if (((((Global_93705[0] == 6 || Global_93705[0] == 7) || Global_93705[0] == 11) || Global_93705[0] == 17) || Global_93705[0] == 140) || Global_93705[0] == 141)
				{
					return 1;
				}
				return 1;
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_111560.f_7256.f_227[145] == 1)
			{
				if (func_24() == 2)
				{
					if (((((Global_93705[13] != 127 && Global_93705[13] != 135) && Global_93721 != 127) && Global_93721 != 135) && !func_93()) && !func_95())
					{
						return 1;
					}
				}
		...
		case joaat("prop_radio_01"):
			iLocal_31 = 1;
			if ((Global_38761[78] != 1 && Global_93705[9] != 117) && Global_93705[11] != 117)
			{
				if (func_24() == 2)
				{
					bLocal_35 = true;
		...
		case joaat("p_w_grass_gls_s"):
			...
			if (func_24() == 0)
			{
				if (Global_93705[0] != 17 && Global_93705[2] != 73)
				{
					return 1;
				}
			}
...
{
	return func_100(iParam0, Global_41396);
}
...
void func_101()
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_280))
	{
		CAM::SET_CAM_MOTION_BLUR_STRENGTH(iLocal_280, 0f);
		CAM::DESTROY_CAM(iLocal_280, 0);
	}
	func_102();
