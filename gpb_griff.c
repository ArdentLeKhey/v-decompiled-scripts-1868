...
void func_9()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_277))
	{
		...
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_277);
	}
}
...
void func_104()
{
	PED::SET_PED_COMPONENT_VARIATION(iLocal_208, 1, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(iLocal_208, 11, 0, 0, 0);
	PED::SET_PED_PROP_INDEX(iLocal_208, 1, 0, 0, false);
	PED::SET_PED_PROP_INDEX(iLocal_208, 0, 0, 0, false);
	iLocal_277 = OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), ENTITY::GET_ENTITY_COORDS(iLocal_208, true), true, true, false);
...
void func_105()
{
	...
	StringCopy(&Local_204, "PBGR", 8);
	StringCopy(&Local_205, "GRIFF", 16);
	StringCopy(&Local_202, "Special_Ped@griff", 64);
	StringCopy(&Local_203, "Base", 64);
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBGR_INTERACT";
	StringCopy(&Local_231, "PBGR_CONV_GM", 16);
	StringCopy(&Local_232, "PBGR_CONV_GT", 16);
	StringCopy(&Local_233, "PBGR_CONV_GF", 16);
	StringCopy(&cLocal_234, "special_ped@griff@base", 64);
	StringCopy(&cLocal_243, "special_ped@griff@intro", 64);
	iLocal_217 = 4;
	iLocal_221[0] = 8;
	iLocal_221[1] = 7;
	iLocal_221[2] = 8;
