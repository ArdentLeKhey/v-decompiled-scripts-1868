...
void func_105()
{
	...
	StringCopy(&Local_204, "PBJS", 8);
	StringCopy(&Local_205, "JESSE", 16);
	StringCopy(&Local_202, "Special_Ped@jessie", 64);
	StringCopy(&Local_203, "Base", 64);
	bLocal_265 = true;
	iLocal_218 = 15;
	sLocal_226 = "PBJS_INTERACT";
	StringCopy(&Local_231, "PBJS_CONV_GM", 16);
	StringCopy(&Local_232, "PBJS_CONV_GT", 16);
	StringCopy(&Local_233, "PBJS_CONV_GF", 16);
	StringCopy(&cLocal_234, "special_ped@jessie@base", 64);
	StringCopy(&cLocal_243, "special_ped@jessie@intro", 64);
	iLocal_217 = 7;
	iLocal_221[0] = 8;
	iLocal_221[1] = 6;
	iLocal_221[2] = 6;
