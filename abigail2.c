...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	vLocal_38 = { -1593.813f, 5221.235f, 1.94482f };
	vLocal_39 = { -1603.986f, 5243.624f, 4.940323f };
	uLocal_40 = func_498(16);
	sLocal_41 = "rcmabigail";
	iLocal_55 = joaat("ASEA");
	vLocal_57 = { -1573.733f, 5164.508f, 18.5576f };
	fLocal_58 = 175.9451f;
	vLocal_239 = { -1014.054f, -2474.013f, 19.1091f };
	...
	if (func_463(Local_54.f_28[0]))
	{
		iLocal_61 = Local_54.f_28[0];
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_61, true, 1);
	}
	func_462();
	if (func_461())
	{
		...
		{
			case 0:
				func_459(-1595.201f, 5217.495f, 3.0009f, 208.2675f, 1, 0);
				func_384(1);
				break;
			}
	}
	while (true)
	{
		...
		func_368(Local_54.f_9, 0, 0, 0, 0, 0);
		if (func_463(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_59)
			{
				case 0:
...
void func_9()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else if (func_232(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_60 = 2;
			...
			{
				if (!func_230(iLocal_61, 1805844857))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_61, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
				}
				if (iLocal_230 == 0)
				{
					if (((!func_229() && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_229()) && (MISC::GET_GAME_TIMER() - iLocal_235) > 10000) && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_235()
{
	if (func_463(iLocal_61))
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_242) > 1000)
		{
			...
			func_236(&uLocal_42, iLocal_61, "ABGAIL2_HINT", 0, 1, 1, 1);
		}
	}
	else
	{
...
int func_244(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_251() || func_250(Global_4456448.f_190930)) || func_249())
	{
...
int func_245(int iParam0)
{
	if (iParam0 != func_217())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_246(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_254(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_257(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_267()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_229()) && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_265();
				}
				if (func_232(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
			if ((iLocal_233 == 0 && iLocal_232 == 1) && !func_229())
			{
				if (func_463(iLocal_61))
				{
...
void func_269()
{
	...
	{
		case 0:
			iLocal_243 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
			func_297();
			if (func_463(iLocal_61))
			{
				func_295();
				if (func_3(iLocal_56))
				{
					...
					func_294(&iLocal_62, "", "", &iLocal_63, &iLocal_64, 1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_236);
					if (!PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 0))
					{
					...
					TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_56, vLocal_239, 20f, 786469, 10f);
					TASK::TASK_VEHICLE_PARK(0, iLocal_56, vLocal_239, 49.567f, 3, 1092616192, 0);
				...
				{
					TASK::TASK_WANDER_STANDARD(iLocal_61, 1193033728, 0);
				}
			}
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_61, vLocal_239, 5f, 5f, 5f, false, true, 0))
			{
				func_234(3);
			}
			else
			{
				func_270(&iLocal_62, "", "", &iLocal_63, iLocal_64, 0);
				if (iLocal_231 == 0)
				{
					if (((func_463(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 1)) && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_229()) && (MISC::GET_GAME_TIMER() - iLocal_234) > 10000) && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = MISC::GET_GAME_TIMER();
						iLocal_237++;
					}
...
int func_275(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_463(PLAYER::PLAYER_PED_ID()) && func_463(iParam0))
	{
...
int func_279(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_280(iParam2, iParam5) };
...
int func_292(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
		...
		case 1:
			switch (iLocal_241)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_498(16)) && func_463(iLocal_61))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						}
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_463(iLocal_61))
							{
								...
								func_339(iLocal_61, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
...
void func_303(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_305() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_305() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_307(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_305() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_313(int iParam0, int iParam1)
{
	...
	if (func_323(&Global_4269915))
	{
		if (func_321(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_314(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_317(var uParam0)
{
	...
	func_319(uParam0, (Global_4269914 - 0.5f));
}
...
void func_329(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_463(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_463(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_463(uParam0->f_41[iVar0]))
		{
...
void func_331(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_337(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_341(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_344(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_345(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_345(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_349(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_347(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_348(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_348(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
int func_349(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_284(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_350(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_350(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_350(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_350(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_350(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_350(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_350(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_350(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_350(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_350(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_350(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_350(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_350(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_350(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_350(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_350(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_350(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_368(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_370(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_371(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_381(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_383(iParam0, Global_41396);
}
...
void func_384(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			func_390(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, vLocal_57, fLocal_58);
			func_234(2);
			break;
		
		case 2:
			func_390(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, vLocal_57, fLocal_58);
			func_234(2);
			break;
	...
	if (!func_389())
	{
		func_387(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_386(0, -1, 1);
	func_385(1, 1, 1);
}
...
void func_390(vector3 vParam0, float fParam1, vector3 vParam2, float fParam3, vector3 vParam4, float fParam5, vector3 vParam6, float fParam7)
{
	int iVar0;
	
	if (func_346(vParam0))
	{
		while (!func_395(&iVar0, 0, vParam2, fParam3, 1, 0))
		{
			SYSTEM::WAIT(0);
		}
	...
	{
		func_339(PLAYER::PLAYER_PED_ID(), vParam0, fParam1, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_55);
	...
	while (!func_391(&iLocal_61, 16, vParam4, fParam5, "RC ABIGAIL 2", 1))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_56 = VEHICLE::CREATE_VEHICLE(iLocal_55, vParam6, fParam7, true, true, false);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
	func_297();
	if (func_346(vParam4))
...
int func_395(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_451(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_451(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_451(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_396(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_160(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_400(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_399(*iParam1);
				...
				func_397(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_397(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_397(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_398(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_398(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_401(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_427(iVar0, bParam1, uParam2) && !func_426(PLAYER::PLAYER_ID())) && !func_410(iParam0))
	{
		return 0;
	}
...
int func_403(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			...
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_407(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_408(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_425(PLAYER::PLAYER_ID()) || func_424(PLAYER::PLAYER_ID()))
	{
		if (func_411(iParam0))
		{
			return 1;
...
int func_424(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			...
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_425(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_217())
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_426(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_246(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_404(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_429(int iParam0, int iParam1)
{
	...
	func_430(iParam0, &(Global_111560.f_32744.f_5510));
}
...
void func_430(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_432(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_431(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_347(iParam0, 0, 0)) || func_347(iParam0, 1, 0)) || func_347(iParam0, 2, 0)) || func_447(iParam0) != 145) || func_446(iParam0)) || func_445(iParam0)) || func_402(iParam0)) || func_444(iParam0)) || !func_434(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_445(iParam0))
		{
		}
...
int func_435(int iParam0, bool bParam1)
{
	...
	{
		if ((((!func_442() && !func_441()) && !func_440()) && !func_439()) && !func_443())
		{
			return 0;
		}
	}
...
int func_451(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_423(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_454(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_454(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_453(uParam0);
	if (func_452(*uParam0))
	{
...
void func_456(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
...
void func_475(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
