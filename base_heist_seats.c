...
void func_1()
{
	MISC::CLEAR_BIT(&Global_1573975, 1);
	func_3(&Local_47);
	func_2();
}
...
{
	func_19(&Local_47);
	if (Global_1590291 == PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1692918[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 5))
	{
		...
		{
			MISC::SET_BIT(&Global_1573975, 1);
			if ((((((iLocal_64 == 0 && !MISC::IS_BIT_SET(Global_1692918[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
...
void func_19(int iParam0)
{
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) };
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0f, 2) };
				iVar5 = vVar4.z;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				iParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, true, false, 1065353216, 0, 1065353216);
		...
		case 6:
			...
			func_33(iParam0);
			func_26(iParam0);
			iVar7 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0->f_421.f_1);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0->f_421.f_1);
...
void func_62(var uParam0)
{
	...
	func_63(&(uParam0->f_421), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_63(&(uParam0->f_421), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
int func_78()
{
	if (Global_1590291 != func_65())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
...
bool func_81(var uParam0, int iParam1)
{
	...
	if (func_84(PLAYER::PLAYER_ID()) || MISC::IS_BIT_SET(iLocal_64, 0))
	{
		return 0;
	}
	vVar0 = { uParam0->f_1 };
...
int func_84(int iParam0)
{
	if (iParam0 != func_65())
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_1692918[iParam0 /*39*/].f_27, 3))
			{
				return 1;
			}
		}
