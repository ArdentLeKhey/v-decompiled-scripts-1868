...
void func_5()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_110592))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_240, "Aknowledge_R", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_110592, "Aknowledge_R", &cLocal_240, -4f);
			}
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_240, "Aknowledge_L", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_110592, "Aknowledge_L", &cLocal_240, -4f);
			}
		}
	}
	if (iLocal_54 == 0)
...
void func_16()
{
	if (func_22(&Global_110591, iLocal_70, iLocal_69))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_110591, 0))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_110591))
			{
				...
				func_20(&Global_110591, iLocal_246);
...
void func_29()
{
	...
	if (func_25(&iLocal_244))
	{
		if (!iLocal_59)
		{
			if (iLocal_244 == Global_110591 && iLocal_55 == 4)
			{
...
void func_32()
{
	if (func_42(&Global_110591, &Global_110592, iLocal_70, iLocal_69))
	{
		if (!func_36())
		{
			if (!func_19(Global_110592, -2118855366))
	...
	else if (func_41(iLocal_67, 3000))
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
		{
			if (func_44())
			{
				...
				{
					TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FORGET_IT", 4f, -2f, -1, 48, 0, 0, 0, 0);
				}
				else
				{
					TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FUCK_U", 4f, -2f, -1, 48, 0, 0, 0, 0);
				}
			}
	...
	if (func_42(&Global_110591, &Global_110592, iLocal_70, iLocal_69))
	{
		...
		if (bVar0)
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
			{
				...
				{
					TASK::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_R", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
				}
				else
				{
					TASK::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_L", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
				}
...
void func_50()
{
	...
	if (func_39(Global_110591))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_63))
		{
			iLocal_63 = HUD::ADD_BLIP_FOR_ENTITY(Global_110591);
...
int func_100(var uParam0, var uParam1, vector3 vParam2, float fParam3)
{
	...
	if (STREAMING::HAS_MODEL_LOADED(func_146()))
	{
		...
		{
			*uParam0 = VEHICLE::CREATE_VEHICLE(func_146(), vParam2, fParam3, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0))
				{
...
int func_137(vector3 vParam0, int iParam1)
{
	if (iParam1 != -1)
	{
		...
		{
			return func_137(vParam0, Global_41397[iParam1 /*5*/].f_4);
		}
	}
	return 0;
}
