...
void __EntryFunction__()
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_181))
	{
		CAM::SET_CAM_PARAMS(iLocal_181, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
		iVar6 = MISC::GET_GAME_TIMER() + 5000;
	}
	while (!func_50(&uLocal_41) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_53();
		func_56(PLAYER::PLAYER_PED_ID());
		SYSTEM::WAIT(0);
	...
	SYSTEM::WAIT(0);
	func_15();
	if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_164.f_9))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1648.4f, -1127.6f, 18.3f, 1, false, 0, 1);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), Local_164.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
	}
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_14(&Local_169, vVar1, ENTITY::GET_ENTITY_ROTATION(Local_164.f_9, 2), 50f, Local_169.f_20, Local_169.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		CAM::ATTACH_CAM_TO_ENTITY(Local_169, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
	}
	SYSTEM::WAIT(0);
	if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_165.f_9))
	{
		func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_165.f_9, true), &fVar4, &fVar5, 1);
		func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
		CAM::SET_CAM_ROT(Local_169, Vector(fVar5, 0f, fVar4) + Local_169.f_14, 2);
	}
	...
	while (true)
	{
		...
		if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_165.f_9))
		{
			func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_165.f_9, true), &fVar4, &fVar5, 1);
			func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			CAM::SET_CAM_ROT(Local_169, Vector((fVar5 + (fVar7 * (fVar8 * 2f))), 0f, (fVar4 + fVar7)) + Local_169.f_14, 2);
		}
		func_53();
		func_2();
		...
		if (MISC::GET_GAME_TIMER() > iLocal_187)
		{
			if (fLocal_190 > 0.01f)
			{
				if (fLocal_190 > 0.5f)
				{
					AUDIO::_PLAY_AMBIENT_SPEECH1(PLAYER::PLAYER_PED_ID(), "ROLLERCOASTER_CHAT_EXCITED", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				else
				{
					AUDIO::_PLAY_AMBIENT_SPEECH1(PLAYER::PLAYER_PED_ID(), "ROLLERCOASTER_CHAT_NORMAL", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
...
void func_6()
{
	...
	if (Local_164.f_10 < IntToFloat(vLocal_192[iLocal_191 /*3*/]))
	{
		return;
	}
	if (Local_164.f_10 >= IntToFloat(vLocal_192[iVar3 /*3*/]))
	{
		iLocal_191 = iVar3;
		return;
	}
	...
	fVar0 = SYSTEM::TO_FLOAT(MISC::ABSI((vLocal_192[iLocal_191 + 1 /*3*/] - vLocal_192[iLocal_191 /*3*/])));
	fVar1 = (vLocal_192[iVar3 /*3*/].f_1 - vLocal_192[iLocal_191 /*3*/].f_1);
	fVar2 = (1f - ((SYSTEM::TO_FLOAT(vLocal_192[iVar3 /*3*/]) - Local_164.f_10) / fVar0));
...
void func_9(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	{
		iParam0->f_14 = (iParam0->f_14 + func_7(((((vVar6.x - iParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_1 = (iParam0->f_14.f_1 + func_7(((((vVar6.y - iParam0->f_14.f_1) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_2 = (iParam0->f_14.f_2 + func_7(((((vVar6.z - iParam0->f_14.f_2) * 0.05f) * fVar5) * fParam7), -3f, 3f));
	}
	if (iParam0->f_26)
	{
...
void func_17(var uParam0)
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			PAD::SET_PAD_SHAKE(0, iLocal_184, iLocal_185);
		}
	}
...
void func_28(var uParam0, int iParam1, int iParam2)
{
	...
	*uParam0 = { *uParam0 + vLocal_160 };
	...
	{
		ENTITY::SET_ENTITY_COLLISION(uParam0->f_9, false, 0);
		ENTITY::SET_ENTITY_VISIBLE(uParam0->f_9, false, 0);
...
void func_29()
{
	...
	iLocal_180[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
	iLocal_180[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_180[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_180[3] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_180[iVar0]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_180[iVar0], true, 0);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_180[iVar0], false, 0);
			ENTITY::SET_ENTITY_COLLISION(iLocal_180[iVar0], false, 0);
...
{
	vLocal_159[(233 - iLocal_161) /*3*/] = fParam0;
	vLocal_159[(233 - iLocal_161) /*3*/].f_1 = fParam1;
	vLocal_159[(233 - iLocal_161) /*3*/].f_2 = fParam2;
	iLocal_161++;
}
...
void func_33(int iParam0, float fParam1, int iParam2)
{
	...
	{
		vLocal_192[(vLocal_192.x - 1) /*3*/] = 232;
		vLocal_192[(vLocal_192.x - 1) /*3*/].f_1 = 0.01f;
		vLocal_192[(vLocal_192.x - 1) /*3*/].f_2 = 0;
		return;
	}
	vLocal_192[iLocal_193 /*3*/] = (iParam0 + iLocal_194);
	if (vLocal_192[iLocal_193 /*3*/] >= 234)
	{
		vLocal_192[iLocal_193 /*3*/] = 233;
	}
...
void func_40()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_44(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_42(iVar0) && (!func_41(14) || Global_110511))
			{
...
int func_46(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_47(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_47(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_47(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_47(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_47(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_47(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_47(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_47(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_47(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_47(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_47(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_47(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_47(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_47(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_47(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_47(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_49(int iParam0, int iParam1)
{
	...
	if (MISC::ABSF((Var1 - Var0)) > MISC::ABSF((Var3 - Var2)))
	{
		return 0;
	}
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_112(iVar10, iParam1, iParam2, -1) };
		if (!func_111(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_112(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_112(iVar10, 14, uVar12[iVar1], -1) };
							func_81(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_103(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_103(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_112(iVar10, iVar0, func_70(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_112(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_112(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_112(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_112(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_112(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_112(iVar10, 14, uVar15[iVar1], -1) };
			func_81(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_103(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_62(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_176(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76389[1 /*14*/] = { func_112(iParam0, iParam1, iParam2, -1) };
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_176(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_103(int iParam0)
{
	...
	{
		func_110(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_106(iParam2)];
	if (iVar0 != 0)
	{
...
int func_108(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_106(iParam1)];
...
void func_114(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_121(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_115(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_108(func_118(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_108(func_117(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_108(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_115(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_115(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_115(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_115(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76389[1 /*14*/] = { func_112(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_176(iParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_112(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_176(iParam0, 14, iVar4))
										{
											if (!func_67(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_112(iVar0, iVar2, iVar1, -1) };
						if (!func_67(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar7 <= 8)
		{
			if (!func_176(iParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_186(bool bParam0)
{
	...
	{
		HUD::CLEAR_HELP(1);
		MISC::CLEAR_BIT(&Global_76825, 7);
		func_1(500, 1);
	}
	func_228(303, 0, 0);
	func_227(&Local_169, 0, 1);
	func_226(&iLocal_182);
	func_226(&iLocal_183);
	func_56(PLAYER::PLAYER_PED_ID());
...
void func_193(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_195() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_195() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_198(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_195() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_224()
{
	...
	if (!func_56(iLocal_180[0]))
	{
		iLocal_180[0] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[1]))
	{
		iLocal_180[1] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[2]))
	{
		iLocal_180[2] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[3]))
	{
		iLocal_180[3] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, true, true, false);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		if (func_56(iLocal_180[iVar0]))
		{
			...
			ENTITY::SET_ENTITY_VISIBLE(iLocal_180[iVar0], true, 0);
			ENTITY::SET_ENTITY_COLLISION(iLocal_180[iVar0], true, 0);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_180[iVar0], true);
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_180[iVar0], true);
			func_225(&(iLocal_180[iVar0]), 0);
		}
		iVar0++;
	}
}
