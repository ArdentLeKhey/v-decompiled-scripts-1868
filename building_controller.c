...
void __EntryFunction__()
{
	...
	while (iVar0 < 10)
	{
		StringCopy(&(Global_40356[iVar0 /*8*/]), "", 32);
		iVar0++;
	}
	SYSTEM::WAIT(0);
	while (true)
		...
		else
		{
			...
			switch (iLocal_92)
			{
				...
				case 1:
					...
					if (func_72())
					{
						if (!func_71(9) || Global_110270.f_19 == 4)
						{
							func_47();
			...
			if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_14())
			{
				if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() || func_11())
				{
					if (!Global_1573980)
					{
						...
						if (!MISC::IS_BIT_SET(Global_4456448.f_184548, 14))
						{
				...
				if (MISC::IS_BIT_SET(Global_1676879.f_1275, 8))
				{
					STREAMING::REMOVE_IPL("Coroner_Int_on");
					STREAMING::REQUEST_IPL("Coroner_Int_off");
					MISC::CLEAR_BIT(&(Global_1676879.f_1275), 8);
				}
				if (!Global_1573983)
				{
					if (MISC::IS_BIT_SET(Global_1676879.f_5, 18))
					{
					...
					if (MISC::IS_BIT_SET(Global_1676879.f_5, 19))
					{
...
void func_1()
{
	if (!MISC::IS_BIT_SET(Global_40518, 0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_193[0]))
		{
			...
			{
				iLocal_193[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_x17dlc_rep_sign_01a"), 2222.883f, 5612.299f, 55.291f, false, false, true);
	...
	if ((!MISC::IS_BIT_SET(Global_40518, 1) && func_3() == 0) && !(NETWORK::NETWORK_IS_ACTIVITY_SESSION() && (func_2(Global_4456448.f_154360) == 14 || func_2(Global_4456448.f_154360) == 15)))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_193[1]))
		{
			...
			{
				iLocal_193[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_base_cabinet_door_01"), -362.402f, 4829.89f, 142.477f, false, false, true);
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (func_10(iParam0))
	{
		...
		if (!bParam1)
		{
			if (Global_2540318.f_81[iParam0])
			{
				Global_2540318.f_81[iParam0] = 0;
				Global_2540318.f_118 = (Global_2540318.f_118 + -1);
			}
		}
		if (Global_2540318.f_118 <= 0 || bParam1)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_7());
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_6());
			if (!bParam1)
			{
				Global_2540318.f_118 = 0;
			}
		}
	}
}
...
int func_11()
{
	...
	return func_12(Global_4456448.f_154360);
}
...
void func_15()
{
	...
	while (iVar2 < 7)
	{
		if (Global_37165[iVar2] != 0 || Global_37173[iVar2] != 0)
		{
			bVar3 = false;
		}
		iVar2++;
	...
	if (func_20(iVar0) && !MISC::ARE_STRINGS_EQUAL(&Global_38118, vVar1.f_3))
	{
		bVar4 = false;
		...
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vVar1, true) > 250f && !bVar4)
		{
			func_18(iVar0, 1);
			func_16(iVar0, 0);
			if (iVar0 == 17)
...
void func_26()
{
	...
	{
		fLocal_83 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_40519[iLocal_81 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
	}
	else
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_40519[iLocal_81 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
		if (fVar0 < fLocal_83)
		{
			fLocal_83 = fVar0;
			iLocal_82 = iLocal_81;
	...
	if (!bLocal_85)
	{
		if (Global_40519[iLocal_84 /*31*/].f_24 == 0)
		{
			iLocal_86 = 0;
			iLocal_84++;
			if (iLocal_84 >= 27)
		...
		{
			iLocal_86++;
			if (iLocal_86 >= Global_40519[iLocal_84 /*31*/].f_24)
			{
				iLocal_86 = 0;
				iLocal_84++;
				if (iLocal_84 >= 27)
...
void func_27(int iParam0)
{
	...
	if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 4))
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			{
				if (!MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 6))
				{
					func_34(iParam0, 1);
				}
			}
			else if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 6))
			{
				func_34(iParam0, 0);
			}
		}
	...
	if ((MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 6) || MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 5)) || func_31(iParam0))
	{
		func_30(iParam0);
		iLocal_84 = iParam0;
		if ((((((((Global_40519[iParam0 /*31*/] == -1735618852 || Global_40519[iParam0 /*31*/] == 213039352) || Global_40519[iParam0 /*31*/] == -1247364148) || Global_40519[iParam0 /*31*/] == 935592315) || Global_40519[iParam0 /*31*/] == 179480401) || Global_40519[iParam0 /*31*/] == -804938986) || Global_40519[iParam0 /*31*/] == -599111730) || Global_40519[iParam0 /*31*/] == 1423193534) || Global_40519[iParam0 /*31*/] == -1958174046)
		{
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_40519[iParam0 /*31*/], 1);
		}
		if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 7))
		{
			func_29(iParam0, 1);
		}
		if (!MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 2))
		{
			if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 1))
			{
				if (Global_40519[iParam0 /*31*/].f_22 > -1f)
				{
					Global_40519[iParam0 /*31*/].f_22 = (Global_40519[iParam0 /*31*/].f_22 - (Global_40519[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
					if (Global_40519[iParam0 /*31*/].f_22 < -1f)
					{
						Global_40519[iParam0 /*31*/].f_22 = -1f;
					}
					MISC::CLEAR_BIT(&(Global_40519[iParam0 /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_40519[iParam0 /*31*/].f_1), 2);
				}
			}
			else if (Global_40519[iParam0 /*31*/].f_22 < 1f)
			{
				Global_40519[iParam0 /*31*/].f_22 = (Global_40519[iParam0 /*31*/].f_22 + (Global_40519[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
				if (Global_40519[iParam0 /*31*/].f_22 > 1f)
				{
		...
		else if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 1))
		{
			if (Global_40519[iParam0 /*31*/].f_22 > -1f)
			{
				MISC::CLEAR_BIT(&(Global_40519[iParam0 /*31*/].f_1), 2);
			}
		}
		else if (Global_40519[iParam0 /*31*/].f_22 < 1f)
		{
	...
	else
	{
		...
		if (!MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 3))
		{
			bVar2 = false;
			iVar3 = VEHICLE::GET_CLOSEST_VEHICLE(Global_40519[iParam0 /*31*/].f_2, 15f, 0, 2175);
			if (ENTITY::DOES_ENTITY_EXIST(iVar3))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar3, 0))
				{
					fVar4 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar3, true), Global_40519[iParam0 /*31*/].f_2);
					if (fVar4 < Global_40519[iParam0 /*31*/].f_7)
					{
						bVar2 = true;
					}
				}
			...
			if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 1))
			{
				if (Global_40519[iParam0 /*31*/].f_22 < 0f)
				{
					if (!bVar2)
					{
						Global_40519[iParam0 /*31*/].f_22 = (Global_40519[iParam0 /*31*/].f_22 + (Global_40519[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
				...
				{
					Global_40519[iParam0 /*31*/].f_22 = 0f;
					MISC::SET_BIT(&(Global_40519[iParam0 /*31*/].f_1), 3);
				}
			}
			else if (Global_40519[iParam0 /*31*/].f_22 > 0f)
			{
				if (!bVar2)
				{
					Global_40519[iParam0 /*31*/].f_22 = (Global_40519[iParam0 /*31*/].f_22 - (Global_40519[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
		...
		else
		{
			if ((((((((Global_40519[iParam0 /*31*/] == -1735618852 || Global_40519[iParam0 /*31*/] == 213039352) || Global_40519[iParam0 /*31*/] == -1247364148) || Global_40519[iParam0 /*31*/] == 935592315) || Global_40519[iParam0 /*31*/] == 179480401) || Global_40519[iParam0 /*31*/] == -804938986) || Global_40519[iParam0 /*31*/] == -599111730) || Global_40519[iParam0 /*31*/] == 1423193534) || Global_40519[iParam0 /*31*/] == -1958174046)
			{
				AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_40519[iParam0 /*31*/], 0);
			}
			func_28(iParam0);
		}
	}
...
void func_29(int iParam0, bool bParam1)
{
	...
	if (Global_40519[iParam0 /*31*/] == -1298870201)
	{
		iVar0 = 23;
	}
	else if (Global_40519[iParam0 /*31*/] == 65926040)
	{
		iVar0 = 22;
	}
	else if (Global_40519[iParam0 /*31*/] == 1423193534)
	{
		iVar0 = 26;
	}
	else if (Global_40519[iParam0 /*31*/] == -1958174046)
	{
		iVar0 = 25;
	}
	if (bParam1)
	{
		if (!MISC::IS_BIT_SET(Global_40519[iVar0 /*31*/].f_1, 2))
		{
			if (MISC::IS_BIT_SET(Global_40519[iVar0 /*31*/].f_1, 1))
			{
				if (Global_40519[iVar0 /*31*/].f_22 > -1f)
				{
					Global_40519[iVar0 /*31*/].f_22 = (Global_40519[iVar0 /*31*/].f_22 - (Global_40519[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
					if (Global_40519[iVar0 /*31*/].f_22 < -1f)
					{
						Global_40519[iVar0 /*31*/].f_22 = -1f;
					}
					MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_40519[iVar0 /*31*/].f_1), 2);
				}
			}
			else if (Global_40519[iVar0 /*31*/].f_22 < 1f)
			{
				Global_40519[iVar0 /*31*/].f_22 = (Global_40519[iVar0 /*31*/].f_22 + (Global_40519[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
				if (Global_40519[iVar0 /*31*/].f_22 > 1f)
				{
			...
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_40519[iVar0 /*31*/], Global_40519[iVar0 /*31*/].f_22, false, false);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40519[iVar0 /*31*/], 1, false, true);
		}
		else if (MISC::IS_BIT_SET(Global_40519[iVar0 /*31*/].f_1, 1))
		{
			if (Global_40519[iVar0 /*31*/].f_22 > -1f)
			{
				MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 2);
			}
		}
		else if (Global_40519[iVar0 /*31*/].f_22 < 1f)
		{
	...
	else if (!MISC::IS_BIT_SET(Global_40519[iVar0 /*31*/].f_1, 3))
	{
		bVar1 = false;
		iVar2 = VEHICLE::GET_CLOSEST_VEHICLE(Global_40519[iVar0 /*31*/].f_2, 15f, 0, 2175);
		if (ENTITY::DOES_ENTITY_EXIST(iVar2))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, 0))
			{
				fVar3 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar2, true), Global_40519[iVar0 /*31*/].f_2);
				if (fVar3 < Global_40519[iVar0 /*31*/].f_7)
				{
					bVar1 = true;
				}
			}
		...
		if (MISC::IS_BIT_SET(Global_40519[iVar0 /*31*/].f_1, 1))
		{
			if (Global_40519[iVar0 /*31*/].f_22 < 0f)
			{
				if (!bVar1)
				{
					Global_40519[iVar0 /*31*/].f_22 = (Global_40519[iVar0 /*31*/].f_22 + (Global_40519[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
			...
			{
				Global_40519[iVar0 /*31*/].f_22 = 0f;
				MISC::SET_BIT(&(Global_40519[iVar0 /*31*/].f_1), 3);
			}
		}
		else if (Global_40519[iVar0 /*31*/].f_22 > 0f)
		{
			if (!bVar1)
			{
				Global_40519[iVar0 /*31*/].f_22 = (Global_40519[iVar0 /*31*/].f_22 - (Global_40519[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
	...
	if (Global_40519[iParam0 /*31*/].f_24 > 0)
	{
		...
		while (iVar0 < Global_40519[iParam0 /*31*/].f_24)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar1))
			{
				...
				{
					if (SYSTEM::VDIST2(Global_40519[iParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(iVar1, true)) < Global_40519[iParam0 /*31*/].f_6)
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1, Global_40519[iParam0 /*31*/].f_9, Global_40519[iParam0 /*31*/].f_12, Global_40519[iParam0 /*31*/].f_8, 0, true, 0))
						{
							iLocal_86 = iVar0;
							return 1;
						}
						if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 0))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1, Global_40519[iParam0 /*31*/].f_16, Global_40519[iParam0 /*31*/].f_19, Global_40519[iParam0 /*31*/].f_15, 0, true, 0))
							{
								iLocal_86 = iVar0;
								return 1;
							}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(iVar1, 0))
						{
							...
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar5, Global_40519[iParam0 /*31*/].f_9, Global_40519[iParam0 /*31*/].f_12, Global_40519[iParam0 /*31*/].f_8, 0, true))
							{
								iLocal_86 = iVar0;
								return 1;
							}
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar6, Global_40519[iParam0 /*31*/].f_9, Global_40519[iParam0 /*31*/].f_12, Global_40519[iParam0 /*31*/].f_8, 0, true))
							{
								iLocal_86 = iVar0;
								return 1;
							}
							if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 0))
							{
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar5, Global_40519[iParam0 /*31*/].f_16, Global_40519[iParam0 /*31*/].f_19, Global_40519[iParam0 /*31*/].f_15, 0, true))
								{
									iLocal_86 = iVar0;
									return 1;
								}
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar6, Global_40519[iParam0 /*31*/].f_16, Global_40519[iParam0 /*31*/].f_19, Global_40519[iParam0 /*31*/].f_15, 0, true))
								{
									iLocal_86 = iVar0;
									return 1;
								}
							...
							if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(iVar2))
							{
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar7, Global_40519[iParam0 /*31*/].f_9, Global_40519[iParam0 /*31*/].f_12, Global_40519[iParam0 /*31*/].f_8, 0, true, 0))
									{
										iLocal_86 = iVar0;
										return 1;
									}
									if (MISC::IS_BIT_SET(Global_40519[iParam0 /*31*/].f_1, 0))
									{
										if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar7, Global_40519[iParam0 /*31*/].f_16, Global_40519[iParam0 /*31*/].f_19, Global_40519[iParam0 /*31*/].f_15, 0, true, 0))
										{
											iLocal_86 = iVar0;
											return 1;
										}
...
void func_34(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_40519[iParam0 /*31*/].f_1), 6);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_40519[iParam0 /*31*/].f_1), 6);
	}
}
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			switch (iParam0)
			{
				case 13:
					...
					{
						if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[78 /*34*/].f_6) == 0)
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_40519[13 /*31*/].f_2, true) <= 100f)
							{
					...
					else if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[78 /*34*/].f_6) == 0)
					{
						if (func_46(13, PLAYER::PLAYER_PED_ID()))
						{
							func_33(13, PLAYER::PLAYER_PED_ID(), 0);
				...
				case 17:
				case 16:
					if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[9 /*34*/].f_6) == 0 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("extreme2")) == 0)
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_40519[17 /*31*/].f_2, true) <= 100f)
						{
							switch (func_39())
							{
								case 0:
				...
				case 22:
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_40519[22 /*31*/].f_2, true) <= 100f)
					{
						switch (func_39())
						{
							case 0:
				...
				case 14:
				case 15:
					if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[27 /*34*/].f_6) == 0)
					{
				...
				case 24:
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 480.4354f, -1317.91f, 29.5957f) < 400f)
					{
						if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[8 /*34*/].f_6) == 0 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[10 /*34*/].f_6) == 0)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != INTERIOR::GET_INTERIOR_AT_COORDS(480.4354f, -1317.91f, 29.5957f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 486.86f, -1316.604f, 27.71937f, 484.8906f, -1312.647f, 31.72312f, 4.25f, 0, true, 0))
								{
				...
				case 4:
					if (!func_46(4, PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							case 0:
								if (SYSTEM::VDIST2(Global_40519[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
								{
							...
							case 1:
								if (func_37(2))
								{
									...
									else if (SYSTEM::VDIST2(Global_40519[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
									{
										func_45(4, PLAYER::PLAYER_PED_ID());
									}
								}
...
void func_40()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_43(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_42(PLAYER::PLAYER_PED_ID());
			if (func_41(iVar0) && (!func_71(14) || Global_110511))
			{
...
{
	if ((MISC::IS_BIT_SET(Global_37192[(iParam0 / 32)], (iParam0 % 32)) && Global_37655[iParam0] != 2) && !MISC::IS_BIT_SET(Global_37428[(iParam0 / 32)], (iParam0 % 32)))
	{
		Global_37201[iParam0] = (Global_37201[iParam0] - 1);
		if (Global_37201[iParam0] <= 0)
		{
...
int func_53(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_54(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_55(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_56(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111560.f_7256[iParam0], true, true);
			}
...
void func_74()
{
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
		...
		while (iVar0 < 10)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_40437[iVar0 /*8*/])))
			{
				if (!STREAMING::IS_IPL_ACTIVE(&(Global_40437[iVar0 /*8*/])))
				{
					STREAMING::REQUEST_IPL(&(Global_40437[iVar0 /*8*/]));
				}
				StringCopy(&(Global_40437[iVar0 /*8*/]), "", 32);
			}
			iVar0++;
		}
	}
	...
	if (Global_39558)
	{
		...
		while (iVar1 < 198)
		{
			func_78(&vLocal_95, iVar1);
			func_77(&vLocal_95, iVar1, Global_38761[iVar1]);
			func_75(&vLocal_95, iVar1, Global_38761[iVar1]);
			Global_39758[iVar1] = 0;
			iVar1++;
		}
		Global_39558 = 0;
	}
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		...
		while (iVar3 < 10)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_40356[iVar3 /*8*/])))
			{
				if (STREAMING::IS_IPL_ACTIVE(&(Global_40356[iVar3 /*8*/])))
				{
					STREAMING::REMOVE_IPL(&(Global_40356[iVar3 /*8*/]));
				}
				StringCopy(&(Global_40356[iVar3 /*8*/]), "", 32);
			}
			iVar3++;
		}
	}
...
void func_75(var uParam0, int iParam1, int iParam2)
{
	if (!func_76(uParam0->f_79, 0f, 0f, 0f, 0))
	{
		if (iParam2 == 0)
		{
			if (Global_39559[iParam1])
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_40156[iParam1], 0);
				Global_39559[iParam1] = 0;
			}
		}
		else if (iParam2 == 1 || iParam2 == 2)
		{
			if (!Global_39559[iParam1])
			{
				Global_40156[iParam1] = PED::ADD_SCENARIO_BLOCKING_AREA(uParam0->f_79, uParam0->f_82, 0, 1, 1, 1);
				Global_39559[iParam1] = 1;
			}
		}
	}
}
...
void func_77(var uParam0, int iParam1, int iParam2)
{
	if (!func_76(uParam0->f_58, 0f, 0f, 0f, 0) && !func_76(uParam0->f_61, 0f, 0f, 0f, 0))
	{
		...
		{
			PATHFIND::SET_ROADS_IN_AREA(uParam0->f_58, uParam0->f_61, true, 1);
		}
		else
		{
			PATHFIND::SET_ROADS_IN_AREA(uParam0->f_58, uParam0->f_61, false, 1);
		}
	}
	if (!func_76(uParam0->f_68, 0f, 0f, 0f, 0))
	{
		...
		{
			if (!Global_39159[iParam1])
			{
				Global_38960[iParam1] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uParam0->f_68, uParam0->f_71, uParam0->f_74, 0, 7);
				Global_39159[iParam1] = 1;
			}
		}
		else if (Global_39159[iParam1])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_38960[iParam1]);
			Global_39159[iParam1] = 0;
		}
	}
...
int func_79(int iParam0)
{
	...
	iVar1 = 0;
	Global_1653163 = 0;
	if (Global_38562[iParam0] || (!func_72() && !Global_39358[iParam0]))
	{
	...
	if (Global_38761[iParam0] == 1)
	{
		func_78(&vLocal_95, iParam0);
		bVar0 = true;
		if (vLocal_95.f_33)
		{
			if (MISC::GET_HASH_KEY(&(vLocal_95.f_8[2 /*8*/])) != MISC::GET_HASH_KEY(""))
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_95, true) > 250f)
				{
	...
	if (Global_39957[iParam0])
	{
		...
		func_77(&vLocal_95, iParam0, Global_38761[iParam0]);
		Global_39957[iParam0] = 0;
	}
	if (Global_39758[iParam0])
	{
		if (!bVar0)
		{
			func_78(&vLocal_95, iParam0);
		...
		func_75(&vLocal_95, iParam0, Global_38761[iParam0]);
		Global_39758[iParam0] = 0;
	}
	return iVar1;
}
...
void func_84()
{
	...
	if (Global_37182)
	{
		...
		while (iVar0 < 27)
		{
			if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_40519[iVar0 /*31*/]))
			{
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(Global_40519[iVar0 /*31*/]);
			}
			iVar0++;
		}
	}
...
void func_85()
{
	if (!iLocal_94 && MISC::IS_BIT_SET(Global_111560.f_9080.f_2[27 /*3*/], 2))
	{
		iLocal_94 = 1;
		bLocal_93 = true;
	}
...
void func_87(char* sParam0)
{
	...
	else
	{
		...
		while (iVar0 < 10)
		{
			iVar2 = MISC::GET_HASH_KEY(&(Global_40356[iVar0 /*8*/]));
			if (iVar2 == 0)
			{
				iVar4 = iVar0;
			}
		...
		if (!bVar3 && iVar4 != -1)
		{
			StringCopy(&(Global_40356[iVar4 /*8*/]), sParam0, 32);
		}
	}
}
...
void func_88()
{
	...
	Global_2437549.f_75.f_426 = 0;
	if (!func_99())
	{
		func_98();
		iLocal_188 = 1;
	}
	Global_38126.f_227 = 0;
	iVar0 = 0;
	while (iVar0 < 226)
	{
		MISC::SET_BIT(&(Global_37183[(iVar0 / 32)]), (iVar0 % 32));
		Global_37201[iVar0] = 0;
		MISC::CLEAR_BIT(&(Global_37192[(iVar0 / 32)]), (iVar0 % 32));
		Global_37655[iVar0] = 0;
		Global_37882[iVar0] = 1;
		MISC::SET_BIT(&(Global_37428[(iVar0 / 32)]), (iVar0 % 32));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 198)
	{
		Global_38363[iVar0] = 0;
		if (Global_39159[iVar0])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_38960[iVar0]);
			Global_39159[iVar0] = 0;
		}
		if (Global_39559[iVar0])
		{
			PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_40156[iVar0], 0);
			Global_39559[iVar0] = 0;
		}
		Global_39358[iVar0] = 0;
		iVar0++;
	}
	Global_39557 = 0;
	if (func_72())
	...
	while (iVar1 < 10)
	{
		StringCopy(&(Global_40437[iVar1 /*8*/]), "", 32);
		iVar1++;
	}
	func_90();
	if (!func_72())
...
void func_91(int iParam0)
{
	...
	if (Global_111560.f_7256.f_426)
	{
		iVar0 = 0;
		while (iVar0 < 198)
		{
			Global_38363[iVar0] = 1;
...
void func_92()
{
	...
	while (iVar0 < 7)
	{
		Global_37165[iVar0] = 0;
		Global_37173[iVar0] = 0;
		iVar0++;
	}
	func_21(3, 1);
	func_21(11, 1);
...
void func_94()
{
	func_81(12, Global_111560.f_7256.f_227[12]);
	func_81(65, Global_111560.f_7256.f_227[65]);
	func_81(6, Global_111560.f_7256.f_227[6]);
	func_81(174, Global_111560.f_7256.f_227[174]);
	func_81(37, Global_111560.f_7256.f_227[37]);
}
...
void func_95()
{
	...
	while (iVar0 < 226)
	{
		...
		{
			OBJECT::ADD_DOOR_TO_SYSTEM(vVar1.f_5, vVar1.f_3, vVar1, 0, false, 0);
		}
		iVar0++;
	}
	Global_37182 = 1;
...
void func_96()
{
	...
	while (iVar0 < 27)
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(Global_40519[iVar0 /*31*/], Global_40519[iVar0 /*31*/].f_5, Global_40519[iVar0 /*31*/].f_2, 1, true, 0);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40519[iVar0 /*31*/], 1, true, false);
		Global_40519[iVar0 /*31*/].f_22 = OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(Global_40519[iVar0 /*31*/]);
		MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 2);
		MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 3);
		MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 5);
		MISC::CLEAR_BIT(&(Global_40519[iVar0 /*31*/].f_1), 6);
		iVar0++;
	}
	bLocal_87 = true;
}
...
void func_97()
{
	...
	iVar0 = 4;
	Global_40519[iVar0 /*31*/] = -1735618852;
	Global_40519[iVar0 /*31*/].f_2 = { -844f, 156f, 66f };
	Global_40519[iVar0 /*31*/].f_5 = joaat("prop_lrggate_02_ld");
	Global_40519[iVar0 /*31*/].f_6 = 900f;
	Global_40519[iVar0 /*31*/].f_7 =
*31*/].f_2 = { 460.06f, -2003.11f, 22.14f };
	Global_40519[iVar0 /*31*/].f_5 = joaat("prop_facgate_01b");
	Global_40519[iVar0 /*31*/].f_6 = 324f;
	Global_40519[iVar0 /*31*/].f_7 = 9f;
	Global_40519[iVar0 /*31*/].f_8 = 10f;
	Global_40519[iVar0 /*31*/].f_9 = { 444.0669f, -1993.736f, 21.10992f };
...
void func_98()
{
	...
	while (iVar0 <= 197)
	{
		if (func_72())
		{
			Global_111560.f_7256.f_227[iVar0] = 0;
		}
		else
		{
			Global_2437549.f_75.f_227[iVar0] = 0;
		}
		Global_38562[iVar0] = 1;
		Global_38363[iVar0] = 0;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 225)
	{
		if (func_72())
		{
			Global_111560.f_7256[iVar0] = 1;
		}
		else
		{
			Global_2437549.f_75[iVar0] = 0;
		}
		MISC::SET_BIT(&(Global_37183[(iVar0 / 32)]), (iVar0 % 32));
		Global_38126.f_227 = 0;
		Global_37201[iVar0] = 0;
		MISC::CLEAR_BIT(&(Global_37192[(iVar0 / 32)]), (iVar0 % 32));
		Global_37655[iVar0] = 0;
		Global_37882[iVar0] = 0;
		iVar0++;
	}
	if (func_72())
	{
		Global_111560.f_7256.f_227[185] = 1;
		Global_111560.f_7256.f_227[187] = 1;
		Global_111560.f_7256.f_227[186] = 1;
		Global_111560.f_7256.f_227[86] = 1;
		Global_111560.f_7256[106] = 0;
		Global_111560.f_7256[64] = 0;
		Global_111560.f_7256[65] = 0;
		Global_111560.f_7256[66] = 0;
		Global_111560.f_7256[164] = 0;
		Global_111560.f_7256.f_426 = 1;
	}
	else
	{
		Global_2437549.f_75.f_227[62] = 1;
		Global_2437549.f_75.f_227[179] = 1;
		Global_2437549.f_75.f_227[14] = 1;
		Global_2437549.f_75.f_227[86] = 1;
		Global_2437549.f_75.f_227[173] = 1;
		Global_2437549.f_75.f_227[76] = 1;
		Global_2437549.f_75.f_227[94] = 1;
		Global_2437549.f_75.f_227[70] = 1;
		Global_2437549.f_75.f_227[71] = 1;
		Global_2437549.f_75.f_227[73] = 1;
		Global_2437549.f_75.f_227[72] = 0;
		Global_2437549.f_75.f_227[74] = 0;
		Global_2437549.f_75.f_426 = 1;
	}
	Global_111560.f_7256.f_227[76] = 1;
	Global_111560.f_7256.f_227[94] = 1;
}
...
bool func_99()
{
	if (func_72())
	{
		return Global_111560.f_7256.f_426;
	}
	return Global_2437549.f_75.f_426;
}
...
void func_101(char* sParam0, int iParam1, vector3 vParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		...
		{
			OBJECT::ADD_DOOR_TO_SYSTEM(iVar0, iParam1, vParam2, 0, false, 0);
		}
...
void func_103()
{
	if (func_72())
	{
		if (((!Global_111560.f_7256.f_426 || MISC::IS_BIT_SET(iLocal_78, 0)) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) || Global_37181)
		{
			if (!Global_2460406)
			{
				if (MISC::IS_BIT_SET(iLocal_78, 0) || Global_37181)
				{
					iLocal_188 = 1;
				}
				iLocal_92 = 0;
	...
	else if ((MISC::IS_BIT_SET(iLocal_78, 1) || ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_93()) && !func_104())) || Global_37181)
	{
		if (func_3() == 2)
		{
