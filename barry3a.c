#region Local Var
	...
	int iLocal_54[2] = { 0, 0 };
	vector3 vLocal_55[6] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_38 = func_496(49);
	vLocal_50 = { 0f, -1f, 0.64f };
	iLocal_51 = joaat("prop_weed_tub_01b");
	vLocal_53 = { -1138.977f, -1252.549f, 6.05f };
	...
	if (func_450())
	{
		...
		{
			case 0:
				func_448(Local_43, Local_43.f_3, 1, 0);
				func_446(1);
				break;
			
			case 1:
				func_448(vLocal_53, 298.7f, 1, 0);
				func_445(1);
				break;
	...
	{
		func_423(&(Local_56[0 /*29*/]), &(Local_39.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_28[0]))
	{
		func_422(&(Local_56[0 /*29*/].f_1), &(Local_39.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_28[1]))
	{
		func_422(&(Local_56[0 /*29*/].f_2), &(Local_39.f_28[1]));
	}
	func_420();
	while (true)
	{
		RECORDING::_0x208784099002BC30("SF_GRTP", 0);
		func_404(Local_39.f_9, 0, 0, 1, 0, 0);
		func_399();
		if (iLocal_40 == 9)
		{
			func_392();
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_241 = 1;
					iLocal_242 = 0;
					iLocal_42 = func_213(vLocal_53, 5, 1);
				}
				else
				{
					iLocal_241 = 1;
			...
			else
			{
				...
				iLocal_42 = func_208(Local_43.f_4, 1, 5);
			}
			iLocal_41 = 1;
			break;
		
		case 1:
			if (!func_207(Local_43.f_4, vLocal_53, 125f))
			{
			...
			else if (!iLocal_241)
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0))
				{
					...
					{
						iLocal_242 = 0;
						if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
						{
							func_214(&iLocal_42);
							iLocal_41 = 0;
							iLocal_40 = 6;
				...
				else if (iLocal_240 && !func_212())
				{
					func_210(3);
					iLocal_240 = 0;
				}
			}
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0))
			{
				HUD::CLEAR_PRINTS();
				iLocal_241 = 0;
				iLocal_240 = 1;
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
			{
				func_214(&iLocal_42);
				iLocal_41 = 0;
				iLocal_40 = 6;
...
bool func_207(int iParam0, vector3 vParam1, float fParam2)
{
...
{
	if (vLocal_55[iParam0 /*3*/].f_1 < vLocal_55[iParam0 /*3*/] || vLocal_55[iParam0 /*3*/] == -1)
	{
		return 1;
	}
	return 0;
...
void func_210(int iParam0)
{
	if (func_209(iParam0))
	{
		func_211(vLocal_55[iParam0 /*3*/].f_2, 7500, 1);
		vLocal_55[iParam0 /*3*/].f_1++;
	}
}
...
int func_213(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_215()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 10f, 10f, 2f, false, true, 0))
			{
				func_214(&iLocal_42);
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_217();
					if (!func_216(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 55f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_209(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
void func_217()
{
	...
	else if (!iLocal_237)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_239)
		{
			if (iLocal_233 == 1)
			{
				if (func_218(&uLocal_63, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_41 = 1;
					iLocal_237 = 1;
				}
			}
			else if (func_218(&uLocal_63, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_41 = 1;
				iLocal_237 = 1;
			}
...
int func_235()
{
	...
	while (iLocal_62 <= 5)
	{
		if (func_236(vLocal_55[iLocal_62 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_62++;
...
void func_237()
{
	switch (iLocal_41)
	{
		case 0:
			...
			if (func_240(Local_43.f_4, 1093140480, 1, 1056964608, 0, 1, 0))
			{
				func_239(0, -1);
				iLocal_246 = 0;
				iLocal_243 = 0;
		...
		case 2:
			func_238(&uLocal_63, 3, 0, "BARRY", 0, 1);
			iLocal_41 = 0;
			iLocal_40 = 7;
			break;
	}
...
int func_240(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_242()
{
	switch (iLocal_41)
	{
		...
		case 1:
			func_248(&uLocal_254, &uLocal_63, "BAR3AAU", &sLocal_255, &cLocal_261);
...
void func_245()
{
	...
	{
		if (!func_212() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0))
		{
			if (!iLocal_229)
			{
				iLocal_229 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_231) > Local_228[iLocal_230 /*2*/].f_1 && (func_247() || iLocal_230 == 0))
			{
				if (iLocal_230 != 2 || ENTITY::GET_ENTITY_SPEED(Local_43.f_4) > 10f)
				{
					if (func_235() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (func_246(&uLocal_63, "BAR3AAU", Local_228[iLocal_230 /*2*/], 7, 1, 0, 0))
						{
							iLocal_229 = 0;
							iLocal_230++;
						}
					}
					else if (func_246(&uLocal_63, "BAR3AAU", Local_228[iLocal_230 /*2*/], 7, 0, 0, 0))
					{
						iLocal_229 = 0;
						iLocal_230++;
					}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0))
			{
				...
				else
				{
					...
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_243 = 0;
						iLocal_41 = 2;
					}
					if (!iLocal_236)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_231) > 8000 && iLocal_230 >= 4) && !func_212())
						{
							if (func_246(&uLocal_63, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_236 = 1;
							}
						}
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_201(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_111560.f_18569[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_156(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_98706, iParam0);
			}
			else
			{
				iVar6 = func_328(&(Global_98669.f_3));
				if (iVar6 > -1)
				{
...
{
	func_260(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_279(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_68(iParam1)];
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_111560.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_286(Var7.f_1)) && iVar9 < 51)
			{
...
int func_292(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
bool func_294(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_300(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_301(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_311(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_224())
			{
				if (func_310(Global_1590285))
				{
					return func_303(2, 2);
				}
				else if (func_302(Global_1590285))
				{
...
int func_304(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_309(iParam1, &vVar1))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var2 = { func_307(iParam0) };
	}
	else
	{
		Var2 = { func_306(iParam0) };
	}
	vVar3 = { Var2 - Var0 };
	vVar3 = { func_305(vVar3, -Var0.f_3.f_2) };
	vVar3 = { func_305(vVar3, vVar1.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar1, 0f, vVar3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_305(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_329(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_330(Global_111560.f_9080.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_330(Global_111560.f_9080.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_330(Global_111560.f_9080.f_99.f_205[11]);
			break;
		
		case 90:
			return func_330(Global_111560.f_9080.f_99.f_205[7]);
			break;
		
		case 93:
			return func_330(Global_111560.f_9080.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_335(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		...
		{
			if (func_362(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_336(Global_102125.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_336(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_355(iParam3, &Var0, vParam1, fParam2, func_267(iParam0));
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_317();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_271(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_339(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_353(iParam0)) || func_352(iParam0)) || func_351(iParam0)) || func_350(iParam0)) || !func_340(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_352(iParam0))
		{
		}
...
int func_354(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_294(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_355(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_354(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_359(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_360(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_364()
{
	switch (iLocal_41)
	{
		case 0:
			func_238(&uLocal_63, 3, 0, "BARRY", 0, 1);
			if (func_218(&uLocal_63, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_41 = 1;
			}
			break;
...
void func_365()
{
	...
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, false, 1);
		iLocal_42 = func_208(Local_43.f_4, 1, 5);
		iLocal_40 = 1;
		iLocal_41 = 0;
	}
...
void func_367(int iParam0)
{
	switch (Local_56[iParam0 /*29*/].f_24)
	{
		case 0:
			...
			{
				if (func_204(Local_56[iParam0 /*29*/]))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_59))
					{
						Local_56[iParam0 /*29*/].f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, -1, 1, true);
						Local_56[iParam0 /*29*/].f_2 = PED::CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, 0, 1, true);
					}
				}
			...
			else if (!ENTITY::IS_ENTITY_DEAD(Local_56[iParam0 /*29*/].f_1, 0))
			{
				PED::SET_PED_AS_COP(Local_56[iParam0 /*29*/].f_1, 1);
		...
		case 1:
			if (func_207(PLAYER::PLAYER_PED_ID(), Local_56[iParam0 /*29*/].f_3, 275f))
			{
				if (func_386(iParam0))
				{
				...
				else if ((func_385(Local_56[iParam0 /*29*/]) || func_372(Local_56[iParam0 /*29*/].f_1)) || func_372(Local_56[iParam0 /*29*/].f_2))
				{
					func_370(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if ((func_372(Local_56[iParam0 /*29*/].f_1) || func_372(Local_56[iParam0 /*29*/].f_2)) || func_385(Local_56[iParam0 /*29*/]))
				{
					func_370(iParam0, 0);
				}
			}
		...
		case 2:
			...
			else if ((func_372(Local_56[iParam0 /*29*/].f_1) || func_372(Local_56[iParam0 /*29*/].f_2)) || func_385(Local_56[iParam0 /*29*/]))
			{
				func_370(iParam0, 0);
			}
			break;
...
int func_372(int iParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		else if (MISC::IS_PROJECTILE_IN_AREA(vVar0 - Vector(3f, 3f, 3f), vVar0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_376(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_381(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_385(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		else if (MISC::IS_PROJECTILE_IN_AREA(vVar0 - Vector(5f, 5f, 5f), vVar0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, true, 0))
	{
		return 1;
	}
	else if (Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_390()
{
	switch (iLocal_243)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_247 && MISC::GET_GAME_TIMER() >= iLocal_245) && !func_212())
				{
					if (func_246(&uLocal_63, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_247 = 1;
					}
				}
	...
	switch (iLocal_41)
	{
		case 0:
			if (!func_398())
			{
				...
				if (MISC::ARE_STRINGS_EQUAL(sLocal_253, "DEFAULT"))
				{
					func_472(1);
				}
				else
				{
					func_396(sLocal_253, 1);
				}
				iLocal_41 = 1;
			}
			break;
...
void func_393(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_62 <= 1)
		{
			func_369(&(Local_56[iLocal_62 /*29*/].f_1));
			func_369(&(Local_56[iLocal_62 /*29*/].f_2));
			iLocal_62++;
		}
		iLocal_62 = 0;
		while (iLocal_62 <= 1)
		{
			func_203(&(Local_56[iLocal_62 /*29*/]));
			iLocal_62++;
		}
	}
	else
	{
		func_394(&iLocal_49, 0);
		func_371(&(Local_43.f_4));
		iLocal_62 = 0;
		while (iLocal_62 <= 1)
		{
			func_368(&(Local_56[iLocal_62 /*29*/].f_1), 1, 0, 1);
			func_368(&(Local_56[iLocal_62 /*29*/].f_2), 1, 0, 1);
			func_371(&(Local_56[iLocal_62 /*29*/]));
			iLocal_62++;
		}
	}
	if (iLocal_57)
	...
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, true, 1);
}
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_407(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_417(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_419(iParam0, Global_41396);
}
...
void func_429(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_435(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_437(bool bParam0)
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1243.316f, -1041.637f, 7.5121f, 1, false, 0, 1);
...
{
	if (vLocal_55[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		vLocal_55[iParam0 /*3*/].f_1 = vLocal_55[iParam0 /*3*/];
	}
}
...
void func_442(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	func_206(&iLocal_49);
	func_203(&(Local_43.f_4));
	Local_43.f_4 = VEHICLE::CREATE_VEHICLE(Local_43.f_5, vParam0, fParam1, true, true, false);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_43.f_4, 1);
	if (bParam2)
	{
		func_443(PLAYER::PLAYER_PED_ID(), Local_43.f_4, -1);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_43.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_43.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_43.f_4, true);
	...
	iLocal_49 = OBJECT::CREATE_OBJECT(iLocal_51, vParam0, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_49, Local_43.f_4, 0, vLocal_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	ENTITY::SET_ENTITY_COLLISION(iLocal_49, true, 0);
	bLocal_46 = true;
	func_421(Local_43.f_4, 0);
...
void func_446(bool bParam0)
{
	...
	if (bParam0)
	{
		...
		{
			func_442(Local_43, Local_43.f_3, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_442(Local_43, Local_43.f_3, 1);
	}
	iLocal_243 = 1;
	iLocal_246 = 1;
}
...
{
	vLocal_55[iParam0 /*3*/].f_1 = iParam1;
}
...
void func_459()
{
	...
	Local_56[0 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1216.144f, -1287.004f, 33.97642f };
	Local_56[0 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1202.456f, -1306.054f, 39.47411f };
	Local_56[0 /*29*/].f_7[0 /*8*/].f_7 = 16.5f;
	Local_56[0 /*29*/].f_7[1 /*8*/][0 /*3*/] = { 1204.858f, -1296.131f, 33.97642f };
	Local_56[0 /*29*/].f_7[1 /*8*/][1 /*3*/] = { 1198.832f, -1365.926f, 39.47705f };
	Local_56[0 /*29*/].f_7[1 /*8*/].f_7 = 37.5f;
	Local_56[0 /*29*/].f_24 = 0;
	Local_56[1 /*29*/].f_3 = { 1162.71f, -1357.86f, 33.73f };
	Local_56[1 /*29*/].f_6 = 266.7f;
	Local_56[1 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1164.457f, -1363.839f, 33.51062f };
	Local_56[1 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1180.637f, -1359.837f, 39.11396f };
...
void func_460()
{
	vLocal_55[0 /*3*/] = { func_461("B3ADELV", 1) };
	vLocal_55[1 /*3*/] = { func_461("B3AGETIN", 1) };
	vLocal_55[2 /*3*/] = { func_461("B3AWAN1", -1) };
	vLocal_55[3 /*3*/] = { func_461("B3ARTV", 1) };
	vLocal_55[4 /*3*/] = { func_461("B3AEXIT", 1) };
	vLocal_55[5 /*3*/] = { func_461("B3ALEAVE", 1) };
}
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar2 = func_328(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_475()
{
	...
	iVar0 = func_331(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_477()
{
	...
	{
		if (func_328(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
