#region Local Var
	...
	int iLocal_91 = 0;
	int iLocal_92 = 0;
	struct<7> Local_93 = { 0, 0, 0, 0, 0, 0, 0 } ;
	int iLocal_94 = 0;
	int iLocal_95 = 0;
	int iLocal_96 = 0;
	int iLocal_97 = 0;
...
void __EntryFunction__()
{
	...
	Var0.f_1 = 5;
	Var0.f_17 = 5;
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_104))
	{
		vLocal_56 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_104, true) };
		iLocal_94 = iScriptParam_104;
		Var0.f_1[0 /*3*/] = { vLocal_56 };
		iLocal_78 = ENTITY::GET_ENTITY_MODEL(iLocal_94);
	}
	else
	{
		iLocal_94 = iScriptParam_104;
	...
	iLocal_59 = 0;
	func_117(&Global_110211, 0);
	func_116();
	if (func_115(uLocal_58, 1))
	{
		iLocal_64 = 10;
	}
	else
	...
	if (!func_115(uLocal_58, 8))
	{
		if (!func_113(iLocal_64))
		{
			if (func_112(0, iLocal_63))
			{
				func_119(0);
			}
			else
	...
	if (func_115(uLocal_58, 8388608))
	{
		func_119(1);
	}
	if (func_115(uLocal_58, 524288) && (func_111() && !func_110()))
	{
		func_119(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_115(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			func_109(iLocal_69, 1, 0);
			iLocal_69 = 263;
		}
		func_108(10);
	}
	while (true)
	{
		if (!func_115(uLocal_58, 268435456))
		{
			fVar2 = 0f;
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0 /*3*/], &fVar2, 0, 0))
			{
				if (fVar2 != 0f)
				{
					Var0.f_1[0 /*3*/].f_2 = fVar2;
					func_107(&uLocal_58, 268435456);
				}
			}
		}
		iLocal_53 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
		if (func_115(uLocal_58, 1048576))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(vLocal_55, Var0.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			vLocal_75 = { vLocal_55 };
			vLocal_76 = { Var0.f_1[0 /*3*/] };
			vLocal_75.z = 0f;
			vLocal_76.z = 0f;
			...
			{
				case 0:
					if (func_113(iLocal_64) || (func_115(uLocal_58, 16) && !func_115(uLocal_58, 524288)))
					{
						iLocal_62 = -1;
						func_106();
						func_108(1);
					...
					else
					{
						...
						if ((vLocal_55.z - Var0.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (!func_115(uLocal_58, 4))
					{
						func_102();
						func_107(&uLocal_58, 4);
					}
					if (fLocal_74 > (fLocal_66 * fLocal_66) && !Global_98703)
					{
						if (iLocal_69 != 263)
						{
							if (func_101(6) && !func_100(iLocal_69))
							{
							}
							else
							{
					...
					{
						Local_52 = { Local_51 };
						bVar4 = !func_115(uLocal_58, 64);
						func_117(&uLocal_58, 128);
						if (!func_99(3) && !Global_98703)
						{
							if (func_115(uLocal_58, 2097152))
							{
								if ((!func_115(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_98())) && !Global_98703)
								{
									func_108(10);
									break;
								}
						...
						if ((!func_89(6) || Global_110607) || func_88())
						{
							bVar4 = false;
						}
						if (func_115(uLocal_58, 1))
						...
						if (bVar4)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, Var0.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, false, true, iLocal_67))
							{
								bVar4 = false;
							}
							if (ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
							{
								iLocal_94 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_56, 2f, iLocal_78, 1, 0, 1);
								func_85(&uLocal_58, 128);
								bVar4 = false;
							}
							else
							{
								vLocal_83 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_94, vLocal_82) };
								if (func_78(&Local_79, vLocal_55, vLocal_83, iLocal_94))
								{
									bLocal_80 = false;
								}
								else if (Local_79.f_12 == 1)
								{
									bLocal_80 = true;
								}
								if (bLocal_80)
							...
							if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != iLocal_84)
							{
								bVar4 = false;
							}
							...
							if (bVar4)
							{
								...
								if (func_77(uLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_76(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_85(&uLocal_58, 2048);
									}
									else if (!func_115(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_60);
										func_117(&uLocal_58, 2048);
									}
									if (func_73(iLocal_60, 1))
									{
										sLocal_65 = sLocal_65;
										func_75(&iLocal_60);
										func_117(&uLocal_58, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar5 != 1)
						{
							iVar5 = func_34(&iLocal_62, 6, iLocal_64, 0, 0);
						}
						if (iVar5 == 1)
						{
				...
				case 6:
					if (func_115(Global_110211, 262144))
					{
						func_117(&Global_110211, 262144);
						func_13();
					}
					if (func_115(uLocal_58, 2097152))
					{
						if (!func_99(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
						{
							func_108(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						func_8(&iLocal_71);
						func_117(&uLocal_58, 256);
						func_7();
						if (bVar1)
						{
							func_117(&uLocal_58, 2);
						}
						else if (func_115(uLocal_58, 2))
						{
							if (func_115(Global_110211, 0))
							{
								func_6(&iLocal_62);
								iLocal_62 = -1;
								func_117(&uLocal_58, 2);
						...
						func_4();
						func_117(&Global_110211, 0);
						if (func_115(uLocal_58, 16777216))
						{
							func_119(1);
						}
						if (iLocal_63 != -1)
					...
					if ((iLocal_68 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_70 == 2)
							{
								if (iLocal_70 == 2)
								{
									if (func_113(iLocal_64) && func_112(0, iLocal_63))
									{
										func_116();
										if (iLocal_69 != 263)
										{
...
int func_23()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_ROTATION(iLocal_94, 2) };
	Local_93 = { ENTITY::GET_ENTITY_COORDS(iLocal_94, true) };
	Local_93.f_3 = vVar0.z;
	Local_93.f_4 = iLocal_94;
	if (!MISC::IS_BIT_SET(Global_111521, 10))
	{
		Local_93.f_6 = iLocal_86;
		Local_93.f_5 = iLocal_87;
	}
	else
	{
		Local_93.f_6 = iLocal_85;
		Local_93.f_5 = iLocal_88;
	}
	iVar1 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &Local_93, 7, iLocal_61);
...
void func_37()
{
	...
	if (bLocal_90)
	{
		...
		fVar5 = SYSTEM::VDIST2(vVar4, vLocal_56);
		if (iLocal_91 == 0)
		{
			if (fVar5 < (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(iLocal_87, false);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_87, iLocal_88, -1, 2049, 3);
						TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_87, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(iLocal_88, false);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_88, iLocal_87, -1, 2049, 3);
						TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_88, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
				}
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
					{
						...
						{
							TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 0.5f, 0);
						}
						else
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						...
						{
							TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 0.5f, 0);
						}
						else
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
		...
		else if (iLocal_91 == 1)
		{
			if (fVar5 >= (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
					{
						TASK::TASK_STAND_STILL(iLocal_87, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_87))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_87, true);
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						TASK::TASK_STAND_STILL(iLocal_88, -1);
				...
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1, false, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_87, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_87))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_87, true);
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1, false, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_88, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_88))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_88, true);
	...
	if (!iLocal_97)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::GET_PLAYER_INDEX(), 0)) || PED::IS_ANY_PED_SHOOTING_IN_AREA(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, 1, 1)) || MISC::IS_PROJECTILE_IN_AREA(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_87, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_88, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				bVar3 = true;
			}
			else
			{
				...
				while (iVar2 < iVar1)
				{
					...
					{
						if (PED::IS_PED_IN_MELEE_COMBAT(uVar0[iVar2]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uVar0[iVar2]))
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_87, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
		...
		if (!func_101(6) && !func_101(7))
		{
			...
			{
				if (PED::IS_PED_FLEEING(iLocal_87) || PED::IS_PED_FLEEING(iLocal_88))
				{
					bVar3 = true;
				}
			}
	...
	if (iLocal_92 == 1)
	{
		if (!INTERIOR::IS_VALID_INTERIOR(iLocal_95))
		{
			iLocal_95 = INTERIOR::GET_INTERIOR_AT_COORDS(-573.3155f, 291.2963f, 79.5509f);
		}
		else if (iLocal_95 == INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()))
		{
			func_38(140, 3);
			func_38(139, 3);
			if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
			{
				if (iLocal_98)
				{
					...
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, false);
					iLocal_98 = 0;
				}
			}
		}
		else if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
		{
			if (!iLocal_98)
			{
	...
	{
		if (!INTERIOR::IS_VALID_INTERIOR(iLocal_96))
		{
			iLocal_96 = INTERIOR::GET_INTERIOR_AT_COORDS(1995.614f, 3049.877f, 46.2153f);
		}
		else if (iLocal_96 == INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
			{
				if (iLocal_98)
...
void func_43()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_101(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_44(Global_111560.f_2358.f_539.f_4321))
				{
...
int func_49(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_50(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_51(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_52(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111560.f_7256[iParam0], true, true);
			}
...
int func_70()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		iVar3 = 1;
		iVar3 = 0;
		while (iVar3 < func_72() + 1)
		{
			if (iVar3 > 0)
			{
				fVar2 = SYSTEM::VDIST2(vVar0, func_71(iVar3));
				if (fVar1 > fVar2)
				{
					fVar1 = fVar2;
				}
...
int func_78(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	{
		case 0:
			uParam0->f_2 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(vParam1, vParam2, 19, iParam3, 7);
			*uParam0 = 1;
			break;
		
		case 1:
			if (SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar2, &iVar0) == 2)
			{
				if (uParam0->f_9 == 0)
				{
					*uParam0 = 3;
			...
			else if (SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar2, &iVar0) == 0)
			{
				*uParam0 = 3;
			}
			break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_96()) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_30738) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_96()) || func_93()) || Global_110607) || Global_30738) || func_95()) || Global_42561) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_90)
	{
		vVar0 = { func_71(iLocal_92) };
		vVar1 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
		fVar2 = SYSTEM::VDIST2(vVar1, vVar0);
		if ((fVar2 > 45f || Global_111522) && !ENTITY::DOES_ENTITY_EXIST(iLocal_87))
		{
			if (Global_111522)
			{
				Global_111522 = 0;
			}
			vVar3 = { -573.1373f, 294.0269f, 78.1765f };
			vVar4 = { -574.1169f, 292.7964f, 78.1766f };
			vVar5 = { 1995.614f, 3049.877f, 46.2153f };
			vVar6 = { 1995.488f, 3047.383f, 46.2153f };
			fVar7 = 172.6813f;
			fVar8 = 274.5094f;
			fVar9 = 142.6717f;
			fVar10 = 44.8785f;
			iVar11 = INTERIOR::GET_INTERIOR_AT_COORDS(func_71(iLocal_92));
			if (INTERIOR::IS_VALID_INTERIOR(iVar11))
			{
				INTERIOR::PIN_INTERIOR_IN_MEMORY(iVar11);
				while (!INTERIOR::IS_INTERIOR_READY(iVar11))
				{
					SYSTEM::WAIT(0);
				}
				INTERIOR::UNPIN_INTERIOR(iVar11);
			}
			iLocal_87 = PED::CREATE_PED(26, iLocal_85, func_104(iLocal_92 == 1, vVar3, vVar5), func_103(iLocal_92 == 1, fVar7, fVar9), 1, true);
			iLocal_88 = PED::CREATE_PED(26, iLocal_86, func_104(iLocal_92 == 1, vVar4, vVar6), func_103(iLocal_92 == 1, fVar8, fVar10), 1, true);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_87, true, 0);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, true, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_87, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, true);
			iLocal_98 = 1;
			MISC::CLEAR_BIT(&Global_111521, 10);
			iLocal_91 = -1;
			if (fVar2 < (20f * 20f))
			{
				iLocal_91 = 1;
		...
		else
		{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(iLocal_87))
			{
			}
			iLocal_89 = 0;
		}
...
Vector3 func_104(bool bParam0, vector3 vParam1, vector3 vParam2)
{
	if (bParam0)
	{
		return vParam1;
...
int func_105()
{
	if (bLocal_90)
	{
		return ((STREAMING::HAS_MODEL_LOADED(iLocal_85) && STREAMING::HAS_MODEL_LOADED(iLocal_86)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_dart_1")));
	}
	return 1;
}
...
void func_116()
{
	...
	iLocal_84 = INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_56);
	func_107(&uLocal_58, 1);
	func_85(&uLocal_58, 524288);
	iLocal_61 = 29500;
}
