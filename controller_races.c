...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(iVar0);
			if (MISC::IS_BIT_SET(Global_111560.f_24974.f_1, iVar0))
			{
				if (MISC::IS_BIT_SET(Global_111560.f_24974.f_3, iVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_111534[iVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_111560.f_24974.f_3), iVar0);
							}
							else if ((MISC::GET_GAME_TIMER() - Global_111540[iVar0]) > 60000)
							{
								Global_111534[iVar0] = 0;
								Global_111540[iVar0] = MISC::GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_111560.f_24974.f_3), iVar0);
							}
...
{
	return MISC::IS_BIT_SET(Global_111560.f_9080.f_99.f_219[0], iParam0);
}
...
void func_13()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_17(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_15(iVar0) && (!func_14(14) || Global_110511))
			{
...
void func_19()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(iVar0);
			if (MISC::IS_BIT_SET(Global_111560.f_24971.f_2, iVar0))
			{
				fVar2 = SYSTEM::VDIST2(func_9(PLAYER::PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_111524[iVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_111560.f_24971.f_2), iVar0);
						}
						else if ((MISC::GET_GAME_TIMER() - Global_111529[iVar0]) > 60000)
						{
							Global_111524[iVar0] = 0;
							Global_111529[iVar0] = MISC::GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_111560.f_24971.f_2), iVar0);
						}
			...
			else if (!Global_111560.f_24971)
			{
				if (iVar1 == 82)
				{
					func_21(82);
					func_20(65, 1000);
					Global_111560.f_24971 = 1;
				}
			}
			iVar0++;
		}
...
{
	return func_29(iParam0, Global_41396);
}
