...
void func_3()
{
	...
	if (Global_111560.f_9080 || func_19(0))
	{
		if (!func_18())
		{
			iVar0 = func_17();
...
void func_6()
{
	...
	{
		if (func_10(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_9(PLAYER::PLAYER_PED_ID());
			if (func_8(iVar0) && (!func_7(14) || Global_110511))
			{
