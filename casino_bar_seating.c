...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1676879.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					if (func_51(uParam0))
					{
				...
				else if (uParam0->f_6 == -1)
				{
					...
					{
						if (func_41(uParam0->f_9) && !Global_262145.f_26216)
						{
				...
				else if (PAD::IS_CONTROL_JUST_PRESSED(0, 51))
				{
					...
					{
						MISC::SET_BIT(&(Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_4), 15);
						func_36(157);
					}
				}
			}
		...
		case 4:
			...
			vVar2 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0, 2) };
			vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			iVar4 = vVar3.z;
			fVar5 = 0.05f;
		...
		case 5:
			...
			vVar7 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar8 = vVar7.z;
		...
		case 6:
			...
			func_17(uParam0);
			func_8(uParam0);
			iVar9 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_8);
			if (func_33(&(uParam0->f_7), 13))
			{
				PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
			}
		...
		case 8:
			iVar10 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_8);
...
void func_36(int iParam0)
{
	...
	while (iVar0 < 3)
	{
		if (Global_2097152[func_37() /*10828*/].f_6168.f_4015[iVar0 /*3*/] == iParam0)
		{
...
int func_41(int iParam0)
{
	switch (iParam0)
	{
		...
		case 6:
		case 7:
			if (Global_98721.f_344 == 486476725)
			{
				return 1;
			}
			break;
...
int func_50(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && func_57(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_56(int iParam0, vector3 vParam1, int iParam2)
{
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, 0, true, 0);
}
...
int func_83(int iParam0)
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_84(Global_2424073[iParam0 /*421*/].f_309.f_5) == 14;
			}
		}
	}
	return 0;
...
void func_87(var uParam0)
{
	...
	MISC::CLEAR_BIT(&(Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_4), 15);
}
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_97(PLAYER::PLAYER_ID(), 0) && !func_96()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_92(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_92(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					...
					if (func_89(Global_4456448.f_190930))
					{
...
void func_102()
{
	func_103(0, &uLocal_197, 0, 1);
	func_103(1, &uLocal_197, 1, 1);
	func_103(2, &uLocal_197, 2, 1);
	func_103(3, &uLocal_197, 3, 1);
	func_103(4, &uLocal_197, 4, 1);
	func_103(5, &uLocal_197, 5, 1);
	func_103(6, &uLocal_197, 6, 1);
	func_103(7, &uLocal_197, 7, 1);
	func_103(8, &uLocal_197, 8, 1);
	func_103(9, &uLocal_197, 9, 1);
	func_103(10, &uLocal_197, 10, 1);
	func_103(11, &uLocal_197, 11, 1);
	func_103(12, &uLocal_197, 12, 1);
	func_103(13, &uLocal_197, 13, 1);
	func_103(14, &uLocal_197, 14, 1);
	func_103(15, &uLocal_197, 15, 1);
	func_103(16, &uLocal_197, 16, 1);
	func_103(17, &uLocal_197, 17, 1);
	func_103(18, &uLocal_197, 18, 1);
	func_103(19, &uLocal_197, 19, 1);
	func_103(20, &uLocal_197, 20, 1);
	func_103(21, &uLocal_197, 21, 1);
	func_103(22, &uLocal_197, 22, 1);
	func_103(23, &uLocal_197, 23, 1);
	func_103(24, &uLocal_197, 24, 1);
	func_103(25, &uLocal_197, 25, 1);
	func_103(26, &uLocal_197, 26, 1);
	func_103(27, &uLocal_197, 27, 1);
	func_103(28, &uLocal_197, 28, 1);
	func_103(29, &uLocal_197, 29, 1);
	func_103(30, &uLocal_197, 30, 1);
}
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_108(iParam0, &vVar0, &fVar1);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { vVar0 };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, fVar1 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_105(func_107(), func_106(iParam3, fVar1)) + vVar0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_105(func_104(), func_106(iParam3, fVar1)) + vVar0 };
...
Vector3 func_105(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
