...
void func_2()
{
	...
	func_78();
	if (Global_95981 || (Global_95982 && !func_75(0)))
	{
	...
	if (!bVar1)
	{
		if (((((((((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_73(iLocal_58))) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || func_72()) || CUTSCENE::IS_CUTSCENE_PLAYING()) || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || Global_76575) || Global_95983) || iLocal_61)
		{
			iLocal_82 = 1;
	...
	if (((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && (MISC::GET_GAME_TIMER() - iLocal_56) > 2000) || (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::IS_TIME_MORE_THAN(NETWORK::GET_NETWORK_TIME(), NETWORK::GET_TIME_OFFSET(iLocal_57, 2000)))) || bLocal_59)
	{
		...
		while (iVar12 < iVar11)
		{
			...
			{
				iVar3 = Global_111560.f_2358.f_539.f_2387[iLocal_58];
			}
			else
			{
			...
			if (func_56(iLocal_58, iVar8, iVar3, &iVar4))
			{
				...
				{
					if (Global_111560.f_2358.f_539.f_2387[iLocal_58] == 0)
					{
						bVar13 = false;
					}
					Global_111560.f_2358.f_539.f_2387[iLocal_58] = iVar4;
				}
				else
				{
				...
				if (iVar4 > func_53(iLocal_58, iVar8, -1))
				{
					...
					else if ((!Global_111560.f_9080 && !func_52(0)) || !MISC::IS_BIT_SET(Global_111560.f_9080.f_2[27 /*3*/], 2))
					{
						bVar13 = false;
					}
					iVar14 = iVar4;
...
void func_4(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if (func_7())
	{
		iVar0 = Global_2576213[iParam0 /*3*/][func_5(iParam2)];
		if (iVar0 != 0)
		{
...
int func_9()
{
	...
	if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_745 == 1)
	{
		return 0;
	}
	if (func_42())
	...
	if (func_40())
	{
		if (!func_41())
		{
			if (!func_39(3, -1))
			{
				if (func_37(&Global_2461320, 300000, 0) == 1)
				{
					func_36(&Global_2461318);
					func_34(3, -1);
				}
				else if (func_37(&Global_2461318, 7000, 0) == 0)
				{
					return 0;
				}
			}
	...
	if (Global_2531497.f_3967)
	{
		return 0;
	}
	if (Global_2437549.f_3750)
	{
		return 0;
	}
	...
	if (Global_2437549.f_3884.f_39 == 1)
	{
		return 0;
	}
	if (Global_2449755.f_2846.f_25 == 1)
	{
		return 0;
	}
	if (func_17(1))
	...
	if (Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_727)
	{
		return 0;
	}
...
bool func_13()
{
	return Global_2437549.f_1893.f_688 != 0;
}
...
{
	return MISC::IS_BIT_SET(Global_1627738[iParam0 /*38*/].f_14, 0);
}
...
int func_24(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 5:
			if (iParam1 > -1)
			{
				if (Global_1373500.f_137[iParam1])
				{
					return 1;
				}
				if (Global_1373500.f_170[iParam1])
				{
					return 1;
				}
			}
		...
		default:
			if (MISC::IS_BIT_SET(Global_1373500.f_1046, iParam0))
			{
				return 1;
			}
			if (MISC::IS_BIT_SET(Global_1373500.f_1047, iParam0))
			{
				return 1;
			}
			break;
	...
	switch (iParam1)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				fVar0 = ((fVar1 - Global_111560.f_2358.f_539.f_2355[iParam0]) / 175f);
			}
			else if (iParam0 == 1)
			{
			...
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 + ((4f * Global_262145.f_23813) * IntToFloat(func_70(7234, -1, 0))));
			}
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 * 0.25f);
		...
		case 2:
			if (iParam0 == 0)
			{
				...
				fVar0 = (SYSTEM::TO_FLOAT((iVar3 - Global_111560.f_2358.f_539.f_2359[iParam0])) / 20f);
			}
			else if (iParam0 == 1)
			{
		...
		case 4:
			if (iParam0 == 0)
			{
				...
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar3 - Global_111560.f_2358.f_539.f_2363[iParam0])) / 50f));
			}
			else if (iParam0 == 1)
			{
		...
		case 7:
			if (iParam0 == 0)
			{
				...
				fVar0 = ((fVar1 - Global_111560.f_2358.f_539.f_2367[iParam0]) / 45f);
			}
			else if (iParam0 == 1)
			{
			...
			if (iParam0 == 0)
			{
				...
				fVar0 = (fVar0 + ((SYSTEM::TO_FLOAT((iVar3 - Global_111560.f_2358.f_539.f_2371[iParam0])) / 2f) * 1.5f));
			}
			else if (iParam0 == 1)
			{
		...
		case 6:
			if (iParam0 == 0)
			{
				...
				iVar6 = (iVar6 - iVar5);
				fVar0 = (SYSTEM::TO_FLOAT((iVar5 - Global_111560.f_2358.f_539.f_2375[iParam0])) / 40f);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar6 - Global_111560.f_2358.f_539.f_2379[iParam0])) / 80f));
			}
			else if (iParam0 == 1)
			{
	...
	switch (iParam0)
	{
		...
		case 2:
			switch (iParam1)
			{
				...
				case 6:
				case 7:
					return Global_111560.f_2358.f_539.f_2247[iParam1 /*4*/][iParam0];
					break;
			}
			break;
...
int func_61(int iParam0, int iParam1)
{
	...
	return Global_111560.f_1983[iParam0 /*121*/][iParam1 /*10*/].f_8;
}
...
{
	return BigHashList[iParam0 /*3*/][func_5(iParam1)];
}
...
int func_66()
{
	if (func_49(1))
	{
		return Global_1590446[func_67() /*871*/].f_211.f_6;
	}
	return 0;
}
...
float func_68(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2575525[iParam0 /*3*/][func_5(iParam1)];
...
{
	return func_77(iParam0, Global_41396);
}
...
void func_79()
{
	...
	if (!iLocal_80)
	{
		if (iLocal_58 == 3)
		{
			if (Global_2097152[func_81() /*10828*/].f_6168.f_7)
			{
				iLocal_77 = func_62(func_63(147, -1));
				Global_2097152[func_81() /*10828*/].f_6168.f_7 = 0;
			}
			else
			{
				iLocal_77 = Global_2097152[func_81() /*10828*/].f_6168.f_6;
			}
			if (Global_2097152[func_81() /*10828*/].f_6168.f_4 == 0)
			{
				Global_2097152[func_81() /*10828*/].f_6168.f_4 = NETWORK::GET_CLOUD_TIME_AS_INT();
			}
			iLocal_79 = Global_2097152[func_81() /*10828*/].f_6168.f_4;
			iLocal_78 = Global_2097152[func_81() /*10828*/].f_6168.f_5;
		}
		else
		{
			if (Global_111560.f_2358.f_539.f_2292[iLocal_58])
			{
				switch (iLocal_58)
				{
					case 0:
				...
				Global_111560.f_2358.f_539.f_2292[iLocal_58] = 0;
			}
			else
			{
				iLocal_77 = Global_111560.f_2358.f_539.f_2288[iLocal_58];
			}
			if (Global_111560.f_2358.f_539.f_2280[iLocal_58] == 0)
			{
				Global_111560.f_2358.f_539.f_2280[iLocal_58] = NETWORK::GET_CLOUD_TIME_AS_INT();
			}
			iLocal_79 = Global_111560.f_2358.f_539.f_2280[iLocal_58];
			iLocal_78 = Global_111560.f_2358.f_539.f_2284[iLocal_58];
		}
		iLocal_80 = 1;
		iLocal_81 = 1;
	}
	else if ((NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_79) > 86400)
	{
		...
		if (iLocal_58 == 3)
		{
			Global_2097152[func_81() /*10828*/].f_6168.f_7 = 1;
		}
		else
		{
			Global_111560.f_2358.f_539.f_2292[iLocal_58] = 1;
		}
	}
	if (iLocal_81)
	{
	...
	if (iLocal_58 == 3)
	{
		Global_2097152[func_81() /*10828*/].f_6168.f_4 = iLocal_79;
		Global_2097152[func_81() /*10828*/].f_6168.f_5 = iLocal_78;
	}
	else
	{
		Global_111560.f_2358.f_539.f_2280[iLocal_58] = iLocal_79;
		Global_111560.f_2358.f_539.f_2284[iLocal_58] = iLocal_78;
	}
}
...
void func_82()
{
	...
	if (iLocal_74)
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if ((((ENTITY::DOES_ENTITY_EXIST(iVar1) && VEHICLE::IS_VEHICLE_DRIVEABLE(iVar1, 0)) && !ENTITY::IS_ENTITY_IN_AIR(iVar1)) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar1, -1, 0) == PLAYER::PLAYER_PED_ID()) && (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar1)) || VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iVar1))))
			{
				bVar0 = false;
	...
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(iVar2) && VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, 0)) && ENTITY::GET_ENTITY_SPEED(iVar2) < 20f) && !ENTITY::IS_ENTITY_IN_AIR(iVar2))
		{
...
void func_83()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && VEHICLE::IS_VEHICLE_DRIVEABLE(iVar1, 0)) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar1, -1, 0) == PLAYER::PLAYER_PED_ID()) && (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iVar1)) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar1))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(iVar1))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(iVar1))))
		{
			if (iLocal_66)
			{
...
void func_86()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_88(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_73(iVar0) && (!func_54(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_73(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_97(int iParam0)
{
	...
	func_98(&(Global_1385294[iVar2 /*5*/]));
...
void func_99()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!MISC::IS_BIT_SET(Global_2097152[func_81() /*10828*/].f_6168.f_1273, 2))
		{
			fVar0 = (SYSTEM::TO_FLOAT(func_70(192, -1, 0)) / 20f);
			iVar1 = SYSTEM::FLOOR(fVar0);
			iVar1 = func_69(iVar1, 0, 100);
			func_80(3, 2, iVar1);
			MISC::SET_BIT(&(Global_2097152[func_81() /*10828*/].f_6168.f_1273), 2);
		}
	}
	bLocal_59 = true;
	iLocal_54 = 1;
...
void func_100()
{
	...
	else
	{
		...
		Global_111560.f_2358.f_539.f_2387[0] = func_53(0, 0, -1);
		Global_111560.f_2358.f_539.f_2387[1] = func_53(1, 0, -1);
		Global_111560.f_2358.f_539.f_2387[2] = func_53(2, 0, -1);
		Global_111560.f_2358.f_539.f_2354 = 1;
		Global_95981 = 1;
	}
}
...
int func_101()
{
	...
	return Global_111560.f_2358.f_539.f_2354;
}
