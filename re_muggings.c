			...
			switch (iLocal_44)
			{
				...
				case 1:
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						if (iLocal_117 == 0)
						{
							iLocal_117 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101, vLocal_104, 0f);
						}
						PLAYER::SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(PLAYER::PLAYER_ID());
						switch (iLocal_46)
						{
								...
								switch (iLocal_47)
								{
									...
									case 4:
										...
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 242628503) == 7)
										{
											...
											TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
									...
									case 5:
										...
										if (!ENTITY::IS_ENTITY_DEAD(iLocal_60, 0))
										{
											if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 242628503) == 7)
											{
												...
												TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
												TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
												TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
												TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
												TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
					...
					if (iLocal_124)
					{
						if (!iLocal_137)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_61, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_60, 0))
							{
								...
								{
									TASK::TASK_SMART_FLEE_PED(iLocal_61, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									iLocal_137 = 1;
								}
							}
						}
						...
						if (!PED::IS_PED_INJURED(iLocal_61))
						{
							if (iLocal_80 == 3)
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_61, 1805844857) != 1)
								{
									...
									TASK::TASK_SMART_FLEE_PED(iLocal_61, iLocal_60, 200f, -1, 0, 0);
...
int func_14(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_22() || func_21(Global_4456448.f_190930)) || func_20())
	{
...
int func_15(int iParam0)
{
	if (iParam0 != func_17())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_16(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_41()
{
	if (!PED::IS_PED_INJURED(iLocal_60))
	{
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_backward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
			...
			if (!PED::IS_PED_INJURED(iLocal_60))
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
					{
						TASK::CLEAR_PED_TASKS(iLocal_60);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_151), 1f, 20000, 0.25f, 0, 1193033728);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					}
				...
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
					{
						...
						else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 242628503) == 7)
						{
							TASK::CLEAR_PED_TASKS(iLocal_60);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_PLAY_ANIM(0, cLocal_320, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	if (!PED::IS_PED_INJURED(iLocal_60))
	{
		if (!bLocal_126)
		{
						...
						if (func_123(1, 0, 1))
						{
							if (!func_122())
							{
								if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										while (!func_112(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_71, 1, 1056964608, 0, 1, 0) || func_167())
										{
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_60, 15f, 15f, 15f, 0, 1, 0))
			{
				...
				if (iLocal_45 == 2)
				{
					TASK::TASK_PLAY_ANIM(0, cLocal_333, "RETURNING_FRONT_A", 8f, -1000f, -1, 0, 0, 0, 0, 0);
				}
				TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
			...
			switch (iLocal_125)
			{
				case 0:
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_105, (Var3.f_1 + 1.5f), (Var3.f_1 + 1.5f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_321, sLocal_323, vLocal_105, vLocal_106, 0, 2), (Var3.f_1 + 1f), (Var3.f_1 + 1f), 3f, false, true, 0))
								{
									...
									else
									{
										...
										vLocal_74 = { func_103(vLocal_105, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_321, sLocal_323, vLocal_105, vLocal_106, 0, 2)) };
									}
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
									{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_107, cLocal_321, sLocal_322, 1000f, -8f, 0, 0, 1148846080, 0);
						if (!PED::IS_PED_INJURED(iLocal_60))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_60);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_60, iLocal_107, cLocal_321, sLocal_323, 1000f, -8f, 0, 0, 1148846080, 0);
						}
					...
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_107) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_107) > 0.9f) || func_101(1000))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_60))
						{
							...
							if (iLocal_80 == 4)
							{
								...
								{
									TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 58.803f, -1067.711f, 28.4411f, 1f, 20000, 1048576000, 0, 1193033728);
									TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_60), 1);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
...
void func_68(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_70() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_70() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_72(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_76(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_70() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_77(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_72(iParam1)];
...
void func_108(vector3 vParam0, var uParam1, float fParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_109(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fVar2, 15f))
		{
			bVar0 = true;
		}
...
void func_128()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_131(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_129(iVar0) && (!func_53(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_129(Global_111560.f_2358.f_539.f_4321))
				{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_60, PLAYER::PLAYER_PED_ID(), 25f, 25f, 5f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_60, PLAYER::PLAYER_PED_ID(), 17))
			{
				if (func_42(&uLocal_154, cLocal_85, sLocal_90, 4, 0, 0, 0) || func_62())
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_60, cLocal_319, "flee_forward_outro_shopkeeper", 3))
					{
						...
						if (iLocal_45 == 2)
						{
							TASK::TASK_PLAY_ANIM(0, cLocal_333, "RETURNING_FRONT_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
						}
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
	...
	if (!PED::IS_PED_INJURED(iLocal_60) && iLocal_80 == 4)
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_60, cLocal_319, "flee_forward_loop_shopkeeper", 3))
		{
			...
			if (bParam0)
			{
				...
				TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			TASK::CLEAR_PED_TASKS(iLocal_60);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
...
int func_159()
{
	if (!PED::IS_PED_INJURED(iLocal_61))
	{
		if (PED::CAN_PED_SEE_HATED_PED(iLocal_61, PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61, 20f, 20f, 20f, 0, 1, 0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				...
				if (func_173())
				{
					...
					if (iLocal_80 == 3)
					{
						if (!iLocal_55)
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_79, 1f, 20000, fVar0, 4, 1193033728);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
							iLocal_55 = 1;
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_79, iLocal_60, 1f, false, 1.5f, 4f, true, 0, 0, -957453492, 20000);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_60, -1, 1);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_61, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
						SYSTEM::SETTIMERA(0);
		...
		if (iLocal_111 && !bLocal_109)
		{
			if (!PED::IS_PED_INJURED(iLocal_60) && !PED::IS_PED_INJURED(iLocal_61))
			{
				if (func_42(&uLocal_154, cLocal_85, sLocal_86, 4, 0, 0, 0) || func_62())
				{
					TASK::CLEAR_PED_TASKS(iLocal_60);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
					TASK::TASK_PLAY_ANIM(0, cLocal_319, "handsup_standing_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, cLocal_319, "handsup_standing_base", 8f, -4f, 7000, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, cLocal_319, "handsup_standing_exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					func_172();
				...
				switch (iLocal_623)
				{
					case 0:
						...
						if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
						{
							TASK::CLEAR_PED_TASKS(iLocal_61);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_626, iLocal_60, 2f, false, 0.1f, 4f, true, 0, 0, -957453492, 20000);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_61, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
						...
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_61, 242628503) == 7)
						{
							...
							if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
							{
								...
								else
								{
									TASK::CLEAR_PED_TASKS(iLocal_61);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
									TASK::TASK_PLAY_ANIM(0, cLocal_320, "pickup_low", 8f, -4f, -1, 8224, 0, 0, 0, 0);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_61, iLocal_103);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
									iLocal_623 = 2;
					...
					case 4:
						...
						TASK::TASK_SMART_FLEE_PED(iLocal_61, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
...
void func_171()
{
	...
	{
		TASK::TASK_PLAY_ANIM(iLocal_61, cLocal_319, sLocal_327, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_45 == 2)
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, sLocal_328, 8f, -8f, -1, 0, 0, 0, 0, 0);
		...
		else if (iLocal_80 == 4)
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_backward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_backward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, sLocal_328, 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
	...
	{
		TASK::TASK_PLAY_ANIM(iLocal_61, cLocal_319, sLocal_329, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_45 == 2)
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, sLocal_330, 8f, -8f, -1, 8, 0.1f, 0, 0, 0);
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_forward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "flee_forward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, sLocal_330, 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
int func_174(int iParam0)
{
	if (func_176())
	{
		...
		if (func_175(Global_111549))
		{
			func_140(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_175(Global_111549))
		{
...
int func_176()
{
	switch (func_177(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_180(iParam0, Global_41396);
}
...
void func_205()
{
	switch (iLocal_116)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_61))
			{
				TASK::TASK_PLAY_ANIM(iLocal_61, cLocal_319, "IG_1_guy_stickup_loop", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			if (!PED::IS_PED_INJURED(iLocal_60))
			{
				TASK::TASK_PLAY_ANIM(iLocal_60, cLocal_321, "ortega_stand_loop_ort", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			iLocal_116++;
			break;
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_61))
			{
				...
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_60, vLocal_121, 250f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_60, true);
					SYSTEM::WAIT(0);
					func_211();
				}
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_61))
			{
				if (!PED::IS_PED_INJURED(iLocal_61))
				{
					...
					{
						if (PED::CAN_PED_SEE_HATED_PED(iLocal_61, PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61, 3f, 3f, 15f, 0, 1, 0))
						{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_60))
			{
				if (!PED::IS_PED_INJURED(iLocal_60))
				{
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_60, PLAYER::PLAYER_PED_ID(), 1))
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_61, false), 150f, -1, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
							PED::SET_PED_KEEP_TASK(iLocal_60, true);
	...
	if (iLocal_150 && !bLocal_113)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_61) && ENTITY::DOES_ENTITY_EXIST(iLocal_61))
		{
			if (!PED::IS_PED_INJURED(iLocal_60) && !PED::IS_PED_INJURED(iLocal_61))
			{
				if ((((iLocal_148 - iLocal_147) > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61, 3f, 3f, 35f, 0, 1, 0)) && ENTITY::IS_ENTITY_ON_SCREEN(iLocal_61)) && !func_167())
				{
					if ((func_42(&uLocal_154, cLocal_85, "REMG2_FKIT", 4, 0, 0, 0) || func_62()) || func_62())
					{
						...
						TASK::TASK_SMART_FLEE_COORD(iLocal_61, vLocal_121, 250f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_61, true);
						func_280();
					}
				}
			...
			if (func_196())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 242628503) == 7 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 474215631) == 7)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_61))
					{
						...
						{
							TASK::TASK_SMART_FLEE_PED(iLocal_60, iLocal_61, 150f, -1, 0, 0);
						}
					}
					else if (iLocal_45 == 3)
					{
						if (!PED::IS_PED_FLEEING(iLocal_60))
						{
							TASK::TASK_SMART_FLEE_COORD(iLocal_60, vLocal_104, 150f, -1, 0, 0);
						}
					}
					PED::SET_PED_KEEP_TASK(iLocal_60, true);
					SYSTEM::WAIT(0);
...
void func_215()
{
	...
	if (iLocal_80 == 3)
	{
		...
		iLocal_107 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_105, vLocal_106, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_61, iLocal_107, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
	if (iLocal_80 == 4)
	{
...
void func_216()
{
	...
	TASK::TASK_PLAY_ANIM(iLocal_61, cLocal_319, sLocal_325, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(iLocal_60, cLocal_319, sLocal_326, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
}
...
int func_235(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_270(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_268()) || Global_110607) || Global_30738) || func_267()) || func_55(8, -1)) || func_266()) || func_265()) || func_264()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_268()) || Global_30738) || func_267()) || func_55(8, -1)) || func_264()) || func_266()) || func_265()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_268()) || Global_110607) || Global_30738) || func_267()) || func_55(8, -1)) || func_264()) || func_266()) || func_265()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_268()) || Global_110607) || Global_30738) || func_267()) || func_55(8, -1)) || func_266()) || func_265()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_268() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_55(8, -1)) || func_263()) || func_262()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_268()) || Global_30738) || func_267()) || func_55(8, -1)) || func_265()) || func_264()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_268()) || func_265()) || Global_110607) || Global_30738) || func_267()) || Global_42561) || func_55(8, -1)) || func_264()) || func_262()) || func_263()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_268()) || Global_110607) || Global_30738) || func_267()) || func_55(8, -1)) || func_264()) || func_262()) || func_266()) || func_265()) || func_263())
						{
							return 0;
						}
						break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_60))
		{
			if (!PED::IS_PED_INJURED(iLocal_60))
			{
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, -1146898486) == 7 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_60, 242628503) == 7)
				{
					...
					TASK::TASK_SMART_FLEE_COORD(0, vLocal_104, 250f, -1, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_60, iLocal_103);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					PED::SET_PED_KEEP_TASK(iLocal_60, true);
...
void func_286(int iParam0)
{
	...
	if (func_196())
	{
		...
		func_290(30000);
		StringCopy(&cVar0, func_289(Global_111549, 1), 64);
		if (func_288(Global_111549) > 0)
		{
...
void func_300()
{
	...
	{
		func_95(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
