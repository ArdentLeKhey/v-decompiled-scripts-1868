...
void func_16(int iParam0)
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_108(1);
				iLocal_74 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
...
void func_136()
{
	if (!func_77(vLocal_52, 0f, 0f, 0f, 0) && func_135() != func_137())
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_52, 60f))
		{
			if (func_85(func_74(25)))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_74(25), true), vLocal_52) >= 100f)
				{
					func_68(0);
				}
			}
...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_49, 0) && Global_41396 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_49, 1))
			{
				if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_50, 5f))
				{
					...
					{
						if ((func_249(PLAYER::PLAYER_PED_ID()) && !MISC::IS_BIT_SET(uLocal_47[0], 17)) && !MISC::IS_BIT_SET(uLocal_47[1], 18))
						{
							if (PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (MISC::IS_BIT_SET(iLocal_49, 0))
								{
									if (!func_205() && func_185(ENTITY::GET_ENTITY_COORDS(iLocal_51, true)))
									{
...
int func_184()
{
	...
	while (iVar1 <= 4)
	{
		if (func_249(uVar0[iVar1]) && uVar0[iVar1] != PLAYER::PLAYER_PED_ID())
		{
...
int func_188(vector3 vParam0, bool bParam1)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_93838[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_93838[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_201()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_93737[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
void func_208()
{
	...
	if ((Global_41396 == 15 && iLocal_38 == 0) && !func_207())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!MISC::IS_BIT_SET(iLocal_49, 0))
...
int func_220(var uParam0)
{
	...
	if (func_249(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_85(iVar0))
		{
...
void func_222()
{
	...
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_207()) && Global_76574 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
	...
	else if (((((((Global_41396 != 15 || Global_41396 != 0) || Global_41396 != 2) || Global_41396 != 4) || Global_41396 != 17) || func_207()) || Global_76574 == -1) || Global_110615)
	{
		iVar1 = 0;
		if (func_132())
		{
...
int func_240()
{
	if (((((Global_41396 == 15 && !func_207()) && Global_76574 == -1) && !func_132()) && !func_241(1112014848)) && !Global_110615)
	{
		return 1;
	}
	return 0;
...
int func_246(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_247(iParam1)];
