...
void __EntryFunction__()
{
	...
	switch (ScriptParam_929.f_2)
	{
		case 1:
			if (ScriptParam_929.f_4)
			{
				...
				{
					iLocal_450 = func_262(100000f, iLocal_170, Global_111560.f_19968.f_9);
				}
			}
			else
			{
				if (Global_111560.f_19968.f_3 == 0)
				{
					bLocal_793 = true;
				}
				if (!func_261())
				...
				{
					iLocal_450 = Global_111560.f_19968.f_9;
					iLocal_170 = Global_111560.f_19968.f_2;
				}
	...
	{
		iLocal_796 = 1;
		if ((Global_111560.f_19968.f_6 % 2) == 0)
		{
			bLocal_799 = true;
		}
	}
	...
	if (Global_111560.f_19968.f_3 >= 5)
	{
		bLocal_779 = true;
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_821)
			{
				case 0:
					...
					else if (iLocal_170 == 3)
					{
						if ((iLocal_906 == 5 && iLocal_908 < 1) && !iLocal_764)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
							{
								...
								{
									iLocal_764 = 1;
									TASK::CLEAR_PED_TASKS(Local_824[0 /*20*/]);
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 0);
								}
							}
						}
					}
					...
					{
						func_185(&(Local_394[func_256() /*28*/]), &(Local_394[func_256() /*28*/].f_10), Local_393[iLocal_450 /*23*/].f_1, &(Local_824[0 /*20*/]), &(Local_824[0 /*20*/].f_2), &uLocal_820, fLocal_864, sLocal_465, &sLocal_466, iLocal_853);
					}
					if (iLocal_170 == 4)
					{
					...
					if (!bLocal_779)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_816) && !ENTITY::IS_ENTITY_DEAD(iLocal_816, 0))
						{
							...
							{
								bLocal_776 = true;
								TASK::TASK_SMART_FLEE_PED(iLocal_816, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (func_173())
							{
								bLocal_777 = true;
					...
					if (bLocal_190 && !bLocal_798)
					{
						if (func_175(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 1, 1, 0))
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
							{
								...
								TASK::TASK_SMART_FLEE_PED(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
							{
								TASK::CLEAR_PED_TASKS(Local_824[0 /*20*/].f_1);
								...
								if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
								{
									TASK::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/].f_1, iLocal_171);
								}
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_171);
								iLocal_875 = 18;
							}
						...
						if (func_175(Local_824[0 /*20*/].f_1, Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 0))
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
							{
								TASK::CLEAR_PED_TASKS(Local_824[0 /*20*/].f_1);
								PED::SET_PED_KEEP_TASK(Local_824[0 /*20*/].f_1, true);
								TASK::TASK_SMART_FLEE_PED(Local_824[0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
						}
					}
						...
						if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_900, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_900, 0))
						{
							if (!iLocal_216)
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/].f_6))
								{
									...
									{
										func_147(&uLocal_149, ENTITY::GET_ENTITY_COORDS(Local_824[0 /*20*/].f_6, true), 0, 0, 1, 1, 1);
									}
								}
							}
							else
		...
		case 1:
			if ((SYSTEM::TIMERA() > 3000 && iLocal_216) && !func_43("TOWT_OBJ_04", 0, 0))
			{
				if (!func_47())
				{
					...
					{
						if (Global_111560.f_19968.f_5 == 0 || Global_111560.f_19968.f_5 == 1)
						{
							func_257(&Param0, 5, (*iParam1)[0 /*20*/], "TOWTRAINF", 0, 1);
							func_171(&Param0, "TOWAUD", "TOW_MECH", 7, 0, 0, 0);
							sLocal_226 = "TOW_MECH";
						}
						else if (Global_111560.f_19968.f_5 == 2)
						{
...
void func_27()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_30(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(iVar0) && (!func_32(14) || Global_110511))
			{
	...
	switch (iLocal_452)
	{
		case 1:
			...
			else if (iLocal_170 == 1)
			{
				if (Global_111560.f_19968.f_5 == 0 || Global_111560.f_19968.f_5 == 1)
				{
					func_257(&Local_396, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_49()
{
	func_53(&Global_110211, 3);
	func_300(&(Global_111560.f_19968.f_1), 8192);
	func_50();
	func_193();
}
...
void func_62(int iParam0, int iParam1)
{
	...
	func_64(Global_111560.f_24899[iParam0 /*4*/], func_100(iParam0), iParam1, 0, 0);
	switch (iParam0)
	{
		case 3:
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7)
{
...
void func_102()
{
	Global_111560.f_19968.f_3++;
	Global_111560.f_19968.f_2 = iLocal_170;
	switch (iLocal_170)
	{
		case 2:
			Global_111560.f_19968.f_4++;
			break;
		
		case 3:
			Global_111560.f_19968.f_7++;
			break;
		
		case 0:
			Global_111560.f_19968.f_6++;
			break;
		
		case 1:
			Global_111560.f_19968.f_5++;
			break;
		
		case 4:
			Global_111560.f_19968.f_8++;
			break;
	}
}
...
int func_103(char* sParam0)
{
	...
	if (func_104(&uVar0, &uVar1, &uVar2))
	{
		...
		{
			VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_900, 6f, 2, 0);
			iLocal_214 = 1;
			if (ENTITY::DOES_ENTITY_EXIST(Local_824[iLocal_839 /*20*/]) && !ENTITY::IS_ENTITY_DEAD(Local_824[iLocal_839 /*20*/], 0))
			{
				...
				TASK::TASK_GOTO_ENTITY_OFFSET(0, Local_824[0 /*20*/].f_6, 20000, 2f, 0f, 1f, 0);
				...
				TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
				TASK::TASK_PERFORM_SEQUENCE(Local_824[iLocal_839 /*20*/], iLocal_171);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_171);
				PED::SET_PED_KEEP_TASK(Local_824[iLocal_839 /*20*/], true);
			}
			if ((Global_111560.f_19968.f_3 == 0 || Global_111560.f_19968.f_3 == 1) || Global_111560.f_19968.f_3 == 4)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_816) && !ENTITY::IS_ENTITY_DEAD(iLocal_816, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_171);
					...
					{
						TASK::TASK_PERFORM_SEQUENCE(iLocal_816, iLocal_171);
			...
			if ((Global_111560.f_19968.f_3 == 0 || Global_111560.f_19968.f_3 == 1) || Global_111560.f_19968.f_3 == 4)
			{
				...
				else if (Global_111560.f_19968.f_3 == 1)
				{
					func_171(&Local_396, "TOWAUD", "TOW_TUT_ENDB", 9, 0, 0, 0);
				}
				else if (Global_111560.f_19968.f_3 == 4)
				{
...
int func_106(char* sParam0, vector3 vParam1)
{
	...
	while (iVar1 < 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_824[iVar1 /*20*/].f_6))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[iVar1 /*20*/].f_6) && func_112())
				{
...
void func_113()
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6)) || (Global_111560.f_19968.f_3 == 0 || Global_111560.f_19968.f_3 > 2))
	{
		return;
	}
	switch (iLocal_852)
			...
			if (!bLocal_792)
			{
				if ((func_123(Local_824[iParam1 /*20*/].f_6, iLocal_900, &iLocal_449, 10, 150f, 4f, 1) || iLocal_787) || iLocal_216)
				{
					if (!bLocal_770)
					{
						iLocal_449 = 0;
						func_122(&iLocal_444);
						if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[iParam1 /*20*/], -875674219) != 1)
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[iParam1 /*20*/], PLAYER::PLAYER_PED_ID(), -1);
						}
						bLocal_770 = true;
					}
					if (bLocal_770)
					{
						if (ENTITY::IS_ENTITY_AT_COORD(iLocal_900, ENTITY::GET_ENTITY_COORDS(Local_824[iParam1 /*20*/], true), 25f, 25f, 25f, false, true, 0))
						{
							...
							{
								TASK::STOP_ANIM_TASK(Local_824[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", -4f);
							}
							if (!func_121())
							{
								if (iLocal_170 == 1)
								{
									...
									TASK::TASK_ENTER_VEHICLE(Local_824[iParam1 /*20*/], iLocal_900, 20000, 0, 2f, 1048577, 0);
								}
								else if (iLocal_170 == 3)
								{
									if (Global_111560.f_19968.f_7 == 0 || Global_111560.f_19968.f_7 == 1)
...
int func_133(bool bParam0, int iParam1)
{
	...
	else if (Local_393[iLocal_450 /*23*/] == 4)
	{
		fLocal_864 = -1f;
		iLocal_784 = 1;
		iLocal_901 = VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_394[func_256() /*28*/].f_23, Local_394[func_256() /*28*/].f_26, true, true, false);
		...
		{
			iLocal_395 = func_134(Local_394[func_256() /*28*/].f_17, Local_394[func_256() /*28*/].f_20);
		}
		...
		VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_824[0 /*20*/].f_6, 0, 0, false);
	}
	if (bParam0)
	{
		bLocal_190 = true;
...
int func_135(vector3 vParam0, float fParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	*iParam2 = func_136(&Local_824);
	...
	{
		Local_824[*iParam2 /*20*/].f_17 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(Local_393[iLocal_450 /*23*/].f_10, fVar0, 0f, 0);
	}
	else
	{
		Local_824[*iParam2 /*20*/].f_17 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar0, 0f, 0);
	}
	Local_824[*iParam2 /*20*/].f_18 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar1, 2.5f, 0);
	Local_824[*iParam2 /*20*/].f_19 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar2, 4f, 0);
	if (bParam3)
	{
...
int func_138(vector3 vParam0, float fParam1, var uParam2, int iParam3)
{
	...
	VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_824[*uParam2 /*20*/].f_6, 4, 0, false);
	...
	iLocal_850 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar4, fVar5, -1.5f, -30f, 0f), 10f, 0f, 0);
	iLocal_851 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar4, fVar5, -1.5f, 30f, 0f), 10f, 0f, 0);
...
int func_153(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_160() || func_159(Global_4456448.f_190930)) || func_158())
	{
...
int func_154(int iParam0)
{
	if (iParam0 != func_20())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_155(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_179(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(iParam0) || func_180(iVar1))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam1), iParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam1, iParam0, 17))
		...
		case 3:
			...
			while (iVar0 < iParam5)
			{
				if (!ENTITY::IS_ENTITY_DEAD((*uParam4)[iVar0], 0))
				{
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
					TASK::TASK_PERFORM_SEQUENCE((*uParam4)[iVar0], iLocal_171);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_171);
				}
				iVar0++;
			}
...
void func_187(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar0 == 0)
		{
			Local_438[iVar0 /*18*/].f_8 = { func_188(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0f) };
		}
		else
		{
...
int func_189()
{
	...
	{
		case 0:
			func_257(&Local_396, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		...
		case 1:
			...
			TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
			TASK::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_171);
		...
		case 2:
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843 + 15))
			{
				...
				func_122(&iLocal_444);
				TASK::TASK_LOOK_AT_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_7, -1, 2, 2);
				SYSTEM::SETTIMERB(0);
				iLocal_911 = 3;
			}
			break;
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_171);
						TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK::TASK_GO_TO_COORD_ANY_MEANS(0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_393[iLocal_450 /*23*/].f_1, Local_393[iLocal_450 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
...
int func_190()
{
	if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
	{
		if (bLocal_177)
		{
			...
			{
				case 0:
					if (TASK::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) == 1)
					{
						iLocal_855 = 1;
					}
					break;
...
void func_193()
{
	...
	VEHICLE::_REMOVE_SPEED_ZONE(iLocal_850);
	VEHICLE::_REMOVE_SPEED_ZONE(iLocal_851);
	...
	while (iVar0 < 1)
	{
		VEHICLE::_REMOVE_SPEED_ZONE(Local_824[iVar0 /*20*/].f_17);
		VEHICLE::_REMOVE_SPEED_ZONE(Local_824[iVar0 /*20*/].f_18);
		VEHICLE::_REMOVE_SPEED_ZONE(Local_824[iVar0 /*20*/].f_19);
		iVar0++;
	}
	if (!func_11(Local_394[func_256() /*28*/].f_17))
	{
...
void func_199(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, int iParam7)
{
	func_122(iParam1);
	if (bParam2)
	{
...
int func_200()
{
	...
	switch (iLocal_909)
	{
		case 0:
			if (bLocal_799)
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
				{
					...
					TASK::TASK_PLAY_ANIM(Local_824[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(Local_824[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_824[0 /*20*/].f_6, 10);
					}
			...
			else if (bLocal_800)
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
				{
					...
					TASK::TASK_PLAY_ANIM(Local_824[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					bLocal_190 = true;
				}
			}
			else if (func_209())
		...
		case 1:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6) || func_208(iLocal_900, Local_824[0 /*20*/].f_6, !(bLocal_799 || bLocal_800)))
				{
			...
			if (func_7(&iLocal_894) && func_4(&iLocal_894) > 1f)
			{
				if (bLocal_799 && func_7(&iLocal_894))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_171);
						TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_824[0 /*20*/], 0);
						TASK::TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_a", "idle_c", 0.25f, 0.25f, 30000, 1, 0, 0, 0, 0);
						TASK::TASK_SMART_FLEE_PED(0, Local_824[0 /*20*/], 1000f, -1, 0, 0);
						TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
						{
				...
				{
					if ((Global_111560.f_19968.f_4 % 2) == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_171);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::TASK_GO_TO_ENTITY(0, iLocal_900, 20000, 9f, 1f, 1073741824, 0);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				...
				else if (bLocal_798)
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_171);
						TASK::TASK_GO_TO_ENTITY(0, iLocal_900, 20000, 15f, 3f, 1073741824, 0);
						TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_171);
						TASK::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_171);
			...
			if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0))
				{
					if (bLocal_800)
					{
						if (!func_47())
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], 242628503) == 1)
							{
								if (TASK::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) == 2)
								{
									if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
									{
					...
					{
						if (func_204() || (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6) && !bLocal_813))
						{
							func_172();
							iLocal_909 = 5;
						}
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
			{
				if (func_119(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1) < 12f)
				{
					TASK::CLEAR_PED_TASKS(Local_824[0 /*20*/]);
					if (bLocal_798)
					{
						TASK::TASK_COMBAT_PED(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
		...
		case 5:
			if (!func_47())
			{
				...
				if ((!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
				{
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
					}
					else
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
						...
						TASK::TASK_ENTER_VEHICLE(0, Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
						TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_824[0 /*20*/].f_6, 5f, 786597);
						TASK::CLOSE_SEQUENCE_TASK(iVar0);
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
						{
							TASK::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iVar0);
						}
						TASK::CLEAR_SEQUENCE_TASK(&iVar0);
						bLocal_928 = true;
					}
					...
					if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						if (bLocal_799)
						{
							if (SYSTEM::TIMERB() > 8000)
							{
								...
								{
									VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_824[0 /*20*/].f_6, 1);
									TASK::TASK_ENTER_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
								}
								iLocal_909 = 7;
							}
						}
							...
							if (!bLocal_798)
							{
								if (PED::IS_PED_IN_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
								{
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
									{
										...
										{
											if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -258271821) != 1)
											{
												TASK::TASK_VEHICLE_DRIVE_WANDER(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 2f, 786597);
											}
										}
										else
										{
								...
								else if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
								{
									...
									{
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -1794415470) != 1)
										{
											if (VEHICLE::IS_VEHICLE_SEAT_FREE(Local_824[0 /*20*/].f_6, -1, 0))
											{
												TASK::TASK_ENTER_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, -1, -1, 2f, 1, 0);
											}
										}
									}
									else if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], 1056466932) != 1)
									{
										TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
									}
								}
		...
		case 7:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0) && !VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
			{
				...
				bLocal_791 = false;
				TASK::TASK_VEHICLE_DRIVE_WANDER(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 5f, 786597);
				iLocal_909 = 8;
				return 1;
			}
			break;
...
int func_204()
{
	...
	{
		case 0:
			if (TASK::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) >= 1 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				iLocal_912 = 1;
			}
			break;
		...
		case 1:
			if (bLocal_807 && !iLocal_808)
			{
				if (!func_47())
				{
					...
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -875674219) != 1)
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_1, 0);
						}
						iLocal_808 = 1;
						iLocal_912 = 2;
					}
	...
	if (!iLocal_780)
	{
		...
		if (bLocal_799)
		{
			if (SYSTEM::VDIST2(vVar0, vVar1) < 25f)
			{
				...
				if (!func_47())
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
					func_257(&Local_396, 5, Local_824[0 /*20*/], "TOWSEXMANLYGUY", 0, 1);
...
void func_231(var uParam0)
{
	...
	while (!func_236(&uLocal_472) || !VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_819[0]))
	{
		func_226(&uLocal_490);
		SYSTEM::WAIT(0);
	}
...
void func_258()
{
	iLocal_170 = func_260(Global_111560.f_19968.f_2);
	...
	{
		iLocal_450 = func_262(1300f, iLocal_170, Global_111560.f_19968.f_9);
		Global_111560.f_19968.f_9 = iLocal_450;
	}
	if (iLocal_450 == 0)
	{
		iLocal_170 = 3;
...
{
	iLocal_450 = func_262(1300f, iParam0, Global_111560.f_19968.f_9);
	if (iLocal_450 == -1)
	{
		return 0;
	}
...
int func_260(int iParam0)
{
	...
	if (iParam0 != 2)
	{
		if (Global_111560.f_19968.f_4 < iVar0)
		{
			iVar0 = Global_111560.f_19968.f_4;
			iVar1 = 2;
		}
	}
	if (iParam0 != 0)
	{
		if (Global_111560.f_19968.f_6 < iVar0)
		{
			iVar0 = Global_111560.f_19968.f_6;
			iVar1 = 0;
		}
	}
	if (iParam0 != 1)
	{
		if (Global_111560.f_19968.f_5 < iVar0)
		{
			iVar0 = Global_111560.f_19968.f_5;
			iVar1 = 1;
		}
	}
	if (iParam0 != 3)
	{
		if (Global_111560.f_19968.f_7 < iVar0)
		{
			iVar0 = Global_111560.f_19968.f_7;
			iVar1 = 3;
		}
	}
	if (iParam0 != 4)
	{
		if (Global_111560.f_19968.f_8 < iVar0)
		{
			iVar0 = Global_111560.f_19968.f_8;
			iVar1 = 4;
		}
	}
	return iVar1;
...
int func_272(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_283())
	{
		...
		{
			iVar2 = func_273(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_279()
{
	...
	iVar0 = func_280(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_283()
{
	...
	{
		if (func_273(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
