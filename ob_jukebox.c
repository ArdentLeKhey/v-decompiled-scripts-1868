#region Local Var
	...
	struct<5> Local_225 = { 1, 1056964608, -1, -1, 0 } ;
	vector3 vLocal_226[32] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
#endregion
...
void __EntryFunction__()
{
	...
	iLocal_205 = -1;
	iLocal_212 = 4;
	sLocal_213 = "anim@amb@clubhouse@jukebox@";
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY("ob_jukebox")) > 1)
	{
		func_206(0);
	}
	iLocal_203 = Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26;
	...
	if (func_189(Var0))
	{
		...
		{
			iLocal_199 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&Var0);
		}
	}
	if (iLocal_203 == 126)
	{
		iLocal_199 = func_182(PLAYER::PLAYER_ID());
		AUDIO::START_AUDIO_SCENE("dlc_ch_arcade_music_volume");
		AUDIO::SET_AUDIO_SCENE_VARIABLE("dlc_ch_arcade_music_volume", "ArcadeRadioVolumeDucking", Local_225.f_1);
	}
	if (iLocal_199 == func_181())
	{
		func_206(0);
	}
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_203 == 126)
		{
			if (Global_1590446[iLocal_199 /*871*/].f_273.f_346 != iLocal_212 && func_178(iLocal_199))
			{
				func_175(Global_1590446[iLocal_199 /*871*/].f_273.f_346);
				func_172(1);
				Local_225.f_1 = 0.5f;
				Local_225 = 1;
				Local_225.f_3 = iLocal_200;
				func_171();
			}
			else
			{
		...
		else if (Global_1590446[iLocal_199 /*871*/].f_273.f_344 != iLocal_212)
		{
			func_175(Global_1590446[iLocal_199 /*871*/].f_273.f_344);
			func_172(1);
			Local_225 = 1;
			Local_225.f_3 = iLocal_200;
			func_171();
	...
	while (true)
	{
		...
		if (iLocal_198 != 0 && !func_169(vLocal_224, 0f, 0f, 0f, 0))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_168();
		...
		else if (iLocal_203 != -1 && iLocal_203 <= 126)
		{
			vLocal_222 = { func_1() };
			...
			if (iLocal_203 == 126)
			{
				iLocal_198 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_222, 2f, joaat("ch_prop_arcade_jukebox_01a"), 1, 0, 0);
			}
			else
			{
				iLocal_198 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_222, 2f, joaat("bkr_prop_clubhouse_jukebox_01a"), 1, 0, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_198))
			{
				vLocal_223 = { ENTITY::GET_ENTITY_COORDS(iLocal_198, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_198) * Vector(0.6f, 0.6f, 0.6f) };
				vLocal_223.z = (vLocal_223.z + 0.5f);
				vLocal_224 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_198, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
Vector3 func_1()
{
	if (func_5(iLocal_203, -1))
	{
		return func_3(iLocal_203);
	}
	else if (iLocal_203 == 126)
	{
		return func_2();
	}
	return 0f, 0f, 0f;
...
void func_6()
{
	if (iLocal_199 == PLAYER::PLAYER_ID() && func_170())
	{
		if (!func_20(&uLocal_220))
		{
			func_19(&uLocal_220, 0, 0);
		}
		else if (func_18(&uLocal_220, 180000, 0))
		{
			func_8(iLocal_200);
			func_7(&uLocal_220, 0, 0);
		}
	}
}
...
void func_8(int iParam0)
{
	...
	if (iLocal_203 == 126)
	{
		...
		iVar1 = (NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_209);
		func_13(func_17(iParam0), (iVar0 + iVar1), -1, 1, 0);
		if (iLocal_210 < (iVar0 + iVar1))
		{
			func_11(func_12());
		}
	}
	else
	{
		...
		iVar3 = (NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_209);
		func_13(func_10(iParam0), (iVar2 + iVar3), -1, 1, 0);
		if (iLocal_210 < (iVar2 + iVar3))
		{
			func_11(func_9());
		}
	}
	iLocal_209 = NETWORK::GET_CLOUD_TIME_AS_INT();
}
...
{
	Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_345 = uParam0;
}
...
void func_21()
{
	...
	bVar0 = func_170();
	if (Local_225.f_3 != iLocal_200)
	{
		func_175(Local_225.f_3);
		if (iLocal_199 == PLAYER::PLAYER_ID() && Local_225.f_4)
		{
			if (iLocal_203 == 126)
			{
				func_22(26808, iLocal_200, -1, 1);
				Global_1590446[iLocal_199 /*871*/].f_273.f_346 = iLocal_200;
			}
			else
			{
				func_22(9355, iLocal_200, -1, 1);
				Global_1590446[iLocal_199 /*871*/].f_273.f_344 = iLocal_200;
			}
		}
	}
	if (MISC::IS_BIT_SET(iLocal_208, 6) != bVar0)
	{
		func_172(bVar0);
		if ((iLocal_199 == PLAYER::PLAYER_ID() && Local_225.f_4) && !bVar0)
		{
			if (iLocal_203 == 126)
			{
				func_22(26808, iLocal_212, -1, 1);
				Global_1590446[iLocal_199 /*871*/].f_273.f_346 = iLocal_212;
			}
			else
			{
				func_22(9355, iLocal_212, -1, 1);
				Global_1590446[iLocal_199 /*871*/].f_273.f_344 = iLocal_212;
			}
		}
	}
}
	...
	switch (iLocal_215)
	{
		case 0:
			if (func_159() && func_158())
			{
				...
				if (iLocal_205 == -1)
				{
					func_155(&iLocal_205, 4, "JBOX_INTERACT", 0, 0, 0, 0);
				}
				else if ((iLocal_205 != -1 && func_154(iLocal_205, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					func_153(2);
					func_151(&iLocal_205);
					MISC::SET_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 0);
					MISC::SET_BIT(&Global_2507867, 4);
				}
				MISC::SET_BIT(&Global_2507867, 3);
			}
			else if (iLocal_205 != -1)
			{
				func_151(&iLocal_205);
				MISC::CLEAR_BIT(&Global_2507867, 3);
			}
			else if (!func_158() && func_159())
			{
				func_150("JBOX_NO_MONEY");
				MISC::CLEAR_BIT(&Global_2507867, 3);
			}
			else
			{
		...
		case 2:
			if (Local_225.f_2 == PLAYER::PLAYER_ID() && func_148())
			{
				iLocal_206 = 0;
				func_153(1);
				MISC::CLEAR_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::SET_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 1);
				func_138(PLAYER::PLAYER_ID(), 0, 256, 0);
				func_137(&uLocal_218);
			}
			else if (Local_225.f_2 != -1 || !func_148())
			{
				func_153(0);
				MISC::CLEAR_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::CLEAR_BIT(&Global_2507867, 4);
			}
			break;
		...
		case 1:
			...
			{
				iLocal_202 = 0;
				MISC::SET_BIT(&iLocal_208, 1);
				func_153(3);
				if (!MONEY::NETWORK_CAN_SPEND_MONEY(1, false, false, 0, -1, 0))
				{
					iLocal_214 = 1;
				}
			}
		...
		case 3:
			if (MISC::IS_BIT_SET(iLocal_208, 4))
			{
				if (func_131())
				{
					MISC::CLEAR_BIT(&iLocal_208, 4);
				}
			}
			func_42();
			break;
		...
		case 4:
			if (MISC::IS_BIT_SET(iLocal_208, 3))
			{
				MISC::CLEAR_BIT(&iLocal_208, 3);
				func_39(1, -1);
			}
			iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_207);
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "EXIT", 3))
			{
				func_30(MISC::IS_BIT_SET(iLocal_208, 5));
				if (iLocal_201 != -1)
				{
					if ((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "INSERT_COINS", 3) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.82f) || !MISC::IS_BIT_SET(iLocal_208, 5))
					{
						func_29(iLocal_201);
					}
				}
			...
			{
				MISC::CLEAR_BIT(&iLocal_208, 5);
				MISC::CLEAR_BIT(&iLocal_208, 4);
				MISC::CLEAR_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 1);
				MISC::CLEAR_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 2);
				MISC::CLEAR_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 3);
				func_138(PLAYER::PLAYER_ID(), 1, 0, 0);
				MISC::CLEAR_BIT(&Global_2507867, 4);
				iLocal_214 = 0;
				if (iLocal_203 == 126)
				{
					iLocal_211 = Global_1590446[iLocal_199 /*871*/].f_273.f_344;
				}
				else
				{
					iLocal_211 = Global_1590446[iLocal_199 /*871*/].f_273.f_346;
				}
				STATS::_0x8989CBD7B4E82534(func_27(func_28()), func_26(func_28()), func_25(), func_24(), 4, iLocal_211, 0);
				func_153(0);
			}
			break;
	}
...
{
	vLocal_226[PLAYER::PLAYER_ID() /*3*/].f_1 = iParam0;
	MISC::SET_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 2);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_206)
		{
			...
			case 1:
				...
				{
					STREAMING::REMOVE_ANIM_DICT(sLocal_213);
					iLocal_206 = 0;
					return 1;
				}
				break;
...
int func_38(char* sParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_207);
	STREAMING::REQUEST_ANIM_DICT(sLocal_213);
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_213))
	{
		if ((!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar0) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f) || bParam1)
		{
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_207))
			{
				PED::DETACH_SYNCHRONIZED_SCENE(iLocal_207);
				iLocal_207 = -1;
			}
			iLocal_207 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_224, ENTITY::GET_ENTITY_ROTATION(iLocal_198, 2), 2, false, bParam2, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_207, sLocal_213, sParam0, 4f, -2f, 5, 0, 2f, 0);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_207);
			return 1;
		}
	}
	return 0;
...
void func_42()
{
	if (!func_130())
	{
		...
		{
			if (MISC::IS_BIT_SET(iLocal_208, 1))
			{
				func_86();
				MISC::CLEAR_BIT(&iLocal_208, 1);
			}
			else
			{
				func_85(iLocal_202, 1, 1);
			}
			func_80();
			func_44(1, -1, 1, 0, 1, -1082130432, 0, 0, -1);
			func_43();
			MISC::SET_BIT(&iLocal_208, 3);
		}
	}
}
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_22350.f_4690)) != 0 && Global_22350.f_4766 != -1)
			{
				...
				if (Global_22350.f_4768 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4768), func_66(Global_22350.f_4768, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				{
					func_75(Global_4268271.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					fVar40 = (((Global_22347 + fVar36) + (0.00078125f * 4f)) - (0.00078125f * 1f));
				}
				func_61(fVar40);
				...
				{
					func_75(Global_4268271.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_60(Global_4268271.f_67, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_69(Global_4268271.f_67), func_66(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
									...
									if (bVar52)
									{
										if (func_75(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(26), func_66(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
										if (func_75(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(27), func_66(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
									}
												...
												if (func_75(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_75(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar28)]), func_66(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar28)]), func_66(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
												...
												if (func_75(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_75(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (Global_22347 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
													}
									...
									if (func_75(Global_22350.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_75(Global_22350.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[iVar22]), func_66(Global_22350.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_46(Global_22350.f_4433[iVar22])), (fVar37 * func_46(Global_22350.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
								}
	...
	if (Global_22350.f_4769 != 0)
	{
		...
		if (!Global_22350.f_4770)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_55(&Global_4268271);
				if (Global_4268271.f_20 == -1)
				{
					func_54(&(Global_4268271.f_16));
				}
				else
				{
...
var func_66(int iParam0, bool bParam1)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_22350.f_7013[iParam0 /*16*/])))
	{
		...
		{
			return func_67(&(Global_22350.f_7013[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
int func_77(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_79(8, -1) && func_78() != 65)) || (HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_76837) || Global_22350.f_8384) || HUD::IS_WARNING_MESSAGE_ACTIVE()) || Global_98721.f_1417)
	{
		return 0;
	}
	return 1;
...
void func_83()
{
	...
	if (iLocal_202 == Local_225.f_3 && func_170())
	{
		func_82("JBOX_PLIST_PLY", 0, 0);
	}
	else if (iLocal_202 == iLocal_212)
	{
	...
	else
	{
		...
		StringIntConCat(&Var0, iLocal_202, 16);
		func_82(&Var0, 0, 0);
	}
}
...
void func_99()
{
	...
	if (!MISC::IS_BIT_SET(iLocal_208, 0))
	{
		if (PAD::_IS_INPUT_JUST_DISABLED(2))
		{
		...
		{
			func_19(&uLocal_216, 0, 0);
			MISC::SET_BIT(&iLocal_208, 0);
		}
	}
	else if (func_18(&uLocal_216, iVar1, 0))
	{
		func_137(&uLocal_216);
		MISC::CLEAR_BIT(&iLocal_208, 0);
	}
	if (bVar3)
	{
		iLocal_202++;
		if (iLocal_202 > func_117())
		{
			iLocal_202 = 0;
		}
	...
	if (bVar6)
	{
		...
		switch (iLocal_214)
		{
			...
			case 0:
				if (iLocal_202 != Local_225.f_3 || !func_170())
				{
					iLocal_201 = iLocal_202;
					iLocal_214 = 2;
					iLocal_202 = 0;
					MISC::SET_BIT(&iLocal_208, 1);
					MISC::SET_BIT(&iLocal_208, 4);
				}
				else
				{
					bVar8 = true;
			...
			case 2:
				if (iLocal_202 == 0)
				{
					iLocal_206 = 0;
					func_153(4);
					if (iLocal_201 != iLocal_212)
					{
						MISC::SET_BIT(&iLocal_208, 5);
						func_100(iLocal_201);
					}
				}
				else
...
void func_100(int iParam0)
{
	...
	if (MONEY::NETWORK_CAN_SPEND_MONEY(1, false, false, 1, -1, 0))
	{
		if (func_113())
		{
			func_101(1976384368, 1, &iVar1, 0, 0, 1);
			Global_4263810[iVar1 /*84*/] = iVar0;
		}
		else
		{
...
void func_104(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_105(&(Global_4263810[iParam0 /*84*/]));
	}
}
...
void func_105(var uParam0)
{
	...
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	func_106(&(uParam0->f_13));
	func_106(&(uParam0->f_13.f_13));
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)
{
	...
	while (iVar0 < 5)
	{
		if (Global_4263810[iVar0 /*84*/].f_65.f_2 == 0)
		{
			...
			{
				func_110(Global_4263810[iVar0 /*84*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
void func_110(struct<66> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
{
	vLocal_226[PLAYER::PLAYER_ID() /*3*/].f_2 = fParam0;
	MISC::SET_BIT(&(vLocal_226[PLAYER::PLAYER_ID() /*3*/]), 3);
}
...
void func_118(var uParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, var uParam5)
{
	if (MISC::IS_PC_VERSION() && !NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE())
	{
		...
		if (func_122())
		{
			if (Global_4268347 == iLocal_202)
			{
				*bParam2 = 1;
			}
			else
			{
				iLocal_202 = Global_4268347;
				func_85(iLocal_202, 1, 1);
			}
		}
		if (func_121())
...
int func_132()
{
	...
	switch (iLocal_206)
	{
		case 0:
			func_31(0);
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_198, 0.06f, -0.8958f, 0.2f) };
			if (!func_20(&uLocal_218))
			{
				func_19(&uLocal_218, 0, 0);
			}
			else if (func_18(&uLocal_218, 2000, 0))
			{
				iLocal_206 = 1;
			}
			if (!func_136(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar0, 0.8f, 0))
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar0, 1f, 4000, ENTITY::GET_ENTITY_HEADING(iLocal_198), 0.125f);
				}
			}
			else
			{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_56(PLAYER::PLAYER_ID(), 0) && !func_146()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_142(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_142(iVar26) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					...
					if (func_139(Global_4456448.f_190930))
					{
...
void func_143(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		func_144(joaat("MPPLY_IS_CHAR_SPECTATING"), bParam0);
	}
}
...
int func_158()
{
	if (func_170() || MONEY::NETWORK_CAN_SPEND_MONEY(1, false, false, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
int func_159()
{
	...
	iVar0 = 1;
	if (func_205(PLAYER::PLAYER_ID()) && !func_178(iLocal_199))
	{
		iVar0 = 0;
	}
	if ((((((((((((((!MISC::IS_BIT_SET(Global_2507867, 5) && !func_166()) && !func_36(0)) && !func_165()) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_198)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_223, 0.55f, 0.8f, 1.5f, false, true, 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "EXIT", 3)) && !func_164(PLAYER::PLAYER_ID())) && !func_163()) && iVar0) && !MISC::IS_BIT_SET(Global_1676879.f_4, 2)) && func_160(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2405071.f_2670) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
void func_168()
{
	if (func_163())
	{
		if (MISC::IS_BIT_SET(vLocal_226[Local_225.f_2 /*3*/], 2))
		{
			if (vLocal_226[Local_225.f_2 /*3*/].f_1 == iLocal_212)
			{
				if (func_170())
				{
					Local_225 = 0;
					Local_225.f_3 = iLocal_212;
					if (iLocal_199 == Local_225.f_2)
					{
						Local_225.f_4 = 1;
					}
				}
			}
			else if (Local_225.f_3 != vLocal_226[Local_225.f_2 /*3*/].f_1)
			{
				Local_225.f_3 = vLocal_226[Local_225.f_2 /*3*/].f_1;
				if (iLocal_199 == Local_225.f_2)
				{
					Local_225.f_4 = 1;
				}
		...
		if (MISC::IS_BIT_SET(vLocal_226[Local_225.f_2 /*3*/], 3))
		{
			if (Local_225.f_1 != vLocal_226[Local_225.f_2 /*3*/].f_2)
			{
				Local_225.f_1 = vLocal_226[Local_225.f_2 /*3*/].f_2;
			}
		}
		if (!MISC::IS_BIT_SET(vLocal_226[Local_225.f_2 /*3*/], 1) && !MISC::IS_BIT_SET(vLocal_226[Local_225.f_2 /*3*/], 0))
		{
			Local_225.f_2 = -1;
		}
	}
	else if (MISC::IS_BIT_SET(vLocal_226[iLocal_204 /*3*/], 0))
	{
		if (!func_163())
		{
			Local_225.f_2 = iLocal_204;
		}
	}
	if (!func_163())
	{
		if (iLocal_203 == 126)
		{
			if (Global_1590446[iLocal_199 /*871*/].f_273.f_346 == Local_225.f_3 && (!func_170() && Global_1590446[iLocal_199 /*871*/].f_273.f_346 == iLocal_212))
			{
				Local_225.f_4 = 0;
			}
		}
		else if (Global_1590446[iLocal_199 /*871*/].f_273.f_344 == Local_225.f_3 && (!func_170() && Global_1590446[iLocal_199 /*871*/].f_273.f_344 == iLocal_212))
		{
			Local_225.f_4 = 0;
		}
	}
...
void func_171()
{
	...
	if (iLocal_203 == 126)
	{
		iVar0 = func_12();
		iLocal_209 = NETWORK::GET_CLOUD_TIME_AS_INT();
		iLocal_210 = func_16(func_17(iVar0), -1, 0);
	}
	else
	{
		iVar1 = func_9();
		iLocal_209 = NETWORK::GET_CLOUD_TIME_AS_INT();
		iLocal_210 = func_16(func_10(iVar1), -1, 0);
	}
}
...
void func_172(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&iLocal_208, 6);
	}
	else
	{
		MISC::CLEAR_BIT(&iLocal_208, 6);
	}
	if (func_5(iLocal_203, -1))
	{
		func_174(iLocal_203, bParam0);
	}
	else if (iLocal_203 == 126)
	{
		func_173(bParam0);
...
void func_175(int iParam0)
{
	if (func_5(iLocal_203, -1))
	{
		if (iParam0 != iLocal_212 && iParam0 != -1)
		{
			if (iLocal_199 == PLAYER::PLAYER_ID() && iLocal_209 != 0)
			{
				func_8(iLocal_200);
			}
			func_177(iLocal_203, iParam0);
		}
		if (iParam0 != -1)
		{
			iLocal_200 = iParam0;
...
int func_180(int iParam0)
{
	if (iParam0 != func_181())
	{
		return MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_389.f_1, 2);
	}
	return 0;
}
...
bool func_184(int iParam0, bool bParam1)
{
	...
	return Global_1628955[iParam0 /*614*/].f_11 != func_181();
}
...
int func_185(int iParam0)
{
	if (iParam0 != func_181())
	{
		if (Global_1628955[iParam0 /*614*/].f_11 != func_181())
		{
...
int func_187(int iParam0)
{
	if (iParam0 != func_181())
	{
		...
		else if (((Global_1312873 || Global_2405071.f_2669) && iParam0 == PLAYER::PLAYER_ID()) && func_188(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5;
		}
	}
...
{
	*uParam1 = { Global_1590446[iParam0 /*871*/].f_273.f_63 };
}
...
void func_191()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !MISC::IS_BIT_SET(iLocal_208, 2))
	{
		iVar0 = Global_1048576.f_1234;
		...
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_225, 5);
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_226, 97);
		if (!func_192())
		{
			func_206(0);
		}
		MISC::SET_BIT(&iLocal_208, 2);
	}
}
...
int func_199(int iParam0)
{
	if (iParam0 != func_181())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_188(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_200()
{
	if (iLocal_203 == 126)
	{
		...
		else if (MISC::IS_BIT_SET(Global_2507867, 1))
		{
			MISC::CLEAR_BIT(&Global_2507867, 1);
			func_206(0);
		}
		else if (MISC::IS_BIT_SET(Global_1676879.f_6, 10))
		{
			if (iLocal_215 != 0)
			{
				if (MISC::IS_BIT_SET(iLocal_208, 3))
	...
	else if (iLocal_203 != Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26)
	{
		func_206(0);
	}
}
...
int func_205(int iParam0)
{
	if (iParam0 != func_181())
	{
		if (func_188(iParam0, 1, 1))
		{
			...
			{
				return func_186(Global_2424073[iParam0 /*421*/].f_309.f_5) == 17;
			}
		}
	}
	return 0;
...
void func_207()
{
	...
	{
		if (((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "IDLE", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "EXIT", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "INSERT_COINS", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "SELECT_TRACK", 3))
		{
