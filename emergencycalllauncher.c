#region Local Var
	...
	var uLocal_208 = 0;
	var uLocal_209 = 0;
	struct<6> Local_210 = { 0, 0, 0, 0, 0, 0 } ;
	int iLocal_211 = 0;
	int iLocal_212 = 0;
#endregion
...
void func_3()
{
	...
	{
		Local_210 = { func_5() };
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Local_210)) == 0)
		{
			func_4();
		}
		else
		...
		case 0:
			if ((((((func_35(130) && func_33(PLAYER::PLAYER_ID()) != 192) && func_33(PLAYER::PLAYER_ID()) != 190) && func_33(PLAYER::PLAYER_ID()) != 191) && func_33(PLAYER::PLAYER_ID()) != 225) && func_33(PLAYER::PLAYER_ID()) != 226) && func_33(PLAYER::PLAYER_ID()) != 227)
			{
				...
				if (!Global_30794)
				{
					if (func_31())
					{
						if (func_8(&uLocal_45, 130, "LOCAUD", "LOC_CALLQ", iLocal_212, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
						{
							if (!func_6())
							{
					...
					else if (func_8(&uLocal_45, 130, "LOCAUD", "LOC_CALLQ", iLocal_212, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
					{
						if (!func_6())
						{
							SCRIPT::REQUEST_SCRIPT("emergencycall");
...
{
	Global_30960 = 1;
	StringCopy(&Global_30961, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}
