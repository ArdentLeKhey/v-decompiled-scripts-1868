...
void func_2()
{
	...
	if (Global_42529 > iVar1 || Global_42529 == -1)
	{
		...
		if (Global_42532 != Global_42533)
		{
			...
			if (MISC::ABSF((Global_42532 - Global_42533)) < 0.01f)
			{
		...
		{
			CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", ((Global_42532 * fVar3) * fVar5));
		}
		if ((MISC::GET_GAME_TIMER() % 100) == 0)
		{
			...
			else
			{
				...
				CAM::SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(((Global_42532 * fVar3) * fVar5));
				CAM::_0x487A82C650EB7799(((Global_42531 * fVar3) * fVar5));
				fLocal_18 = fVar3;
			}
		}
		if (((Global_42531 * fVar3) * fVar5) < 1f)
		{
			CAM::_0x0225778816FDC28C(((Global_42531 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", (((Global_42532 * Global_42526) * fVar3) * fVar5));
		}
		CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE((((Global_42532 * Global_42526) * fVar3) * fVar5));
		if (CAM::DOES_CAM_EXIST(Global_42528))
		{
			if (CAM::IS_CAM_SHAKING(Global_42528))
			{
				CAM::SET_CAM_SHAKE_AMPLITUDE(Global_42528, ((Global_42532 * fVar3) * fVar5));
			}
		}
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_42555) && !MISC::IS_STRING_NULL_OR_EMPTY(&Global_42539))
		{
			AUDIO::START_AUDIO_SCENE(&Global_42539);
		...
		if (Global_42534 > 0f)
		{
			if (fLocal_16 != Global_42534)
			{
				...
				{
					GRAPHICS::SET_TRANSITION_TIMECYCLE_MODIFIER(&Global_42535, 15f);
			...
			else
			{
				...
				if (iVar7 <= (Global_42530 / 2) && Global_42529 != -1)
				{
					...
					else
					{
						...
						{
							GRAPHICS::_0x1CBA05AE7BD7EE05((SYSTEM::TO_FLOAT((Global_42530 / 2)) / 1000f));
						}
						fLocal_16 = -99f;
						Global_42534 = 0f;
...
float func_13()
{
	...
	if (iVar2 <= Global_42530)
	{
		if (Global_42529 != -1)
		{
			fVar1 = (SYSTEM::TO_FLOAT(iVar2) / SYSTEM::TO_FLOAT(Global_42530));
		}
	}
	return fVar1;
}
...
void func_15(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Global_42322[iParam0 /*5*/].f_1, 0))
	{
		func_18(iParam0);
		return;
	}
