					...
					switch (iLocal_29)
					{
						case 0:
							...
							else
							{
								...
								Global_30796[iLocal_41 /*11*/].f_2 = 0;
								Global_30796[iLocal_41 /*11*/].f_6 = 1;
								Global_30796[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								Global_30796[iLocal_41 /*11*/].f_1 = 0;
								Global_30796[iLocal_41 /*11*/].f_4 = 0;
								Global_30796[iLocal_41 /*11*/].f_7 = 0;
								Global_30796[iLocal_41 /*11*/].f_8 = 0;
								Global_30796[iLocal_41 /*11*/].f_10 = 0;
								fLocal_30 = -4f;
								func_55(&iLocal_26);
								func_53();
								func_52();
						...
						case 1:
							...
							{
								if (func_44() || Global_30796[iLocal_41 /*11*/].f_5)
								{
									iLocal_29 = 2;
								}
							}
						...
						case 2:
							...
							if (!func_64(iLocal_41))
							{
								if ((Global_30796[iLocal_41 /*11*/] == 3 || Global_30796[iLocal_41 /*11*/] == 2) || Global_30796[iLocal_41 /*11*/] == -1)
								{
									Global_30796[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								}
								GRAPHICS::SET_TV_CHANNEL(Global_30796[iLocal_41 /*11*/]);
								GRAPHICS::SET_TV_VOLUME(fLocal_30);
							}
							else
							{
								iLocal_42 = Global_30796[iLocal_41 /*11*/];
								iLocal_43 = Global_30796[iLocal_41 /*11*/].f_1;
								GRAPHICS::SET_TV_CHANNEL_PLAYLIST(iLocal_42, func_41(iLocal_43), Global_30796[iLocal_41 /*11*/].f_9);
								GRAPHICS::SET_TV_CHANNEL(iLocal_42);
								if (Global_30796[iLocal_41 /*11*/].f_7)
								{
									Global_30796[iLocal_41 /*11*/].f_5 = 0;
									Global_30796[iLocal_41 /*11*/].f_7 = 0;
								}
							}
							Global_30796[iLocal_41 /*11*/].f_2 = 1;
							func_40(133, 1);
							func_40(131, 1);
							func_40(132, 1);
							iLocal_29 = 3;
						...
						case 3:
							if (Global_30796[iLocal_41 /*11*/].f_4)
							{
								iLocal_29 = 6;
							}
							if (Global_30796[iLocal_41 /*11*/].f_7 && func_64(iLocal_41))
							{
								Global_30796[iLocal_41 /*11*/].f_7 = 0;
								iLocal_29 = 6;
							}
...
void func_1()
{
	if (iLocal_41 != -1)
	{
		Global_30796[iLocal_41 /*11*/] = GRAPHICS::GET_TV_CHANNEL();
	}
...
int func_15()
{
	if (!func_64(iLocal_41))
	{
		if (((((((func_31(&iLocal_26) >= 1f && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_68, 1f, 1f, 1.5f, false, true, 0)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_35) == INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())) && !func_30(8, -1)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), vLocal_31, 90f)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (iLocal_40 == -1)
			{
				func_29();
...
int func_44()
{
	...
	if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_68, 1f, 1f, 1.5f, false, true, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), vLocal_31, 90f)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		func_43(&iLocal_40);
		return 0;
	}
	...
	if (Global_30796[iLocal_41 /*11*/].f_8)
	{
		func_43(&iLocal_40);
		return 0;
	}
	...
	if (func_26(iLocal_40, 1))
	{
		func_43(&iLocal_40);
		func_55(&iLocal_26);
		Global_30796[iLocal_41 /*11*/].f_7 = 1;
		if (AUDIO::REQUEST_AMBIENT_AUDIO_BANK("SAFEHOUSE_MICHAEL_SIT_SOFA", 0, -1))
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
		}
...
void func_62()
{
	...
	if (Global_30796[iLocal_41 /*11*/].f_10 == 0)
	{
		if (iLocal_66 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_38))
...
void func_68()
{
	...
	{
		func_1();
		Global_30796[iLocal_41 /*11*/].f_6 = 0;
		Global_30796[iLocal_41 /*11*/].f_7 = 0;
		Global_30796[iLocal_41 /*11*/].f_8 = 0;
		Global_30796[iLocal_41 /*11*/].f_4 = 0;
		Global_30796[iLocal_41 /*11*/].f_5 = 0;
		Global_30796[iLocal_41 /*11*/].f_2 = 0;
		Global_30796[iLocal_41 /*11*/] = -1;
		Global_30796[iLocal_41 /*11*/].f_1 = 0;
		Global_30796[iLocal_41 /*11*/].f_10 = 0;
	}
