...
void __EntryFunction__()
{
	...
	vLocal_274 = { 0f, 0f, 0f };
	vLocal_275 = { 0f, 0f, 0f };
	iLocal_280 = MISC::GET_RANDOM_INT_IN_RANGE(0, 4);
	func_76();
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_286))
	{
		iLocal_41 = iScriptParam_286;
...
void func_1()
{
	...
	{
		case 0:
			if (func_52(vVar0, vVar1) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_41, true), 90f))
			{
				func_76();
		...
		case 2:
			...
			iLocal_278 = PED::CREATE_SYNCHRONIZED_SCENE(func_37(), func_36(), 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_278, func_35(), func_34(iLocal_280), 8f, -2f, 0, 0, 1148846080, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_278, func_33(iLocal_280), func_35(), 8f, -2f, 0, 1148846080);
			if (PED::_0x7F2F4F13AC5257EF(iLocal_278))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_278, false);
			}
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				iLocal_279 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_279, iLocal_278, func_30(iLocal_280), func_35());
			...
			iLocal_283 = 0;
			iLocal_284 = (MISC::GET_GAME_TIMER() + func_29());
			iLocal_277 = 3;
			break;
		...
		case 3:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_278))
			{
				...
				if (iLocal_281)
				{
					fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_278);
					if (ENTITY::FIND_ANIM_EVENT_PHASE(func_35(), func_34(iLocal_280), "WalkInterruptible", &fVar3, &fVar4))
					{
				...
				if (!iLocal_283 && MISC::GET_GAME_TIMER() > iLocal_284)
				{
		...
		case 5:
			if (func_2(iLocal_279))
			{
				CAM::_RENDER_FIRST_PERSON_CAM(0, 0, 3, 0);
			}
			AUDIO::RELEASE_AMBIENT_AUDIO_BANK();
			if (STATS::STAT_GET_INT(joaat("NUM_SH_MR_JAM_USED"), &iLocal_285, -1))
			{
				STATS::STAT_SET_INT(joaat("NUM_SH_MR_JAM_USED"), iLocal_285 + 1, 1);
			}
...
int func_52(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95627 && Global_95628) || func_54())
					{
						return 0;
					}
					if (func_53(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_111560.f_7256.f_227[145] == 1)
			{
				if (func_15() == 2)
				{
					if (((((Global_93705[13] != 127 && Global_93705[13] != 135) && Global_93721 != 127) && Global_93721 != 135) && !func_65()) && !func_67())
					{
						return 1;
					}
				}
...
{
	return func_73(iParam0, Global_41396);
}
