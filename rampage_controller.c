...
void __EntryFunction__()
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_111560.f_18569[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
bool func_1()
{
	return (((func_9(9) || Global_30738) || func_2() != 2) || Global_110647[56 /*10*/].f_3);
}
...
{
	return func_11(iParam0, Global_41396);
}
...
void func_19(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_111560.f_2347[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_29 + iVar0), 0)) || MISC::IS_BIT_SET(Global_111560.f_18569[(iLocal_30 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
...
void func_28()
{
	...
	{
		func_32(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
