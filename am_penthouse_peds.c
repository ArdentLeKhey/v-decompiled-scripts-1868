...
void __EntryFunction__()
{
	...
	{
		func_47();
		if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_35()) || Global_1316819 == 0)
		{
			func_32();
		}
		func_3();
...
void func_1()
{
	...
	if (iLocal_21 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_23[iVar0 /*13*/]) && !ENTITY::IS_ENTITY_DEAD(Local_23[iVar0 /*13*/], 0))
			{
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		if (func_30(&(Local_23[iVar0 /*13*/])))
		{
			...
			else if (ENTITY::IS_ENTITY_DEAD(Local_23[iVar0 /*13*/], 0))
			{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED(sVar0))
		{
			...
			else
			{
				...
				while (iVar8 < 4)
				{
					...
					{
						case 0:
							TASK::TASK_PLAY_ANIM(0, sVar0, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 1:
							TASK::TASK_PLAY_ANIM(0, sVar0, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 2:
							TASK::TASK_PLAY_ANIM(0, sVar0, "IDLE_C", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 3:
							TASK::TASK_PLAY_ANIM(0, sVar0, "IDLE_D", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
					}
					iVar8++;
				}
...
void func_11(var uParam0)
{
	if (iLocal_20 < 2)
	{
		...
		if (func_28(uParam0))
		{
			*uParam0 = PED::CREATE_PED(26, func_26(uParam0), uParam0->f_6, uParam0->f_9, 0, false);
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				...
				if (func_7(uParam0))
				{
					PED::SET_PED_ALTERNATE_MOVEMENT_ANIM(*uParam0, 0, func_12(uParam0), "BASE", 1090519040, 1);
				}
				iLocal_20++;
			}
		}
...
{
	if (iParam0 >= Global_262145.f_26199)
	{
		return 5;
	}
	else if (iParam0 >= Global_262145.f_26198)
	{
		return 4;
	}
	else if (iParam0 >= Global_262145.f_26197)
	{
		return 3;
	}
	else if (iParam0 >= Global_262145.f_26196)
	{
		return 2;
	}
	return 1;
...
void func_54()
{
	while (!NETWORK::_NETWORK_IS_THIS_SCRIPT_MARKED(32, 0, Global_1316834))
	{
		SYSTEM::WAIT(0);
	}
	Global_1316834++;
