...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	vLocal_78 = { -1593.813f, 5221.235f, 1.94482f };
	vLocal_79 = { -1603.986f, 5243.624f, 4.940323f };
	uLocal_80 = func_365(16);
	...
	func_328(&iLocal_83, &(Local_82.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
		RECORDING::_0x208784099002BC30("SF_DAS", 0);
		func_312(Local_82.f_9, 0, 0, 0, 0, 0);
		func_1();
	}
}
...
void func_1()
{
	switch (iLocal_87)
	{
		...
		case 1:
			func_299();
			if ((func_303(iLocal_83) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_83, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_87++;
			}
			break;
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					CAM::SET_CAM_PARAMS(iLocal_84, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					CAM::SET_CAM_PARAMS(iLocal_84, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
				...
				if (func_303(iLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
		...
		case 5:
			...
			if (func_224(1000) || MISC::GET_GAME_TIMER() > iLocal_86)
			{
...
void func_214(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
void func_231(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_234(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_268(iParam3, &Var0, vParam1, fParam2, func_271(iParam0));
		func_235(iParam3, iParam0, 0);
	}
}
...
void func_235(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_254();
			}
...
void func_236(int iParam0, int iParam1)
{
	...
	func_273(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_237(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_252(iParam0, 0, 0)) || func_252(iParam0, 1, 0)) || func_252(iParam0, 2, 0)) || func_271(iParam0) != 145) || func_251(iParam0)) || func_250(iParam0)) || func_249(iParam0)) || func_248(iParam0)) || !func_238(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_250(iParam0))
		{
		}
...
int func_265(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_272(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_272(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_272(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_268(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_265(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_270(iParam0);
			func_269(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
bool func_272(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_278(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_279(vParam0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
void func_282(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_283(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_283(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_285(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_287(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_297(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_297(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_305()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_297(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_312(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_314(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_315(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_325(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_327(iParam0, Global_41396);
}
...
int func_345(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_351())
	{
		...
		{
			iVar2 = func_346(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_347()
{
	...
	iVar0 = func_348(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_351()
{
	...
	{
		if (func_346(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
