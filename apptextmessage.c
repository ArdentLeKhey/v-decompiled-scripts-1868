...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_19486.f_1 != 9)
		{
			...
			{
				if (MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iLocal_23 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_111560.f_14136[iLocal_23 /*104*/].f_24 == 1)
	{
		if (Global_19464 == 0)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_19457))
			{
				...
				HUD::THEFEED_REMOVE_ITEM(Global_111560.f_14136[iLocal_23 /*104*/].f_16);
				func_42(Global_19467, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_40();
				if (iLocal_21 > 0)
				{
		...
		if ((func_3(2, Global_19455, 0) || Global_111560.f_14046[Global_19486 /*20*/].f_17 == 1) || Global_21865 == 1)
		{
			...
			if (Global_111560.f_14136[iLocal_23 /*104*/].f_24 != 0)
			{
				...
				if (Global_111560.f_14136[iLocal_23 /*104*/].f_17 == 145)
				{
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iLocal_23 /*104*/].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
				...
				switch (Global_111560.f_14136[iLocal_23 /*104*/].f_32)
				{
					...
					case 1:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_111560.f_14136[iLocal_23 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iLocal_23 /*104*/].f_33));
						if (Global_111560.f_14136[iLocal_23 /*104*/].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67), "NULL"))
						{
							HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67));
						}
						if ((Global_111560.f_14136[iLocal_23 /*104*/].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67), "NULL")) && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iLocal_23 /*104*/].f_83), "NULL"))
						{
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iLocal_23 /*104*/].f_67));
							}
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_111560.f_14136[iLocal_23 /*104*/].f_83)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_111560.f_14136[iLocal_23 /*104*/].f_83));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iLocal_23 /*104*/].f_83));
							}
						}
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_111560.f_14136[iLocal_23 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_INTEGER(Global_111560.f_14136[iLocal_23 /*104*/].f_49);
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
				...
				{
					if (PED::IS_PEDHEADSHOT_VALID(Global_21874[iLocal_23]))
					{
						if (PED::IS_PEDHEADSHOT_READY(Global_21874[iLocal_23]))
						{
							sVar1 = PED::GET_PEDHEADSHOT_TXD_STRING(Global_21874[iLocal_23]);
						}
						else
						{
							sVar1 = "CHAR_DEFAULT";
...
void func_33()
{
	...
	if (Global_111560.f_14136[iLocal_23 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 165)
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iLocal_23 /*104*/]), &(Local_49[iVar0 /*6*/])))
			{
				if (iVar0 < 19)
				{
...
void func_39()
{
	if (Global_111560.f_14046[Global_19486 /*20*/].f_17 == 0)
	{
		...
		func_42(Global_19467, "DISPLAY_VIEW", 6f, SYSTEM::TO_FLOAT(iLocal_22), -1082130432, -1082130432, -1082130432);
		func_31(Global_19467, "SET_HEADER", "CELL_1", 0, 0, 0, 0);
		if (Global_19474)
		{
			if (iLocal_20 > 0)
	...
	while (iVar1 < 34)
	{
		...
		if (Global_111560.f_14136[iVar3 /*104*/].f_24 != 0)
		{
			if (Global_111560.f_14136[iVar3 /*104*/].f_99[Global_19486] == 1)
			{
				...
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_111560.f_14136[iVar3 /*104*/].f_18.f_2);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_111560.f_14136[iVar3 /*104*/].f_18.f_1);
				...
				if (Global_111560.f_14136[iVar3 /*104*/].f_17 == 145)
				{
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iVar3 /*104*/].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
				...
				switch (Global_111560.f_14136[iVar3 /*104*/].f_32)
				{
					...
					case 1:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_111560.f_14136[iVar3 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iVar3 /*104*/].f_33));
						if (Global_111560.f_14136[iVar3 /*104*/].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iVar3 /*104*/].f_67), "NULL"))
						{
							HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iVar3 /*104*/].f_67));
						}
						if ((Global_111560.f_14136[iVar3 /*104*/].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iVar3 /*104*/].f_67), "NULL")) && !MISC::ARE_STRINGS_EQUAL(&(Global_111560.f_14136[iVar3 /*104*/].f_83), "NULL"))
						{
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_111560.f_14136[iVar3 /*104*/].f_67)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_111560.f_14136[iVar3 /*104*/].f_67));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iVar3 /*104*/].f_67));
							}
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_111560.f_14136[iVar3 /*104*/].f_83)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_111560.f_14136[iVar3 /*104*/].f_83));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_111560.f_14136[iVar3 /*104*/].f_83));
							}
						}
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_111560.f_14136[iVar3 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_INTEGER(Global_111560.f_14136[iVar3 /*104*/].f_49);
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
