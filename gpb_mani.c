...
void func_105()
{
	...
	StringCopy(&Local_204, "PBMN", 8);
	StringCopy(&Local_205, "MANI", 16);
	StringCopy(&Local_202, "Special_Ped@mani", 64);
	StringCopy(&Local_203, "Base", 64);
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBMN_INTERACT";
	StringCopy(&Local_231, "PBMN_CONV_GM", 16);
	StringCopy(&Local_232, "PBMN_CONV_GT", 16);
	StringCopy(&Local_233, "PBMN_CONV_GF", 16);
	StringCopy(&cLocal_234, "special_ped@mani@base", 64);
	StringCopy(&cLocal_243, "special_ped@mani@intro", 64);
	iLocal_217 = 8;
	iLocal_221[0] = 6;
	iLocal_221[1] = 6;
	iLocal_221[2] = 6;
