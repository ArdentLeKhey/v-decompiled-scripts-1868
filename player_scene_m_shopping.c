	...
	if (!PED::IS_PED_INJURED(*iParam0))
	{
		...
		if (iLocal_290 >= 0)
		{
			if (FIRE::IS_ENTITY_ON_FIRE(*iParam0))
			{
				...
				{
					TASK::STOP_ANIM_PLAYBACK(*iParam0, 0, 0);
				}
		...
		{
			case 0:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96028) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
				{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_318, 2))
					{
						TASK::CLEAR_PED_TASKS(*iParam0);
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*iParam0, -16f, 1);
						PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*iParam0);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
					...
					else
					{
						...
						if (!ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_300, &cLocal_318, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
				...
				else if (iLocal_99 != 151)
				{
					...
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(*iParam0, &cLocal_327, vLocal_296 + vLocal_336, (fLocal_297 + fLocal_337), 0, 0, 1);
			...
			case 2:
				...
				else
				{
					...
					TASK::CLEAR_PED_TASKS(*iParam0);
					if (func_133(vLocal_298, 0f, 0f, 0f, 0))
					{
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
					{
						if (fLocal_299 == 0f)
						{
							fLocal_299 = (SYSTEM::VMAG(vLocal_298) * 0.75f);
						}
						TASK::TASK_WANDER_IN_AREA(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 1077936128, 1086324736);
						func_135(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_296 + vLocal_298, fLocal_299, 1))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 0);
						PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_339, 0);
						func_135(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar4, 0, &vVar5, 14))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vVar5) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar5, 1f, -1, 1048576000, 0, 1193033728);
							vVar6 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) - Vector(2f, 2f, 2f) };
							vVar7 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) + Vector(2f, 2f, 2f) };
							iLocal_339 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar6, vVar7, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*iParam0);
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_309, 2))
				{
				}
				else if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_318, 2))
				{
				}
				break;
...
Vector3 func_5(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_6(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
void func_7(int iParam0)
{
	...
	if (PED::IS_PED_INJURED(iParam0))
	{
		if (!iLocal_342 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					if (!func_123(iVar2) || func_115(iVar2) == 6)
					{
						...
						if (func_46(Global_94433, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_342 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_340 > 0)
		{
			if (iLocal_341 == 0)
			{
				if (iLocal_340 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_340 + 10000 < MISC::GET_GAME_TIMER())
			{
...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)
{
	...
	switch (iVar3)
	{
		...
		case 2:
			if (Global_93705[2] == 65 || Global_93705[2] == 66)
			{
				return 0;
			}
...
void func_44()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_39(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_41(iVar0) && (!func_28(14) || Global_110511))
			{
...
void func_52(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_54() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_54() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_60(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_54() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_67(int iParam0, int iParam1)
{
	...
	if (func_77(&Global_4269915))
	{
		if (func_75(&Global_4269915, iParam0))
		{
			return 0;
		}
...
void func_71(var uParam0)
{
	...
	func_73(uParam0, (Global_4269914 - 0.5f));
}
...
int func_91(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19665)
	{
		if (Global_19486.f_1 == 6)
		{
			...
			func_93(1);
			func_96(Global_19467, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19466), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_100()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_101(Global_111560.f_14136[iVar2 /*104*/].f_18, Global_111560.f_14136[Global_21872 /*104*/].f_18))
		{
			Global_21872 = iVar2;
		}
		iVar2++;
...
int func_116(int iParam0, int iParam1)
{
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_111560.f_7683.f_919[func_117()])
		{
			return 5;
		}
	}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_9(iParam3), 0);
}
...
int func_136()
{
	if (!func_138())
	{
		func_35(&uLocal_100, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		switch (func_38(Global_98390))
		{
			case 0:
				func_35(&uLocal_100, 1, Global_98390, func_137(0), 0, 1);
				break;
			
			case 1:
				func_35(&uLocal_100, 2, Global_98390, func_137(1), 0, 1);
				break;
			
			case 2:
				func_35(&uLocal_100, 3, Global_98390, func_137(2), 0, 1);
				break;
	...
	if (iLocal_293 != 0)
	{
		...
		{
			iLocal_292 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_296 + vLocal_294, 1f, iLocal_293, 1, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_292))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_292, vLocal_296 + vLocal_294, 1, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_292, Vector(fLocal_297, 0f, 0f) + vLocal_295, 2, 1);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_292, true);
			}
		}
	}
	return 0;
...
int func_139(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_140(Global_98390) && iParam1 != 0)
		{
			Global_98390 = 0;
		}
	}
...
void func_147()
{
	...
	if (iLocal_291 != 0)
	{
		VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_291, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_291 != 0)
		{
			if (!VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_291))
			{
				bVar1 = false;
			}
		}
	...
	func_148(&Global_98390, Global_93702);
	PED::SET_PED_CONFIG_FLAG(Global_98390, 132, true);
	PED::SET_PED_CONFIG_FLAG(Global_98390, 317, true);
}
...
void func_149()
{
	...
	iLocal_99 = Global_98072;
	func_165(iLocal_99, &vLocal_296, &fLocal_297, &cVar0);
	switch (iLocal_99)
	{
		case 98:
		...
		default:
			vLocal_298 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_299 = (SYSTEM::VMAG(vLocal_298) * 0.75f);
			break;
	}
	if ((iLocal_99 != 94 && iLocal_99 != 152) && iLocal_99 != 151)
	{
		...
		Var1.f_31 = 49;
		Var1.f_81 = 2;
		if (func_152(0, iLocal_99, &Var1, &uVar2, &uVar3, &uVar4, &uVar5))
		{
			iLocal_291 = Var1;
		}
	}
	...
	if (iLocal_290 == 0)
	{
		func_150(iLocal_99, &cLocal_300, &cLocal_309, &cLocal_318, &uVar6, &uVar7);
		iLocal_290 = 0;
	}
	else
	{
...
int func_154(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_155(Global_98073[iParam0 /*98*/], 0))
	{
		func_153(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[0];
			StringCopy(sParam2, func_171(Global_111560.f_2358.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[1];
			StringCopy(sParam2, func_171(Global_111560.f_2358.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[2];
			StringCopy(sParam2, func_171(Global_111560.f_2358.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_172()
{
	if (iLocal_291 != 0)
	{
		VEHICLE::REMOVE_VEHICLE_ASSET(iLocal_291);
	}
