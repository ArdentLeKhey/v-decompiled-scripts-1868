...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_233(Local_77.f_9, 0, 0, 0, 0, 0);
			...
			switch (iLocal_80)
			{
				case 0:
					if (func_223(1, 1093140480, 0))
					{
						...
						{
							OBJECT::ADD_DOOR_TO_SYSTEM(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, true, 0);
						}
						if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1736361794))
						{
...
int func_213(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
int func_216(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_217(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_223(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_230(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_230(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_233(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_235(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_236(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_247(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_249(iParam0, Global_41396);
}
...
int func_268(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_274())
	{
		...
		{
			iVar2 = func_269(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_270()
{
	...
	iVar0 = func_271(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_274()
{
	...
	{
		if (func_269(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
