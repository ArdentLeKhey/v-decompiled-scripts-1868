...
void __EntryFunction__()
{
	...
	if (!func_271(&iVar2, &Var0, vVar1, 1f))
	{
		func_270();
	...
	while (true)
	{
		...
		func_206(Var0);
		func_199(&iLocal_54, &(Var0.f_9), vVar1);
		if (iLocal_55 == 0)
		{
			if (Var0 == 22)
			{
		...
		if (Var0 == 21)
		{
			func_195(&Var0, vVar1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_190(&Var0, vVar1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_56 == 0)
			{
				if (func_195(&Var0, vVar1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_56 = 1;
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_198(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_189(iParam3), 0);
}
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_193(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_191(&uVar0, cParam2, sParam3, 7, 0, 0);
...
float func_194(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_191(&uVar0, cParam2, sParam3, 7, 0, 0);
...
bool func_221(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_222(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_222(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_227(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_226(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_234(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
{
	if ((func_243() && Global_98669.f_11 == 6) && iParam0 == func_166(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_249(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_249(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_254(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_198(uParam0->f_35[iVar1]))
				{
...
void func_258(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_259(iParam0);
...
int func_271(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_272((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_272((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_272(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_273(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_273(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
