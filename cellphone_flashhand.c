...
void __EntryFunction__()
{
	...
	if (Global_19468 == 0)
	{
		...
		if (Global_76577)
		{
			Global_19467 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("cellphone_ifruit");
			iLocal_41 = 1;
			if (iLocal_41 == 1)
			{
			}
		...
		{
			Global_19474 = 1;
			Global_19467 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("cellphone_prologue");
		}
		else
		{
			Global_19467 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2(&(Global_111560.f_14046[Global_19486 /*20*/]));
		}
		SYSTEM::SETTIMERA(0);
		...
		if ((MISC::IS_XBOX360_VERSION() || MISC::IS_DURANGO_VERSION()) || MISC::IS_PC_VERSION())
		{
			...
			func_102(Global_19467, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			HUD::GET_HUD_COLOUR(9, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_102(Global_19467, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			HUD::GET_HUD_COLOUR(6, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_102(Global_19467, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
		}
		else
		{
			HUD::GET_HUD_COLOUR(9, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
	...
	if (Global_76577)
	{
		...
		if (Global_4269892 == 0)
		{
			...
			if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var1) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4269895 == 0)
			{
					...
					if (((((((((((((((ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("VALKYRIE") || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("INSURGENT")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("TECHNICAL")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("TRASH")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("trash2")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("LIMO2")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("INSURGENT3")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("HALFTRACK")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("DUNE3")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("trailersmall2")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("TECHNICAL2")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("BOXVILLE5")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("MOGUL")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("BOMBUSHKA")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("TULA")) || ENTITY::GET_ENTITY_MODEL(iLocal_66) == joaat("chernobog"))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_66))
						{
							...
							if (iVar6 != -2)
							{
								...
								if (VEHICLE::IS_TURRET_SEAT(iLocal_66, iVar6))
								{
									MISC::SET_BIT(&Global_7357, 4);
								}
							}
...
void func_18()
{
	if (MISC::IS_BIT_SET(Global_7357, 10) || iLocal_72 == 1)
	{
...
void func_82()
{
	...
	func_102(Global_19467, "SET_PROVIDER_ICON", SYSTEM::TO_FLOAT(iLocal_42), SYSTEM::TO_FLOAT(iLocal_43), -1082130432, -1082130432, -1082130432);
}
...
int func_83()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_88(iVar0))
		{
			...
			{
				if (MISC::IS_BIT_SET(Global_111560.f_7683[iVar2 /*15*/].f_2, iVar0))
				{
			...
			{
				if (MISC::IS_BIT_SET(Global_111560.f_7683.f_651[iVar2 /*14*/].f_2, iVar0))
				{
			...
			{
				if (MISC::IS_BIT_SET(Global_111560.f_7683.f_765[iVar2 /*10*/].f_2, iVar0))
				{
...
int func_86(vector3 vParam0, int iParam1)
{
	if (iParam1 != -1)
	{
		...
		if (SYSTEM::VDIST2(vParam0, Global_41397[iParam1 /*5*/]) <= (Global_41397[iParam1 /*5*/].f_3 * Global_41397[iParam1 /*5*/].f_3))
		{
			return 1;
		}
...
int func_97(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_98(iParam1)];
...
void func_100()
{
	...
	if (iLocal_45 != Global_7359)
	{
		...
		func_73(Global_19467, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(iLocal_45), -1f, -1f, -1f, &Local_47, 0, 0, 0, 0);
		if (Global_19429 == 0)
		{
			func_82();
		}
