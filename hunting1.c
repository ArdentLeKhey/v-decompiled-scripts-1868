...
void __EntryFunction__()
{
	...
	iLocal_333 = -1;
	iLocal_335 = -1;
	iLocal_340 = joaat("prop_satdish_l_02b");
	...
	if (func_528())
	{
		Global_76822 = 1;
		iLocal_77 = 0;
		while (!func_517(&Local_88))
		{
			SYSTEM::WAIT(0);
		}
		func_516(&Local_88, 0, 1);
		Global_76822 = 0;
	}
	...
	func_515(25);
	func_514();
	func_513(&uLocal_89, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_513(&uLocal_89, 3, iLocal_348, "CLETUS", 0, 1);
	while (true)
	{
		RECORDING::_0x208784099002BC30("SF_TP", 0);
		func_496(Local_88.f_9, 0, 0, 0, 0, 0);
...
void func_10(int iParam0, bool bParam1)
{
	...
	{
		func_178(&(Global_110647[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_14()
{
	...
	{
		func_16(13, SYSTEM::FLOOR(Global_111560.f_10189.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76389[1 /*14*/] = { func_90(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_90(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_155(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_64, Global_111560.f_2358.f_539[iVar0 /*65*/].f_63))
		{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76389[1 /*14*/] = { func_90(iVar10, iParam1, iParam2, -1) };
		if (!func_80(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76389[1 /*14*/] = { func_90(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_90(iVar10, 14, uVar12[iVar1], -1) };
							func_58(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
							func_73(14);
							if (Global_76387 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_76387 == 1)
						{
			...
			{
				Global_76389[1 /*14*/] = { func_90(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_90(iVar10, 14, uVar15[iVar1], -1) };
			func_58(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_73(14);
			if (Global_76387 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
{
	Global_76389[1 /*14*/] = { func_90(iParam0, iParam1, iParam2, -1) };
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_73(int iParam0)
{
	...
	{
		func_79(iParam0, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 2, Global_76389[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_76(iParam2)];
	if (iVar0 != 0)
	{
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_155(iParam0, Global_111560.f_2358.f_539[iVar0 /*65*/].f_61, Global_111560.f_2358.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_89(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[0], Global_111560.f_2358.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_89(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[1], Global_111560.f_2358.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_89(&Var1, -99, -99, Global_111560.f_2358.f_539.f_196[2], Global_111560.f_2358.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_77(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_155(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_155(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76389[2 /*14*/] = { func_90(iVar0, 14, iVar4, -1) };
									if (Global_76389[2 /*14*/].f_12 == iVar3)
									{
										if (func_155(iParam0, 14, iVar4))
										{
											if (!func_46(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76389[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76389[2 /*14*/] = { func_90(iVar0, iVar2, iVar1, -1) };
						if (!func_46(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76389[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76389[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_76389[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	{
		if (func_157(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_156(PLAYER::PLAYER_PED_ID());
			if (func_159(iVar0) && (!func_98(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_159(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_164(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_98706, 0);
		func_168(&sVar1, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}
...
void func_170(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_173()
{
	...
	{
		func_162();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_174(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		...
		if (Var0.f_5 != 4)
		{
			...
			while (iVar3 < 63)
			{
				...
				if (iVar5 != iParam0)
				{
					...
					{
						if (!MISC::IS_BIT_SET(Global_111560.f_18569[iVar5 /*6*/], 3))
						{
							bVar2 = false;
						}
						if (!MISC::IS_BIT_SET(Global_111560.f_18569[iVar5 /*6*/], 0))
						{
							func_184(iVar5);
						}
					}
...
{
	func_183(iParam0, 1);
	Global_111560.f_18569[iParam0 /*6*/].f_3 = func_182();
...
void func_224()
{
	if (iLocal_274)
	{
		...
		WEAPON::SET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"), iLocal_337);
	}
	else
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (func_308(PLAYER::PLAYER_PED_ID()))
				{
					...
					if (!func_212())
					{
						func_229(PLAYER::PLAYER_PED_ID(), vLocal_415, fLocal_416, 0, 1);
					}
					if (func_308(iLocal_348))
					{
...
void func_226(bool bParam0)
{
	if (func_308(iLocal_348))
	{
		if (bParam0)
		{
			...
			{
				if (!PED::IS_PED_GROUP_MEMBER(iLocal_348, func_227()))
				{
					TASK::CLEAR_PED_TASKS(iLocal_348);
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_348, func_227());
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_348, 1);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_348, false);
				}
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(iLocal_348, func_227()))
		{
			TASK::CLEAR_PED_TASKS(iLocal_348);
			PED::REMOVE_PED_FROM_GROUP(iLocal_348);
		}
	}
}
...
int func_229(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_231(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_209(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_111560.f_18569[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_164(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_98706, iParam0);
			}
			else
			{
				iVar6 = func_302(&(Global_98669.f_3));
				if (iVar6 > -1)
				{
...
{
	func_233(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_249(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_250(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_252(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_76(iParam1)];
...
void func_256(int iParam0, bool bParam1)
{
	...
	if (func_159(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_257(iParam0, &(Global_111560.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_257(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_262(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_259(Var7.f_1)) && iVar9 < 51)
			{
...
int func_265(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
bool func_267(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_273(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_289(iVar0))
		{
			if (!bParam3 || func_288(iVar0))
			{
...
Vector3 func_274(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_285(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_284())
			{
				if (func_283(Global_1590285))
				{
					return func_276(2, 2);
				}
				else if (func_275(Global_1590285))
				{
...
int func_277(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_282(iParam1, &vVar1))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var2 = { func_280(iParam0) };
	}
	else
	{
		Var2 = { func_279(iParam0) };
	}
	vVar3 = { Var2 - Var0 };
	vVar3 = { func_278(vVar3, -Var0.f_3.f_2) };
	vVar3 = { func_278(vVar3, vVar1.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar1, 0f, vVar3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_278(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_303(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_304(Global_111560.f_9080.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_304(Global_111560.f_9080.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_304(Global_111560.f_9080.f_99.f_205[11]);
			break;
		
		case 90:
			return func_304(Global_111560.f_9080.f_99.f_205[7]);
			break;
		
		case 93:
			return func_304(Global_111560.f_9080.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_310()
{
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0))
			{
				func_321();
				if (iLocal_301[17])
				{
...
void func_311()
{
	...
	while (iVar3 < 4)
	{
		if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(iVar2[iVar3], vVar0[iVar3 /*3*/], 1))
		{
			iLocal_425[iVar3] = VEHICLE::CREATE_VEHICLE(iVar2[iVar3], vVar0[iVar3 /*3*/], fVar1[iVar3], true, true, false);
		}
		iVar3++;
	}
	if (((func_230(iLocal_425[0]) && func_230(iLocal_425[1])) && func_230(iLocal_425[2])) && func_230(iLocal_425[3]))
	{
		func_312();
	}
}
...
void func_314(bool bParam0, bool bParam1)
{
	...
	{
		iLocal_263 = func_315(iLocal_348, 1, 1, 5);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_263))
	{
		if (!bParam0)
		{
			HUD::SET_BLIP_SCALE(iLocal_263, 0.75f);
		}
		HUD::SET_BLIP_FLASHES(iLocal_263, bParam1);
	}
}
...
void func_322()
{
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			...
			{
				if (!func_308(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						iLocal_277 = 0;
						func_348(iVar0, iVar1);
						vLocal_421[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true) };
						iLocal_303[iVar0] = 1;
						Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_260[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!ENTITY::IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_260[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_329 = 1;
							}
							else if (!ENTITY::IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
					...
					while (iLocal_330 < 3)
					{
						if (func_230(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
							Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14 = { ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, true) };
							Local_260[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_260[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_330 < 3)
					{
						if ((ENTITY::DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0)) && !PED::IS_PED_INJURED(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						...
						{
							if (ENTITY::DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0))
							{
								TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, vLocal_421[iVar0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			PED::SET_PED_INCREASED_AVOIDANCE_RADIUS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 8000));
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (MISC::GET_GAME_TIMER() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
					}
					else if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
					{
						TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), false, false, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							TASK::CLEAR_PED_TASKS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
							TASK::TASK_WANDER_IN_AREA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					TASK::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					TASK::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				PED::SET_PED_KEEP_TASK(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					if (func_325(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 1) >= 45f)
					{
						TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
						Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3 = 10;
					}
				}
				else if (func_325(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >= 45f)
				{
					if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
					{
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (func_325(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 0) < 2f)
				{
					TASK::CLEAR_PED_TASKS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		...
		case 8:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
					if (func_324(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
					{
						iLocal_338++;
						iLocal_277 = 0;
					}
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
void func_327(int iParam0)
{
	...
	if (func_344())
	{
		...
		{
			func_341(767);
			if (func_328(&uLocal_89, cLocal_353, "HUNT1_KILL", "HUNT1_KILL_1", 7, 0, 0))
			{
				iLocal_267 = 1;
			}
		}
...
{
	return Global_53722.f_37[iParam0];
}

int func_343()
{
	return Global_53722.f_36;
}

bool func_344()
{
	return Global_53722.f_36 > 0;
}

void func_345(int iParam0, int iParam1)
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0) && ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3)
	{
		if (!HUD::DOES_BLIP_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/] = func_315(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (HUD::DOES_BLIP_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
			{
				HUD::SET_BLIP_SCALE(Local_260[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
			}
		}
	}
	else
...
void func_346(int iParam0, int iParam1)
{
	...
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		if (iParam1 == 1)
		{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = PED::CREATE_PED(26, iLocal_341, vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, true);
		if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			ENTITY::SET_ENTITY_HEALTH(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = PED::CREATE_PED(26, iLocal_341, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, true);
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				ENTITY::SET_ENTITY_HEALTH(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
...
void func_348(int iParam0, int iParam1)
{
	if (func_349())
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_BARK_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, false, 0);
	}
	else
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_CRY_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, false, 0);
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_377, fLocal_378, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (HUD::DOES_BLIP_EXIST(Local_258[iVar0 /*10*/].f_9))
		{
			HUD::REMOVE_BLIP(&(Local_258[iVar0 /*10*/].f_9));
		}
		func_357(&(Local_258[iVar0 /*10*/]));
		iVar0++;
	}
	if (iLocal_271)
	{
...
void func_359()
{
	...
	while (!STREAMING::HAS_MODEL_LOADED(iLocal_343) || !STREAMING::HAS_MODEL_LOADED(iLocal_344))
	{
		SYSTEM::WAIT(0);
	}
}
...
void func_360()
{
	...
	else
	{
		...
		while (iVar0 < 2)
		{
			...
			while (iVar1 < 3)
			{
				func_362(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6);
				iVar1++;
			}
			iVar0++;
		}
...
int func_361()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_348) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), vLocal_367, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_363()
{
	...
	func_364();
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || iLocal_301[16])
	{
		func_358();
		func_351();
		iLocal_254 = 15;
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_378(iVar0);
			if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28))
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					if (!bLocal_289)
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
						{
							bLocal_289 = true;
							func_318(6);
						}
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_259[iVar0 /*29*/].f_7 = MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
				if ((!VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_319 < 3) && ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, 1))
				{
					Local_259[iVar0 /*29*/].f_28 = VEHICLE::CREATE_VEHICLE(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, Local_259[iVar0 /*29*/].f_4, true, true, false);
					if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_259[iVar0 /*29*/].f_28, 0))
					{
						ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_259[iVar0 /*29*/].f_28, true);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, true);
						Local_259[iVar0 /*29*/].f_7 = MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
						Local_259[iVar0 /*29*/].f_12 = PED::CREATE_PED_INSIDE_VEHICLE(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, true);
						if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12))
						{
							Local_259[iVar0 /*29*/].f_11 = OBJECT::CREATE_OBJECT(iLocal_345, Local_259[iVar0 /*29*/].f_16, true, true, false);
							if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_11))
							{
								ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, PED::GET_PED_BONE_INDEX(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								ENTITY::SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, false, 0);
								ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_259[iVar0 /*29*/].f_12, true, 1);
								ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_259[iVar0 /*29*/].f_12, true);
								...
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_319++;
			...
			case 4:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
						if (!func_376(Local_259[iVar0 /*29*/].f_12, -1817882002))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
						}
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
						{
							if (func_324(Local_259[iVar0 /*29*/].f_28))
							{
								if (func_375(iVar0))
								{
									if (!Local_259[iVar0 /*29*/].f_1)
									{
										...
										func_374(iVar0);
										ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_259[iVar0 /*29*/].f_28);
						...
						{
							if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, true), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
					...
					else
					{
						...
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, false);
						TASK::TASK_VEHICLE_DRIVE_WANDER(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
						PED::SET_PED_KEEP_TASK(Local_259[iVar0 /*29*/].f_12, true);
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				...
				{
					TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
					vVar1 = { func_368(Local_259[iVar0 /*29*/].f_28) };
					if (!func_267(vVar1, 0f, 0f, 0f, 0))
					{
						TASK::TASK_VEHICLE_PARK(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, vVar1, ENTITY::GET_ENTITY_HEADING(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						TASK::TASK_VEHICLE_TEMP_ACTION(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						TASK::TASK_VEHICLE_TEMP_ACTION(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_259[iVar0 /*29*/].f_28) && func_308(Local_259[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(Local_259[iVar0 /*29*/].f_28))
					{
						TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
							TASK::TASK_LEAVE_VEHICLE(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 7:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					vVar2 = { ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, true) };
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(vVar2, 3f, 1))
						{
							Local_259[iVar0 /*29*/].f_25 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_22) };
			...
			case 9:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, false, false, 1))
						{
							TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						Local_259[iVar0 /*29*/].f_15 = TASK::GET_SCRIPT_TASK_STATUS(Local_259[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						TASK::OPEN_SEQUENCE_TASK(&(Local_259[iVar0 /*29*/].f_14));
						...
						TASK::CLOSE_SEQUENCE_TASK(Local_259[iVar0 /*29*/].f_14);
						TASK::TASK_PERFORM_SEQUENCE(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_14);
						TASK::CLEAR_SEQUENCE_TASK(&(Local_259[iVar0 /*29*/].f_14));
						Local_259[iVar0 /*29*/].f_8 = MISC::GET_GAME_TIMER() + 20000;
			...
			case 12:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						if (MISC::GET_GAME_TIMER() > Local_259[iVar0 /*29*/].f_8)
						{
							if (ENTITY::IS_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11))
							{
								ENTITY::SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, false, 0);
							}
							else
						...
						else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !ENTITY::IS_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11))
						{
							ENTITY::SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, true, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, false), ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, true), false) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12))
				{
					if (!ENTITY::IS_ENTITY_DEAD(Local_259[iVar0 /*29*/].f_12, 0))
					{
						PED::SET_PED_KEEP_TASK(Local_259[iVar0 /*29*/].f_12, true);
					}
					func_366(&(Local_259[iVar0 /*29*/].f_12), 1, 0, 1);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28))
				{
					func_365(&(Local_259[iVar0 /*29*/].f_28));
				}
				Local_259[iVar0 /*29*/].f_13 = 1;
				break;
		}
		if (func_377(Local_259[iVar0 /*29*/].f_28) && func_308(Local_259[iVar0 /*29*/].f_12))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_376, ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, true), true) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			TASK::CLEAR_PED_TASKS(iVar0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar0, true);
			TASK::OPEN_SEQUENCE_TASK(&(Local_259[iParam0 /*29*/].f_14));
			TASK::TASK_ENTER_VEHICLE(0, Local_259[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_259[iParam0 /*29*/].f_28, 60f, 786468);
			TASK::CLOSE_SEQUENCE_TASK(Local_259[iParam0 /*29*/].f_14);
			TASK::TASK_PERFORM_SEQUENCE(iVar0, Local_259[iParam0 /*29*/].f_14);
			PED::SET_PED_KEEP_TASK(iVar0, true);
			TASK::CLEAR_SEQUENCE_TASK(&(Local_259[iParam0 /*29*/].f_14));
		}
...
Vector3 func_368(int iParam0)
{
	...
	if (func_377(iParam0))
	{
		...
		if (PATHFIND::GET_CLOSEST_VEHICLE_NODE(vVar0, &vVar1, 1, 1077936128, 0))
		{
			if (PATHFIND::_GET_POINT_ON_ROAD_SIDE(vVar1, 0, &vVar1))
			{
				if (!VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(vVar1, 2f) && !OBJECT::IS_ANY_OBJECT_NEAR_POINT(vVar1, 2f, 0))
				{
					return vVar1;
				}
			}
...
{
	if (func_308(Local_259[iParam0 /*29*/].f_12))
	{
		TASK::CLEAR_PED_TASKS(Local_259[iParam0 /*29*/].f_12);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iParam0 /*29*/].f_12, true);
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, 0))
			{
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, Local_259[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_259[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				TASK::TASK_SMART_FLEE_COORD(Local_259[iParam0 /*29*/].f_12, vLocal_358, 10000f, -1, 0, 0);
				Local_259[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_259[iParam0 /*29*/].f_2 = 1;
		PED::SET_PED_KEEP_TASK(Local_259[iParam0 /*29*/].f_12, true);
	}
	else
	{
...
void func_370()
{
	...
	else if (MISC::GET_GAME_TIMER() > iLocal_318)
	{
		...
		{
			if (func_371(&uLocal_89, cLocal_353, "HUNT1_CARH", 7, 0, 0, 0))
			{
				iLocal_278 = 0;
			}
		}
...
int func_372()
{
	...
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_308(iLocal_348))
		{
			vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_348, true) };
			if (func_373(PLAYER::PLAYER_PED_ID(), iLocal_348, 0) <= 10f && MISC::ABSF((vVar0.z - vVar1.z)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_28, 0))
	{
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_259[iParam0 /*29*/].f_28, false);
	}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_259[iParam0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_28, 0))
	{
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_259[iParam0 /*29*/].f_12))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_12, 0) || !ENTITY::IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_12, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iParam0 /*29*/].f_12, PLAYER::PLAYER_PED_ID(), 1))
			{
				func_369(iParam0);
			}
		}
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					...
					if (iLocal_301[14])
					{
						fVar0 = (300f / SYSTEM::TO_FLOAT(iLocal_336));
...
void func_381()
{
	if (bLocal_292)
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[0 /*29*/].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[1 /*29*/].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[2 /*29*/].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[3 /*29*/].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[4 /*29*/].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[0 /*29*/].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[1 /*29*/].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[2 /*29*/].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[3 /*29*/].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_259[4 /*29*/].f_10);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_255 = 13;
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_376, 50f, 0, 0, 0, 0, false, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_374, 50f, 0, 0, 0, 0, false, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_375, 50f, 0, 0, 0, 0, false, 0);
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_358, fLocal_305, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
{
	func_387();
	STREAMING::REQUEST_MODEL(Local_259[0 /*29*/].f_9);
	STREAMING::REQUEST_MODEL(Local_259[1 /*29*/].f_9);
	STREAMING::REQUEST_MODEL(Local_259[2 /*29*/].f_9);
	STREAMING::REQUEST_MODEL(Local_259[3 /*29*/].f_9);
	STREAMING::REQUEST_MODEL(Local_259[4 /*29*/].f_9);
	STREAMING::REQUEST_MODEL(Local_259[0 /*29*/].f_10);
	STREAMING::REQUEST_MODEL(Local_259[1 /*29*/].f_10);
	STREAMING::REQUEST_MODEL(Local_259[2 /*29*/].f_10);
	STREAMING::REQUEST_MODEL(Local_259[3 /*29*/].f_10);
	STREAMING::REQUEST_MODEL(Local_259[4 /*29*/].f_10);
	STREAMING::REQUEST_MODEL(iLocal_345);
	while ((((((((((!STREAMING::HAS_MODEL_LOADED(Local_259[0 /*29*/].f_9) || !STREAMING::HAS_MODEL_LOADED(Local_259[1 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_259[2 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_259[3 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_259[4 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_259[0 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_259[1 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_259[2 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_259[3 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_259[4 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(iLocal_345))
	{
		SYSTEM::WAIT(0);
	}
	bLocal_292 = true;
...
void func_387()
{
	Local_259[0 /*29*/] = { func_388(joaat("HABANERO"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), vLocal_374) };
	Local_259[1 /*29*/] = { func_388(joaat("DUBSTA"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), vLocal_375) };
	Local_259[2 /*29*/] = { func_388(joaat("PATRIOT"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), vLocal_375) };
	Local_259[3 /*29*/] = { func_388(joaat("REBEL"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), vLocal_374) };
	Local_259[4 /*29*/] = { func_388(joaat("SADLER"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), vLocal_375) };
}

struct<29> func_388(int iParam0, vector3 vParam1, float fParam2, int iParam3, vector3 vParam4)
{
	struct<29> Var0;
...
void func_389()
{
	...
	if (!bLocal_289)
	{
		...
		else
		{
			...
			while (iVar0 < 5)
			{
				func_362(Local_259[iVar0 /*29*/].f_28);
				iVar0++;
			}
			func_390();
			if (bLocal_283)
...
int func_392(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_393()
{
	...
	if (!iLocal_293)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_357, 50f, 50f, 50f, false, true, 0))
		{
			func_395();
			iLocal_293 = 1;
		}
	...
	if (!bLocal_283)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_357, 5f, 5f, 5f, false, true, 0) && func_394(1077936128, 1))
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_374, vLocal_375, false, 1);
			func_8(&iLocal_262);
			func_385();
			func_2();
			func_351();
...
void func_395()
{
	PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_401, vLocal_402, 0, 1, 1, 1);
	PED::SET_PED_NON_CREATION_AREA(vLocal_401, vLocal_402);
	MISC::CLEAR_AREA_OF_PEDS(vLocal_412, 5f, 0);
}
...
void func_396()
{
	...
	if (iLocal_301[3])
	{
		if (!func_223() || MISC::GET_PROFILE_SETTING(203) == 0)
		{
			...
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_426, 1);
			}
			if (iLocal_336 <= 3)
			{
				func_382(769, 3, 1);
...
void func_397()
{
	...
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_359, fLocal_315);
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_360, fLocal_315);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 1, true, 0))
	{
		if (iLocal_301[1])
		{
			iLocal_290 = 0;
...
void func_399()
{
	...
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_359, fLocal_315);
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_360, fLocal_315);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 0, true, 0))
	{
		func_321();
		func_404();
		func_383();
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && (ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0) || iLocal_338 >= 3))
		{
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0))
					{
						func_226(1);
					}
					iLocal_254 = 8;
...
void func_400()
{
	...
	while (iVar0 < 3)
	{
		if (!HUD::DOES_BLIP_EXIST(Local_258[iVar0 /*10*/].f_9))
		{
			if (func_230(Local_258[iVar0 /*10*/]))
			{
				if (!Local_258[iVar0 /*10*/].f_7)
				{
					Local_258[iVar0 /*10*/].f_9 = func_401(Local_258[iVar0 /*10*/]);
					HUD::SET_BLIP_COLOUR(Local_258[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
...
void func_404()
{
	...
	while (iVar0 < 3)
	{
		...
		if (Local_258[iVar0 /*10*/].f_7 == 1)
		{
			...
			{
				if (func_324(Local_258[iVar0 /*10*/]))
				{
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_258[iVar0 /*10*/]);
					iLocal_338++;
				}
				else
				{
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*10*/]) && !Local_258[iParam0 /*10*/].f_7)
	{
		Local_258[iParam0 /*10*/].f_5 = ENTITY::GET_ENTITY_HEALTH(Local_258[iParam0 /*10*/]);
		if (Local_258[iParam0 /*10*/].f_5 < 100)
		{
			...
			OBJECT::_0xE7E4C198B0185900(Local_258[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_228(1);
...
void func_407()
{
	MISC::CLEAR_AREA_OF_PEDS(vLocal_403, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_404, vLocal_405);
	MISC::CLEAR_AREA_OF_PEDS(vLocal_406, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_407, vLocal_408);
	MISC::CLEAR_AREA_OF_PEDS(vLocal_409, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_410, vLocal_411);
}
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			MISC::CLEAR_AREA_OF_OBJECTS(Local_258[iVar0 /*10*/].f_1, 2f, 0);
			Local_258[iVar0 /*10*/] = OBJECT::CREATE_OBJECT(iLocal_340, Local_258[iVar0 /*10*/].f_1, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(Local_258[iVar0 /*10*/]))
			{
				ENTITY::SET_ENTITY_HEADING(Local_258[iVar0 /*10*/], Local_258[iVar0 /*10*/].f_4);
				OBJECT::SET_OBJECT_TARGETTABLE(Local_258[iVar0 /*10*/], 0);
				ENTITY::SET_ENTITY_HEALTH(Local_258[iVar0 /*10*/], 100, 0);
				ENTITY::SET_ENTITY_DYNAMIC(Local_258[iVar0 /*10*/], 1);
				Local_258[iVar0 /*10*/].f_7 = 0;
				Local_258[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((ENTITY::DOES_ENTITY_EXIST(Local_258[0 /*10*/]) && ENTITY::DOES_ENTITY_EXIST(Local_258[1 /*10*/])) && ENTITY::DOES_ENTITY_EXIST(Local_258[2 /*10*/])) && func_409())
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_340);
			iLocal_271 = 0;
			return 1;
...
int func_409()
{
	iLocal_335 = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	if (ENTITY::DOES_ENTITY_EXIST(Local_258[iLocal_335 /*10*/]))
	{
...
void func_410()
{
	...
	while (!STREAMING::HAS_MODEL_LOADED(iLocal_340))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_271 = 1;
...
void func_411()
{
	...
	else
	{
		...
		if (HUD::DOES_BLIP_EXIST(iLocal_263))
		{
			if (!HUD::IS_BLIP_FLASHING(iLocal_263))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), vLocal_384, 0, 1, 0))
				{
					func_2();
					func_314(1, 0);
					func_319("HT_BKHTER");
			...
			else
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), vLocal_385, 0, 1, 0))
				{
					func_314(1, 0);
					if (func_398("HT_BKHTER", 0, 0))
					{
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_380, fLocal_381, 0, 1);
					func_352();
				}
				func_228(1);
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_379, 2f, 0, 0, 0, 0, false, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
			...
			switch (iLocal_320)
			{
				case 0:
					if (func_440(1, 1093140480, 0))
					{
						...
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_354, 0, 0, 0);
						}
						if (func_230(iLocal_348))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_348, sLocal_355, 0, 0, 0);
							CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_355, PLAYER::PLAYER_PED_ID(), 0);
							iLocal_347 = func_436(iLocal_348, joaat("WEAPON_SNIPERRIFLE"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_347))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_347, "Daves_Rifle", 0, 0, 0);
						}
						func_435();
						...
						func_428(vLocal_386, vLocal_387, 5f, vLocal_394, fLocal_314, 1, 1, 1, 0, 0);
						func_428(vLocal_388, vLocal_389, 5f, vLocal_394, fLocal_314, 1, 1, 1, 0, 0);
						func_428(vLocal_390, vLocal_391, 5f, vLocal_394, fLocal_314, 1, 1, 1, 0, 0);
						func_428(vLocal_392, vLocal_393, 5f, vLocal_394, fLocal_314, 1, 1, 1, 0, 0);
						if (func_230(iLocal_426))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(iLocal_426, 76.1155f);
						}
						func_424(vLocal_379, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
						iLocal_320++;
					}
					break;
				
				case 1:
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_355, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_276)
						{
							func_229(iLocal_348, vLocal_373, fLocal_312, 0, 1);
							iLocal_255 = 2;
							bLocal_276 = true;
						}
					}
					...
					{
						WEAPON::GIVE_WEAPON_OBJECT_TO_PED(iLocal_347, PLAYER::PLAYER_PED_ID());
					}
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				if (func_408())
				{
					if (func_308(iLocal_348))
					{
						...
						{
							func_229(iLocal_348, vLocal_373, fLocal_312, 0, 1);
							WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("WEAPON_SNIPERRIFLE"));
							TASK::CLEAR_PED_TASKS(iLocal_348);
							iLocal_255 = 2;
						}
					}
...
void func_416(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_422(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_424(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_428(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_429(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_429(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_431(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_431(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_433(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_432(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_432(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_432(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_432(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_432(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_432(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_432(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_432(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_432(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_432(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_432(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_432(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_432(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_432(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_432(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_432(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_432(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				if (func_439(func_260(iVar2, iVar6)))
				{
					iVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_260(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_260(iVar2, iVar6));
				func_437(iVar1, func_260(iVar2, iVar6));
			}
		}
		iVar6++;
	}
...
int func_440(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_443(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_443(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_446()
{
	if (!CAM::IS_GAMEPLAY_HINT_ACTIVE() && func_373(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) > 3f)
	{
		iLocal_325 = MISC::GET_GAME_TIMER() + 2000;
		if (func_308(iLocal_348))
		{
			if (func_308(PLAYER::PLAYER_PED_ID()))
			{
			}
			CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_348, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			CAM::SET_GAMEPLAY_HINT_FOV(fLocal_306);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fLocal_307);
			CAM::_SET_GAMEPLAY_HINT_ANGLE(fLocal_308);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(fLocal_309);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETY(fLocal_310);
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(1);
		}
	}
	else if (func_308(iLocal_348) && func_308(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_325 || func_373(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) <= 3f)
		{
			if (func_373(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) <= 3f)
			{
			}
			iLocal_320 = 0;
			iLocal_257 = 0;
...
void func_447()
{
	...
	if (func_308(iLocal_348))
	{
		ENTITY::SET_ENTITY_LOD_DIST(iLocal_348, 200);
		TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_348, 0);
		PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_348, 0);
		PED::SET_PED_CONFIG_FLAG(iLocal_348, 169, true);
		PED::SET_PED_CONFIG_FLAG(iLocal_348, 206, true);
		PED::SET_PED_CONFIG_FLAG(iLocal_348, 32, false);
		PED::SET_PED_DIES_IN_WATER(iLocal_348, 0);
		PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_348);
		PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(iLocal_348, 1);
		PED::SET_PED_CAN_BE_DRAGGED_OUT(iLocal_348, 0);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, true);
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(iLocal_348, 1);
		PED::SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(iLocal_348, 1);
	}
	iLocal_257 = 0;
	if (func_528())
	{
		...
		{
			case 0:
				func_448(vLocal_380, fLocal_381, 1, 0);
				iLocal_254 = 3;
				break;
			
			case 1:
				func_448(vLocal_356, fLocal_304, 1, 0);
				iLocal_254 = 5;
				break;
			
			case 2:
				func_448(vLocal_358, fLocal_305, 1, 0);
				iLocal_254 = 12;
				break;
			
			case 3:
				func_448(vLocal_377, fLocal_378, 1, 0);
				iLocal_254 = 16;
				break;
			
			case 4:
				func_448(vLocal_415, fLocal_416, 1, 0);
				iLocal_254 = 20;
				break;
...
void func_448(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_528())
	{
...
void func_450()
{
	...
	{
		iLocal_274 = 1;
		iLocal_337 = WEAPON::GET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"));
	}
}
...
void func_456()
{
	if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
	{
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_397, vLocal_398, 16f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_399, vLocal_400, 19f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_401, vLocal_402, 19f, 0, true, 0))
		{
	...
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 3:
				...
				ENTITY::SET_ENTITY_COORDS(iLocal_348, vLocal_373, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(iLocal_348, fLocal_312);
				iLocal_255 = 2;
				break;
			...
			case 2:
				if (func_308(iLocal_348))
				{
					...
					{
						bLocal_276 = true;
						iLocal_334 = MISC::GET_GAME_TIMER() + 5000;
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("WEAPON_SNIPERRIFLE"));
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0))
					{
						TASK::CLEAR_PED_TASKS(iLocal_348);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 1);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_348, true);
						iLocal_255 = 6;
					}
				}
				else if (!iLocal_301[0])
				{
					...
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_1", 7, 0, 0, 0))
						{
							iLocal_301[0] = 1;
						}
					}
				...
				{
					func_487(&uLocal_436, &uLocal_89, cLocal_353, &sLocal_437, &cLocal_443);
				}
				break;
			
			case 5:
				if (!PED::IS_PED_INJURED(iLocal_348))
				{
					if (WEAPON::HAS_PED_GOT_WEAPON(iLocal_348, joaat("WEAPON_SNIPERRIFLE"), 0))
					{
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("WEAPON_SNIPERRIFLE"));
					}
					if (func_488())
					{
						...
						{
							ENTITY::SET_ENTITY_VISIBLE(iLocal_346, false, 0);
						}
						func_354();
						func_353();
						func_8(&iLocal_263);
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						ENTITY::SET_ENTITY_COORDS(iLocal_348, vLocal_368, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(iLocal_348, fLocal_304);
						iLocal_288 = 0;
						iLocal_255 = 6;
					}
				}
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 0, true, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_DIARR", 7, 0, 0, 0))
						{
			...
			case 7:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 0, true, 0))
				{
					...
					if (func_485())
					{
						func_380();
						func_404();
						if (iLocal_290 && !func_398("HT_SHDISH", 0, 0))
						{
							func_480(0);
						}
						if (iLocal_338 == 1 && func_479())
						{
							if (!iLocal_299[0])
							{
								if (func_398("HT_SHDISH", 0, 0))
								{
									if (func_328(&uLocal_89, cLocal_353, "HUNT1_DISH", "HUNT1_DISH_1", 7, 1, 0))
									{
										iLocal_269 = 0;
										func_490(0);
										iLocal_299[0] = 1;
								...
								else if (func_328(&uLocal_89, cLocal_353, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0))
								{
									iLocal_269 = 0;
									func_490(0);
									iLocal_299[0] = 1;
						...
						else if (iLocal_338 == 2 && func_479())
						{
							if (!iLocal_299[1])
							{
								if (func_328(&uLocal_89, cLocal_353, "HUNT1_DISH", "HUNT1_DISH_2", 7, 0, 0))
								{
									iLocal_269 = 0;
									func_490(0);
									iLocal_299[1] = 1;
						...
						else if (iLocal_338 == 3)
						{
							...
							{
								func_316();
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_1A", 7, 0, 0, 0))
								{
									RECORDING::_0x293220DA1B46CEBC(2f, 5f, 4);
									iLocal_269 = 0;
									iLocal_299[2] = 1;
				...
				{
					if (func_371(&uLocal_89, cLocal_353, "HUNT1_LAREA", 7, 1, 0, 0))
					{
						iLocal_301[2] = 1;
					}
				}
			...
			case 11:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), vLocal_385, 0, 1, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_ENCAR", 7, 0, 0, 0))
							{
								func_8(&iLocal_263);
								func_226(1);
			...
			case 12:
				if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_333 == -1)
					{
						iLocal_333 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(vLocal_395, vLocal_396, 0f, 0, 7);
					}
					func_380();
					iLocal_301[9] = 1;
					func_226(0);
					...
					iLocal_328 = 0;
					TASK::TASK_LOOK_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_369, 1f, 60000, 0.25f, 512, fLocal_305);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
			...
			case 13:
				if (!PED::IS_PED_INJURED(iLocal_348))
				{
					if (func_488())
					{
						...
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						ENTITY::SET_ENTITY_COORDS(iLocal_348, vLocal_369, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(iLocal_348, fLocal_305);
						func_380();
						func_353();
						func_354();
						func_8(&iLocal_263);
			...
			case 14:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_369, 1.25f, 1.25f, 2.5f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_363, vLocal_364, 10f, 0, true, 0))
					{
						if (func_485())
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_328 == 1)
							{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					...
					if (func_485())
					{
						...
						if (iLocal_282)
						{
							if (func_349())
							{
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYIN", 7, 0, 0, 0))
								{
									iLocal_282 = 0;
									iLocal_277 = 0;
								}
						...
						{
							if (func_328(&uLocal_89, cLocal_353, "HUNT1_TYRE", "HUNT1_TYRE_1", 7, 0, 0))
							{
								iLocal_299[0] = 1;
							}
						}
						...
						{
							if (func_328(&uLocal_89, cLocal_353, "HUNT1_TYRE", "HUNT1_TYRE_2", 7, 0, 0))
							{
								iLocal_299[1] = 1;
							}
						}
						else if (iLocal_338 == 3)
						{
							if (!iLocal_299[2])
							{
								if (iLocal_336 <= 6 && func_371(&uLocal_89, cLocal_353, "HUNT1_TYR2", 7, 0, 0, 0))
								{
									iLocal_299[2] = 1;
								}
								else if (iLocal_336 <= 10 && func_371(&uLocal_89, cLocal_353, "HUNT1_TRY3", 7, 0, 0, 0))
								{
									iLocal_299[2] = 1;
								}
								else if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYR4", 7, 0, 0, 0))
								{
									iLocal_299[2] = 1;
								}
							}
			...
			case 16:
				if (func_477())
				{
					iLocal_331 = 0;
					func_458();
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[0 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 1);
					func_314(0, 0);
					iLocal_255 = 17;
				}
			...
			case 17:
				PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_348, 1.4f);
				if (!iLocal_301[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_358, true) > 10f)
							{
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_3", 8, 0, 0, 0))
								{
									iLocal_301[15] = 1;
								}
							}
				...
				{
					case 0:
						if (func_325(iLocal_348, vLocal_420[0 /*3*/], 0) < 2f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[1 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					
					case 1:
						if (func_325(iLocal_348, vLocal_420[1 /*3*/], 0) < 2f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[2 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					
					case 2:
						if (func_325(iLocal_348, vLocal_420[2 /*3*/], 0) < 2f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[3 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					
					case 3:
						if (func_325(iLocal_348, vLocal_420[3 /*3*/], 0) < 2f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_348, vLocal_413, vLocal_414, 3.5f, 0, true, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 20:
				if (!PED::IS_PED_INJURED(iLocal_348))
				{
					if (func_488())
					{
						...
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						ENTITY::SET_ENTITY_COORDS(iLocal_348, vLocal_370, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(iLocal_348, fLocal_371);
						func_353();
						func_354();
						func_314(1, 0);
						iLocal_255 = 18;
			...
			case 18:
				...
				{
					vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || vVar0.z > 41f)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT_ROOF", 7, 0, 0, 0))
						{
							TASK::CLEAR_PED_TASKS(iLocal_348);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 21;
						}
					}
					else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, -875674219) != 1)
					{
			...
			case 21:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7)
					{
						if ((func_371(&uLocal_89, cLocal_353, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_338 > 0) || iLocal_328 == 1)
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 5f, 4);
							iLocal_328 = 0;
							iLocal_301[17] = 1;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0))
				{
					...
					{
						func_316();
						iLocal_322 = MISC::GET_GAME_TIMER() + 2000;
						bLocal_279 = true;
					}
					if (func_485())
					{
						...
						if (iLocal_338 == 1 && !iLocal_301[18])
						{
							if (!func_223())
							{
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_FIRST", 7, 0, 0, 0))
								{
									if (iLocal_281)
									{
										iLocal_281 = 0;
						...
						if (iLocal_338 == 2 && !iLocal_301[19])
						{
							if (!func_223())
							{
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_SEC", 7, 0, 0, 0))
								{
									if (iLocal_281)
									{
										iLocal_281 = 0;
						...
						if (iLocal_281)
						{
							if (!func_223())
							{
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_COYMIS", 7, 0, 0, 0))
								{
									iLocal_281 = 0;
								}
							}
				...
				if (bLocal_279)
				{
					...
					{
						func_316();
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_FIN", 8, 0, 0, 0))
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 4f, 4);
							func_490(0);
							iLocal_255 = 23;
			...
			case 24:
				...
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
					ENTITY::SET_ENTITY_COORDS(iLocal_348, vLocal_417, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_348, fLocal_418);
			...
			case 25:
				if (!func_223())
				{
					if (!iLocal_301[21])
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_4", 7, 0, 0, 0))
						{
							iLocal_301[21] = 1;
						}
					}
					else if (!func_223())
					{
						if (func_308(iLocal_348))
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_422, 1f, 60000, 0.25f, 0, 1193033728);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_423, 1f, 60000, 0.25f, 0, 1193033728);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_424, 1f, 60000, 0.25f, 0, 1193033728);
							TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_351);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_348, iLocal_351);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_351);
							PED::SET_PED_KEEP_TASK(iLocal_348, true);
						}
						iLocal_255 = 0;
					}
				}
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				...
				{
					if (PED::IS_PED_RAGDOLL(iLocal_348))
					{
						func_2();
						iLocal_324 = MISC::GET_GAME_TIMER() + 2400;
						iLocal_280 = 1;
					}
				}
				if (((ENTITY::IS_ENTITY_DEAD(iLocal_348, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), 1)) || WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_348, 0, 2)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_348, false), 10f))
				{
					func_2();
					iLocal_324 = MISC::GET_GAME_TIMER() + 2400;
					iLocal_280 = 1;
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_324)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_348))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_348, 0))
					{
						TASK::CLEAR_PED_TASKS(iLocal_348);
						TASK::TASK_SMART_FLEE_PED(iLocal_348, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_348, true);
						func_318(2);
					}
					else
...
void func_463()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_433)
		{
			iLocal_434 = MISC::GET_GAME_TIMER() + 3000;
			iLocal_433 = 1;
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_434)
		{
			if (func_372())
			{
				if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYRBAN", 7, 0, 0, 0))
				{
					iLocal_301[10] = 1;
				}
			}
...
void func_464()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!iLocal_291)
			{
				iLocal_317 = MISC::GET_GAME_TIMER() + 3000;
				iLocal_291 = 1;
			}
			else if (MISC::GET_GAME_TIMER() > iLocal_317)
			{
				if (!func_223())
				{
					if (!iLocal_301[8])
					{
						if (func_466(&uLocal_89, cLocal_353, "HUNT1_BANTER", &Local_428, 7, 0, 0))
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_428))
							{
								Local_428 = { func_465() };
							}
							else
...
void func_467()
{
	...
	if (func_308(PLAYER::PLAYER_PED_ID()) && func_308(iLocal_348))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_230(iLocal_426))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == iLocal_426 && PED::GET_VEHICLE_PED_IS_IN(iLocal_348, 0) == iLocal_426)
				{
					if (!iLocal_431)
					{
						iLocal_432 = ENTITY::GET_ENTITY_HEALTH(iLocal_426);
						iLocal_431 = 1;
					}
					else
					{
						iVar0 = ENTITY::GET_ENTITY_HEALTH(iLocal_426);
						if (iVar0 < iLocal_432)
						{
							func_468();
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_DAMCAR", 8, 0, 0, 0))
							{
								iLocal_431 = 0;
							}
						}
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_301[7])
		{
			if (!func_223())
			{
				if (func_372())
				{
					if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == iLocal_426)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_CLVEH", 7, 0, 0, 0))
						{
							iLocal_301[7] = 1;
						}
					}
					...
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT1_OWNVEH", 7, 0, 0, 0))
						{
							iLocal_301[7] = 1;
						}
					}
...
void func_471()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 0, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!iLocal_297)
				{
					if (!func_398("HT_NXTLOC", 0, 0) && iLocal_301[4])
					{
						iLocal_332 = MISC::GET_GAME_TIMER() + 20000;
						iLocal_297 = 1;
					}
				}
				else if (MISC::GET_GAME_TIMER() > iLocal_332)
				{
					if (!func_223() && func_372())
					{
						if (!iLocal_301[6])
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_NOVEH", 7, 0, 0, 0))
							{
								iLocal_301[6] = 1;
							}
						}
...
void func_474()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!iLocal_429)
		{
			if (iLocal_302[1] && !func_398("HT_NXTLOC", 0, 0))
			{
				iLocal_430 = MISC::GET_GAME_TIMER() + 3000;
				iLocal_429 = 1;
			}
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_430)
		{
			if (!func_223() && func_372())
			{
				if (!iLocal_301[4])
				{
					if (func_371(&uLocal_89, cLocal_353, "HUNT1_2", 7, 0, 0, 0))
					{
						iLocal_301[4] = 1;
					}
				}
...
void func_475()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 16f, 0, true, 0))
	{
		if ((iLocal_302[1] && !func_398("HT_NXTLOC", 0, 0)) && !func_223())
		{
			if (!iLocal_296)
			{
				iLocal_316 = MISC::GET_GAME_TIMER() + 15000;
				iLocal_296 = 1;
			}
			else if (MISC::GET_GAME_TIMER() > iLocal_316)
			{
				if (!iLocal_301[5] && func_372())
				{
					if (func_371(&uLocal_89, cLocal_353, "HUNT1_WAIT", 7, 0, 0, 0))
					{
						iLocal_296 = 0;
					}
				}
...
void func_476()
{
	if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		if (!iLocal_273)
		{
			iLocal_435 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 1))
			{
				if (!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(iLocal_435))
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_NOCAR", 7, 0, 0, 0))
							{
								iLocal_273 = 1;
							}
						}
...
int func_477()
{
	if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_346))
		{
			TASK::CLEAR_PED_TASKS(iLocal_348);
		...
		{
			OBJECT::DELETE_OBJECT(&iLocal_346);
		}
	}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (MISC::IS_BULLET_IN_AREA(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_223())
			{
				if (!func_398("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_258[iVar0 /*10*/].f_7)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT_MISS", 7, 0, 0, 0))
						{
							iLocal_277 = 0;
						}
					}
	...
	if (MISC::IS_BULLET_IN_AREA(1793.305f, 3804.426f, 32.6374f, 10f, 1))
	{
		if (!func_223())
		{
			if (!func_398("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				if (func_371(&uLocal_89, cLocal_353, "HUNT_MISS2", 6, 0, 0, 0))
				{
					iLocal_277 = 0;
				}
			}
...
void func_480(int iParam0)
{
	...
	if (((iLocal_338 < 3 && !func_398("HT_SHDISH", 0, 0)) && !func_398("HT_SHTYRE", 0, 0)) && !func_398("HT_SHCOY", 0, 0))
	{
		if (iLocal_277)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_326)
			{
				if (MISC::ARE_STRINGS_EQUAL(sVar0, "HUNT1_DIIN"))
				{
					if ((func_349() || iLocal_323 > 2) || iLocal_338 == 0)
					{
						if (func_371(&uLocal_89, cLocal_353, sVar0, 7, 0, 0, 0))
						{
							iLocal_277 = 0;
						}
					}
					else
					{
						...
						{
							case 0:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_SAT", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_323++;
								}
							...
							case 1:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_SAT2", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_323++;
								}
							...
							case 2:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_SAT3", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_323++;
								}
				...
				{
					if ((func_349() || iLocal_339 > 2) || iLocal_338 == 0)
					{
						if (func_371(&uLocal_89, cLocal_353, sVar0, 7, 0, 0, 0))
						{
							iLocal_277 = 0;
					...
					else
					{
						...
						{
							case 0:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_BANT1", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_339++;
								}
							...
							case 1:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_BANT2", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_339++;
								}
							...
							case 2:
								if (func_371(&uLocal_89, cLocal_353, "HUNT1_BANT3", 7, 0, 0, 0))
								{
									iLocal_277 = 0;
									iLocal_339++;
								}
				...
				else
				{
					...
					{
						case 0:
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_COYB1", 7, 0, 0, 0))
							{
								iLocal_277 = 0;
								iLocal_427++;
							}
						...
						case 1:
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_COYB2", 7, 0, 0, 0))
							{
								iLocal_277 = 0;
								iLocal_427++;
							}
						...
						case 2:
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_COYB3", 7, 0, 0, 0))
							{
								iLocal_277 = 0;
								iLocal_427++;
							}
		...
		{
			iLocal_327 = MISC::GET_RANDOM_INT_IN_RANGE(10000, 15000);
			iLocal_326 = (MISC::GET_GAME_TIMER() + iLocal_327);
			iLocal_277 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f))
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) != 1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) != 7)
								{
									iLocal_328 = 1;
								}
							}
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_369, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_482(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_372, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_482(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
	...
	if (!func_223())
	{
		if (func_372())
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (!iLocal_288)
				{
					if (func_371(&uLocal_89, cLocal_353, "HUNT1_UGUN", 9, 0, 0, 0))
					{
						iLocal_288 = 1;
						iLocal_287 = 0;
					}
			...
			{
				if (func_371(&uLocal_89, cLocal_353, "HUNT_UGUN2", 9, 0, 0, 0))
				{
					iLocal_287 = 1;
					iLocal_288 = 0;
				}
	...
	if (!bParam1 || iLocal_269)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_348))
			{
				...
				if (bParam1)
				{
					TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_258[iLocal_335 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				TASK::TASK_PERFORM_SEQUENCE(iLocal_348, iVar0);
...
int func_488()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_346) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_346, iLocal_348))
	{
		return 1;
	}
	if (!iLocal_265)
...
void func_489()
{
	...
	while (!STREAMING::HAS_MODEL_LOADED(iLocal_342))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_265 = 1;
...
void func_490(bool bParam0)
{
	...
	if (func_308(iLocal_348))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_348, true);
			TASK::TASK_CLEAR_LOOK_AT(iLocal_348);
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
void func_491(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_308(iLocal_348) && func_308(PLAYER::PLAYER_PED_ID()))
	{
		if (func_462())
		{
			iVar1 = 0;
			while (iVar1 < func_461())
			{
				...
				{
					iVar0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_460(iVar1));
					if (iVar0 != PLAYER::PLAYER_PED_ID() && iVar0 != iLocal_348)
					{
			...
			while (iVar1 < 5)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar1 /*29*/].f_12))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar1 /*29*/].f_12, PLAYER::PLAYER_PED_ID(), 1))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_259[iVar1 /*29*/].f_12);
						iLocal_321++;
					}
				}
				iVar1++;
			...
			if (iLocal_321 == 1)
			{
				if (!iLocal_301[13])
				{
					if (func_328(&uLocal_89, cLocal_353, "HUNT1_INOC", "HUNT1_INOC_1", 8, 0, 0))
					{
						iLocal_301[13] = 1;
					}
				}
...
void func_492()
{
	if (!PED::IS_PED_INJURED(iLocal_348))
	{
		if (((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("WEAPON_GRENADE"), 0) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("WEAPON_STICKYBOMB"), 0)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("WEAPON_MOLOTOV"), 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_348, false), 10f))
		{
			PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_261, 1862763509);
		}
		if (!iLocal_272)
		{
			if (func_494() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_348))
			{
				if (func_223())
				{
					func_316();
				}
				func_493(&uLocal_89, cLocal_353, "HUNT1_PTREAC", 6, 0, 0);
				iLocal_272 = 1;
			}
		}
		if (!bLocal_298)
		{
			if (PED::IS_PED_FALLING(iLocal_348))
			{
				ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, false);
				bLocal_298 = true;
			}
		}
		else if (TASK::IS_PED_GETTING_UP(iLocal_348))
		{
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, true);
			bLocal_298 = false;
		}
...
int func_494()
{
	if (func_308(iLocal_348))
	{
		if (iLocal_255 != 25)
		{
			if ((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && func_373(iLocal_348, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_348, 30f)) && func_373(iLocal_348, PLAYER::PLAYER_PED_ID(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_495()
{
	if (!PED::IS_PED_INJURED(iLocal_348))
	{
		if ((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_328 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_346))
			{
				OBJECT::DELETE_OBJECT(&iLocal_346);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_346))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_346 = OBJECT::CREATE_OBJECT(iLocal_342, ENTITY::GET_ENTITY_COORDS(iLocal_348, true), false, false, false);
			}
		}
		else if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_346, iLocal_348))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_346, iLocal_348, PED::GET_PED_BONE_INDEX(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}

void func_496(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_498(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_499(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_510(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_512(iParam0, Global_41396);
}
...
void func_514()
{
	if (!iLocal_284)
	{
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_261, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, iLocal_261);
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, false, 0);
			}
			if (bVar2)
			{
				iLocal_77 = 3;
...
void func_518(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	func_519(iParam0, iLocal_79, vParam1, fParam2);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_519(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_520(iParam0);
...
int func_521(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_522(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_522(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_529()
{
	...
	if (bLocal_264)
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_349, 0);
	}
	if (iLocal_293)
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_350, 0);
	}
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_530(&Local_88, 0, 0, 0);
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_546())
	{
		...
		{
			iVar2 = func_302(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_544()
{
	...
	iVar0 = func_305(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_546()
{
	...
	{
		if (func_302(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
