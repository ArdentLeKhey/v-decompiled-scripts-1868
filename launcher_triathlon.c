...
void __EntryFunction__()
{
	...
	iLocal_89 = 1;
	iLocal_91 = -1;
	vLocal_56 = { ScriptParam_97.f_1[0 /*3*/] };
	vLocal_56 = { vLocal_56 };
	uLocal_54 = uLocal_54;
	Local_52 = { Local_52 };
	bVar0 = false;
	...
	iLocal_59 = 0;
	func_122(&Global_110211, 0);
	func_119();
	MISC::_0x6F2135B6129620C1(1);
	if (func_118(uLocal_58, 1))
	{
		iLocal_64 = 10;
	}
	else
	...
	if (!func_118(uLocal_58, 8))
	{
		if (!func_116(iLocal_64))
		{
			if (func_115(0, iLocal_63))
			{
				func_124(0);
			}
			else
	...
	if (func_118(uLocal_58, 8388608))
	{
		func_124(1);
	}
	if (func_118(uLocal_58, 524288) && (func_114() && !func_113()))
	{
		func_124(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_118(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			func_112(iLocal_69, 1, 0);
			iLocal_69 = 263;
		}
		func_111(10);
	}
	while (true)
	{
		if (!func_118(uLocal_58, 268435456))
		{
			fVar1 = 0f;
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_97.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
					ScriptParam_97.f_1[0 /*3*/].f_2 = fVar1;
					func_110(&uLocal_58, 268435456);
				}
			}
		}
		iLocal_53 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
		if (func_118(uLocal_58, 1048576))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(vLocal_55, ScriptParam_97.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			vLocal_75 = { vLocal_55 };
			vLocal_76 = { ScriptParam_97.f_1[0 /*3*/] };
			vLocal_75.z = 0f;
			vLocal_76.z = 0f;
			...
			{
				case 0:
					if (func_116(iLocal_64) || (func_118(uLocal_58, 16) && !func_118(uLocal_58, 524288)))
					{
						iLocal_62 = -1;
						func_109();
						func_111(1);
					...
					else
					{
						...
						if ((vLocal_55.z - ScriptParam_97.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (!func_118(uLocal_58, 4))
					{
						func_103();
						func_110(&uLocal_58, 4);
					}
					if (fLocal_74 > (fLocal_66 * fLocal_66) && !Global_98703)
					{
						if (iLocal_69 != 263)
						{
							if (func_102(6) && !func_101(iLocal_69))
							{
							}
							else
							{
					...
					{
						Local_52 = { Local_51 };
						bVar3 = !func_118(uLocal_58, 64);
						func_122(&uLocal_58, 128);
						if (!func_100(3) && !Global_98703)
						{
							if (func_118(uLocal_58, 2097152))
							{
								if ((!func_118(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_99())) && !Global_98703)
								{
									func_111(10);
									break;
								}
						...
						if ((!func_90(6) || Global_110607) || func_89())
						{
							bVar3 = false;
						}
						if (func_118(uLocal_58, 1))
						...
						if (bVar3)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_97.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, false, true, iLocal_67))
							{
								bVar3 = false;
							}
							if (fLocal_57 < ((fLocal_77 * fLocal_77) + 4f))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
									func_86(&uLocal_58, 128);
									bVar3 = false;
									if (!func_118(uLocal_58, 1024))
									{
										func_79("MG_GET_ON_FOOT", -1);
										func_86(&uLocal_58, 1024);
									}
								}
								else if (func_118(uLocal_58, 1024))
								{
									func_122(&uLocal_58, 1024);
							...
							if (bVar3)
							{
								...
								if (func_78(uLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_77(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_86(&uLocal_58, 2048);
									}
									else if (!func_118(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_76(&iLocal_60);
										func_122(&uLocal_58, 2048);
									}
									if (func_74(iLocal_60, 1))
									{
										sLocal_65 = sLocal_65;
										func_76(&iLocal_60);
										func_122(&uLocal_58, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar4 != 1)
						{
							iVar4 = func_57(&iLocal_62, 6, iLocal_64, 0, 0);
						}
						if (iVar4 == 1)
						{
				...
				case 6:
					if (!func_118(uLocal_58, 256))
					{
						...
						{
							func_86(&uLocal_58, 256);
						}
					}
					if (func_118(Global_110211, 262144))
					{
						func_122(&Global_110211, 262144);
						func_36();
					}
					if (func_118(uLocal_58, 2097152))
					{
						if (!func_100(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
						{
							func_111(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_32(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_31(&iLocal_71);
						func_122(&uLocal_58, 256);
						func_30();
						if (bVar0)
						{
							func_122(&uLocal_58, 2);
						}
						else if (func_118(uLocal_58, 2))
						{
							if (func_118(Global_110211, 0))
							{
								func_29(&iLocal_62);
								iLocal_62 = -1;
								func_122(&uLocal_58, 2);
						...
						if (iLocal_63 != -1)
						{
							if (func_118(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_98706, 0);
								func_28(func_39(iLocal_63), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_98706, 0);
								func_28(func_39(iLocal_63), 0, Global_98706, 0, 0);
							}
						}
						func_4();
						func_122(&Global_110211, 0);
						if (func_118(uLocal_58, 16777216))
						{
							func_124(1);
						}
						if (iLocal_63 != -1)
					...
					if ((iLocal_68 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_70 == 2)
							{
								if (iLocal_70 == 2)
								{
									if (func_116(iLocal_64) && func_115(0, iLocal_63))
									{
										func_119();
										if (iLocal_69 != 263)
										{
...
void func_4()
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_85, true, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_83))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_83, true, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_84))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_84, true, 1);
	}
	iLocal_86 = PED::ADD_SCENARIO_BLOCKING_AREA((vLocal_79.x - 3f), (vLocal_79.y - 3f), (vLocal_79.z - 3f), (vLocal_79.x + 3f), (vLocal_79.y + 3f), (vLocal_79.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
...
void func_7()
{
	if (func_118(Global_111560.f_20006.f_9, 1))
	{
		func_122(&(Global_111560.f_20006.f_9), 1);
		if (iLocal_91 == Global_111560.f_20006.f_8)
		{
			if (Global_111560.f_20006.f_8 != 2)
			{
				Global_111560.f_20006.f_8++;
				if (Global_111560.f_20006.f_8 == 1)
				{
					func_112(108, 1, 0);
					func_20(114, 1, 0, 1, 0);
				}
				else if (Global_111560.f_20006.f_8 == 2)
				{
					func_112(109, 1, 0);
					func_20(115, 1, 0, 1, 0);
				}
				if (iLocal_88 && Global_111560.f_20006.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_8(int iParam0, bool bParam1)
{
	...
	if (bParam1 != MISC::IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 13))
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 18);
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 13);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 13);
	}
}
...
void func_11(int iParam0, bool bParam1)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 4))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 4);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 4);
	}
	if (Global_31108 == 1)
	{
		Global_31109 = 1;
...
void func_12(int iParam0, bool bParam1)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 5))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 5);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 5);
	}
	if (Global_31108 == 1)
	{
		Global_31109 = 1;
...
void func_13(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 6))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 6);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 6);
	}
	if (bParam2)
	{
		MISC::SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 11);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 11);
	}
	if (Global_31108 == 1)
	{
		Global_31109 = 1;
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		MISC::CLEAR_BIT(&(Global_111560.f_20405.f_150[iVar1]), iVar0);
		MISC::CLEAR_BIT(&(Global_111560.f_20405.f_150[iVar1]), iVar0);
	}
}
...
int func_46()
{
	...
	Var0.f_6 = iLocal_83;
	Var0.f_7 = iLocal_84;
	iVar1 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &Var0, 8, iLocal_61);
...
void func_60()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_85, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
...
void func_61()
{
	...
	if (MISC::GET_GAME_TIMER() > iLocal_90 && fLocal_57 < (30f * 30f))
	{
		iLocal_90 = MISC::GET_GAME_TIMER() + 10000;
		if (MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) <= 0.5f)
		{
			...
			{
				StringCopy(&Var6, "A_M_Y_TRIATHLON_01_MINI_0", 32);
				StringIntConCat(&Var6, MISC::GET_RANDOM_INT_IN_RANGE(1, 5), 32);
				func_62(iVar4, "TRIATHLON_WARMUP", &Var6, 6);
			}
		}
	}
}
...
void func_65()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_68(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_66(iVar0) && (!func_102(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_66(Global_111560.f_2358.f_539.f_4321))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_93()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_97()) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_97() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_82(8, -1)) || func_84()) || func_92()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_97()) || Global_30738) || func_96()) || func_82(8, -1)) || func_94()) || func_93()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_97()) || func_94()) || Global_110607) || Global_30738) || func_96()) || Global_42561) || func_82(8, -1)) || func_93()) || func_92()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_92()) || func_95()) || func_94()) || func_84())
						{
							return 0;
						}
						break;
...
void func_103()
{
	...
	if (bLocal_87)
	{
		MISC::CLEAR_AREA_OF_OBJECTS(vLocal_78, 25f, 0);
		if (TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_1_Start") && iLocal_91 == 1)
		{
			TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_1_Start", true);
		}
		if (TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_2_Start") && iLocal_91 == 0)
		{
			TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_2_Start", true);
		}
		if (TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_3_Start") && iLocal_91 == 2)
		{
			TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_3_Start", true);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_81))
		{
			vVar1 = { func_107(iLocal_91 == 1, 2434.162f, 4282.774f, 35.5112f, func_107(iLocal_91 == 0, -1231.203f, -2051.531f, 12.9317f, func_107(iLocal_91 == 2, 1591.099f, 3814.026f, 33.2697f, 0f, 0f, 0f))) };
			fVar0 = func_106(iLocal_91 == 1, 264.0724f, func_106(iLocal_91 == 0, 256.2876f, func_106(iLocal_91 == 2, 222.6197f, 0f)));
			iLocal_81 = OBJECT::CREATE_OBJECT(joaat("prop_tri_table_01"), vVar1, true, true, false);
			ENTITY::SET_ENTITY_HEADING(iLocal_81, fVar0);
		...
		{
			vLocal_79 = { func_107(iLocal_91 == 1, 2434.955f, 4282.711f, 35.5333f, func_107(iLocal_91 == 0, -1230.361f, -2051.761f, 12.918f, func_107(iLocal_91 == 2, 1591.686f, 3813.401f, 33.3371f, 0f, 0f, 0f))) };
			fVar0 = func_106(iLocal_91 == 1, 264.3256f, func_106(iLocal_91 == 0, 253.044f, func_106(iLocal_91 == 2, 220.7912f, 0f)));
			iLocal_82 = OBJECT::CREATE_OBJECT(joaat("prop_chair_08"), vLocal_79, true, true, false);
			ENTITY::SET_ENTITY_HEADING(iLocal_82, fVar0);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_82, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_chair_08"));
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_83))
		{
			vVar1.z = (vVar1.z + 0.54f);
			iLocal_83 = OBJECT::CREATE_OBJECT(joaat("p_cs_clipboard"), vVar1, true, true, false);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			fVar0 = func_106(iLocal_91 == 1, 79.9315f, func_106(iLocal_91 == 0, 77.5972f, func_106(iLocal_91 == 2, 47.2081f, 0f)));
			iLocal_85 = PED::CREATE_PED(4, joaat("a_m_y_roadcyc_01"), vLocal_79, fVar0, 1, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_84))
		{
			if (iLocal_91 == 1)
			{
				vVar2 = { 2433.74f, 4283.08f, 36.235f };
			}
			else if (iLocal_91 == 0)
			{
				vVar2 = { -1231.47f, -2051.23f, 13.68f };
			}
			else if (iLocal_91 == 2)
			{
				vVar2 = { 1591.11f, 3814.46f, 33.99f };
			}
			iLocal_84 = OBJECT::CREATE_OBJECT(joaat("prop_pencil_01"), vVar2, true, true, false);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_pencil_01"));
		}
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_79, 3f, 1))
			{
				TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_85, vLocal_79, 2f, 0);
			}
			else
			{
				switch (iLocal_91)
				{
					case 0:
						vVar3 = { -1230.37f, -2051.766f, 13.4441f };
						fVar4 = 69.8085f;
						break;
					
					case 1:
						vVar3 = { 2435.042f, 4282.716f, 36.0357f };
						fVar4 = 83.5805f;
						break;
					
					case 2:
						vVar3 = { 1591.71f, 3813.355f, 33.8383f };
						fVar4 = 41.0251f;
						break;
				}
				TASK::TASK_START_SCENARIO_AT_POSITION(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", vVar3, fVar4, -1, 0, 1);
			}
		}
		iVar8 = 0;
		while (iVar8 < iLocal_92)
		{
			func_105(iLocal_91, iVar8, &vVar5, &vVar6, &fVar7);
			if (!func_104(vVar5))
			{
				iLocal_92[iVar8] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(vVar5, vVar6, fVar7, 0, 7);
			}
			iVar8++;
		}
	}
...
Vector3 func_107(bool bParam0, vector3 vParam1, vector3 vParam2)
{
	if (bParam0)
	{
		return vParam1;
...
void func_119()
{
	...
	if (Global_111560.f_20006.f_8 == -1)
	{
		Global_111560.f_20006.f_8 = 0;
	}
	if (Global_111560.f_20006.f_8 < iLocal_91)
	{
		func_86(&uLocal_58, 8388608);
	}
}

int func_120(vector3 vParam0, var uParam1)
{
	int iVar0;
	vector3 vVar1[3];
	float fVar2;
	...
	fVar2 = SYSTEM::VDIST2(vVar1[0 /*3*/], vParam0);
	fVar4 = 0f;
	iVar3 = 1;
	while (iVar3 <= (3 - 1))
	{
...
void func_126()
{
	...
	if (fLocal_74 > (fLocal_66 * fLocal_66))
	{
		...
		{
			OBJECT::DELETE_OBJECT(&iLocal_80);
		}
	}
	func_127(1, -1);
	iVar0 = 0;
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_86, 0);
	if (!iLocal_89)
	{
