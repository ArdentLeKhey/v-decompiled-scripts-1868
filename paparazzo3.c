...
void __EntryFunction__()
{
	...
	sLocal_58 = "Beverley";
	vLocal_229 = { -260.614f, 292.106f, 91.127f };
	vLocal_230 = { 7.2E-05f, -2.500116f, 89.63998f };
	vLocal_232 = { 0.07f, -0.13f, 0.07f };
	...
	{
		func_477("Force cleanup [TERMINATING]");
		func_458(1);
		func_443();
	}
	if (func_442())
	...
	while (true)
	{
		...
		func_320(Local_43.f_9, 0, 0, 0, 0, 0);
		if (iLocal_41 == 2)
		{
			func_316();
		}
...
{
	func_250();
	if (!func_231(Local_43.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				if (func_229(Local_43.f_28[0]))
				{
			...
			case 1:
				if (!bLocal_225)
				{
					bLocal_225 = func_214(&uLocal_59, "PAP3AU", "PAP3_RCM_LO", 8, 0, 0, 0);
				}
				else if (!func_213())
				{
...
bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_242(iParam0, iParam1);
	if (!func_230(iParam0) || !func_230(iParam1))
	{
		if (iVar2 != -1)
		{
			func_241(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_235(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_235(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_236(iParam2, iParam5) };
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar1 = { func_240(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_239(vVar1, vVar0);
...
float func_239(vector3 vParam0, vector3 vParam1)
{
...
int func_248(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
void func_250()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_230(Local_43.f_28[0]))
	{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_230(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_286(sLocal_56, PLAYER::PLAYER_PED_ID(), 0, 2);
				}
			}
			if (func_279(1, 1093140480, 0))
			{
				if (func_230(Local_43.f_28[0]))
				{
		...
		case 1:
			...
			{
				iLocal_228 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_229, vLocal_230, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
				PED::_0x2208438012482A1A(Local_43.f_28[0], 0, 0);
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_56, 0))
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 1, false, 0, 1);
			...
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_46, vLocal_229, 0, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_46, vLocal_230, 2, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_228, "leadout_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
			...
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_228, "leadout_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 1, 1148846080);
			...
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_228, "leadout_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 1, 1148846080);
			...
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_45, -261.1132f, 294.1956f, 90.68612f, 0, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_45, -0.604164f, -2.332095f, 89.8831f, 2, 0);
...
void func_254(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_260(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_264(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_268(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_269(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_269(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_273(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_271(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_272(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_273(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_240(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_274(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_274(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_274(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_274(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_274(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_274(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_274(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_274(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_274(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_274(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_274(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_274(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_274(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_274(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_274(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_274(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_274(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_276()
{
	...
	{
		MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar2), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar1 = { func_277() };
		if ((vVar0[1 /*3*/] - vVar0[0 /*3*/]) > vVar1.x)
		{
			return 0;
		}
		if ((vVar0[1 /*3*/].f_1 - vVar0[0 /*3*/].f_1) > vVar1.y)
		{
			return 0;
		}
		if ((vVar0[1 /*3*/].f_2 - vVar0[0 /*3*/].f_2) > vVar1.z)
		{
			return 0;
		}
	}
...
int func_279(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_284(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_284(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_287(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_42(iVar4, func_81(iVar0), func_65(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_49(iVar4, func_81(iVar0), func_65(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(iVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_42(iVar4, 14, func_56(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_49(iVar4, 14, func_56(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		...
		iVar8 = func_65(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_50(iVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_83(iVar4, 0, iVar9, -1) };
...
void func_292()
{
	if (func_262())
	{
		CAM::SET_GAMEPLAY_ENTITY_HINT(Local_43.f_28[0], 0f, 0f, 0f, 1, -1, 1500, 2000, 0);
	}
}
...
void func_293()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_229(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_226, "leadin_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_226, "leadin_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_226, "leadin_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				func_253(1, 1, 1, 1);
				iLocal_42 = 1;
			}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_226))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.99f)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_227))
						{
							...
							TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							PED::_0x2208438012482A1A(Local_43.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_227, "idle_01_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_46);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_227, "idle_01_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_47[0]);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_227, "idle_01_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_47[1]);
							}
						}
					}
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
							bLocal_224 = func_214(&uLocal_59, "PAP3AU", "PAP3_RCM_LI", 8, 0, 0, 0);
						}
					}
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.3f)
					{
...
void func_294()
{
	...
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, vLocal_232), ENTITY::GET_ENTITY_ROTATION(Local_43.f_41[3], 2), 1065353216, 0, 0, 0);
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_231, "CAMERA", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, vLocal_232), sLocal_234, false, 0, 0);
			iLocal_235 = 1;
		}
	}
}
...
void func_297()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_284(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_304()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_45))
	{
		iLocal_45 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_51, 1, 0, 1);
		ENTITY::SET_CAN_CLIMB_ON_ENTITY(iLocal_45, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		func_313(&iLocal_46, &(Local_43.f_41[0]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
	{
		func_313(&(iLocal_47[0]), &(Local_43.f_41[1]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
	{
		func_313(&(iLocal_47[1]), &(Local_43.f_41[2]));
	}
	func_312(&uLocal_59, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_312(&uLocal_59, 3, Local_43.f_28[0], "BEVERLY", 0, 1);
...
int func_307(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_308()
{
	if (func_230(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		iLocal_228 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_229, vLocal_230, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
...
int func_314()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_43.f_28[0], 0))
		{
			func_315("P3BEVDEAD");
			return 1;
		}
...
void func_316()
{
	...
	{
		case 0:
			if (MISC::ARE_STRINGS_EQUAL(sLocal_236, "DEFAULT"))
			{
				func_458(1);
			}
			else
			{
				func_318(sLocal_236, 1);
			}
			iLocal_42 = 1;
			break;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_322(Global_76832, Global_76834, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_323(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_333(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_335(iParam0, Global_41396);
}
...
void func_337(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_442() || !func_435())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_432(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_410(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_409(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105109.f_2890 };
			fParam2 = Global_105109.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, 1, 0, 0, false);
		func_403(vParam1, 5f, 0);
		if (func_152(iParam10))
		{
			func_401(iParam10, 0);
			while (!func_338(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_338(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_395(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_395(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_395(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_343(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_342(*iParam1);
				...
				func_340(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_340(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_340(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_341(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
int func_344(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_371(iVar0, bParam1, uParam2) && !func_370(PLAYER::PLAYER_ID())) && !func_354(iParam0))
	{
		return 0;
	}
...
int func_346(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			...
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_351(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_352(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_369(PLAYER::PLAYER_ID()) || func_368(PLAYER::PLAYER_ID()))
	{
		if (func_355(iParam0))
		{
			return 1;
...
int func_368(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_220())
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_369(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_220())
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_370(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_347(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_371(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_373(int iParam0, int iParam1)
{
	...
	func_374(iParam0, &(Global_111560.f_32744.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_375(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_271(iParam0, 0, 0)) || func_271(iParam0, 1, 0)) || func_271(iParam0, 2, 0)) || func_391(iParam0) != 145) || func_390(iParam0)) || func_389(iParam0)) || func_345(iParam0)) || func_388(iParam0)) || !func_378(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_389(iParam0))
		{
		}
...
int func_395(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_367(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_398(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_398(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_397(iParam0);
	if (func_396(*iParam0))
	{
...
void func_400(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
...
void func_401(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_402(iParam0, iParam1))
				{
...
void func_403(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_408(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_404(int iParam0)
{
	...
	if (func_408(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_406(0, Global_75396.f_555[0 /*21*/].f_12) || !func_406(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_405(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_406(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_407(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_379(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_408(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_409(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_409(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_409(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_409(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_410(vector3 vParam0, float fParam1)
{
	return func_411(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_411(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_428(uParam0))
	{
		...
		if (func_427(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_416(iVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_392(iVar0, uParam0->f_11);
				}
				else if ((!func_413(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_412(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_413(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_415(iParam0, Global_75396.f_139[38], 0))
			{
				func_404(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_415(iParam0, Global_75396.f_139[43], 1))
			{
				func_404(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_415(iParam0, uVar1[iVar3], 1) && func_414(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_409(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_414(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_416(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_375(iVar1 + 1));
			}
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_419(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_418())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_395(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar2 + 1)))
				{
...
int func_420(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_426(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_422(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
bool func_429()
{
	return func_427(&(Global_105109.f_2890));
}

void func_430()
{
	func_431(&(Global_105109.f_2890));
}
...
int func_432(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_434(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_435()
{
	return func_428(&(Global_105109.f_2890));
}
...
int func_436(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (!func_441(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			{
				if (func_438(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
			...
			if (func_229(uParam0->f_28[0]))
			{
				...
				{
					func_437(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (bVar6)
			{
				iVar1[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				vVar2[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				vVar3[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				iVar1[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				vVar2[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				vVar3[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				iVar1[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
		...
		case 3:
			if (func_230(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_40, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_40, true);
				if (func_230(uParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_230(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_40, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_230(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_40, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_437(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_263(iParam0);
...
int func_438(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_439(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_439(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_443()
{
	...
	func_456(&(iLocal_47[0]), 0);
	func_456(&(iLocal_47[1]), 0);
	func_456(&iLocal_45, 0);
	func_456(&iLocal_46, 0);
	STREAMING::REMOVE_ANIM_DICT(sLocal_57);
	STREAMING::REMOVE_PTFX_ASSET();
	func_455(&uLocal_59, 1);
	func_455(&uLocal_59, 3);
	HUD::CLEAR_ADDITIONAL_TEXT(0, true);
	HUD::CLEAR_PRINTS();
	func_454(&(Local_43.f_28[0]), 1, 0, 1);
	func_444(&Local_43, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_444(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_452(uParam0, iParam1);
	func_447(uParam0, bParam2);
	func_445(uParam0, bParam3);
}

void func_445(var uParam0, bool bParam1)
{
	func_446(&(uParam0->f_41), bParam1);
}
...
void func_453(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_454(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_454(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_458(bool bParam0)
{
	...
	if (!func_475())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_459(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_460(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_466())
	{
		...
		{
			iVar2 = func_461(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_466()
{
	...
	{
		if (func_461(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_479(&(uParam0->f_28));
	func_479(&(uParam0->f_35));
	func_479(&(uParam0->f_41));
}
