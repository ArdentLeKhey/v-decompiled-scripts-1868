...
void __EntryFunction__()
{
	...
	StringCopy(&vLocal_321, "", 24);
	StringCopy(&vLocal_325, "MAUDE_MCS_5", 24);
	...
	if (func_521())
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				func_447(vLocal_333, fLocal_117, 1, 0);
				iLocal_61 = 2;
				func_436(1, 0);
				break;
			...
			case 1:
				...
				func_447(vLocal_330, 254.9762f, 0, 0);
				func_436(4, 0);
				break;
	...
	else if (func_435(0))
	{
		...
		{
			func_433(PLAYER::PLAYER_PED_ID(), vLocal_333, fLocal_117, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_331 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_422();
			func_421();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_334, fLocal_118, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_335, fLocal_119, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_433(Local_68.f_9, vLocal_330, 0f, 0, 0);
					if (!func_71())
					{
						func_433(PLAYER::PLAYER_PED_ID(), vLocal_330, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
int func_37()
{
	if (func_59(vLocal_331, Local_75.f_1, 210f))
	{
		if (!iLocal_110)
		{
		...
		{
			if (func_59(vLocal_331, Local_79.f_1, 150f))
			{
		...
		{
			if (func_59(vLocal_331, Local_80.f_1, 150f))
			{
...
void func_67()
{
	...
	if (func_434(Local_75))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_151, Local_75, 0);
		}
	}
}
...
void func_72()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				iLocal_100 = 0;
				StringCopy(&vLocal_321, "BBC_T12", 24);
			}
			if (func_23(Local_68.f_9))
			{
		...
		case 1:
			...
			else if (!iLocal_100)
			{
				...
				if (iLocal_62 == 4)
				{
					if (func_23(Local_75))
					{
						if (func_112(Local_75, vLocal_331, 35f))
						{
							func_97(&uLocal_155, 4, Local_75, "MAUDE", 0, 1);
							if (func_75(&uLocal_155, cLocal_149, &vLocal_321, 4, 0, 0, 0))
							{
								iLocal_100 = 1;
							}
						}
				...
				else if (func_75(&uLocal_155, cLocal_149, &vLocal_321, 4, 0, 0, 0))
				{
					iLocal_100 = 1;
				}
				if (iLocal_62 == 4)
	...
	if (iLocal_132 > 0)
	{
		...
		while (iVar0 <= (iLocal_132 - 1))
		{
			if (iLocal_67 == 4)
			{
				if (func_23(Local_69[iVar0 /*19*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iVar0 /*19*/], -2065892691);
	...
	if (func_23(Local_69[iParam0 /*19*/]))
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iParam0 /*19*/]) == iLocal_320)
		{
			...
			if (!PED::IS_PED_FLEEING(Local_69[iParam0 /*19*/]))
			{
				...
				{
					PED::_0xF1C03A5352243A30(Local_69[iParam0 /*19*/]);
				}
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					if (func_434(Local_75))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_75, sLocal_151, 0, 0, 0);
					}
					if (func_434(Local_68.f_9))
					{
					...
					if (func_434(Local_77))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_77, sLocal_153, 0, 0, 0);
					}
					if (func_434(Local_78))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_78, sLocal_154, 0, 0, 0);
					}
...
void func_315()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_320);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_320, 1862763509);
				iLocal_137 = ENTITY::GET_ENTITY_HEALTH(Local_68.f_9);
				vLocal_336 = { ENTITY::GET_ENTITY_COORDS(Local_68.f_9, false) };
				func_361(&vLocal_337, vLocal_336);
			...
			case 1:
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						if (func_327(Local_68.f_9, vLocal_331, bVar0, 0, 1, iLocal_137))
						{
							if ((func_120(iLocal_135, 5000) || func_174(vLocal_337, 0f, 0f, 0f, 0)) || (!func_59(vVar1, vLocal_337, 8.5f) && !func_59(vVar1, vLocal_336, 8.5f)))
							{
								func_326();
						...
						else
						{
							if (!iLocal_81)
							{
								if (!func_120(iLocal_122, 2500))
								{
									if (!func_62())
									{
										if (func_112(Local_68.f_9, vLocal_331, 30f))
										{
							...
							{
								if (func_120(iLocal_122, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_68.f_9, vLocal_331, 30f))
									{
							...
							func_323(Local_68.f_9, vLocal_331, iLocal_135, 925353388);
						}
					}
					else
					{
				...
				{
					func_326();
					if (!func_112(Local_68.f_9, vLocal_331, 10f))
					{
						if (!iLocal_95)
						{
			...
			case 2:
				...
				iLocal_82 = 1;
				func_326();
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_320);
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_320, 1862763509);
				func_117(&(Local_68.f_8));
				iLocal_82 = 1;
				Local_68.f_17 = MISC::GET_GAME_TIMER();
				func_324(&uLocal_44, 0, 0);
...
void func_362()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_112(Local_68.f_9, vLocal_331, 20f))
					{
				...
				case 6:
					if (!func_112(Local_68.f_9, vLocal_331, 3.5f))
					{
				...
				case 31:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 1f, true, 0.5f, 4f, true, 0, 0, -957453492, 20000);
						TASK::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500), 1);
						TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_332, 50f);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_143);
						TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, iLocal_143);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_143);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
				...
				case 33:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 2f, true, 0.5f, 4f, true, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_143);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 2f, true, 0.75f, 4f, true, 0, 0, -687903391, 20000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_143);
						TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, iLocal_143);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_143);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
				...
				case 13:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_68.f_9, vLocal_331);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 17, true);
						TASK::TASK_SMART_FLEE_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
						PED::SET_PED_KEEP_TASK(Local_68.f_9, true);
						Local_68.f_10 = 14;
					}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_364())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, 0))
								{
									...
									if (fVar4 < 1.75f && func_112(Local_68.f_9, vLocal_331, 8f))
									{
				...
				case 23:
					if (func_367(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_366())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_331, 50f)) || !func_120(iLocal_140, 2000))
							{
					...
					if (func_367(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_366())
					{
						if (!func_64(Local_68.f_9, -1519143300))
						{
							if (!func_64(Local_68.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									if (!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_331, 50f))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 23;
									}
							...
							else if (!func_363(Local_68.f_19, 10) && func_112(Local_68.f_9, vLocal_331, 50f))
							{
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		if (func_112(iParam0, vLocal_331, fParam2))
		{
...
void func_383()
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_330, 100f))
	{
		if (!func_384())
		{
			CUTSCENE::REQUEST_CUTSCENE(&vLocal_325, 8);
			func_67();
			iLocal_111 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_330, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_108)
				{
					...
					func_117(&(Local_68.f_8));
					if (!func_112(Local_68.f_9, vLocal_331, 25f))
					{
					...
					{
						func_388();
						func_386(&Local_75, vLocal_331, &iLocal_124, 5000, 1101004800);
					}
				}
				else if (func_112(Local_68.f_9, vLocal_331, 8f))
				{
...
int func_386(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, -1519143300))
				{
					if (func_112(Local_68.f_9, vLocal_331, 25f))
					{
						...
						{
							if (func_120(iLocal_123, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_5();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_122, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_68.f_9, vLocal_331, 20f))
							{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_115))
						{
							if (iLocal_94)
							{
								iLocal_115 = func_395(vLocal_330, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_330, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_330, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_330, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
				...
				else
				{
					...
					if (func_112(Local_68.f_9, vLocal_331, 8f))
					{
						if (Local_68.f_10 == 25 || Local_68.f_10 == 26)
						{
							Local_68.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_105)
				{
					bLocal_105 = func_393(vLocal_331, Local_63, 180f);
				}
				if (func_316(&(Local_68.f_9)))
				{
					iLocal_112 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_105)
					{
						bLocal_105 = func_393(vLocal_331, Local_63, 0f);
					}
					func_131(4);
				}
				break;
...
int func_393(vector3 vParam0, vector3 vParam1, float fParam2)
{
	int iVar0;
	
	if (!func_394(vParam0, vParam1, fParam2))
	{
...
bool func_394(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
			...
			case 1:
				...
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						if (func_327(Local_68.f_9, vLocal_331, bVar0, 0, 1, 170))
						{
							func_326();
							func_398(iLocal_132);
							Local_68.f_17 = MISC::GET_GAME_TIMER();
						...
						else
						{
							...
							func_323(Local_68.f_9, vLocal_331, iLocal_134, 925353388);
						}
					}
				}
				else
		...
		if (func_23(Local_69[iVar0 /*19*/]))
		{
			...
			switch (Local_69[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_23(Local_68.f_9) || (PED::IS_PED_FLEEING(Local_68.f_9) && TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_68.f_9) > 1f))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_69[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
					...
					{
						func_116(&(Local_69[iVar0 /*19*/].f_6));
						if (func_112(Local_69[iVar0 /*19*/], vLocal_331, 5f))
						{
							if (!func_363(Local_69[iVar0 /*19*/].f_16, 10))
							{
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iVar0 /*19*/], ENTITY::GET_ENTITY_COORDS(Local_69[iVar0 /*19*/], true), 5f, 0, 0);
					...
					{
						if (!func_112(Local_69[iVar0 /*19*/], vLocal_331, 7f))
						{
							TASK::CLEAR_PED_TASKS(Local_69[iVar0 /*19*/]);
						...
						func_400(Local_69[iVar0 /*19*/], &(Local_69[iVar0 /*19*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					}
					break;
...
int func_401(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0, true) };
			if (MISC::IS_BULLET_IN_AREA(vVar0, fParam5, 1))
			{
				return 1;
			}
			if (func_112(iParam0, vLocal_331, fParam2))
			...
			vVar1 = { vVar0 };
			vVar2 = { vVar1 };
			vVar1.x = (vVar1.x - fParam6);
			vVar1.y = (vVar1.y - fParam6);
			vVar1.z = (vVar1.z - fParam6);
			vVar2.x = (vVar2.x + fParam6);
			vVar2.y = (vVar2.y + fParam6);
			vVar2.z = (vVar2.z + fParam6);
			if (MISC::IS_PROJECTILE_IN_AREA(vVar1, vVar2, 1))
			{
				return 1;
			}
				...
				switch (iLocal_61)
				{
					case 2:
						...
						else
						{
							...
							if (func_112(Local_68.f_9, vLocal_331, 25f) && func_413(Local_68.f_9, vLocal_331, 10f))
							{
								...
								else if (func_112(Local_68.f_9, vLocal_331, 5f))
								{
									iLocal_61 = 0;
								}
...
void func_407()
{
	if (!iLocal_92)
	{
		if (!func_62())
		{
			if (func_112(Local_68.f_9, vLocal_331, (25f + 5f)))
			{
				iLocal_116 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
	...
	{
		if (!func_112(Local_68.f_9, vLocal_331, (25f + 10f)))
		{
			Local_329 = { func_408() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_329))
			{
...
int func_411(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_434(iParam0))
	{
		if (!func_363(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_112(Local_68.f_9, vLocal_331, fParam3))
				{
					return 0;
				}
				if (!func_413(iParam0, vLocal_331, fParam4))
				{
					return 0;
				}
			}
...
int func_413(int iParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
		...
		case 1:
			...
			if (func_23(Local_68.f_9))
			{
				...
				if (func_112(Local_68.f_9, vLocal_331, 25f) && func_413(Local_68.f_9, vLocal_331, 10f))
				{
					...
					{
						if (func_112(Local_68.f_9, vLocal_331, (25f - 1.5f)))
						{
							iLocal_61 = 1;
							iLocal_60 = 2;
						}
...
void func_423()
{
	...
	if (iLocal_58 == 0)
	{
		if (!SYSTEM::VDIST2(vLocal_331, Local_63) <= ((Local_63.f_3 + 25f) * (Local_63.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_9, 0) && !PED::IS_PED_INJURED(Local_68.f_9))
		{
			...
			{
				if (!func_112(Local_68.f_9, vLocal_331, 150f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
			...
			{
				if (!func_112(Local_68.f_9, vLocal_331, 80f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
...
int func_428(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
void func_433(int iParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
...
void func_438(bool bParam0, bool bParam1)
{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_141, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
...
void func_447(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_521())
	{
...
void func_448(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_516(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	...
	else if (iParam7 == 1)
	{
		...
		{
			func_489(iParam10, 0);
			while (!func_449(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_449(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_484(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_484(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_484(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_454(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_453(*iParam1);
				...
				func_451(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_451(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_454(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_479(iVar0, bParam1, uParam2) && !func_478(PLAYER::PLAYER_ID())) && !func_462(iParam0))
	{
		return 0;
	}
...
int func_455(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_460(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_476(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_477(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_82())
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_478(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_456(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_490(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
void func_491(int iParam0)
{
	...
	if (func_164(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_75396.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_170(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_492(0, Global_75396.f_555[0 /*21*/].f_12) || !func_492(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
...
int func_492(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_493(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
int func_497(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("CARGOBOB"):
			if (func_499(iParam0, Global_75396.f_139[38], 0))
			{
				func_491(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_499(iParam0, Global_75396.f_139[43], 1))
			{
				func_491(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_499(iParam0, uVar1[iVar3], 1) && func_498(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_498(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_516(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_518(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_519()
{
	return func_512(&(Global_105109.f_2890));
}
...
void func_522()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_320);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_320, 1862763509);
	vVar0 = { func_529(Local_63) };
	vVar1 = { func_528(Local_63) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar1);
	iLocal_141 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
	...
	if (func_23(PLAYER::PLAYER_PED_ID()))
	{
		func_97(&uLocal_155, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_523()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_360(Local_68.f_9);
		func_524(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		...
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK::SET_SEQUENCE_TO_REPEAT(iLocal_143, 1);
		TASK::CLOSE_SEQUENCE_TASK(iLocal_143);
		TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, iLocal_143);
		TASK::CLEAR_SEQUENCE_TASK(&iLocal_143);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_23(Local_69[iVar0 /*19*/]))
		{
			...
			func_524(Local_69[iVar0 /*19*/], "BACKUP_", iVar0);
			switch (iVar0)
			{
				case 0:
					TASK::OPEN_SEQUENCE_TASK(&iLocal_143);
...
int func_525()
{
	...
	if (iLocal_129 > 0)
	{
		...
		{
			if (func_527(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_131 > 0)
	{
		...
		{
			if (func_526(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_526(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam4))
...
int func_527(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
void func_530()
{
	...
	iLocal_128 = 0;
	iLocal_131 = 0;
	vLocal_333 = { 1477.907f, 6372.509f, 22.5721f };
	fLocal_117 = 145.357f;
	vLocal_334 = { 1456.282f, 6352.942f, 22.8309f };
	fLocal_118 = 97.282f;
	vLocal_335 = { 1445.696f, 6351.564f, 22.7946f };
	fLocal_119 = 90.3412f;
	vLocal_336 = { 0f, 0f, 0f };
	vLocal_337 = { 0f, 0f, 0f };
	iLocal_61 = 4;
	...
	iLocal_137 = 0;
	iLocal_139 = -1;
	vLocal_332 = { 1425.318f, 6346.781f, 22.9851f };
	vLocal_330 = { 2722.661f, 4143.105f, 43.0617f };
	StringCopy(&vLocal_321, "", 24);
	StringCopy(&Local_329, "", 24);
	Local_75.f_6 = func_541(62);
	Local_75.f_1 = { func_540() };
	Local_75.f_4 = func_539();
	Local_77.f_5 = func_538();
	Local_77.f_1 = { func_537() };
	Local_77.f_4 = func_536();
	Local_78.f_5 = func_535();
	Local_78.f_1 = { func_534() };
	Local_78.f_4 = func_533();
	Local_79.f_5 = func_48();
	Local_79.f_1 = { func_47() };
	Local_79.f_4 = func_46();
	Local_80.f_5 = func_45();
	Local_80.f_1 = { func_532() };
	Local_80.f_4 = func_531();
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110607) || Global_30738) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_543()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_545()) || Global_30738) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110607) || Global_30738) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110607) || Global_30738) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_545() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_544()) || func_548()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_545()) || Global_30738) || func_551()) || func_95(8, -1)) || func_549()) || func_543()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_545()) || func_549()) || Global_110607) || Global_30738) || func_551()) || Global_42561) || func_95(8, -1)) || func_543()) || func_548()) || func_544()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_545()) || Global_110607) || Global_30738) || func_551()) || func_95(8, -1)) || func_543()) || func_548()) || func_550()) || func_549()) || func_544())
						{
							return 0;
						}
						break;
...
int func_556(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_567())
	{
		...
		{
			iVar2 = func_557(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
void func_559(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_563()
{
	...
	iVar0 = func_564(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_567()
{
	...
	{
		if (func_557(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
