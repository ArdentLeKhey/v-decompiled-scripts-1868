								...
								if (!func_80())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											...
											func_74(iLocal_88[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_88[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_107)
										{
											...
											func_74(iLocal_86[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_86[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_108)
										{
											...
											func_74(iLocal_87[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_87[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
...
void func_1()
{
	...
	if (iLocal_282 && !iLocal_105)
	{
		...
		while (iVar0 < 4)
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_93[iVar0]))
			{
				HUD::REMOVE_BLIP(&(iLocal_93[iVar0]));
			}
			if (HUD::DOES_BLIP_EXIST(uLocal_95[iVar0]))
			{
				HUD::REMOVE_BLIP(&(uLocal_95[iVar0]));
			}
			if (iLocal_46 >= 6)
			{
...
void func_7(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_9() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_9() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_10(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_11(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_15(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_9() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_16(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_11(iParam1)];
...
void func_41()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_44(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_42(iVar0) && (!func_34(14) || Global_110511))
			{
...
void func_74(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_78(iParam0))
		{
			...
			{
				if (func_76(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_75(*uParam2))
					{
...
void func_81()
{
	...
	switch (iLocal_46)
	{
		...
		case 6:
			if (func_68())
			{
				fLocal_64 = MISC::GET_RANDOM_FLOAT_IN_RANGE(1.5f, 2.5f);
				...
				if (iLocal_78 < 5 && iLocal_79 < MISC::GET_GAME_TIMER())
				{
					...
					MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS((vLocal_50.x + fLocal_64), (vLocal_50.y + fLocal_65), (vLocal_50.z + fLocal_66), (vLocal_50.x - fLocal_64), (vLocal_50.y - fLocal_65), vLocal_50.z, 10, 0, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
...
void func_98(int iParam0, int iParam1)
{
	...
	ENTITY::SET_ENTITY_HEADING(iParam0, MISC::GET_HEADING_FROM_VECTOR_2D(vLocal_281.x, vLocal_281.y));
	if (bLocal_110)
	{
		if (!PED::IS_PED_INJURED(iParam1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (!PED::IS_PED_INJURED(iParam1))
				{
					TASK::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(iParam1, 32, 1);
				}
			}
			else
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, PLAYER::PLAYER_PED_ID(), 6, 20f, 786469, -1f, -1f, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
			{
	...
	else if (!PED::IS_PED_INJURED(iParam1))
	{
		...
		{
			TASK::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, PLAYER::PLAYER_PED_ID(), 2, 100f, 786469, -1f, -1f, 1);
		}
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(iParam0, ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
	}
}
		...
		case 3:
			...
			if (bLocal_107)
			{
				...
				while (iVar2 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(iLocal_83[iVar2], 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83[iVar2], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83[iVar2], 579380604) != 0)
						{
							TASK::CLEAR_PED_TASKS(iLocal_83[iVar2]);
							TASK::TASK_COMBAT_PED(iLocal_83[iVar2], PLAYER::PLAYER_PED_ID(), 0, 16);
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(iLocal_84[iVar3], 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_84[iVar3], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_84[iVar3], 579380604) != 0)
						{
							TASK::CLEAR_PED_TASKS(iLocal_84[iVar3]);
							TASK::TASK_COMBAT_PED(iLocal_84[iVar3], PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_80))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_101, 7f, 7f, 10f, false, true, 0))
				{
					...
					TASK::TASK_LOOK_AT_ENTITY(iLocal_80, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					if (!HUD::DOES_BLIP_EXIST(iLocal_90))
					{
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_81[iVar0]))
			{
				...
				else if (HUD::DOES_BLIP_EXIST(iLocal_92[iVar0]))
				{
		...
		if (!func_134())
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_48[7 /*3*/], 110f, 95f, 40f, false, true, 0))
			{
				...
				if ((!HUD::DOES_BLIP_EXIST(iLocal_91) && !HUD::DOES_BLIP_EXIST(iLocal_92[6])) && !HUD::DOES_BLIP_EXIST(iLocal_92[7]))
				{
					iLocal_91 = func_72(iLocal_80, 1, 145);
					iLocal_92[6] = func_72(iLocal_81[6], 1, 145);
					iLocal_92[7] = func_72(iLocal_81[7], 1, 145);
				}
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_91, false);
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_92[6], false);
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_92[7], false);
				func_107(1);
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_81[6]))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(iLocal_81[6])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_81[6]))
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_81[6], 0, 0);
			}
		}
	...
	switch (iLocal_75)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_81[6]))
			{
				...
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_81[6], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_81[6], 4000, 2048, 2);
			...
			if (!PED::IS_PED_INJURED(iLocal_81[7]))
			{
				...
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_81[7], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_81[7], 4000, 2048, 2);
		...
		case 1:
			...
			if (HUD::DOES_BLIP_EXIST(iLocal_92[6]))
			{
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_92[6], true);
			}
			if (HUD::DOES_BLIP_EXIST(iLocal_92[7]))
			{
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_92[7], true);
			}
...
int func_111()
{
	switch (func_112(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_115(iParam0, Global_41396);
}
...
void func_117()
{
	...
	else if (HUD::DOES_BLIP_EXIST(iLocal_91))
	{
		HUD::REMOVE_BLIP(&iLocal_91);
	}
	iVar0 = 0;
...
void func_118()
{
	...
	if ((((((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_m_chigoon_02")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_03"))) && STREAMING::HAS_MODEL_LOADED(joaat("REBEL"))) && STREAMING::HAS_MODEL_LOADED(joaat("BOBCATXL"))) && STREAMING::HAS_MODEL_LOADED(joaat("SANCHEZ"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_c_rottweiler"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		...
		while (iVar1 < iLocal_82)
		{
			...
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_51, vLocal_52, 100, 1, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
			iVar1++;
		}
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[0], "random@dealgonewrongdead_peds", "ped_b", -1635.928f, 4707.941f, 46.383f, -29.25f, 12.25f, 171.75f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[1], "random@dealgonewrongdead_peds", "ped_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[2], "random@dealgonewrongdead_peds", "ped_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[3], "random@dealgonewrongdead_peds", "ped_c", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[4], "random@dealgonewrongdead_peds", "ped_d", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_81[5], "random@dealgonewrongdead_peds", "ped_e", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_82[0], "random@dealgonewrongdead_peds", "dog_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_82[1], "random@dealgonewrongdead_peds", "dog_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_81[6], iVar3, "random@dealgonewrong", "base", 8f, -8f, 5, 0, 1148846080, 0);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_81[7], iVar4, "random@dealgonewrong", "idle_a", 8f, -8f, 5, 0, 1148846080, 0);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_80, iVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1148846080, 0);
		...
		if (func_40() == 0)
		{
			func_100(&uLocal_114, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		if (func_40() == 1)
		{
			func_100(&uLocal_114, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (func_40() == 2)
		{
			func_100(&uLocal_114, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		iLocal_99[0] = GRAPHICS::ADD_DECAL(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[1] = GRAPHICS::ADD_DECAL(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[2] = GRAPHICS::ADD_DECAL(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[3] = GRAPHICS::ADD_DECAL(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[4] = GRAPHICS::ADD_DECAL(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[5] = GRAPHICS::ADD_DECAL(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[6] = GRAPHICS::ADD_DECAL(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[7] = GRAPHICS::ADD_DECAL(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[8] = GRAPHICS::ADD_DECAL(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[9] = GRAPHICS::ADD_DECAL(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		iLocal_99[10] = GRAPHICS::ADD_DECAL(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
...
void func_120()
{
	...
	while (iVar0 < 5)
	{
		...
		while (iLocal_77 < 5)
		{
			...
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_54, vLocal_55, 1, 0, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y + fLocal_65), (vLocal_53.z + fLocal_66) };
			vLocal_55 = { (vLocal_53.x - fLocal_64), (vLocal_53.y - fLocal_65), vLocal_53.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_54, vLocal_55, 1, 0, joaat("WEAPON_ASSAULTRIFLE"), 0, 1, 1, -1082130432);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y - fLocal_65), (vLocal_53.z + fLocal_66) };
...
int func_134()
{
	if ((Global_111549 == func_65() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
int func_138(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_174(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_110607) || Global_30738) || func_171()) || func_95(8, -1)) || func_170()) || func_169()) || func_168()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_172()) || Global_30738) || func_171()) || func_95(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_110607) || Global_30738) || func_171()) || func_95(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_110607) || Global_30738) || func_171()) || func_95(8, -1)) || func_170()) || func_169()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_172() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_167()) || func_166()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_172()) || Global_30738) || func_171()) || func_95(8, -1)) || func_169()) || func_168()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_172()) || func_169()) || Global_110607) || Global_30738) || func_171()) || Global_42561) || func_95(8, -1)) || func_168()) || func_166()) || func_167()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_172()) || Global_110607) || Global_30738) || func_171()) || func_95(8, -1)) || func_168()) || func_166()) || func_170()) || func_169()) || func_167())
						{
							return 0;
						}
						break;
