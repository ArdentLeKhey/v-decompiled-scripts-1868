	...
	while (true)
	{
		...
		switch (func_33(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				...
				if ((!Global_37182 && func_32() != -1) && func_32() != 999)
				{
					if (!iLocal_63)
					{
...
void func_9()
{
	...
	if ((MISC::IS_BIT_SET(Global_2540191, iLocal_72) || MISC::IS_BIT_SET(Global_2540191.f_1, iLocal_72)) || MISC::IS_BIT_SET(Global_2540191.f_2, iLocal_72))
	{
		if (MISC::IS_BIT_SET(Global_2540191, iLocal_72))
		{
			MISC::SET_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
		}
		if (MISC::IS_BIT_SET(Global_2540191.f_1, iLocal_72))
		{
			MISC::CLEAR_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
		}
		if (MISC::IS_BIT_SET(Global_2540191.f_2, iLocal_72))
		{
...
int func_11()
{
	if (Global_2097152[func_12() /*10828*/].f_6168.f_2 >= 281)
	{
		Global_2097152[func_12() /*10828*/].f_6168.f_2 = -1;
		return -1;
	}
	return Global_2097152[func_12() /*10828*/].f_6168.f_2;
}
