#region Local Var
	...
	var uLocal_72 = 0;
	var uLocal_73 = 0;
	var uLocal_74 = 1097859072;
	var uLocal_75 = 1500;
	var uLocal_76 = 45;
	var uLocal_77 = 1103626240;
	var uLocal_78 = 5;
	var uLocal_79 = 0;
	var uLocal_80 = 16;
	var uLocal_81 = 0;
...
void __EntryFunction__()
{
	...
	iLocal_70 = 1;
	iLocal_246 = -1;
	vLocal_254 = { 405.8286f, -1627.996f, 28.2928f };
	fLocal_255 = 1f;
	...
	while (true)
	{
		if (func_152())
		{
			...
			{
				iLocal_273 = 0;
				func_2(&iLocal_272, iVar2, &uVar0, &iLocal_273, bVar1);
			}
			SYSTEM::WAIT(iLocal_273);
		}
		else
		{
			func_1();
...
void func_1()
{
	...
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_268))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_f_y_soucent_01"));
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_269))
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_269))
		{
			...
			if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_269))
			{
				VEHICLE::DELETE_VEHICLE(&iLocal_269);
			}
		}
		else
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("TOWTRUCK"));
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_269);
		}
	}
}
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		func_149(Global_111560.f_19968.f_3, &vVar1, &fVar3, &uVar0, &uVar2);
		if (Global_111560.f_19968.f_3 >= 5 || uLocal_257)
		{
			func_148(iParam1, vVar1, fVar3, iParam0);
		...
		switch (*iParam0)
		{
			case 0:
				...
				func_144(&(Global_111560.f_19968.f_1), 2048);
				func_144(&(Global_111560.f_19968.f_1), 4096);
				func_144(&(Global_111560.f_19968.f_1), 8192);
				func_144(&(Global_111560.f_19968.f_1), 16384);
				...
				if (func_150(iParam0, 0, 1))
				{
					...
					*iParam3 = 0;
					if (PAD::IS_CONTROL_JUST_PRESSED(0, 86) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 86))
					{
						func_117();
						func_115();
						vLocal_51.x = iLocal_268;
						vLocal_51.y = iLocal_269;
						*iParam0 = 16;
					}
				}
				break;
			...
			case 16:
				...
				*iParam3 = 0;
				iVar4 = func_107();
				func_144(&(Global_111560.f_19968.f_1), 1073741824);
				if (iVar4 == 1)
				{
					if (!bParam4)
					{
			...
			case 17:
				if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_245))
				{
					...
					else
					{
						func_21(&iLocal_45);
						func_3();
						func_144(&Global_110211, 3);
						func_1();
						func_23();
						iLocal_269 = 0;
						iLocal_268 = 0;
						if (func_22(Global_111560.f_19968.f_1, 2048))
						{
							iLocal_249 = 0;
						}
						else if (func_22(Global_111560.f_19968.f_1, 4096))
						{
							iLocal_249 = 10000;
						}
						else if (func_22(Global_111560.f_19968.f_1, 8192))
						{
							iLocal_249 = 60000;
						}
						else if (func_22(Global_111560.f_19968.f_1, 16384))
						{
							iLocal_249 = 120000;
						}
						else
						...
						func_144(&(Global_111560.f_19968.f_1), 8192);
						func_144(&(Global_111560.f_19968.f_1), 16384);
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_268) && !ENTITY::IS_ENTITY_DEAD(iLocal_268, 0))
						{
			...
			case 18:
				if (Global_98669 == 10)
				{
					...
					{
						bParam4 = true;
						if (iLocal_265 == joaat("TOWTRUCK"))
						{
							STREAMING::REQUEST_MODEL(joaat("TOWTRUCK"));
						}
						else if (iLocal_265 == joaat("towtruck2"))
						{
						...
						if (Global_111560.f_19968.f_3 >= 5)
						{
							if (STREAMING::HAS_MODEL_LOADED(iLocal_265))
							{
								...
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_269))
								{
									...
									iLocal_269 = VEHICLE::CREATE_VEHICLE(iLocal_265, 408.8376f, -1638.952f, 28.2928f, 230.2387f, true, true, false);
									STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_265);
								}
								if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_269, 0))
								{
									PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_269, -1);
									PED::SET_PED_COORDS_KEEP_VEHICLE(PLAYER::PLAYER_PED_ID(), 408.8376f, -1638.952f, 28.2928f);
									ENTITY::SET_ENTITY_HEADING(iLocal_269, 230.2387f);
									*iParam0 = 16;
								}
							}
						}
			...
			case 19:
				if ((MISC::GET_GAME_TIMER() - *uParam2) > iLocal_249)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
void func_23()
{
	if (func_22(uLocal_247, 1))
	{
		func_144(&uLocal_247, 1);
		func_21(&iLocal_246);
	}
	if (SCRIPT::IS_THREAD_ACTIVE(iLocal_245))
	{
		SCRIPT::TERMINATE_THREAD(iLocal_245);
	}
...
void func_25(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_98669 != 10 && Global_98669 != 9)
	{
		...
		func_27(&Global_102125, cParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_92877 = 0;
	}
}
...
void func_57()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_47(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(iVar0) && (!func_58(14) || Global_110511))
			{
...
int func_107()
{
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_51.z = 1;
			iLocal_245 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_51, 9, 29500);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_268, 0))
			{
				PED::SET_PED_KEEP_TASK(iLocal_268, true);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_268);
			STREAMING::REMOVE_ANIM_DICT("amb@world_human_smoking@male@male_a@base");
			STREAMING::REMOVE_ANIM_DICT("oddjobs@towingcome_here");
			func_108(&uLocal_247, 1);
			return 1;
		}
		else if (iVar0 == 0)
		{
...
{
	return func_113(iParam0, Global_41396);
}
...
void func_118()
{
	switch (iLocal_70)
	{
		case 1:
			if (!func_142())
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_141(&iLocal_58))
				{
					AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
					func_139(&iLocal_58);
				}
				else if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_141(&iLocal_58))
				{
					if (func_136(&iLocal_58) >= 2f)
					{
						iLocal_70 = 0;
					}
				}
		...
		case 0:
			if (!func_142())
			{
				func_135(&uLocal_80, 4, 0, "TOWDISPATCH", 0, 1);
				if (func_120(&uLocal_80, "TOWAUD", "TOW_DISP_GEN", 9, 0, 0, 0))
				{
					iLocal_70 = 2;
				}
			}
		...
		case 4:
			if (func_136(&iLocal_58) > 30f)
			{
				if (!func_22(Global_111560.f_19968.f_1, 1024))
				{
					func_119("TOW_MISSEDJOB", -1);
					func_108(&(Global_111560.f_19968.f_1), 1024);
				}
				iLocal_70 = 5;
			}
			break;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == iParam0)
			{
				...
				{
					iLocal_269 = iVar0;
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_269) && !ENTITY::IS_ENTITY_DEAD(iLocal_269, 0))
					{
						iLocal_265 = ENTITY::GET_ENTITY_MODEL(iLocal_269);
					}
					return 1;
				}
			}
...
void func_146(var uParam0, int iParam1)
{
	if (!func_150(uParam0, 0, 1))
	{
		if (func_143(iParam1))
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 86) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 86))
			{
				...
				{
					func_135(&uLocal_80, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_135(&uLocal_80, 4, 0, "TOWDISPATCH", 0, 1);
					if (func_120(&uLocal_80, "TOWAUD", "TOW_JOBS_AVL", 4, 0, 0, 0))
					{
						if (!func_141(&iLocal_67))
						{
							func_147(&iLocal_67);
						}
						else
	...
	if (iLocal_264)
	{
		if (func_141(&iLocal_67))
		{
			if (func_136(&iLocal_67) > 4f)
			{
				if (func_120(&uLocal_80, "TOWAUD", "TOW_NO_JOBS", 4, 0, 0, 0))
				{
					iLocal_264 = 0;
				}
			}
...
void func_148(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_71)
	{
		case 0:
			...
			if (fVar0 < 25f && !func_22(Global_111560.f_19968.f_1, 1073741824))
			{
				return;
			}
			if (bLocal_262)
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_254, fLocal_255) || func_22(Global_111560.f_19968.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_269))
					{
						iLocal_269 = VEHICLE::CREATE_VEHICLE(joaat("TOWTRUCK"), vParam1, fParam2, true, true, false);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("TOWTRUCK"));
						iLocal_71 = 3;
					}
				}
		...
		case 3:
			if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(iParam0, 0) == iLocal_269)
				{
					iLocal_71 = 0;
				}
			}
			if (ENTITY::IS_ENTITY_DEAD(iLocal_269, 0))
			{
				iLocal_71 = 0;
			}
			if (fVar0 > 62500f)
...
int func_150(var uParam0, bool bParam1, bool bParam2)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_248) < iLocal_249)
	{
		return 0;
	}
	return 1;
