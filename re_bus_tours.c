	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_63, 2.5f, 1.5f, 0f), 1, false, 0, 1);
...
void func_28(vector3 vParam0, int iParam1)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		if (!CAM::DOES_CAM_EXIST(iLocal_81) && !CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				CAM::SET_GAMEPLAY_COORD_HINT(vParam0, iParam1, 3000, 3000, 0);
				func_29(vParam0);
...
void func_30()
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_81))
	{
		...
		if ((iVar9 > 28 || iVar9 < -28) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		if ((iVar8 > 28 || iVar8 < -28) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		CAM::ATTACH_CAM_TO_ENTITY(iLocal_81, PLAYER::PLAYER_PED_ID(), vVar7.x, (vVar7.y - 1f), (vVar7.z + 1f), 1);
	}
	else
	{
		...
		CAM::RENDER_SCRIPT_CAMS(true, false, 2000, 1, 0, 0);
	}
}
	...
	if (!PED::IS_PED_INJURED(uLocal_59[2]))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_59[2], -880529684) == 7)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_89 + 8000)
			{
				...
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_59[2], MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) };
				iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(1000, 6000);
				TASK::TASK_LOOK_AT_COORD(uLocal_59[2], vVar0, iVar1, 2049, 2);
...
void func_36(vector3 vParam0, float fParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		MISC::CLEAR_AREA_OF_VEHICLES(vParam0.x, vParam0.y, vParam0.z, 5f, 0, 0, 0, 0, false, 0);
		ENTITY::SET_ENTITY_COORDS(iLocal_63, vParam0.x, vParam0.y, vParam0.z, 1, false, 0, 1);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_63, true, true, 0);
		if (iVar0 < 13)
		{
			if (!PED::IS_PED_INJURED(iLocal_57))
			{
		...
		switch (iLocal_48)
		{
			...
			case 1:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
				{
					if (iVar1 <= 13)
					{
						func_85(ENTITY::GET_ENTITY_COORDS(iLocal_63, true), Local_50[iVar1 /*15*/].f_1, &vLocal_77, &vLocal_78, 500);
					}
					if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA(vLocal_77.x, vLocal_77.y, vLocal_78.x, vLocal_78.y))
					{
...
void func_48(vector3 vParam0)
{
	...
	while (iVar0 < 5)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_61) > iLocal_60[iVar0] && iLocal_62[iVar0] == 0)
		{
			...
			{
				TASK::TASK_LOOK_AT_COORD(uLocal_59[iVar0], vParam0, 20000, 2050, 4);
			}
			iLocal_62[iVar0] = 1;
		}
		iVar0++;
...
int func_49()
{
	...
	switch (iLocal_86)
	{
		case 0:
			...
			ENTITY::SET_ENTITY_COORDS(iLocal_63, Local_51.f_1, 1, false, 0, 1);
			...
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 101.4382f, 250.0447f, 107.2579f, 1, false, 0, 1);
				...
				while (iLocal_88 < 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_59[iLocal_88]))
					{
						if (!PED::IS_PED_INJURED(uLocal_59[iLocal_88]))
						{
							...
							ENTITY::SET_ENTITY_COORDS(uLocal_59[iLocal_88], vVar1[iLocal_88 /*3*/], 1, false, 0, 1);
...
int func_87(int iParam0)
{
	...
	{
		if (AUDIO::_CAN_PED_SPEAK(iParam0, "TOUR_ABOUT_TO_START", 0))
		{
			return 1;
		}
	}
			...
			case 0:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_63, 8f, 8f, 5f, 0, 1, 0))
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 115.1136f, 241.6893f, 106.6493f, 1, false, 0, 1);
					}
				}
				PAD::_SWITCH_TO_INPUT_MAPPING_SCHEME("BusTours");
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
				{
					func_85(ENTITY::GET_ENTITY_COORDS(iLocal_63, true), Local_50[0 /*15*/].f_1, &vLocal_77, &vLocal_78, 500);
...
void func_97(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_99() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_99() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_103(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_99() /*10828*/].f_6168.f_10, iParam0);
}
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_126("TX_H02"))
			{
				if (func_157())
				{
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_67))
					{
						...
						HUD::SET_BLIP_SCALE(iLocal_67, Global_30782);
						if (!PED::IS_PED_INJURED(iLocal_58))
						{
...
int func_129(var uParam0)
{
	...
	*uParam0 = 0;
	if (PED::GET_CLOSEST_PED(vLocal_53, 100f, 1, 0, uParam0, 0, 0, 28))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_110607) || Global_30738) || func_166()) || func_23(8, -1)) || func_165()) || func_164()) || func_163()) || func_162()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_167()) || Global_30738) || func_166()) || func_23(8, -1)) || func_163()) || func_165()) || func_164()) || func_162()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_110607) || Global_30738) || func_166()) || func_23(8, -1)) || func_163()) || func_165()) || func_164()) || func_162()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_110607) || Global_30738) || func_166()) || func_23(8, -1)) || func_165()) || func_164()) || func_162()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_167() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_23(8, -1)) || func_162()) || func_161()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_30738) || func_166()) || func_23(8, -1)) || func_164()) || func_163()) || func_162()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_110607) || Global_30738) || func_166()) || func_23(8, -1)) || func_163()) || func_161()) || func_165()) || func_164()) || func_162())
						{
							return 0;
						}
						break;
...
{
	if (func_174(iParam0, &uLocal_90, &uLocal_87, iLocal_85, bLocal_91, 1077936128, 0) || PED::IS_PED_RAGDOLL(iParam0))
	{
		func_169(iParam0);
		return 1;
	}
...
void func_184()
{
	if (iLocal_75)
	{
		PATHFIND::_0x07FB139B592FA687(vLocal_77.x, vLocal_77.y, vLocal_78.x, vLocal_78.y);
	}
}
...
void func_186()
{
	...
	else
	{
		...
		if ((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_262)) && STREAMING::HAS_MODEL_LOADED(joaat("TOURBUS"))) && HUD::HAS_ADDITIONAL_TEXT_LOADED(2))
		{
			...
			PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vLocal_53, &uLocal_54, &uLocal_64, 1, 1077936128, 0);
			...
			iLocal_57 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_63, 26, iVar1, -1, 1, true);
			...
			iLocal_58 = PED::CREATE_PED(26, iVar0, 102.9893f, 248.5367f, 107.1759f, 329f, 1, true);
			...
			TASK::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_C", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_80, 1);
...
int func_197(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_224(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
...
void func_243()
{
	func_234(30000);
	func_242(&Global_30795);
	Global_30783 = MISC::GET_GAME_TIMER();
}
