...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_1006)
		{
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_1003, 200f, 200f, 200f, false, true, 0) && !CAM::IS_SPHERE_VISIBLE(vLocal_1003, 50f))
			{
				MISC::CLEAR_AREA(vLocal_1003, 50f, 1, 0, 0, false);
				iLocal_1006 = 1;
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_1003, 200f, 200f, 200f, false, true, 0))
		{
			iLocal_1006 = 0;
		}
		if (!iLocal_1011)
		{
			if (Global_95196.f_358 == MISC::GET_HASH_KEY("AHP1_TRUCKCALLED") || Global_95126)
			{
				func_98(543);
		...
		while (iVar0 <= 7)
		{
			...
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_834[iVar0], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 2500f)
				{
					PED::SET_PED_KEEP_TASK(iLocal_834[iVar0], true);
					TASK::TASK_SMART_FLEE_PED(iLocal_834[iVar0], PLAYER::PLAYER_PED_ID(), 300f, 20000, 1, 0);
		...
		switch (iLocal_1001)
		{
				...
				while (iVar1 < iLocal_834)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_834[iVar1]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID())))
						{
							...
							if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, 0) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iVar2, true)) < 30f) && VEHICLE::IS_VEHICLE_MODEL(iVar2, joaat("FIRETRUK")))
							{
			...
			case 0:
				...
				else
				{
					...
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_1003) < SYSTEM::POW(100f, 2f))
					{
					...
					if (bLocal_1012)
					{
						...
						{
							func_36(iLocal_833);
							if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_833) && ENTITY::IS_ENTITY_AT_COORD(iLocal_832, vLocal_1003, Global_19, true, true, 0))
							{
					...
					{
						func_36(iLocal_832);
						if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_832) && ENTITY::IS_ENTITY_AT_COORD(iLocal_832, vLocal_1003, Global_19, true, true, 0))
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_830))
							{
								HUD::REMOVE_BLIP(&iLocal_830);
				...
				{
					if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_832, true)) > 22500f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_832)) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_832, true)) > 90000f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
			...
			case 2:
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_832, 0))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_832, vLocal_1003, Global_19 + Vector(2f, 2f, 2f), true, true, 0))
					{
						iLocal_1001 = 0;
					}
					else if (bLocal_1012)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_833))
						{
							...
							{
								VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_832, false, 0);
								if (VEHICLE::IS_VEHICLE_SIREN_ON(iLocal_832))
								{
									VEHICLE::SET_VEHICLE_SIREN(iLocal_832, false);
								}
			...
			case 101:
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_832, 0))
				{
					...
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_832, true)) > 22500f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
...
void func_14(char* sParam0)
{
	...
	while (iVar0 < Global_95196.f_9)
	{
		...
		{
			PED::DELETE_PED(&(Global_95196.f_9[iVar0]));
		}
		iVar0++;
	}
...
int func_17()
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 226.6765f, -1668.942f, 25.46082f, 185.6446f, -1635.836f, 39.29184f, 57.75f, 0, true, 0))
			{
				return 1;
			}
		}
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		switch (iLocal_1014)
		{
			...
			case 1:
				...
				{
					if ((((PED::IS_PED_INJURED(func_92(iLocal_1015)) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) != func_92(iLocal_1015)) || !PED::IS_PED_IN_VEHICLE(func_92(iLocal_1015), iVar0, 0)) || !func_91(func_92(iLocal_1015))) || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 0))
					{
					...
					else
					{
						switch (iLocal_1035)
						{
							...
							case 1:
								if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA(Local_1018, Local_1018.f_1, Local_1020, Local_1020.f_1))
								{
									iLocal_1035++;
								}
								break;
							...
							case 2:
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_1015), iVar0, vLocal_1003, 15f, 0, joaat("FIRETRUK"), 786484, 5f, 5f);
								if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), vLocal_1003) > 250f)
								{
									VEHICLE::_0x182F266C2D9E2BEB(iVar0, SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_832, true), vLocal_1003));
								}
								iLocal_1035++;
								break;
							
							case 3:
								if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, 697.6884f, -1013.364f, 27.4968f, 688.3482f, -1013.179f, 22.32968f, 29.25f, 0, true, 0))
								{
									if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), vLocal_1016) < SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), vLocal_1017))
									{
										if (bLocal_1012)
										{
											TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_1015), iVar0, vLocal_1017, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
										}
										else
										{
											TASK::TASK_VEHICLE_PARK(func_92(iLocal_1015), iVar0, vLocal_1003, 180f, 1, 15f, 0);
										}
									}
									else if (bLocal_1012)
									{
										TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_1015), iVar0, vLocal_1016, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
									}
									else
									{
										TASK::TASK_VEHICLE_PARK(func_92(iLocal_1015), iVar0, vLocal_1003, 0f, 1, 15f, 0);
									}
									iLocal_1035++;
								}
								break;
...
void func_46()
{
	...
	bVar0 = false;
	if (!PED::IS_PED_INJURED(func_92(iLocal_1015)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
	{
		if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_832) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_832, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_832, 0)) && PED::IS_PED_IN_VEHICLE(func_92(iLocal_1015), iLocal_832, 0)) || (((ENTITY::DOES_ENTITY_EXIST(iLocal_833) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_833, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_833, 0)) && PED::IS_PED_IN_VEHICLE(func_92(iLocal_1015), iLocal_833, 0)))
		{
			bVar0 = true;
		}
	}
	switch (iLocal_1022)
	{
		case 0:
			...
			if (func_71(0, 1, 145, 0, iVar1, &cLocal_1023, &cLocal_1027, 1))
			{
				...
				if (func_28() == 1)
				{
					...
					func_69(&uLocal_836, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				else
				{
					func_69(&uLocal_836, 1, func_92(1), "FRANKLIN", 0, 1);
					func_69(&uLocal_836, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				}
				if (!iLocal_1032)
				{
		...
		case 2:
			...
			if (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || (!bLocal_1031 && !func_49()))
			{
				func_47();
				iLocal_1022 = 3;
				iLocal_1034 = MISC::GET_GAME_TIMER();
...
void func_95()
{
	...
	if (iLocal_1036 < 8)
	{
		if (iLocal_1036 < 4)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_95196.f_9[iLocal_1036]))
			{
				if (!PED::IS_PED_INJURED(Global_95196.f_9[iLocal_1036]))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_95196.f_9[iLocal_1036], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < 900f)
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196.f_9[iLocal_1036], true, 1);
						iLocal_834[iLocal_1036] = Global_95196.f_9[iLocal_1036];
						bVar0 = true;
						Global_95196.f_9[iLocal_1036] = 0;
					}
					else if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_95196.f_9[iLocal_1036], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_95196.f_9[iLocal_1036]))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196.f_9[iLocal_1036], true, 1);
						PED::DELETE_PED(&(Global_95196.f_9[iLocal_1036]));
					}
				}
			}
		}
		if (!bVar0)
		{
			if (PED::GET_CLOSEST_PED(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 30f, 1, 1, &iVar1, 0, 1, 21))
			{
				if ((ENTITY::DOES_ENTITY_EXIST(iVar1) && !PED::IS_PED_INJURED(iVar1)) && !func_96(iVar1, &iLocal_834))
				{
		...
		if (bVar0)
		{
			if (!PED::IS_PED_INJURED(iLocal_834[iLocal_1036]))
			{
				...
				PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, 0);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_834[iLocal_1036], 17, false);
				PLAYER::SET_WANTED_LEVEL_DIFFICULTY(PLAYER::PLAYER_ID(), 0f);
			}
			iLocal_1036++;
		}
...
void func_99()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(Global_95196[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[0], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_95196[0], 0))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], true, 1);
		iLocal_832 = Global_95196[0];
		Global_95196[0] = 0;
	}
	if ((ENTITY::DOES_ENTITY_EXIST(Global_95196[1]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[1], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_95196[1], 0))
	{
	...
	if (func_10(0))
	{
		...
		iLocal_834[0] = PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, 1, true);
		iLocal_834[1] = PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, 1, true);
		iLocal_834[2] = PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, 1, true);
		iVar1 = 0;
		while (iVar1 <= (iLocal_834 - 1))
		{
			if (!PED::IS_PED_INJURED(iLocal_834[iVar1]))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_834[iVar1], "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_834[iVar1], 17, false);
