	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 5:
			...
			if ((iVar6 != 1 && iVar6 != 0) || func_34(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar8, 5f))
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_43.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar9))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_43.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_43.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			iVar10 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar1], false), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
int func_72()
{
	if ((CAM::IS_SCREEN_FADED_OUT() && !func_85()) && !Global_2509232)
	{
		return 1;
	}
	if (!func_84())
...
int func_84()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 207.5193f, 5163.855f, -86.59737f, 211.7083f, 5163.879f, -83.6007f, 6.25f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
bool func_85()
{
	return MISC::IS_BIT_SET(Global_1676879.f_4, 10);
}
...
int func_86()
{
	if (Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
...
void func_87()
{
	func_88(0, &uLocal_162, 0, 2);
	func_88(1, &uLocal_162, 1, 1);
	func_88(2, &uLocal_162, 2, 2);
}
...
void func_88(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_93(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, fVar1 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_90(func_92(), func_91(iParam3, fVar1)) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_90(func_89(), func_91(iParam3, fVar1)) + vVar0 };
