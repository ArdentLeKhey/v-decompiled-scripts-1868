...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_377(52);
	iLocal_79 = joaat("a_c_retriever");
	vLocal_81 = { 1726.4f, 83.0424f, 169.67f };
	fLocal_82 = 328.7801f;
	...
	if (!func_335())
	{
		if ((func_317(Local_80.f_28[0]) && func_317(PLAYER::PLAYER_PED_ID())) && !func_316(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	while (true)
	{
		...
		func_299(Local_80.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (func_317(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_317(Local_91))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_91, 10f, 1))
					{
						func_297();
					}
				}
...
void func_8()
{
	switch (iLocal_85)
	{
		...
		case 1:
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_102, 0))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), iLocal_102, 1f, 1))
					{
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_297 == 0)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == 2)
					{
						iLocal_297 = 1;
					}
				}
				if (func_228(Local_91))
				{
					...
					{
						if ((MISC::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((MISC::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_85 = 2;
				}
			}
		...
		case 2:
			...
			{
				if (func_211(&uLocal_106, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0))
				{
					func_9();
				}
			}
...
void func_229()
{
	...
	while (MISC::GET_GAME_TIMER() < iLocal_296 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_294, false);
						...
						PED::_0x2208438012482A1A(Local_91, 0, 0);
						CAM::DESTROY_CAM(iLocal_285, 0);
						iLocal_301 = 1;
					}
				}
			}
		...
		else if (!iLocal_302)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_295, true);
		...
		if (MISC::GET_GAME_TIMER() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				CAM::DESTROY_CAM(iLocal_287, 0);
				iLocal_284 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", true);
				CAM::SET_CAM_PARAMS(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
	...
	if (func_317(Local_91))
	{
		if (iVar0 < 3)
		{
			...
			vVar4 = { ENTITY::GET_ENTITY_COORDS(Local_91, true) };
			if (vVar4.z > 155f)
			{
				fVar5 = 155f;
			}
			...
			ENTITY::SET_ENTITY_COORDS(Local_91, 1657.046f, -17.4571f, fVar5, 1, false, 0, 1);
		}
	}
	...
	if (func_228(Local_91))
	{
		...
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_91);
		PED::_0x2208438012482A1A(Local_91, 0, 0);
		ENTITY::SET_ENTITY_COORDS(Local_91, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEALTH(Local_91, 0, 0);
	}
	func_230(&uLocal_106, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_211(&uLocal_106, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}
...
void func_232(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_238(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_245()
{
	...
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						if (func_317(Local_91))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_91, "Dom", 0, joaat("cs_dom"), 0);
						}
						SYSTEM::WAIT(0);
						iLocal_305 = 0;
						...
						if (func_317(Local_91))
						{
							ENTITY::FREEZE_ENTITY_POSITION(Local_91, false);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_103) && !ENTITY::IS_ENTITY_DEAD(iLocal_103, 0))
						{
							ENTITY::SET_ENTITY_VISIBLE(iLocal_103, false, 0);
						}
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_96 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
							...
							{
								vLocal_272 = { 1649.793f, 11.7826f, 172.7745f };
								fLocal_273 = 220.9923f;
							}
							else
							{
								vLocal_272 = { 1662.016f, 53.0925f, 171.2482f };
								fLocal_273 = 298.6364f;
							}
							func_251(1654.721f, 4.166876f, 172.5245f, 1662.562f, -8.920052f, 178.2742f, 6.25f, vLocal_272, fLocal_273, 1, 1, 1, 0, 0);
						}
						else
						{
							vLocal_272 = { 1649.793f, 11.7826f, 172.7745f };
							fLocal_273 = 220.9923f;
							func_250(vLocal_272, fLocal_273);
						}
						func_247(1660.186f, -7.492f, 172.774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						MISC::CLEAR_AREA_OF_PEDS(1660.186f, -7.492f, 172.774f, 200f, 0);
						iLocal_288 = PED::ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_85 = 1;
					}
				}
			}
					...
					if (!iLocal_90)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
						{
							if (func_317(Local_91))
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_293, true);
								CAM::SET_CAM_ACTIVE(iLocal_285, true);
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_103) && !ENTITY::IS_ENTITY_DEAD(iLocal_103, 0))
			{
				ENTITY::SET_ENTITY_VISIBLE(iLocal_103, true, 0);
			}
			if (iLocal_87 == 0)
			{
...
void func_247(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_250(vector3 vParam0, float fParam1)
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			...
			{
				ENTITY::SET_ENTITY_COORDS(iVar0, vParam0, 1, false, 0, 1);
...
void func_251(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_252(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_252(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_256(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_254(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_255(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_256(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_258(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_257(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_257(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_257(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_257(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_257(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_257(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_257(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_257(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_257(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_257(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_257(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_257(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_257(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_257(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_257(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_257(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_257(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_264(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_264(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_267()
{
	...
	switch (iLocal_85)
	{
		case 0:
			...
			iLocal_94 = func_277(Local_91, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_85 = 1;
			break;
		...
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				if (func_317(Local_91))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_91, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (PED::IS_PED_RAGDOLL(Local_91))
					{
						ENTITY::SET_ENTITY_HEALTH(Local_91, 0, 0);
					}
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_91, 32f, 1))
					{
						if (func_271(Local_91, 1, 0, 0, 0))
						{
							if (iLocal_93 == 0)
							{
								if (!func_266())
								{
									func_270(&uLocal_106, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_93 = 1;
								}
							}
							else if (iLocal_93 == 1)
							{
								if (!func_266())
								{
									func_270(&uLocal_106, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_93 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_300)
							{
								if (func_316(PLAYER::PLAYER_PED_ID(), Local_91, 30f, 1) && !func_266())
								{
									if (func_211(&uLocal_106, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0))
									{
										iLocal_300 = 1;
									}
								}
							...
							func_269();
							if (!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), Local_91))
							{
								TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_91, -1, 0, 2);
							}
						}
					}
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_85 = 2;
...
void func_268()
{
	if (func_317(Local_91))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			TASK::TASK_PERFORM_SEQUENCE(Local_91, iLocal_95);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_290 < 5)
		{
			if (MISC::GET_GAME_TIMER() > (iLocal_291 + (8000 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))))
			{
				...
				{
					if (func_211(&uLocal_106, "EXT4AUD", "EXT4_DOM", 6, 0, 0, 0))
					{
	...
	if (!func_266())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
		{
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_289))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_289, "DOM", Local_91, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}
...
int func_274(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	{
		vVar1 = { func_258(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_275(vVar1, vVar0);
...
void func_280()
{
	...
	else
	{
		...
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
		func_244(800, 0);
		iLocal_88 = 1;
		func_287(1, 1, 1);
	}
...
void func_281()
{
	if (func_228(Local_80.f_28[0]))
	{
		func_285(Local_80.f_28[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_282(&(Local_80.f_28[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
	}
	TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_80.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 1048576000, 0, 1193033728);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	MISC::CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, 0, 0, 0, 0, false, 0);
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_97))
	{
		iLocal_97 = VEHICLE::CREATE_VEHICLE(joaat("SANCHEZ"), 1662.88f, -14.255f, 172.7742f, 205.3516f, true, true, false);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_98))
	{
		iLocal_98 = VEHICLE::CREATE_VEHICLE(joaat("BMX"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, true, true, false);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_100))
	{
		iLocal_100 = OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_101))
	{
		iLocal_101 = OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_101, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_91))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			...
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_95, 1);
	...
	if (func_317(Local_91))
	{
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_91, 0);
		func_230(&uLocal_106, 4, Local_91, "DOM", 0, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_91, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_103))
	{
		iLocal_103 = OBJECT::CREATE_AMBIENT_PICKUP(joaat("PICKUP_PARACHUTE"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	ENTITY::SET_ENTITY_ROTATION(iLocal_103, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	ENTITY::PLAY_ENTITY_ANIM(iLocal_103, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, 0, 0.99f, 0);
	func_246(1);
}

void func_282(int iParam0, vector3 vParam1, float fParam2)
{
	func_283(iParam0, iLocal_79, vParam1, fParam2, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, 0);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_283(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_284(iParam0);
...
int func_285(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_290(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_335())
	{
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_80.f_28[0])) && func_317(PLAYER::PLAYER_PED_ID())) && iLocal_305 == 1)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], -1, 0, 2);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(1);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_80.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
		...
		{
			if (func_316(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
			{
...
void func_297()
{
	...
	if (iLocal_305)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(1);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_91, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fVar1);
			CAM::_SET_GAMEPLAY_HINT_ANGLE(fVar2);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(fVar3);
...
void func_298()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_91, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
		...
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
...
{
	if (((!func_313(0) || Global_76846) || Global_76835 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
...
{
	return func_315(iParam0, Global_41396);
}
...
void func_318()
{
	...
	Local_91.f_5 = func_377(52);
	Local_91.f_9 = { 1660.324f, -11.7125f, 173.9638f };
	Local_91.f_12 = 119.6007f;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_99))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_99, 90f, 0f, -63f, 2, 1);
		ENTITY::FREEZE_ENTITY_POSITION(iLocal_99, true);
		ENTITY::SET_ENTITY_VISIBLE(iLocal_99, false, 0);
	}
	func_322(1);
	if (!ENTITY::DOES_ENTITY_EXIST(Local_91))
	{
		func_319(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
		ENTITY::FREEZE_ENTITY_POSITION(Local_91, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_91, true);
		WEAPON::REMOVE_ALL_PED_WEAPONS(Local_91, 1);
		PED::SET_PED_COMPONENT_VARIATION(Local_91, 8, 2, 0, 0);
		AUDIO::DISABLE_PED_PAIN_AUDIO(Local_91, true);
		PED::SET_PED_CONFIG_FLAG(Local_91, 137, true);
		PED::SET_PED_CONFIG_FLAG(Local_91, 118, false);
		PED::SET_PED_CONFIG_FLAG(Local_91, 208, true);
		PED::SET_PED_MONEY(Local_91, 5000);
	}
	if (func_228(PLAYER::PLAYER_PED_ID()))
	{
		func_230(&uLocal_106, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_319(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_320(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_320(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_336(int iParam0)
{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_288, 0);
	AUDIO::RELEASE_SCRIPT_AUDIO_BANK();
	func_348(&iLocal_100, 0);
	func_348(&iLocal_101, 0);
	func_348(&iLocal_102, 0);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", true);
	func_337(&Local_80, 1, 0, 0);
...
{
	func_337(&Local_80, 1, 0, 0);
	func_347(&(Local_80.f_28[0]), 1, 0, 1);
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar2 = func_354(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_355()
{
	...
	iVar0 = func_356(&(Global_98669.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_98669.f_3)) > -1)
		{
			return 1;
		}
	}
