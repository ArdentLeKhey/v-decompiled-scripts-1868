...
void func_40(int iParam0)
{
	...
	while (iVar1 < Global_111560.f_7683.f_198)
	{
		...
		{
			func_41(Global_111560.f_7683.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (CAM::GET_FOCUS_PED_ON_SCREEN(30f, 31086, 0.8f, 0.7f, 0.25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_48 = PED::CREATE_PED(26, joaat("u_m_m_streetart_01"), vLocal_49, fLocal_50, 1, true);
...
int func_95(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_133(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
