					...
					if (iVar1 != 2)
					{
						if ((!MISC::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_74(5))
						{
							...
							if (func_70())
							{
								...
								if (((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_30887) && (MISC::GET_GAME_TIMER() - iLocal_105) > 3000)
								{
									iVar4 = func_68();
									if (iVar4 == 0)
									{
			...
			case 8:
				if (func_70())
				{
					if (!func_21())
					{
						...
						iLocal_96 = SYSTEM::START_NEW_SCRIPT(&vLocal_97, 29500);
