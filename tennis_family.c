...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (func_285(uParam0, iVar8, *iParam2, func_309(uParam1)))
	{
		...
		ENTITY::SET_ENTITY_COORDS(uParam0->f_247, func_284(&(uParam0->f_247)), 1, false, 0, 0);
	...
	switch (func_309(uParam1))
	{
		case 0:
			...
			{
				HUD::CLEAR_PRINTS();
				ENTITY::SET_ENTITY_COORDS((uParam0[iParam3 /*94*/])->f_32, func_271(&(uParam0->f_189), func_273(uParam1), uParam0->f_1661, uParam0->f_1658, iParam3 == func_272(uParam1), iParam3), 1, true, 0, 1);
		...
		case 4:
			if (func_269(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_267(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, vVar13, MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, false));
					...
					func_267(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, vVar1, MISC::GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, false));
		...
		case 8:
			...
			bVar14 = (MISC::GET_GAME_TIMER() > func_255(uParam0[iParam3 /*94*/]) && MISC::GET_GAME_TIMER() > func_255(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && ENTITY::DOES_ENTITY_EXIST(uParam0->f_247))
					{
						fVar19 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve");
		...
		case 10:
			...
			vVar6 = { func_284(&(uParam0->f_247)) };
			if (vVar6.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && SYSTEM::VDIST2(uParam0->f_189.f_29, func_284(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_104(uParam1, (1 - func_272(uParam1)));
				func_270(uParam1, 14);
			}
		...
		case 12:
			...
			else if (vVar6.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && SYSTEM::VDIST2(uParam0->f_189.f_29, func_284(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_104(uParam1, (1 - func_178(uParam1)));
				func_270(uParam1, 14);
				if (func_64(uParam1) != iParam3 && uParam0->f_1657 != 1)
...
void func_28(var uParam0, char* sParam1, float fParam2)
{
	...
	{
		TASK::TASK_MOVE_NETWORK_BY_NAME(func_266(uParam0), sParam1, fParam2, 0, "mini@tennis", 4);
	}
}
...
void func_42()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_43(14) || Global_110511))
			{
...
void func_54(var uParam0, var uParam1)
{
	...
	if (!func_105(uParam0, 2048) && func_56(uParam0->f_37, uParam1))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 242628503) != 1)
		{
			...
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_266(uParam0), uParam1->f_29 + vVar0, 2f, 20000, 1048576000, 0, 1193033728);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_112(iParam3), 0);
}
...
Vector3 func_124(var uParam0, var uParam1, vector3 vParam2, int iParam3)
{
	...
	{
		fVar6 = func_125(0.4f, 1f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f));
...
int func_134(var uParam0, var uParam1, vector3 vParam2, bool bParam3)
{
	...
	vVar8 = { PED::GET_PED_BONE_COORDS(func_266(uParam0), 60309, 0f, 0f, 0f) };
	vVar9 = { vVar0 - vVar8 };
...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar11 = func_144(uParam0, &vVar12, &vVar13, &vLocal_322, &vLocal_324, &vLocal_325, 0, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
	...
	{
		iVar11 = func_144(uParam0, &vVar12, &vVar13, &vLocal_318, &vLocal_320, &vLocal_321, 1, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
			func_143(uParam0, 0.5f);
			func_142(uParam0, 1f);
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = MISC::_0x7F8F6405F4777AF6(vVar5, func_117(bParam6, *uParam5, *uParam4), func_117(bParam6, *uParam4, *uParam5), 0);
				...
				if ((uParam3[iVar18 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar14 == 0 && (iVar18 == 72 || iVar18 == 73))
						{
							...
							if (iVar18 == 72)
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_322, &vLocal_324, &vLocal_325, 0, &fVar24, &fVar25, &vVar16);
							}
							else
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_318, &vLocal_320, &vLocal_321, 1, &fVar24, &fVar25, &vVar16);
							}
							if (iVar23 != 0)
							{
...
int func_183(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (func_105(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_51(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar0 = func_51(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
		}
		vVar5 = { func_123(vVar6, vVar5, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f)) };
...
int func_215(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else if ((!PED::IS_PED_INJURED(func_266(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_105(uParam0[iParam1 /*94*/], 8192))
	{
		...
		PED::_0x2208438012482A1A(func_266(uParam0[iParam1 /*94*/]), 0, 0);
		func_59(uParam0[iParam1 /*94*/], 8192);
	}
...
void func_219(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar2 = (MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				TASK::TASK_PLAY_ANIM(0, func_196(func_197(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
	...
	{
		PED::_0x2208438012482A1A(func_266(uParam0), 0, 0);
	}
}
...
void func_228(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			ENTITY::SET_ENTITY_HEADING(uParam0->f_32, ENTITY::GET_ENTITY_HEADING(uParam0->f_32));
			func_59(uParam0, 16384);
			fVar2 = (MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam8, 180f, 0f));
			vVar3 = { uParam1->f_189.f_29 - ENTITY::GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_70(vVar3, uParam0->f_40) < 0f;
			bVar5 = func_70(vVar3, uParam0->f_43) < 0f;
			func_223(uParam0, 0);
...
void func_237(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		if (!PED::IS_PED_INJURED(func_266(uParam0)) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_266(uParam0)))
		{
			...
			TASK::SET_TASK_MOVE_NETWORK_SIGNAL_BOOL(func_266(uParam0), &(uParam1->f_1670), 1);
	...
	switch (func_148(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_76(uParam0) == 75)
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(func_266(uParam0), vVar1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_71(&(uParam0->f_4)), vVar2, false, true, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073) == 7) && !func_229(&(uParam0->f_4), 256))
				{
					func_236(&(uParam0->f_4), 0);
					func_218(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_76(uParam0) == 75)
			{
				MISC::_0xF56DFB7B61BE7276(func_284(uParam4), func_284(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				if (((!PED::IS_PED_INJURED(func_266(uParam0)) && !SYSTEM::VDIST2(uParam0->f_37, vVar1) <= (0f * 0f)) && !func_229(&(uParam0->f_4), 4)) && !func_105(uParam0, 1024))
				{
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, vVar1) <= (0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073) == 7)
				{
...
void func_263(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_266(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_266(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam1 /*94*/]), 28422), vLocal_316, vLocal_317, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam2 /*94*/]), 28422), vLocal_316, vLocal_317, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	vVar0 = { 0f, 0f, 1f };
	fVar1 = func_145(fParam9 == -1f, MISC::GET_FRAME_TIME(), fParam9);
	iVar2 = 0;
...
void func_306(int iParam0)
{
	switch (Global_93705[iParam0])
	{
		...
		default:
			Global_111560.f_18509[iParam0] = Global_93705[iParam0];
			break;
	}
}
...
int func_307(var uParam0, int iParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			TASK::TASK_SEEK_COVER_FROM_PED(func_266(uParam0[(1 - iParam1) /*94*/]), PLAYER::PLAYER_PED_ID(), -1, 0);
		}
		return 1;
	}
	if (PED::IS_PED_INJURED(iVar0))
...
void func_332()
{
	...
	if (Global_111560.f_9080 || func_341(0))
	{
		if (!func_340())
		{
			iVar0 = func_339();
...
int func_334(int iParam0)
{
	...
	func_335(&(Global_111560.f_2358.f_539), iVar1);
...
void func_335(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_337(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
