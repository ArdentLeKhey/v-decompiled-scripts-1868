...
void func_3()
{
	func_4(&(Global_102125.f_2890), &Global_102125, 0, 1, 1, 0);
}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_24(14) || Global_110511))
			{
...
{
	return func_30(iParam0, Global_41396);
}
...
void func_31(int iParam0)
{
	...
	if (iLocal_43 != 9)
	{
		if (!Global_111560.f_19978.f_13)
		{
			if (Global_111560.f_19978.f_1 == 0 && Global_111560.f_19978.f_2 == 0)
			{
				if (!func_170(Global_111560.f_19978, 32))
				{
					func_167("MG_TRAF_AVAIL", 0, 0, -1, 10000, 7, 0, 0, 0);
					func_165(&(Global_111560.f_19978), 32);
				}
			}
			func_1(106, 1, 0);
			Global_111560.f_19978.f_13 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			if (STREAMING::HAS_MODEL_LOADED(joaat("DUNE")))
			{
				...
				iLocal_44 = VEHICLE::CREATE_VEHICLE(func_162(), vLocal_45, fLocal_46, true, true, false);
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = func_131(&iLocal_33, 6, 9, 0, 0);
					iLocal_37 = 1;
				}
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_30 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 29500);
					func_81(16);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_111560.f_19978.f_12 = iVar5;
					func_1(106, 0, 0);
					Global_111560.f_19978.f_13 = 0;
				}
				*iParam0 = 0;
				func_43(&Global_110211, 2);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_32(Global_111560.f_19978.f_12))
			{
				func_163(0);
				iLocal_43 = 1;
			}
...
void func_83(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_98669 != 10 && Global_98669 != 9)
	{
		...
		func_85(&Global_102125, cParam0, 0, "Start", iParam1, iParam2);
		func_84();
		Global_92877 = 0;
	}
}
...
int func_91(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_89(iParam1)];
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_96(iParam0, &(Global_111560.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_96(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_98(Var7.f_1)) && iVar9 < 51)
			{
...
int func_113(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_129(iVar0))
		{
...
Vector3 func_114(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_125(Global_100764);
			break;
		
		case 46:
			if (Global_1590285 != func_124())
			{
				if (func_123(Global_1590285))
				{
					return func_116(2, 2);
				}
				else if (func_115(Global_1590285))
				{
...
void func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_152(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_111560.f_32744.f_4801 = func_53();
			}
...
void func_135(int iParam0, int iParam1)
{
	...
	func_14(iParam0, &(Global_111560.f_32744.f_5510));
}

int func_136(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_150(iParam0)) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || !func_137(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_149(iParam0))
		{
		}
...
int func_152(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_106(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_106(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_106(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_153(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_152(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_158(iParam0);
			func_157(uParam1, &(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_171(int iParam0)
{
	...
	if (iLocal_39 != 9)
	{
		if (!Global_111560.f_19978.f_14)
		{
			func_1(105, 1, 0);
			Global_111560.f_19978.f_14 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("CUBAN800")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_40))
				{
					...
					func_165(&(Global_111560.f_19978), 128);
					iLocal_39 = 4;
				}
				else
				{
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					iLocal_30 = SYSTEM::START_NEW_SCRIPT("Traffick_Air", 29500);
					func_81(15);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_111560.f_19978.f_11 = uVar4;
					func_1(105, 0, 0);
					Global_111560.f_19978.f_14 = 0;
					iLocal_39 = 9;
				}
				*iParam0 = 0;
				func_43(&Global_110211, 1);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_32(Global_111560.f_19978.f_11))
			{
				func_172(0);
				iLocal_39 = 1;
			}
...
void func_172(bool bParam0)
{
	...
	if (func_170(Global_111560.f_19978, 128))
	{
		func_43(&(Global_111560.f_19978), 128);
	}
	iLocal_41 = 0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_130()) || func_181()) || func_174()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_182()) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_182() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_175(8, -1)) || func_180()) || func_179()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_182()) || Global_30738) || func_176()) || func_175(8, -1)) || func_181()) || func_174()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_182()) || func_181()) || Global_110607) || Global_30738) || func_176()) || Global_42561) || func_175(8, -1)) || func_174()) || func_179()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_179()) || func_130()) || func_181()) || func_180())
						{
							return 0;
						}
						break;
	...
	while (iVar0 < 8)
	{
		if (Global_95632[iVar0 /*17*/] && !Global_95632[iVar0 /*17*/].f_1)
		{
			if (Global_95632[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_191(Global_95632[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
