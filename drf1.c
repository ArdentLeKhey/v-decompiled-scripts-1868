...
void __EntryFunction__()
{
	...
	StringCopy(&vLocal_387, "Michael", 24);
	StringCopy(&vLocal_391, "Therapist", 24);
	vLocal_395 = { -1907.785f, -574.8f, 18.616f };
	vLocal_396 = { -1895.534f, -564.2134f, 11.3497f };
	fLocal_397 = 179f;
	fLocal_398 = 314.381f;
	fLocal_399 = 54.08f;
	MISC::SET_MISSION_FLAG(1);
	StringCopy(&cVar10, "DrfAud", 16);
	iLocal_404 = func_273(func_274(), 0, 1);
	iLocal_405 = func_273(func_274(), 0, 1);
	iLocal_406 = func_273(func_274(), 0, 1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		func_272();
		if (bVar13)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_380) && PED::IS_PED_INJURED(iLocal_380))
			{
				func_271(80, 1);
				STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), true, 1);
			}
			func_269(0, 0);
		}
		else
		...
		func_254(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
	}
	iLocal_62 = func_253();
	func_252(&Local_61, iLocal_62);
	FIRE::STOP_FIRE_IN_RANGE(-1899.756f, -561.3688f, 10.78784f, 100f);
	MISC::SET_BIT(&(Global_111560.f_10011.f_25), 6);
	switch (func_253())
	{
		case 0:
			fVar12 = 3.6f;
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				func_245();
				while (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					SYSTEM::WAIT(0);
				}
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 1048576000, 0, 1193033728);
				iVar8 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				iVar9 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
			...
			case 1:
				if (!bVar4)
				{
					...
					{
						func_234(&iLocal_379, iLocal_55, vLocal_395, fLocal_397, iLocal_404, iLocal_405, iLocal_406);
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
							...
							{
								func_139(&vLocal_387, PLAYER::PLAYER_PED_ID(), 0, 2);
							}
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_379, 0))
							{
								func_139(&vLocal_391, iLocal_379, 0, 2);
							}
							bVar5 = true;
						}
					}
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_379, 0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &vLocal_387, 0, 0, 0);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_379, &vLocal_391, 0, 0, 0);
					}
			...
			case 2:
				if (CAM::DOES_CAM_EXIST(iVar8))
				{
					CAM::DESTROY_CAM(iVar8, 0);
				}
				if (CAM::DOES_CAM_EXIST(iVar9))
				{
					CAM::DESTROY_CAM(iVar9, 0);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_387, 0))
				{
					func_134(iLocal_379, 1, 0);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_391, 0))
				{
					func_134(iLocal_379, 0, 1);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					func_133(iLocal_379, &iLocal_381, &iLocal_382, &iLocal_384, &uLocal_63, vLocal_396, fLocal_399, iLocal_57);
					func_131(func_253());
					func_244(&iLocal_231);
					func_130(&iLocal_255, 0, 0, 0, 1);
					func_129(&iLocal_255, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_129(&iLocal_255, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					bVar5 = false;
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					iLocal_60 = 3;
			...
			case 3:
				func_122();
				if (CAM::IS_SCREEN_FADED_OUT() || bVar14)
				{
					if (bVar14)
					{
					...
					func_121(&iLocal_231);
					while (func_137(&iLocal_231) < 0.4f)
					{
						SYSTEM::WAIT(0);
						func_122();
					}
				...
				if (!bVar2)
				{
					if (!bLocal_407 && !CUTSCENE::IS_CUTSCENE_ACTIVE())
					{
						Local_61.f_20 = 0;
						func_109(&(Local_61.f_12), &Local_61, func_253());
						bLocal_407 = true;
					}
					if (func_99(&iLocal_231, &iLocal_255, &bVar1))
					{
						if (bVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_137(&iLocal_231) >= 14f)
					{
						Local_61.f_20 = 2;
						bVar2 = true;
						HUD::CLEAR_HELP(1);
					}
					else if (!bVar3 && func_137(&iLocal_231) >= 7f)
					{
						StringCopy(&cVar11, "DRF_PROMPT", 16);
						func_98(&uLocal_63, &cVar10, &cVar11, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if ((func_137(&iLocal_231) > 5f && func_136()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_137(&iLocal_231) > fVar12) || func_95(iLocal_62, iLocal_379, &iLocal_384))))
				{
					func_92();
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_398);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
							func_80(0, 1, 1, 0, 0, 0);
							iLocal_382 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382))
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_382, 0))
								{
									ENTITY::SET_ENTITY_COORDS(iLocal_382, func_79(iLocal_382), 1, false, 0, 1);
				...
				else
				{
					...
					if (!iLocal_409)
					{
						if (CUTSCENE::_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_137(&iVar7) > func_76(func_253()))
							{
								if (func_253() == 4)
								{
									iLocal_380 = PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, true);
									...
									func_75(&uLocal_63, 1, iLocal_380, "FRIEDLANDER", 0, 1);
								}
								iLocal_409 = 1;
							}
						}
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
				{
					func_271(80, 1);
					STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), true, 1);
					func_98(&uLocal_63, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (HUD::DOES_BLIP_EXIST(iLocal_383))
					{
						HUD::SET_BLIP_COLOUR(iLocal_383, 1);
					}
					iLocal_60 = 17;
				}
				else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_380) || func_74(iLocal_380, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					func_98(&uLocal_63, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (HUD::DOES_BLIP_EXIST(iLocal_383))
					{
						HUD::SET_BLIP_COLOUR(iLocal_383, 3);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_380))
					{
						MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_380, true), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_57();
					PED::SET_PED_CONFIG_FLAG(iLocal_380, 26, true);
					if (func_77(&iLocal_246))
					{
						if (func_137(&iLocal_246) > 2.5f)
						{
							PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 1000, 0, 1, 0);
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
							func_135(&iLocal_246);
						}
					}
					if (!iLocal_411)
					{
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (func_137(&iLocal_243) > 2f)
						{
							switch (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE())
							{
								case 0:
									vVar16 = { -1905.289f, -560.9047f, 12.5379f };
									vVar17 = { -8.9999f, 0f, -99.8165f };
									break;
								
								case 1:
									vVar16 = { -1908.006f, -560.4351f, 12.6592f };
									vVar17 = { -3f, 0f, -99.8148f };
									break;
								
								case 2:
									vVar16 = { -1908.759f, -558.642f, 13.4942f };
									vVar17 = { -12.0007f, 0f, -115.8697f };
									break;
								
								case 4:
									vVar16 = { -1904.658f, -560.0228f, 12.4975f };
									vVar17 = { -10.0948f, 0.0099f, -128.3421f };
									break;
							...
							iLocal_384 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vVar16, vVar17, 50f, 0, 2);
							CAM::SET_CAM_ACTIVE_WITH_INTERP(iLocal_384, iLocal_385, 2660, 1, 1);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382) && !ENTITY::IS_ENTITY_DEAD(iLocal_382, 0))
							{
								VEHICLE::SET_VEHICLE_FIXED(iLocal_382);
								ENTITY::SET_ENTITY_INVINCIBLE(iLocal_382, false);
								VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_382, true);
							}
							func_121(&iLocal_243);
							iLocal_411 = 1;
						}
					...
					else if (CAM::DOES_CAM_EXIST(iLocal_385))
					{
						if (func_137(&iLocal_243) >= 2.66f)
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(func_56(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 2, -16f, 0f));
							CAM::RENDER_SCRIPT_CAMS(false, true, 340, 0, 0, 0);
					...
					if (iLocal_410 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_54(&iLocal_237, 0.5f))
						{
							...
							else if (HUD::GET_BLIP_COLOUR(iLocal_383) != 3)
							{
								HUD::SET_BLIP_COLOUR(iLocal_383, 3);
								if (func_77(&iLocal_240))
								{
									if (func_137(&iLocal_240) < (7500f / 1000f))
									{
					...
					{
						func_51(&iLocal_237, 0.3f);
					}
					if (!PED::IS_PED_INJURED(iLocal_380))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_381))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_380, 0))
							{
								iVar0 = 1;
							}
							if (!PED::IS_PED_FLEEING(iLocal_380))
							{
								if ((((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_381, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_381, 1)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_381, 0, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_381, 1, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_381, 2, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_381, 3, 2000)) || (iVar0 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_380, 0))) || func_50(iLocal_381)) || func_46(iLocal_381))
								{
									TASK::TASK_SMART_FLEE_PED(iLocal_380, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
								}
							}
						}
						else if (!PED::IS_PED_FLEEING(iLocal_380))
						{
							TASK::TASK_SMART_FLEE_PED(iLocal_380, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
						}
						if (!bVar15 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_380, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, true, 0))
						{
			...
			case 16:
				if (!func_77(&iLocal_234))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_244(&iLocal_234);
				}
				else if (func_137(&iLocal_234) > 2f)
				{
					func_2(func_40(), 24, func_39(iLocal_62));
					func_272();
					func_269(0, 0);
					func_254(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
				}
			...
			case 17:
				...
				if (func_137(&iLocal_234) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
					HUD::REMOVE_BLIP(&iLocal_383);
					if (CAM::DOES_CAM_EXIST(iLocal_384))
					{
						CAM::DESTROY_CAM(iLocal_384, 0);
					}
					...
					if (!func_1(80))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_380))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_381) && PED::IS_PED_IN_VEHICLE(iLocal_380, iLocal_381, 0))
							{
								VEHICLE::DELETE_VEHICLE(&iLocal_381);
							}
						}
						PED::DELETE_PED(&iLocal_380);
					}
...
void func_6(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_8() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_8() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_10(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_14(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_8() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_15(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_10(iParam1)];
...
int func_21(int iParam0, int iParam1)
{
	...
	if (func_31(&Global_4269915))
	{
		if (func_29(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_22(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
void func_25(var uParam0)
{
	...
	func_27(uParam0, (Global_4269914 - 0.5f));
}
...
void func_41()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_44(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_42(iVar0) && (!func_33(14) || Global_110511))
			{
...
int func_46(int iParam0)
{
	...
	if ((func_49(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_47(iParam0))
	{
...
void func_57()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_380) || ENTITY::IS_ENTITY_DEAD(iLocal_380, 0)) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		return;
	}
	if (!func_77(&iLocal_249))
	{
		func_244(&iLocal_249);
	}
	if (!func_77(&iLocal_252))
	{
		func_244(&iLocal_252);
	}
	fVar3 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_380, true));
	if (iLocal_401 < 7)
	{
		if (iLocal_401 <= 0)
		{
			if (func_137(&iLocal_249) > 0.2f)
			{
				iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(0, 7);
				MISC::SET_BIT(&iLocal_400, iVar1);
				StringCopy(&Var0, "DRF_RUNOFF_", 16);
				StringIntConCat(&Var0, iVar1 + 1, 16);
				func_58(&uLocal_63, "DrfAud", "DRF_RUNOFF", &Var0, 8, 0, 0);
				iLocal_401 = 1;
				func_121(&iLocal_249);
			}
		}
		else if (func_137(&iLocal_249) > 12f)
		{
			if (fVar3 <= 144f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
			{
				iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(0, (7 - iLocal_401));
				while (iVar2 >= 0 && iVar2 < 7)
				{
					if (!MISC::IS_BIT_SET(iLocal_400, iVar2))
					{
						if (iVar1 == 0)
						{
							MISC::SET_BIT(&iLocal_400, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
	...
	if (iLocal_403 < 8)
	{
		if (iLocal_403 <= 0)
		{
			if (func_137(&iLocal_252) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
				iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
				MISC::SET_BIT(&iLocal_402, iVar1);
				StringCopy(&Var0, "DRF_CHASE_", 16);
				StringIntConCat(&Var0, iVar1 + 1, 16);
				func_58(&uLocal_63, "DrfAud", "DRF_CHASE", &Var0, 8, 0, 0);
				iLocal_403 = 1;
				func_121(&iLocal_252);
			}
		}
		else if (func_137(&iLocal_252) > 10.3f)
		{
			if (fVar3 <= 2500f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
				iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(0, (8 - iLocal_403));
				iVar2 = 0;
				while (iVar2 >= 0)
				{
					if (!MISC::IS_BIT_SET(iLocal_402, iVar2))
					{
						if (iVar1 == 0)
						{
							MISC::SET_BIT(&iLocal_402, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
			...
			{
				func_51(&iLocal_252, 5f);
			}
		}
	}
	if (((!iLocal_410 && iLocal_401 >= 1) && iLocal_403 >= 1) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		iLocal_410 = 1;
	}
}
...
Vector3 func_79(int iParam0)
{
	...
	return Vector(10.7548f, -555.7014f, -1900.292f) - Vector(Var5, Var5, Var5) * Vector(0f, -0.7771f, -0.6293f) - Vector(Var5.f_1, Var5.f_1, Var5.f_1) * Vector(0f, -0.6293f, 0.7771f);
}

void func_80(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_86(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_90()
{
	...
	if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_381, 0))
	{
		VEHICLE::DELETE_VEHICLE(&iLocal_381);
		iLocal_381 = VEHICLE::CREATE_VEHICLE(iLocal_57, vLocal_396, fLocal_399, true, true, false);
	...
	if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_381, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_381, 0))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1907.827f, -560.0641f, 10.8064f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 260.195f);
		ENTITY::SET_ENTITY_COORDS(iLocal_381, vLocal_396, 1, false, 0, 1);
		...
		if ((!iLocal_409 || !ENTITY::DOES_ENTITY_EXIST(iLocal_380)) || ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
		{
			iLocal_380 = PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_380, 3, iLocal_404, iLocal_405, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_380, 4, 0, iLocal_406, 0);
		...
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_380, -1899.7f, -562.2f, 10.7945f, 1, false, 0, 1);
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			while (!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || (!PED::IS_PED_INJURED(iLocal_380) && !PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_380)))
			{
				SYSTEM::WAIT(0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		...
		fVar0 = 2f;
		if (!PED::IS_PED_INJURED(iLocal_380) && !ENTITY::IS_ENTITY_DEAD(iLocal_381, 0))
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_386);
			TASK::TASK_ENTER_VEHICLE(0, iLocal_381, -1, -1, fVar0, 1, 0);
			TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_381, -1783.73f, -629.1945f, 9.89f, 20f, 0, ENTITY::GET_ENTITY_MODEL(iLocal_381), 786484, 10f, 12f);
			...
			PED::FORCE_PED_MOTION_STATE(iLocal_380, -530524, true, 1, 1);
		}
		iLocal_383 = HUD::ADD_BLIP_FOR_ENTITY(iLocal_380);
		HUD::SET_BLIP_COLOUR(iLocal_383, 1);
		func_121(&iLocal_237);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		iLocal_385 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
		HUD::DISPLAY_RADAR(false);
		HUD::DISPLAY_HUD(false);
	}
	MISC::CLEAR_AREA(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, false);
...
int func_95(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_96())
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iParam1))
		{
			...
			{
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar1, &Var3, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(iParam1, &cVar1, &cVar4, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar2, &cVar5, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				TASK::TASK_PLAY_ANIM(iParam1, &cVar2, &cVar6, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iParam1, 0, 0);
				if (CAM::DOES_CAM_EXIST(*iParam2))
				{
					CAM::DESTROY_CAM(*iParam2, 0);
				}
				if (!CAM::DOES_CAM_EXIST(*iParam2))
				{
					*iParam2 = CAM::CREATE_CAMERA(26379945, 0);
				}
...
int func_99(int iParam0, int iParam1, var uParam2)
{
	bool bVar0;
	bool bVar1;
	...
	func_100(iParam1, 1128792064, 1, 0, 1, 1065353216);
	return 0;
}
...
struct<4> func_111(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_119() <= 0)
	{
		if (!func_118())
		{
			iVar1 = func_115(1, 2, 3, 4, 12);
		}
		else if (func_114() >= 1)
		{
			iVar1 = func_115(5, 6, 7, 0, 0);
		}
		else
		{
			iVar1 = func_115(5, 7, 0, 0, 0);
		}
	}
	else if (func_119() >= 2)
	{
		iVar1 = func_115(10, 11, 0, 0, 0);
	}
	else if (!func_118())
	{
		if (iParam2 != 4)
		{
			iVar1 = func_115(8, 9, 0, 0, 0);
		}
		else
		{
			iVar1 = 9;
	...
	{
		iVar1 = func_115(8, 9, 10, 0, 0);
	}
	else
	{
		iVar1 = func_115(9, 10, 0, 0, 0);
	}
	func_113(uParam0, iVar1);
	if (bParam3)
	{
		func_112(&(Global_111560.f_19956), iVar1, 1);
	}
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_117(&(Global_111560.f_19956), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_117(&(Global_111560.f_19956), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_117(&(Global_111560.f_19956), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_117(&(Global_111560.f_19956), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_117(&(Global_111560.f_19956), iParam4))
	{
		iVar2[iParam4] = 0;
	}
...
int func_129(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_130(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (*uParam0 == 0)
	{
...
void func_133(int iParam0, var uParam1, int iParam2, int iParam3, var uParam4, vector3 vParam5, float fParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	*iParam2 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		...
		else
		{
			...
			{
				iVar1 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam2, -1, 0);
	...
	{
		*uParam1 = Global_95196[0];
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*uParam1, true, 1);
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = VEHICLE::CREATE_VEHICLE(iParam7, vParam5, fParam6, true, true, false);
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*iParam2, true, 0);
		}
	}
	func_75(uParam4, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_75(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (CAM::DOES_CAM_EXIST(*iParam3))
	{
		CAM::DESTROY_CAM(*iParam3, 0);
	}
	if (!CAM::DOES_CAM_EXIST(*iParam3))
	{
		*iParam3 = CAM::CREATE_CAMERA(26379945, 0);
	}
...
void func_134(int iParam0, int iParam1, int iParam2)
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1907.39f, -577.33f, 17.64f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 318.6574f);
		TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar1, &cVar3, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar2, &cVar5, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	}
	if (iParam2 && !PED::IS_PED_INJURED(iParam0))
	{
		ENTITY::SET_ENTITY_COORDS(iParam0, -1907.69f, -574.77f, 17.67f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(iParam0, 177f);
		TASK::TASK_PLAY_ANIM(iParam0, &cVar1, &cVar4, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(iParam0, &cVar2, &cVar6, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
...
void func_139(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar1;
...
void func_140(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_217(iVar4, func_219(iVar0), func_218(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_219(iVar0)), &uVar1))
			{
				Var3 = { func_151(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_149(iVar4, func_219(iVar0), func_218(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_219(iVar0)), &uVar1))
			{
				Var3 = { func_151(iVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_217(iVar4, 14, func_142(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_151(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_149(iVar4, 14, func_142(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_151(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_218(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_218(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_141(iVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_151(iVar4, 0, iVar9, -1) };
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_146(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_145(iParam0, func_146(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
...
void func_153(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_162(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_154(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_15(func_157(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_15(func_156(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_15(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_146(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_221(int iParam0, var uParam1)
{
	...
	iVar0 = Global_2576213[iParam0 /*3*/][func_10(uParam1)];
...
struct<4> func_226(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	struct<4> Var0;
	int iVar1;
	int iVar2;
	...
	if ((((!func_231(&(Global_111560.f_19956), 8) && iParam1) && iParam0 != 4) && func_229(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_231(&(Global_111560.f_19956), 1) && func_229(5) > 0)
		{
			MISC::SET_BIT(&iVar2, 1);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 2) && func_229(7) >= 2)
		{
			MISC::SET_BIT(&iVar2, 2);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 3) && ((((func_229(8) > 0 || func_229(9) > 0) && func_229(7) > 0) && iParam1) && iParam0 != 4))
		{
			MISC::SET_BIT(&iVar2, 3);
			iVar3++;
		}
		if ((!func_231(&(Global_111560.f_19956), 4) && func_229(1) > 0) && func_229(1) < 3)
		{
			MISC::SET_BIT(&iVar2, 4);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 5) && func_229(1) >= 3)
		{
			MISC::SET_BIT(&iVar2, 5);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 6) && func_229(0) > 0)
		{
			MISC::SET_BIT(&iVar2, 6);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 7))
		{
			MISC::SET_BIT(&iVar2, 7);
			iVar3++;
		}
		if (((!func_231(&(Global_111560.f_19956), 8) && iParam1) && func_229(3) > 0) && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar2, 8);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 9))
		{
			MISC::SET_BIT(&iVar2, 9);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 10))
		{
			MISC::SET_BIT(&iVar2, 10);
			iVar3++;
		}
		if (!func_231(&(Global_111560.f_19956), 11))
		{
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar1 = func_228(7, 9, 10, 11, 0);
			}
			else
			{
				iVar1 = func_228(7, 9, 10, 0, 0);
			}
		}
		else
		{
	...
	if (bParam2)
	{
		func_227(&(Global_111560.f_19956), iVar1, 1);
	}
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_231(&(Global_111560.f_19956), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar3 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_231(&(Global_111560.f_19956), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar3 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_231(&(Global_111560.f_19956), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar3 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_231(&(Global_111560.f_19956), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar3 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_231(&(Global_111560.f_19956), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar3 = true;
	}
...
int func_229(int iParam0)
{
	...
	{
		case 0:
			return func_230(&Global_95167, 1);
			break;
		
		case 1:
			return func_230(&Global_95169, 3);
			break;
		
		case 2:
			return func_230(&Global_95173, 1);
			break;
		
		case 3:
			return func_230(&Global_95175, 1);
			break;
		
		case 4:
			return func_230(&Global_95177, 1);
			break;
		
		case 5:
			return func_230(&Global_95179, 1);
			break;
		
		case 6:
			return func_230(&Global_95181, 1);
			break;
		
		case 7:
			return func_230(&Global_95183, 2);
			break;
		
		case 8:
			return func_230(&Global_95186, 1);
			break;
		
		case 9:
			return func_230(&Global_95188, 1);
			break;
	}
	return 0;
}
...
void func_234(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
	...
	PED::SET_PED_COMPONENT_VARIATION(*uParam0, 3, iParam4, iParam5, 0);
	PED::SET_PED_COMPONENT_VARIATION(*uParam0, 4, 0, iParam6, 0);
	func_235(1, 0);
	func_80(1, 1, 1, 0, 0, 0);
}
...
void func_255()
{
	...
	while (iVar0 < 1)
	{
		Global_95164[iVar0] = 0;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		Global_95161[iVar0] = 0;
		iVar0++;
	}
}
...
void func_256()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_257(&Global_95167, 1);
				break;
			
			case 1:
				func_257(&Global_95169, 3);
				break;
			
			case 2:
				func_257(&Global_95173, 1);
				break;
			
			case 3:
				func_257(&Global_95175, 1);
				break;
			
			case 4:
				func_257(&Global_95177, 1);
				break;
			
			case 5:
				func_257(&Global_95179, 1);
				break;
			
			case 6:
				func_257(&Global_95181, 1);
				break;
			
			case 7:
				func_257(&Global_95183, 2);
				break;
			
			case 8:
				func_257(&Global_95186, 1);
				break;
			
			case 9:
				func_257(&Global_95188, 1);
				break;
		}
		iVar1++;
	}
...
int func_261(int iParam0)
{
	...
	func_262(&(Global_111560.f_2358.f_539), iVar1);
...
void func_262(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_264(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
...
void func_269(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_268(0) && Global_76823.f_1 == 1) && func_270(Global_76823))
		{
		}
		else
		{
