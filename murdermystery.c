...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 5:
			...
			if (((!func_76(5) && iLocal_61 == 4) && func_71()) && !func_70(0))
			{
				func_68(5, 1, 0);
			}
			break;
		...
		case 6:
			if (!func_34(3))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, true, 0))
				{
					func_33(3, 1);
				}
			}
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0))
			{
				if (func_34(3))
				{
			...
			if (!func_34(2))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0) || CAM::IS_SCREEN_FADED_OUT())
				{
					ENTITY::CREATE_MODEL_HIDE(vLocal_58, 200f, joaat("prop_mineshaft_door"), 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
			...
			if (func_34(1))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, true, 0))
				{
...
void func_3()
{
	switch (Global_111560.f_10044.f_134)
	{
		case 0:
			Global_111560.f_10044.f_134 = 1;
			break;
		
		case 1:
			Global_111560.f_10044.f_134 = 2;
			GRAPHICS::_SET_EXTRA_TIMECYCLE_MODIFIER(func_4());
			AUDIO::PLAY_SOUND_FRONTEND(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
		
		case 2:
			Global_111560.f_10044.f_134 = 0;
			break;
	}
}
...
bool func_6()
{
	return Global_111560.f_10044.f_133 == 127;
}
...
bool func_22(int iParam0)
{
	...
	iVar1 = MISC::GET_BITS_IN_RANGE(Global_111560.f_10044.f_133, 0, (iVar0 - 1));
...
void func_24(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_25(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_25(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_29(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_27(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_28(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_29(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_30(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_30(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_30(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_30(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_30(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_30(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_30(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_30(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_30(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_30(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_30(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_30(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_30(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_30(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_30(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_30(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_30(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&iLocal_78, iParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&iLocal_78, iParam0);
	}
}

bool func_34(int iParam0)
{
	return MISC::IS_BIT_SET(iLocal_78, iParam0);
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_51, vLocal_57, true, true, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_57, true, true, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(PLAYER::PLAYER_PED_ID(), vLocal_55, fLocal_56);
				...
				STREAMING::NEW_LOAD_SCENE_START_SPHERE(vLocal_55, 20f, 0);
				func_39(24, &iLocal_59);
				...
				if (iLocal_72 <= MISC::GET_GAME_TIMER())
				{
					...
					func_44(PLAYER::PLAYER_PED_ID(), vLocal_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
		...
		case 3:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_43(0);
				func_37();
				func_36(vLocal_53, 30f, 12, 5000, 0, 0);
				func_61(1, 800);
				iLocal_60 = 0;
			}
			break;
...
void func_36(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_49()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_111560.f_10044.f_133), iParam0);
		if (!bParam2)
		{
	...
	{
		MISC::CLEAR_BIT(&(Global_111560.f_10044.f_133), iParam0);
	}
}
...
bool func_73()
{
	return SYSTEM::VDIST2(func_75(iLocal_71), vLocal_70) < func_74(iLocal_71);
}
...
{
	return MISC::IS_BIT_SET(Global_111560.f_10044.f_133, iParam0);
}
...
int func_77()
{
	switch (iLocal_71)
	{
		...
		case 6:
			return (func_79() || (func_34(2) && func_78(vLocal_58)));
...
bool func_79()
{
	return SYSTEM::VDIST2(func_81(iLocal_71), vLocal_70) < func_80(iLocal_71);
}
...
void func_82()
{
	if (func_67(PLAYER::PLAYER_PED_ID()))
	{
		vLocal_70 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			func_87(&iLocal_73, func_75(iLocal_71), 0.2f);
			break;
		
		case 4:
			func_86(joaat("u_f_m_drowned_01"));
			func_85(sLocal_74);
			iLocal_66 = PED::CREATE_PED(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_f_m_drowned_01"));
			TASK::TASK_PLAY_ANIM(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, true, 0);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_63, 1, true, false);
			iLocal_62 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(joaat("u_m_o_filmnoir"));
			iLocal_64 = PED::CREATE_PED(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, true);
...
void func_87(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 5:
			...
			{
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(iLocal_63);
			}
			...
			if (func_50(sLocal_76) || func_50(sLocal_77))
			{
				HUD::CLEAR_HELP(1);
			}
			break;
		...
		case 6:
			...
			if (func_34(2))
			{
				ENTITY::REMOVE_MODEL_HIDE(vLocal_58, 200f, joaat("prop_mineshaft_door"), false);
			}
			break;
	}
}
