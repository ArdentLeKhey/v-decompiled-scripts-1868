...
void func_105()
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBBB_INTERACT";
	StringCopy(&Local_231, "PBBB_CONV_GM", 16);
	StringCopy(&Local_232, "PBBB_CONV_GT", 16);
	StringCopy(&Local_233, "PBBB_CONV_GF", 16);
	StringCopy(&cLocal_234, "special_ped@bill@base", 64);
	StringCopy(&cLocal_243, "special_ped@bill@intro", 64);
	iLocal_217 = 2;
	iLocal_221[0] = 7;
	iLocal_221[1] = 5;
	iLocal_221[2] = 5;
