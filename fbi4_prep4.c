#region Local Var
	...
	int iLocal_200 = 0;
	int iLocal_201 = 0;
	char* sLocal_202[3] = { NULL, NULL, NULL };
...
void __EntryFunction__()
{
	...
	sLocal_188 = "FBIPRD";
	vLocal_194 = { 0f, 0f, 0f };
	vLocal_195 = { -1335.314f, -1277.943f, 3.8649f };
	vLocal_196 = { -1336.378f, -1279.056f, 3.855f };
	iLocal_199 = -1;
	sLocal_203 = "FBIPRAU";
	...
	if (func_270())
	{
		func_269(-1339.786f, -1277.51f, 3.8874f, 261.2839f, 1, 0);
	}
	if (func_268(0))
	{
		Global_111560.f_2358.f_539.f_2395[0] = -99;
		Global_111560.f_2358.f_539.f_2395[1] = -99;
		Global_111560.f_2358.f_539.f_2395[2] = -99;
		func_234();
	}
	while (true)
	{
	...
	switch (iLocal_81)
	{
		case 0:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_187))
			{
				...
				{
					while ((MISC::GET_GAME_TIMER() - iLocal_199) < 3000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)
{
	...
	if (Global_111560.f_9080 || func_268(0))
	{
		iVar0 = func_18();
		if (!func_5(iVar0))
		{
...
int func_5(int iParam0)
{
	...
	func_6(&(Global_111560.f_2358.f_539), iVar1);
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_8(Global_111560.f_18528[iVar0], &vVar2, &fVar3))
			{
...
void func_12()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_14(iVar0) && (!func_13(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_14(Global_111560.f_2358.f_539.f_4321))
				{
...
void func_23()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_196, 2f) && func_87(21))
			{
			...
			else
			{
				...
				else if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_195, 75f))
				{
					if (!iLocal_201)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, vLocal_196, 1, 1, "PRD_SHOP");
				}
				else if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_196, 12f))
				{
					if (iLocal_201)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, vLocal_196, 1, 1, "PRD_BLIP");
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_198) > 2000)
			{
				func_22(&iLocal_192);
				if (func_43(&uLocal_373, &cLocal_369, &uLocal_204))
				{
					func_42(0, -1);
					if ((Global_111560.f_2358.f_539.f_2395[0] == 38 && Global_111560.f_2358.f_539.f_2395[1] == 33) && Global_111560.f_2358.f_539.f_2395[2] == 54)
					{
						func_41(821);
					}
					func_38();
		...
		case 3:
			Global_111560.f_2358.f_539.f_2395[0] = 38;
			Global_111560.f_2358.f_539.f_2395[1] = 33;
			Global_111560.f_2358.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_81 = 2;
			break;
	}
...
void func_39(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_268(0) && Global_76823.f_1 == 1) && func_40(Global_76823))
		{
		}
		else
		{
...
int func_57(int iParam0)
{
	...
	return Global_96177[func_58(iParam0)];
}
...
void func_84(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_85(vParam1, 5, bParam2);
		if (bParam3)
		{
...
int func_85(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_86(char* sParam0, int iParam1, int iParam2)
{
...
bool func_93(int iParam0, vector3 vParam1, float fParam2)
{
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (bParam1)
			{
				func_95(PLAYER::PLAYER_PED_ID(), vLocal_196, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_95(int iParam0, vector3 vParam1, float fParam2)
{
	if (func_233(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_96(iParam0, vParam1, fParam2, 0, 1);
}

int func_96(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, vector3 vParam1, float fParam2)
{
	...
	{
		case 0:
			if (func_98(vParam1, vLocal_194, 1056964608, 0) && fParam2 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			...
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_203, 6);
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_195, 60f))
				{
		...
		case 3:
			func_95(PLAYER::PLAYER_PED_ID(), vLocal_196, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_114(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_270() || !func_217())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_214(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_193(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		func_183(vParam1, 5f, 0);
		if (func_14(iParam10))
		{
			func_181(iParam10, 0);
			while (!func_115(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_115(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_175(iParam0, &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_175(iParam0, &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_175(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_116(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_120(iParam1, &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111560.f_20113[iParam0 /*43*/].f_31 = func_119(*iParam1);
				...
				func_117(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111560.f_20113[iParam0 /*43*/].f_1));
				...
				func_117(Global_111560.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111560.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_117(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_118(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
int func_121(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_148(iVar0, bParam1, uParam2) && !func_147(PLAYER::PLAYER_ID())) && !func_131(iParam0))
	{
		return 0;
	}
...
int func_123(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			...
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_128(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_129(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_146(PLAYER::PLAYER_ID()) || func_145(PLAYER::PLAYER_ID()))
	{
		if (func_132(iParam0))
		{
			return 1;
...
int func_145(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			...
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_146(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1 && Global_2424073[iParam0 /*421*/].f_309.f_8 != func_66())
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_147(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2424073[iParam0 /*421*/].f_309.f_5 != -1)
			{
				return func_124(Global_2424073[iParam0 /*421*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_150(int iParam0, int iParam1)
{
	...
	func_151(iParam0, &(Global_111560.f_32744.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_152(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_170(iParam0, 0, 0)) || func_170(iParam0, 1, 0)) || func_170(iParam0, 2, 0)) || func_169(iParam0) != 145) || func_168(iParam0)) || func_167(iParam0)) || func_122(iParam0)) || func_166(iParam0)) || !func_156(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_167(iParam0))
		{
		}
		...
		if (func_170(iParam0, 0, 0))
		{
		}
		if (func_170(iParam0, 1, 0))
		{
		}
		if (func_170(iParam0, 2, 0))
		{
		}
...
int func_170(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_171(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_171(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
int func_175(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_144(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_178(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_178(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_177(iParam0);
	if (func_176(*iParam0))
	{
...
void func_181(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96030[iVar0]) == func_182(iParam0, iParam1))
				{
...
void func_183(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_191(&(Global_75396.f_555[0 /*21*/]), iVar0))
		{
...
void func_184(int iParam0)
{
	...
	if (func_191(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_190(iParam0, 0)) && Global_76305.f_66 == 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] != 0) && Global_111560.f_32744.f_1958[Global_75396.f_555[0 /*21*/].f_14] > 3) && (!func_188(0, Global_75396.f_555[0 /*21*/].f_12) || !func_188(1, Global_75396.f_555[0 /*21*/].f_12)))
			{
				func_187(&(Global_111560.f_32744.f_69[Global_75396.f_555[0 /*21*/].f_14 /*78*/]), &Global_76305);
...
int func_188(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_189(&(Global_111560.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_157(Global_111560.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_191(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_192(Global_111560.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_192(Global_111560.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_192(Global_111560.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_193(vector3 vParam0, float fParam1)
{
	return func_194(&(Global_105109.f_2890), vParam0, fParam1, 0);
}

int func_194(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_181(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_181(uParam0->f_11, 2);
						}
					}
					...
					func_172(iVar0, uParam0->f_11);
				}
				else if ((!func_196(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_195(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_196(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_197(iParam0, Global_75396.f_139[38], 0))
			{
				func_184(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_197(iParam0, Global_75396.f_139[43], 1))
			{
				func_184(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_197(iParam0, uVar1[iVar3], 1) && func_98(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_192(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_198(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_152(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_152(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_152(iVar1 + 1));
			}
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_201(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_200())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_175(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_152(iVar2 + 1)))
				{
...
int func_202(int iParam0)
{
	...
	if (func_204(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
int func_210(var uParam0)
{
	...
	if (!func_157(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
...
bool func_211()
{
	return func_209(&(Global_105109.f_2890));
}

void func_212()
{
	func_213(&(Global_105109.f_2890));
}
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_216(Global_105109.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_217()
{
	return func_210(&(Global_105109.f_2890));
}
...
void func_220()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_195, 150f))
				{
					func_226(2);
				}
				else if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_195, 75f))
...
int func_221()
{
	...
	if (!func_222(bLocal_190, iVar0) && !bLocal_190)
	{
		return 0;
	}
	return 1;
...
void func_229()
{
	if (func_231())
	{
		...
		{
			case 0:
				if (Global_111560.f_2358.f_539.f_2395[0] == -99)
				{
					func_230(sLocal_202[0], sLocal_202[1], sLocal_202[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2395[1] == -99)
				{
					func_230(sLocal_202[1], sLocal_202[0], sLocal_202[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2395[2] == -99)
				{
					func_230(sLocal_202[2], sLocal_202[1], sLocal_202[0]);
				}
				break;
			
			case 1:
				if (Global_111560.f_2358.f_539.f_2395[1] == -99)
				{
					func_230(sLocal_202[1], sLocal_202[0], sLocal_202[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2395[0] == -99)
				{
					func_230(sLocal_202[0], sLocal_202[1], sLocal_202[2]);
				}
				else if (Global_111560.f_2358.f_539.f_2395[2] == -99)
			...
			case 2:
				if (Global_111560.f_2358.f_539.f_2395[2] == -99)
				{
					func_230(sLocal_202[2], sLocal_202[1], sLocal_202[0]);
				}
				else if (Global_111560.f_2358.f_539.f_2395[0] == -99)
...
void func_230(char* sParam0, char* sParam1, char* sParam2)
{
...
int func_232()
{
	...
	while (iVar1 <= 2)
	{
		if (Global_111560.f_2358.f_539.f_2395[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_234()
{
	...
	if (func_224(iVar0) < 1500)
	{
		func_235(func_11(), 96, 1500, 0, 0);
	}
}
...
void func_235(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_236(func_267(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_239(int iParam0)
{
	...
	if (iParam0 == 12)
	{
		func_242(8269, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 13)
	{
		func_242(8270, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 14)
	{
		func_242(8271, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 15)
	{
		func_242(8272, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 16)
	{
		func_242(8273, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 17)
	{
		func_242(8274, 0, -1, 1, 0);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_241() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_241() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_240(iParam0));
...
int func_243(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_245(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_246(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_246(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_246(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_246(137, -1, -1);
	}
	if (iParam0 == 12)
	{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_241() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_246(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_248(iParam0, iParam1);
	uVar2 = func_247(iParam0);
	if (0 != iVar1)
	{
...
{
	if (func_13(14) && !func_262(iParam0))
	{
		return 0;
	}
	...
	if (func_261(&Global_4269915))
	{
		if (func_259(&Global_4269915, iParam0))
		{
			return 0;
		}
		if (func_252(&Global_4269915, iParam0))
		{
			return 1;
		}
	}
...
int func_252(var uParam0, int iParam1)
{
	...
	if (func_13(14) && !func_262(iParam1))
	{
		return 0;
	}
...
void func_255(var uParam0)
{
	...
	func_257(uParam0, (Global_4269914 - 0.5f));
}
...
void func_269(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_270())
	{
...
void func_271()
{
	func_272(joaat("player_zero"), 14, 31, 1);
	func_272(joaat("player_zero"), 14, 32, 1);
	func_272(joaat("player_zero"), 14, 33, 1);
	func_272(joaat("player_zero"), 14, 34, 1);
	func_272(joaat("player_zero"), 14, 35, 1);
	func_272(joaat("player_zero"), 14, 36, 1);
	func_272(joaat("player_zero"), 14, 37, 1);
	func_272(joaat("player_zero"), 14, 38, 1);
	func_272(joaat("player_zero"), 14, 39, 1);
	func_272(joaat("player_zero"), 14, 40, 1);
	func_272(joaat("player_zero"), 14, 41, 1);
	func_272(joaat("player_zero"), 14, 42, 1);
	func_272(joaat("player_zero"), 14, 43, 1);
	func_272(joaat("player_zero"), 14, 44, 1);
	func_272(joaat("player_zero"), 9, 9, 1);
	func_272(joaat("player_zero"), 9, 10, 1);
	func_272(joaat("player_zero"), 9, 11, 1);
	func_272(joaat("player_zero"), 9, 12, 1);
	func_272(joaat("player_zero"), 9, 13, 1);
	func_272(joaat("player_zero"), 9, 14, 1);
	func_272(joaat("player_one"), 14, 26, 1);
	func_272(joaat("player_one"), 14, 27, 1);
	func_272(joaat("player_one"), 14, 28, 1);
	func_272(joaat("player_one"), 14, 29, 1);
	func_272(joaat("player_one"), 14, 30, 1);
	func_272(joaat("player_one"), 14, 31, 1);
	func_272(joaat("player_one"), 14, 32, 1);
	func_272(joaat("player_one"), 14, 33, 1);
	func_272(joaat("player_one"), 14, 34, 1);
	func_272(joaat("player_one"), 14, 35, 1);
	func_272(joaat("player_one"), 14, 36, 1);
	func_272(joaat("player_one"), 14, 37, 1);
	func_272(joaat("player_one"), 14, 38, 1);
	func_272(joaat("player_one"), 14, 39, 1);
	func_272(joaat("player_one"), 9, 5, 1);
	func_272(joaat("player_one"), 9, 6, 1);
	func_272(joaat("player_one"), 9, 7, 1);
	func_272(joaat("player_one"), 9, 8, 1);
	func_272(joaat("player_one"), 9, 9, 1);
	func_272(joaat("player_one"), 9, 10, 1);
	func_272(joaat("player_two"), 14, 49, 1);
	func_272(joaat("player_two"), 14, 50, 1);
	func_272(joaat("player_two"), 14, 51, 1);
	func_272(joaat("player_two"), 14, 52, 1);
	func_272(joaat("player_two"), 14, 53, 1);
	func_272(joaat("player_two"), 14, 54, 1);
	func_272(joaat("player_two"), 14, 55, 1);
	func_272(joaat("player_two"), 14, 56, 1);
	func_272(joaat("player_two"), 14, 57, 1);
	func_272(joaat("player_two"), 14, 58, 1);
	func_272(joaat("player_two"), 14, 59, 1);
	func_272(joaat("player_two"), 14, 60, 1);
	func_272(joaat("player_two"), 9, 9, 1);
	func_272(joaat("player_two"), 9, 10, 1);
	func_272(joaat("player_two"), 9, 11, 1);
	func_272(joaat("player_two"), 9, 12, 1);
	func_272(joaat("player_two"), 9, 13, 1);
	func_272(joaat("player_two"), 9, 14, 1);
	func_272(joaat("player_two"), 9, 15, 1);
	func_272(joaat("player_two"), 9, 16, 1);
}

int func_272(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_76389[1 /*14*/] = { func_274(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_273(iParam1, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 0, Global_76389[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_273(iParam1, Global_76389[1 /*14*/].f_5, Global_76389[1 /*14*/].f_2, 0, Global_76389[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_273(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_274(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_339();
...
void func_276(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_284(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_277(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_277(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_281(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_281(Global_2621444, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_273(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_273(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_273(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_280(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_89(func_279(iParam1, uParam0->f_2), Global_76386, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_278(iParam1, uParam0->f_2, &iVar1))
			{
				iVar0 = func_89(iVar1, Global_76386, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_281(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_282(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_282(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_284(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_285(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_342(var uParam0, int iParam1)
{
	...
	{
		func_346(&uLocal_82, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_345(&uLocal_82);
	func_343(&uLocal_134, &uLocal_82, 50f);
}

void func_343(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		vVar5 = { vVar3 - vVar4 };
		vVar5 = { vVar5 / FtoV(SYSTEM::SQRT(((vVar5.x * vVar5.x) + (vVar5.y * vVar5.f_1)))) };
		if (func_344(uParam1, *(uParam1[iVar1 /*3*/]) + vVar5))
		{
			vVar5 = { -vVar5 };
		}
...
bool func_344(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_346(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_348()
{
	sLocal_202[0] = "PRD_BUYM";
	sLocal_202[1] = "PRD_BUYF";
	sLocal_202[2] = "PRD_BUYT";
}
...
void func_359(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
