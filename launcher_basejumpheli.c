...
void __EntryFunction__()
{
	...
	iLocal_59 = 0;
	func_166(&Global_110211, 0);
	func_160();
	MISC::_0x6F2135B6129620C1(1);
	if (func_159(uLocal_58, 1))
	{
		iLocal_64 = 10;
	}
	else
	...
	if (!func_159(uLocal_58, 8))
	{
		if (!func_157(iLocal_64))
		{
			if (func_156(0, iLocal_63))
			{
				func_168(0);
			}
			else
	...
	if (func_159(uLocal_58, 8388608))
	{
		func_168(1);
	}
	if (func_159(uLocal_58, 524288) && (func_155() && !func_154()))
	{
		func_168(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_159(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			func_153(iLocal_69, 1, 0);
			iLocal_69 = 263;
		}
		func_152(10);
	}
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			{
				case 0:
					if (func_157(iLocal_64) || (func_159(uLocal_58, 16) && !func_159(uLocal_58, 524288)))
					{
						iLocal_62 = -1;
						func_145();
						func_152(1);
				...
				case 3:
					...
					if (!func_159(uLocal_58, 4))
					{
						func_141();
						func_140(&uLocal_58, 4);
					}
					if (fLocal_74 > (fLocal_66 * fLocal_66) && !Global_98703)
					{
						if (iLocal_69 != 263)
						{
							if (func_139(6) && !func_138(iLocal_69))
							{
							}
							else
							{
					...
					{
						Local_52 = { Local_51 };
						bVar2 = !func_159(uLocal_58, 64);
						func_166(&uLocal_58, 128);
						if (!func_137(3) && !Global_98703)
						{
							if (func_159(uLocal_58, 2097152))
							{
								if ((!func_159(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_136())) && !Global_98703)
								{
									func_152(10);
									break;
								}
						...
						if ((!func_127(6) || Global_110607) || func_126())
						{
							bVar2 = false;
						}
						if (!bLocal_78)
						{
							func_124(&uLocal_58, 128);
							bVar2 = false;
						}
						if (func_159(uLocal_58, 1))
						{
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_116(iLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_115(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_124(&uLocal_58, 2048);
									}
									else if (!func_159(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_114(&iLocal_60);
										func_166(&uLocal_58, 2048);
									}
									if (func_112(iLocal_60, 1))
									{
										sLocal_65 = sLocal_65;
										func_114(&iLocal_60);
										func_166(&uLocal_58, 2048);
				...
				case 6:
					if (func_159(Global_110211, 262144))
					{
						func_166(&Global_110211, 262144);
						func_14();
					}
					if (func_159(uLocal_58, 2097152))
					{
						if (!func_137(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
						{
							func_152(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						func_9(&iLocal_71);
						func_166(&uLocal_58, 256);
						func_8();
						if (bVar0)
						{
							func_166(&uLocal_58, 2);
						}
						else if (func_159(uLocal_58, 2))
						{
							if (func_159(Global_110211, 0))
							{
								func_7(&iLocal_62);
								iLocal_62 = -1;
								func_166(&uLocal_58, 2);
						...
						if (iLocal_63 != -1)
						{
							if (func_159(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_98706, 0);
								func_6(func_20(iLocal_63), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_98706, 0);
								func_6(func_20(iLocal_63), 0, Global_98706, 0, 0);
							}
						}
						func_5();
						func_166(&Global_110211, 0);
						if (func_159(uLocal_58, 16777216))
						{
							func_168(1);
						}
						if (iLocal_63 != -1)
					...
					if ((iLocal_68 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_70 == 2)
							{
								if (iLocal_70 == 2)
								{
									if (func_157(iLocal_64) && func_156(0, iLocal_63))
									{
										func_160();
										if (iLocal_69 != 263)
										{
...
void func_2()
{
	...
	ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_247.f_3));
}
...
void func_16(int iParam0, int iParam1)
{
	...
	if (CAM::DOES_CAM_EXIST(*iParam0) && CAM::IS_CAM_ACTIVE(*iParam0))
	{
		...
		fVar3 = MISC::ATAN2((vVar1.z - vVar2.z), MISC::GET_DISTANCE_BETWEEN_COORDS(vVar1, vVar2, false));
		if (fVar3 > vVar0.x)
		{
...
void func_26()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_247) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	}
...
int func_27()
{
	...
	Global_111560.f_18962 = iLocal_81;
	switch (iLocal_81)
	{
		case 0:
		case 1:
...
void func_36()
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_247, 1);
	}
}
...
void func_51()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar2) && iVar2 != iLocal_54)
	{
		Local_247.f_1 = iVar2;
	}
	if (!iLocal_249)
	...
	if (func_107(Local_247.f_3, Local_247, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		func_150(0);
		iLocal_249 = 0;
		if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_3) && !PED::IS_PED_INJURED(Local_247.f_3))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0) && PED::IS_PED_IN_VEHICLE(Local_247.f_3, Local_247, 0))
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247, ENTITY::GET_ENTITY_COORDS(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247), 262144, 50f, 50f, 1);
			}
			else
			{
				TASK::TASK_SMART_FLEE_PED(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
			PED::SET_PED_KEEP_TASK(Local_247.f_3, true);
			PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 251, false);
			PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 255, false);
			Local_247.f_3 = 0;
		}
	...
	fVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_106(iLocal_81));
	if (fVar6 < 11664f)
	{
		if (!iLocal_251)
		{
			STREAMING::REQUEST_MODEL(func_105(iLocal_81));
			iLocal_251 = 1;
		}
	}
	else if (fVar6 > 13924f)
	{
		if (iLocal_251)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_105(iLocal_81));
			iLocal_251 = 0;
		}
	}
	if (fVar6 < 10000f)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_247.f_3))
		{
			if ((STREAMING::HAS_MODEL_LOADED(func_105(iLocal_81)) && ENTITY::DOES_ENTITY_EXIST(Local_247)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0))
			{
				Local_247.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_247, 4, func_105(iLocal_81), -1, 1, true);
				if (!PED::IS_PED_INJURED(Local_247.f_3))
				{
					PED::SET_PED_HELMET(Local_247.f_3, 0);
					func_104(Local_247.f_3, iLocal_81);
					func_103();
					AUDIO::SET_AMBIENT_VOICE_NAME(Local_247.f_3, func_102(iLocal_81));
					func_100(&uLocal_82, 0, Local_247.f_3, func_101(iLocal_81), 1, 1);
					TASK::TASK_STAND_STILL(Local_247.f_3, -1);
					PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 251, true);
					PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 255, true);
				}
				VEHICLE::SET_VEHICLE_ENGINE_ON(Local_247, true, true, 0);
				VEHICLE::SET_HELI_BLADES_SPEED(Local_247, fVar7);
			}
		}
		else
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_247.f_3, true, 0);
			if (!CAM::DOES_CAM_EXIST(iLocal_252) || !CAM::IS_CAM_RENDERING(iLocal_252))
			{
				VEHICLE::SET_HELI_BLADES_SPEED(Local_247, fVar7);
			}
			if (!MISC::IS_BIT_SET(Local_247.f_169, 0))
			{
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!PED::IS_PED_INJURED(Local_247.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_247.f_3, true)) < 400f)
						{
							func_78(&uLocal_82, "OJBJAUD", func_98(iLocal_81), 8, 0, 0, 0);
							TASK::TASK_LOOK_AT_ENTITY(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 6000, 0, 2);
							MISC::SET_BIT(&(Local_247.f_169), 0);
						}
					}
				}
			}
	...
	else if (fVar6 > 12100f)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_3))
		{
			...
			if (!ENTITY::IS_ENTITY_ON_SCREEN(iVar3))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar3, true, 0);
	...
	{
		vVar5 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_247, PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f)) };
		if (vVar5.x < 0f || vVar5.y < 1f)
		{
			AUDIO::SET_AUDIO_FLAG("DisableFlightMusic", 1);
			AUDIO::SET_VEH_RADIO_STATION(Local_247, "OFF");
			func_166(&uLocal_58, 64);
			bVar8 = true;
			if (iLocal_250)
			{
			...
			if (!CAM::DOES_CAM_EXIST(iLocal_252))
			{
				func_65(0, 0, 1);
				func_58(1);
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					func_22(&iLocal_253);
					while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247, 0) && func_53(&iLocal_253) < 2f)
					{
						SYSTEM::WAIT(0);
					}
					func_9(&iLocal_253);
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247, 0))
					{
						bVar8 = false;
						CAM::RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
						if (CAM::DOES_CAM_EXIST(iLocal_252))
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_247.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_247, 0))
					{
						TASK::OPEN_SEQUENCE_TASK(&iVar4);
						TASK::TASK_STAND_STILL(0, 500);
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247, ENTITY::GET_ENTITY_COORDS(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247), 262144, 50f, 50f, 1);
						TASK::CLOSE_SEQUENCE_TASK(iVar4);
						TASK::TASK_PERFORM_SEQUENCE(Local_247.f_3, iVar4);
	...
	if (!bVar8)
	{
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_247, true)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
...
int func_76(int iParam0, int iParam1)
{
	...
	if (PED::IS_PED_IN_VEHICLE(iParam0, iParam1, 0) && func_77(iParam0, iParam1) == -1)
	{
		return 1;
	}
	return 0;
...
void func_90()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_93(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_91(iVar0) && (!func_139(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_91(Global_111560.f_2358.f_539.f_4321))
				{
...
int func_107(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (((!ENTITY::DOES_ENTITY_EXIST(iParam1) || ENTITY::IS_ENTITY_DEAD(iParam1, 0)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iParam1))
	{
		return 1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_130()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_134()) || Global_30738) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_119(8, -1)) || func_121()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_134()) || func_131()) || Global_110607) || Global_30738) || func_133()) || Global_42561) || func_119(8, -1)) || func_130()) || func_129()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_142(vector3 vParam0, float fParam1)
{
	...
	fLocal_57 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (fLocal_57 > 25f || CAM::IS_SCREEN_FADED_OUT()))
	{
		if (fLocal_57 < 25600f)
		{
	...
	if (bVar1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_247))
		{
			VEHICLE::DELETE_VEHICLE(&Local_247);
		}
		MISC::CLEAR_AREA(vParam0, 4f, 1, 0, 0, false);
		if (iLocal_81 == 0)
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-835.7629f, -1298.777f, 0f, -815.1855f, -1283.906f, 10f, false, 1);
		}
		if (iLocal_81 == 3)
		{
			Local_247 = VEHICLE::CREATE_VEHICLE(joaat("FROGGER"), vParam0, fParam1, true, true, false);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247, 5);
		}
		else
		{
			Local_247 = VEHICLE::CREATE_VEHICLE(joaat("MAVERICK"), vParam0, fParam1, true, true, false);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247, 6);
		}
		iLocal_54 = Local_247;
		ENTITY::_SET_ENTITY_SOMETHING(iLocal_54, true);
		if (MISC::GET_GROUND_Z_FOR_3D_COORD(vParam0, &uVar0, 0, 0))
		{
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_247, 1084227584);
		}
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_247, true);
		iLocal_249 = 1;
	}
	else
	{
...
{
	return func_158(iParam0, Global_41396);
}
...
void func_160()
{
	...
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_124(&uLocal_58, 8388608);
		return;
	}
	StringCopy(&Local_51, "bj", 64);
	iLocal_81 = func_164(vLocal_56, 1);
	func_124(&uLocal_58, 64);
	switch (iLocal_81)
	{
		case 0:
			iLocal_69 = 125;
	...
	func_124(&uLocal_58, 4194304);
	func_124(&uLocal_58, 16);
	...
	{
		func_166(&uLocal_58, 8);
	}
	if (func_139(12))
	{
		func_124(&uLocal_58, 8);
	}
	iLocal_61 = 29500;
}
