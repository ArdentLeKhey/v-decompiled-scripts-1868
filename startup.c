...
void __EntryFunction__()
{
	...
	switch (iLocal_52)
	{
		case 0:
			...
			while ((!MISC::IS_BIT_SET(Global_4270473, 0) || !MISC::IS_BIT_SET(Global_4270473, 1)) || !MISC::IS_BIT_SET(Global_4270473, 2))
			{
				if (!MISC::IS_BIT_SET(Global_4270473, 0))
				{
				}
				if (!MISC::IS_BIT_SET(Global_4270473, 1))
				{
				}
				if (!MISC::IS_BIT_SET(Global_4270473, 2))
				{
				}
				SYSTEM::WAIT(0);
			}
			MISC::START_SAVE_DATA(&Global_111560, 1, 1);
			MISC::REGISTER_FLOAT_TO_SAVE(&Global_111560, "fSaveVersion");
			MISC::STOP_SAVE_DATA();
			if (Global_1)
			{
				Global_0 = Global_111560;
			}
			Global_111560 = 1.7f;
			if (Global_1)
			{
	...
	MISC::START_SAVE_DATA(&Global_2097152, 10829, 0);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&Global_2097152, 10829, "g_savedMPGlobals");
	iVar1 = 0;
	while (iVar1 < 1)
	{
		func_21(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_19(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_17(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_14(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_12(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_11(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_10(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		func_3(&(Global_2097152[iVar1 /*10828*/]), iVar1);
		iVar1++;
	}
...
void func_4(var uParam0, int iParam1)
{
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801.f_19), 8, &cVar0);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(uParam0->f_10801.f_19[0 /*7*/]), 7, "TEMPSTAT_DATE");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/]), "TEMPSTAT_DATE.year");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	MISC::STOP_SAVE_STRUCT();
...
void func_5(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801.f_15), 4, &cVar0);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(uParam0->f_10801.f_15[0 /*3*/]), 3, "TEMPSTAT_VEC");
	MISC::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10801.f_15[0 /*3*/]), "TEMPSTAT_VEC.x");
	MISC::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10801.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	MISC::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10801.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
}
...
void func_6(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801.f_6), 9, &cVar0);
	MISC::_0x8269816F6CFD40F8(&(uParam0->f_10801.f_6[0 /*8*/]), "TEMPSTAT_LABEL");
	MISC::STOP_SAVE_ARRAY();
}
...
void func_7(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801.f_4), 2, &cVar0);
	MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_10801.f_4[0]), "TEMPSTAT_BOOL");
	MISC::STOP_SAVE_ARRAY();
}
...
void func_8(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801.f_2), 2, &cVar0);
	MISC::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10801.f_2[0]), "TEMPSTAT_FLOAT");
	MISC::STOP_SAVE_ARRAY();
}
...
void func_9(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10801), 2, &cVar0);
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10801[0]), "TEMPSTAT_INT1");
	MISC::STOP_SAVE_ARRAY();
}
...
void func_10(var uParam0, int iParam1)
{
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(uParam0->f_10651), 150, &cVar0);
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10651), "MPATM_CARET_");
	iVar1 = 0;
	StringCopy(&Var2, "MPATMLOGVAL", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10651.f_1), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar3 = { Var2 };
		StringIntConCat(&cVar3, iVar1, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10651.f_1[iVar1]), &cVar3);
		iVar1++;
	}
	MISC::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGSCRS", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10651.f_18), 97, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar4 = { Var2 };
		StringIntConCat(&cVar4, iVar1, 16);
		MISC::_0x48F069265A0E4BEC(&(uParam0->f_10651.f_18[iVar1 /*6*/]), &cVar4);
		iVar1++;
	}
	MISC::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGACT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10651.f_115), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar5 = { Var2 };
		StringIntConCat(&cVar5, iVar1, 16);
		MISC::REGISTER_ENUM_TO_SAVE(&(uParam0->f_10651.f_115[iVar1]), &cVar5);
		iVar1++;
	}
	MISC::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGDAT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10651.f_132), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar6 = { Var2 };
		StringIntConCat(&cVar6, iVar1, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10651.f_132[iVar1]), &cVar6);
		iVar1++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_10651.f_149), "mpAnyVecBought");
	MISC::STOP_SAVE_STRUCT();
}
...
void func_11(var uParam0, int iParam1)
{
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(uParam0->f_10410), 241, &Var0);
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410), "BOUNTY_GAMERH64_1");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_1), "BOUNTY_GAMERH64_2");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_2), "BOUNTY_GAMERH64_3");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_3), "BOUNTY_GAMERH64_4");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_4), "BOUNTY_GAMERH64_5");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_5), "BOUNTY_GAMERH64_6");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_6), "BOUNTY_GAMERH64_7");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_7), "BOUNTY_GAMERH64_8");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_8), "BOUNTY_GAMERH64_9");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_9), "BOUNTY_GAMERH64_10");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_10), "BOUNTY_GAMERH64_11");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_11), "BOUNTY_GAMERH64_12");
	MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_12), "BOUNTY_GAMERH64_13");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10410.f_13), "BOUNTY_TIME");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10410.f_14), "BOUNTY_VALUE");
	StringConCat(&Var0, "_GH", 24);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10410.f_15), 209, &Var0);
	iVar2 = 0;
	while (iVar2 < 16)
	{
		...
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/]), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_2", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_1), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_3", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_2), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_4", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_3), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_5", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_4), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_6", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_5), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_7", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_6), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_8", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_7), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_9", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_8), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_10", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_9), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_11", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_10), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_12", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_11), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_13", 32);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_10410.f_15[iVar2 /*13*/].f_12), &cVar1);
		iVar2++;
	}
	MISC::STOP_SAVE_ARRAY();
	StringCopy(&Var0, "MP_BOUNTY_SAVED", 24);
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_10410.f_224), 17, &Var0);
	iVar2 = 0;
	while (iVar2 < 16)
	{
		MemCopy(&cVar1, {Var0}, 8);
		StringIntConCat(&cVar1, iVar2, 32);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_10410.f_224[iVar2]), &cVar1);
		iVar2++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::STOP_SAVE_STRUCT();
...
void func_13(var uParam0, char* sParam1)
{
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(uParam0, 4242, sParam1);
	...
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_1326), "LAST_ACC_SMPLINT");
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1304), 22, "PROP_ARY_VAL");
	iVar4 = 0;
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_1327), "KR_PATCH_UPDATE");
	iVar4 = 0;
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2683), 919, "DLC_MODS");
	iVar4 = 0;
	while (iVar4 < uParam0->f_2683)
	{
		StringCopy(&Var1, "DLC_MODS_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_2683[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	iVar4 = 0;
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_3602), 408, "DLC_SUPERMODS");
	iVar4 = 0;
	while (iVar4 < uParam0->f_3602)
	{
		StringCopy(&Var1, "DLC_SMODS_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_3602[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1328), 274, "OUTFIT_CompDraw");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringIntConCat(&Var1, iVar4, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1328[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompDraw", 16);
			...
			MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_1328[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		MISC::STOP_SAVE_ARRAY();
		iVar4++;
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1602), 274, "OUTFIT_CompTex");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1602[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_1602[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		MISC::STOP_SAVE_ARRAY();
		iVar4++;
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1876), 211, "OUTFIT_PropID");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_1876[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropID", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_1876[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		MISC::STOP_SAVE_ARRAY();
		iVar4++;
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2087), 211, "OUTFIT_PropTex");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2087[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_2087[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		MISC::STOP_SAVE_ARRAY();
		iVar4++;
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2298), 22, "OUTFIT_Stored");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2298[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2320), 22, "OUTFIT_CrewTatA");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2320[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2342), 22, "OUTFIT_CrewTatB");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2342[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2364), 22, "OUTFIT_CrewTatC");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2364[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2386), 22, "OUTFIT_CrewTatD");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2386[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2408), 22, "OUTFIT_CrewTatE");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2408[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2430), 22, "OUTFIT_CrewTatF");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2430[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2621), 22, "OUTFIT_Shirt");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_2621[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2452), 169, "OUTFIT_Name");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::_0x8269816F6CFD40F8(&(uParam0->f_2452[iVar4 /*8*/]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_2643), 40, "LAST_JobGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/]), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_2", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_1), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_3", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_2), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_4", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_3), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_5", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_4), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_6", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_5), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_7", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_6), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_8", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_7), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_9", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_8), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_10", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_9), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_11", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_10), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_12", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_11), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_13", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_2643[iVar4 /*13*/].f_12), &cVar6);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_4010), "DO_CompletedObjectives");
	MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_4011), "DO_LoggedInToday");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4012), "DO_xValue");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4013), "DO_LastHistoryLength");
	MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4014), "DO_LastResetTime");
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4015), 10, "DO_Objectives");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4015[iVar4 /*3*/]), &Var1);
		StringCopy(&Var1, "Completed", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(uParam0->f_4015[iVar4 /*3*/].f_1), &Var1);
		StringCopy(&Var1, "Initial", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4015[iVar4 /*3*/].f_2), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4025), 25, "DO_History");
	iVar4 = 0;
	while (iVar4 < 24)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4025[iVar4]), &Var1);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4050), 49, "LAST_JobGamer_TL");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		MISC::_0xFAA457EF263E8763(&(uParam0->f_4050[iVar4 /*16*/]), &cVar7);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4099), 11, "BGSAVEINT");
	iVar0 = 0;
	while (iVar0 < 10)
	{
		StringCopy(&Var1, "BGSAVEINT", 16);
		StringIntConCat(&Var1, iVar0, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4099[iVar0]), &Var1);
		iVar0++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4110), 3, "PROPLIB");
	iVar0 = 0;
	while (iVar0 < uParam0->f_4110)
	{
		StringCopy(&Var1, "PROPLIB", 16);
		StringIntConCat(&Var1, iVar0, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_4110[iVar0]), &Var1);
		iVar0++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4113), 40, "LAST_GOGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/]), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_2", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_1), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_3", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_2), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_4", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_3), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_5", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_4), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_6", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_5), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_7", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_6), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_8", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_7), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_9", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_8), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_10", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_9), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_11", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_10), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_12", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_11), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_13", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4113[iVar4 /*13*/].f_12), &cVar8);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4153), 40, "LAST_GOJobGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/]), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_2", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_1), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_3", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_2), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_4", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_3), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_5", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_4), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_6", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_5), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_7", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_6), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_8", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_7), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_9", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_8), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_10", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_9), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_11", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_10), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_12", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_11), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_13", 16);
		MISC::_REGISTER_INT64_TO_SAVE(&(uParam0->f_4153[iVar4 /*13*/].f_12), &cVar9);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_4193), 49, "LAST_GOJobGamer_TL");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		MISC::_0xFAA457EF263E8763(&(uParam0->f_4193[iVar4 /*16*/]), &cVar10);
		iVar4++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::STOP_SAVE_ARRAY();
...
{
	func_15(&(uParam0->f_6080), iParam1);
}
...
void func_18(var uParam0, char* sParam1)
{
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(uParam0, 574, sParam1);
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_36), 19, "PROP_DRINKS");
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_55), 19, "PROP_SMOKES");
	StringCopy(&cVar1, "SMOKED_", 16);
	iVar0 = 0;
	while (iVar0 < 5)
	{
		StringIntConCat(&cVar1, iVar0 + 5, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_55[iVar0]), &cVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 13)
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_74), 19, "PROP_STRIPPERS");
	StringCopy(&cVar1, "STRIPPERS_", 16);
	iVar0 = 0;
	while (iVar0 < 5)
	{
		StringIntConCat(&cVar1, iVar0 + 5, 16);
		MISC::REGISTER_INT_TO_SAVE(&(uParam0->f_74[iVar0]), &cVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 13)
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(uParam0->f_93), 481, "PROP_NAMEDVEHS");
	iVar0 = 0;
	while (iVar0 < 30)
	{
		StringCopy(&cVar1, "NAMEDVEH_", 16);
		StringIntConCat(&cVar1, iVar0, 16);
		MISC::_0xFAA457EF263E8763(&(uParam0->f_93[iVar0 /*16*/]), &cVar1);
		iVar0++;
	}
	MISC::STOP_SAVE_ARRAY();
	MISC::STOP_SAVE_ARRAY();
...
void func_29()
{
	...
	{
		Global_111560.f_668.f_1307 = (Global_111560.f_668.f_1307 - iVar0);
	}
}
...
void func_30()
{
	...
	while (iVar0 < 3)
	{
		...
		while (iVar1 <= 198)
		{
			if (MISC::IS_BIT_SET(Global_111560.f_25177[iVar1], iVar0))
			{
				MISC::CLEAR_BIT(&(Global_111560.f_25177[iVar1]), iVar0);
				iVar2 = (iVar1 + (198 - 171)) + 1;
				MISC::SET_BIT(&(Global_111560.f_25177[iVar2]), iVar0);
			}
			iVar1++;
		}
		iVar0++;
...
void func_34()
{
	if (Global_111560.f_9080.f_99.f_205[7] != 0)
	{
		if (!Global_111560.f_9080.f_330[86 /*6*/])
		{
			Global_111560.f_9080.f_330[86 /*6*/] = 1;
		}
	}
	if (Global_111560.f_9080.f_99.f_205[8] != 0)
	{
		if (!Global_111560.f_9080.f_330[71 /*6*/])
		{
			Global_111560.f_9080.f_330[71 /*6*/] = 1;
		}
	}
	if (Global_111560.f_9080.f_99.f_205[9] != 0)
	{
		if (!Global_111560.f_9080.f_330[91 /*6*/])
		{
			Global_111560.f_9080.f_330[91 /*6*/] = 1;
		}
	}
	if (Global_111560.f_9080.f_99.f_205[10] != 0)
	{
		if (!Global_111560.f_9080.f_330[67 /*6*/])
		{
			Global_111560.f_9080.f_330[67 /*6*/] = 1;
		}
	}
	if (Global_111560.f_9080.f_99.f_205[11] != 0)
	{
		if (!Global_111560.f_9080.f_330[77 /*6*/])
		{
			Global_111560.f_9080.f_330[77 /*6*/] = 1;
		}
	}
	func_35(195, 198);
	func_35(195, 197);
...
void func_35(int iParam0, int iParam1)
{
	...
	Var0 = { Global_111560.f_10189[iParam0 /*12*/] };
	uVar1 = Global_111560.f_10189[iParam0 /*12*/].f_4;
	uVar2 = Global_111560.f_10189[iParam0 /*12*/].f_5;
	uVar3 = Global_111560.f_10189[iParam0 /*12*/].f_6;
	uVar4 = Global_111560.f_10189[iParam0 /*12*/].f_7;
	uVar5 = Global_111560.f_10189[iParam0 /*12*/].f_8;
	uVar6 = Global_111560.f_10189[iParam0 /*12*/].f_9;
	uVar7 = Global_111560.f_10189[iParam0 /*12*/].f_10;
	uVar8 = Global_111560.f_10189[iParam0 /*12*/].f_11;
	Global_111560.f_10189[iParam0 /*12*/] = { Global_111560.f_10189[iParam1 /*12*/] };
	Global_111560.f_10189[iParam0 /*12*/].f_4 = Global_111560.f_10189[iParam1 /*12*/].f_4;
	Global_111560.f_10189[iParam0 /*12*/].f_5 = Global_111560.f_10189[iParam1 /*12*/].f_5;
	Global_111560.f_10189[iParam0 /*12*/].f_6 = Global_111560.f_10189[iParam1 /*12*/].f_6;
	Global_111560.f_10189[iParam0 /*12*/].f_7 = Global_111560.f_10189[iParam1 /*12*/].f_7;
	Global_111560.f_10189[iParam0 /*12*/].f_8 = Global_111560.f_10189[iParam1 /*12*/].f_8;
	Global_111560.f_10189[iParam0 /*12*/].f_9 = Global_111560.f_10189[iParam1 /*12*/].f_9;
	Global_111560.f_10189[iParam0 /*12*/].f_10 = Global_111560.f_10189[iParam1 /*12*/].f_10;
	Global_111560.f_10189[iParam0 /*12*/].f_11 = Global_111560.f_10189[iParam1 /*12*/].f_11;
	Global_111560.f_10189[iParam1 /*12*/] = { Var0 };
	Global_111560.f_10189[iParam1 /*12*/].f_4 = uVar1;
	Global_111560.f_10189[iParam1 /*12*/].f_5 = uVar2;
	Global_111560.f_10189[iParam1 /*12*/].f_6 = uVar3;
	Global_111560.f_10189[iParam1 /*12*/].f_7 = uVar4;
	Global_111560.f_10189[iParam1 /*12*/].f_8 = uVar5;
	Global_111560.f_10189[iParam1 /*12*/].f_9 = uVar6;
	Global_111560.f_10189[iParam1 /*12*/].f_10 = uVar7;
	Global_111560.f_10189[iParam1 /*12*/].f_11 = uVar8;
}
...
void func_36()
{
	...
	while (iVar0 < 16)
	{
		if (!func_37(Global_111560.f_24899[iVar0 /*4*/]))
		{
			if (Global_111560.f_24899[iVar0 /*4*/] != 145)
			{
				Global_111560.f_24899[iVar0 /*4*/] = 145;
			}
		}
		iVar0++;
	}
