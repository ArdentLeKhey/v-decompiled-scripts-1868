...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				iLocal_46 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("mission_complete");
				iLocal_45 = 1;
				break;
			...
			case 2:
				...
				GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_46, "SET_MISSION_TITLE_COLOUR", ScriptParam_50.f_2, ScriptParam_50.f_2, ScriptParam_50.f_2, -1082130432, -1082130432);
				...
				GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_46, "SET_MEDAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), -1082130432, -1082130432, -1082130432, -1082130432);
			...
			case 3:
				if (((func_2(&iLocal_47) > ScriptParam_50.f_67 && ScriptParam_50.f_67 != -1f) || CAM::IS_SCREEN_FADED_OUT()) || Global_30880)
				{
					func_19();
				}
				else
