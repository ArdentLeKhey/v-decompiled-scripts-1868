				...
				if (func_113())
				{
					...
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
							...
							vVar3 = { vLocal_55 };
							vVar4 = { vLocal_55 };
							func_99(iLocal_48, &vVar1, &vVar2, &vVar3, &vVar4);
							fVar5 = 0f;
							fVar6 = 0f;
							func_98(vVar1, vVar2, vVar3, &fVar5, &fVar6);
							fVar7 = (fVar5 * fVar6);
							if (((((fVar7 >= 0.35f && func_97(vVar1, 0f, 1f)) && func_97(vVar2, 0f, 1f)) && func_97(vVar3, 0f, 1f)) && func_97(vVar4, 0f, 1f)) || ((((fVar7 < 0.35f && func_97(vVar1, 0.05f, 0.95f)) && func_97(vVar2, 0.05f, 0.95f)) && func_97(vVar3, 0.05f, 0.95f)) && func_97(vVar4, 0.05f, 0.95f)))
							{
								if (fVar5 >= 0.08f && fVar6 >= 0.101f)
								{
									func_96(&iLocal_49, Local_54[iLocal_48 /*8*/], 0.01f);
									func_96(&iLocal_50, vVar1, 0.01f);
									func_96(&iLocal_51, vVar2, 0.01f);
									func_96(&iLocal_52, vVar3, 0.01f);
									func_96(&iLocal_53, vVar4, 0.01f);
									bVar8 = false;
									iVar9 = 0;
...
void func_1()
{
	Global_111560.f_10044.f_135[1] = -1;
}
...
void func_2(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_111560.f_24990), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_111560.f_24990), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_111560.f_24990.f_1), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_111560.f_24990.f_1), iVar0);
		}
	}
}
...
void func_12(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_23(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_13(&(Global_76389[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_13(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_13(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
				...
				if (iVar0 == 1)
				{
					...
					while (iVar1 <= 14)
					{
						if ((uVar3[iVar1] != -99 && iVar1 != 12) && iVar1 != 14)
						{
							...
							{
								uVar4 = { func_81(iParam0, uVar3[iVar1]) };
								iVar2 = 0;
								while (iVar2 <= 8)
								{
									func_80(iParam0, 14, uVar4[iVar2], 1, 1);
									func_91(iParam0, 14, uVar4[iVar2], 1);
									iVar2++;
								}
							}
						}
	...
	else
	{
		...
		while (iVar5 < iVar7)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_84(iParam0, func_24(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_89(vVar2.z)] = func_83(iParam1, vVar2.x, func_89(vVar2.z), iVar0);
					}
				}
				else if (vVar2.y != -1)
				{
...
bool func_93(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_111560.f_10044.f_135[iVar0], iVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_111560.f_10044.f_135[iVar0]), iVar1);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_111560.f_10044.f_135[iVar0]), iVar1);
	}
}

void func_96(int iParam0, vector3 vParam1, float fParam2)
{
...
int func_97(vector3 vParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
void func_98(vector3 vParam0, vector3 vParam1, vector3 vParam2, float fParam3, float fParam4)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(vParam1, &vVar1, &(vVar1.f_1));
	GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(vParam2, &vVar2, &(vVar2.f_1));
	*fParam3 = SYSTEM::VDIST(vVar0, vVar1);
	*fParam4 = SYSTEM::VDIST(vVar0, vVar2);
}
...
void func_99(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	{
		vVar1 = { -95.402f, -744.506f, 37.2165f };
		vVar2 = { 0.9047f, 0.4261f, 0f };
		fVar3 = 0.51f;
		fVar4 = 0.35f;
	}
	else if (iParam0 == 29 && vVar0.z <= 36f)
	{
		vVar1 = { -95.4013f, -744.5073f, 37.1846f };
		vVar2 = { 0.9047f, 0.4261f, 0f };
		fVar3 = 0.51f;
		fVar4 = 0.43f;
	}
	...
	{
		vVar1 = { Local_54[iParam0 /*8*/] };
		vVar2 = { Local_54[iParam0 /*8*/].f_3 };
		fVar3 = Local_54[iParam0 /*8*/].f_6;
		fVar4 = Local_54[iParam0 /*8*/].f_7;
	}
	fVar6 = (fVar3 / 2f);
	fVar7 = (fVar4 / 2f);
	vVar8 = { func_100(func_101(vVar2, 0f, 0f, -1f)) };
	vVar9 = { func_100(func_101(vVar2, vVar8)) };
	*uParam1 = { vVar1 + Vector(fVar6, fVar6, fVar6) * vVar8 + Vector(fVar7, fVar7, fVar7) * vVar9 + vVar2 * Vector(fVar5, fVar5, fVar5) };
	*uParam2 = { vVar1 + Vector(fVar6, fVar6, fVar6) * -vVar8 + Vector(fVar7, fVar7, fVar7) * vVar9 + vVar2 * Vector(fVar5, fVar5, fVar5) };
	*uParam3 = { vVar1 + Vector(fVar6, fVar6, fVar6) * vVar8 + Vector(fVar7, fVar7, fVar7) * -vVar9 + vVar2 * Vector(fVar5, fVar5, fVar5) };
	*uParam4 = { vVar1 + Vector(fVar6, fVar6, fVar6) * -vVar8 + Vector(fVar7, fVar7, fVar7) * -vVar9 + vVar2 * Vector(fVar5, fVar5, fVar5) };
}
...
Vector3 func_101(vector3 vParam0, vector3 vParam1)
{
...
int func_102(float fParam0)
{
	...
	while (iVar0 < 50)
	{
		if (!func_93(iVar0))
		{
			fVar3 = SYSTEM::VDIST2(vVar2, Local_54[iVar0 /*8*/]);
...
bool func_105()
{
	...
	if (Global_111560.f_10044.f_135[1] == -1)
	{
		return 1;
	}
	...
	if (iVar0 > 0)
	{
		...
		while (iVar2 <= (iVar0 - 1))
		{
			if (Global_111560.f_10044.f_135[iVar2] != -1)
			{
				return 0;
			}
			iVar2++;
	...
	if (iVar1 == 31)
	{
		return Global_111560.f_10044.f_135[iVar0] == -1;
	}
	return Global_111560.f_10044.f_135[iVar0] == (SYSTEM::ROUND(SYSTEM::POW(2f, SYSTEM::TO_FLOAT(iVar1 + 1))) - 1);
}
		...
		switch (iLocal_56)
		{
			...
			case 1:
				if (iLocal_60 < MISC::GET_GAME_TIMER())
				{
					if (!func_112())
					{
						iLocal_57 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("MIDSIZED_MESSAGE");
...
void func_115(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3, float fParam4)
{
	Local_54[iParam0 /*8*/] = { vParam1 };
	Local_54[iParam0 /*8*/].f_3 = { vParam2 };
