...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110647[Var0 /*10*/].f_9 != -1)
			{
				...
				func_268(&(Global_110647[Var0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_198(Var0);
		func_191(&iLocal_53, &uLocal_54, &(Var0.f_9), vVar1, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_184(&Var0, vVar1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_184(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
...
void func_191(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_190(PLAYER::PLAYER_PED_ID(), vParam4, 1);
					fVar1 = func_190(PLAYER::PLAYER_PED_ID(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
int func_199(var uParam0, bool bParam1)
{
	...
	if ((func_236(*uParam0) || func_234(*uParam0)) || Global_76822 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_235() && Global_98669.f_11 == 6) && iParam0 == func_167(&(Global_98669.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = PED::CREATE_PED(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
...
int func_252(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
...
int func_253(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_254(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
