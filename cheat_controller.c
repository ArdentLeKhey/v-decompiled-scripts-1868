...
void __EntryFunction__()
{
	...
	{
		func_2();
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_1(PLAYER::PLAYER_ID(), 1, 1)) && !Global_1574198) && Global_30736 == 0)
		{
			func_113();
		}
		SYSTEM::WAIT(0);
...
void func_4(int iParam0)
{
	...
	if (STREAMING::HAS_MODEL_LOADED(iParam0))
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_68))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_68, 0))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_68, 0))
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0.x, vVar0.y, (vVar0.z + 4f), 1, false, 0, 1);
						bVar2 = true;
					}
				}
			...
			{
				iLocal_68 = VEHICLE::CREATE_VEHICLE(iParam0, vVar0, fVar1, false, true, false);
...
void func_5(int iParam0)
{
	...
	{
		MISC::SET_BIT(&Global_30983, iParam0);
		Global_30986 = 1;
		func_6();
	}
}
...
int func_18(int iParam0, vector3 vParam1, float fParam2)
{
	...
	iVar13 = SHAPETEST::_START_SHAPE_TEST_RAY(func_19(PLAYER::PLAYER_ID()) + Vector(1f, 0f, 0f), vParam1, 87, PLAYER::PLAYER_PED_ID(), 0);
...
{
	if (MISC::IS_BIT_SET(Global_30981, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_31(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&Global_30982, iParam0);
		func_5(iParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_30982, iParam0);
	}
}
...
void func_36()
{
	...
	switch (iLocal_64)
	{
		...
		case 2:
			...
			fVar2 = (fVar2 + 500f);
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0.x, vVar0.y, fVar2, 1, false, 0, 1);
...
{
	if (MISC::IS_BIT_SET(Global_30982, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_74()
{
	...
	{
		iLocal_54 = 1;
		if ((((((func_27(23) || func_27(22)) || func_27(7)) || func_15(9)) || func_15(10)) || !PLAYER::IS_SPECIAL_ABILITY_UNLOCKED(func_75())) || !PLAYER::IS_SPECIAL_ABILITY_ENABLED(PLAYER::PLAYER_ID()))
		{
			func_21("CHEAT_NOT_NOW");
			return;
		}
...
{
	if (MISC::IS_BIT_SET(Global_30984, iParam0))
	{
		if (iParam1 != 0)
		{
			if (iParam1 == Global_30985)
			{
				MISC::CLEAR_BIT(&Global_30984, iParam0);
				iLocal_83 = 1;
				return 1;
			}
			else
