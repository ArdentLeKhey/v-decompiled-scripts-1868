	...
	else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		while (iVar0 < Global_4269890)
		{
			...
			if (iLocal_29 == 0)
			{
				...
				{
					case 0:
						if (MISC::IS_BIT_SET(Global_4269615, 5))
						{
							bVar1 = true;
						}
						break;
					...
					case 1:
						if (MISC::IS_BIT_SET(Global_4269615, 6))
						{
							bVar1 = true;
						}
						break;
					...
					case 2:
						if (MISC::IS_BIT_SET(Global_4269615, 7))
						{
							bVar1 = true;
						}
						break;
					...
					case 3:
						if (MISC::IS_BIT_SET(Global_4269615, 8))
						{
							bVar1 = true;
						}
						break;
				...
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_28);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4269868[iVar0]);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
			if (fLocal_21 == fLocal_21)
			{
...
float func_11(int iParam0)
{
	...
	fLocal_24 = (SYSTEM::COS(((3.14159f / 180f) * vLocal_20.x)) * (Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y));
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4269804[iParam0 /*3*/], vLocal_20));
...
{
	fLocal_26 = SYSTEM::SQRT((((Global_4269804[iParam0 /*3*/] - vLocal_20.x) * (Global_4269804[iParam0 /*3*/] - vLocal_20.x)) + ((Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y) * (Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y))));
	return fLocal_26;
}
...
float func_15()
{
	...
	fLocal_24 = (SYSTEM::COS(((3.14159f / 180f) * vLocal_20.x)) * (Global_21911.f_1 - vLocal_20.y));
	fLocal_25 = MISC::ATAN2(fLocal_23, fLocal_24);
	if (fLocal_25 < 0f)
	{
		fLocal_25 = (fLocal_25 + 360f);
...
float func_16()
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_21911, vLocal_20));
...
float func_17()
{
	fLocal_26 = SYSTEM::SQRT((((Global_21911 - vLocal_20.x) * (Global_21911 - vLocal_20.x)) + ((Global_21911.f_1 - vLocal_20.y) * (Global_21911.f_1 - vLocal_20.y))));
	return fLocal_26;
}
