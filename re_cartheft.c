			...
			if (func_168(iLocal_73) && !func_110())
			{
				if (func_108())
				{
					if (!PED::IS_PED_INJURED(iLocal_71))
					{
						switch (iLocal_47)
						{
								...
								if (!PED::IS_PED_INJURED(iLocal_72))
								{
									if (PED::IS_PED_IN_VEHICLE(iLocal_72, iLocal_73, 0))
									{
										if (iLocal_121 == 2)
										{
											...
											TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 30f, iLocal_120, 200f, 10f, 0);
										...
										else
										{
											...
											TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 40f, iLocal_120, 200f, 10f, 1);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_74);
											TASK::TASK_PERFORM_SEQUENCE(iLocal_72, iLocal_74);
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_74);
										}
							...
							case 1:
								...
								func_76();
								if ((((((func_75() || func_74()) || ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_73)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_73, 1, 5000)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_73)) || PED::IS_PED_INJURED(iLocal_72)) || !PED::IS_PED_IN_VEHICLE(iLocal_72, iLocal_73, 0))
								{
									...
									VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_73, 50f, 5, 0);
					...
					else
					{
						if (!PED::IS_PED_INJURED(iLocal_72))
						{
							if (PED::IS_PED_IN_VEHICLE(iLocal_72, iLocal_73, 0))
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_72, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 50f, iLocal_120, 10f, 10f, 0);
								PED::SET_PED_KEEP_TASK(iLocal_72, true);
								STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(ENTITY::GET_ENTITY_MODEL(iLocal_72));
							}
							else
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_71))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_74);
						TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_88, 1f, 20000, 1193033728, 1056964608);
	...
	if (((!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_168(iLocal_73)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_126))
	{
		switch (iLocal_49)
		{
					...
					if (func_46(1, 0, 1))
					{
						if (!MISC::IS_BIT_SET(Global_7356, 11))
						{
							if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
							{
								...
								{
									HUD::CLEAR_HELP(1);
									while (!func_33(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_53, 1, 1056964608, 0, 1, 0))
									{
										HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
										SYSTEM::WAIT(0);
									}
									func_33(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_53, 0, 1056964608, 0, 1, 0);
								}
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
								if (!PED::IS_PED_INJURED(iLocal_71))
								{
			...
			case 1:
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_71, iLocal_122, sLocal_126, sLocal_128, 1000f, -2f, 0, 0, 1148846080, 0);
				...
				ENTITY::PLAY_ENTITY_ANIM(iLocal_73, sLocal_127, sLocal_126, 1000f, false, false, 0, 0f, 262144);
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_122))
					{
						if (iLocal_132 == 0)
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122) >= 0.83f)
							{
								...
								TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_126, sLocal_129, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122), 0, 0, 0);
			...
			if (iLocal_77)
			{
				if (!PED::IS_PED_INJURED(iLocal_72))
				{
					if (!iLocal_118)
					{
						...
						{
							TASK::TASK_DRIVE_BY(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 40f, 100, 1, -753768974);
							iLocal_118 = 1;
						}
					}
...
int func_86(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_93() || func_92(Global_4456448.f_190930)) || func_91())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
int func_87(int iParam0)
{
	if (iParam0 != func_53())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER::PLAYER_ID()) && func_88(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
		...
		switch (iLocal_48)
		{
			case 0:
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
				{
					...
					else if (!PED::IS_PED_RAGDOLL(iLocal_71) && !TASK::IS_PED_GETTING_UP(iLocal_71))
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_74);
							TASK::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 2f, -8f, -1, 0, 0, 0, 0, 0);
							TASK::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 8f, -8f, -1, 0, 0, 0, 0, 0);
							TASK::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 8f, -2f, -1, 0, 0, 0, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_74);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_74);
							iLocal_124 = MISC::GET_GAME_TIMER();
			...
			case 1:
				if (iLocal_121 == 1)
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_74);
						TASK::TASK_PLAY_ANIM(0, sLocal_80, sLocal_82, 4f, -2f, -1, 0, 0, 0, 0, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_74);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_74);
						iLocal_48 = 2;
				...
				else if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 60f))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1)
					{
						...
						if (bLocal_57 == 0)
						{
							TASK::TASK_PLAY_ANIM(0, sLocal_80, "pointing", 8f, -4f, -1, 0, 0, 0, 0, 0);
						}
						TASK::CLOSE_SEQUENCE_TASK(iLocal_74);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_74);
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1 && !func_115(iLocal_71, -875674219))
				{
					if (iLocal_121 == 1)
					{
						...
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_71, vLocal_85, 1.5f, 1.5f, 1.5f, false, true, 0))
						{
							...
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_74);
								TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_85, 1f, 20000, fLocal_90, 1056964608);
						...
						{
							TASK::TASK_PLAY_ANIM(iLocal_71, sLocal_79, "waiting", 4f, -4f, -1, 0, 0, 0, 0, 0);
							if (func_114(iLocal_71, PLAYER::PLAYER_PED_ID(), 1) < 25f)
							{
								func_113();
							}
			...
			case 3:
				...
				else
				{
					...
					if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_71, vLocal_85, 4f, 4f, 4f, false, true, 0))
					{
						...
						{
							TASK::TASK_GO_STRAIGHT_TO_COORD(iLocal_71, vLocal_85, 1f, 20000, fLocal_90, 1056964608);
						}
					}
...
int func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_149(&iVar2);
		iVar3 = func_148(Var1, Global_111560.f_7683.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_146(Global_111560.f_7683.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_144(Global_111560.f_7683.f_765[iVar2 /*10*/]))
				{
					Global_111560.f_7683.f_765[iVar2 /*10*/] = { Var1 };
					func_145(&Var1);
					return 1;
...
void func_149(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_148(Global_111560.f_7683.f_765[iVar0 /*10*/], Global_111560.f_7683.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_157(int iParam0)
{
	if (func_160())
	{
		...
		if (func_131(Global_111549))
		{
			func_158(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_131(Global_111549))
		{
...
int func_160()
{
	switch (func_161(&Global_30795, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_169()
{
	...
	if (((((((STREAMING::HAS_MODEL_LOADED(iVar3) && STREAMING::HAS_MODEL_LOADED(iVar4)) && STREAMING::HAS_MODEL_LOADED(iVar5)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_79)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_80)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_81)) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4")) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_121 == 1)
		{
			func_183("re_cartheft - Distance to vTop = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_86));
			func_183("re_cartheft - Distance to vBottom = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_87));
		...
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_73, "RE_CAR_STEAL_STOLEN_VEHICLE", 0);
...
int func_187()
{
	if ((Global_111549 == func_140() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111550)
	{
		return 1;
	}
	return 0;
...
int func_194(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_229(Global_111560.f_24990.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110607) || Global_30738) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_223()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_227()) || Global_30738) || func_226()) || func_59(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110607) || Global_30738) || func_226()) || func_59(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110607) || Global_30738) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_227() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_59(8, -1)) || func_222()) || func_221()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_30738) || func_226()) || func_59(8, -1)) || func_224()) || func_223()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_227()) || func_224()) || Global_110607) || Global_30738) || func_226()) || Global_42561) || func_59(8, -1)) || func_223()) || func_221()) || func_222()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_110607) || Global_30738) || func_226()) || func_59(8, -1)) || func_223()) || func_221()) || func_225()) || func_224()) || func_222())
						{
							return 0;
						}
						break;
...
void func_238(int iParam0)
{
	...
	if (func_187())
	{
		...
		func_241(30000);
		StringCopy(&cVar0, func_240(Global_111549, 1), 64);
		if (func_139(Global_111549) > 0)
		{
