	...
	while (true)
	{
		if (Global_41396 != 15)
		{
			if (Global_41359 != 0)
			{
				if (Global_41358 != -1)
				{
					if (!SCRIPT::IS_THREAD_ACTIVE(Global_41359))
					{
		...
		if (Global_41357 > 0)
		{
			...
			if (Global_41357 == iVar0)
			{
				...
				if (Global_41357 > 1)
				{
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < Global_41357)
					{
						if (func_15(Global_41363[iVar4 /*4*/].f_2))
						{
							iVar2[iVar4] = 0;
						}
						else
					...
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < (Global_41357 - 1))
					{
						if (!iVar2[iVar4 + 1])
						{
							if (Global_41363[iVar4 + 1 /*4*/].f_1 < Global_41363[iVar5 /*4*/].f_1)
							{
								iVar5 = iVar4 + 1;
							}
						}
					...
					iVar3 = iVar5;
					if (Global_41363[iVar3 /*4*/].f_2 == 15)
					{
						iVar3 = -1;
					}
					if (iVar3 != -1)
					{
						if (!func_15(Global_41363[iVar3 /*4*/].f_2))
						{
							iVar3 = -1;
						}
					}
				...
				if (iVar3 > -1)
				{
					Global_41358 = Global_41363[iVar3 /*4*/];
					Global_41359 = Global_41363[iVar3 /*4*/].f_3;
					Global_41396 = Global_41363[iVar3 /*4*/].f_2;
					Global_41357 = 0;
					Global_41362 = 0;
				}
				else
		...
		Global_31009 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		SYSTEM::WAIT(0);
	}
	Global_41362 = 0;
}
