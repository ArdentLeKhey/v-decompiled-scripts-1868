...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, 1);
		...
		MISC::CLEAR_AREA(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_245();
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_178(2))
		{
			...
			else if (((func_194(sParam3) && !*uParam8 == 1) && func_127(PLAYER::PLAYER_PED_ID())) && func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam8 = 1;
			}
			if (func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
int func_258(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT("rcmminute1");
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
...
void func_273(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, 1);
	}
	else if (*iParam0 == 34)
	{
