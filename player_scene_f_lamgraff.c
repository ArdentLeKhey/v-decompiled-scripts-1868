...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(Global_98390))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98390, &sLocal_271, &cLocal_303, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98390))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98390, 0, 0);
					TASK::CLEAR_PED_TASKS(Global_98390);
					return 0;
				}
				fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_312);
				if (!iLocal_266)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_313 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_313, 0);
						iLocal_313 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_313 == 0)
					{
						...
						GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_313, fLocal_314, fLocal_315, fLocal_316, false);
					}
				}
...
int func_26()
{
	...
	if (!PED::IS_PED_INJURED(Global_98390))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_267))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98390, &sLocal_271, &cLocal_287, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98390))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98390, 0, 0);
				...
				else
				{
					...
					{
						iLocal_312 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_269, 0f, 0f, fLocal_270, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_312, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(Global_98390, iLocal_312, &sLocal_271, &cLocal_303, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Global_98390);
					PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(Global_98390, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_312))
					{
						iLocal_312 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_269, 0f, 0f, fLocal_270, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_312, true);
...
int func_29(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_30(Global_98390) && iParam1 != 0)
		{
			Global_98390 = 0;
		}
	}
...
void func_37()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_98390) || !STREAMING::HAS_MODEL_LOADED(iLocal_268))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_98390))
	{
		if (!PED::IS_PED_INJURED(Global_98390))
		{
			TASK::TASK_STAND_STILL(Global_98390, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_98390, 1862763509);
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98390, true, 1);
	PED::SET_PED_CONFIG_FLAG(Global_98390, 132, true);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(Global_98390, 16);
	func_39(&Global_98390, Global_93703);
	func_38(&uLocal_100, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_267 = OBJECT::CREATE_OBJECT(iLocal_268, ENTITY::GET_ENTITY_COORDS(Global_98390, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_267, Global_98390, PED::GET_PED_BONE_INDEX(Global_98390, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
...
void func_40()
{
	...
	func_46(iLocal_99, &vLocal_269, &fLocal_270, &cVar0);
	...
	func_43(Var1, &Var2);
	func_41(iLocal_99, &sLocal_271, &cVar3, &cLocal_287, &uVar4, &uVar5);
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[0];
			StringCopy(sParam2, func_53(Global_111560.f_2358.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[1];
			StringCopy(sParam2, func_53(Global_111560.f_2358.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_111560.f_2358.f_539.f_2310[2];
			StringCopy(sParam2, func_53(Global_111560.f_2358.f_539.f_2314[2]), 32);
			return 1;
			break;
