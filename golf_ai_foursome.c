	...
	while (true)
	{
		...
		switch (iVar2)
		{
			case 2:
				...
				func_337(&Var1);
				STREAMING::REQUEST_ANIM_DICT(func_336());
			...
			case 3:
				if (((STREAMING::HAS_ANIM_DICT_LOADED(func_336()) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("GOLF_I", false, -1)) && STREAMING::HAS_ANIM_SET_LOADED("move_m@golfer@")) && func_331(&uVar4))
				{
					func_328(&uVar3);
					iVar2 = 4;
				}
			...
			case 4:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_327(CLOCK::GET_CLOCK_HOURS()))
				{
					if (((!CAM::IS_SPHERE_VISIBLE(func_326(&Var1, (2 + iVar5 * 2)), 10f) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_326(&Var1, (2 + iVar5 * 2)), 10f, 10f, 10f, false, true, 0)) || ((func_325() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || CAM::IS_SCREEN_FADED_OUT())) || func_324(4))
					{
						if (iVar6 == 0)
						{
							func_320(&Var1, &(Var0[iVar5 /*170*/]), (2 + iVar5 * 2), MISC::GET_RANDOM_INT_IN_RANGE(1, 3));
						}
						if (iVar6 < func_319(&(Var0[iVar5 /*170*/])))
						{
							func_313(&Var1, &(Var0[iVar5 /*170*/]), iVar6);
						}
						iVar6++;
						if (iVar6 > func_319(&(Var0[iVar5 /*170*/])))
						{
							iVar6 = 0;
							func_311(&Var1, &(Var0[iVar5 /*170*/]), func_312(&(Var0[iVar5 /*170*/])), func_319(&(Var0[iVar5 /*170*/])));
							iVar5++;
							if (iVar5 >= Var0)
							{
								iVar2 = 5;
...
void func_1(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	{
		iVar0 = 0;
		while (iVar0 < func_319(uParam2))
		{
			func_300(uParam2, iVar0);
			iVar0++;
		}
		return;
	}
	func_299(&(uParam2->f_15[uParam2->f_165 /*34*/]), PLAYER::PLAYER_PED_ID(), uParam2, uParam2->f_165, uParam1);
	uParam2->f_165++;
	if (uParam2->f_165 >= func_319(uParam2))
	{
		uParam2->f_165 = 0;
	}
	...
	while (iVar0 < func_319(uParam2))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_298(&(uParam2->f_15[iVar0 /*34*/]))))
		{
			if (ENTITY::IS_ENTITY_DEAD(func_298(&(uParam2->f_15[iVar0 /*34*/])), 0) && !func_297(uParam2, iVar0, 16777216))
			{
				func_295(uParam2);
				return;
			}
			if (bVar1 && func_294(func_298(&(uParam2->f_15[iVar0 /*34*/])), 1) < 100f)
			{
				func_295(uParam2);
				return;
			}
			if (func_285(func_298(&(uParam2->f_15[iVar0 /*34*/])), func_293(uParam2, 0), &Var2, &uVar3, 1, 1, 0, 1, 1))
			{
				func_295(uParam2);
				return;
			}
	...
	{
		if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == func_293(uParam2, 0))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(func_293(uParam2, 0), false, 0);
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam2->f_152[0]));
			func_284(uParam2, 0, 0);
			if (ENTITY::DOES_ENTITY_EXIST(func_283(uParam2, 0)) && !ENTITY::IS_ENTITY_DEAD(func_283(uParam2, 0), 0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(func_283(uParam2, 0), -1794415470) != 1)
				{
					TASK::CLEAR_PED_TASKS(func_283(uParam2, 0));
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(func_283(uParam2, 0), PLAYER::PLAYER_PED_ID(), -1);
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(func_283(uParam2, 1)) && !ENTITY::IS_ENTITY_DEAD(func_283(uParam2, 1), 0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(func_283(uParam2, 1), -1794415470) != 1)
				{
					TASK::CLEAR_PED_TASKS(func_283(uParam2, 1));
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(func_283(uParam2, 1), PLAYER::PLAYER_PED_ID(), -1);
				}
			}
		}
		if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == func_293(uParam2, 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(func_293(uParam2, 1), false, 0);
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam2->f_152[1]));
			func_284(uParam2, 0, 1);
		}
	}
	if (Global_110588 == func_312(uParam2))
	{
		func_282(uParam2, uParam1, iParam3);
	}
	if (iParam4 == 0 && func_324(16))
	{
		iVar4 = func_281(Global_110588);
		if (func_312(uParam2) != iVar4 && !func_280(iParam3, iVar4))
		{
			func_279(uParam2, uParam1, iVar4);
		}
	}
	if (func_278(uParam0, 1) || func_324(1))
	{
		iVar0 = 0;
		while (iVar0 < func_319(uParam2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_298(&(uParam2->f_15[iVar0 /*34*/]))))
			{
				if (!ENTITY::IS_ENTITY_DEAD(func_298(&(uParam2->f_15[iVar0 /*34*/])), 0))
				{
					ENTITY::SET_ENTITY_COORDS(func_298(&(uParam2->f_15[iVar0 /*34*/])), func_277(&(uParam2->f_15[iVar0 /*34*/])), 1, false, 0, 1);
				}
			}
			iVar0++;
		}
	...
	if (func_278(uParam0, 2) || func_324(2))
	{
		iVar5 = func_281(Global_110588);
		func_279(uParam2, uParam1, iVar5);
	}
	switch (func_275(uParam2))
	{
		case 5:
			if (!func_274(uParam2, 1048576))
			{
				if ((((ENTITY::DOES_ENTITY_EXIST(func_273(uParam2, uParam2->f_165)) && !ENTITY::IS_ENTITY_DEAD(func_273(uParam2, uParam2->f_165), 0)) && ENTITY::DOES_ENTITY_EXIST(func_283(uParam2, uParam2->f_165))) && !func_297(uParam2, uParam2->f_165, 16777216)) && func_272(func_273(uParam2, uParam2->f_165), func_283(uParam2, uParam2->f_165), 1) < 25f)
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(func_283(uParam2, uParam2->f_165), -1794415470) != 1 && !func_297(uParam2, uParam2->f_165, 67108864))
					{
						TASK::CLEAR_PED_TASKS(func_283(uParam2, uParam2->f_165));
						if (!PED::IS_PED_IN_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), 0))
						{
							if (uParam2->f_165 == func_270(uParam2, func_271(uParam2, uParam2->f_165)))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(func_283(uParam2, uParam2->f_165 + 1)) || !PED::IS_PED_GETTING_INTO_A_VEHICLE(func_283(uParam2, uParam2->f_165 + 1)))
								{
									TASK::TASK_ENTER_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), -1, -1, 1f, 1, 0);
								}
							}
							else
							{
								TASK::TASK_ENTER_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), -1, 0, 1f, 1, 0);
							}
						}
					}
				}
				else
				{
					...
					while (iVar0 < func_319(uParam2))
					{
						if (iVar0 != func_269(uParam2))
						{
							if (func_268(uParam1, uParam2, iVar0))
							{
								vVar7 = { func_267(uParam1, func_312(uParam2), iVar0) };
							}
							else if (!func_266(uParam2, -1))
							{
								vVar7 = { func_265(uParam1, func_312(uParam2), iVar0) };
							}
							else
							{
								vVar7 = { func_264(uParam2, iVar0) };
							}
							if (ENTITY::DOES_ENTITY_EXIST(func_283(uParam2, iVar0)) && !ENTITY::IS_ENTITY_DEAD(func_283(uParam2, iVar0), 0))
							{
								TASK::CLEAR_PED_TASKS(func_283(uParam2, iVar0));
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_283(uParam2, iVar0), vVar7, 1f, -1, 1048576000, 0, 1193033728);
							}
						}
						iVar0++;
					}
				...
				if (func_261(uParam2, 0))
				{
					iVar0 = 0;
					while (iVar0 < func_319(uParam2))
					{
						func_260(&(uParam2->f_15[iVar0 /*34*/]), 33554432);
						iVar0++;
					}
					func_276(uParam2, 6);
					func_259(&(uParam2->f_159));
				}
			}
			else
			{
		...
		case 6:
			if (func_256(&(uParam2->f_159), 2f))
			{
				func_253(uParam2, func_269(uParam2), uParam1, 1, 0);
			}
			if ((func_252(uParam2) == 0 && func_319(uParam2) > 2) && !func_297(uParam2, 2, 67108864))
			{
				if (func_319(uParam2) == 3)
				{
					func_253(uParam2, 2, uParam1, 0, 0);
				}
				else
				{
					func_253(uParam2, func_251(uParam2, 2, 3), uParam1, 0, 0);
				}
			}
			else if (func_319(uParam2) > 2 && !func_297(uParam2, 0, 67108864))
			{
				func_253(uParam2, func_251(uParam2, 0, 1), uParam1, 0, 0);
			}
			break;
		
		case 2:
			if (!func_274(uParam2, 8388608))
			{
			...
			if (func_63(uParam2, -1, 0))
			{
				...
				uParam2->f_157 = 0;
				while (uParam2->f_157 < func_319(uParam2))
				{
					func_262(uParam2, 0);
				...
				if (func_274(uParam2, 1048576))
				{
					vVar7 = { func_265(uParam1, func_312(uParam2), func_269(uParam2)) };
					func_42(uParam2, func_269(uParam2), vVar7, uParam1, 0, 1);
					TASK::TASK_TURN_PED_TO_FACE_COORD(func_64(uParam2), func_41(uParam1, func_312(uParam2)), 0);
				}
			}
			else if (func_39(&(uParam2->f_15[func_269(uParam2) /*34*/])))
			{
				func_38(&(uParam2->f_15[func_269(uParam2) /*34*/]));
...
void func_2(var uParam0, var uParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (iVar0 < func_319(uParam0))
	{
		func_17(&(uParam0->f_15[iVar0 /*34*/]), 0, 0);
		func_9(uParam0, iVar0, 0f, 0f, 0f, 5, 1);
		if (ENTITY::DOES_ENTITY_EXIST(func_298(&(uParam0->f_15[iVar0 /*34*/]))))
		{
			if (!ENTITY::IS_ENTITY_DEAD(func_298(&(uParam0->f_15[iVar0 /*34*/])), 0))
			{
				ENTITY::SET_ENTITY_COORDS(func_298(&(uParam0->f_15[iVar0 /*34*/])), func_265(uParam1, iVar1, iVar0), 1, false, 0, 1);
			}
		}
		iVar0++;
	}
	if (bParam2)
	{
		...
		vVar3 = { 5f, 5f, 0f };
		fVar4 = 0f;
		if (func_3(func_326(uParam1, iVar1), func_41(uParam1, iVar1), &vVar2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			iVar5 = 0;
			while (iVar5 < 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_293(uParam0, iVar5)))
				{
					if (!ENTITY::IS_ENTITY_DEAD(func_293(uParam0, iVar5), 0) && !CAM::IS_SPHERE_VISIBLE(vVar2 + FtoV(SYSTEM::TO_FLOAT(iVar5)) * vVar3, 5f))
					{
						ENTITY::SET_ENTITY_COORDS(func_293(uParam0, iVar5), vVar2 + FtoV(SYSTEM::TO_FLOAT(iVar5)) * vVar3, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(func_293(uParam0, iVar5), fVar4);
					}
				}
				iVar5++;
			}
...
int func_7(vector3 vParam0)
{
	...
	if (func_8(vParam0, vVar0) > fVar1)
	{
		...
		if (OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1227.909f, -68.76888f, 43.06714f, -1260.599f, -50.60131f, 44.63058f, 2.74f, 0, false))
		{
			return 1;
		}
	}
...
int func_18(var uParam0, var uParam1)
{
	...
	if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_64(uParam0), true), func_41(uParam1, func_312(uParam0))) < IntToFloat(iVar1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_25(uParam0)) && !ENTITY::IS_ENTITY_DEAD(func_293(uParam0, func_252(uParam0)), 0))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_25(uParam0), true), func_41(uParam1, func_312(uParam0))) > IntToFloat(iVar1))
			{
				return 1;
			}
			func_20(uParam0, uParam1, func_252(uParam0), 1, 38218, 7458);
		}
		return 0;
	}
...
{
	return func_277(&(uParam0->f_15[uParam0->f_157 /*34*/]));
}
...
void func_20(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (((iParam2 == 0 && (iVar0 == 0 || iVar0 == 1)) || (iParam2 == 1 && (iVar0 == 2 || iVar0 == 3))) && func_23(uParam0, iVar0) == 4)
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(func_283(uParam0, iVar0), uParam0->f_15[iVar0 /*34*/].f_21);
...
{
	return func_293(uParam0, func_271(uParam0, func_269(uParam0)));
}
...
int func_26(var uParam0, var uParam1)
{
	...
	{
		return func_269(uParam0);
	}
	iVar2 = 0;
	while (iVar2 < func_319(uParam0))
	{
		if (func_23(uParam0, iVar2) != 0)
		{
			if (func_21(uParam0, iVar2) != 10 && !func_297(uParam0, iVar2, 16777216))
			{
				vVar4 = { func_264(uParam0, iVar2) };
				vVar5 = { func_41(uParam1, func_312(uParam0)) };
				vVar4.z = 0f;
				vVar5.z = 0f;
...
int func_29(var uParam0, var uParam1)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (((((func_28(&(uParam0->f_15[iVar0 /*34*/])) != 3 && func_28(&(uParam0->f_15[iVar0 /*34*/])) != 8) && func_21(uParam0, iVar0) != 10) && !func_297(uParam0, iVar0, 16384)) && !func_30(uParam0, uParam1, iVar0, 0)) && !func_297(uParam0, iVar0, 16777216))
		{
			return 0;
		}
		iVar0++;
...
bool func_30(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = func_269(uParam0);
	}
	return func_32(uParam0, iParam2) >= (func_31(uParam1, func_312(uParam0)) + (5 + iParam3));
}
...
void func_42(var uParam0, int iParam1, vector3 vParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	ENTITY::SET_ENTITY_COORDS(func_283(uParam0, iParam1), vParam2, 0, false, 0, 1);
	iVar1 = func_271(uParam0, iParam1);
	if (ENTITY::DOES_ENTITY_EXIST(func_293(uParam0, iVar1)) && iParam5)
	{
		vVar2 = { 0f, 0f, 0f };
		vVar3 = { 0f, 0f, 0f };
		fVar4 = 0f;
		...
		if (!ENTITY::IS_ENTITY_DEAD(func_293(uParam0, iVar1), 0))
		{
			if (func_297(uParam0, iParam1, 1048576))
			{
				bVar5 = func_43(vParam2 + vVar3, func_41(uParam3, func_312(uParam0)), &vVar2, &fVar4);
			}
			else
			{
				bVar5 = func_3(vParam2 + vVar3, func_41(uParam3, func_312(uParam0)), &vVar2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0);
			}
			if (bVar5 && !CAM::IS_SPHERE_VISIBLE(vVar2, 5f))
			{
				ENTITY::SET_ENTITY_COORDS(func_293(uParam0, iVar1), vVar2, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(func_293(uParam0, iVar1), fVar4);
			}
		}
	}
}
...
void func_44(var uParam0, var uParam1)
{
	...
	iVar0 = 0;
	while (iVar0 < func_319(uParam1))
	{
		func_10(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, 0f, 5, 1);
		func_50(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, -1f);
		func_49(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, 0f);
		func_48(&(uParam1->f_15[iVar0 /*34*/]), func_326(uParam0, func_312(uParam1)));
		func_46(&(uParam1->f_15[iVar0 /*34*/]), func_47(uParam0, func_312(uParam1)));
...
int func_52(var uParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		func_55(func_312(uParam2));
	}
	iVar0 = 1;
	if (func_312(uParam2) >= iParam3 + 1 || uParam0->f_23)
	{
		if (bParam4 && iVar0)
		{
		...
		{
			if (func_312(uParam2) >= func_53(uParam1))
			{
				func_54(uParam2, 0);
			}
			return 0;
...
int func_63(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		...
		{
			if ((func_22(&(uParam0->f_15[iVar0 /*34*/])) != 10 && (func_24(&(uParam0->f_15[iVar0 /*34*/])) != 4 || !bParam2)) && !func_297(uParam0, iVar0, 16777216))
			{
				return 0;
			}
		}
...
int func_64(var uParam0)
{
	...
	return func_298(&(uParam0->f_15[uParam0->f_157 /*34*/]));
}

void func_65(var uParam0, int iParam1)
{
	func_260(&(uParam0->f_15[uParam0->f_157 /*34*/]), iParam1);
}
...
int func_66(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar1 = (func_312(uParam1) + iParam3);
	...
	while (iVar0 < *uParam2)
	{
		if (func_312(uParam2[iVar0 /*170*/]) == iVar1 && !func_297(uParam2[iVar0 /*170*/], 0, 8388608))
		{
			return 0;
		}
		iVar0++;
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	{
		case 0:
			vVar0 = { func_326(uParam1, func_312(uParam2)) };
			func_4(&vVar0, 1073741824, 1065353216);
			if (!ENTITY::DOES_ENTITY_EXIST(func_249(uParam2)))
			{
				func_244(uParam2, func_246(vVar0, func_247(func_248(uParam1, func_312(uParam2)), func_19(uParam2))));
			}
			else if (!func_243())
			{
				ENTITY::SET_ENTITY_COORDS(func_249(uParam2), vVar0, 1, false, 0, 1);
			}
			func_242(uParam2, ENTITY::GET_ENTITY_COORDS(func_249(uParam2), true));
			if (func_31(uParam1, func_312(uParam2)) == 1)
			{
			...
			if (!bLocal_376)
			{
				func_230(uParam0, uParam1, uParam2, 1);
			}
			func_203(uParam1, uParam2, uParam0, 0, 0, 1, 1, 0);
			ENTITY::SET_ENTITY_RECORDS_COLLISIONS(func_249(uParam2), 0);
			func_202(func_249(uParam2), 1);
			func_199(uParam0, uParam1, uParam2);
			func_198(&(uParam2->f_1), &(uParam2->f_15[func_269(uParam2) /*34*/]), uParam0);
			func_195(uParam2, func_196(uParam2, uParam0));
			func_259(&(uParam2->f_162));
			func_262(uParam2, 3);
			break;
		...
		case 1:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(func_249(uParam2)))
			{
				func_244(uParam2, func_246(func_326(uParam1, func_312(uParam2)) + Vector(0.075f, 0f, 0f), func_247(func_248(uParam1, func_312(uParam2)), func_19(uParam2))));
			}
			func_199(uParam0, uParam1, uParam2);
			func_198(&(uParam2->f_1), &(uParam2->f_15[func_269(uParam2) /*34*/]), uParam0);
			if (!func_194(uParam2))
		...
		case 3:
			if (func_193(uParam2) || func_40(&(uParam2->f_15[func_269(uParam2) /*34*/]), 1048576))
			{
				if (func_40(&(uParam2->f_15[func_269(uParam2) /*34*/]), 1048576))
				{
					func_192(uParam2, func_269(uParam2), uParam1, 0, 1);
					func_189(&(uParam2->f_162));
					func_262(uParam2, func_188());
					return;
				}
				...
				func_262(uParam2, func_188());
				func_187(uParam2, 1);
				func_175(uParam0, &(uParam2->f_15[func_269(uParam2) /*34*/]), &(uParam2->f_1));
		...
		case 4:
			if (func_170(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_269(uParam2) /*34*/].f_2, 0) < 1f)
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_269(uParam2) /*34*/].f_2))
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam2->f_15[func_269(uParam2) /*34*/].f_2);
					func_203(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_276(uParam2, 0);
					func_262(uParam2, 1);
			...
			{
				if (((uParam2->f_1 == 4 || uParam2->f_1 == 6) || func_274(uParam2, 1048576)) && ENTITY::DOES_ENTITY_EXIST(func_249(uParam2)))
				{
					if (((func_156(func_64(uParam2)) || func_171(&(uParam2->f_162), 2.5f)) || func_274(uParam2, 1048576)) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(func_249(uParam2)))
					{
						if (func_274(uParam2, 1048576))
						{
							if (bLocal_0)
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(func_249(uParam2)))
				{
					uParam2->f_1 = 0;
					func_262(uParam2, 0);
				}
		...
		case 5:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(func_249(uParam2)))
			{
				func_244(uParam2, func_246(func_19(uParam2), func_247(func_248(uParam1, func_312(uParam2)), func_19(uParam2))));
			}
			if (!func_172(uParam1, uParam2))
			{
				func_105(uParam0, uParam1, uParam2);
				func_104(&(uParam2->f_1));
				if (func_274(uParam2, 4))
				{
		...
		case 6:
			func_118(uParam0, uParam2, 1);
			if ((func_88(uParam2) || func_87(uParam2)) || func_7(ENTITY::GET_ENTITY_COORDS(func_249(uParam2), true)))
			{
				func_86(uParam2);
			}
			else
			...
			func_262(uParam2, 7);
			func_76(uParam2, 1);
			if (func_75(uParam2) > func_31(uParam1, func_312(uParam2)) + 3)
			{
				func_262(uParam2, 7);
		...
		case 8:
			...
			if (!func_63(uParam2, func_269(uParam2), 0) && !func_274(uParam2, 1048576))
			{
				TASK::CLEAR_PED_TASKS(func_64(uParam2));
				TASK::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
				TASK::TASK_GO_TO_COORD_ANY_MEANS(0, func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1f, 0, 0, 786603, -1082130432);
				TASK::TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_312(uParam2)), 0);
				TASK::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
				TASK::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
				TASK::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
			}
			break;
		...
		case 7:
			...
			{
				if (func_70(uParam1, uParam2) && !func_266(uParam2, func_269(uParam2)))
				{
					if (!func_274(uParam2, 1048576))
					{
						if (bLocal_0)
						...
						TASK::CLEAR_PED_TASKS(func_64(uParam2));
						TASK::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_265(uParam1, func_312(uParam2), func_269(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
						TASK::TASK_TURN_PED_TO_FACE_COORD(0, func_326(uParam1, func_312(uParam2)), 0);
						TASK::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
						TASK::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
						TASK::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
					}
					...
					{
						ENTITY::SET_ENTITY_COORDS(func_64(uParam2), func_265(uParam1, func_312(uParam2), func_269(uParam2)), 1, false, 0, 1);
					}
				}
				else if (func_194(uParam2) || func_274(uParam2, 67108864))
				{
					if (!func_274(uParam2, 1048576))
					{
						if (!func_63(uParam2, func_269(uParam2), 0))
						{
							if (bLocal_0)
							{
							}
							TASK::CLEAR_PED_TASKS(func_64(uParam2));
							TASK::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
							TASK::TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_312(uParam2)), 0);
							TASK::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
							TASK::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
							TASK::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
					...
					else if (!func_274(uParam2, 4194304))
					{
						ENTITY::SET_ENTITY_COORDS(func_64(uParam2), func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1, false, 0, 1);
					}
				}
				else if (!func_274(uParam2, 1048576))
				{
					if (!func_63(uParam2, func_269(uParam2), 0) && ENTITY::DOES_ENTITY_EXIST(func_25(uParam2)))
					{
				...
				if (func_35(uParam2) == 8 || func_274(uParam2, 16384))
				{
					func_262(uParam2, 10);
...
{
	return func_69(func_269(uParam0));
}
...
{
	if (func_312(uParam1) < 0 || func_312(uParam1) >= func_53(uParam0))
	{
		return 0;
	}
...
void func_77(var uParam0, var uParam1)
{
	if (!bLocal_376)
	{
		...
		func_242(uParam1, ENTITY::GET_ENTITY_COORDS(func_249(uParam1), true));
		func_84(uParam1, SYSTEM::VDIST(func_19(uParam1), func_41(uParam0, func_312(uParam1))));
	}
	else
	{
		ENTITY::SET_ENTITY_COORDS(func_249(uParam1), func_19(uParam1) + Vector(0.05f, 0f, 0f), 1, false, 0, 1);
		func_82(uParam1);
		func_80(uParam1);
	}
	ENTITY::SET_ENTITY_MAX_SPEED(func_249(uParam1), 150f);
	func_202(func_249(uParam1), 1);
	func_65(uParam1, 2);
	func_78(uParam1, 0f);
}
...
void func_89(var uParam0, var uParam1, var uParam2)
{
	...
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		...
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, iVar5) && !func_274(uParam2, 268435456))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_249(uParam2), 0, false, 0);
				ENTITY::SET_ENTITY_COLLISION(iVar5, false, 0);
				func_74(uParam2, 268435456);
			}
		}
	}
	else if (func_274(uParam2, 2) && func_194(uParam2))
	{
		if (!func_278(uParam0, 268435456) && SYSTEM::VDIST2(vVar4, vVar3) < (0.3f * 0.3f))
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_CUP_MISS_MASTER", func_249(uParam2), 0, false, 0);
			func_125(uParam0, 268435456);
		}
	}
	if (((fVar2 < 0.25f || (fVar2 < 6f && func_98(uParam1, uParam2))) || func_274(uParam2, 256)) || func_97())
	{
		...
		if ((!func_98(uParam1, uParam2) && (((func_274(uParam2, 256) || SYSTEM::VDIST2(vVar4, vVar3) < (0.1601f * 0.1601f)) || func_97()) || func_93(uParam1, uParam2))) && 0)
		{
	...
	{
		ENTITY::SET_ENTITY_COORDS(iVar0, func_90(uParam2), 1, false, 0, 1);
		ENTITY::SET_ENTITY_RECORDS_COLLISIONS(iVar0, 0);
		func_202(iVar0, 1);
		func_262(uParam2, 6);
		func_74(uParam2, 68);
...
int func_93(var uParam0, var uParam1)
{
	...
	if (SYSTEM::VDIST(vVar0, func_41(uParam0, func_312(uParam1))) > fVar1)
	{
		return 0;
	}
	return 1;
...
int func_98(var uParam0, var uParam1)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(func_249(uParam1)))
	{
		return 0;
	}
	vVar0 = { ENTITY::GET_ENTITY_COORDS(func_249(uParam1), false) };
	vVar1 = { func_41(uParam0, func_312(uParam1)) };
...
{
	AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IN_WATER_MASTER", func_249(uParam0), 0, false, 0);
	return;
	GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_golf_landing_water", ENTITY::GET_ENTITY_COORDS(func_249(uParam0), true), 0f, 0f, func_247(ENTITY::GET_ENTITY_COORDS(func_249(uParam0), true), func_19(uParam0)), 1065353216, 0, 0, 0);
}
...
void func_105(var uParam0, var uParam1, var uParam2)
{
	...
	iVar0 = func_249(uParam2);
	iVar1 = func_102(uParam1, func_312(uParam2));
	...
	GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(iVar0, true), ENTITY::GET_ENTITY_COORDS(iVar0, true) + func_6(vVar9), 0, 0, 0, 255);
	if (func_100(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, iVar1))
			{
				...
				{
					ENTITY::SET_ENTITY_COLLISION(iVar1, false, 0);
				}
			}
		}
		fVar10 = 1f;
		...
		if (!func_278(uParam0, 64))
		{
			if (fVar11 != 0f && SYSTEM::VMAG2(vVar2) > 9.5f)
			{
				...
				vVar16 = { FtoV(func_8(vLocal_386, vVar15)) * vVar15 };
				vVar14 = { FtoV(-(1f + fVar11)) * vVar16 + vLocal_386 };
				vVar17 = { vLocal_386 - vVar16 };
	...
	else
	{
		...
		if (!bLocal_378 && !func_111(uParam2))
		{
	...
	if (!func_274(uParam2, 2))
	{
		if (!func_96(&(uParam2->f_159)) && !func_274(uParam2, 2))
		{
			func_259(&(uParam2->f_159));
		}
		if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0) && func_256(&(uParam2->f_159), 0.2f))
		{
	...
	{
		func_92(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, true), func_41(uParam1, func_312(uParam2)));
	}
	...
	{
		vLocal_386 = { ENTITY::GET_ENTITY_VELOCITY(iVar0) };
	}
	func_310(uParam0, 32);
}
...
void func_106(var uParam0)
{
	...
	sVar0 = "";
	switch (ENTITY::GET_LAST_MATERIAL_HIT_BY_ENTITY(func_249(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_107(sVar0))
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, ENTITY::GET_ENTITY_COORDS(func_249(uParam0), true), 0f, 0f, func_247(ENTITY::GET_ENTITY_COORDS(func_249(uParam0), true), func_19(uParam0)), 1065353216, 0, 0, 0);
	}
}
...
{
	return ((func_94(uParam0) == 2 || func_274(uParam0, 65536)) && func_85(uParam0) == 4);
}
...
void func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_107(sVar0))
	{
		if (bParam1)
		{
			AUDIO::PLAY_SOUND_FROM_COORD(-1, sVar0, ENTITY::GET_ENTITY_COORDS(func_249(uParam0), true), 0, false, 0, 0);
		}
		else
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_249(uParam0), 0, false, 0);
		}
	}
}
...
int func_118(var uParam0, var uParam1, bool bParam2)
{
	...
	sVar1 = func_121(uParam0, &(uParam1->f_15[func_269(uParam1) /*34*/]), 1, 1);
...
int func_126(var uParam0, var uParam1, var uParam2)
{
	...
	func_202(func_249(uParam2), 0);
	ENTITY::SET_ENTITY_RECORDS_COLLISIONS(func_249(uParam2), 1);
	OBJECT::SET_OBJECT_PHYSICS_PARAMS(func_249(uParam2), -1f, -1f, 0f, 0f, 0.01f, -1f, -1f, -1f, -1f, -1f, -1082130432);
	bVar0 = func_85(uParam2) == 4;
	fVar1 = func_142(&(uParam2->f_15[func_269(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_377, 0);
	fVar2 = 1f;
	...
	switch (uParam2->f_1)
	{
		case 4:
			...
			{
				fVar4 = (func_247(func_90(uParam2), func_19(uParam2)) + 90f);
			}
	...
	ENTITY::SET_ENTITY_VELOCITY(func_249(uParam2), vVar6);
	ENTITY::SET_ENTITY_MAX_SPEED(func_249(uParam2), 150f);
	func_125(uParam0, 32);
	func_129(uParam0, uParam2, 0, func_278(uParam0, 16), uParam2->f_1.f_2 < 50f);
...
void func_127(var uParam0, var uParam1, var uParam2)
{
	...
	switch (func_35(uParam0))
	{
		...
		case 5:
			if (uParam0->f_1 != 6 && func_31(uParam1, func_312(uParam0)) > 3)
			{
	...
	func_128(uParam0, func_278(uParam2, 16));
	if (!func_107(sVar0))
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, func_19(uParam0), 0f, 0f, func_116(uParam0), 1065353216, 0, 0, 0);
	}
}
...
void func_128(var uParam0, bool bParam1)
{
	...
	return;
	if (!func_194(uParam0) && ENTITY::DOES_ENTITY_EXIST(func_249(uParam0)))
	{
		iVar0 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_golf_ball_trail", func_249(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
		if (bParam1)
		{
...
void func_129(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_107(sVar0))
	{
		if (iParam2 || !ENTITY::DOES_ENTITY_EXIST(func_249(uParam1)))
		{
			AUDIO::PLAY_SOUND_FROM_COORD(-1, sVar0, func_19(uParam1), 0, false, 0, 0);
		}
		else
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_249(uParam1), 0, false, 0);
		}
	}
}
...
void func_150()
{
	...
	{
		if (func_154(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_153(PLAYER::PLAYER_PED_ID());
			if (func_152(iVar0) && (!func_151(14) || Global_110511))
			{
...
void func_157(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = 1000;
	if (func_274(uParam0, 256))
	{
		iVar0 = 450;
	}
	bVar1 = func_274(uParam0, 131072);
	fVar2 = 0f;
	...
	if ((uParam2->f_11 == 0 && !func_274(uParam0, 1048576)) || func_167(uParam0) == 0)
	{
		func_187(uParam0, 1);
	...
	else if (((((uParam2->f_11 + iVar0) < uParam2->f_12 || uParam2->f_10 != 0) && *uParam2 != 4) && *uParam2 != 6) || func_274(uParam0, 1048576))
	{
		func_187(uParam0, 4);
		*uParam2 = 4;
		if (bParam3)
...
int func_172(var uParam0, var uParam1)
{
	...
	vVar1 = { ENTITY::GET_ENTITY_COORDS(func_249(uParam1), false) };
	if (func_35(uParam1) != 3 && SYSTEM::VDIST2(vVar1, func_41(uParam0, func_312(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	if (SYSTEM::VDIST2(vVar1, func_41(uParam0, func_312(uParam1))) > (55f * 55f))
	{
		return 0;
	}
	return 1;
	...
	if (!PED::IS_PED_INJURED(iVar0))
	{
		...
		switch (func_168(uParam1))
		{
			...
			case 1:
				...
				{
					TASK::TASK_PLAY_ANIM(iVar0, func_119(0), &cVar10, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (bLocal_0)
					{
					}
				}
			...
			case 4:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar11, 3))
				{
					...
					{
						TASK::TASK_PLAY_ANIM(iVar0, func_119(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
					}
...
char* func_178(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	vVar2 = { ENTITY::GET_ENTITY_COORDS(func_298(uParam0), true) };
	if (bParam3)
	{
		vVar2 = { iParam4, iParam5, iParam6 };
	}
	vVar3 = { func_277(uParam0) };
	fVar4 = 52.25f;
	func_183(iVar1, &fVar4, &fVar5, &fVar6);
	vVar2.z = (vVar2.z + fVar6);
	vVar7 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(func_298(uParam0)) };
	vVar8 = { func_6(vVar3 - vVar2) };
	vVar9 = { func_131(vVar7, 90f) };
	vVar10 = { vVar7 };
	func_179(&vVar10, fVar4, vVar9);
	fVar11 = MISC::ACOS(func_8(vVar7, vVar8));
	fVar12 = (fVar11 - fVar4);
	vVar13 = { func_6(vVar10) };
	func_179(&vVar13, fVar12, vVar9);
	GRAPHICS::DRAW_DEBUG_LINE(vVar2, vVar2 + vVar8, 255, 0, 0, 255);
	GRAPHICS::DRAW_DEBUG_LINE(vVar2, vVar2 + vVar7, 0, 0, 255, 255);
	GRAPHICS::DRAW_DEBUG_LINE(vVar2, vVar2 + vVar13, 255, 255, 255, 255);
	GRAPHICS::DRAW_DEBUG_LINE(vVar2, vVar2 + vVar10, 0, 0, 0, 255);
	if (fVar11 < fVar4)
	{
...
Vector3 func_182(vector3 vParam0, vector3 vParam1)
{
	vector3 vVar0;
	
	vVar0 = { vParam0 - func_180(vParam0, vParam1) };
	return vVar0;
}
...
{
	func_42(uParam0, iParam1, func_264(uParam0, iParam1), uParam2, bParam3, iParam4);
}

int func_193(var uParam0)
{
	if (func_243() || func_194(uParam0))
	{
...
Vector3 func_196(var uParam0, var uParam1)
{
	...
	if (func_274(uParam0, 1048576) || func_85(uParam0) == 4)
	{
		vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), (func_116(uParam0) + fVar1), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_269(uParam0) /*34*/])))) * ((func_165(uParam0, 1) * fVar2) / 100f)), 0f, 0f) };
	}
	else if (func_35(uParam0) != 3)
	{
		vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_269(uParam0) /*34*/])))) * (func_165(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
...
void func_203(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (bParam5)
	{
		vVar0 = { func_248(uParam0, func_312(uParam1)) };
	}
	else
	{
		vVar0 = { func_41(uParam0, func_312(uParam1)) };
	}
	iVar1 = (func_247(vVar0, func_19(uParam1)) + 90f);
	func_204(&(uParam1->f_15[func_269(uParam1) /*34*/]), uParam2, iVar1, 0, iParam3, iParam4, iParam6, bParam7);
}
...
void func_204(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		TASK::TASK_STAND_STILL(func_298(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	func_260(uParam0, 134217728);
	func_229(uParam0, iParam2);
	vVar1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_277(uParam0), func_117(uParam0), func_228(iVar0)) };
	vVar2 = { ENTITY::GET_ENTITY_COORDS(func_298(uParam0), true) };
	if (bParam3)
	{
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(func_298(uParam0));
	}
	if (iParam5 || func_40(uParam0, 1048576))
	{
		...
		else
		{
			...
			if (bVar4)
			{
				ENTITY::SET_ENTITY_HEADING(func_298(uParam0), func_117(uParam0));
				ENTITY::SET_ENTITY_COORDS(func_298(uParam0), vVar1, 0, true, 1, 1);
			}
		}
	}
	else
	{
		TASK::CLEAR_PED_TASKS(func_298(uParam0));
		TASK::OPEN_SEQUENCE_TASK(&(uParam0->f_21));
		if (func_243() || func_186(uParam0))
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, -1, 0.25f, 512, iParam2);
		...
		TASK::TASK_PERFORM_SEQUENCE(func_298(uParam0), uParam0->f_21);
...
void func_205(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (!func_210(func_298(uParam0), iVar0))
		{
			return;
		}
	}
	...
	if (!bParam2 || bVar2)
	{
		...
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(func_164(uParam0), iVar3, PED::GET_PED_BONE_INDEX(iVar3, 28422), func_207(iVar3, iVar0), func_206(iVar3, iVar0), 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_209(var uParam0, var uParam1)
{
	...
	func_38(uParam0);
	iVar0 = OBJECT::CREATE_OBJECT_NO_OFFSET(func_211(uParam1, func_123(uParam0)), func_277(uParam0), false, true, false);
	return iVar0;
}
...
void func_212(var uParam0, var uParam1)
{
	...
	func_213(func_298(uParam0), &cVar3, &cVar4, bVar2, fVar0, 1f, 10, 0f, 0f, 0f, 0);
	if (!func_40(uParam0, 32768))
	{
		PED::_0x2208438012482A1A(func_298(uParam0), 1, 0);
		PED::_0xED3C76ADFA6D07C4(func_298(uParam0));
...
void func_213(int iParam0, char[4] cParam1, char[4] cParam2, bool bParam3, float fParam4, float fParam5, int iParam6, float fParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	Var1.f_2 = func_214(cParam1);
	Var1.f_1 = func_119(bParam10);
	Var1.f_3 = fParam7;
	Var1.f_4 = fParam5;
	if (bParam3)
	{
		Var1.f_7 = func_214(cParam2);
		Var1.f_6 = func_119(1);
		Var1.f_8 = fParam7;
		Var1.f_9 = fParam5;
	}
	Var1.f_20 = iParam6;
	TASK::TASK_SCRIPTED_ANIMATION(iParam0, &Var1, &Var0, &Var0, iParam8, iParam9);
}
...
int func_215(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, float fParam10)
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (!func_224())
	{
		...
		{
			if (((bParam7 && func_220(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_222 == 1)
			{
			}
			else if (func_219() == 28)
			{
	...
	if (((!vParam0.x == Global_2437549.f_1234 || !vParam0.y == Global_2437549.f_1234.f_1) || !vParam0.z == Global_2437549.f_1234.f_2) || !fParam1 == Global_2437549.f_1237)
	{
		...
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2437549.f_1238) < func_218(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
	...
	if (Global_2437549.f_1232)
	{
		...
		if (Global_2437549.f_1239 > -1)
		{
			...
			if (func_216(&(Global_2437549.f_1239), vParam0, fParam1, iVar0))
			{
				func_225(bParam4, bParam7);
				return 1;
			}
...
int func_216(var uParam0, vector3 vParam1, float fParam2, int iParam3)
{
...
void func_230(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	fVar3 = -9999f;
	fVar4 = -1f;
	if (func_172(uParam1, uParam2) || func_243())
	{
		if (func_241(uParam1, uParam2, 0))
		{
			func_239(uParam2, 7);
		}
		else if (fVar0 < 5f)
		...
		func_237(uParam2, func_135(uParam0, 19));
	...
	{
		func_239(uParam2, 0);
		func_237(uParam2, func_135(uParam0, 16));
		if (func_140(uParam2) != -1)
		{
			return;
		}
	}
	else if (func_235(uParam1, uParam2, bParam3))
	{
		func_239(uParam2, 3);
	}
	else
	...
	func_232(uParam1, uParam2, &iVar5, &iVar6, 0);
	fVar4 = func_201(uParam0, func_135(uParam0, iVar6));
	if (func_136(uParam2) == 3 || func_136(uParam2) == 2)
	{
		fVar4 = (fVar4 * func_231());
	}
	if (fVar4 > fVar0)
	{
		func_237(uParam2, func_135(uParam0, iVar6));
		return;
	}
	iVar2 = -1;
	iVar1 = 0;
	while (iVar1 < *uParam0)
	{
		...
		if (iVar7 >= iVar5 && iVar7 <= iVar6)
		{
			...
			if (func_263(uParam1, uParam2))
			{
				if (func_312(uParam2) == 2)
				{
					fVar4 = (fVar4 * 1.1f);
				}
				else if (func_312(uParam2) == 3)
				{
					fVar4 = (fVar4 * 2.25f);
				}
			}
	...
	if (iVar2 != -1)
	{
		func_237(uParam2, iVar2);
		return;
	}
	func_237(uParam2, func_135(uParam0, iVar5));
}
...
void func_232(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else if (func_235(uParam0, uParam1, 1))
	{
		*uParam2 = 7;
		if (bParam4)
		{
	...
	else if (func_263(uParam0, uParam1))
	{
		*uParam2 = 1;
		*uParam3 = 17;
	}
	else if (func_233(uParam1))
	{
		*uParam2 = 3;
		*uParam3 = 17;
	}
...
int func_235(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	vector3 vVar1;
...
{
	func_238(&(uParam0->f_15[uParam0->f_157 /*34*/]), iParam1);
}
...
{
	func_240(&(uParam0->f_15[uParam0->f_157 /*34*/]), iParam1);
}
...
int func_241(var uParam0, var uParam1, bool bParam2)
{
	vector3 vVar0;
	...
	if (bParam2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_249(uParam1)))
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(func_249(uParam1), true) };
		}
	}
	if (SYSTEM::VDIST2(vVar0, func_41(uParam0, func_312(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	return 1;
...
{
	func_245(&(uParam0->f_15[uParam0->f_157 /*34*/]), uParam1);
}
...
int func_246(vector3 vParam0, float fParam1)
{
	int iVar0;
...
float func_247(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}

Vector3 func_248(var uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_28)
	{
		return 0f, 0f, 0f;
...
{
	return func_250(&(uParam0->f_15[uParam0->f_157 /*34*/]));
}
...
{
	return func_271(uParam0, func_269(uParam0));
}

void func_253(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	iVar2 = func_283(uParam0, func_255(uParam0, iParam1));
	vVar4 = { func_264(uParam0, iParam1) };
	vVar5 = { 0f, 0f, 0f };
	if (ENTITY::IS_ENTITY_DEAD(iVar2, 0))
	{
		return;
	}
	if (ENTITY::IS_ENTITY_DEAD(func_273(uParam0, iParam1), 0))
	{
		func_276(uParam0, 2);
		return;
	}
	fVar1 = 144f;
	bVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_293(uParam0, func_271(uParam0, iParam1)), true), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
	if (!PED::IS_PED_IN_VEHICLE(iVar2, func_273(uParam0, iParam1), 0) && !bVar6)
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1794415470) != 1)
		{
			TASK::TASK_ENTER_VEHICLE(iVar2, func_273(uParam0, iParam1), -1, -1, 1f, 1, 0);
		}
		return;
	}
	iVar7 = 786603;
	...
	if (((ENTITY::DOES_ENTITY_EXIST(iVar2) && !ENTITY::IS_ENTITY_DEAD(iVar2, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1817882002) != 1) && !func_40(&(uParam0->f_15[iParam1 /*34*/]), 33554432))
	{
		if (func_271(uParam0, iParam1) == 1 && !func_266(uParam0, -1))
		{
			if (func_263(uParam2, uParam0) && func_312(uParam0) == 0)
			{
				vVar5 = { -3f, -3f, 0f };
			}
			else
		...
		func_3(vVar4 + vVar5, func_41(uParam2, func_312(uParam0)), &(uParam0->f_15[iParam1 /*34*/].f_10), &fVar0, 0f, 0f, 0f, 0f, 0f, 0f, 0);
		TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_283(uParam0, func_255(uParam0, iParam1)), func_273(uParam0, iParam1), uParam0->f_15[iParam1 /*34*/].f_10, 4f, 0, 0, iVar7, 4f, -1f);
	}
	if (bVar6)
	{
		TASK::CLEAR_PED_TASKS(func_283(uParam0, func_255(uParam0, iParam1)));
		func_57(&(uParam0->f_15[iParam1 /*34*/]), 33554432);
		if (!func_266(uParam0, -1))
		{
			TASK::TASK_EVERYONE_LEAVE_VEHICLE(func_273(uParam0, iParam1));
			iVar8 = 1;
			func_20(uParam0, uParam2, func_271(uParam0, iParam1), 0, 36485, 45335);
			iVar3 = 0;
			while (iVar3 < func_319(uParam0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_283(uParam0, iVar3)) && !ENTITY::IS_ENTITY_DEAD(func_283(uParam0, iVar3), 0))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(func_283(uParam0, iVar3), 0))
					{
						iVar8 = 0;
					}
				}
		...
		else if ((SYSTEM::VDIST2(func_264(uParam0, iParam1), func_41(uParam2, func_312(uParam0))) < 1600f && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_273(uParam0, iParam1), true), func_41(uParam2, func_312(uParam0))) < 1600f) && !func_297(uParam0, iParam1, 67108864))
		{
			func_20(uParam0, uParam2, func_271(uParam0, iParam1), 1, 38218, 7458);
			if (bParam3)
			{
				func_276(uParam0, 2);
			}
		}
		else if (PED::IS_PED_IN_ANY_VEHICLE(func_283(uParam0, iParam1), 0))
		{
			TASK::TASK_VEHICLE_PARK(func_283(uParam0, func_255(uParam0, iParam1)), func_273(uParam0, iParam1), ENTITY::GET_ENTITY_COORDS(func_273(uParam0, iParam1), true), 0f, 3, 360f, 0);
			if (bParam3)
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(func_283(uParam0, iParam1), 0, 0);
				func_276(uParam0, 2);
				func_254(uParam0, iParam1, 1);
			}
		}
		else if (bParam3)
		{
...
{
	return func_270(uParam0, func_271(uParam0, iParam1));
}
...
int func_261(var uParam0, int iParam1)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (iVar0 >= iParam1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(func_283(uParam0, iVar0), 0) && !ENTITY::IS_ENTITY_DEAD(func_273(uParam0, iVar0), 0))
			{
				if ((!PED::IS_PED_IN_VEHICLE(func_283(uParam0, iVar0), func_273(uParam0, iVar0), 0) && !func_297(uParam0, iVar0, 16777216)) && !func_297(uParam0, iVar0, 67108864))
				{
					return 0;
				}
			}
...
Vector3 func_264(var uParam0, int iParam1)
{
	...
	return func_277(&(uParam0->f_15[iParam1 /*34*/]));
}

Vector3 func_265(var uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_28)
	{
		return 0f, 0f, 0f;
...
Vector3 func_267(var uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_28)
	{
		return 0f, 0f, 0f;
...
int func_268(var uParam0, var uParam1, int iParam2)
{
	int iVar0;
	vector3 vVar1;
	
	iVar0 = func_250(&(uParam1->f_15[iParam2 /*34*/]));
	if (!ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		return 0;
	}
	vVar1 = { ENTITY::GET_ENTITY_COORDS(func_250(&(uParam1->f_15[iParam2 /*34*/])), false) };
	if (SYSTEM::VDIST2(vVar1, func_41(uParam0, func_312(uParam1))) > (55f * 55f))
	{
		return 0;
	}
...
{
	return func_293(uParam0, func_271(uParam0, iParam1));
}
...
int func_280(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_312(uParam0[iVar0 /*170*/]) == iParam1)
		{
			return 1;
		}
		iVar0++;
...
void func_282(var uParam0, var uParam1, var uParam2)
{
	int iVar0;
	...
	while (iVar0 < func_53(uParam1))
	{
		...
		{
			func_279(uParam0, uParam1, iVar0);
			return;
		}
		iVar0++;
	}
...
int func_283(var uParam0, int iParam1)
{
	...
	return func_298(&(uParam0->f_15[iParam1 /*34*/]));
}
...
int func_285(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		if (!func_292(*uParam2, 4))
		{
			if (func_289(iVar0, iParam0, uParam2, bParam5))
			{
				*uParam3 = 4;
				return 1;
			}
		}
		if (!func_292(*uParam2, 8))
		{
			if (func_288(iVar0, iParam0, uParam2))
			{
				*uParam3 = 8;
				return 1;
			}
		}
		bVar1 = !func_292(*uParam2, 128);
		if (bParam4)
		{
			if (func_286(iParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		}
		else if (!func_292(*uParam2, 16))
		{
			if (func_286(iParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_286(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if (bParam3)
	{
		if (!bLocal_390)
		{
			iLocal_391 = ENTITY::GET_ENTITY_HEALTH(iParam0);
			bLocal_390 = true;
		}
		iLocal_392 = ENTITY::GET_ENTITY_HEALTH(iParam0);
		iLocal_393 = (iLocal_391 - iLocal_392);
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, iVar0, 1))
			{
				if (IntToFloat(iLocal_393) > 100f)
				{
					return 1;
				}
			}
	...
	if (func_287(PLAYER::PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_294(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_289(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar1;
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(iParam0) || func_290(iVar1))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam1), iParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam1, iParam0, 17))
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
				{
					...
					{
						if (func_272(PLAYER::PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
			{
				...
				{
					if (func_294(iParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
...
float func_294(int iParam0, bool bParam1)
{
	return func_272(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}
...
void func_295(var uParam0)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		...
		func_296(&(uParam0->f_15[iVar0 /*34*/]));
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_15[iVar0 /*34*/].f_2) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_15[iVar0 /*34*/].f_2, 0))
		{
...
void func_299(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(func_298(uParam0)))
	{
		return;
	}
	if (ENTITY::IS_ENTITY_DEAD(func_298(uParam0), 0) || PED::IS_PED_INJURED(func_298(uParam0)))
	{
		return;
	}
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(func_298(uParam0), -1794415470) == 1)
	{
		return;
	}
	vVar0 = { func_277(uParam0) };
	vVar1 = { ENTITY::GET_ENTITY_COORDS(iParam1, true) };
	vVar2 = { ENTITY::GET_ENTITY_COORDS(func_298(uParam0), true) };
	...
	if (SYSTEM::VDIST2(vVar0, vVar1) > (150f * 150f))
	{
		...
		if (vVar0.z > 100f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3))
			{
				...
				{
					ENTITY::SET_ENTITY_COORDS(uParam0->f_3, vVar0.x, vVar0.y, 50f, 1, false, 0, 1);
				}
			}
		}
	}
	else
	{
		if (func_40(uParam0, 262144))
		{
			...
			func_260(uParam0, 262144);
		}
		if (func_40(uParam0, 524288) && func_266(uParam2, -1))
		{
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(func_298(uParam0), 1435919172) == 1)
			{
				TASK::CLEAR_PED_TASKS(func_298(uParam0));
			}
		}
	...
	if (SYSTEM::VDIST2(vVar2, vVar1) > (150f * 150f))
	{
		...
		if (func_40(uParam0, 262144) && iParam3 == func_269(uParam2))
		{
	...
	{
		if (func_40(uParam0, 262144) && func_266(uParam2, -1))
		{
		...
		func_260(uParam0, 524288);
	}
}

void func_300(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_283(uParam0, iParam1)) && !ENTITY::IS_ENTITY_DEAD(func_283(uParam0, iParam1), 0))
	{
		if (!ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(func_283(uParam0, iParam1), PLAYER::PLAYER_PED_ID(), 17))
		{
			PED::DELETE_PED(&(uParam0->f_15[iParam1 /*34*/].f_2));
			return;
		}
		else if (!func_297(uParam0, iParam1, 16777216))
		{
			TASK::TASK_SMART_FLEE_PED(func_283(uParam0, iParam1), PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
		}
		if (PED::IS_PED_IN_MELEE_COMBAT(func_283(uParam0, iParam1)))
		{
			TASK::CLEAR_PED_TASKS(func_283(uParam0, iParam1));
			TASK::TASK_SMART_FLEE_PED(func_283(uParam0, iParam1), PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
		}
	}
...
int func_301(var uParam0)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (!func_297(uParam0, iVar0, 16777216))
		{
			return 0;
		}
		iVar0++;
...
void func_302(var uParam0, var uParam1)
{
	...
	func_54(uParam0, 2);
	func_44(uParam1, uParam0);
	if (!PED::IS_PED_INJURED(func_283(uParam0, 0)))
	{
		vVar0 = { -1238.818f, 109.3903f, 55.91227f };
		iVar1 = func_308(uParam0, 0);
		func_307(uParam0, 0, vVar0);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			OBJECT::DELETE_OBJECT(&iVar1);
		}
		func_306(uParam0, 0, func_246(vVar0, 0f));
		func_9(uParam0, 0, vVar0, 3, 0);
		func_305(uParam0, 0, 2);
		func_254(uParam0, 0, 1);
		func_304(uParam0, 0, 4);
		func_303(uParam0, 0, 4f);
		ENTITY::SET_ENTITY_COORDS(func_283(uParam0, 0), -1241.802f, 107.3439f, 55.7186f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(func_283(uParam0, 0), 342.8433f);
	}
	if (!PED::IS_PED_INJURED(func_283(uParam0, 1)))
	{
		vVar0 = { -1236.201f, 112.7829f, 56.23418f };
		iVar1 = func_308(uParam0, 1);
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(func_283(uParam0, 1));
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			OBJECT::DELETE_OBJECT(&iVar1);
		}
		func_307(uParam0, 1, vVar0);
		func_306(uParam0, 1, func_246(vVar0, 0f));
		func_9(uParam0, 1, vVar0, 8, 0);
		func_305(uParam0, 1, 2);
		func_254(uParam0, 1, 10);
		ENTITY::SET_ENTITY_COORDS(func_283(uParam0, 1), -1243.465f, 104.3183f, 55.5857f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(func_283(uParam0, 1), 306.093f);
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_293(uParam0, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(func_293(uParam0, 0), 0))
	{
		ENTITY::SET_ENTITY_COORDS(func_293(uParam0, 0), -1257.234f, 94.0251f, 54.784f, 0, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(func_293(uParam0, 0), 240.9284f);
	}
	func_276(uParam0, 2);
}
...
void func_306(var uParam0, int iParam1, var uParam2)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_15)
	{
		return;
	}
	func_245(&(uParam0->f_15[iParam1 /*34*/]), uParam2);
}

void func_307(var uParam0, int iParam1, vector3 vParam2)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_15)
	{
		return;
...
int func_308(var uParam0, int iParam1)
{
	...
	return func_250(&(uParam0->f_15[iParam1 /*34*/]));
}

void func_309(int iParam0)
{
	Global_110588.f_1 = (Global_110588.f_1 || iParam0);
}
...
void func_311(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_293(uParam1, iVar2)))
		{
			if (iVar2 == 1)
			{
				vVar3 = { Vector(10f, 10f, 10f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(func_293(uParam1, 0)) };
			}
			if (func_43(func_326(uParam0, iParam2) + vVar3, func_41(uParam0, func_312(uParam1)), &vVar0, &fVar1))
			{
				func_284(uParam1, VEHICLE::CREATE_VEHICLE(joaat("CADDY"), vVar0, fVar1, true, true, false), iVar2);
				VEHICLE::SET_VEHICLE_EXTRA(func_293(uParam1, iVar2), 5, true);
				ENTITY::_SET_ENTITY_SOMETHING(func_293(uParam1, iVar2), true);
			}
		}
		iVar2++;
	}
...
void func_313(var uParam0, var uParam1, int iParam2)
{
	...
	iVar2 = 3;
	func_317(uParam1, iParam2, 4);
	if (iParam2 == 0)
	{
		vVar0 = { func_326(uParam0, func_312(uParam1)) };
	}
	else
	{
		vVar0 = { func_265(uParam0, func_312(uParam1), iParam2) };
	}
	if (!ENTITY::DOES_ENTITY_EXIST(func_283(uParam1, iParam2)))
	{
		iVar1 = func_316(&iVar2, 1065437102);
		func_314(uParam1, iParam2, PED::CREATE_PED(iVar2, iVar1, vVar0, 0f, 1, true));
		ENTITY::SET_ENTITY_HEADING(func_283(uParam1, iParam2), func_247(vVar0, func_326(uParam0, func_312(uParam1))));
		if (STREAMING::HAS_ANIM_SET_LOADED("move_m@golfer@"))
		{
			PED::SET_PED_WEAPON_MOVEMENT_CLIPSET(func_283(uParam1, iParam2), "move_m@golfer@");
		}
		PED::_0x2F3C3D9F50681DE4(func_283(uParam1, iParam2), 1);
	}
}
...
void func_314(var uParam0, int iParam1, int iParam2)
{
	...
	func_315(&(uParam0->f_15[iParam1 /*34*/]), iParam2);
}
...
void func_317(var uParam0, int iParam1, int iParam2)
{
	...
	func_318(&(uParam0->f_15[iParam1 /*34*/]), iParam2);
}
...
void func_320(var uParam0, var uParam1, int iParam2, int iParam3)
{
	func_54(uParam1, iParam2);
	func_323(uParam1, iParam3);
	func_322(uParam1, 0, 0);
	func_322(uParam1, 2, 1);
	func_321(uParam1, 0);
...
{
	return (Global_110588.f_1 && iParam0) != 0;
}
...
int func_329(var uParam0, int iParam1)
{
	...
	while (iVar0 < iVar1)
	{
		if ((*uParam0)[iVar0] == 0)
		{
			func_330(uParam0[iVar0], iParam1);
			uParam0->f_15++;
			return 1;
		}
		iVar0++;
...
{
	func_334(uParam0, joaat("a_m_y_golfer_01"));
	func_334(uParam0, joaat("prop_golf_putter_01"));
	func_334(uParam0, joaat("prop_golf_ball"));
	func_334(uParam0, joaat("prop_golf_pitcher_01"));
	func_334(uParam0, joaat("prop_golf_wood_01"));
	func_334(uParam0, joaat("prop_golf_iron_01"));
	func_334(uParam0, joaat("CADDY"));
	func_333(uParam0);
}
...
void func_338(var uParam0)
{
	...
	{
		(*uParam0)[iVar0 /*3*/] = (SYSTEM::VDIST(func_326(uParam0, iVar0), func_248(uParam0, iVar0)) + SYSTEM::VDIST(func_248(uParam0, iVar0), func_41(uParam0, iVar0)));
...
{
	Global_110588.f_1 = (Global_110588.f_1 - (Global_110588.f_1 && iParam0));
}
...
void func_341(var uParam0, int iParam1)
{
	...
	func_343(iParam1);
	func_342();
	STREAMING::REMOVE_ANIM_DICT(func_336());
...
void func_343(var uParam0)
{
	...
	{
		iVar1 = 0;
		while (iVar1 < func_319(uParam0[iVar0 /*170*/]))
		{
			func_61(uParam0[iVar0 /*170*/], iVar1);
			func_38(&((uParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/]));
			func_296(&((uParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/]));
