...
void func_1()
{
	...
	func_5();
	if (func_3(Global_110591) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_110591, 1))
	{
	...
	else
	{
		if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		{
			...
			{
				if (PED::IS_PED_IN_VEHICLE(Global_110592, Global_110591, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Global_110592, Global_110591, PLAYER::PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
					}
				}
				else if (!PED::IS_PED_FLEEING(Global_110592))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_SMART_FLEE_PED(Global_110592, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
					}
				}
				PED::SET_PED_KEEP_TASK(Global_110592, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_110592, false);
			}
		}
		else if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(Global_110592, Global_110591, 0))
			{
				if (!func_2(Global_110592, -258271821))
				{
					TASK::TASK_VEHICLE_DRIVE_WANDER(Global_110592, Global_110591, 12f, 790699);
				}
			}
			PED::SET_PED_KEEP_TASK(Global_110592, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_110592, false);
					...
					if (func_56(func_57()) >= iLocal_101)
					{
						if (bLocal_65)
						{
							if (iLocal_101 > 0)
							{
								...
								func_46(Global_110592, &iLocal_805);
						...
						else if (ENTITY::GET_ENTITY_SPEED(Global_110591) > 5f)
						{
							if (!func_8())
							{
								iLocal_805 = 12;
...
void func_13(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_15() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_15() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_16(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_17(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_21(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_15() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_22(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = BigHashList[iParam0 /*3*/][func_17(iParam1)];
...
void func_32(var uParam0)
{
	...
	func_34(uParam0, (Global_4269914 - 0.5f));
}
...
void func_58()
{
	...
	{
		if (func_61(Global_111560.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_60(PLAYER::PLAYER_PED_ID());
			if (func_59(iVar0) && (!func_40(14) || Global_110511))
			{
				if (Global_111560.f_2358.f_539.f_4321 != iVar0 && func_59(Global_111560.f_2358.f_539.f_4321))
				{
		...
		switch (iLocal_808)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_idle", 3))
						{
							if (!func_2(Global_110592, -2118855366))
							{
			...
			case 1:
				...
				func_174(&Global_110591, iLocal_826);
				if (func_173())
				{
		...
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_112))
		{
			if (iLocal_808 != 0)
			{
				...
				if (iLocal_58)
				{
					Local_801 = { func_80() };
					func_78(&uLocal_113);
					func_77(0, 75, "TXM_EXIT", &uLocal_113, 0, 359);
					if (iLocal_91 > 1)
					{
						func_77(2, 218, "TXM_CDES", &uLocal_113, 0, 359);
					}
					if (!bLocal_60)
					{
						if (iLocal_91 > 0)
						{
							func_77(2, 176, "TXM_SLCT", &uLocal_113, 0, 359);
						}
					}
					else if (iLocal_808 == 2)
					{
						func_77(2, 177, "TXM_STOP", &uLocal_113, 0, 359);
						if (bLocal_59)
						{
							func_77(2, 176, "TXM_SLCT", &uLocal_113, 0, 359);
						}
						if (func_76())
						{
							func_77(2, 176, "TXM_SKIP", &uLocal_113, 0, 359);
						}
						if (!bLocal_64)
						{
							func_77(2, 179, "TXM_HURY", &uLocal_113, 0, 359);
						}
					}
					else if (iLocal_808 == 3)
					{
						func_77(2, 177, "TXM_STRT", &uLocal_113, 0, 359);
						if (bLocal_59)
						{
							func_77(2, 176, "TXM_SLCT", &uLocal_113, 0, 359);
						}
				...
				func_75(1);
				func_74(1);
				func_67(&iLocal_112, &Local_801, &uLocal_113, func_73(&uLocal_113));
			}
		}
		else
		{
			iLocal_112 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("instructional_buttons");
		}
	}
	else
	{
		...
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
		{
			...
			while (iVar0 < uParam2->f_680)
			{
				if (MISC::IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					{
						func_70(&(uParam2->f_1[iVar0 /*56*/].f_32));
					}
					if (MISC::IS_PC_VERSION())
					{
				...
				else
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*iParam0, "SET_DATA_SLOT");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
					func_71(&(uParam2->f_1[iVar0 /*56*/]));
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam2->f_1[iVar0 /*56*/].f_16)))
					{
						func_71(&(uParam2->f_1[iVar0 /*56*/].f_16));
					}
					if (MISC::IS_BIT_SET(uParam2->f_674, iVar0))
					{
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(uParam2->f_1[iVar0 /*56*/].f_32));
	...
	switch (iLocal_810)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT() && AUDIO::IS_AUDIO_SCENE_ACTIVE("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_110591, false);
				}
				HUD::CLEAR_PRINTS();
		...
		case 2:
			if (func_126(&vLocal_43, &Global_110598, &Global_110604))
			{
				func_157();
				iLocal_810 = 3;
			}
		...
		case 3:
			if (Global_76593 == -1)
			{
				...
				func_118();
				func_117();
				MISC::CLEAR_AREA(Global_110598, 5f, 1, 0, 0, false);
				func_113(1097859072);
				if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					ENTITY::SET_ENTITY_COORDS(Global_110591, Global_110598, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(Global_110591, Global_110604);
					ENTITY::FREEZE_ENTITY_POSITION(Global_110591, true);
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
				STREAMING::NEW_LOAD_SCENE_STOP();
				MISC::CLEAR_AREA(Global_110598, 5000f, 1, 0, 0, false);
				MISC::CLEAR_AREA_OF_OBJECTS(Global_110598, 5000f, 0);
				MISC::CLEAR_AREA_OF_PROJECTILES(Global_110598, 30f, 0);
				GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(Global_110598, 5000f);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Global_110598, 5000f);
				if (Global_95621 != -1)
				{
					func_112(Global_95621, 1);
					func_111(Global_95621);
				}
				iLocal_802 = func_110(vLocal_43.x);
				if (iLocal_802 != -1)
				{
					func_112(iLocal_802, 1);
				}
				iLocal_57 = 0;
				iLocal_810 = 4;
			}
		...
		case 4:
			if (STREAMING::NEW_LOAD_SCENE_START_SPHERE(Global_110598, 4500f, 0))
			{
				iLocal_57 = 1;
				iLocal_810 = 5;
			}
		...
		case 6:
			...
			{
				bVar1 = true;
				if (Global_89487[iLocal_802 /*34*/].f_13 == -1 && Global_89487[iLocal_802 /*34*/].f_14 == -1)
				{
					bVar1 = false;
				}
				if (bVar1)
				{
					if (((func_57() == 0 && !MISC::IS_BIT_SET(Global_89487[iLocal_802 /*34*/].f_15, 8)) || (func_57() == 1 && !MISC::IS_BIT_SET(Global_89487[iLocal_802 /*34*/].f_15, 9))) || (func_57() == 2 && !MISC::IS_BIT_SET(Global_89487[iLocal_802 /*34*/].f_15, 10)))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					if (func_105(Global_89487[iLocal_802 /*34*/].f_13, Global_89487[iLocal_802 /*34*/].f_14))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_89487[iLocal_802 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				{
					iLocal_67 = 0;
					MISC::GET_GROUND_Z_FOR_3D_COORD(Global_110598 + Vector(100f, 0f, 0f), &fVar2, 0, 0);
					if (fVar2 > Global_110598.f_2)
					{
						Global_110598.f_2 = (fVar2 + 0.5f);
					}
				}
				func_113(12f);
				func_83();
				if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Global_110591, false);
					ENTITY::SET_ENTITY_HEADING(Global_110591, Global_110604);
					ENTITY::SET_ENTITY_COORDS(Global_110591, Global_110598, 1, false, 0, 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Global_110591, 1084227584);
					TASK::TASK_VEHICLE_TEMP_ACTION(Global_110592, Global_110591, 24, 5000);
				}
				iLocal_89 = MISC::GET_GAME_TIMER();
				iLocal_810 = 8;
			}
		...
		case 8:
			if (func_160(iLocal_89, 500))
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_110591, true);
				}
				if (!func_82())
				{
		...
		case 9:
			...
			{
				if (((!Global_95627 && iLocal_802 != -1) && iLocal_802 != 72) && iLocal_802 != 87)
				{
					func_111(iLocal_802);
				}
				func_161(0);
...
void func_83()
{
	...
	switch (iLocal_803)
	{
		case 92:
			vVar0 = { func_85(229, 0) };
			fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_110598, vVar0, true);
			if (fVar1 < 100f)
			{
				vVar0 = { func_84(Global_110598 - vVar0) };
				vVar0 = { (Global_110598 + (vVar0.x * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), (Global_110598.f_1 + (vVar0.y * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), Global_110598.f_2 };
				PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar0, &Global_110598, &Global_110604, 1, 1077936128, 0);
				ENTITY::SET_ENTITY_COORDS(Global_110591, Global_110598, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(Global_110591, Global_110604);
			}
			break;
...
int func_97(int iParam0)
{
	if (iParam0 != -1)
	{
		if (!Global_110647[iParam0 /*10*/].f_1)
		{
			return 1;
		}
	}
...
int func_110(int iParam0)
{
	...
	while (iVar0 < 8)
	{
		if (Global_95632[iVar0 /*17*/])
		{
			if (Global_95632[iVar0 /*17*/].f_9 != 263)
			{
				if (Global_31111[Global_95632[iVar0 /*17*/].f_9 /*23*/].f_19 == iParam0)
				{
					return Global_95632[iVar0 /*17*/].f_5;
				}
			}
		}
		iVar0++;
...
void func_113(float fParam0)
{
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_110598, iVar2, &vVar3, 1, 3f, 0f))
			{
				iVar2++;
			}
		}
	}
	if (SYSTEM::VDIST2(vVar3, Global_110598) > 2f)
	{
		PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3, 0, &Global_110598, 0);
	}
}
...
void func_118()
{
	...
	fVar0 = func_121(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598);
	if (bLocal_64)
	{
...
void func_119(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_94(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5)))
		{
			func_120(&(Global_111560.f_18098.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_94(&(Global_111560.f_18098.f_362[iVar1 /*3*/])))
		{
			func_120(&(Global_111560.f_18098.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
void func_122()
{
	...
	fVar0 = (((func_121(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598) / 50f) * fLocal_73) * 2.4f);
...
void func_123()
{
	...
	if (iLocal_101 != iLocal_102)
	{
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		fLocal_83 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598);
...
{
	STREAMING::NEW_LOAD_SCENE_STOP();
	if (STREAMING::_0x07C313F94746702C(Global_110270.f_218))
	{
		STREAMING::_0x1EE7D8DF4425F053(Global_110270.f_218);
	}
}
...
int func_126(int iParam0, var uParam1, float fParam2)
{
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_807)
		{
			case 0:
				iLocal_110 = 3;
				vLocal_816 = { func_49(*iParam0) };
				if (HUD::DOES_BLIP_EXIST(Global_110596) && *iParam0 == Global_110596)
				{
					*uParam1 = { Global_110601 };
					*fParam2 = Global_110605;
				...
				{
					if (func_144(vLocal_816, uParam1, fParam2))
					{
						vVar0 = { vLocal_816 - *uParam1 };
						vVar0.z = 0f;
						fLocal_72 = SYSTEM::VMAG(vVar0);
			...
			case 1:
				if (func_133(vLocal_816, uParam1, fParam2, 1))
				{
					vVar0 = { vLocal_816 - *uParam1 };
					vVar0.z = 0f;
					fLocal_72 = SYSTEM::VMAG(vVar0);
			...
			case 2:
				...
				{
					if (func_127(&Global_110591, ENTITY::GET_ENTITY_COORDS(Global_110591, false), vLocal_816, uParam1, fParam2, &iLocal_88, 1000))
					{
						iLocal_807 = 3;
						return 1;
					}
...
int func_127(var uParam0, vector3 vParam1, vector3 vParam2, var uParam3, float fParam4, int iParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
	...
	iVar18 = *iParam5 + 2;
	iVar19 = 50;
	func_130(vParam1, vParam2, &vLocal_817, &vLocal_818, iParam6);
	if (func_129(vLocal_817, vLocal_818))
	{
			...
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam2, *iParam5, uParam3, fParam4, &iVar6, iVar14, fVar0, fVar1))
			{
				...
				if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar12))
				{
					if (PATHFIND::GET_CLOSEST_ROAD(*uParam3, 1f, 1, &uVar4, &uVar3, &iVar8, &iVar7, &fVar10, iVar15))
					{
						...
						if (func_128(vParam2, *uParam3) || fVar11 < 0.5f)
						{
...
int func_128(vector3 vParam0, vector3 vParam1)
{
	float fVar0;
	float fVar1;
...
void func_130(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	...
	if (!func_131(vVar0, *uParam4, 1056964608, 0) || !func_131(vVar0, *uParam4, 1056964608, 0))
	{
		*uParam4 = { vVar0 };
		*uParam5 = { vVar1 };
	}
...
int func_133(vector3 vParam0, var uParam1, float fParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2[6];
	...
	if (func_143(vParam0, 1900f, -6600f, 100f, 6900f, -3600f, 140f))
	{
		*uParam1 = { 1261.58f, -3332.685f, 5.4191f };
		*fParam2 = 163.87f;
		return 1;
	}
	else if (func_143(vParam0, -3800f, 5400f, -100f, -1900f, 8500f, 100f))
	{
		*uParam1 = { -1577.16f, 5166.51f, 19.1864f };
		*fParam2 = 0f;
		return 1;
	}
	else if (func_143(vParam0, -874.9833f, 125.7645f, -100f, -768.6254f, 193.0297f, 100f))
	{
		*uParam1 = { -856.6151f, 163.7361f, 65.093f };
		*fParam2 = 355.3355f;
		return 1;
	}
	else if (func_143(vParam0, -39.2005f, -1473.55f, -100f, 10.6133f, -1430.099f, 100f))
	{
		*uParam1 = { -15.5181f, -1456.4f, 29.4244f };
		*fParam2 = 94.6893f;
		return 1;
	}
	else if (func_143(vParam0, 1964.742f, 3792.59f, -100f, 1992.636f, 3840.253f, 100f))
	{
	...
	{
		if (func_138(vVar1, 1283.326f, -1731.522f, 51.78555f, 17f))
		{
			*uParam1 = { 1283.326f, -1731.522f, 51.78555f };
			*fParam2 = 275.4274f;
			return 1;
		}
		if (func_138(vVar1, 1334.386f, -1709.762f, 55.70131f, 41f))
		{
			*uParam1 = { 1334.386f, -1709.762f, 55.70131f };
			*fParam2 = 275.4411f;
			return 1;
		}
		if (func_138(vVar1, 1246.166f, -1750.625f, 45.35691f, 28f))
		{
			*uParam1 = { 1246.166f, -1750.625f, 45.35691f };
			*fParam2 = 301.2981f;
			return 1;
		}
		if (func_138(vVar1, 1196.272f, -1753.051f, 37.63976f, 32f))
		{
	...
	if (func_138(vVar1, -1693.302f, -1109.13f, 17.89778f, 240f))
	{
	...
	fVar8 = 232.0109f;
	fVar9 = func_135(vParam0, vVar7);
	vVar10 = { 2450.604f, 5129.224f, 45.9722f };
	fVar11 = 241.1957f;
	fVar12 = func_135(vParam0, vVar10);
	vVar1 = { vParam0 };
	bVar13 = false;
	if (vParam0.z == 1f)
	{
	...
	if (func_134(vVar1, -99.68751f, -2448.891f, 5.01731f, 230f))
	{
...
bool func_134(vector3 vParam0, vector3 vParam1, float fParam2)
{
...
bool func_138(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
...
int func_139(vector3 vParam0, int iParam1, int iParam2, bool bParam3)
{
	vector3 vVar0[15];
	vector3 vVar1[15];
	float fVar2[15];
...
{
	return SYSTEM::VDIST2(vParam1, func_142(iParam0)) < func_141(iParam0);
}
...
int func_143(vector3 vParam0, vector3 vParam1, vector3 vParam2)
{
...
int func_144(vector3 vParam0, var uParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar1 = 1E+08f;
	fVar2 = 1E+08f;
	func_156(&vParam0, &iLocal_803, &fVar0);
	func_154(&vParam0, &iLocal_106, &fVar1);
	func_151(&vParam0, &iLocal_804, &fVar2);
	if (fVar0 < fVar1 && fVar0 < fVar2)
	{
		if (func_150(iLocal_803, vParam0))
		{
			if (func_149(iLocal_803, uParam1, fParam2))
			{
				return 1;
			}
		}
	...
	{
		if (func_148(iLocal_106, vParam0))
		{
	...
	{
		if (func_146(iLocal_804, vParam0))
		{
			if (func_145(iLocal_804, uParam1, fParam2))
			{
				return 1;
			}
		}
...
int func_154(var uParam0, int iParam1, float fParam2)
{
	...
	{
		*iParam1 = iVar4;
		if (MISC::IS_BIT_SET(Global_111560.f_18569[*iParam1 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111560.f_18569[*iParam1 /*6*/], 3))
		{
			func_99(*iParam1, &Var5);
			if (MISC::IS_BIT_SET(Var5.f_26, func_155()))
			{
				vVar3 = { Var5.f_6 };
				if (uParam0->f_2 == 1f)
				{
...
int func_156(var uParam0, int iParam1, float fParam2)
{
	...
	while (iVar4 < 8)
	{
		if (Global_95632[iVar4 /*17*/])
		{
			if (Global_95632[iVar4 /*17*/].f_9 != 263)
			{
				if (HUD::DOES_BLIP_EXIST(Global_31111[Global_95632[iVar4 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = { HUD::GET_BLIP_COORDS(Global_31111[Global_95632[iVar4 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
					...
					if (fVar2 < fVar1)
					{
						if (fVar2 < Global_95632[iVar4 /*17*/].f_10.f_2)
						{
							fVar1 = fVar2;
							iVar0 = iVar4;
						}
	...
	{
		*fParam2 = fVar1;
		*iParam1 = Global_95632[iVar0 /*17*/].f_5;
		return 1;
	}
	*iParam1 = -1;
	*fParam2 = 999999f;
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!PED::IS_PED_INJURED(iVar2))
				{
					if (!PED::IS_PED_SITTING_IN_VEHICLE(iVar2, Global_110591))
					{
						iVar3 = 0;
						if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_110591, iVar3, 0))
						{
							iVar3 = func_159(&Global_110591);
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(Global_110591, iVar3, 0))
							{
								TASK::CLEAR_PED_TASKS(iVar2);
								PED::SET_PED_INTO_VEHICLE(iVar2, Global_110591, iVar3);
							}
						}
						else
						{
...
void func_169()
{
	...
	if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
		{
			if (VEHICLE::IS_VEHICLE_STOPPED(Global_110591))
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_idle", 3))
				{
					if (!func_2(Global_110592, -2118855366))
			...
			else if (!func_2(Global_110592, -272084098))
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(Global_110591, true) };
				fVar1 = ENTITY::GET_ENTITY_HEADING(Global_110591);
				TASK::TASK_VEHICLE_PARK(Global_110592, Global_110591, vVar0, fVar1, 3, 60f, 0);
			}
		}
	}
}
		...
		if (bLocal_61)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
			{
				if (!PED::IS_PED_INJURED(Global_110592))
				{
					if (func_172())
					{
						if (ENTITY::GET_ENTITY_SPEED(Global_110591) < 2f)
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_110591, 1))
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_idle", 3))
					{
						if (PED::IS_PED_HEADTRACKING_PED(Global_110592, PLAYER::PLAYER_PED_ID()))
						{
							TASK::TASK_CLEAR_LOOK_AT(Global_110592);
						}
						TASK::TASK_PLAY_ANIM(Global_110592, &cLocal_811, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_exit", 3))
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(Global_110592, &cLocal_811, "leanover_exit", 1.2f);
						iLocal_90 = MISC::GET_GAME_TIMER();
						func_174(&Global_110591, iLocal_826);
					}
					else if (!func_2(Global_110592, 242628503))
					{
						if (func_171(&iLocal_90, iLocal_826))
						{
							if (!func_2(Global_110592, -2118855366))
							{
								TASK::TASK_VEHICLE_TEMP_ACTION(Global_110592, Global_110591, 1, 1000000);
						...
						else
						{
							...
							TASK::CLEAR_PED_TASKS(Global_110592);
							TASK::TASK_CLEAR_LOOK_AT(Global_110592);
							PED::SET_DRIVER_ABILITY(Global_110592, 0.5f);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_800);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_110591, Global_110598, fVar1, iVar0, 45f);
							TASK::TASK_VEHICLE_PARK(0, Global_110591, Global_110598, Global_110604, iLocal_110, 60f, 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_800);
							TASK::TASK_PERFORM_SEQUENCE(Global_110592, iLocal_800);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_800);
						}
					}
				}
			}
...
int func_171(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iVar3))
	{
		...
		bVar4 = true;
		iVar2 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_110591, iVar6, 0);
		...
		if (bVar4)
		{
			TASK::TASK_ENTER_VEHICLE(iVar3, Global_110591, 20000, iVar6, 2f, 9437185, 0);
			bVar5 = true;
		}
	}
	if (iVar0 > 1)
...
int func_172()
{
	if ((ENTITY::IS_ENTITY_AT_COORD(Global_110591, Global_110598, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_808 == 4)
	{
		iLocal_56 = 1;
		if (TASK::GET_SCRIPT_TASK_STATUS(Global_110592, 242628503) == 7)
		{
			return 1;
		}
	}
...
int func_173()
{
	if (bLocal_60)
	{
		...
		else if (func_126(&vLocal_43, &Global_110598, &Global_110604))
		{
			iLocal_103 = 0;
			vLocal_820 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) };
			fLocal_83 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598);
	...
	if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_811))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_800);
				TASK::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_800);
				TASK::TASK_PERFORM_SEQUENCE(Global_110592, iLocal_800);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_800);
				return 1;
...
int func_177()
{
	...
	iLocal_111 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("taxi_display");
	iLocal_112 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("instructional_buttons");
	STREAMING::REQUEST_ANIM_DICT(&cLocal_811);
...
void func_178()
{
	...
	if (!CAM::DOES_CAM_EXIST(iLocal_68))
	{
		if (!func_186() && !func_185(8, -1))
		{
			...
			CAM::ATTACH_CAM_TO_ENTITY(iLocal_68, Global_110591, vLocal_822, 1);
			func_182();
...
void func_183(int iParam0, int iParam1, vector3 vParam2)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (CAM::DOES_CAM_EXIST(*iParam1))
		{
			...
			fVar3 = vVar0.y;
			vVar4 = { func_84(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110591, vParam2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110591, vLocal_822)) };
			func_184(vVar4, &fVar1, &fVar2, 1);
			CAM::SET_CAM_ROT(*iParam1, fVar1, fVar3, fVar2, 2);
		}
	}
}

void func_184(vector3 vParam0, var uParam1, var uParam2, int iParam3)
{
	float fVar0;
...
void func_187()
{
	...
	while (iVar0 < iLocal_91)
	{
		...
		else if (func_192(vLocal_806[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_131(HUD::GET_BLIP_COORDS(vLocal_806[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(HUD::GET_BLIP_SPRITE(vLocal_806[iVar0 /*3*/]));
			HUD::GET_HUD_COLOUR(HUD::GET_BLIP_HUD_COLOUR(vLocal_806[iVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar1);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar2);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar3);
			iVar6 = func_190(vLocal_806[iVar0 /*3*/]);
			if (iVar6 == -1)
			{
...
void func_193()
{
	...
	if (MISC::GET_MISSION_FLAG())
	{
		if (iLocal_94 == 0)
		{
			if (HUD::DOES_BLIP_EXIST(Global_110595))
			{
				iVar0 = 0;
				while (iVar0 < 40)
				{
					if (HUD::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
					{
						if (vLocal_806[iVar0 /*3*/] == Global_110595)
						{
							iLocal_92 = iVar0;
							iVar0 = 40;
						}
	...
	if (MISC::GET_MISSION_FLAG())
	{
		if (!Global_110597 == -1)
		{
			...
			while (iVar0 < 40)
			{
				if (HUD::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
				{
					if (func_192(vLocal_806[iVar0 /*3*/]) == Global_110597)
					{
						iLocal_92 = iVar0;
						iVar0 = 40;
					}
			...
			if (func_196(iVar2))
			{
				if (func_209(iVar2))
				{
					if (!func_207(&iVar2))
					{
						...
						if (HUD::DOES_BLIP_EXIST(Global_110594))
						{
							if (func_192(iVar2) == iLocal_44)
							{
								if (!Global_110594 == iVar2)
								{
									bVar1 = false;
								}
							}
						...
						if (bVar1)
						{
							...
							if (bVar1)
							{
								func_204(&iVar2, &vVar0);
								func_198(vVar0, bParam1);
							}
						}
					}
				}
...
void func_198(vector3 vParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 40)
	{
		if (func_192(vLocal_806[iVar0 /*3*/]) == func_192(vParam0.x))
		{
			iVar1 = iVar0;
			iVar0 = 40;
		}
	...
	while (iVar0 < 40)
	{
		...
		if (iVar0 < iLocal_91)
		{
			if (func_192(vLocal_806[iVar0 /*3*/]) == func_192(vParam0.x))
			{
				if (func_202(vParam0, vLocal_806[iVar0 /*3*/]))
				{
					if (bParam1)
					{
						func_201(vParam0, iVar0);
						iVar0 = 40;
						return;
					}
					else
					{
						func_199(vParam0, iVar0);
						iLocal_91++;
						iVar0 = 40;
						return;
					}
...
void func_199(vector3 vParam0, int iParam1)
{
	...
	if (func_192(vLocal_806[iParam1 /*3*/]) == HUD::_GET_WAYPOINT_BLIP_SPRITE())
	{
		iLocal_97 = iParam1;
...
int func_202(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5)
{
...
void func_204(int iParam0, var uParam1)
{
	...
	*uParam1 = *iParam0;
	...
	{
		PATHFIND::GET_STREET_NAME_AT_COORD(Global_110598, &(uParam1->f_1), &(uParam1->f_2));
	}
}
...
int func_206(int iParam0)
{
	...
	while (iVar0 < 8)
	{
		if (Global_95632[iVar0 /*17*/])
		{
			if (Global_95632[iVar0 /*17*/].f_9 != 263)
			{
				if (HUD::DOES_BLIP_EXIST(Global_31111[Global_95632[iVar0 /*17*/].f_9 /*23*/].f_19))
				{
					if (Global_31111[Global_95632[iVar0 /*17*/].f_9 /*23*/].f_19 == *iParam0)
					{
						return Global_95632[iVar0 /*17*/].f_5;
...
bool func_208(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	if (SYSTEM::TIMERB() > 250)
	{
		...
		if (!bVar0)
		{
			if (iLocal_97 != -1)
			{
				...
				{
					if (func_192(vLocal_806[iLocal_97 /*3*/]) == HUD::_GET_WAYPOINT_BLIP_SPRITE())
					{
						vVar1 = { HUD::GET_BLIP_COORDS(vLocal_806[iLocal_97 /*3*/]) };
						if (!func_131(vVar1, vLocal_821, 1056964608, 0))
						{
							bVar0 = true;
						}
					}
...
int func_212()
{
	...
	iVar0 = 0;
	if (func_3(Global_110591))
	{
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_110591, -1, 0))
		{
			iVar0++;
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_110591, 0, 0))
		{
			iVar0++;
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_110591, 1, 0))
			...
			if (iLocal_808 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 179))
					{
						...
						if (!PED::IS_PED_INJURED(Global_110592))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_enter", 3))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_idle", 3))
								{
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_exit", 3))
									{
										TASK::CLEAR_PED_TASKS(Global_110592);
									}
								}
...
void func_223()
{
	if (!Global_110596 == 0)
	{
		if (!HUD::DOES_BLIP_EXIST(Global_110596))
		{
			Global_110596 = 0;
		}
	}
...
int func_227()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (func_228(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
				{
...
int func_229(int iParam0)
{
	...
	if (iLocal_808 != 4)
	{
		if (iParam0 == 1)
		{
			...
			if (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_110591, 2, 30000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_110591, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_110591, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_110591, 1, 7000))
			{
				return 1;
			}
		}
...
int func_231()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_235(&iVar0, func_237(), func_236()))
		{
			...
			{
				vLocal_819 = { ENTITY::GET_ENTITY_COORDS(Global_110591, true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				vLocal_819.z = 0f;
...
void func_238(bool bParam0)
{
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_112);
	if (func_239(Global_110592))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_enter", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_enter", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_idle", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_idle", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_811, "leanover_exit", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_exit", &cLocal_811, -2f);
		}
		if (PED::IS_PED_HEADTRACKING_PED(Global_110592, PLAYER::PLAYER_PED_ID()))
		{
			TASK::TASK_CLEAR_LOOK_AT(Global_110592);
		...
		if (iLocal_810 != 10)
		{
			...
			if (bParam0)
			{
				if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
				{
					...
					{
						if ((!func_82() && !func_8()) && Global_98669 != 10)
						{
							CAM::DO_SCREEN_FADE_IN(250);
						}
					}
