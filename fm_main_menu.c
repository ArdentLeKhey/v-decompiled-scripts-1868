#region Local Var
	...
	var uLocal_179 = 0;
	var uLocal_180 = 0;
	struct<6> Local_181 = { 0, 0, 0, 0, 0, -1 } ;
	var uLocal_182 = 0;
	var uLocal_183 = 0;
	var uLocal_184 = 3;
	var uLocal_185 = 17;
...
void __EntryFunction__()
{
	...
	uLocal_297 = Global_4456448.f_2;
	Global_1312440 = 0;
	Local_181.f_5 = Global_4456448;
	Global_1312370 = 0;
	Global_1312441 = 0;
	iLocal_296 = Global_4456448;
	if (Global_4456448 == 0)
	{
		Global_4456448.f_2 = uLocal_297;
	}
	Global_1654032 = 0;
	while (true)
	{
		if (iLocal_296 != Global_4456448)
		{
			func_17(&Local_181);
			iLocal_296 = Global_4456448;
			MISC::CLEAR_BIT(&(Local_181.f_4), 0);
		}
		if (func_16() == 3)
		{
			func_18();
		...
		switch (iLocal_294)
		{
			...
			case 1:
				if (Local_181.f_5 != Global_4456448)
				{
					Local_181.f_5 = Global_4456448;
					func_17(&Local_181);
				}
			...
			case 4:
				if (func_11())
				{
					if (((Global_4456448.f_2 != 6 && Global_4456448 != 4) && Global_4456448.f_2 != 5) && !func_10())
					{
						if (func_9(&iLocal_295))
						{
							iLocal_294 = 2;
						}
					}
					...
					{
						if (func_7(&iLocal_295))
						{
							iLocal_294 = 2;
						}
					}
					else if (func_6(&iLocal_295))
					{
						iLocal_294 = 2;
					}
				}
...
int func_2(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Race_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Race_Creator", 29500);
...
int func_5(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Deathmatch_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Deathmatch_Creator", 29500);
...
int func_6(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Capture_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Capture_Creator", 29500);
...
int func_7(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Survival_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Survival_Creator", 29500);
...
int func_8(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_LTS_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_LTS_Creator", 29500);
...
int func_9(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Mission_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Mission_Creator", 29500);
...
void func_14(var uParam0)
{
	if (Global_4456448 == 0)
	{
		Global_4456448.f_37 = uParam0->f_8[0 /*18*/][5];
		Global_4456448.f_38 = uParam0->f_8[0 /*18*/][5];
		Global_4456448.f_42 = uParam0->f_8[0 /*18*/][7] + 1;
	}
	else if (Global_4456448 == 1)
	{
		Global_4456448.f_37 = uParam0->f_8[1 /*18*/][0];
		Global_4456448.f_62 = uParam0->f_8[1 /*18*/][2];
		Global_4456448.f_64 = uParam0->f_8[1 /*18*/][3];
		Global_4456448.f_39 = uParam0->f_8[1 /*18*/][4];
		Global_4456448.f_88011 = uParam0->f_8[1 /*18*/][5];
		Global_4456448.f_88010 = uParam0->f_8[1 /*18*/][6];
		Global_4456448.f_70 = uParam0->f_8[1 /*18*/][7];
		Global_4456448.f_60684 = uParam0->f_8[1 /*18*/][8];
		Global_4456448.f_75 = uParam0->f_8[1 /*18*/][9];
		Global_4456448.f_65 = uParam0->f_8[1 /*18*/][10];
		Global_4456448.f_67 = uParam0->f_8[1 /*18*/][11];
		Global_4456448.f_69 = uParam0->f_8[1 /*18*/][12];
		Global_4456448.f_68 = uParam0->f_8[1 /*18*/][13];
		Global_4456448.f_92413 = uParam0->f_8[1 /*18*/][14];
	}
	else if (Global_4456448 == 2)
	{
		Global_4456448.f_37 = uParam0->f_8[2 /*18*/][4];
		Global_4456448.f_58156 = uParam0->f_8[2 /*18*/][14];
		Global_4456448.f_58153 = uParam0->f_8[2 /*18*/][7];
	}
}
...
int func_16()
{
	if (MISC::IS_BIT_SET(Global_1373500.f_102, 1))
	{
		return 1;
	}
	if (MISC::IS_BIT_SET(Global_1373500.f_102, 2))
	{
		MISC::CLEAR_BIT(&(Global_1373500.f_102), 2);
		return 2;
	}
	if (MISC::IS_BIT_SET(Global_1373500.f_102, 3))
	{
		MISC::CLEAR_BIT(&(Global_1373500.f_102), 3);
		return 3;
	}
	return 0;
}
