...
void func_137()
{
	...
	func_144();
	func_109();
	if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_50, 150f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, true, 0))
	{
...
bool func_141(char* sParam0, int iParam1, int iParam2)
{
...
void func_147()
{
	if (func_103(35))
	{
		if (iLocal_38 == 0)
		{
			...
			{
				if (!func_76(iLocal_51, vLocal_50, 10f) || ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_51))
				{
					MISC::CLEAR_BIT(&iLocal_49, 1);
				}
			}
...
void func_151()
{
	...
	if ((Global_41396 == 15 && !func_169()) || func_103(35))
	{
		if (iLocal_38 == 0)
		{
...
void func_190(int iParam0, var uParam1)
{
	...
	func_191(&uLocal_80, Local_44, PLAYER::PLAYER_PED_ID(), Local_44.f_1, 0, 1);
...
{
	return func_204(iParam0, Global_41396);
}
...
void func_209()
{
	...
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_169()) && Global_76574 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
	...
	else if (((((((Global_41396 != 15 || Global_41396 != 0) || Global_41396 != 2) || Global_41396 != 4) || Global_41396 != 17) || func_169()) || Global_76574 == -1) || Global_110615)
	{
		iVar1 = 0;
		if (func_210())
		{
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_210()) && !Global_110200)
					{
						MISC::SET_BIT(&iLocal_49, 15);
						HUD::CLEAR_HELP(1);
					}
...
int func_227()
{
	if (((((Global_41396 == 15 && !func_169()) && Global_76574 == -1) && !func_210()) && !func_228(1112014848)) && !Global_110615)
	{
		return 1;
	}
	return 0;
...
int func_233(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2542527[iParam0 /*3*/][func_234(iParam1)];
...
void func_237(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_111560.f_20405.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_111560.f_20405[iVar0 /*16*/])))
		{
			...
			func_239((Global_111560.f_20405.f_145 - 1));
